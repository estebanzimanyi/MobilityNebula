...
functionName:  IDENTIFIER | AVG | MAX | MIN | SUM | COUNT | MEDIAN | ARRAY_AGG | VAR | TEMPORAL_SEQUENCE | TEMPORAL_EINTERSECTS_GEOMETRY | TEMPORAL_AINTERSECTS_GEOMETRY | TEMPORAL_ECONTAINS_GEOMETRY | EDWITHIN_TGEO_GEO | TGEO_AT_STBOX | ACONTAINS_GEO_TRGEOMETRY | ACOVERS_GEO_TRGEOMETRY | ACOVERS_TRGEOMETRY_GEO | ADISJOINT_TRGEOMETRY_GEO | ADISJOINT_TRGEOMETRY_TRGEOMETRY | ADWITHIN_TRGEOMETRY_GEO | ADWITHIN_TRGEOMETRY_TRGEOMETRY | AINTERSECTS_TRGEOMETRY_GEO | AINTERSECTS_TRGEOMETRY_TRGEOMETRY | ATOUCHES_TRGEOMETRY_GEO | ECONTAINS_GEO_TRGEOMETRY | ECOVERS_GEO_TRGEOMETRY | ECOVERS_TRGEOMETRY_GEO | EDISJOINT_TRGEOMETRY_GEO | EDISJOINT_TRGEOMETRY_TRGEOMETRY | EDWITHIN_TRGEOMETRY_GEO | EDWITHIN_TRGEOMETRY_TRGEOMETRY | EINTERSECTS_TRGEOMETRY_GEO | EINTERSECTS_TRGEOMETRY_TRGEOMETRY | ETOUCHES_TRGEOMETRY_GEO;
