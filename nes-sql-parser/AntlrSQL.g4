...
functionName:  IDENTIFIER | AVG | MAX | MIN | SUM | COUNT | MEDIAN | ARRAY_AGG | VAR | TEMPORAL_SEQUENCE | TEMPORAL_EINTERSECTS_GEOMETRY | TEMPORAL_AINTERSECTS_GEOMETRY | TEMPORAL_ECONTAINS_GEOMETRY | EDWITHIN_TGEO_GEO | TGEO_AT_STBOX | ACOVERS_GEO_TGEO | ADISJOINT_GEO_TGEO | ADWITHIN_GEO_TGEO | AINTERSECTS_GEO_TGEO | ATOUCHES_GEO_TGEO | EDISJOINT_GEO_TGEO | EDWITHIN_GEO_TGEO | EINTERSECTS_GEO_TGEO | ETOUCHES_GEO_TGEO;
...
ADISJOINT_GEO_TGEO: 'ADISJOINT_GEO_TGEO' | 'adisjoint_geo_tgeo';
ADWITHIN_GEO_TGEO: 'ADWITHIN_GEO_TGEO' | 'adwithin_geo_tgeo';
AINTERSECTS_GEO_TGEO: 'AINTERSECTS_GEO_TGEO' | 'aintersects_geo_tgeo';
ATOUCHES_GEO_TGEO: 'ATOUCHES_GEO_TGEO' | 'atouches_geo_tgeo';
EDISJOINT_GEO_TGEO: 'EDISJOINT_GEO_TGEO' | 'edisjoint_geo_tgeo';
EDWITHIN_GEO_TGEO: 'EDWITHIN_GEO_TGEO' | 'edwithin_geo_tgeo';
EINTERSECTS_GEO_TGEO: 'EINTERSECTS_GEO_TGEO' | 'eintersects_geo_tgeo';
ETOUCHES_GEO_TGEO: 'ETOUCHES_GEO_TGEO' | 'etouches_geo_tgeo';
