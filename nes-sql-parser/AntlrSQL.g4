...
functionName:  IDENTIFIER | AVG | MAX | MIN | SUM | COUNT | MEDIAN | ARRAY_AGG | VAR | TEMPORAL_SEQUENCE | TEMPORAL_EINTERSECTS_GEOMETRY | TEMPORAL_AINTERSECTS_GEOMETRY | TEMPORAL_ECONTAINS_GEOMETRY | EDWITHIN_TGEO_GEO | TGEO_AT_STBOX | TRGEOMETRY_AT_STBOX | TRGEOMETRY_MINUS_STBOX;
...
TRGEOMETRY_AT_STBOX: 'TRGEOMETRY_AT_STBOX' | 'trgeometry_at_stbox';
TRGEOMETRY_MINUS_STBOX: 'TRGEOMETRY_MINUS_STBOX' | 'trgeometry_minus_stbox';
