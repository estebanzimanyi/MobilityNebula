...
functionName:  IDENTIFIER | AVG | MAX | MIN | SUM | COUNT | MEDIAN | ARRAY_AGG | VAR | TEMPORAL_SEQUENCE | TEMPORAL_EINTERSECTS_GEOMETRY | TEMPORAL_AINTERSECTS_GEOMETRY | TEMPORAL_ECONTAINS_GEOMETRY | EDWITHIN_TGEO_GEO | TGEO_AT_STBOX | ALWAYS_EQ_BIGINT_TBIGINT | ALWAYS_EQ_TBIGINT_BIGINT | ALWAYS_GE_BIGINT_TBIGINT | ALWAYS_GE_TBIGINT_BIGINT | ALWAYS_GT_BIGINT_TBIGINT | ALWAYS_GT_TBIGINT_BIGINT | ALWAYS_LE_BIGINT_TBIGINT | ALWAYS_LE_TBIGINT_BIGINT | ALWAYS_LT_BIGINT_TBIGINT | ALWAYS_LT_TBIGINT_BIGINT | ALWAYS_NE_BIGINT_TBIGINT | ALWAYS_NE_TBIGINT_BIGINT | EVER_EQ_BIGINT_TBIGINT | EVER_EQ_TBIGINT_BIGINT | EVER_GE_BIGINT_TBIGINT | EVER_GE_TBIGINT_BIGINT | EVER_GT_BIGINT_TBIGINT | EVER_GT_TBIGINT_BIGINT | EVER_LE_BIGINT_TBIGINT | EVER_LE_TBIGINT_BIGINT | EVER_LT_BIGINT_TBIGINT | EVER_LT_TBIGINT_BIGINT | EVER_NE_BIGINT_TBIGINT | EVER_NE_TBIGINT_BIGINT;
