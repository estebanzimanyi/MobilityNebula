...
functionName:  IDENTIFIER | AVG | MAX | MIN | SUM | COUNT | MEDIAN | ARRAY_AGG | VAR | TEMPORAL_SEQUENCE | TEMPORAL_EINTERSECTS_GEOMETRY | TEMPORAL_AINTERSECTS_GEOMETRY | TEMPORAL_ECONTAINS_GEOMETRY | EDWITHIN_TGEO_GEO | TGEO_AT_STBOX | TPOSE_APPLY_GEO | TRGEOMETRY_AT_GEOM | TRGEOMETRY_BODY_POINT_TRAJECTORY | TRGEOMETRY_MINUS_GEOM;
...
TPOSE_APPLY_GEO: 'TPOSE_APPLY_GEO' | 'tpose_apply_geo';
TRGEOMETRY_AT_GEOM: 'TRGEOMETRY_AT_GEOM' | 'trgeometry_at_geom';
TRGEOMETRY_BODY_POINT_TRAJECTORY: 'TRGEOMETRY_BODY_POINT_TRAJECTORY' | 'trgeometry_body_point_trajectory';
TRGEOMETRY_MINUS_GEOM: 'TRGEOMETRY_MINUS_GEOM' | 'trgeometry_minus_geom';
