...
functionName:  IDENTIFIER | AVG | MAX | MIN | SUM | COUNT | MEDIAN | ARRAY_AGG | VAR | TEMPORAL_SEQUENCE | TEMPORAL_EINTERSECTS_GEOMETRY | TEMPORAL_AINTERSECTS_GEOMETRY | TEMPORAL_ECONTAINS_GEOMETRY | EDWITHIN_TGEO_GEO | TGEO_AT_STBOX | TGEOMPOINT_TO_TNPOINT | TPOSE_ANGULAR_SPEED | TPOSE_PITCH | TPOSE_ROLL | TPOSE_SPEED | TPOSE_YAW | TRGEOMETRY_CENTROID | TRGEOMETRY_CUMULATIVE_LENGTH | TRGEOMETRY_SPEED | TRGEOMETRY_TO_TGEOMETRY | TFLOAT_COS | TFLOAT_SIN | TFLOAT_TAN | TFLOAT_TO_TBIGINT | TINT_TO_TBIGINT;
...
TGEOMPOINT_TO_TNPOINT: 'TGEOMPOINT_TO_TNPOINT' | 'tgeompoint_to_tnpoint';
TPOSE_ANGULAR_SPEED: 'TPOSE_ANGULAR_SPEED' | 'tpose_angular_speed';
TPOSE_PITCH: 'TPOSE_PITCH' | 'tpose_pitch';
TPOSE_ROLL: 'TPOSE_ROLL' | 'tpose_roll';
TPOSE_SPEED: 'TPOSE_SPEED' | 'tpose_speed';
TPOSE_YAW: 'TPOSE_YAW' | 'tpose_yaw';
TRGEOMETRY_CENTROID: 'TRGEOMETRY_CENTROID' | 'trgeometry_centroid';
TRGEOMETRY_CUMULATIVE_LENGTH: 'TRGEOMETRY_CUMULATIVE_LENGTH' | 'trgeometry_cumulative_length';
TRGEOMETRY_SPEED: 'TRGEOMETRY_SPEED' | 'trgeometry_speed';
TRGEOMETRY_TO_TGEOMETRY: 'TRGEOMETRY_TO_TGEOMETRY' | 'trgeometry_to_tgeometry';
