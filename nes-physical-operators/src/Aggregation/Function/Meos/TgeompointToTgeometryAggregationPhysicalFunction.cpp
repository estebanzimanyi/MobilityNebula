...
TgeompointToTgeometryAggregationPhysicalFunction::TgeompointToTgeometryAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TgeompointToTgeometryAggregationPhysicalFunction::lift(
...
void TgeompointToTgeometryAggregationPhysicalFunction::combine(
...
Nautilus::Record TgeompointToTgeometryAggregationPhysicalFunction::lower(
...
void TgeompointToTgeometryAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TgeompointToTgeometryAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TgeompointToTgeometryAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTgeompointToTgeometryAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TGEOMPOINT_TO_TGEOMETRY aggregation cannot be created through the registry. "
