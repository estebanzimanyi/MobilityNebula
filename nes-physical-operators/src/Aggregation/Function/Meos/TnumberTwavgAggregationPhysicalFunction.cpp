...
TnumberTwavgAggregationPhysicalFunction::TnumberTwavgAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberTwavgAggregationPhysicalFunction::lift(
...
void TnumberTwavgAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberTwavgAggregationPhysicalFunction::lower(
...
void TnumberTwavgAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberTwavgAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TnumberTwavgAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberTwavgAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TnumberTwavg aggregation cannot be created through the registry. "
