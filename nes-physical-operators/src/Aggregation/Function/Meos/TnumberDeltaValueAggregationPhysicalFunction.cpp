...
TnumberDeltaValueAggregationPhysicalFunction::TnumberDeltaValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberDeltaValueAggregationPhysicalFunction::lift(
...
void TnumberDeltaValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberDeltaValueAggregationPhysicalFunction::lower(
...
void TnumberDeltaValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberDeltaValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnumberDeltaValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberDeltaValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TNUMBER_DELTA_VALUE aggregation cannot be created through the registry. "
