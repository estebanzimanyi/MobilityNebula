...
TrajectoryWkbAggregationPhysicalFunction::TrajectoryWkbAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TrajectoryWkbAggregationPhysicalFunction::lift(
...
void TrajectoryWkbAggregationPhysicalFunction::combine(
...
Nautilus::Record TrajectoryWkbAggregationPhysicalFunction::lower(
...
void TrajectoryWkbAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TrajectoryWkbAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TrajectoryWkbAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTrajectoryWkbAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TRAJECTORY_WKB aggregation cannot be created through the registry. "
