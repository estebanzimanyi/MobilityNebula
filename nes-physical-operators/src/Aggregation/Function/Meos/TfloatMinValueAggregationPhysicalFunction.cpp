...
static std::mutex meos_temporaltfloatminvalue_mutex;


TfloatMinValueAggregationPhysicalFunction::TfloatMinValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TfloatMinValueAggregationPhysicalFunction::lift(
...
void TfloatMinValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TfloatMinValueAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* seqStr) -> double
        {
            ...
            double value = tfloat_min_value(temp);
...
void TfloatMinValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TfloatMinValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TfloatMinValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTfloatMinValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TfloatMinValue aggregation cannot be created through the registry. "
