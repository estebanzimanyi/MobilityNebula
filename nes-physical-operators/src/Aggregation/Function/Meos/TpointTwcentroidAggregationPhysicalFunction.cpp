...
TpointTwcentroidAggregationPhysicalFunction::TpointTwcentroidAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointTwcentroidAggregationPhysicalFunction::lift(
...
void TpointTwcentroidAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointTwcentroidAggregationPhysicalFunction::lower(
...
void TpointTwcentroidAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointTwcentroidAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TpointTwcentroidAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointTwcentroidAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TpointTwcentroid aggregation cannot be created through the registry. "
