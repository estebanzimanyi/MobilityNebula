...
TgeoStartValueAggregationPhysicalFunction::TgeoStartValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TgeoStartValueAggregationPhysicalFunction::lift(
...
void TgeoStartValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TgeoStartValueAggregationPhysicalFunction::lower(
...
void TgeoStartValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TgeoStartValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TgeoStartValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTgeoStartValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TgeoStartValue aggregation cannot be created through the registry. "
