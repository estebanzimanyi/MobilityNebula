...
static std::mutex meos_temporaltfloatstartvalue_mutex;


TemporalTFloatStartValueAggregationPhysicalFunction::TemporalTFloatStartValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalTFloatStartValueAggregationPhysicalFunction::lift(
...
void TemporalTFloatStartValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTFloatStartValueAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* seqStr) -> double
        {
            ...
            std::lock_guard<std::mutex> lock(meos_temporaltfloatstartvalue_mutex);
            ...
            double value = tfloat_start_value(temp);
...
void TemporalTFloatStartValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTFloatStartValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTFloatStartValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTFloatStartValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTFloatStartValue aggregation cannot be created through the registry. "
