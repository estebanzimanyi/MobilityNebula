...
FloatUnionAggregationPhysicalFunction::FloatUnionAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
{
    throw std::runtime_error("FLOAT_UNION aggregation cannot be created through the registry. "
