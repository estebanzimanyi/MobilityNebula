...
TnumberTrendAggregationPhysicalFunction::TnumberTrendAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberTrendAggregationPhysicalFunction::lift(
...
void TnumberTrendAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberTrendAggregationPhysicalFunction::lower(
...
void TnumberTrendAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberTrendAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnumberTrendAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberTrendAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TnumberTrend aggregation cannot be created through the registry. "
