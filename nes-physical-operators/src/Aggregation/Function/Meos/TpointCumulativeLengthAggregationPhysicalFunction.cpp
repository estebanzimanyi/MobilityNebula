...
TpointCumulativeLengthAggregationPhysicalFunction::TpointCumulativeLengthAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointCumulativeLengthAggregationPhysicalFunction::lift(
...
void TpointCumulativeLengthAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointCumulativeLengthAggregationPhysicalFunction::lower(
...
void TpointCumulativeLengthAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointCumulativeLengthAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TpointCumulativeLengthAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointCumulativeLengthAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TpointCumulativeLength aggregation cannot be created through the registry. "
