...
TpointSpeedAggregationPhysicalFunction::TpointSpeedAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointSpeedAggregationPhysicalFunction::lift(
...
void TpointSpeedAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointSpeedAggregationPhysicalFunction::lower(
...
void TpointSpeedAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointSpeedAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TpointSpeedAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointSpeedAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TpointSpeed aggregation cannot be created through the registry. "
