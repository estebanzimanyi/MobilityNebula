...
TpointAzimuthAggregationPhysicalFunction::TpointAzimuthAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointAzimuthAggregationPhysicalFunction::lift(
...
void TpointAzimuthAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointAzimuthAggregationPhysicalFunction::lower(
...
void TpointAzimuthAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointAzimuthAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TpointAzimuthAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointAzimuthAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TPOINT_AZIMUTH aggregation cannot be created through the registry. "
