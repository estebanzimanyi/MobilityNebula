...
static std::mutex meos_temporaltintmaxvalue_mutex;


TemporalTIntMaxValueAggregationPhysicalFunction::TemporalTIntMaxValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalTIntMaxValueAggregationPhysicalFunction::lift(
...
void TemporalTIntMaxValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTIntMaxValueAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* seqStr) -> int
        {
            ...
            MEOS::Meos::ensureMeosInitialized();
            std::lock_guard<std::mutex> lock(meos_temporaltintmaxvalue_mutex);
...
void TemporalTIntMaxValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTIntMaxValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTIntMaxValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTIntMaxValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTIntMaxValue aggregation cannot be created through the registry. "
