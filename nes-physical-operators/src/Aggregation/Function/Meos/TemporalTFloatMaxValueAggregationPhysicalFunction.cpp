...
static std::mutex meos_temporaltfloatmaxvalue_mutex;


TemporalTFloatMaxValueAggregationPhysicalFunction::TemporalTFloatMaxValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalTFloatMaxValueAggregationPhysicalFunction::lift(
...
void TemporalTFloatMaxValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTFloatMaxValueAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* seqStr) -> double
        {
            ...
            MEOS::Meos::ensureMeosInitialized();
            std::lock_guard<std::mutex> lock(meos_temporaltfloatmaxvalue_mutex);
            ...
            double value = tfloat_max_value(temp);
...
void TemporalTFloatMaxValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTFloatMaxValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTFloatMaxValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTFloatMaxValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTFloatMaxValue aggregation cannot be created through the registry. "
