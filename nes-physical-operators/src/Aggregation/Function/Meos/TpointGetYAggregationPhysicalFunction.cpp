...
TpointGetYAggregationPhysicalFunction::TpointGetYAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointGetYAggregationPhysicalFunction::lift(
...
void TpointGetYAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointGetYAggregationPhysicalFunction::lower(
...
void TpointGetYAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointGetYAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TpointGetYAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointGetYAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TpointGetY aggregation cannot be created through the registry. "
