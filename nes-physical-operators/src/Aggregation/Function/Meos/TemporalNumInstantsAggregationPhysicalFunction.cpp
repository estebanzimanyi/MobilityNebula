...
static std::mutex meos_temporalnuminstants_mutex;


TemporalNumInstantsAggregationPhysicalFunction::TemporalNumInstantsAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalNumInstantsAggregationPhysicalFunction::lift(
...
void TemporalNumInstantsAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalNumInstantsAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* trajStr) -> int
        {
            ...
            int value = temporal_num_instants(static_cast<Temporal*>(temp));
...
void TemporalNumInstantsAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalNumInstantsAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalNumInstantsAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalNumInstantsAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalNumInstants aggregation cannot be created through the registry. "
