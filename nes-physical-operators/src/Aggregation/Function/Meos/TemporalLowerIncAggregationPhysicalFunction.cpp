...
static std::mutex meos_temporallowerinc_mutex;


TemporalLowerIncAggregationPhysicalFunction::TemporalLowerIncAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalLowerIncAggregationPhysicalFunction::lift(
...
void TemporalLowerIncAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalLowerIncAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* trajStr) -> bool
        {
            ...
            std::lock_guard<std::mutex> lock(meos_temporallowerinc_mutex);
            ...
            bool value = temporal_lower_inc(static_cast<Temporal*>(temp));
...
void TemporalLowerIncAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalLowerIncAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalLowerIncAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalLowerIncAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalLowerInc aggregation cannot be created through the registry. "
