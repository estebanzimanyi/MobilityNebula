...
TemporalCopyAggregationPhysicalFunction::TemporalCopyAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalCopyAggregationPhysicalFunction::lift(
...
void TemporalCopyAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalCopyAggregationPhysicalFunction::lower(
...
void TemporalCopyAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalCopyAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TemporalCopyAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalCopyAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TEMPORAL_COPY aggregation cannot be created through the registry. "
