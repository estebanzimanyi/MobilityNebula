...
TemporalAtMaxAggregationPhysicalFunction::TemporalAtMaxAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalAtMaxAggregationPhysicalFunction::lift(
...
void TemporalAtMaxAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalAtMaxAggregationPhysicalFunction::lower(
...
void TemporalAtMaxAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalAtMaxAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TemporalAtMaxAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalAtMaxAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TEMPORAL_AT_MAX aggregation cannot be created through the registry. "
