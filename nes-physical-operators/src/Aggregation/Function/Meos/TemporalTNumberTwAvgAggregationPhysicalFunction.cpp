...
static std::mutex meos_temporaltnumbertwavg_mutex;


TemporalTNumberTwAvgAggregationPhysicalFunction::TemporalTNumberTwAvgAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalTNumberTwAvgAggregationPhysicalFunction::lift(
...
void TemporalTNumberTwAvgAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTNumberTwAvgAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* seqStr) -> double
        {
            ...
            double value = tnumber_twavg(temp);
...
void TemporalTNumberTwAvgAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTNumberTwAvgAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTNumberTwAvgAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTNumberTwAvgAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTNumberTwAvg aggregation cannot be created through the registry. "
