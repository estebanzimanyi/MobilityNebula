...
TintMinValueAggregationPhysicalFunction::TintMinValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TintMinValueAggregationPhysicalFunction::lift(
...
void TintMinValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TintMinValueAggregationPhysicalFunction::lower(
...
void TintMinValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TintMinValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TintMinValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTintMinValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TintMinValue aggregation cannot be created through the registry. "
