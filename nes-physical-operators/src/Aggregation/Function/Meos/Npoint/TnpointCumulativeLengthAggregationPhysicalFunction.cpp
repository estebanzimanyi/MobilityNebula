...
TnpointCumulativeLengthAggregationPhysicalFunction::TnpointCumulativeLengthAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnpointCumulativeLengthAggregationPhysicalFunction::lift(
...
void TnpointCumulativeLengthAggregationPhysicalFunction::combine(
...
Nautilus::Record TnpointCumulativeLengthAggregationPhysicalFunction::lower(
...
void TnpointCumulativeLengthAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnpointCumulativeLengthAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnpointCumulativeLengthAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnpointCumulativeLengthAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TNPOINT_CUMULATIVE_LENGTH aggregation cannot be created through the registry. "
