...
TnpointSpeedAggregationPhysicalFunction::TnpointSpeedAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnpointSpeedAggregationPhysicalFunction::lift(
...
void TnpointSpeedAggregationPhysicalFunction::combine(
...
Nautilus::Record TnpointSpeedAggregationPhysicalFunction::lower(
...
void TnpointSpeedAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnpointSpeedAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnpointSpeedAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnpointSpeedAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TNPOINT_SPEED aggregation cannot be created through the registry. "
