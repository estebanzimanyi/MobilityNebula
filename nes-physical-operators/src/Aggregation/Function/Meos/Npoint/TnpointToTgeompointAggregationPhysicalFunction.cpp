...
TnpointToTgeompointAggregationPhysicalFunction::TnpointToTgeompointAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnpointToTgeompointAggregationPhysicalFunction::lift(
...
void TnpointToTgeompointAggregationPhysicalFunction::combine(
...
Nautilus::Record TnpointToTgeompointAggregationPhysicalFunction::lower(
...
void TnpointToTgeompointAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnpointToTgeompointAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnpointToTgeompointAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnpointToTgeompointAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TNPOINT_TO_TGEOMPOINT aggregation cannot be created through the registry. "
