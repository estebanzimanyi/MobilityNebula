...
TintStartValueAggregationPhysicalFunction::TintStartValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TintStartValueAggregationPhysicalFunction::lift(
...
void TintStartValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TintStartValueAggregationPhysicalFunction::lower(
...
void TintStartValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TintStartValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TintStartValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTintStartValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TintStartValue aggregation cannot be created through the registry. "
