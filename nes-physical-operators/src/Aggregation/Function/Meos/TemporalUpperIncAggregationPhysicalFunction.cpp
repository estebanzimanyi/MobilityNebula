...
static std::mutex meos_temporalupperinc_mutex;


TemporalUpperIncAggregationPhysicalFunction::TemporalUpperIncAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalUpperIncAggregationPhysicalFunction::lift(
...
void TemporalUpperIncAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalUpperIncAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* trajStr) -> bool
        {
            ...
            std::lock_guard<std::mutex> lock(meos_temporalupperinc_mutex);
            ...
            bool value = temporal_upper_inc(static_cast<Temporal*>(temp));
...
void TemporalUpperIncAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalUpperIncAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalUpperIncAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalUpperIncAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalUpperInc aggregation cannot be created through the registry. "
