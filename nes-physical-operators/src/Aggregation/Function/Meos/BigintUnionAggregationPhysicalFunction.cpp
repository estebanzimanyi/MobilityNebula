...
void BigintUnionAggregationPhysicalFunction::lift(
...
void BigintUnionAggregationPhysicalFunction::combine(
...
Nautilus::Record BigintUnionAggregationPhysicalFunction::lower(
...
void BigintUnionAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t BigintUnionAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void BigintUnionAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterBigintUnionAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("BIGINT_UNION aggregation cannot be created through the registry. "
