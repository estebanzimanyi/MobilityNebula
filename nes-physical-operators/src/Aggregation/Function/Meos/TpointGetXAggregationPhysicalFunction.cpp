...
TpointGetXAggregationPhysicalFunction::TpointGetXAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointGetXAggregationPhysicalFunction::lift(
...
void TpointGetXAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointGetXAggregationPhysicalFunction::lower(
...
void TpointGetXAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointGetXAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TpointGetXAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointGetXAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TpointGetX aggregation cannot be created through the registry. "
