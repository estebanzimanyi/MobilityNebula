...
void TemporalTFloatEndValueAggregationPhysicalFunction::lift(
...
void TemporalTFloatEndValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTFloatEndValueAggregationPhysicalFunction::lower(
...
void TemporalTFloatEndValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTFloatEndValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTFloatEndValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTFloatEndValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTFloatEndValue aggregation cannot be created through the registry. "
