...
static std::mutex meos_trajectorywkb_mutex;


TpointTrajectoryAggregationPhysicalFunction::TpointTrajectoryAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointTrajectoryAggregationPhysicalFunction::lift(
...
void TpointTrajectoryAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointTrajectoryAggregationPhysicalFunction::lower(
...
void TpointTrajectoryAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointTrajectoryAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TpointTrajectoryAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointTrajectoryAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TPOINT_TRAJECTORY aggregation cannot be created through the registry. "
