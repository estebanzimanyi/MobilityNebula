...
TgeoEndValueAggregationPhysicalFunction::TgeoEndValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TgeoEndValueAggregationPhysicalFunction::lift(
...
void TgeoEndValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TgeoEndValueAggregationPhysicalFunction::lower(
...
void TgeoEndValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TgeoEndValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TgeoEndValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTgeoEndValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TgeoEndValue aggregation cannot be created through the registry. "
