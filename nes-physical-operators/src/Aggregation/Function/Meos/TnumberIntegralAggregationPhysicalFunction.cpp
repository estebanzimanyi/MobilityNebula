...
TnumberIntegralAggregationPhysicalFunction::TnumberIntegralAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberIntegralAggregationPhysicalFunction::lift(
...
void TnumberIntegralAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberIntegralAggregationPhysicalFunction::lower(
...
void TnumberIntegralAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberIntegralAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TnumberIntegralAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberIntegralAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TnumberIntegral aggregation cannot be created through the registry. "
