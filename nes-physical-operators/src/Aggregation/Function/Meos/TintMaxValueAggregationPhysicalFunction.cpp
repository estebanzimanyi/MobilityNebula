...
TintMaxValueAggregationPhysicalFunction::TintMaxValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TintMaxValueAggregationPhysicalFunction::lift(
...
void TintMaxValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TintMaxValueAggregationPhysicalFunction::lower(
...
void TintMaxValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TintMaxValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TintMaxValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTintMaxValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TintMaxValue aggregation cannot be created through the registry. "
