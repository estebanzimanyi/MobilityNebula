...
void TemporalTIntEndValueAggregationPhysicalFunction::lift(
...
void TemporalTIntEndValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTIntEndValueAggregationPhysicalFunction::lower(
...
void TemporalTIntEndValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTIntEndValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTIntEndValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTIntEndValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTIntEndValue aggregation cannot be created through the registry. "
