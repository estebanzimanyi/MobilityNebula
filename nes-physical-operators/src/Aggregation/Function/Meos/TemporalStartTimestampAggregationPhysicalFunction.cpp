...
TemporalStartTimestampAggregationPhysicalFunction::TemporalStartTimestampAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalStartTimestampAggregationPhysicalFunction::lift(
...
void TemporalStartTimestampAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalStartTimestampAggregationPhysicalFunction::lower(
...
void TemporalStartTimestampAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalStartTimestampAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalStartTimestampAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalStartTimestampAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalStartTimestamp aggregation cannot be created through the registry. "
