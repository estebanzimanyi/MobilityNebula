...
void TemporalEndTimestampAggregationPhysicalFunction::lift(
...
void TemporalEndTimestampAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalEndTimestampAggregationPhysicalFunction::lower(
...
void TemporalEndTimestampAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalEndTimestampAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalEndTimestampAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalEndTimestampAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalEndTimestamp aggregation cannot be created through the registry. "
