...
TfloatStartValueAggregationPhysicalFunction::TfloatStartValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TfloatStartValueAggregationPhysicalFunction::lift(
...
void TfloatStartValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TfloatStartValueAggregationPhysicalFunction::lower(
...
void TfloatStartValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TfloatStartValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TfloatStartValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTfloatStartValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TfloatStartValue aggregation cannot be created through the registry. "
