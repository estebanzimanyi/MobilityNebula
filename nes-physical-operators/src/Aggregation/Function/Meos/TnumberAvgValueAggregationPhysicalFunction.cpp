...
TnumberAvgValueAggregationPhysicalFunction::TnumberAvgValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberAvgValueAggregationPhysicalFunction::lift(
...
void TnumberAvgValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberAvgValueAggregationPhysicalFunction::lower(
...
void TnumberAvgValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberAvgValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TnumberAvgValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberAvgValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TnumberAvgValue aggregation cannot be created through the registry. "
