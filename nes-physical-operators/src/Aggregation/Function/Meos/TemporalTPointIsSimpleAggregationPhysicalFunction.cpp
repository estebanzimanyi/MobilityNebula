...
static std::mutex meos_temporaltpointissimple_mutex;


TemporalTPointIsSimpleAggregationPhysicalFunction::TemporalTPointIsSimpleAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalTPointIsSimpleAggregationPhysicalFunction::lift(
...
void TemporalTPointIsSimpleAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTPointIsSimpleAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    if (numberOfEntries == nautilus::val<size_t>(0)) {
        ...
        resultRecord.write(resultFieldIdentifier, nautilus::val<bool>(0));
        return resultRecord;
    }
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* trajStr) -> bool
        {
            ...
            bool value = tpoint_is_simple(static_cast<Temporal*>(temp));
...
void TemporalTPointIsSimpleAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTPointIsSimpleAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTPointIsSimpleAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTPointIsSimpleAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTPointIsSimple aggregation cannot be created through the registry. "
