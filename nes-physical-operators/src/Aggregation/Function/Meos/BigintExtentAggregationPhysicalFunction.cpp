...
BigintExtentAggregationPhysicalFunction::BigintExtentAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
{
    throw std::runtime_error("BIGINT_EXTENT aggregation cannot be created through the registry. "
