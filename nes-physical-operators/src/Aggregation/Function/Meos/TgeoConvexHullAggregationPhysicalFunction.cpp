...
TgeoConvexHullAggregationPhysicalFunction::TgeoConvexHullAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TgeoConvexHullAggregationPhysicalFunction::lift(
...
void TgeoConvexHullAggregationPhysicalFunction::combine(
...
Nautilus::Record TgeoConvexHullAggregationPhysicalFunction::lower(
...
void TgeoConvexHullAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TgeoConvexHullAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TgeoConvexHullAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTgeoConvexHullAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TgeoConvexHull aggregation cannot be created through the registry. "
