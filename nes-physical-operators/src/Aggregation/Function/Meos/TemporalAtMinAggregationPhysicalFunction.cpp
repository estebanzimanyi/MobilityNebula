...
TemporalAtMinAggregationPhysicalFunction::TemporalAtMinAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalAtMinAggregationPhysicalFunction::lift(
...
void TemporalAtMinAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalAtMinAggregationPhysicalFunction::lower(
...
void TemporalAtMinAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalAtMinAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TemporalAtMinAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalAtMinAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TEMPORAL_AT_MIN aggregation cannot be created through the registry. "
