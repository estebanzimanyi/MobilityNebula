...
TspatialExtentTransfnAggregationPhysicalFunction::TspatialExtentTransfnAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TspatialExtentTransfnAggregationPhysicalFunction::lift(
...
void TspatialExtentTransfnAggregationPhysicalFunction::combine(
...
Nautilus::Record TspatialExtentTransfnAggregationPhysicalFunction::lower(
...
void TspatialExtentTransfnAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TspatialExtentTransfnAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(STBox*);
}

void TspatialExtentTransfnAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTspatialExtentTransfnAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TSPATIAL_EXTENT_TRANSFN aggregation cannot be created through the registry. "
