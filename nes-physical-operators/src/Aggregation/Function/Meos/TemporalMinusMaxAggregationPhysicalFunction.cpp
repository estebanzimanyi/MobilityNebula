...
TemporalMinusMaxAggregationPhysicalFunction::TemporalMinusMaxAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalMinusMaxAggregationPhysicalFunction::lift(
...
void TemporalMinusMaxAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalMinusMaxAggregationPhysicalFunction::lower(
...
void TemporalMinusMaxAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalMinusMaxAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TemporalMinusMaxAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalMinusMaxAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TEMPORAL_MINUS_MAX aggregation cannot be created through the registry. "
