...
static std::mutex meos_temporaltintminvalue_mutex;


TemporalTIntMinValueAggregationPhysicalFunction::TemporalTIntMinValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalTIntMinValueAggregationPhysicalFunction::lift(
...
void TemporalTIntMinValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTIntMinValueAggregationPhysicalFunction::lower(
...
void TemporalTIntMinValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTIntMinValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTIntMinValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTIntMinValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTIntMinValue aggregation cannot be created through the registry. "
