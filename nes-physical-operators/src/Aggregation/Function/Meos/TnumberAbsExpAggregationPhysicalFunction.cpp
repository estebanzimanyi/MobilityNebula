...
static std::mutex meos_tnumberabsexp_mutex;


TnumberAbsExpAggregationPhysicalFunction::TnumberAbsExpAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberAbsExpAggregationPhysicalFunction::lift(
...
void TnumberAbsExpAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberAbsExpAggregationPhysicalFunction::lower(
...
void TnumberAbsExpAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberAbsExpAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnumberAbsExpAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberAbsExpAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TNUMBER_ABS_EXP aggregation cannot be created through the registry. "
