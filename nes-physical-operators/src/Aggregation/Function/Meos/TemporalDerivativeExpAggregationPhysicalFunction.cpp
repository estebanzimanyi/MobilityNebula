...
void TemporalDerivativeExpAggregationPhysicalFunction::lift(
...
void TemporalDerivativeExpAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalDerivativeExpAggregationPhysicalFunction::lower(
...
void TemporalDerivativeExpAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalDerivativeExpAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TemporalDerivativeExpAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalDerivativeExpAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TEMPORAL_DERIVATIVE_EXP aggregation cannot be created through the registry. "
