...
TpointAngularDifferenceAggregationPhysicalFunction::TpointAngularDifferenceAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointAngularDifferenceAggregationPhysicalFunction::lift(
...
void TpointAngularDifferenceAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointAngularDifferenceAggregationPhysicalFunction::lower(
...
void TpointAngularDifferenceAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointAngularDifferenceAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TpointAngularDifferenceAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointAngularDifferenceAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TPOINT_ANGULAR_DIFFERENCE aggregation cannot be created through the registry. "
