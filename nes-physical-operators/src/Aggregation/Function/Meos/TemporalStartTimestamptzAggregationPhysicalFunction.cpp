...
static std::mutex meos_temporalstarttimestamp_mutex;


TemporalStartTimestamptzAggregationPhysicalFunction::TemporalStartTimestamptzAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalStartTimestamptzAggregationPhysicalFunction::lift(
...
void TemporalStartTimestamptzAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalStartTimestamptzAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* trajStr) -> int64_t
        {
            ...
            int64_t value = temporal_start_timestamptz(static_cast<Temporal*>(temp));
...
void TemporalStartTimestamptzAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalStartTimestamptzAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalStartTimestamptzAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalStartTimestamptzAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalStartTimestamptz aggregation cannot be created through the registry. "
