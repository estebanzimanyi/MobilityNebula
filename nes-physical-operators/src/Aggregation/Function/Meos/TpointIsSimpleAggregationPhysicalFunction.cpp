...
TpointIsSimpleAggregationPhysicalFunction::TpointIsSimpleAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TpointIsSimpleAggregationPhysicalFunction::lift(
...
void TpointIsSimpleAggregationPhysicalFunction::combine(
...
Nautilus::Record TpointIsSimpleAggregationPhysicalFunction::lower(
...
void TpointIsSimpleAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TpointIsSimpleAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TpointIsSimpleAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTpointIsSimpleAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TpointIsSimple aggregation cannot be created through the registry. "
