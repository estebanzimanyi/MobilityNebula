...
static std::mutex meos_temporaltnumberintegral_mutex;


TemporalTNumberIntegralAggregationPhysicalFunction::TemporalTNumberIntegralAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TemporalTNumberIntegralAggregationPhysicalFunction::lift(
...
void TemporalTNumberIntegralAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTNumberIntegralAggregationPhysicalFunction::lower(
    const nautilus::val<AggregationState*> aggregationState, [[maybe_unused]] PipelineMemoryProvider& pipelineMemoryProvider)
{
    ...
    auto resultValue = nautilus::invoke(
        +[](const char* seqStr) -> double
        {
            ...
            MEOS::Meos::ensureMeosInitialized();
            std::lock_guard<std::mutex> lock(meos_temporaltnumberintegral_mutex);
            ...
            double value = tnumber_integral(temp);
...
void TemporalTNumberIntegralAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTNumberIntegralAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTNumberIntegralAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTNumberIntegralAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTNumberIntegral aggregation cannot be created through the registry. "
