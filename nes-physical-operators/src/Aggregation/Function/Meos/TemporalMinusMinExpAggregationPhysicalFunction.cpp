...
void TemporalMinusMinExpAggregationPhysicalFunction::lift(
...
void TemporalMinusMinExpAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalMinusMinExpAggregationPhysicalFunction::lower(
...
void TemporalMinusMinExpAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalMinusMinExpAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TemporalMinusMinExpAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalMinusMinExpAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TEMPORAL_MINUS_MIN_EXP aggregation cannot be created through the registry. "
