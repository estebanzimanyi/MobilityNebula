...
void TemporalTFloatMinValueAggregationPhysicalFunction::lift(
...
void TemporalTFloatMinValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TemporalTFloatMinValueAggregationPhysicalFunction::lower(
...
void TemporalTFloatMinValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TemporalTFloatMinValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TemporalTFloatMinValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTemporalTFloatMinValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TemporalTFloatMinValue aggregation cannot be created through the registry. "
