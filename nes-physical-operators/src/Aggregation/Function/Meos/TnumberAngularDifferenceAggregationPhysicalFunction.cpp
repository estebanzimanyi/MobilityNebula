...
TnumberAngularDifferenceAggregationPhysicalFunction::TnumberAngularDifferenceAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberAngularDifferenceAggregationPhysicalFunction::lift(
...
void TnumberAngularDifferenceAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberAngularDifferenceAggregationPhysicalFunction::lower(
...
void TnumberAngularDifferenceAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberAngularDifferenceAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnumberAngularDifferenceAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberAngularDifferenceAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TNUMBER_ANGULAR_DIFFERENCE aggregation cannot be created through the registry. "
