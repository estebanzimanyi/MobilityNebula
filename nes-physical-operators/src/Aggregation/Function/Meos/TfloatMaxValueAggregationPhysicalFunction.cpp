...
TfloatMaxValueAggregationPhysicalFunction::TfloatMaxValueAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TfloatMaxValueAggregationPhysicalFunction::lift(
...
void TfloatMaxValueAggregationPhysicalFunction::combine(
...
Nautilus::Record TfloatMaxValueAggregationPhysicalFunction::lower(
...
void TfloatMaxValueAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TfloatMaxValueAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Nautilus::Interface::PagedVector);
}

void TfloatMaxValueAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* pagedVectorMemArea) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTfloatMaxValueAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TfloatMaxValue aggregation cannot be created through the registry. "
