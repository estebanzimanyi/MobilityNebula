...
TgeoCentroidAggregationPhysicalFunction::TgeoCentroidAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TgeoCentroidAggregationPhysicalFunction::lift(
...
void TgeoCentroidAggregationPhysicalFunction::combine(
...
Nautilus::Record TgeoCentroidAggregationPhysicalFunction::lower(
...
void TgeoCentroidAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TgeoCentroidAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TgeoCentroidAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTgeoCentroidAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TGEO_CENTROID aggregation cannot be created through the registry. "
