...
TnumberAbsAggregationPhysicalFunction::TnumberAbsAggregationPhysicalFunction(
    DataType inputType,
    DataType resultType,
...
void TnumberAbsAggregationPhysicalFunction::lift(
...
void TnumberAbsAggregationPhysicalFunction::combine(
...
Nautilus::Record TnumberAbsAggregationPhysicalFunction::lower(
...
void TnumberAbsAggregationPhysicalFunction::reset(const nautilus::val<AggregationState*> aggregationState, PipelineMemoryProvider&)
{
    nautilus::invoke(
...
size_t TnumberAbsAggregationPhysicalFunction::getSizeOfStateInBytes() const
{
    return sizeof(Temporal*);
}

void TnumberAbsAggregationPhysicalFunction::cleanup(nautilus::val<AggregationState*> aggregationState)
{
    nautilus::invoke(
        +[](AggregationState* st) -> void
        {
...
AggregationPhysicalFunctionRegistryReturnType AggregationPhysicalFunctionGeneratedRegistrar::RegisterTnumberAbsAggregationPhysicalFunction(
    AggregationPhysicalFunctionRegistryArguments)
{
    throw std::runtime_error("TNUMBER_ABS aggregation cannot be created through the registry. "
