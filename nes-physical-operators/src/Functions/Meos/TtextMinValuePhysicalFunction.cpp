...
#include <Functions/Meos/TtextMinValuePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextMinValuePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtextMinValuePhysicalFunction::TtextMinValuePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TtextMinValuePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtextMinValuePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TtextMinValuePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TtextMinValuePhysicalFunction(std::move(arg0), std::move(arg1));
}
