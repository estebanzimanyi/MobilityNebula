...
#include <Functions/Meos/StboxGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxGtPhysicalFunction::StboxGtPhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
