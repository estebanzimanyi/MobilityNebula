...
#include <Functions/Meos/AlwaysLtTfloatTfloatPhysicalFunction.hpp>
...
AlwaysLtTfloatTfloatPhysicalFunction::AlwaysLtTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal AlwaysLtTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysLtTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AlwaysLtTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AlwaysLtTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
