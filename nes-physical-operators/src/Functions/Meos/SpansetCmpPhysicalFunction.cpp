...
#include <Functions/Meos/SpansetCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetCmpPhysicalFunction::SpansetCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
