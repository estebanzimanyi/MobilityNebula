...
#include <Functions/Meos/MinusSpanDatePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusSpanDatePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusSpanDatePhysicalFunction::MinusSpanDatePhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusSpanDatePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = minus_span_date(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusSpanDatePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusSpanDatePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusSpanDatePhysicalFunction(std::move(arg0), std::move(arg1));
}
