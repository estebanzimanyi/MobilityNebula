...
#include <Functions/Meos/IntTimestamptzToTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterIntTimestamptzToTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

IntTimestamptzToTboxPhysicalFunction::IntTimestamptzToTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal IntTimestamptzToTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                TBox* res = int_timestamptz_to_tbox(temp, arg0V);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterIntTimestamptzToTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "IntTimestamptzToTboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return IntTimestamptzToTboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
