...
#include <Functions/Meos/TemporalToTsequencesetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalToTsequencesetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalToTsequencesetPhysicalFunction::TemporalToTsequencesetPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalToTsequencesetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_to_tsequenceset(temp, (interpType) 2);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalToTsequencesetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TemporalToTsequencesetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TemporalToTsequencesetPhysicalFunction(std::move(arg0), std::move(arg1));
}
