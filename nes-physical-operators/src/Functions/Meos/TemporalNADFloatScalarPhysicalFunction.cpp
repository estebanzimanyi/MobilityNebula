...
#include <Functions/Meos/TemporalNADFloatScalarPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalNADFloatScalarPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalNADFloatScalarPhysicalFunction::TemporalNADFloatScalarPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalNADFloatScalarPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double valueValue,
            ...
            try
            {
                ...
                if (!temp) return 0;
                double r = nad_tfloat_float(temp, scalarValue);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalNADFloatScalarPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalNADFloatScalarPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalNADFloatScalarPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
