...
#include <Functions/Meos/TneBoolTboolPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTneBoolTboolPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TneBoolTboolPhysicalFunction::TneBoolTboolPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TneBoolTboolPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = tne_bool_tbool(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTneBoolTboolPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TneBoolTboolPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TneBoolTboolPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
