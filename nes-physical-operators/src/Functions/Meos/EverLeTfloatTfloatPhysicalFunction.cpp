...
#include <Functions/Meos/EverLeTfloatTfloatPhysicalFunction.hpp>
...
EverLeTfloatTfloatPhysicalFunction::EverLeTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal EverLeTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double v1, double v2, uint64_t t) -> double {
            try {
                ...
                int r = ever_le_tfloat_tfloat(temp1, temp2);
                free(temp1);
                free(temp2);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverLeTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverLeTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverLeTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
