...
#include <Functions/Meos/MinusDateSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusDateSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusDateSpanPhysicalFunction::MinusDateSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusDateSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = minus_date_span(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusDateSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusDateSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusDateSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
