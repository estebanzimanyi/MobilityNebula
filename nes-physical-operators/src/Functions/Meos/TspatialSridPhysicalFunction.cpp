...
#include <Functions/Meos/TspatialSridPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTspatialSridPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TspatialSridPhysicalFunction::TspatialSridPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TspatialSridPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTspatialSridPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TspatialSridPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TspatialSridPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
