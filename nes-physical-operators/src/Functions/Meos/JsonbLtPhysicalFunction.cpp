...
#include <Functions/Meos/JsonbLtPhysicalFunction.hpp>
...
JsonbLtPhysicalFunction::JsonbLtPhysicalFunction(PhysicalFunction jbFunction,
...
VarVal JsonbLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterJsonbLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "JsonbLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return JsonbLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
