...
#include <Functions/Meos/TtextFromBaseTempPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextFromBaseTempPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtextFromBaseTempPhysicalFunction::TtextFromBaseTempPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TtextFromBaseTempPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = ttext_from_base_temp(arg0T, temp);
                free(temp);
                free(arg0T);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtextFromBaseTempPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TtextFromBaseTempPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TtextFromBaseTempPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
