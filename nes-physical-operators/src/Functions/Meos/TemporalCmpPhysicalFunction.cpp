...
#include <Functions/Meos/TemporalCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalCmpPhysicalFunction::TemporalCmpPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return temporal_cmp(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalCmpPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalCmpPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
