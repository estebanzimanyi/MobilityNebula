...
#include <Functions/Meos/OverrightTspatialTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverrightTspatialTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverrightTspatialTspatialPhysicalFunction::OverrightTspatialTspatialPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal OverrightTspatialTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return overright_tspatial_tspatial(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverrightTspatialTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "OverrightTspatialTspatialPhysicalFunction requires 6 children but got {}",
    ...
    return OverrightTspatialTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
