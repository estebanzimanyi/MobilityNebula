...
#include <Functions/Meos/TintValueSplitPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintValueSplitPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintValueSplitPhysicalFunction::TintValueSplitPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TintValueSplitPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg1 = parameterValues[3].cast<nautilus::val<int32_t>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg1) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                int * _aux = nullptr;
                Temporal ** arr = (Temporal **) tint_value_split(temp, arg0, arg1, &_aux, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintValueSplitPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TintValueSplitPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TintValueSplitPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
