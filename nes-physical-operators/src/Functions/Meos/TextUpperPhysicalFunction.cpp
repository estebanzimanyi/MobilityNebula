...
TextUpperPhysicalFunction::TextUpperPhysicalFunction(PhysicalFunction str)
{
    paramFns.reserve(1);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size()==1,
                 "TextUpperPhysicalFunction requires 1 child but got {}",
                 arguments.childFunctions.size());
    return TextUpperPhysicalFunction(std::move(arguments.childFunctions[0]));
}
