...
#include <Functions/Meos/MulIntervalDoublePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMulIntervalDoublePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MulIntervalDoublePhysicalFunction::MulIntervalDoublePhysicalFunction(PhysicalFunction litFunction,
...
VarVal MulIntervalDoublePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Interval* res = mul_interval_double(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMulIntervalDoublePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MulIntervalDoublePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MulIntervalDoublePhysicalFunction(std::move(arg0), std::move(arg1));
}
