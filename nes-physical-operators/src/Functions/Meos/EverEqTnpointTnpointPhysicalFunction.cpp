...
EverEqTnpointTnpointPhysicalFunction::EverEqTnpointTnpointPhysicalFunction(PhysicalFunction ridFunction,
    ...
    const auto result = nautilus::invoke(
        +[](int64_t rid,
            ...
            try
            {
                ...
                double r = ever_eq_tnpoint_tnpoint(temp, inst0);
                free(temp);
                free(inst0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTnpointTnpointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
