...
#include <Functions/Meos/UnionTimestamptzSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionTimestamptzSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionTimestamptzSpanPhysicalFunction::UnionTimestamptzSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionTimestamptzSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_timestamptz_span(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionTimestamptzSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionTimestamptzSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionTimestamptzSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
