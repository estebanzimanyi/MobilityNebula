...
#include <Functions/Meos/OverbackStboxTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbackStboxTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbackStboxTspatialPhysicalFunction::OverbackStboxTspatialPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal OverbackStboxTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = overback_stbox_tspatial(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbackStboxTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "OverbackStboxTspatialPhysicalFunction requires 5 children but got {}",
    ...
    return OverbackStboxTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
