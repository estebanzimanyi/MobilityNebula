...
#include <Functions/Meos/OverleftSpansetSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverleftSpansetSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverleftSpansetSpansetPhysicalFunction::OverleftSpansetSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal OverleftSpansetSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = overleft_spanset_spanset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverleftSpansetSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverleftSpansetSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverleftSpansetSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
