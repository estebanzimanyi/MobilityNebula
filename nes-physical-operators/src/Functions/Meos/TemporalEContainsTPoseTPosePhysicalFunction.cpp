...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEContainsTPoseTPosePhysicalFunction(PhysicalFunctionRegistryArguments); }
