...
AlwaysNeNpointTnpointPhysicalFunction::AlwaysNeNpointTnpointPhysicalFunction(PhysicalFunction rid0Function,
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t rid0,
            ...
            try
            {
                ...
                double r = always_ne_npoint_tnpoint(np0, temp);
                free(temp);
                free(np0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeNpointTnpointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
