...
#include <Functions/Meos/FrontTspatialTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFrontTspatialTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }
