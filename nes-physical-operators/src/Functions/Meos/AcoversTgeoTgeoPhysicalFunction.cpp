...
AcoversTgeoTgeoPhysicalFunction::AcoversTgeoTgeoPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction ts1, PhysicalFunction lon2, PhysicalFunction lat2, PhysicalFunction ts2)
{
    paramFns.reserve(6);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AcoversTgeoTgeoPhysicalFunction(
