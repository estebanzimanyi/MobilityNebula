...
#include <Functions/Meos/GeomIntersects2dPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomIntersects2dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomIntersects2dPhysicalFunction::GeomIntersects2dPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeomIntersects2dPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geom_intersects2d(temp, arg0G.getGeometry());
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeomIntersects2dPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeomIntersects2dPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeomIntersects2dPhysicalFunction(std::move(arg0), std::move(arg1));
}
