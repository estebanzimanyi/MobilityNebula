...
#include <Functions/Meos/TgeoSpaceBoxesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgeoSpaceBoxesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgeoSpaceBoxesPhysicalFunction::TgeoSpaceBoxesPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TgeoSpaceBoxesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg0 = parameterValues[3].cast<nautilus::val<double>>();
    auto arg1 = parameterValues[4].cast<nautilus::val<double>>();
    auto arg2 = parameterValues[5].cast<nautilus::val<double>>();
    auto arg3 = parameterValues[6].cast<VariableSizedData>();
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg3Ptr, uint32_t arg3Size) -> char*
        {
            try
            {
                ...
                MEOS::Meos::StaticGeometry arg3G(arg3S);
                if (!arg3G.getGeometry()) { free(temp); return (char*) nullptr; }

                int _cnt = 0;
                STBox* arr = (STBox*) tgeo_space_boxes(temp, arg0, arg1, arg2, arg3G.getGeometry(), false, true, &_cnt);
                free(temp);
        ...
        lon, lat, ts, arg0, arg1, arg2, arg3.getContent(), arg3.getContentSize());
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTgeoSpaceBoxesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 7,
                 "TgeoSpaceBoxesPhysicalFunction requires 7 children but got {}",
    ...
    return TgeoSpaceBoxesPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
