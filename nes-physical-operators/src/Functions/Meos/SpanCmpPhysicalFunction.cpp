...
#include <Functions/Meos/SpanCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpanCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpanCmpPhysicalFunction::SpanCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpanCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpanCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpanCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpanCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
