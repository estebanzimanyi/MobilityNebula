...
#include <Functions/Meos/GeoSplitNStboxesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeoSplitNStboxesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeoSplitNStboxesPhysicalFunction::GeoSplitNStboxesPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeoSplitNStboxesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                STBox* arr = (STBox*) geo_split_n_stboxes(temp, arg0, &_cnt);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeoSplitNStboxesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeoSplitNStboxesPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeoSplitNStboxesPhysicalFunction(std::move(arg0), std::move(arg1));
}
