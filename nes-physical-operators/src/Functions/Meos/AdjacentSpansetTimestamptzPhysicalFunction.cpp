...
#include <Functions/Meos/AdjacentSpansetTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAdjacentSpansetTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AdjacentSpansetTimestamptzPhysicalFunction::AdjacentSpansetTimestamptzPhysicalFunction(PhysicalFunction litFunction,
...
VarVal AdjacentSpansetTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = adjacent_spanset_timestamptz(temp, arg0V);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdjacentSpansetTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AdjacentSpansetTimestamptzPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AdjacentSpansetTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1));
}
