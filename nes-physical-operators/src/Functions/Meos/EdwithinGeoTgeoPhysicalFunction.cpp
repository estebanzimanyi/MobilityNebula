...
#include <Functions/Meos/EdwithinGeoTgeoPhysicalFunction.hpp>
...
EdwithinGeoTgeoPhysicalFunction::EdwithinGeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EdwithinGeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                return edwithin_geo_tgeo(staticGeometry.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEdwithinGeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EdwithinGeoTgeoPhysicalFunction requires 5 children but got {}",
    ...
    return EdwithinGeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
