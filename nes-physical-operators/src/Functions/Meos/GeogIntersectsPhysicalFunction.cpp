...
#include <Functions/Meos/GeogIntersectsPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeogIntersectsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeogIntersectsPhysicalFunction::GeogIntersectsPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeogIntersectsPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geog_intersects(temp, arg0G.getGeometry(), true);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeogIntersectsPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeogIntersectsPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeogIntersectsPhysicalFunction(std::move(arg0), std::move(arg1));
}
