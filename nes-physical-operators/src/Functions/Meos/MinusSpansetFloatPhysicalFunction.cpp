...
#include <Functions/Meos/MinusSpansetFloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusSpansetFloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusSpansetFloatPhysicalFunction::MinusSpansetFloatPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusSpansetFloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = minus_spanset_float(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusSpansetFloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusSpansetFloatPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusSpansetFloatPhysicalFunction(std::move(arg0), std::move(arg1));
}
