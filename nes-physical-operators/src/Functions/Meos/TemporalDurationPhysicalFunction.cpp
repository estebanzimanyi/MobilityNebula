...
#include <Functions/Meos/TemporalDurationPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalDurationPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalDurationPhysicalFunction::TemporalDurationPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalDurationPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                Interval* res = temporal_duration(temp, true);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalDurationPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TemporalDurationPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TemporalDurationPhysicalFunction(std::move(arg0), std::move(arg1));
}
