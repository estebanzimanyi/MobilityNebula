...
#include <Functions/Meos/TemporalETouchesTCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalETouchesTCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalETouchesTCbufferCbufferPhysicalFunction::TemporalETouchesTCbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalETouchesTCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = etouches_tcbuffer_cbuffer(tcbuffer, cb);
                free(tcbuffer);
                free(cb);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalETouchesTCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalETouchesTCbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalETouchesTCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
