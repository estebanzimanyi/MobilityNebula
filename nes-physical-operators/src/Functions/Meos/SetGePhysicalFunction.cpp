...
#include <Functions/Meos/SetGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSetGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SetGePhysicalFunction::SetGePhysicalFunction(PhysicalFunction litFunction,
...
VarVal SetGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSetGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SetGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SetGePhysicalFunction(std::move(arg0), std::move(arg1));
}
