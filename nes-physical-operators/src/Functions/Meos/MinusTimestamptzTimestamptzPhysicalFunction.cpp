...
#include <Functions/Meos/MinusTimestamptzTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusTimestamptzTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusTimestamptzTimestamptzPhysicalFunction::MinusTimestamptzTimestamptzPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal MinusTimestamptzTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                Interval* res = (Interval*) minus_timestamptz_timestamptz(temp, arg0);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusTimestamptzTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusTimestamptzTimestamptzPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusTimestamptzTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1));
}
