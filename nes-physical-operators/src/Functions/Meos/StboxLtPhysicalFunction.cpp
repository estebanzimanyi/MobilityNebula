...
#include <Functions/Meos/StboxLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxLtPhysicalFunction::StboxLtPhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
