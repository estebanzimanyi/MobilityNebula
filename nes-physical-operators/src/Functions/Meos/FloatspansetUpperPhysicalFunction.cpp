...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatspansetUpperPhysicalFunction(PhysicalFunctionRegistryArguments); }
