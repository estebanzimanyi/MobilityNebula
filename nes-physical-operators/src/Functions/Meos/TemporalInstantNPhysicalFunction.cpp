...
#include <Functions/Meos/TemporalInstantNPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalInstantNPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalInstantNPhysicalFunction::TemporalInstantNPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalInstantNPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_instant_n(temp, 1);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalInstantNPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalInstantNPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalInstantNPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
