...
#include <Functions/Meos/BigintspanMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBigintspanMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BigintspanMakePhysicalFunction::BigintspanMakePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal BigintspanMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg2) -> char*
        {
            try
            {
                ...
                Span* res = (Span*) bigintspan_make(temp, arg0, arg1, arg2);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBigintspanMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "BigintspanMakePhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return BigintspanMakePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
