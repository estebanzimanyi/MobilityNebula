...
#include <Functions/Meos/StboxCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxCmpPhysicalFunction::StboxCmpPhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
