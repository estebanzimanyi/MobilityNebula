...
#include <Functions/Meos/DistanceIntsetIntsetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceIntsetIntsetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceIntsetIntsetPhysicalFunction::DistanceIntsetIntsetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceIntsetIntsetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = distance_intset_intset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceIntsetIntsetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceIntsetIntsetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceIntsetIntsetPhysicalFunction(std::move(arg0), std::move(arg1));
}
