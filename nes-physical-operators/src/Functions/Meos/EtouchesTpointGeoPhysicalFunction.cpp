...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEtouchesTpointGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EtouchesTpointGeoPhysicalFunction::EtouchesTpointGeoPhysicalFunction(PhysicalFunction lonFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                return etouches_tpoint_geo(temporalGeometry.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEtouchesTpointGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "EtouchesTpointGeoPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return EtouchesTpointGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
