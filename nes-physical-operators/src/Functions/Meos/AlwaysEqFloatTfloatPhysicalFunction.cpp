...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysEqFloatTfloatPhysicalFunction(PhysicalFunctionRegistryArguments); }
