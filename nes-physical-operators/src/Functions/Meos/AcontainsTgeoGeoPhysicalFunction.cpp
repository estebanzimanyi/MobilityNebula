...
AcontainsTgeoGeoPhysicalFunction::AcontainsTgeoGeoPhysicalFunction(PhysicalFunction lon, PhysicalFunction lat,
    ...
    const auto result = nautilus::invoke(
        +[](double lon, double lat, uint64_t ts,
            ...
            try {
                ...
                int r = acontains_tgeo_geo(tgeo, gs);
                free(tgeo); free(gs);
                return r > 0 ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AcontainsTgeoGeoPhysicalFunction(std::move(arguments.childFunctions[0]),
