...
#include <Functions/Meos/JsonbGtPhysicalFunction.hpp>
...
JsonbGtPhysicalFunction::JsonbGtPhysicalFunction(PhysicalFunction jbFunction,
...
VarVal JsonbGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterJsonbGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "JsonbGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return JsonbGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
