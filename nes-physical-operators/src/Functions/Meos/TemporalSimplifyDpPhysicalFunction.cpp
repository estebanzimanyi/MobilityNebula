...
#include <Functions/Meos/TemporalSimplifyDpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalSimplifyDpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalSimplifyDpPhysicalFunction::TemporalSimplifyDpPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalSimplifyDpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg1) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_simplify_dp(temp, arg0, arg1);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalSimplifyDpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TemporalSimplifyDpPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TemporalSimplifyDpPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
