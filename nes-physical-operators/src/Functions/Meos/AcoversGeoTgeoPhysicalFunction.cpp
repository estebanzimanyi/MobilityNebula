...
AcoversGeoTgeoPhysicalFunction::AcoversGeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                return acovers_geo_tgeo(staticGeometry.getGeometry(),
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AcoversGeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
