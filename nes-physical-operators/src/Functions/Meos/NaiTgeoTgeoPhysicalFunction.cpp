...
#include <Functions/Meos/NaiTgeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNaiTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NaiTgeoTgeoPhysicalFunction::NaiTgeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal NaiTgeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) nai_tgeo_tgeo(temp, arg0t);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNaiTgeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "NaiTgeoTgeoPhysicalFunction requires 6 children but got {}",
    ...
    return NaiTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
