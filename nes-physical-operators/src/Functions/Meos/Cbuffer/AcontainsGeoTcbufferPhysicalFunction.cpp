...
#include <Functions/Meos/Cbuffer/AcontainsGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAcontainsGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AcontainsGeoTcbufferPhysicalFunction::AcontainsGeoTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AcontainsGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = acontains_geo_tcbuffer(arg0G.getGeometry(), temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAcontainsGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AcontainsGeoTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AcontainsGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
