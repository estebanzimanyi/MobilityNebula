...
#include <Functions/Meos/Cbuffer/TcbufferAtGeomPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferAtGeomPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferAtGeomPhysicalFunction::TcbufferAtGeomPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferAtGeomPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tcbuffer_at_geom(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferAtGeomPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferAtGeomPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferAtGeomPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
