...
#include <Functions/Meos/Cbuffer/AcontainsTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAcontainsTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AcontainsTcbufferCbufferPhysicalFunction::AcontainsTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AcontainsTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAcontainsTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AcontainsTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AcontainsTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
