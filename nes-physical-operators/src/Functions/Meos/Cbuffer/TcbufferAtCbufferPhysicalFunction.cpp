...
#include <Functions/Meos/Cbuffer/TcbufferAtCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferAtCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferAtCbufferPhysicalFunction::TcbufferAtCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferAtCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tcbuffer_at_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferAtCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferAtCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferAtCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
