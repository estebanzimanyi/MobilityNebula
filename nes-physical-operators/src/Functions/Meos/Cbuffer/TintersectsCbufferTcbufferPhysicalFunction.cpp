...
#include <Functions/Meos/Cbuffer/TintersectsCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintersectsCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintersectsCbufferTcbufferPhysicalFunction::TintersectsCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TintersectsCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tintersects_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintersectsCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TintersectsCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TintersectsCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
