...
#include <Functions/Meos/Cbuffer/TdisjointCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdisjointCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdisjointCbufferTcbufferPhysicalFunction::TdisjointCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdisjointCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tdisjoint_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdisjointCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdisjointCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TdisjointCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
