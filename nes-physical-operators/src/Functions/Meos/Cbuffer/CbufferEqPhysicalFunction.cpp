...
#include <Functions/Meos/Cbuffer/CbufferEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferEqPhysicalFunction::CbufferEqPhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
