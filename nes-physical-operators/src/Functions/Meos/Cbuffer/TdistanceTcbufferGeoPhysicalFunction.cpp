...
#include <Functions/Meos/Cbuffer/TdistanceTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTcbufferGeoPhysicalFunction::TdistanceTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdistanceTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tdistance_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdistanceTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TdistanceTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
