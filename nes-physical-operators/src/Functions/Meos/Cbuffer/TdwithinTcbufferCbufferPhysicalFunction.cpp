...
#include <Functions/Meos/Cbuffer/TdwithinTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdwithinTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdwithinTcbufferCbufferPhysicalFunction::TdwithinTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdwithinTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tdwithin_tcbuffer_cbuffer(temp, arg0B, arg1);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdwithinTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TdwithinTcbufferCbufferPhysicalFunction requires 6 children but got {}",
    ...
    return TdwithinTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
