...
#include <Functions/Meos/Cbuffer/TdisjointGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdisjointGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdisjointGeoTcbufferPhysicalFunction::TdisjointGeoTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdisjointGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tdisjoint_geo_tcbuffer(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdisjointGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdisjointGeoTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TdisjointGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
