...
#include <Functions/Meos/Cbuffer/DistanceCbufferStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceCbufferStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceCbufferStboxPhysicalFunction::DistanceCbufferStboxPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceCbufferStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_cbuffer_stbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceCbufferStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceCbufferStboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceCbufferStboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
