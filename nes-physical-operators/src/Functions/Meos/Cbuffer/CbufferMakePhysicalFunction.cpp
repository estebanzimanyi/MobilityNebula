...
#include <Functions/Meos/Cbuffer/CbufferMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferMakePhysicalFunction::CbufferMakePhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Cbuffer* res = (Cbuffer*) cbuffer_make(temp, arg0);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferMakePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferMakePhysicalFunction(std::move(arg0), std::move(arg1));
}
