...
#include <Functions/Meos/Cbuffer/AcoversGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAcoversGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AcoversGeoTcbufferPhysicalFunction::AcoversGeoTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AcoversGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = acovers_geo_tcbuffer(arg0G.getGeometry(), temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAcoversGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AcoversGeoTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AcoversGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
