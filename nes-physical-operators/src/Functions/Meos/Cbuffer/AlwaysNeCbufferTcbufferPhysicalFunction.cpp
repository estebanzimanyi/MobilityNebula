...
#include <Functions/Meos/Cbuffer/AlwaysNeCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysNeCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysNeCbufferTcbufferPhysicalFunction::AlwaysNeCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AlwaysNeCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = always_ne_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysNeCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AlwaysNeCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AlwaysNeCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
