...
#include <Functions/Meos/Cbuffer/ShortestlineTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterShortestlineTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ShortestlineTcbufferGeoPhysicalFunction::ShortestlineTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal ShortestlineTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) shortestline_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterShortestlineTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "ShortestlineTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return ShortestlineTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
