...
#include <Functions/Meos/Cbuffer/AtouchesTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAtouchesTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AtouchesTcbufferCbufferPhysicalFunction::AtouchesTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AtouchesTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAtouchesTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AtouchesTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AtouchesTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
