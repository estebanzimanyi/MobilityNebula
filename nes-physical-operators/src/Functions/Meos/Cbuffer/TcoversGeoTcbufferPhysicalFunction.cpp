...
#include <Functions/Meos/Cbuffer/TcoversGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcoversGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcoversGeoTcbufferPhysicalFunction::TcoversGeoTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcoversGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tcovers_geo_tcbuffer(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcoversGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcoversGeoTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TcoversGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
