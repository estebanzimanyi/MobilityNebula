...
#include <Functions/Meos/Cbuffer/AcoversTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAcoversTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAcoversTcbufferGeoPhysicalFunction(
