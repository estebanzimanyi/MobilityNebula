...
#include <Functions/Meos/Cbuffer/EcontainsTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEcontainsTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EcontainsTcbufferGeoPhysicalFunction::EcontainsTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EcontainsTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
