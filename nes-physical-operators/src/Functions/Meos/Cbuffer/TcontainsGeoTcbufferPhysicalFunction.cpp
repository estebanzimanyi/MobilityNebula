...
#include <Functions/Meos/Cbuffer/TcontainsGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcontainsGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcontainsGeoTcbufferPhysicalFunction::TcontainsGeoTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcontainsGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tcontains_geo_tcbuffer(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcontainsGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcontainsGeoTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TcontainsGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
