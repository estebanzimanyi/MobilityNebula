...
#include <Functions/Meos/Cbuffer/EverNeCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverNeCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverNeCbufferTcbufferPhysicalFunction::EverNeCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EverNeCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = ever_ne_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverNeCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EverNeCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return EverNeCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
