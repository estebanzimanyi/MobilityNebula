...
#include <Functions/Meos/Cbuffer/TdisjointTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdisjointTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdisjointTcbufferCbufferPhysicalFunction::TdisjointTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdisjointTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tdisjoint_tcbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdisjointTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdisjointTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TdisjointTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
