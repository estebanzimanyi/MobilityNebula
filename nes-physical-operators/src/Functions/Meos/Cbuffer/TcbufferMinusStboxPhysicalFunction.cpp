...
#include <Functions/Meos/Cbuffer/TcbufferMinusStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferMinusStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferMinusStboxPhysicalFunction::TcbufferMinusStboxPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferMinusStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tcbuffer_minus_stbox(temp, arg0B, true);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferMinusStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferMinusStboxPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferMinusStboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
