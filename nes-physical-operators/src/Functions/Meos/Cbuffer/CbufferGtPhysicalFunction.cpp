...
#include <Functions/Meos/Cbuffer/CbufferGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferGtPhysicalFunction::CbufferGtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
