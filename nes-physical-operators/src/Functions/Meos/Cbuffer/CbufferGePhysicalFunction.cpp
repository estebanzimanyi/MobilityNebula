...
#include <Functions/Meos/Cbuffer/CbufferGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferGePhysicalFunction::CbufferGePhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferGePhysicalFunction(std::move(arg0), std::move(arg1));
}
