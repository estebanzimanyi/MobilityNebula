...
#include <Functions/Meos/Cbuffer/TintersectsGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintersectsGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintersectsGeoTcbufferPhysicalFunction::TintersectsGeoTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TintersectsGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tintersects_geo_tcbuffer(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintersectsGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TintersectsGeoTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TintersectsGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
