...
#include <Functions/Meos/Cbuffer/TcbufferMinusGeomPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferMinusGeomPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferMinusGeomPhysicalFunction::TcbufferMinusGeomPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferMinusGeomPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tcbuffer_minus_geom(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferMinusGeomPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferMinusGeomPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferMinusGeomPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
