...
#include <Functions/Meos/Cbuffer/EverEqCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverEqCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverEqCbufferTcbufferPhysicalFunction::EverEqCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EverEqCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = ever_eq_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverEqCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EverEqCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return EverEqCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
