...
#include <Functions/Meos/Cbuffer/NaiTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNaiTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NaiTcbufferGeoPhysicalFunction::NaiTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal NaiTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) nai_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNaiTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "NaiTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return NaiTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
