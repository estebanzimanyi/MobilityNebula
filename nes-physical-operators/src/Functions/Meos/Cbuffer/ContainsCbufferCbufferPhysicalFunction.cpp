...
#include <Functions/Meos/Cbuffer/ContainsCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsCbufferCbufferPhysicalFunction::ContainsCbufferCbufferPhysicalFunction(PhysicalFunction litFunction,
...
VarVal ContainsCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contains_cbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainsCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "ContainsCbufferCbufferPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return ContainsCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1));
}
