...
#include <Functions/Meos/Cbuffer/MinusCbufferSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusCbufferSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusCbufferSetPhysicalFunction::MinusCbufferSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusCbufferSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Set* res = minus_cbuffer_set(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusCbufferSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusCbufferSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusCbufferSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
