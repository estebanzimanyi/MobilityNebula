...
#include <Functions/Meos/Cbuffer/TcbufferTraversedAreaPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferTraversedAreaPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferTraversedAreaPhysicalFunction::TcbufferTraversedAreaPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferTraversedAreaPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg0 = parameterValues[4].cast<nautilus::val<bool>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) tcbuffer_traversed_area(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferTraversedAreaPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferTraversedAreaPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferTraversedAreaPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
