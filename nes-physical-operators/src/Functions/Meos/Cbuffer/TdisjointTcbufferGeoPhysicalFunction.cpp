...
#include <Functions/Meos/Cbuffer/TdisjointTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdisjointTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdisjointTcbufferGeoPhysicalFunction::TdisjointTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdisjointTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tdisjoint_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdisjointTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdisjointTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TdisjointTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
