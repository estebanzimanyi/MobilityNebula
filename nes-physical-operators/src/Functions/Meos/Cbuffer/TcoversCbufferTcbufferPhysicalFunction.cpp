...
#include <Functions/Meos/Cbuffer/TcoversCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcoversCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcoversCbufferTcbufferPhysicalFunction::TcoversCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcoversCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tcovers_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcoversCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcoversCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TcoversCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
