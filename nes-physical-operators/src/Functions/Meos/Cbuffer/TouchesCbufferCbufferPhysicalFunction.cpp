...
#include <Functions/Meos/Cbuffer/TouchesCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTouchesCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TouchesCbufferCbufferPhysicalFunction::TouchesCbufferCbufferPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TouchesCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = touches_cbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTouchesCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TouchesCbufferCbufferPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TouchesCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1));
}
