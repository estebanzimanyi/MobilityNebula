...
#include <Functions/Meos/Cbuffer/EcontainsCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEcontainsCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EcontainsCbufferTcbufferPhysicalFunction::EcontainsCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EcontainsCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = econtains_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEcontainsCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EcontainsCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return EcontainsCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
