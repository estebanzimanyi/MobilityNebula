...
#include <Functions/Meos/Cbuffer/ShortestlineTcbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterShortestlineTcbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ShortestlineTcbufferTcbufferPhysicalFunction::ShortestlineTcbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal ShortestlineTcbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) shortestline_tcbuffer_tcbuffer(temp, arg0t);
                free(temp);
                free(arg0t);
        ...
        lon, lat, radius, ts, lon2, lat2, radius2, ts2);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterShortestlineTcbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "ShortestlineTcbufferTcbufferPhysicalFunction requires 8 children but got {}",
    ...
    return ShortestlineTcbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
