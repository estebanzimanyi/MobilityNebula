...
#include <Functions/Meos/Cbuffer/AdwithinTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAdwithinTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AdwithinTcbufferCbufferPhysicalFunction::AdwithinTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AdwithinTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdwithinTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "AdwithinTcbufferCbufferPhysicalFunction requires 6 children but got {}",
    ...
    return AdwithinTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
