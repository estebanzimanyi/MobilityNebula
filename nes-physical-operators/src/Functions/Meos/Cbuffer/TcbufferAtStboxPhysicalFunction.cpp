...
#include <Functions/Meos/Cbuffer/TcbufferAtStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferAtStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferAtStboxPhysicalFunction::TcbufferAtStboxPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferAtStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tcbuffer_at_stbox(temp, arg0B, true);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferAtStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferAtStboxPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferAtStboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
