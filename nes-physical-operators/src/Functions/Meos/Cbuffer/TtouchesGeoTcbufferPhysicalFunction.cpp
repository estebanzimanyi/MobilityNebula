...
#include <Functions/Meos/Cbuffer/TtouchesGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtouchesGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtouchesGeoTcbufferPhysicalFunction::TtouchesGeoTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TtouchesGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = ttouches_geo_tcbuffer(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtouchesGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TtouchesGeoTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TtouchesGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
