...
#include <Functions/Meos/Cbuffer/CbufferCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferCmpPhysicalFunction::CbufferCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
