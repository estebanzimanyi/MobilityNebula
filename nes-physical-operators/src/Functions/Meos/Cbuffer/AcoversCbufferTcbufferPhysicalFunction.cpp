...
#include <Functions/Meos/Cbuffer/AcoversCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAcoversCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AcoversCbufferTcbufferPhysicalFunction::AcoversCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AcoversCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = acovers_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAcoversCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AcoversCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AcoversCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
