...
#include <Functions/Meos/Cbuffer/CbufferTimestamptzToStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferTimestamptzToStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferTimestamptzToStboxPhysicalFunction::CbufferTimestamptzToStboxPhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferTimestamptzToStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                STBox* res = (STBox*) cbuffer_timestamptz_to_stbox(temp, arg0V);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferTimestamptzToStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferTimestamptzToStboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferTimestamptzToStboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
