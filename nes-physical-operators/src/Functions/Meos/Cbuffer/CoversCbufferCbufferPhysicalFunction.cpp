...
#include <Functions/Meos/Cbuffer/CoversCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCoversCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CoversCbufferCbufferPhysicalFunction::CoversCbufferCbufferPhysicalFunction(PhysicalFunction litFunction,
...
VarVal CoversCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = covers_cbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCoversCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CoversCbufferCbufferPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CoversCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1));
}
