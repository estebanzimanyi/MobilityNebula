...
#include <Functions/Meos/Cbuffer/EdwithinTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEdwithinTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EdwithinTcbufferCbufferPhysicalFunction::EdwithinTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EdwithinTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEdwithinTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "EdwithinTcbufferCbufferPhysicalFunction requires 6 children but got {}",
    ...
    return EdwithinTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
