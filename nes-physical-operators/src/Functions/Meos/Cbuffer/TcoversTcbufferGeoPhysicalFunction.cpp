...
#include <Functions/Meos/Cbuffer/TcoversTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcoversTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcoversTcbufferGeoPhysicalFunction::TcoversTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcoversTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tcovers_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcoversTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcoversTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TcoversTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
