...
#include <Functions/Meos/Cbuffer/EcoversTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEcoversTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EcoversTcbufferCbufferPhysicalFunction::EcoversTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EcoversTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEcoversTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EcoversTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return EcoversTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
