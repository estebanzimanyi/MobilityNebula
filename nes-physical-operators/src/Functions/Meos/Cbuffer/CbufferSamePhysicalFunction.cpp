...
#include <Functions/Meos/Cbuffer/CbufferSamePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferSamePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferSamePhysicalFunction::CbufferSamePhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferSamePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferSamePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferSamePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferSamePhysicalFunction(std::move(arg0), std::move(arg1));
}
