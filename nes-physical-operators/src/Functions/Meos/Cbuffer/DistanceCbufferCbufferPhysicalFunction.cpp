...
#include <Functions/Meos/Cbuffer/DistanceCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceCbufferCbufferPhysicalFunction::DistanceCbufferCbufferPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_cbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceCbufferCbufferPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1));
}
