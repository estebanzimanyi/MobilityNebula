...
#include <Functions/Meos/Cbuffer/TcontainsTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcontainsTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcontainsTcbufferGeoPhysicalFunction::TcontainsTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcontainsTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tcontains_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcontainsTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcontainsTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TcontainsTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
