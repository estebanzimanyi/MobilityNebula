...
#include <Functions/Meos/Cbuffer/TtouchesTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtouchesTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtouchesTcbufferGeoPhysicalFunction::TtouchesTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TtouchesTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = ttouches_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtouchesTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TtouchesTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TtouchesTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
