...
#include <Functions/Meos/Cbuffer/AlwaysEqCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysEqCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysEqCbufferTcbufferPhysicalFunction::AlwaysEqCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AlwaysEqCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = always_eq_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysEqCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AlwaysEqCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AlwaysEqCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
