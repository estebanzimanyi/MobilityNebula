...
#include <Functions/Meos/Cbuffer/TintersectsTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintersectsTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintersectsTcbufferGeoPhysicalFunction::TintersectsTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TintersectsTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tintersects_tcbuffer_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintersectsTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TintersectsTcbufferGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TintersectsTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
