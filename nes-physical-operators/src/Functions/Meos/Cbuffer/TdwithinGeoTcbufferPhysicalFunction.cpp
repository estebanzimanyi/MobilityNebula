...
#include <Functions/Meos/Cbuffer/TdwithinGeoTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdwithinGeoTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdwithinGeoTcbufferPhysicalFunction::TdwithinGeoTcbufferPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TdwithinGeoTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                if (!arg0T) { return (char*) nullptr; }

                Temporal* res = (Temporal*) tdwithin_geo_tcbuffer(temp, arg0T, arg1);
                free(arg0T);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdwithinGeoTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TdwithinGeoTcbufferPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TdwithinGeoTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
