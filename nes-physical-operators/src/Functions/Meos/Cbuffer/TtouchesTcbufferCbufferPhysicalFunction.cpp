...
#include <Functions/Meos/Cbuffer/TtouchesTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtouchesTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtouchesTcbufferCbufferPhysicalFunction::TtouchesTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TtouchesTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = ttouches_tcbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtouchesTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TtouchesTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TtouchesTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
