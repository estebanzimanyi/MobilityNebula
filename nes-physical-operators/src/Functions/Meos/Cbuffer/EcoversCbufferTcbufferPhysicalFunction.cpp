...
#include <Functions/Meos/Cbuffer/EcoversCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEcoversCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EcoversCbufferTcbufferPhysicalFunction::EcoversCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EcoversCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = ecovers_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEcoversCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EcoversCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return EcoversCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
