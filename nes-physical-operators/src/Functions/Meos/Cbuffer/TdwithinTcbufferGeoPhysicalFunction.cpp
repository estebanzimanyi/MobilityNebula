...
#include <Functions/Meos/Cbuffer/TdwithinTcbufferGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdwithinTcbufferGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdwithinTcbufferGeoPhysicalFunction::TdwithinTcbufferGeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdwithinTcbufferGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                if (!arg0G.getGeometry()) { free(temp); return (char*) nullptr; }

                Temporal* res = (Temporal*) tdwithin_tcbuffer_geo(temp, arg0G.getGeometry(), arg1);
                free(temp);
        ...
        lon, lat, radius, ts, arg0.getContent(), arg0.getContentSize(), arg1);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdwithinTcbufferGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TdwithinTcbufferGeoPhysicalFunction requires 6 children but got {}",
    ...
    return TdwithinTcbufferGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
