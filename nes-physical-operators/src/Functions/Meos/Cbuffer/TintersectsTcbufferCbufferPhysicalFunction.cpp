...
#include <Functions/Meos/Cbuffer/TintersectsTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintersectsTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintersectsTcbufferCbufferPhysicalFunction::TintersectsTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TintersectsTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tintersects_tcbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintersectsTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TintersectsTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TintersectsTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
