...
#include <Functions/Meos/Cbuffer/CbufferNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferNePhysicalFunction::CbufferNePhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferNePhysicalFunction(std::move(arg0), std::move(arg1));
}
