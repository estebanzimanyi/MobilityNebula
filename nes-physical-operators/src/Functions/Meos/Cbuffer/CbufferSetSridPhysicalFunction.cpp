...
#include <Functions/Meos/Cbuffer/CbufferSetSridPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferSetSridPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferSetSridPhysicalFunction::CbufferSetSridPhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferSetSridPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                cbuffer_set_srid(temp, arg0);
                char* outStr = cbuffer_out(temp, 15);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferSetSridPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferSetSridPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferSetSridPhysicalFunction(std::move(arg0), std::move(arg1));
}
