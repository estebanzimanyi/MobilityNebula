...
#include <Functions/Meos/Cbuffer/ContainedCbufferSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedCbufferSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedCbufferSetPhysicalFunction::ContainedCbufferSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal ContainedCbufferSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contained_cbuffer_set(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainedCbufferSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "ContainedCbufferSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return ContainedCbufferSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
