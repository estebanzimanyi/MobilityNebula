...
#include <Functions/Meos/Cbuffer/EverEqTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverEqTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverEqTcbufferCbufferPhysicalFunction::EverEqTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = ever_eq_tcbuffer_cbuffer(tcbuffer, cb);
                free(tcbuffer);
                free(cb);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EverEqTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return EverEqTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
