...
#include <Functions/Meos/Cbuffer/TtouchesCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtouchesCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtouchesCbufferTcbufferPhysicalFunction::TtouchesCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TtouchesCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = ttouches_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtouchesCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TtouchesCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TtouchesCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
