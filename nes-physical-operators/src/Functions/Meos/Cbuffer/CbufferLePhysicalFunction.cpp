...
#include <Functions/Meos/Cbuffer/CbufferLePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferLePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferLePhysicalFunction::CbufferLePhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferLePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferLePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferLePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferLePhysicalFunction(std::move(arg0), std::move(arg1));
}
