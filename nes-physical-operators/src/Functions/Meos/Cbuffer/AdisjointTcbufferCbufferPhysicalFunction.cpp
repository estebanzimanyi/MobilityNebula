...
#include <Functions/Meos/Cbuffer/AdisjointTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAdisjointTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AdisjointTcbufferCbufferPhysicalFunction::AdisjointTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AdisjointTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdisjointTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AdisjointTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AdisjointTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
