...
#include <Functions/Meos/Cbuffer/TcbufferExpandPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferExpandPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferExpandPhysicalFunction::TcbufferExpandPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferExpandPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tcbuffer_expand(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferExpandPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferExpandPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferExpandPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
