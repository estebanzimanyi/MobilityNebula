...
#include <Functions/Meos/Cbuffer/AcontainsCbufferTcbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAcontainsCbufferTcbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AcontainsCbufferTcbufferPhysicalFunction::AcontainsCbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AcontainsCbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = acontains_cbuffer_tcbuffer(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAcontainsCbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AcontainsCbufferTcbufferPhysicalFunction requires 5 children but got {}",
    ...
    return AcontainsCbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
