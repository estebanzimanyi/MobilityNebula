...
#include <Functions/Meos/Cbuffer/CbufferLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterCbufferLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

CbufferLtPhysicalFunction::CbufferLtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal CbufferLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterCbufferLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "CbufferLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return CbufferLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
