...
#include <Functions/Meos/Cbuffer/DisjointCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDisjointCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DisjointCbufferCbufferPhysicalFunction::DisjointCbufferCbufferPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DisjointCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = disjoint_cbuffer_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDisjointCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DisjointCbufferCbufferPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DisjointCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1));
}
