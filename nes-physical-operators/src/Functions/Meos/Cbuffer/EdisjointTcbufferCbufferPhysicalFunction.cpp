...
#include <Functions/Meos/Cbuffer/EdisjointTcbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEdisjointTcbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EdisjointTcbufferCbufferPhysicalFunction::EdisjointTcbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal EdisjointTcbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEdisjointTcbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EdisjointTcbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return EdisjointTcbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
