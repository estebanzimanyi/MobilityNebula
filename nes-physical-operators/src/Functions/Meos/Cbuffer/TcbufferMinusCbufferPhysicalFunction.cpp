...
#include <Functions/Meos/Cbuffer/TcbufferMinusCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTcbufferMinusCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TcbufferMinusCbufferPhysicalFunction::TcbufferMinusCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TcbufferMinusCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tcbuffer_minus_cbuffer(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTcbufferMinusCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TcbufferMinusCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TcbufferMinusCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
