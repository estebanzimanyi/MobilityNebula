...
#include <Functions/Meos/Cbuffer/NadTcbufferStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTcbufferStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTcbufferStboxPhysicalFunction::NadTcbufferStboxPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal NadTcbufferStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                double r = nad_tcbuffer_stbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTcbufferStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "NadTcbufferStboxPhysicalFunction requires 5 children but got {}",
    ...
    return NadTcbufferStboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
