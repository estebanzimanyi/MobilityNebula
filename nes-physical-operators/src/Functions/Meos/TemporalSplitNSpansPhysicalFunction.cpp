...
#include <Functions/Meos/TemporalSplitNSpansPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalSplitNSpansPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalSplitNSpansPhysicalFunction::TemporalSplitNSpansPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalSplitNSpansPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) temporal_split_n_spans(temp, arg0, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalSplitNSpansPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalSplitNSpansPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalSplitNSpansPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
