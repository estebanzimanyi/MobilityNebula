...
#include <Functions/Meos/RightSpansetSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterRightSpansetSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

RightSpansetSpanPhysicalFunction::RightSpansetSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal RightSpansetSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = right_spanset_span(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterRightSpansetSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "RightSpansetSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return RightSpansetSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
