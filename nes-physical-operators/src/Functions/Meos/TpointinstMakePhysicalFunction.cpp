...
#include <Functions/Meos/TpointinstMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTpointinstMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TpointinstMakePhysicalFunction::TpointinstMakePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TpointinstMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tpointinst_make(temp, arg0);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTpointinstMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TpointinstMakePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TpointinstMakePhysicalFunction(std::move(arg0), std::move(arg1));
}
