...
#include <Functions/Meos/TfloatValueTimeSplitPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatValueTimeSplitPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TfloatValueTimeSplitPhysicalFunction::TfloatValueTimeSplitPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TfloatValueTimeSplitPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTfloatValueTimeSplitPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TfloatValueTimeSplitPhysicalFunction requires 6 children but got {}",
    ...
    return TfloatValueTimeSplitPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
