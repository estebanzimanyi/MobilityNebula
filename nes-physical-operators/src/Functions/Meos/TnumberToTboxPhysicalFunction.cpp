...
#include <Functions/Meos/TnumberToTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTnumberToTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TnumberToTboxPhysicalFunction::TnumberToTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TnumberToTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTnumberToTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TnumberToTboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TnumberToTboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
