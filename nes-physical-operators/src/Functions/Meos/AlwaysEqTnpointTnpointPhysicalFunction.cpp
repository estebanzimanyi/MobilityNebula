...
AlwaysEqTnpointTnpointPhysicalFunction::AlwaysEqTnpointTnpointPhysicalFunction(PhysicalFunction ridFunction,
    ...
    const auto result = nautilus::invoke(
        +[](int64_t rid,
            ...
            try
            {
                ...
                double r = always_eq_tnpoint_tnpoint(temp, inst0);
                free(temp);
                free(inst0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "AlwaysEqTnpointTnpointPhysicalFunction requires 6 children but got {}",
    ...
    return AlwaysEqTnpointTnpointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
