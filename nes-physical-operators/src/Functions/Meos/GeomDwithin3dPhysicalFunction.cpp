...
#include <Functions/Meos/GeomDwithin3dPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomDwithin3dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomDwithin3dPhysicalFunction::GeomDwithin3dPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeomDwithin3dPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geom_dwithin3d(temp, arg0G.getGeometry(), 2.0);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeomDwithin3dPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeomDwithin3dPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeomDwithin3dPhysicalFunction(std::move(arg0), std::move(arg1));
}
