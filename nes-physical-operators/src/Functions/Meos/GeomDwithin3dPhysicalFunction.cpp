...
GeomDwithin3dPhysicalFunction::GeomDwithin3dPhysicalFunction(PhysicalFunction wkt1Function,
    ...
    const auto result = nautilus::invoke(
        +[](const char* w1, uint32_t w1sz, const char* w2, uint32_t w2sz, double d) -> double {
            try {
                ...
                bool r = geom_dwithin3d(gs1, gs2, d);
                free(gs1); free(gs2);
                return r ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return GeomDwithin3dPhysicalFunction(
