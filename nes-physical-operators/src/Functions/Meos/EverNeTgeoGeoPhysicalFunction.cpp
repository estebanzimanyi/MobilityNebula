...
EverNeTgeoGeoPhysicalFunction::EverNeTgeoGeoPhysicalFunction(PhysicalFunction lon, PhysicalFunction lat,
    ...
    const auto result = nautilus::invoke(
        +[](double lon, double lat, uint64_t ts,
            ...
            try {
                ...
                double r = ever_ne_tgeo_geo(tgeo, gs) > 0 ? 1.0 : 0.0;
                free(tgeo); free(gs);
                return r;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EverNeTgeoGeoPhysicalFunction(std::move(arguments.childFunctions[0]),
