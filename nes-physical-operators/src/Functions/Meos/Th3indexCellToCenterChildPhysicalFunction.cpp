...
Th3indexCellToCenterChildPhysicalFunction::Th3indexCellToCenterChildPhysicalFunction(PhysicalFunction cellFunction,
    ...
    const auto actualLen = nautilus::invoke(
        +[](uint64_t cell,
            ...
            try
            {
                ...
                Temporal* tres = th3index_cell_to_center_child(temp, (int32_t)arg0);
                free(temp);
                if (!tres) return 0u;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return Th3indexCellToCenterChildPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
