...
#include <Functions/Meos/TgeoSplitEachNStboxesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgeoSplitEachNStboxesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgeoSplitEachNStboxesPhysicalFunction::TgeoSplitEachNStboxesPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TgeoSplitEachNStboxesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg0 = parameterValues[3].cast<nautilus::val<int32_t>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                STBox* arr = (STBox*) tgeo_split_each_n_stboxes(temp, arg0, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTgeoSplitEachNStboxesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TgeoSplitEachNStboxesPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TgeoSplitEachNStboxesPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
