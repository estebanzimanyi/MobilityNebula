...
AlwaysNeTh3indexH3indexPhysicalFunction::AlwaysNeTh3indexH3indexPhysicalFunction(PhysicalFunction cellFunction,
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t cell,
            ...
            try
            {
                ...
                double r = always_ne_th3index_h3index(temp, (H3Index)arg0);
                free(temp);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeTh3indexH3indexPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
