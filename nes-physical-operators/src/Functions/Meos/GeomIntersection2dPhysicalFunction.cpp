...
#include <Functions/Meos/GeomIntersection2dPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomIntersection2dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomIntersection2dPhysicalFunction::GeomIntersection2dPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeomIntersection2dPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) geom_intersection2d(temp, arg0G.getGeometry());
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeomIntersection2dPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeomIntersection2dPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeomIntersection2dPhysicalFunction(std::move(arg0), std::move(arg1));
}
