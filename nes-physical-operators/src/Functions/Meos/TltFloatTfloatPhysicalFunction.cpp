...
#include <Functions/Meos/TltFloatTfloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTltFloatTfloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TltFloatTfloatPhysicalFunction::TltFloatTfloatPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TltFloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = tlt_float_tfloat(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTltFloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TltFloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TltFloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
