...
EverEqPoseTposePhysicalFunction::EverEqPoseTposePhysicalFunction(PhysicalFunction px0Function,
    ...
    const auto result = nautilus::invoke(
        +[](double px0,
            ...
            try
            {
                ...
                double r = ever_eq_pose_tpose(pose0, temp);
                free(temp);
                free(pose0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqPoseTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
