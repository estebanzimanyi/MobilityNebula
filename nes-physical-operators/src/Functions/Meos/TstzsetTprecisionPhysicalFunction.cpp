...
#include <Functions/Meos/TstzsetTprecisionPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTstzsetTprecisionPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TstzsetTprecisionPhysicalFunction::TstzsetTprecisionPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TstzsetTprecisionPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                Set* res = (Set*) tstzset_tprecision(temp, arg0B, arg1V);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTstzsetTprecisionPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TstzsetTprecisionPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TstzsetTprecisionPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
