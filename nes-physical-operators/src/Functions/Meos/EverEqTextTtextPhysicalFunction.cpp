...
#include <Functions/Meos/EverEqTextTtextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverEqTextTtextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverEqTextTtextPhysicalFunction::EverEqTextTtextPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal EverEqTextTtextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* valuePtr, uint32_t valueSize,
            ...
            try
            {
                ...
                int r = ever_eq_text_ttext(arg0T, temp);
                free(temp);
                free(arg0T);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverEqTextTtextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverEqTextTtextPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverEqTextTtextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
