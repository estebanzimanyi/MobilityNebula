...
TfloatTanPhysicalFunction::TfloatTanPhysicalFunction(PhysicalFunction trajFunction)
{
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 1,
                 "TfloatTanPhysicalFunction requires 1 child but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    return TfloatTanPhysicalFunction(std::move(arg0));
}
