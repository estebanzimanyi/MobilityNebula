...
#include <Functions/Meos/TboxShiftScaleTimePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboxShiftScaleTimePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboxShiftScaleTimePhysicalFunction::TboxShiftScaleTimePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TboxShiftScaleTimePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                TBox* res = (TBox*) tbox_shift_scale_time(temp, arg0B, arg1B);
                free(temp);
                free(arg0B);
                free(arg1B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboxShiftScaleTimePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TboxShiftScaleTimePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TboxShiftScaleTimePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
