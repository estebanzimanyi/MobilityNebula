...
#include <Functions/Meos/TtextMaxValuePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextMaxValuePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtextMaxValuePhysicalFunction::TtextMaxValuePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TtextMaxValuePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtextMaxValuePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TtextMaxValuePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TtextMaxValuePhysicalFunction(std::move(arg0), std::move(arg1));
}
