...
#include <Functions/Meos/TgeoValueAtTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgeoValueAtTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgeoValueAtTimestamptzPhysicalFunction::TgeoValueAtTimestamptzPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TgeoValueAtTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg1) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = nullptr;
                bool ok = tgeo_value_at_timestamptz(temp, arg0V, arg1, &res);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTgeoValueAtTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TgeoValueAtTimestamptzPhysicalFunction requires 5 children but got {}",
    ...
    return TgeoValueAtTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
