...
#include <Functions/Meos/TfloatboxExpandPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatboxExpandPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TfloatboxExpandPhysicalFunction::TfloatboxExpandPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TfloatboxExpandPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                TBox* res = (TBox*) tfloatbox_expand(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTfloatboxExpandPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TfloatboxExpandPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TfloatboxExpandPhysicalFunction(std::move(arg0), std::move(arg1));
}
