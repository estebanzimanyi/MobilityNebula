...
#include <Functions/Meos/EverEqTtextTextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverEqTtextTextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverEqTtextTextPhysicalFunction::EverEqTtextTextPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal EverEqTtextTextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* valuePtr, uint32_t valueSize,
            ...
            try
            {
                ...
                int r = ever_eq_ttext_text(temp, arg0T);
                free(temp);
                free(arg0T);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverEqTtextTextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverEqTtextTextPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverEqTtextTextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
