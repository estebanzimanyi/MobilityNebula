...
#include <Functions/Meos/OverlapsNumspanTnumberPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverlapsNumspanTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverlapsNumspanTnumberPhysicalFunction::OverlapsNumspanTnumberPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal OverlapsNumspanTnumberPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = overlaps_numspan_tnumber(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverlapsNumspanTnumberPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "OverlapsNumspanTnumberPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return OverlapsNumspanTnumberPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
