...
#include <Functions/Meos/EverGeTfloatTfloatPhysicalFunction.hpp>
...
EverGeTfloatTfloatPhysicalFunction::EverGeTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal EverGeTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverGeTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverGeTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverGeTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
