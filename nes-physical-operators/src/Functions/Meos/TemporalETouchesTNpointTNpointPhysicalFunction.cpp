...
#include <Functions/Meos/TemporalETouchesTNpointTNpointPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalETouchesTNpointTNpointPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalETouchesTNpointTNpointPhysicalFunction::TemporalETouchesTNpointTNpointPhysicalFunction(PhysicalFunction ridAFunction,
...
VarVal TemporalETouchesTNpointTNpointPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t ridAValue, double fractionAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                int r = etouches_tgeo_tgeo(tgeoA, tgeoB);
                free(tgeoB);
                free(tnpointB);
                free(tgeoA);
                free(tnpointA);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalETouchesTNpointTNpointPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalETouchesTNpointTNpointPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalETouchesTNpointTNpointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
