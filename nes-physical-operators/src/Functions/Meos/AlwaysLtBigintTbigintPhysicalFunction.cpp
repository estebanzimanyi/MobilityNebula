...
AlwaysLtBigintTbigintPhysicalFunction::AlwaysLtBigintTbigintPhysicalFunction(PhysicalFunction valueFunction,
    ...
    const auto result = nautilus::invoke(
        +[](int64_t valueValue,
            ...
            try
            {
                ...
                if (!temp) return 0;
                int r = always_lt_bigint_tbigint(scalarValue, temp);
                free(temp);
                return r;
            }
