...
#include <Functions/Meos/NadTintIntPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTintIntPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTintIntPhysicalFunction::NadTintIntPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal NadTintIntPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTintIntPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "NadTintIntPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return NadTintIntPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
