...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEDisjointGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }
