...
#include <Functions/Meos/NadTboxfloatTboxfloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTboxfloatTboxfloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTboxfloatTboxfloatPhysicalFunction::NadTboxfloatTboxfloatPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NadTboxfloatTboxfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = nad_tboxfloat_tboxfloat(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTboxfloatTboxfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NadTboxfloatTboxfloatPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NadTboxfloatTboxfloatPhysicalFunction(std::move(arg0), std::move(arg1));
}
