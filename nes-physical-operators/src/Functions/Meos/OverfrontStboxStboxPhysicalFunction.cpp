...
#include <Functions/Meos/OverfrontStboxStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverfrontStboxStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverfrontStboxStboxPhysicalFunction::OverfrontStboxStboxPhysicalFunction(PhysicalFunction boxFunction,
...
VarVal OverfrontStboxStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* boxPtr, uint32_t boxSize,
            ...
            try
            {
                ...
                bool r = overfront_stbox_stbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverfrontStboxStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverfrontStboxStboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverfrontStboxStboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
