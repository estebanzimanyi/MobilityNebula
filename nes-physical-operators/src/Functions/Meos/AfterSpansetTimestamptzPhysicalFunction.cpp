...
#include <Functions/Meos/AfterSpansetTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAfterSpansetTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AfterSpansetTimestamptzPhysicalFunction::AfterSpansetTimestamptzPhysicalFunction(PhysicalFunction litFunction,
...
VarVal AfterSpansetTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = after_spanset_timestamptz(temp, arg0V);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAfterSpansetTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AfterSpansetTimestamptzPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AfterSpansetTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1));
}
