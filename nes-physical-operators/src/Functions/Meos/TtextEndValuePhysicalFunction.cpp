...
#include <Functions/Meos/TtextEndValuePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextEndValuePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtextEndValuePhysicalFunction::TtextEndValuePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TtextEndValuePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtextEndValuePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TtextEndValuePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TtextEndValuePhysicalFunction(std::move(arg0), std::move(arg1));
}
