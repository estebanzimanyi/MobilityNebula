...
#include <Functions/Meos/TboxLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboxLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboxLtPhysicalFunction::TboxLtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TboxLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboxLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TboxLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TboxLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
