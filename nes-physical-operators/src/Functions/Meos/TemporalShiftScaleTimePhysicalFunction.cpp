...
#include <Functions/Meos/TemporalShiftScaleTimePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalShiftScaleTimePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalShiftScaleTimePhysicalFunction::TemporalShiftScaleTimePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalShiftScaleTimePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_shift_scale_time(temp, arg0B, arg1B);
                free(temp);
                free(arg0B);
                free(arg1B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalShiftScaleTimePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TemporalShiftScaleTimePhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TemporalShiftScaleTimePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
