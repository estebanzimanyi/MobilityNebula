...
#include <Functions/Meos/SameTemporalTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSameTemporalTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SameTemporalTstzspanPhysicalFunction::SameTemporalTstzspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal SameTemporalTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = same_temporal_tstzspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSameTemporalTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "SameTemporalTstzspanPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return SameTemporalTstzspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
