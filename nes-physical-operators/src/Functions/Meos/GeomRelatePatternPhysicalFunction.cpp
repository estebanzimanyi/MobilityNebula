...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomRelatePatternPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomRelatePatternPhysicalFunction::GeomRelatePatternPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geom_relate_pattern(temp, arg0G.getGeometry(), (char*)"T*F**FFF*");
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeomRelatePatternPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeomRelatePatternPhysicalFunction(std::move(arg0), std::move(arg1));
}
