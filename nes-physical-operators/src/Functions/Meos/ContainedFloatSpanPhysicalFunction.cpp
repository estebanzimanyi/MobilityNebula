...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedFloatSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedFloatSpanPhysicalFunction::ContainedFloatSpanPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contained_float_span(arg0, temp);
                free(temp);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return ContainedFloatSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
