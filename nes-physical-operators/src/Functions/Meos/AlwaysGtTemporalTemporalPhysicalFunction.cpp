...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysGtTemporalTemporalPhysicalFunction(PhysicalFunctionRegistryArguments); }
