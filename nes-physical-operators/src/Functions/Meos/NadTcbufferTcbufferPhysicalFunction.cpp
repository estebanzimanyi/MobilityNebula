...
NadTcbufferTcbufferPhysicalFunction::NadTcbufferTcbufferPhysicalFunction(
    ...
    const auto result = nautilus::invoke(
        +[](double lon1, double lat1, double r1, uint64_t ts1,
            ...
            try {
                ...
                double r = nad_tcbuffer_tcbuffer(tcb1, tcb2);
                free(tcb1); free(tcb2);
                return r;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return NadTcbufferTcbufferPhysicalFunction(std::move(arguments.childFunctions[0]),
