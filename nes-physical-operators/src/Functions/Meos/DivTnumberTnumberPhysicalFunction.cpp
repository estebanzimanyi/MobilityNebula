...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDivTnumberTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }
