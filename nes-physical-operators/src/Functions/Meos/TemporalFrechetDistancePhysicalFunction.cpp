...
#include <Functions/Meos/TemporalFrechetDistancePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalFrechetDistancePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalFrechetDistancePhysicalFunction::TemporalFrechetDistancePhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalFrechetDistancePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return temporal_frechet_distance(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalFrechetDistancePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalFrechetDistancePhysicalFunction requires 6 children but got {}",
    ...
    return TemporalFrechetDistancePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
