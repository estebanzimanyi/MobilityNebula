...
#include <Functions/Meos/OverlapsSpansetSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverlapsSpansetSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverlapsSpansetSpanPhysicalFunction::OverlapsSpansetSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal OverlapsSpansetSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = overlaps_spanset_span(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverlapsSpansetSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverlapsSpansetSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverlapsSpansetSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
