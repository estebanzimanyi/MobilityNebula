...
#include <Functions/Meos/IntspansetBinsPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterIntspansetBinsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

IntspansetBinsPhysicalFunction::IntspansetBinsPhysicalFunction(PhysicalFunction litFunction,
...
VarVal IntspansetBinsPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg1) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) intspanset_bins(temp, arg0, arg1, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterIntspansetBinsPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "IntspansetBinsPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return IntspansetBinsPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
