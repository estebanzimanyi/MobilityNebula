...
#include <Functions/Meos/OverfrontTspatialStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverfrontTspatialStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverfrontTspatialStboxPhysicalFunction::OverfrontTspatialStboxPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal OverfrontTspatialStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = overfront_tspatial_stbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverfrontTspatialStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "OverfrontTspatialStboxPhysicalFunction requires 5 children but got {}",
    ...
    return OverfrontTspatialStboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
