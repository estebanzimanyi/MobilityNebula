...
#include <Functions/Meos/SetSplitNSpansPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSetSplitNSpansPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SetSplitNSpansPhysicalFunction::SetSplitNSpansPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SetSplitNSpansPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) set_split_n_spans(temp, arg0, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSetSplitNSpansPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SetSplitNSpansPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SetSplitNSpansPhysicalFunction(std::move(arg0), std::move(arg1));
}
