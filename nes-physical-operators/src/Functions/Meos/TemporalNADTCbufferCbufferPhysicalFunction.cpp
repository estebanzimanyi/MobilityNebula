...
#include <Functions/Meos/TemporalNADTCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalNADTCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalNADTCbufferCbufferPhysicalFunction::TemporalNADTCbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
                                                          PhysicalFunction latFunction,
                                                          PhysicalFunction radiusFunction,
                                                          PhysicalFunction timestampFunction,
                                                          PhysicalFunction cbufferLiteralFunction)
{
    ...
    parameterFunctions.push_back(std::move(cbufferLiteralFunction));
}

VarVal TemporalNADTCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                double r = nad_tcbuffer_cbuffer(tcbuffer, cb);
                free(tcbuffer);
                free(cb);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalNADTCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalNADTCbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalNADTCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
