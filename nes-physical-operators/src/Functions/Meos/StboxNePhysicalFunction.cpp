...
#include <Functions/Meos/StboxNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxNePhysicalFunction::StboxNePhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxNePhysicalFunction(std::move(arg0), std::move(arg1));
}
