...
#include <Functions/Meos/TextcatTextsetTextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTextcatTextsetTextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TextcatTextsetTextPhysicalFunction::TextcatTextsetTextPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TextcatTextsetTextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Set* res = (Set*) textcat_textset_text(temp, arg0T);
                free(temp);
                free(arg0T);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTextcatTextsetTextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TextcatTextsetTextPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TextcatTextsetTextPhysicalFunction(std::move(arg0), std::move(arg1));
}
