...
#include <Functions/Meos/Pose/NadTposePosePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTposePosePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTposePosePhysicalFunction::NadTposePosePhysicalFunction(PhysicalFunction xFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                double r = nad_tpose_pose(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "NadTposePosePhysicalFunction requires 5 children but got {}",
    ...
    return NadTposePosePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
