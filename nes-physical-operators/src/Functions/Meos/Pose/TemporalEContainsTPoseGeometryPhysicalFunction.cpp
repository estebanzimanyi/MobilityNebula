...
#include <Functions/Meos/Pose/TemporalEContainsTPoseGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEContainsTPoseGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }
