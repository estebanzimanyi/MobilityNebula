...
#include <Functions/Meos/Pose/PoseCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseCmpPhysicalFunction::PoseCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
