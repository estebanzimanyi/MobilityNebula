...
#include <Functions/Meos/Pose/TposeMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTposeMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TposeMakePhysicalFunction::TposeMakePhysicalFunction(PhysicalFunction trajFunction,
...
VarVal TposeMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTposeMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TposeMakePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TposeMakePhysicalFunction(std::move(arg0), std::move(arg1));
}
