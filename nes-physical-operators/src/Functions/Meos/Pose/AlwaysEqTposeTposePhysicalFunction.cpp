...
#include <Functions/Meos/Pose/AlwaysEqTposeTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysEqTposeTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysEqTposeTposePhysicalFunction::AlwaysEqTposeTposePhysicalFunction(PhysicalFunction trajFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* trajPtr, uint32_t trajSize,
            ...
            try
            {
                ...
                int r = always_eq_tpose_tpose(temp, arg0T);
                free(temp);
                free(arg0T);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysEqTposeTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AlwaysEqTposeTposePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AlwaysEqTposeTposePhysicalFunction(std::move(arg0), std::move(arg1));
}
