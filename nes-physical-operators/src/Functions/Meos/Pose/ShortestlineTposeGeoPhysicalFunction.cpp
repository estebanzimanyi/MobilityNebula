...
#include <Functions/Meos/Pose/ShortestlineTposeGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterShortestlineTposeGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ShortestlineTposeGeoPhysicalFunction::ShortestlineTposeGeoPhysicalFunction(PhysicalFunction xFunction,
...
VarVal ShortestlineTposeGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) shortestline_tpose_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterShortestlineTposeGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "ShortestlineTposeGeoPhysicalFunction requires 5 children but got {}",
    ...
    return ShortestlineTposeGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
