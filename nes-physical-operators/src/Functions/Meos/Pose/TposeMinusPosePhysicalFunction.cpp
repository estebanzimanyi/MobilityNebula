...
#include <Functions/Meos/Pose/TposeMinusPosePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTposeMinusPosePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TposeMinusPosePhysicalFunction::TposeMinusPosePhysicalFunction(PhysicalFunction xFunction,
...
VarVal TposeMinusPosePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tpose_minus_pose(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTposeMinusPosePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TposeMinusPosePhysicalFunction requires 5 children but got {}",
    ...
    return TposeMinusPosePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
