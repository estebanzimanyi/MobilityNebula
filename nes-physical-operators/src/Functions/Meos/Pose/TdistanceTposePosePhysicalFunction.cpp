...
#include <Functions/Meos/Pose/TdistanceTposePosePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTposePosePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTposePosePhysicalFunction::TdistanceTposePosePhysicalFunction(PhysicalFunction xFunction,
...
VarVal TdistanceTposePosePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tdistance_tpose_pose(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTposePosePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdistanceTposePosePhysicalFunction requires 5 children but got {}",
    ...
    return TdistanceTposePosePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
