...
#include <Functions/Meos/Pose/PoseEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseEqPhysicalFunction::PoseEqPhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
