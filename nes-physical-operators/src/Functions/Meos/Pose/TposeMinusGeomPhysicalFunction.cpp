...
#include <Functions/Meos/Pose/TposeMinusGeomPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTposeMinusGeomPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TposeMinusGeomPhysicalFunction::TposeMinusGeomPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TposeMinusGeomPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tpose_minus_geom(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTposeMinusGeomPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TposeMinusGeomPhysicalFunction requires 5 children but got {}",
    ...
    return TposeMinusGeomPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
