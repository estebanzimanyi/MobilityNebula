...
#include <Functions/Meos/Pose/EverEqPoseTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverEqPoseTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverEqPoseTposePhysicalFunction::EverEqPoseTposePhysicalFunction(PhysicalFunction xFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                int r = ever_eq_pose_tpose(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EverEqPoseTposePhysicalFunction requires 5 children but got {}",
    ...
    return EverEqPoseTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
