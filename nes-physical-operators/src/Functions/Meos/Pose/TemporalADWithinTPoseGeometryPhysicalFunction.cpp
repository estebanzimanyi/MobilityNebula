...
#include <Functions/Meos/Pose/TemporalADWithinTPoseGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalADWithinTPoseGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalADWithinTPoseGeometryPhysicalFunction::TemporalADWithinTPoseGeometryPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TemporalADWithinTPoseGeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double xValue, double yValue, double thetaValue, uint64_t timestampValue,
            ...
            try
            {
                ...
                int r = adwithin_tgeo_geo(tgeo, staticGeometry.getGeometry(), distValue);
                free(tgeo);
                free(tpose);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalADWithinTPoseGeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalADWithinTPoseGeometryPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalADWithinTPoseGeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
