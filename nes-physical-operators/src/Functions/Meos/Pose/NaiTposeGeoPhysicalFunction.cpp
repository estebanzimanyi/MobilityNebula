...
#include <Functions/Meos/Pose/NaiTposeGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNaiTposeGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NaiTposeGeoPhysicalFunction::NaiTposeGeoPhysicalFunction(PhysicalFunction xFunction,
...
VarVal NaiTposeGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) nai_tpose_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNaiTposeGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "NaiTposeGeoPhysicalFunction requires 5 children but got {}",
    ...
    return NaiTposeGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
