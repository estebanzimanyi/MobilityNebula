...
#include <Functions/Meos/Pose/PoseNsamePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseNsamePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseNsamePhysicalFunction::PoseNsamePhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseNsamePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseNsamePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseNsamePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseNsamePhysicalFunction(std::move(arg0), std::move(arg1));
}
