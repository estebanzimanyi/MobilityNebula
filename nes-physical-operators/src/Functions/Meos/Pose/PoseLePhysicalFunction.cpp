...
#include <Functions/Meos/Pose/PoseLePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseLePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseLePhysicalFunction::PoseLePhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseLePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseLePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseLePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseLePhysicalFunction(std::move(arg0), std::move(arg1));
}
