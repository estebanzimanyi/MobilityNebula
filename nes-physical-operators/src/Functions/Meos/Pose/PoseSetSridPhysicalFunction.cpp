...
#include <Functions/Meos/Pose/PoseSetSridPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseSetSridPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseSetSridPhysicalFunction::PoseSetSridPhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseSetSridPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                pose_set_srid(temp, arg0);
                char* outStr = pose_out(temp, 15);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseSetSridPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseSetSridPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseSetSridPhysicalFunction(std::move(arg0), std::move(arg1));
}
