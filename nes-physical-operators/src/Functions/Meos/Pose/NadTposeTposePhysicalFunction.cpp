...
#include <Functions/Meos/Pose/NadTposeTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTposeTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTposeTposePhysicalFunction::NadTposeTposePhysicalFunction(PhysicalFunction trajFunction,
...
VarVal NadTposeTposePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* trajPtr, uint32_t trajSize,
            ...
            try
            {
                ...
                double r = nad_tpose_tpose(temp, arg0T);
                free(temp);
                free(arg0T);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTposeTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NadTposeTposePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NadTposeTposePhysicalFunction(std::move(arg0), std::move(arg1));
}
