...
#include <Functions/Meos/Pose/PoseMakePoint2dPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseMakePoint2dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseMakePoint2dPhysicalFunction::PoseMakePoint2dPhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseMakePoint2dPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Pose* res = (Pose*) pose_make_point2d(temp, arg0);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseMakePoint2dPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseMakePoint2dPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseMakePoint2dPhysicalFunction(std::move(arg0), std::move(arg1));
}
