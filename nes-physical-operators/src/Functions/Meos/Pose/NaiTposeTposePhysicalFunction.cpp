...
#include <Functions/Meos/Pose/NaiTposeTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNaiTposeTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NaiTposeTposePhysicalFunction::NaiTposeTposePhysicalFunction(PhysicalFunction xFunction,
...
VarVal NaiTposeTposePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) nai_tpose_tpose(temp, arg0t);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNaiTposeTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "NaiTposeTposePhysicalFunction requires 8 children but got {}",
    ...
    return NaiTposeTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
