...
#include <Functions/Meos/Pose/PoseTimestamptzToStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseTimestamptzToStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseTimestamptzToStboxPhysicalFunction::PoseTimestamptzToStboxPhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseTimestamptzToStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                STBox* res = (STBox*) pose_timestamptz_to_stbox(temp, arg0V);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseTimestamptzToStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseTimestamptzToStboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseTimestamptzToStboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
