...
#include <Functions/Meos/Pose/EverNeTposePosePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverNeTposePosePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverNeTposePosePhysicalFunction::EverNeTposePosePhysicalFunction(PhysicalFunction xFunction,
...
VarVal EverNeTposePosePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                int r = ever_ne_tpose_pose(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverNeTposePosePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EverNeTposePosePhysicalFunction requires 5 children but got {}",
    ...
    return EverNeTposePosePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
