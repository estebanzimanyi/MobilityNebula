...
#include <Functions/Meos/Pose/PoseSamePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseSamePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseSamePhysicalFunction::PoseSamePhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseSamePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseSamePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseSamePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseSamePhysicalFunction(std::move(arg0), std::move(arg1));
}
