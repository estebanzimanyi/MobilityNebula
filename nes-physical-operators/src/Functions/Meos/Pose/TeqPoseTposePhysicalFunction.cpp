...
#include <Functions/Meos/Pose/TeqPoseTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTeqPoseTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TeqPoseTposePhysicalFunction::TeqPoseTposePhysicalFunction(PhysicalFunction xFunction,
...
VarVal TeqPoseTposePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = teq_pose_tpose(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTeqPoseTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TeqPoseTposePhysicalFunction requires 5 children but got {}",
    ...
    return TeqPoseTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
