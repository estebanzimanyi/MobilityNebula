...
#include <Functions/Meos/Pose/TnePoseTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTnePoseTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TnePoseTposePhysicalFunction::TnePoseTposePhysicalFunction(PhysicalFunction xFunction,
...
VarVal TnePoseTposePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tne_pose_tpose(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTnePoseTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TnePoseTposePhysicalFunction requires 5 children but got {}",
    ...
    return TnePoseTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
