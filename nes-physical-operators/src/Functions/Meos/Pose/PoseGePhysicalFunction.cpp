...
#include <Functions/Meos/Pose/PoseGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseGePhysicalFunction::PoseGePhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseGePhysicalFunction(std::move(arg0), std::move(arg1));
}
