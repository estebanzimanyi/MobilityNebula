...
#include <Functions/Meos/Pose/PoseMake3dPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseMake3dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseMake3dPhysicalFunction::PoseMake3dPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal PoseMake3dPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg6 = parameterValues[7].cast<nautilus::val<int32_t>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg6) -> char*
        {
            try
            {
                ...
                Pose* res = (Pose*) pose_make_3d(temp, arg0, arg1, arg2, arg3, arg4, arg5, arg6);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseMake3dPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "PoseMake3dPhysicalFunction requires 8 children but got {}",
    ...
    return PoseMake3dPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
