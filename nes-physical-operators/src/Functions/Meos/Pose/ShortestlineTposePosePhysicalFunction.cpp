...
#include <Functions/Meos/Pose/ShortestlineTposePosePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterShortestlineTposePosePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ShortestlineTposePosePhysicalFunction::ShortestlineTposePosePhysicalFunction(PhysicalFunction xFunction,
...
VarVal ShortestlineTposePosePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) shortestline_tpose_pose(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterShortestlineTposePosePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "ShortestlineTposePosePhysicalFunction requires 5 children but got {}",
    ...
    return ShortestlineTposePosePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
