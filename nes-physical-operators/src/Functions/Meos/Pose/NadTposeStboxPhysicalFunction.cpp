...
#include <Functions/Meos/Pose/NadTposeStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTposeStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTposeStboxPhysicalFunction::NadTposeStboxPhysicalFunction(PhysicalFunction xFunction,
...
VarVal NadTposeStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                double r = nad_tpose_stbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTposeStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "NadTposeStboxPhysicalFunction requires 5 children but got {}",
    ...
    return NadTposeStboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
