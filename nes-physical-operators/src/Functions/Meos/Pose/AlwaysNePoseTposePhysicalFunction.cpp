...
#include <Functions/Meos/Pose/AlwaysNePoseTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysNePoseTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysNePoseTposePhysicalFunction::AlwaysNePoseTposePhysicalFunction(PhysicalFunction xFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                int r = always_ne_pose_tpose(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AlwaysNePoseTposePhysicalFunction requires 5 children but got {}",
    ...
    return AlwaysNePoseTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
