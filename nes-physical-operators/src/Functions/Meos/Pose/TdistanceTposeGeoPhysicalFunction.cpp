...
#include <Functions/Meos/Pose/TdistanceTposeGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTposeGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTposeGeoPhysicalFunction::TdistanceTposeGeoPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TdistanceTposeGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tdistance_tpose_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTposeGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdistanceTposeGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TdistanceTposeGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
