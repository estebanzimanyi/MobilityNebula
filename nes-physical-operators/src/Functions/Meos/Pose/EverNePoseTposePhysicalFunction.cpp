...
#include <Functions/Meos/Pose/EverNePoseTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverNePoseTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverNePoseTposePhysicalFunction::EverNePoseTposePhysicalFunction(PhysicalFunction xFunction,
...
VarVal EverNePoseTposePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                int r = ever_ne_pose_tpose(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverNePoseTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EverNePoseTposePhysicalFunction requires 5 children but got {}",
    ...
    return EverNePoseTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
