...
#include <Functions/Meos/Pose/TdistanceTposePointPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTposePointPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTposePointPhysicalFunction::TdistanceTposePointPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TdistanceTposePointPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tdistance_tpose_point(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTposePointPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdistanceTposePointPhysicalFunction requires 5 children but got {}",
    ...
    return TdistanceTposePointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
