...
#include <Functions/Meos/Pose/PoseLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseLtPhysicalFunction::PoseLtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
