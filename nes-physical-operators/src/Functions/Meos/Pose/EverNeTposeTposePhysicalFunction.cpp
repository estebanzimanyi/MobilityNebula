...
#include <Functions/Meos/Pose/EverNeTposeTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverNeTposeTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverNeTposeTposePhysicalFunction::EverNeTposeTposePhysicalFunction(PhysicalFunction trajFunction,
...
VarVal EverNeTposeTposePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* trajPtr, uint32_t trajSize,
            ...
            try
            {
                ...
                int r = ever_ne_tpose_tpose(temp, arg0T);
                free(temp);
                free(arg0T);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverNeTposeTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "EverNeTposeTposePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return EverNeTposeTposePhysicalFunction(std::move(arg0), std::move(arg1));
}
