...
#include <Functions/Meos/Pose/PoseGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseGtPhysicalFunction::PoseGtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
