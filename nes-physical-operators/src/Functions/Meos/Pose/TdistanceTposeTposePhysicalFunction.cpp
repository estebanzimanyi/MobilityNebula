...
#include <Functions/Meos/Pose/TdistanceTposeTposePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTposeTposePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTposeTposePhysicalFunction::TdistanceTposeTposePhysicalFunction(PhysicalFunction trajFunction,
...
VarVal TdistanceTposeTposePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto hexStr = nautilus::invoke(
        +[](const char* aPtr, uint32_t aSize, const char* bPtr, uint32_t bSize) -> char*
        {
            try
            {
                ...
                Temporal* res = tdistance_tpose_tpose(a, b);
                free(a);
                free(b);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTposeTposePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TdistanceTposeTposePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TdistanceTposeTposePhysicalFunction(std::move(arg0), std::move(arg1));
}
