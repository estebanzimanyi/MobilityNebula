...
#include <Functions/Meos/Pose/PoseNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterPoseNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

PoseNePhysicalFunction::PoseNePhysicalFunction(PhysicalFunction litFunction,
...
VarVal PoseNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterPoseNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "PoseNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return PoseNePhysicalFunction(std::move(arg0), std::move(arg1));
}
