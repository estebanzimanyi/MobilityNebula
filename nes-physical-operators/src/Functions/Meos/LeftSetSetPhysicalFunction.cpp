...
#include <Functions/Meos/LeftSetSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterLeftSetSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

LeftSetSetPhysicalFunction::LeftSetSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal LeftSetSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterLeftSetSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "LeftSetSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return LeftSetSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
