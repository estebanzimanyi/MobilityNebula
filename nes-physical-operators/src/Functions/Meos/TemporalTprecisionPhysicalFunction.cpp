...
#include <Functions/Meos/TemporalTprecisionPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalTprecisionPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalTprecisionPhysicalFunction::TemporalTprecisionPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalTprecisionPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_tprecision(temp, arg0B, arg1V);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalTprecisionPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TemporalTprecisionPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TemporalTprecisionPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
