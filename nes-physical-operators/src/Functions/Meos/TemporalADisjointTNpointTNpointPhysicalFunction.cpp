...
#include <Functions/Meos/TemporalADisjointTNpointTNpointPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalADisjointTNpointTNpointPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalADisjointTNpointTNpointPhysicalFunction::TemporalADisjointTNpointTNpointPhysicalFunction(PhysicalFunction ridAFunction,
...
VarVal TemporalADisjointTNpointTNpointPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t ridAValue, double fractionAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                int r = adisjoint_tgeo_tgeo(tgeoA, tgeoB);
                free(tgeoB);
                free(tnpointB);
                free(tgeoA);
                free(tnpointA);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalADisjointTNpointTNpointPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalADisjointTNpointTNpointPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalADisjointTNpointTNpointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
