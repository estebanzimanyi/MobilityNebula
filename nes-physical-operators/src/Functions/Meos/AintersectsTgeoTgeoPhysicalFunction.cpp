...
AintersectsTgeoTgeoPhysicalFunction::AintersectsTgeoTgeoPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction ts1, PhysicalFunction lon2, PhysicalFunction lat2, PhysicalFunction ts2)
{
    paramFns.reserve(6);
    ...
    const auto result = nautilus::invoke(
        +[](double lon1, double lat1, uint64_t ts1,
            ...
            try {
                ...
                int r = aintersects_tgeo_tgeo(t1, t2);
                free(t1); free(t2);
                return r > 0 ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AintersectsTgeoTgeoPhysicalFunction(
