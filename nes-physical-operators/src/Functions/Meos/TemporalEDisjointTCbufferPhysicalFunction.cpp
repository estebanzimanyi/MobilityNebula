...
#include <Functions/Meos/TemporalEDisjointTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEDisjointTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalEDisjointTCbufferPhysicalFunction::TemporalEDisjointTCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalEDisjointTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = edisjoint_tcbuffer_geo(tcbuffer, staticGeometry.getGeometry());
                free(tcbuffer);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalEDisjointTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalEDisjointTCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalEDisjointTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
