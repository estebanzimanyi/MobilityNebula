...
#include <Functions/Meos/TboxCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboxCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboxCmpPhysicalFunction::TboxCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TboxCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboxCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TboxCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TboxCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
