...
NadTcbufferGeoPhysicalFunction::NadTcbufferGeoPhysicalFunction(PhysicalFunction lon, PhysicalFunction lat,
    ...
    const auto result = nautilus::invoke(
        +[](double lon, double lat, double radius, uint64_t ts,
            ...
            try {
                ...
                double r = nad_tcbuffer_geo(tcb_inst, target_gs);
                free(tcb_inst);
                free(target_gs);
                return r;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return NadTcbufferGeoPhysicalFunction(std::move(arguments.childFunctions[0]),
