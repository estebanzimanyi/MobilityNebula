...
#include <Functions/Meos/Box3dMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBox3dMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

Box3dMakePhysicalFunction::Box3dMakePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal Box3dMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg5 = parameterValues[6].cast<nautilus::val<int32_t>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg5) -> char*
        {
            try
            {
                ...
                BOX3D* res = (BOX3D*) box3d_make(temp, arg0, arg1, arg2, arg3, arg4, arg5);
                if (!res) return (char*) nullptr;
                char* outStr = box3d_out(res, 15);
                free(res);
                return outStr;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBox3dMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 7,
                 "Box3dMakePhysicalFunction requires 7 children but got {}",
    ...
    return Box3dMakePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
