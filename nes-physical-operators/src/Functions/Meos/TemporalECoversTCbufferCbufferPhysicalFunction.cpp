...
#include <Functions/Meos/TemporalECoversTCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalECoversTCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalECoversTCbufferCbufferPhysicalFunction::TemporalECoversTCbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalECoversTCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = ecovers_tcbuffer_cbuffer(tcbuffer, cb);
                free(tcbuffer);
                free(cb);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalECoversTCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalECoversTCbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalECoversTCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
