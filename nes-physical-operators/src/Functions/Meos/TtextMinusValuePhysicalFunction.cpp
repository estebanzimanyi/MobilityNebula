...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextMinusValuePhysicalFunction(PhysicalFunctionRegistryArguments); }
