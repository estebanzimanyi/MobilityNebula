...
#include <Functions/Meos/GeoTimestamptzToStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeoTimestamptzToStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeoTimestamptzToStboxPhysicalFunction::GeoTimestamptzToStboxPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeoTimestamptzToStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                STBox* res = (STBox*) geo_timestamptz_to_stbox(temp, arg0V);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeoTimestamptzToStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeoTimestamptzToStboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeoTimestamptzToStboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
