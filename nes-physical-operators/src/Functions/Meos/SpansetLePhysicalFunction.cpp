...
#include <Functions/Meos/SpansetLePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetLePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetLePhysicalFunction::SpansetLePhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetLePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetLePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetLePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetLePhysicalFunction(std::move(arg0), std::move(arg1));
}
