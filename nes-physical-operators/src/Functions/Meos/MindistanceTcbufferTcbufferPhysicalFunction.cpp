...
MindistanceTcbufferTcbufferPhysicalFunction::MindistanceTcbufferTcbufferPhysicalFunction(PhysicalFunction lonAFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return MindistanceTcbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7), std::move(arg8));
}
