...
#include <Functions/Meos/ContainedTimestamptzSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedTimestamptzSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedTimestamptzSpansetPhysicalFunction::ContainedTimestamptzSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal ContainedTimestamptzSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contained_timestamptz_spanset(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainedTimestamptzSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "ContainedTimestamptzSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return ContainedTimestamptzSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
