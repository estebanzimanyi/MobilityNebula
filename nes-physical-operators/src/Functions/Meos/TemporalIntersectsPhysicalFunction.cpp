...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalIntersectsPhysicalFunction(PhysicalFunctionRegistryArguments); }
