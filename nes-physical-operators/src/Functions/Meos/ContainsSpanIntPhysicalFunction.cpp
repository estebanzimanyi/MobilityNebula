...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsSpanIntPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsSpanIntPhysicalFunction::ContainsSpanIntPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contains_span_int(temp, arg0);
                free(temp);
                return r;
            }
