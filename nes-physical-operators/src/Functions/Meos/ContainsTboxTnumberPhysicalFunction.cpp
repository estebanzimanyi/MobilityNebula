...
#include <Functions/Meos/ContainsTboxTnumberPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsTboxTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsTboxTnumberPhysicalFunction::ContainsTboxTnumberPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal ContainsTboxTnumberPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = contains_tbox_tnumber(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainsTboxTnumberPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "ContainsTboxTnumberPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return ContainsTboxTnumberPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
