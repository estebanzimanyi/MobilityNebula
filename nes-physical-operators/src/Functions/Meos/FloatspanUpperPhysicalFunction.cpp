...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatspanUpperPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatspanUpperPhysicalFunction::FloatspanUpperPhysicalFunction(PhysicalFunction litFunction)
{
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return FloatspanUpperPhysicalFunction(std::move(arg0));
}
