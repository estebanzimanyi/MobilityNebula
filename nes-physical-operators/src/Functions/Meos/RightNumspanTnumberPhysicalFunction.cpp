...
#include <Functions/Meos/RightNumspanTnumberPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterRightNumspanTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

RightNumspanTnumberPhysicalFunction::RightNumspanTnumberPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal RightNumspanTnumberPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = right_numspan_tnumber(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterRightNumspanTnumberPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "RightNumspanTnumberPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return RightNumspanTnumberPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
