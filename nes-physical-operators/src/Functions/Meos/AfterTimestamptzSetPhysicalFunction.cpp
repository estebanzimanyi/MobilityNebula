...
#include <Functions/Meos/AfterTimestamptzSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAfterTimestamptzSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AfterTimestamptzSetPhysicalFunction::AfterTimestamptzSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal AfterTimestamptzSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = after_timestamptz_set(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAfterTimestamptzSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AfterTimestamptzSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AfterTimestamptzSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
