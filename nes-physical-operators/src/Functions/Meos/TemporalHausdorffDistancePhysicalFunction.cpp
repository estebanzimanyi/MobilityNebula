...
#include <Functions/Meos/TemporalHausdorffDistancePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalHausdorffDistancePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalHausdorffDistancePhysicalFunction::TemporalHausdorffDistancePhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalHausdorffDistancePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return temporal_hausdorff_distance(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalHausdorffDistancePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalHausdorffDistancePhysicalFunction requires 6 children but got {}",
    ...
    return TemporalHausdorffDistancePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
