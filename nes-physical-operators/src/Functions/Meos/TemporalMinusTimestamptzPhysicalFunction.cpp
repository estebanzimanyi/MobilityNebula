...
#include <Functions/Meos/TemporalMinusTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalMinusTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalMinusTimestamptzPhysicalFunction::TemporalMinusTimestamptzPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalMinusTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_minus_timestamptz(temp, arg0V);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalMinusTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalMinusTimestamptzPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalMinusTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
