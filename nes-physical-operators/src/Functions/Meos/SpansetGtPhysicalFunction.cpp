...
#include <Functions/Meos/SpansetGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetGtPhysicalFunction::SpansetGtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
