...
#include <Functions/Meos/ShortestlineTgeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterShortestlineTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ShortestlineTgeoTgeoPhysicalFunction::ShortestlineTgeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal ShortestlineTgeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) shortestline_tgeo_tgeo(temp, arg0t);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterShortestlineTgeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "ShortestlineTgeoTgeoPhysicalFunction requires 6 children but got {}",
    ...
    return ShortestlineTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
