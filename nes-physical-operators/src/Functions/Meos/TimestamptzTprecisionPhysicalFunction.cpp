...
#include <Functions/Meos/TimestamptzTprecisionPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTimestamptzTprecisionPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TimestamptzTprecisionPhysicalFunction::TimestamptzTprecisionPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TimestamptzTprecisionPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](int64_t value,
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> int64_t {
            try
            {
                ...
                int64_t r = timestamptz_tprecision(temp, arg0B, arg1V);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTimestamptzTprecisionPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TimestamptzTprecisionPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TimestamptzTprecisionPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
