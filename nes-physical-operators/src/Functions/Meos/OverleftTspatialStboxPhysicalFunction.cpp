...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverleftTspatialStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }
