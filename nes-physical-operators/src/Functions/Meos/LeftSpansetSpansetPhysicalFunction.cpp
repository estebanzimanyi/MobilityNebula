...
#include <Functions/Meos/LeftSpansetSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterLeftSpansetSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

LeftSpansetSpansetPhysicalFunction::LeftSpansetSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal LeftSpansetSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = left_spanset_spanset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterLeftSpansetSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "LeftSpansetSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return LeftSpansetSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
