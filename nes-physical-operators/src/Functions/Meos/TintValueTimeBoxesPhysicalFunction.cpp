...
#include <Functions/Meos/TintValueTimeBoxesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintValueTimeBoxesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintValueTimeBoxesPhysicalFunction::TintValueTimeBoxesPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TintValueTimeBoxesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg3Ptr, uint32_t arg3Size) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                TBox* arr = (TBox*) tint_value_time_boxes(temp, arg0, arg1B, arg2, arg3V, &_cnt);
                free(temp);
                free(arg1B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintValueTimeBoxesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TintValueTimeBoxesPhysicalFunction requires 6 children but got {}",
    ...
    return TintValueTimeBoxesPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
