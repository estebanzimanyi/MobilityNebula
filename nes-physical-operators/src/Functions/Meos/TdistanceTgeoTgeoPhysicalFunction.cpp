...
#include <Functions/Meos/TdistanceTgeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTgeoTgeoPhysicalFunction::TdistanceTgeoTgeoPhysicalFunction(PhysicalFunction trajFunction,
...
VarVal TdistanceTgeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto hexStr = nautilus::invoke(
        +[](const char* aPtr, uint32_t aSize, const char* bPtr, uint32_t bSize) -> char*
        {
            try
            {
                ...
                Temporal* res = tdistance_tgeo_tgeo(a, b);
                free(a);
                free(b);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTgeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TdistanceTgeoTgeoPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TdistanceTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1));
}
