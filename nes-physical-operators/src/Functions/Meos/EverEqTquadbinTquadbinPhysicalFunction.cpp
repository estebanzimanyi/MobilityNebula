...
EverEqTquadbinTquadbinPhysicalFunction::EverEqTquadbinTquadbinPhysicalFunction(PhysicalFunction cellFunction,
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t cell,
            ...
            try
            {
                ...
                double r = ever_eq_tquadbin_tquadbin(temp, inst0);
                free(temp);
                free(inst0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTquadbinTquadbinPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
