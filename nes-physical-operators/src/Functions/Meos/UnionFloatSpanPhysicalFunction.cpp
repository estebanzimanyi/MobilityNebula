...
#include <Functions/Meos/UnionFloatSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionFloatSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionFloatSpanPhysicalFunction::UnionFloatSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionFloatSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_float_span(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionFloatSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionFloatSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionFloatSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
