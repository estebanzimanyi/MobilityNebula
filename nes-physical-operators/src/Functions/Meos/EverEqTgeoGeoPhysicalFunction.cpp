...
EverEqTgeoGeoPhysicalFunction::EverEqTgeoGeoPhysicalFunction(PhysicalFunction lon, PhysicalFunction lat,
    ...
    const auto result = nautilus::invoke(
        +[](double lon, double lat, uint64_t ts,
            ...
            try {
                ...
                double r = ever_eq_tgeo_geo(tgeo, gs) > 0 ? 1.0 : 0.0;
                free(tgeo); free(gs);
                return r;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTgeoGeoPhysicalFunction(std::move(arguments.childFunctions[0]),
