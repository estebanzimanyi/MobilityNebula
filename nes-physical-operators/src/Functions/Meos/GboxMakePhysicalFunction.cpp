...
#include <Functions/Meos/GboxMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGboxMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GboxMakePhysicalFunction::GboxMakePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal GboxMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg5) -> char*
        {
            try
            {
                ...
                GBOX* res = (GBOX*) gbox_make(temp, arg0, arg1, arg2, arg3, arg4, arg5);
                if (!res) return (char*) nullptr;
                char* outStr = gbox_out(res, 15);
                free(res);
                return outStr;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGboxMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 7,
                 "GboxMakePhysicalFunction requires 7 children but got {}",
    ...
    return GboxMakePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
