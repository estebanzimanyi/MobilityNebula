...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDivTintIntPhysicalFunction(PhysicalFunctionRegistryArguments); }
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = div_tint_int(temp, arg0);
                free(temp);
