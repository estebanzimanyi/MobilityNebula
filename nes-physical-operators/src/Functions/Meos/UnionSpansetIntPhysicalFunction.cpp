...
#include <Functions/Meos/UnionSpansetIntPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionSpansetIntPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionSpansetIntPhysicalFunction::UnionSpansetIntPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionSpansetIntPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_spanset_int(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionSpansetIntPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionSpansetIntPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionSpansetIntPhysicalFunction(std::move(arg0), std::move(arg1));
}
