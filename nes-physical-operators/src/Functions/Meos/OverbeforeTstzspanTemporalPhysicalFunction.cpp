...
#include <Functions/Meos/OverbeforeTstzspanTemporalPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbeforeTstzspanTemporalPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbeforeTstzspanTemporalPhysicalFunction::OverbeforeTstzspanTemporalPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal OverbeforeTstzspanTemporalPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = overbefore_tstzspan_temporal(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbeforeTstzspanTemporalPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "OverbeforeTstzspanTemporalPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return OverbeforeTstzspanTemporalPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
