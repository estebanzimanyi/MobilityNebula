...
SubBigintTbigintPhysicalFunction::SubBigintTbigintPhysicalFunction(PhysicalFunction trajFunction,
    ...
    auto hexStr = nautilus::invoke(
        +[](const char* aPtr, uint32_t aSize, int64_t s) -> char*
        {
            try
            {
                ...
                Temporal* res = sub_bigint_tbigint(s, a);
                free(a);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SubBigintTbigintPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SubBigintTbigintPhysicalFunction(std::move(arg0), std::move(arg1));
}
