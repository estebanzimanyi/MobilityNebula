...
#include <Functions/Meos/NumspanTimestamptzToTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNumspanTimestamptzToTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NumspanTimestamptzToTboxPhysicalFunction::NumspanTimestamptzToTboxPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NumspanTimestamptzToTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                TBox* res = numspan_timestamptz_to_tbox(temp, arg0V);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNumspanTimestamptzToTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NumspanTimestamptzToTboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NumspanTimestamptzToTboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
