...
#include <Functions/Meos/TemporalInsertPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalInsertPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalInsertPhysicalFunction::TemporalInsertPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalInsertPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg1) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_insert(temp, arg0t, arg1);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalInsertPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalInsertPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalInsertPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
