...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgtIntTintPhysicalFunction(PhysicalFunctionRegistryArguments); }
