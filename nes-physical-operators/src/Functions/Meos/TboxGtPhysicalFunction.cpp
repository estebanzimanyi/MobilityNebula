...
#include <Functions/Meos/TboxGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboxGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboxGtPhysicalFunction::TboxGtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TboxGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboxGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TboxGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TboxGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
