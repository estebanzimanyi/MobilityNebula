...
#include <Functions/Meos/NadTboxintTboxintPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTboxintTboxintPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTboxintTboxintPhysicalFunction::NadTboxintTboxintPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NadTboxintTboxintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = nad_tboxint_tboxint(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTboxintTboxintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NadTboxintTboxintPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NadTboxintTboxintPhysicalFunction(std::move(arg0), std::move(arg1));
}
