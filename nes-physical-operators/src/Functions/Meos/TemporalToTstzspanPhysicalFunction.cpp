...
#include <Functions/Meos/TemporalToTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalToTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalToTstzspanPhysicalFunction::TemporalToTstzspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalToTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                Span* res = temporal_to_tstzspan(temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalToTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TemporalToTstzspanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TemporalToTstzspanPhysicalFunction(std::move(arg0), std::move(arg1));
}
