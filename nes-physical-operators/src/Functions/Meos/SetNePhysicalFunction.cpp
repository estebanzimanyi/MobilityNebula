...
#include <Functions/Meos/SetNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSetNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SetNePhysicalFunction::SetNePhysicalFunction(PhysicalFunction litFunction,
...
VarVal SetNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSetNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SetNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SetNePhysicalFunction(std::move(arg0), std::move(arg1));
}
