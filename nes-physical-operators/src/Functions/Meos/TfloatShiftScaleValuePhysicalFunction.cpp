...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatShiftScaleValuePhysicalFunction(PhysicalFunctionRegistryArguments); }
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tfloat_shift_scale_value(temp, arg0, arg1);
                free(temp);
