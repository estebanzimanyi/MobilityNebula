...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomDwithin2dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomDwithin2dPhysicalFunction::GeomDwithin2dPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geom_dwithin2d(temp, arg0G.getGeometry(), 2.0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeomDwithin2dPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeomDwithin2dPhysicalFunction(std::move(arg0), std::move(arg1));
}
