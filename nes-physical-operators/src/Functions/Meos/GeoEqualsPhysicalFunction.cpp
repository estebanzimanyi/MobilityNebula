...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeoEqualsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeoEqualsPhysicalFunction::GeoEqualsPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geo_equals(temp, arg0G.getGeometry());
                return r;
            }
