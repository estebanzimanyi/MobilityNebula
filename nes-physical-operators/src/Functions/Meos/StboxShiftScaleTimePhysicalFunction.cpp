...
#include <Functions/Meos/StboxShiftScaleTimePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxShiftScaleTimePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxShiftScaleTimePhysicalFunction::StboxShiftScaleTimePhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxShiftScaleTimePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                STBox* res = (STBox*) stbox_shift_scale_time(temp, arg0B, arg1B);
                free(temp);
                free(arg0B);
                free(arg1B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxShiftScaleTimePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "StboxShiftScaleTimePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return StboxShiftScaleTimePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
