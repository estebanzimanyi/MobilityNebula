...
#include <Functions/Meos/TfloatValueSplitPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatValueSplitPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TfloatValueSplitPhysicalFunction::TfloatValueSplitPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TfloatValueSplitPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                double * _aux = nullptr;
                Temporal ** arr = (Temporal **) tfloat_value_split(temp, arg0, arg1, &_aux, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTfloatValueSplitPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TfloatValueSplitPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TfloatValueSplitPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
