...
#include <Functions/Meos/TemporalDeleteTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalDeleteTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalDeleteTimestamptzPhysicalFunction::TemporalDeleteTimestamptzPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalDeleteTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_delete_timestamptz(temp, arg0V, false);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalDeleteTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalDeleteTimestamptzPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalDeleteTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
