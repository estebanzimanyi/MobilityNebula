...
#include <Functions/Meos/BeforeTemporalTemporalPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBeforeTemporalTemporalPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BeforeTemporalTemporalPhysicalFunction::BeforeTemporalTemporalPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal BeforeTemporalTemporalPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return before_temporal_temporal(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBeforeTemporalTemporalPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "BeforeTemporalTemporalPhysicalFunction requires 6 children but got {}",
    ...
    return BeforeTemporalTemporalPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
