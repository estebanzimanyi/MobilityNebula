...
#include <Functions/Meos/TemporalADWithinTCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalADWithinTCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalADWithinTCbufferCbufferPhysicalFunction::TemporalADWithinTCbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalADWithinTCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue, double latValue, double radiusValue, uint64_t timestampValue,
            ...
            try
            {
                ...
                int r = adwithin_tcbuffer_cbuffer(tcbuffer, cb, distValue);
                free(tcbuffer);
                free(cb);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalADWithinTCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalADWithinTCbufferCbufferPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalADWithinTCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
