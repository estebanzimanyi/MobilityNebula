...
TneTemporalTemporalPhysicalFunction::TneTemporalTemporalPhysicalFunction(PhysicalFunction trajFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* trajPtr, uint32_t trajSize,
            ...
            try
            {
                ...
                bool r = tne_temporal_temporal(temp, arg0T);
                free(temp);
                free(arg0T);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TneTemporalTemporalPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TneTemporalTemporalPhysicalFunction(std::move(arg0), std::move(arg1));
}
