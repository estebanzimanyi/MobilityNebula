...
#include <Functions/Meos/DistanceTstzspansetTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceTstzspansetTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceTstzspansetTstzspanPhysicalFunction::DistanceTstzspansetTstzspanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceTstzspansetTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_tstzspanset_tstzspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceTstzspansetTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceTstzspansetTstzspanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceTstzspansetTstzspanPhysicalFunction(std::move(arg0), std::move(arg1));
}
