...
#include <Functions/Meos/UnionSetFloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionSetFloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionSetFloatPhysicalFunction::UnionSetFloatPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionSetFloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Set* res = union_set_float(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionSetFloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionSetFloatPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionSetFloatPhysicalFunction(std::move(arg0), std::move(arg1));
}
