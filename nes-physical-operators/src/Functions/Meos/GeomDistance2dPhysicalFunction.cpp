...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomDistance2dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomDistance2dPhysicalFunction::GeomDistance2dPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = geom_distance2d(temp, arg0G.getGeometry());
                return r;
            }
