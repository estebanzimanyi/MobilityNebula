...
#include <Functions/Meos/OverbackTspatialTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbackTspatialTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbackTspatialTspatialPhysicalFunction::OverbackTspatialTspatialPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal OverbackTspatialTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = overback_tspatial_tspatial(temp, arg0t);
                free(temp);
                free(arg0t);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbackTspatialTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "OverbackTspatialTspatialPhysicalFunction requires 8 children but got {}",
    ...
    return OverbackTspatialTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
