...
#include <Functions/Meos/TimestamptzGetBinPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTimestamptzGetBinPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TimestamptzGetBinPhysicalFunction::TimestamptzGetBinPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TimestamptzGetBinPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](int64_t value,
            ...
            try
            {
                ...
                int64_t r = timestamptz_get_bin(temp, arg0B, arg1V);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTimestamptzGetBinPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TimestamptzGetBinPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TimestamptzGetBinPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
