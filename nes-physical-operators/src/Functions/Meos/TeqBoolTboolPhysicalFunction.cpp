...
#include <Functions/Meos/TeqBoolTboolPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTeqBoolTboolPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TeqBoolTboolPhysicalFunction::TeqBoolTboolPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TeqBoolTboolPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = teq_bool_tbool(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTeqBoolTboolPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TeqBoolTboolPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TeqBoolTboolPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
