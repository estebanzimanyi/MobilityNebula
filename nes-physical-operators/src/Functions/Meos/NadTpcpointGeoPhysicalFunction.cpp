...
#include <Functions/Meos/NadTpcpointGeoPhysicalFunction.hpp>
...
NadTpcpointGeoPhysicalFunction::NadTpcpointGeoPhysicalFunction(PhysicalFunction pt_hexwkbFunction,
...
VarVal NadTpcpointGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTpcpointGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "NadTpcpointGeoPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return NadTpcpointGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
