...
SubTnumberTnumberPhysicalFunction::SubTnumberTnumberPhysicalFunction(PhysicalFunction value1Function,
    ...
    const auto result = nautilus::invoke(
        +[](double value1, double value2, uint64_t ts) -> double {
            try {
                ...
                Temporal* res = sub_tnumber_tnumber(t1, t2);
                free(t1); free(t2);
                if (!res) return 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "SubTnumberTnumberPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return SubTnumberTnumberPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
