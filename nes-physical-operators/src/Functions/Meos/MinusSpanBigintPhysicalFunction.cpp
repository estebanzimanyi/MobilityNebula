...
#include <Functions/Meos/MinusSpanBigintPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusSpanBigintPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusSpanBigintPhysicalFunction::MinusSpanBigintPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusSpanBigintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = minus_span_bigint(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusSpanBigintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusSpanBigintPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusSpanBigintPhysicalFunction(std::move(arg0), std::move(arg1));
}
