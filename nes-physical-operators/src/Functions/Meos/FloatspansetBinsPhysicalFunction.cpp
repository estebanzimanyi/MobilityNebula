...
#include <Functions/Meos/FloatspansetBinsPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatspansetBinsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatspansetBinsPhysicalFunction::FloatspansetBinsPhysicalFunction(PhysicalFunction litFunction,
...
VarVal FloatspansetBinsPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) floatspanset_bins(temp, arg0, arg1, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterFloatspansetBinsPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "FloatspansetBinsPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return FloatspansetBinsPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
