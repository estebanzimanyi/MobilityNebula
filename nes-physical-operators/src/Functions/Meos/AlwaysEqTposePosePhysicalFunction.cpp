...
AlwaysEqTposePosePhysicalFunction::AlwaysEqTposePosePhysicalFunction(PhysicalFunction x, PhysicalFunction y, PhysicalFunction theta, PhysicalFunction ts, PhysicalFunction x2, PhysicalFunction y2, PhysicalFunction theta2)
{
    paramFns.reserve(7);
    ...
    const auto result = nautilus::invoke(
        +[](double x, double y, double theta, uint64_t ts, double x2, double y2, double theta2) -> double {
            try {
                ...
                int r = always_eq_tpose_pose(inst, pose2);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysEqTposePosePhysicalFunction(
