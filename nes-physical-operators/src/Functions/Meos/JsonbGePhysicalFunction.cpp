...
#include <Functions/Meos/JsonbGePhysicalFunction.hpp>
...
JsonbGePhysicalFunction::JsonbGePhysicalFunction(PhysicalFunction jbFunction,
...
VarVal JsonbGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterJsonbGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "JsonbGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return JsonbGePhysicalFunction(std::move(arg0), std::move(arg1));
}
