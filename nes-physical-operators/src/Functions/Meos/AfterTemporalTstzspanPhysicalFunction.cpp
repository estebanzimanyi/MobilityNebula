...
#include <Functions/Meos/AfterTemporalTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAfterTemporalTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AfterTemporalTstzspanPhysicalFunction::AfterTemporalTstzspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal AfterTemporalTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = after_temporal_tstzspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAfterTemporalTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AfterTemporalTstzspanPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AfterTemporalTstzspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
