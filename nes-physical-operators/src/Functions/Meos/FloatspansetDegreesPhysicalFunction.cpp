...
#include <Functions/Meos/FloatspansetDegreesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatspansetDegreesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatspansetDegreesPhysicalFunction::FloatspansetDegreesPhysicalFunction(PhysicalFunction litFunction,
...
VarVal FloatspansetDegreesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = (SpanSet*) floatspanset_degrees(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterFloatspansetDegreesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "FloatspansetDegreesPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return FloatspansetDegreesPhysicalFunction(std::move(arg0), std::move(arg1));
}
