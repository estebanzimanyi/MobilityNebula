...
#include <Functions/Meos/UnionFloatSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionFloatSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionFloatSpansetPhysicalFunction::UnionFloatSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionFloatSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_float_spanset(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionFloatSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionFloatSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionFloatSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
