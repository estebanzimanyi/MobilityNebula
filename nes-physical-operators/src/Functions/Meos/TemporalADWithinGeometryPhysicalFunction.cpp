...
#include <Functions/Meos/TemporalADWithinGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalADWithinGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalADWithinGeometryPhysicalFunction::TemporalADWithinGeometryPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalADWithinGeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalADWithinGeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalADWithinGeometryPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalADWithinGeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
