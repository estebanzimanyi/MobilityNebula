...
#include <Functions/Meos/TtextinstMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextinstMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtextinstMakePhysicalFunction::TtextinstMakePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TtextinstMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) ttextinst_make(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtextinstMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TtextinstMakePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TtextinstMakePhysicalFunction(std::move(arg0), std::move(arg1));
}
