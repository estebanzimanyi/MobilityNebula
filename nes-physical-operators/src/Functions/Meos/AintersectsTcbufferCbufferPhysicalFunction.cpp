...
AintersectsTcbufferCbufferPhysicalFunction::AintersectsTcbufferCbufferPhysicalFunction(
    ...
    const auto result = nautilus::invoke(
        +[](double lon1, double lat1, double r1, uint64_t ts,
            ...
            try {
                ...
                int r = aintersects_tcbuffer_cbuffer(tcb_inst, cb2);
                free(tcb_inst);
                free(cb2);
                return r > 0 ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 7,
                 "AintersectsTcbufferCbufferPhysicalFunction requires 7 children but got {}",
                 arguments.childFunctions.size());
    return AintersectsTcbufferCbufferPhysicalFunction(std::move(arguments.childFunctions[0]),
