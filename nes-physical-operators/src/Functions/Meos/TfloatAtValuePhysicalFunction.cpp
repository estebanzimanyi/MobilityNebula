...
#include <Functions/Meos/TfloatAtValuePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatAtValuePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TfloatAtValuePhysicalFunction::TfloatAtValuePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TfloatAtValuePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = tfloat_at_value(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTfloatAtValuePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TfloatAtValuePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TfloatAtValuePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
