...
#include <Functions/Meos/BigintspansetShiftScalePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBigintspansetShiftScalePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BigintspansetShiftScalePhysicalFunction::BigintspansetShiftScalePhysicalFunction(PhysicalFunction litFunction,
...
VarVal BigintspansetShiftScalePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg1) -> char*
        {
            try
            {
                ...
                SpanSet* res = bigintspanset_shift_scale(temp, arg0, arg1, true, true);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBigintspansetShiftScalePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "BigintspansetShiftScalePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return BigintspansetShiftScalePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
