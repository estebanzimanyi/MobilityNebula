...
#include <Functions/Meos/UnionTimestamptzSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionTimestamptzSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionTimestamptzSpansetPhysicalFunction::UnionTimestamptzSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionTimestamptzSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_timestamptz_spanset(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionTimestamptzSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionTimestamptzSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionTimestamptzSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
