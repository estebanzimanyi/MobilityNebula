...
IntspanMakePhysicalFunction::IntspanMakePhysicalFunction(PhysicalFunction lower, PhysicalFunction upper, PhysicalFunction lower_inc, PhysicalFunction upper_inc) {
    paramFns.reserve(4);
    ...
    const auto actualLen = nautilus::invoke(
        +[](double lo, double hi, double lo_inc, double hi_inc,
            ...
            try {
                ...
                Span* sp = intspan_make((int)lo, (int)hi,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return IntspanMakePhysicalFunction(
