...
#include <Functions/Meos/TspatialSetSridPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTspatialSetSridPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TspatialSetSridPhysicalFunction::TspatialSetSridPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TspatialSetSridPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tspatial_set_srid(temp, 4326);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTspatialSetSridPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TspatialSetSridPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TspatialSetSridPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
