...
EverNeTposeTposePhysicalFunction::EverNeTposeTposePhysicalFunction(PhysicalFunction xFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                double r = ever_ne_tpose_tpose(temp, inst0);
                free(temp);
                free(inst0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "EverNeTposeTposePhysicalFunction requires 8 children but got {}",
    ...
    return EverNeTposeTposePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
