...
#include <Functions/Meos/TemporalMaxInstantPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalMaxInstantPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalMaxInstantPhysicalFunction::TemporalMaxInstantPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalMaxInstantPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_max_instant(temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalMaxInstantPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TemporalMaxInstantPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TemporalMaxInstantPhysicalFunction(std::move(arg0), std::move(arg1));
}
