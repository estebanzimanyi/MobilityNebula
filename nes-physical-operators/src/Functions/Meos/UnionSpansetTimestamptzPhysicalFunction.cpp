...
#include <Functions/Meos/UnionSpansetTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionSpansetTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionSpansetTimestamptzPhysicalFunction::UnionSpansetTimestamptzPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionSpansetTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_spanset_timestamptz(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionSpansetTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionSpansetTimestamptzPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionSpansetTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1));
}
