...
#include <Functions/Meos/TbigintShiftValuePhysicalFunction.hpp>
...
TbigintShiftValuePhysicalFunction::TbigintShiftValuePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TbigintShiftValuePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value, uint64_t ts, double shift_d) -> double {
            try {
                ...
                if (!temp) return 0.0;
                Temporal* res = tbigint_shift_value(temp, static_cast<int64_t>(shift_d));
                free(temp);
                if (!res) return 0.0;
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTbigintShiftValuePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TbigintShiftValuePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TbigintShiftValuePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
