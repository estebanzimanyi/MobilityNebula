...
#include <Functions/Meos/FloatTimestamptzToTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatTimestamptzToTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatTimestamptzToTboxPhysicalFunction::FloatTimestamptzToTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal FloatTimestamptzToTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                TBox* res = float_timestamptz_to_tbox(temp, arg0V);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterFloatTimestamptzToTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "FloatTimestamptzToTboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return FloatTimestamptzToTboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
