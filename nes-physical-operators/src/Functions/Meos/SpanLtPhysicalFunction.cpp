...
#include <Functions/Meos/SpanLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpanLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpanLtPhysicalFunction::SpanLtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpanLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpanLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpanLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpanLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
