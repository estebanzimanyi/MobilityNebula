...
MulBigintTbigintPhysicalFunction::MulBigintTbigintPhysicalFunction(PhysicalFunction trajFunction,
    ...
    auto hexStr = nautilus::invoke(
        +[](const char* aPtr, uint32_t aSize, int64_t s) -> char*
        {
            try
            {
                ...
                Temporal* res = mul_bigint_tbigint(s, a);
                free(a);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MulBigintTbigintPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MulBigintTbigintPhysicalFunction(std::move(arg0), std::move(arg1));
}
