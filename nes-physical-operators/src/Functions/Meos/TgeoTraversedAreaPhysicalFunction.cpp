...
#include <Functions/Meos/TgeoTraversedAreaPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgeoTraversedAreaPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgeoTraversedAreaPhysicalFunction::TgeoTraversedAreaPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TgeoTraversedAreaPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg0 = parameterValues[3].cast<nautilus::val<bool>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) tgeo_traversed_area(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTgeoTraversedAreaPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TgeoTraversedAreaPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TgeoTraversedAreaPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
