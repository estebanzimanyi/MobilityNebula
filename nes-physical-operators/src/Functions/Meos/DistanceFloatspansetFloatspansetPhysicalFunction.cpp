...
#include <Functions/Meos/DistanceFloatspansetFloatspansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceFloatspansetFloatspansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceFloatspansetFloatspansetPhysicalFunction::DistanceFloatspansetFloatspansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceFloatspansetFloatspansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                SpanSet* arg0B = floatspanset_in(arg0S.c_str());
                if (!arg0B) { free(temp); return 0.0; }

                double r = distance_floatspanset_floatspanset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceFloatspansetFloatspansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceFloatspansetFloatspansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceFloatspansetFloatspansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
