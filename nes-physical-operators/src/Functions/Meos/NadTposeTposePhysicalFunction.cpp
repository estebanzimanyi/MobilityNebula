...
NadTposeTposePhysicalFunction::NadTposeTposePhysicalFunction(
    ...
    const auto result = nautilus::invoke(
        +[](double x1, double y1, double theta1, uint64_t ts1,
            ...
            try {
                ...
                double r = nad_tpose_tpose(inst1, inst2);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return NadTposeTposePhysicalFunction(std::move(arguments.childFunctions[0]),
