...
#include <Functions/Meos/AlwaysNeTtextTextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysNeTtextTextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysNeTtextTextPhysicalFunction::AlwaysNeTtextTextPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal AlwaysNeTtextTextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* valuePtr, uint32_t valueSize,
            ...
            try
            {
                ...
                int r = always_ne_ttext_text(temp, arg0T);
                free(temp);
                free(arg0T);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysNeTtextTextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AlwaysNeTtextTextPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AlwaysNeTtextTextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
