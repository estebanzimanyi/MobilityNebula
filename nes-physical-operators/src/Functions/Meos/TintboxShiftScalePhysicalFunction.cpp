...
#include <Functions/Meos/TintboxShiftScalePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintboxShiftScalePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintboxShiftScalePhysicalFunction::TintboxShiftScalePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TintboxShiftScalePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg3) -> char*
        {
            try
            {
                ...
                TBox* res = (TBox*) tintbox_shift_scale(temp, arg0, arg1, arg2, arg3);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintboxShiftScalePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TintboxShiftScalePhysicalFunction requires 5 children but got {}",
    ...
    return TintboxShiftScalePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
