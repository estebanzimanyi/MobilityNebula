...
#include <Functions/Meos/EverLeTbigintTbigintPhysicalFunction.hpp>
...
EverLeTbigintTbigintPhysicalFunction::EverLeTbigintTbigintPhysicalFunction(PhysicalFunction value1Function,
...
VarVal EverLeTbigintTbigintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double v1, double v2, uint64_t t) -> double {
            try {
                ...
                int r = ever_le_tbigint_tbigint(temp1, temp2);
                free(temp1);
                free(temp2);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverLeTbigintTbigintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverLeTbigintTbigintPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverLeTbigintTbigintPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
