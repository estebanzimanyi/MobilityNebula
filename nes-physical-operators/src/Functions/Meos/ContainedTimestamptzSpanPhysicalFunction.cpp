...
#include <Functions/Meos/ContainedTimestamptzSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedTimestamptzSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedTimestamptzSpanPhysicalFunction::ContainedTimestamptzSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal ContainedTimestamptzSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contained_timestamptz_span(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainedTimestamptzSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "ContainedTimestamptzSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return ContainedTimestamptzSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
