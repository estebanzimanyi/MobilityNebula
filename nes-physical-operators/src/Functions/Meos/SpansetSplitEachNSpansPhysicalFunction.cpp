...
#include <Functions/Meos/SpansetSplitEachNSpansPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetSplitEachNSpansPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetSplitEachNSpansPhysicalFunction::SpansetSplitEachNSpansPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetSplitEachNSpansPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) spanset_split_each_n_spans(temp, arg0, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetSplitEachNSpansPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetSplitEachNSpansPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetSplitEachNSpansPhysicalFunction(std::move(arg0), std::move(arg1));
}
