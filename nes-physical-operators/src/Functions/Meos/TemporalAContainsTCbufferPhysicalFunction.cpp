...
#include <Functions/Meos/TemporalAContainsTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalAContainsTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalAContainsTCbufferPhysicalFunction::TemporalAContainsTCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalAContainsTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = acontains_tcbuffer_geo(tcbuffer, staticGeometry.getGeometry());
                free(tcbuffer);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalAContainsTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalAContainsTCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalAContainsTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
