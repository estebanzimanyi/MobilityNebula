...
#include <Functions/Meos/OverlapsTnumberNumspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverlapsTnumberNumspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverlapsTnumberNumspanPhysicalFunction::OverlapsTnumberNumspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal OverlapsTnumberNumspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = overlaps_tnumber_numspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverlapsTnumberNumspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "OverlapsTnumberNumspanPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return OverlapsTnumberNumspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
