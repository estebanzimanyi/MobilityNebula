...
#include <Functions/Meos/DistanceFloatspansetFloatspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceFloatspansetFloatspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceFloatspansetFloatspanPhysicalFunction::DistanceFloatspansetFloatspanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceFloatspansetFloatspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_floatspanset_floatspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceFloatspansetFloatspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceFloatspansetFloatspanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceFloatspansetFloatspanPhysicalFunction(std::move(arg0), std::move(arg1));
}
