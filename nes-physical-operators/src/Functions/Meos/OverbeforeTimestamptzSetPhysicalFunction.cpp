...
#include <Functions/Meos/OverbeforeTimestamptzSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbeforeTimestamptzSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbeforeTimestamptzSetPhysicalFunction::OverbeforeTimestamptzSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal OverbeforeTimestamptzSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = overbefore_timestamptz_set(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbeforeTimestamptzSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverbeforeTimestamptzSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverbeforeTimestamptzSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
