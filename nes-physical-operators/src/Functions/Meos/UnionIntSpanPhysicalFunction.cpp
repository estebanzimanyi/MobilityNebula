...
#include <Functions/Meos/UnionIntSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionIntSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionIntSpanPhysicalFunction::UnionIntSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionIntSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_int_span(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionIntSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionIntSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionIntSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
