...
#include <Functions/Meos/RightSpansetSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterRightSpansetSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

RightSpansetSpansetPhysicalFunction::RightSpansetSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal RightSpansetSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = right_spanset_spanset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterRightSpansetSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "RightSpansetSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return RightSpansetSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
