...
#include <Functions/Meos/OverbeforeTimestamptzSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbeforeTimestamptzSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbeforeTimestamptzSpansetPhysicalFunction::OverbeforeTimestamptzSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal OverbeforeTimestamptzSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = overbefore_timestamptz_spanset(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbeforeTimestamptzSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverbeforeTimestamptzSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverbeforeTimestamptzSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
