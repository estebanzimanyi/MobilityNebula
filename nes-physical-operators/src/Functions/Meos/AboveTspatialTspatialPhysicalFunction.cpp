...
#include <Functions/Meos/AboveTspatialTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAboveTspatialTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AboveTspatialTspatialPhysicalFunction::AboveTspatialTspatialPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal AboveTspatialTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return above_tspatial_tspatial(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAboveTspatialTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "AboveTspatialTspatialPhysicalFunction requires 6 children but got {}",
    ...
    return AboveTspatialTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
