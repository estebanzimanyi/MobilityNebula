...
#include <Functions/Meos/TemporalNADTPoseTPosePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalNADTPoseTPosePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalNADTPoseTPosePhysicalFunction::TemporalNADTPoseTPosePhysicalFunction(PhysicalFunction xAFunction,
...
VarVal TemporalNADTPoseTPosePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double xAValue, double yAValue, double thetaAValue, uint64_t tsAValue,
            double xBValue, double yBValue, double thetaBValue, uint64_t tsBValue) -> double {
            try
            {
                ...
                double r = nad_tgeo_tgeo(tgeoA, tgeoB);
                free(tgeoB);
                free(tposeB);
                free(tgeoA);
                free(tposeA);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalNADTPoseTPosePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "TemporalNADTPoseTPosePhysicalFunction requires 8 children but got {}",
    ...
    return TemporalNADTPoseTPosePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
