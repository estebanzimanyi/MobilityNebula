...
#include <Functions/Meos/FrontTspatialStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFrontTspatialStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }
...
VarVal FrontTspatialStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
