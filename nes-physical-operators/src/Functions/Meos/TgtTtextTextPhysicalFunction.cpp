...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgtTtextTextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgtTtextTextPhysicalFunction::TgtTtextTextPhysicalFunction(PhysicalFunction valueFunction,
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tgt_ttext_text(temp, arg0T);
                free(temp);
                free(arg0T);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return TgtTtextTextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
