...
#include <Functions/Meos/TboolMinusValuePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboolMinusValuePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboolMinusValuePhysicalFunction::TboolMinusValuePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TboolMinusValuePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = tbool_minus_value(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboolMinusValuePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TboolMinusValuePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TboolMinusValuePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
