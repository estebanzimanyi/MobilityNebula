...
#include <Functions/Meos/OverbeforeTimestamptzSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbeforeTimestamptzSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbeforeTimestamptzSpanPhysicalFunction::OverbeforeTimestamptzSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal OverbeforeTimestamptzSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = overbefore_timestamptz_span(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbeforeTimestamptzSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverbeforeTimestamptzSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverbeforeTimestamptzSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
