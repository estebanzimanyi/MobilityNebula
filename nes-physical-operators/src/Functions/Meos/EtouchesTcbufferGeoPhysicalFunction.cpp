...
EtouchesTcbufferGeoPhysicalFunction::EtouchesTcbufferGeoPhysicalFunction(PhysicalFunction lon, PhysicalFunction lat,
    ...
    const auto result = nautilus::invoke(
        +[](double lon, double lat, double radius, uint64_t ts,
            ...
            try {
                ...
                int r = etouches_tcbuffer_geo(tcb_inst, target_gs);
                free(tcb_inst);
                free(target_gs);
                return r > 0 ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EtouchesTcbufferGeoPhysicalFunction(std::move(arguments.childFunctions[0]),
