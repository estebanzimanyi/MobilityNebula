...
#include <Functions/Meos/OverafterTimestamptzSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverafterTimestamptzSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverafterTimestamptzSpanPhysicalFunction::OverafterTimestamptzSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal OverafterTimestamptzSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = overafter_timestamptz_span(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverafterTimestamptzSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverafterTimestamptzSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverafterTimestamptzSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
