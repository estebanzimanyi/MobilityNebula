...
#include <Functions/Meos/AdjacentTspatialTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAdjacentTspatialTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AdjacentTspatialTspatialPhysicalFunction::AdjacentTspatialTspatialPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal AdjacentTspatialTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return adjacent_tspatial_tspatial(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdjacentTspatialTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "AdjacentTspatialTspatialPhysicalFunction requires 6 children but got {}",
    ...
    return AdjacentTspatialTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
