...
#include <Functions/Meos/ContainedTemporalTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedTemporalTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedTemporalTstzspanPhysicalFunction::ContainedTemporalTstzspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal ContainedTemporalTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = contained_temporal_tstzspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainedTemporalTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "ContainedTemporalTstzspanPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return ContainedTemporalTstzspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
