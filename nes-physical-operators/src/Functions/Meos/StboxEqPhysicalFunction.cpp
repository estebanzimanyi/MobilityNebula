...
#include <Functions/Meos/StboxEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxEqPhysicalFunction::StboxEqPhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
