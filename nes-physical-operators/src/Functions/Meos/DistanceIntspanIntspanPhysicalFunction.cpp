...
#include <Functions/Meos/DistanceIntspanIntspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceIntspanIntspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceIntspanIntspanPhysicalFunction::DistanceIntspanIntspanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceIntspanIntspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = distance_intspan_intspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceIntspanIntspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceIntspanIntspanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceIntspanIntspanPhysicalFunction(std::move(arg0), std::move(arg1));
}
