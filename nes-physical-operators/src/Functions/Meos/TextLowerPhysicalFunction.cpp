...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTextLowerPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TextLowerPhysicalFunction::TextLowerPhysicalFunction(PhysicalFunction litFunction)
{
