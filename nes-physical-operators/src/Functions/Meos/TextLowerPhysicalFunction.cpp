...
TextLowerPhysicalFunction::TextLowerPhysicalFunction(PhysicalFunction str)
{
    paramFns.reserve(1);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size()==1,
                 "TextLowerPhysicalFunction requires 1 child but got {}",
                 arguments.childFunctions.size());
    return TextLowerPhysicalFunction(std::move(arguments.childFunctions[0]));
}
