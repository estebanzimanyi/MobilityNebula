...
#include <Functions/Meos/TfloatboxShiftScalePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatboxShiftScalePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TfloatboxShiftScalePhysicalFunction::TfloatboxShiftScalePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TfloatboxShiftScalePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg3 = parameterValues[4].cast<nautilus::val<bool>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg3) -> char*
        {
            try
            {
                ...
                TBox* temp = tbox_in(tempS.c_str());
                if (!temp) return (char*) nullptr;

                TBox* res = (TBox*) tfloatbox_shift_scale(temp, arg0, arg1, arg2, arg3);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTfloatboxShiftScalePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TfloatboxShiftScalePhysicalFunction requires 5 children but got {}",
    ...
    return TfloatboxShiftScalePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
