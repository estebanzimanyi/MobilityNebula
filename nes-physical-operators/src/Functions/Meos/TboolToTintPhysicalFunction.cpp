...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboolToTintPhysicalFunction(PhysicalFunctionRegistryArguments); }
