...
#include <Functions/Meos/TdisjointTgeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdisjointTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdisjointTgeoTgeoPhysicalFunction::TdisjointTgeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdisjointTgeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                Temporal* res = tdisjoint_tgeo_tgeo(temp, arg0t);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdisjointTgeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TdisjointTgeoTgeoPhysicalFunction requires 6 children but got {}",
    ...
    return TdisjointTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
