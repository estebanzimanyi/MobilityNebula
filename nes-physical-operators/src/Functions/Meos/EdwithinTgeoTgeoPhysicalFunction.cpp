...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEdwithinTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EdwithinTgeoTgeoPhysicalFunction::EdwithinTgeoTgeoPhysicalFunction(PhysicalFunction lonAFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EdwithinTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
