...
#include <Functions/Meos/TintTimeBoxesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintTimeBoxesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintTimeBoxesPhysicalFunction::TintTimeBoxesPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TintTimeBoxesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                TBox* arr = (TBox*) tint_time_boxes(temp, arg0B, arg1V, &_cnt);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintTimeBoxesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TintTimeBoxesPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TintTimeBoxesPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
