...
#include <Functions/Meos/StboxExpandTimePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxExpandTimePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxExpandTimePhysicalFunction::StboxExpandTimePhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxExpandTimePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                STBox* res = stbox_expand_time(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxExpandTimePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxExpandTimePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxExpandTimePhysicalFunction(std::move(arg0), std::move(arg1));
}
