...
#include <Functions/Meos/BigintsetShiftScalePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBigintsetShiftScalePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BigintsetShiftScalePhysicalFunction::BigintsetShiftScalePhysicalFunction(PhysicalFunction litFunction,
...
VarVal BigintsetShiftScalePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg1) -> char*
        {
            try
            {
                ...
                Set* res = bigintset_shift_scale(temp, arg0, arg1, true, true);
                free(temp);
                if (!res) return (char*) nullptr;
                char* outStr = bigintset_out(res);
                free(res);
                return outStr;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBigintsetShiftScalePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "BigintsetShiftScalePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return BigintsetShiftScalePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
