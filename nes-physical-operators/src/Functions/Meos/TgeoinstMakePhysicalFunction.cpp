...
#include <Functions/Meos/TgeoinstMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgeoinstMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgeoinstMakePhysicalFunction::TgeoinstMakePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TgeoinstMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tgeoinst_make(temp, arg0);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTgeoinstMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TgeoinstMakePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TgeoinstMakePhysicalFunction(std::move(arg0), std::move(arg1));
}
