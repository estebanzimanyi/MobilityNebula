...
#include <Functions/Meos/DistanceIntspansetIntspansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceIntspansetIntspansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceIntspansetIntspansetPhysicalFunction::DistanceIntspansetIntspansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceIntspansetIntspansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = distance_intspanset_intspanset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceIntspansetIntspansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceIntspansetIntspansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceIntspansetIntspansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
