...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextLowerPhysicalFunction(PhysicalFunctionRegistryArguments); }
