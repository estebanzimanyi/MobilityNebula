...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTeqIntTintPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TeqIntTintPhysicalFunction::TeqIntTintPhysicalFunction(PhysicalFunction valueFunction,
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = teq_int_tint(arg0, temp);
                free(temp);
