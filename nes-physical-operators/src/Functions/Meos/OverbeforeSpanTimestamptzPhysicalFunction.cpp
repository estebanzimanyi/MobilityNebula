...
#include <Functions/Meos/OverbeforeSpanTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbeforeSpanTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbeforeSpanTimestamptzPhysicalFunction::OverbeforeSpanTimestamptzPhysicalFunction(PhysicalFunction litFunction,
...
VarVal OverbeforeSpanTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = overbefore_span_timestamptz(temp, arg0V);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbeforeSpanTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "OverbeforeSpanTimestamptzPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return OverbeforeSpanTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1));
}
