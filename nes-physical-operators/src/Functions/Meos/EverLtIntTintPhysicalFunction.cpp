...
#include <Functions/Meos/EverLtIntTintPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverLtIntTintPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverLtIntTintPhysicalFunction::EverLtIntTintPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal EverLtIntTintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverLtIntTintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverLtIntTintPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverLtIntTintPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
