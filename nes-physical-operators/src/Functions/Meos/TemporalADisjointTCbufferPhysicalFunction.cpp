...
#include <Functions/Meos/TemporalADisjointTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalADisjointTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalADisjointTCbufferPhysicalFunction::TemporalADisjointTCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalADisjointTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = adisjoint_tcbuffer_geo(tcbuffer, staticGeometry.getGeometry());
                free(tcbuffer);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalADisjointTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalADisjointTCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalADisjointTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
