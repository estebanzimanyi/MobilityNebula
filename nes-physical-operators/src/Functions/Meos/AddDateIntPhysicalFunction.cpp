...
#include <Functions/Meos/AddDateIntPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAddDateIntPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AddDateIntPhysicalFunction::AddDateIntPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal AddDateIntPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                DateADT res = add_date_int(temp, arg0);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAddDateIntPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AddDateIntPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AddDateIntPhysicalFunction(std::move(arg0), std::move(arg1));
}
