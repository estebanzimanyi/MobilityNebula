...
AdisjointTgeoGeoPhysicalFunction::AdisjointTgeoGeoPhysicalFunction(PhysicalFunction lon, PhysicalFunction lat,
    ...
    const auto result = nautilus::invoke(
        +[](double lon, double lat, uint64_t ts,
            ...
            try {
                ...
                int r = adisjoint_tgeo_geo(tgeo, gs);
                free(tgeo); free(gs);
                return r > 0 ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AdisjointTgeoGeoPhysicalFunction(std::move(arguments.childFunctions[0]),
