...
EdisjointTgeoGeoPhysicalFunction::EdisjointTgeoGeoPhysicalFunction(PhysicalFunction lonFn, PhysicalFunction latFn,
    ...
    const auto result = nautilus::invoke(
        +[](double lon_v, double lat_v, uint64_t ts_v,
            ...
            try {
                ...
                int r = edisjoint_tgeo_geo(temp, gs);
                free(temp); free(gs);
                return r > 0 ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EdisjointTgeoGeoPhysicalFunction(
