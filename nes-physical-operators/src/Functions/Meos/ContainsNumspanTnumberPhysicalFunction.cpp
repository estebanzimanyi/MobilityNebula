...
#include <Functions/Meos/ContainsNumspanTnumberPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsNumspanTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsNumspanTnumberPhysicalFunction::ContainsNumspanTnumberPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal ContainsNumspanTnumberPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = contains_numspan_tnumber(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainsNumspanTnumberPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "ContainsNumspanTnumberPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return ContainsNumspanTnumberPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
