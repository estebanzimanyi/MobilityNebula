...
#include <Functions/Meos/FloatsetDegreesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatsetDegreesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatsetDegreesPhysicalFunction::FloatsetDegreesPhysicalFunction(PhysicalFunction litFunction,
...
VarVal FloatsetDegreesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                Set* res = (Set*) floatset_degrees(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterFloatsetDegreesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "FloatsetDegreesPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return FloatsetDegreesPhysicalFunction(std::move(arg0), std::move(arg1));
}
