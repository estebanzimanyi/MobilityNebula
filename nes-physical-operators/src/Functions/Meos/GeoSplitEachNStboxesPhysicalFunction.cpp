...
#include <Functions/Meos/GeoSplitEachNStboxesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeoSplitEachNStboxesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeoSplitEachNStboxesPhysicalFunction::GeoSplitEachNStboxesPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeoSplitEachNStboxesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                STBox* arr = (STBox*) geo_split_each_n_stboxes(temp, arg0, &_cnt);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeoSplitEachNStboxesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeoSplitEachNStboxesPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeoSplitEachNStboxesPhysicalFunction(std::move(arg0), std::move(arg1));
}
