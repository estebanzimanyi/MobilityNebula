...
GeogPointMake2dPhysicalFunction::GeogPointMake2dPhysicalFunction(PhysicalFunction sridFunction,
    ...
    const auto actualLen = nautilus::invoke(
        +[](uint64_t srid,
            ...
            try
            {
                ...
                GSERIALIZED* gres = geogpoint_make2d((int32_t)srid, x, y);
                if (!gres) return 0u;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return GeogPointMake2dPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
