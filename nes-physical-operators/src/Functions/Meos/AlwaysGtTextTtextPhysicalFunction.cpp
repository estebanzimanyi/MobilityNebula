...
#include <Functions/Meos/AlwaysGtTextTtextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysGtTextTtextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysGtTextTtextPhysicalFunction::AlwaysGtTextTtextPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal AlwaysGtTextTtextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* valuePtr, uint32_t valueSize,
            ...
            try
            {
                ...
                int r = always_gt_text_ttext(arg0T, temp);
                free(temp);
                free(arg0T);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysGtTextTtextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AlwaysGtTextTtextPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AlwaysGtTextTtextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
