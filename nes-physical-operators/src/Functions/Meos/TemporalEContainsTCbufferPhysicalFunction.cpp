...
#include <Functions/Meos/TemporalEContainsTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEContainsTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalEContainsTCbufferPhysicalFunction::TemporalEContainsTCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalEContainsTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = econtains_tcbuffer_geo(tcbuffer, staticGeometry.getGeometry());
                free(tcbuffer);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalEContainsTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalEContainsTCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalEContainsTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
