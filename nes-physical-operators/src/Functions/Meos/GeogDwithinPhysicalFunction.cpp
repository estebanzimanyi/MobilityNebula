...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeogDwithinPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeogDwithinPhysicalFunction::GeogDwithinPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geog_dwithin(temp, arg0G.getGeometry(), arg1, false);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return GeogDwithinPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
