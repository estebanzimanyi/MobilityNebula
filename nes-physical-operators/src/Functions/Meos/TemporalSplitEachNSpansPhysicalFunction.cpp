...
#include <Functions/Meos/TemporalSplitEachNSpansPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalSplitEachNSpansPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalSplitEachNSpansPhysicalFunction::TemporalSplitEachNSpansPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalSplitEachNSpansPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) temporal_split_each_n_spans(temp, arg0, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalSplitEachNSpansPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalSplitEachNSpansPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalSplitEachNSpansPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
