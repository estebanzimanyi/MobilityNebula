...
#include <Functions/Meos/DistanceTstzspanTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceTstzspanTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceTstzspanTstzspanPhysicalFunction::DistanceTstzspanTstzspanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceTstzspanTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_tstzspan_tstzspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceTstzspanTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceTstzspanTstzspanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceTstzspanTstzspanPhysicalFunction(std::move(arg0), std::move(arg1));
}
