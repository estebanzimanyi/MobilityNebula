...
#include <Functions/Meos/UnionFloatSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionFloatSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionFloatSetPhysicalFunction::UnionFloatSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionFloatSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Set* res = union_float_set(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionFloatSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionFloatSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionFloatSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
