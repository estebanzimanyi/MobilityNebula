...
#include <Functions/Meos/TemporalDeleteTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalDeleteTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalDeleteTstzspanPhysicalFunction::TemporalDeleteTstzspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalDeleteTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_delete_tstzspan(temp, arg0B, false);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalDeleteTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalDeleteTstzspanPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalDeleteTstzspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
