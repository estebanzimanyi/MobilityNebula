...
#include <Functions/Meos/TemporalAfterTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalAfterTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalAfterTimestamptzPhysicalFunction::TemporalAfterTimestamptzPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalAfterTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_after_timestamptz(temp, arg0V, false);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalAfterTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalAfterTimestamptzPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalAfterTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
