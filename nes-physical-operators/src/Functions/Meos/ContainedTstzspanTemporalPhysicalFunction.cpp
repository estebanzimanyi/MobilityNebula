...
#include <Functions/Meos/ContainedTstzspanTemporalPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedTstzspanTemporalPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedTstzspanTemporalPhysicalFunction::ContainedTstzspanTemporalPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal ContainedTstzspanTemporalPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = contained_tstzspan_temporal(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainedTstzspanTemporalPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "ContainedTstzspanTemporalPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return ContainedTstzspanTemporalPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
