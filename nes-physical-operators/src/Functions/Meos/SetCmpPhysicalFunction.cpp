...
#include <Functions/Meos/SetCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSetCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SetCmpPhysicalFunction::SetCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SetCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSetCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SetCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SetCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
