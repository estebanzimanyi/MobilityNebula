...
#include <Functions/Meos/SpanNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpanNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpanNePhysicalFunction::SpanNePhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpanNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpanNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpanNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpanNePhysicalFunction(std::move(arg0), std::move(arg1));
}
