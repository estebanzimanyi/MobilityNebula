...
#include <Functions/Meos/Rgeo/TneGeoTrgeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTneGeoTrgeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TneGeoTrgeometryPhysicalFunction::TneGeoTrgeometryPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TneGeoTrgeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tne_geo_trgeometry(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTneGeoTrgeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TneGeoTrgeometryPhysicalFunction requires 5 children but got {}",
    ...
    return TneGeoTrgeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
