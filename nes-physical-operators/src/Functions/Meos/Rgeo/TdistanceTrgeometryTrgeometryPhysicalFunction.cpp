...
#include <Functions/Meos/Rgeo/TdistanceTrgeometryTrgeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTrgeometryTrgeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTrgeometryTrgeometryPhysicalFunction::TdistanceTrgeometryTrgeometryPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TdistanceTrgeometryTrgeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tdistance_trgeometry_trgeometry(temp, arg0t);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTrgeometryTrgeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "TdistanceTrgeometryTrgeometryPhysicalFunction requires 8 children but got {}",
    ...
    return TdistanceTrgeometryTrgeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
