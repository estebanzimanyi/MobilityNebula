...
#include <Functions/Meos/Rgeo/TneTrgeometryGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTneTrgeometryGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TneTrgeometryGeoPhysicalFunction::TneTrgeometryGeoPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TneTrgeometryGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tne_trgeometry_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTneTrgeometryGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TneTrgeometryGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TneTrgeometryGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
