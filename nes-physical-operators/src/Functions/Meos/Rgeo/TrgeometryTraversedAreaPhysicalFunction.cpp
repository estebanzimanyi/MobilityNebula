...
#include <Functions/Meos/Rgeo/TrgeometryTraversedAreaPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTrgeometryTraversedAreaPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TrgeometryTraversedAreaPhysicalFunction::TrgeometryTraversedAreaPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TrgeometryTraversedAreaPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) trgeometry_traversed_area(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTrgeometryTraversedAreaPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TrgeometryTraversedAreaPhysicalFunction requires 5 children but got {}",
    ...
    return TrgeometryTraversedAreaPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
