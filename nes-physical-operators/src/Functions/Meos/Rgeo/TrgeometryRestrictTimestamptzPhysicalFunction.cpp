...
#include <Functions/Meos/Rgeo/TrgeometryRestrictTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTrgeometryRestrictTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TrgeometryRestrictTimestamptzPhysicalFunction::TrgeometryRestrictTimestamptzPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TrgeometryRestrictTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) trgeometry_restrict_timestamptz(temp, arg0V, true);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTrgeometryRestrictTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TrgeometryRestrictTimestamptzPhysicalFunction requires 5 children but got {}",
    ...
    return TrgeometryRestrictTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
