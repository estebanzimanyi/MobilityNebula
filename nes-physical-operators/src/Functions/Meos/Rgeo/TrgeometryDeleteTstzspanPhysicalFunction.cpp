...
#include <Functions/Meos/Rgeo/TrgeometryDeleteTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTrgeometryDeleteTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TrgeometryDeleteTstzspanPhysicalFunction::TrgeometryDeleteTstzspanPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TrgeometryDeleteTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) trgeometry_delete_tstzspan(temp, arg0B, false);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTrgeometryDeleteTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TrgeometryDeleteTstzspanPhysicalFunction requires 5 children but got {}",
    ...
    return TrgeometryDeleteTstzspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
