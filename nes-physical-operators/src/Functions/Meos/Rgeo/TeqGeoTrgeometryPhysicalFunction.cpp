...
#include <Functions/Meos/Rgeo/TeqGeoTrgeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTeqGeoTrgeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TeqGeoTrgeometryPhysicalFunction::TeqGeoTrgeometryPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TeqGeoTrgeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) teq_geo_trgeometry(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTeqGeoTrgeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TeqGeoTrgeometryPhysicalFunction requires 5 children but got {}",
    ...
    return TeqGeoTrgeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
