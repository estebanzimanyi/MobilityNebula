...
#include <Functions/Meos/Rgeo/TrgeometryDeleteTstzsetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTrgeometryDeleteTstzsetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TrgeometryDeleteTstzsetPhysicalFunction::TrgeometryDeleteTstzsetPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TrgeometryDeleteTstzsetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) trgeometry_delete_tstzset(temp, arg0B, false);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTrgeometryDeleteTstzsetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TrgeometryDeleteTstzsetPhysicalFunction requires 5 children but got {}",
    ...
    return TrgeometryDeleteTstzsetPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
