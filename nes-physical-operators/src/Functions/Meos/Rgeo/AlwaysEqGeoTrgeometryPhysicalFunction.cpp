...
#include <Functions/Meos/Rgeo/AlwaysEqGeoTrgeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysEqGeoTrgeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysEqGeoTrgeometryPhysicalFunction::AlwaysEqGeoTrgeometryPhysicalFunction(PhysicalFunction xFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                int r = always_eq_geo_trgeometry(arg0G.getGeometry(), temp);
                free(temp);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AlwaysEqGeoTrgeometryPhysicalFunction requires 5 children but got {}",
    ...
    return AlwaysEqGeoTrgeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
