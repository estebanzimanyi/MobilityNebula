...
#include <Functions/Meos/Rgeo/EverEqGeoTrgeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverEqGeoTrgeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverEqGeoTrgeometryPhysicalFunction::EverEqGeoTrgeometryPhysicalFunction(PhysicalFunction xFunction,
...
VarVal EverEqGeoTrgeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                int r = ever_eq_geo_trgeometry(arg0G.getGeometry(), temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverEqGeoTrgeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "EverEqGeoTrgeometryPhysicalFunction requires 5 children but got {}",
    ...
    return EverEqGeoTrgeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
