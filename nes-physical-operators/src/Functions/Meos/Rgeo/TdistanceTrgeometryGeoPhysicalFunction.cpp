...
#include <Functions/Meos/Rgeo/TdistanceTrgeometryGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTrgeometryGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTrgeometryGeoPhysicalFunction::TdistanceTrgeometryGeoPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TdistanceTrgeometryGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tdistance_trgeometry_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTrgeometryGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TdistanceTrgeometryGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TdistanceTrgeometryGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
