...
#include <Functions/Meos/Rgeo/AlwaysNeTrgeometryGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysNeTrgeometryGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysNeTrgeometryGeoPhysicalFunction::AlwaysNeTrgeometryGeoPhysicalFunction(PhysicalFunction xFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                int r = always_ne_trgeometry_geo(temp, arg0G.getGeometry());
                free(temp);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AlwaysNeTrgeometryGeoPhysicalFunction requires 5 children but got {}",
    ...
    return AlwaysNeTrgeometryGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
