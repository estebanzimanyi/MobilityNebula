...
#include <Functions/Meos/Rgeo/ShortestlineTrgeometryGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterShortestlineTrgeometryGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ShortestlineTrgeometryGeoPhysicalFunction::ShortestlineTrgeometryGeoPhysicalFunction(PhysicalFunction xFunction,
...
VarVal ShortestlineTrgeometryGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) shortestline_trgeometry_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterShortestlineTrgeometryGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "ShortestlineTrgeometryGeoPhysicalFunction requires 5 children but got {}",
    ...
    return ShortestlineTrgeometryGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
