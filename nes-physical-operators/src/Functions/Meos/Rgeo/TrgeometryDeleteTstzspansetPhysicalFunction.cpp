...
#include <Functions/Meos/Rgeo/TrgeometryDeleteTstzspansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTrgeometryDeleteTstzspansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TrgeometryDeleteTstzspansetPhysicalFunction::TrgeometryDeleteTstzspansetPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TrgeometryDeleteTstzspansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) trgeometry_delete_tstzspanset(temp, arg0B, false);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTrgeometryDeleteTstzspansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TrgeometryDeleteTstzspansetPhysicalFunction requires 5 children but got {}",
    ...
    return TrgeometryDeleteTstzspansetPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
