...
#include <Functions/Meos/Rgeo/TeqTrgeometryGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTeqTrgeometryGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TeqTrgeometryGeoPhysicalFunction::TeqTrgeometryGeoPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TeqTrgeometryGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) teq_trgeometry_geo(temp, arg0G.getGeometry());
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTeqTrgeometryGeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TeqTrgeometryGeoPhysicalFunction requires 5 children but got {}",
    ...
    return TeqTrgeometryGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
