...
#include <Functions/Meos/Rgeo/TrgeometryDeleteTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTrgeometryDeleteTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TrgeometryDeleteTimestamptzPhysicalFunction::TrgeometryDeleteTimestamptzPhysicalFunction(PhysicalFunction xFunction,
...
VarVal TrgeometryDeleteTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) trgeometry_delete_timestamptz(temp, arg0V, false);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTrgeometryDeleteTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TrgeometryDeleteTimestamptzPhysicalFunction requires 5 children but got {}",
    ...
    return TrgeometryDeleteTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
