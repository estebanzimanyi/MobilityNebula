...
#include <Functions/Meos/TemporalEDWithinTCbufferTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEDWithinTCbufferTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalEDWithinTCbufferTCbufferPhysicalFunction::TemporalEDWithinTCbufferTCbufferPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalEDWithinTCbufferTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalEDWithinTCbufferTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 9,
                 "TemporalEDWithinTCbufferTCbufferPhysicalFunction requires 9 children but got {}",
    ...
    return TemporalEDWithinTCbufferTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7), std::move(arg8));
}
