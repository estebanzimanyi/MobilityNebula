...
#include <Functions/Meos/IntspanExpandPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterIntspanExpandPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

IntspanExpandPhysicalFunction::IntspanExpandPhysicalFunction(PhysicalFunction litFunction,
...
VarVal IntspanExpandPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int arg0) -> char*
        {
            try
            {
                ...
                Span* res = (Span*) intspan_expand(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterIntspanExpandPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "IntspanExpandPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return IntspanExpandPhysicalFunction(std::move(arg0), std::move(arg1));
}
