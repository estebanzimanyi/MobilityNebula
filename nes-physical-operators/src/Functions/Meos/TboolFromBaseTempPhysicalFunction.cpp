...
#include <Functions/Meos/TboolFromBaseTempPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboolFromBaseTempPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboolFromBaseTempPhysicalFunction::TboolFromBaseTempPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TboolFromBaseTempPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg0 = parameterValues[2].cast<nautilus::val<bool>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tbool_from_base_temp(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboolFromBaseTempPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TboolFromBaseTempPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TboolFromBaseTempPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
