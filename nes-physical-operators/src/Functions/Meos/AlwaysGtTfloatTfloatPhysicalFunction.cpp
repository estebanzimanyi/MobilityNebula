...
#include <Functions/Meos/AlwaysGtTfloatTfloatPhysicalFunction.hpp>
...
AlwaysGtTfloatTfloatPhysicalFunction::AlwaysGtTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal AlwaysGtTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double v1, double v2, uint64_t t) -> double {
            try {
                ...
                int r = always_gt_tfloat_tfloat(temp1, temp2);
                free(temp1);
                free(temp2);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysGtTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AlwaysGtTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AlwaysGtTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
