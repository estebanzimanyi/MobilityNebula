...
#include <Functions/Meos/TemporalLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalLtPhysicalFunction::TemporalLtPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return temporal_lt(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalLtPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalLtPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
