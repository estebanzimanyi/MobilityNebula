...
#include <Functions/Meos/TemporalMinusTstzsetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalMinusTstzsetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalMinusTstzsetPhysicalFunction::TemporalMinusTstzsetPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalMinusTstzsetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = temporal_minus_tstzset(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalMinusTstzsetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalMinusTstzsetPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalMinusTstzsetPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
