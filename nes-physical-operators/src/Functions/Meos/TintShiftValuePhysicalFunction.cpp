...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintShiftValuePhysicalFunction(PhysicalFunctionRegistryArguments); }
