...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterIntspanUpperPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

IntspanUpperPhysicalFunction::IntspanUpperPhysicalFunction(PhysicalFunction litFunction)
{
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return IntspanUpperPhysicalFunction(std::move(arg0));
}
