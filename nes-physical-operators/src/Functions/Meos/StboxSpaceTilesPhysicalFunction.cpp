...
#include <Functions/Meos/StboxSpaceTilesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxSpaceTilesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxSpaceTilesPhysicalFunction::StboxSpaceTilesPhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxSpaceTilesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg3Ptr, uint32_t arg3Size) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                STBox* arr = (STBox*) stbox_space_tiles(temp, arg0, arg1, arg2, arg3G.getGeometry(), true, &_cnt);
                free(temp);
        ...
        box.getContent(), box.getContentSize(), arg0, arg1, arg2, arg3.getContent(), arg3.getContentSize());
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxSpaceTilesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "StboxSpaceTilesPhysicalFunction requires 5 children but got {}",
    ...
    return StboxSpaceTilesPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
