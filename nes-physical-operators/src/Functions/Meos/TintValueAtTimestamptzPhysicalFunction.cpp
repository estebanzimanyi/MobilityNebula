...
#include <Functions/Meos/TintValueAtTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintValueAtTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintValueAtTimestamptzPhysicalFunction::TintValueAtTimestamptzPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TintValueAtTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](int32_t value,
            ...
            try
            {
                ...
                int res;
                bool ok = tint_value_at_timestamptz(temp, arg0V, arg1, &res);
                free(temp);
                if (!ok) return 0;
                return (int) res;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintValueAtTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TintValueAtTimestamptzPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TintValueAtTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
