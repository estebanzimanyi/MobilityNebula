...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTgeoGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTgeoGeoPhysicalFunction::NadTgeoGeoPhysicalFunction(PhysicalFunction lonFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return NadTgeoGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
