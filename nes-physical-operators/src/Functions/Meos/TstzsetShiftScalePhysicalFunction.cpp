...
#include <Functions/Meos/TstzsetShiftScalePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTstzsetShiftScalePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TstzsetShiftScalePhysicalFunction::TstzsetShiftScalePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TstzsetShiftScalePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                Set* res = tstzset_shift_scale(temp, arg0B, arg1B);
                free(temp);
                free(arg0B);
                free(arg1B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTstzsetShiftScalePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TstzsetShiftScalePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TstzsetShiftScalePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
