...
#include <Functions/Meos/SpansetGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetGePhysicalFunction::SpansetGePhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetGePhysicalFunction(std::move(arg0), std::move(arg1));
}
