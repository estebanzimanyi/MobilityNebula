...
#include <Functions/Meos/TemporalDyntimewarpDistancePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalDyntimewarpDistancePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalDyntimewarpDistancePhysicalFunction::TemporalDyntimewarpDistancePhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalDyntimewarpDistancePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            double lonBValue, double latBValue, uint64_t tsBValue) -> double {
            try
            {
                ...
                return temporal_dyntimewarp_distance(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalDyntimewarpDistancePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalDyntimewarpDistancePhysicalFunction requires 6 children but got {}",
    ...
    return TemporalDyntimewarpDistancePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
