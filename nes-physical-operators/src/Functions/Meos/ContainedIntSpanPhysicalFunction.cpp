...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedIntSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedIntSpanPhysicalFunction::ContainedIntSpanPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contained_int_span(arg0, temp);
                free(temp);
                return r;
            }
