...
#include <Functions/Meos/FloatspansetShiftScalePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatspansetShiftScalePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatspansetShiftScalePhysicalFunction::FloatspansetShiftScalePhysicalFunction(PhysicalFunction litFunction,
...
VarVal FloatspansetShiftScalePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                SpanSet* res = floatspanset_shift_scale(temp, arg0, arg1, true, true);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterFloatspansetShiftScalePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "FloatspansetShiftScalePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return FloatspansetShiftScalePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
