...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterLineNumpointsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

LineNumpointsPhysicalFunction::LineNumpointsPhysicalFunction(PhysicalFunction litFunction)
{
