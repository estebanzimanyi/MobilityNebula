...
#include <Functions/Meos/OverbeforeTemporalTstzspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbeforeTemporalTstzspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbeforeTemporalTstzspanPhysicalFunction::OverbeforeTemporalTstzspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal OverbeforeTemporalTstzspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = overbefore_temporal_tstzspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbeforeTemporalTstzspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "OverbeforeTemporalTstzspanPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return OverbeforeTemporalTstzspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
