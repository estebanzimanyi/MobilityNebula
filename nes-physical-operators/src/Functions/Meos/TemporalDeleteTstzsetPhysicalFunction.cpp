...
#include <Functions/Meos/TemporalDeleteTstzsetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalDeleteTstzsetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalDeleteTstzsetPhysicalFunction::TemporalDeleteTstzsetPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalDeleteTstzsetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_delete_tstzset(temp, arg0B, false);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalDeleteTstzsetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalDeleteTstzsetPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalDeleteTstzsetPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
