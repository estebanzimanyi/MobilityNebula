...
#include <Functions/Meos/MinusFloatSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusFloatSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusFloatSpansetPhysicalFunction::MinusFloatSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusFloatSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = minus_float_spanset(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusFloatSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusFloatSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusFloatSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
