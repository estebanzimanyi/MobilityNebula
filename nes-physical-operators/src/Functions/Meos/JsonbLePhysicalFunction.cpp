...
#include <Functions/Meos/JsonbLePhysicalFunction.hpp>
...
JsonbLePhysicalFunction::JsonbLePhysicalFunction(PhysicalFunction jbFunction,
...
VarVal JsonbLePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterJsonbLePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "JsonbLePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return JsonbLePhysicalFunction(std::move(arg0), std::move(arg1));
}
