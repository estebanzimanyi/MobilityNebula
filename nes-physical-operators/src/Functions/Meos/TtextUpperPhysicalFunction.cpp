...
#include <Functions/Meos/TtextUpperPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTtextUpperPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TtextUpperPhysicalFunction::TtextUpperPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TtextUpperPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTtextUpperPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TtextUpperPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TtextUpperPhysicalFunction(std::move(arg0), std::move(arg1));
}
