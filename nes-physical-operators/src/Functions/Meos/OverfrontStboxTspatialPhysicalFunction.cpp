...
#include <Functions/Meos/OverfrontStboxTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverfrontStboxTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverfrontStboxTspatialPhysicalFunction::OverfrontStboxTspatialPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal OverfrontStboxTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = overfront_stbox_tspatial(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverfrontStboxTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "OverfrontStboxTspatialPhysicalFunction requires 5 children but got {}",
    ...
    return OverfrontStboxTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
