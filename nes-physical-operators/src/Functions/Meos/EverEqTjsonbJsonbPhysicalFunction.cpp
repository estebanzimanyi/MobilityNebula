...
EverEqTjsonbJsonbPhysicalFunction::EverEqTjsonbJsonbPhysicalFunction(PhysicalFunction json_strFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* json_strPtr, uint32_t json_strSize,
            ...
            try
            {
                ...
                double r = ever_eq_tjsonb_jsonb(temp, jb0);
                free(temp);
                free(jb0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTjsonbJsonbPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
