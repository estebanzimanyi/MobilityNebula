...
#include <Functions/Meos/DatespanBinsPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDatespanBinsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DatespanBinsPhysicalFunction::DatespanBinsPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DatespanBinsPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) datespan_bins(temp, arg0B, arg1V, &_cnt);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDatespanBinsPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "DatespanBinsPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return DatespanBinsPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
