...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverNeTextTtextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverNeTextTtextPhysicalFunction::EverNeTextTtextPhysicalFunction(PhysicalFunction valueFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* valuePtr, uint32_t valueSize,
            ...
            try
            {
                ...
                int r = ever_ne_text_ttext(arg0T, temp);
                free(temp);
                free(arg0T);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EverNeTextTtextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
