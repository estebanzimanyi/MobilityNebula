...
#include <Functions/Meos/TemporalNADTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalNADTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalNADTCbufferPhysicalFunction::TemporalNADTCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalNADTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                double r = nad_tcbuffer_geo(tcbuffer, staticGeometry.getGeometry());
                free(tcbuffer);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalNADTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalNADTCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalNADTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
