...
#include <Functions/Meos/AlwaysNeTfloatTfloatPhysicalFunction.hpp>
...
AlwaysNeTfloatTfloatPhysicalFunction::AlwaysNeTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal AlwaysNeTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double v1, double v2, uint64_t t) -> double {
            try {
                ...
                int r = always_ne_tfloat_tfloat(temp1, temp2);
                free(temp1);
                free(temp2);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysNeTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AlwaysNeTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AlwaysNeTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
