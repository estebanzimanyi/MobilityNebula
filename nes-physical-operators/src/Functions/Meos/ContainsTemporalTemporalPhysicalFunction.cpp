...
#include <Functions/Meos/ContainsTemporalTemporalPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsTemporalTemporalPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsTemporalTemporalPhysicalFunction::ContainsTemporalTemporalPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal ContainsTemporalTemporalPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return contains_temporal_temporal(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainsTemporalTemporalPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "ContainsTemporalTemporalPhysicalFunction requires 6 children but got {}",
    ...
    return ContainsTemporalTemporalPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
