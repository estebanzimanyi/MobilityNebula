...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTpointLengthWkbPhysicalFunction(PhysicalFunctionRegistryArguments); }
