...
AlwaysNeTposeTposePhysicalFunction::AlwaysNeTposeTposePhysicalFunction(
    ...
    const auto result = nautilus::invoke(
        +[](double x1, double y1, double theta1, uint64_t ts1,
            ...
            try {
                ...
                int r = always_ne_tpose_tpose(inst1, inst2);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeTposeTposePhysicalFunction(std::move(arguments.childFunctions[0]),
