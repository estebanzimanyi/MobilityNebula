...
#include <Functions/Meos/TeqTtextTextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTeqTtextTextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TeqTtextTextPhysicalFunction::TeqTtextTextPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TeqTtextTextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = teq_ttext_text(temp, arg0T);
                free(temp);
                free(arg0T);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTeqTtextTextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TeqTtextTextPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TeqTtextTextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
