...
#include <Functions/Meos/TemporalSubtypePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalSubtypePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalSubtypePhysicalFunction::TemporalSubtypePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalSubtypePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                const char* res = temporal_subtype(temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalSubtypePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TemporalSubtypePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TemporalSubtypePhysicalFunction(std::move(arg0), std::move(arg1));
}
