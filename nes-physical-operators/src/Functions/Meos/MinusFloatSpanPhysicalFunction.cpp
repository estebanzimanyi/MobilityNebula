...
#include <Functions/Meos/MinusFloatSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusFloatSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusFloatSpanPhysicalFunction::MinusFloatSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusFloatSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = minus_float_span(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusFloatSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusFloatSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusFloatSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
