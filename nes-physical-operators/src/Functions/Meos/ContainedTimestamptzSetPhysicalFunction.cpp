...
#include <Functions/Meos/ContainedTimestamptzSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainedTimestamptzSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainedTimestamptzSetPhysicalFunction::ContainedTimestamptzSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal ContainedTimestamptzSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contained_timestamptz_set(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainedTimestamptzSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "ContainedTimestamptzSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return ContainedTimestamptzSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
