...
#include <Functions/Meos/DistanceDatespanDatespanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceDatespanDatespanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceDatespanDatespanPhysicalFunction::DistanceDatespanDatespanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceDatespanDatespanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                Span* temp = datespan_in(tempS.c_str());
                if (!temp) return 0;
                ...
                Span* arg0B = datespan_in(arg0S.c_str());
                if (!arg0B) { free(temp); return 0; }

                int r = distance_datespan_datespan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceDatespanDatespanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceDatespanDatespanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceDatespanDatespanPhysicalFunction(std::move(arg0), std::move(arg1));
}
