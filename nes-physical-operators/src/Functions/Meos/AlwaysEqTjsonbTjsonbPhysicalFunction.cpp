...
AlwaysEqTjsonbTjsonbPhysicalFunction::AlwaysEqTjsonbTjsonbPhysicalFunction(PhysicalFunction json_strFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* json_strPtr, uint32_t json_strSize,
            ...
            try
            {
                ...
                double r = always_eq_tjsonb_tjsonb(temp, inst0);
                free(temp);
                free(inst0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysEqTjsonbTjsonbPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
