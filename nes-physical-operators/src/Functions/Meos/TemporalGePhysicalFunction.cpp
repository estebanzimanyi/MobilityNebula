...
#include <Functions/Meos/TemporalGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalGePhysicalFunction::TemporalGePhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return temporal_ge(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalGePhysicalFunction requires 6 children but got {}",
    ...
    return TemporalGePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
