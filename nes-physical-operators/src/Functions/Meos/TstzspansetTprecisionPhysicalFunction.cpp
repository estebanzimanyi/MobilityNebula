...
#include <Functions/Meos/TstzspansetTprecisionPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTstzspansetTprecisionPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TstzspansetTprecisionPhysicalFunction::TstzspansetTprecisionPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TstzspansetTprecisionPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                SpanSet* res = (SpanSet*) tstzspanset_tprecision(temp, arg0B, arg1V);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTstzspansetTprecisionPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TstzspansetTprecisionPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TstzspansetTprecisionPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
