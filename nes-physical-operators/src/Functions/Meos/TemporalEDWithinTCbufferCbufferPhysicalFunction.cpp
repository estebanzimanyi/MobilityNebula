...
#include <Functions/Meos/TemporalEDWithinTCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEDWithinTCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalEDWithinTCbufferCbufferPhysicalFunction::TemporalEDWithinTCbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
                                                          ...
                                                          PhysicalFunction distFunction)
{
    ...
    parameterFunctions.push_back(std::move(cbufferLitFunction));
    parameterFunctions.push_back(std::move(distFunction));
}

VarVal TemporalEDWithinTCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue, double latValue, double radiusValue, uint64_t timestampValue,
            const char* cbufLitPtr, uint32_t cbufLitSize, double distValue) -> int {
            try
            {
                ...
                int r = edwithin_tcbuffer_cbuffer(tcbuffer, cb, distValue);
                free(tcbuffer);
                free(cb);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalEDWithinTCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalEDWithinTCbufferCbufferPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalEDWithinTCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
