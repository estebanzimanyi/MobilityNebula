...
#include <Functions/Meos/TboxEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboxEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboxEqPhysicalFunction::TboxEqPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TboxEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboxEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TboxEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TboxEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
