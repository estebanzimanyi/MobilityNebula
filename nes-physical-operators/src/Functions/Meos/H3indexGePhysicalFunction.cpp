...
H3indexGePhysicalFunction::H3indexGePhysicalFunction(PhysicalFunction aFunction,
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t a,
            ...
            try
            {
                ...
                double r = h3index_ge((H3Index)a, (H3Index)b);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return H3indexGePhysicalFunction(std::move(arg0), std::move(arg1));
}
