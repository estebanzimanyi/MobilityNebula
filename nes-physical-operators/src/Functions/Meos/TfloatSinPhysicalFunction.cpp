...
TfloatSinPhysicalFunction::TfloatSinPhysicalFunction(PhysicalFunction trajFunction)
{
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 1,
                 "TfloatSinPhysicalFunction requires 1 child but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    return TfloatSinPhysicalFunction(std::move(arg0));
}
