...
#include <Functions/Meos/TnumberToSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTnumberToSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TnumberToSpanPhysicalFunction::TnumberToSpanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TnumberToSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTnumberToSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TnumberToSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TnumberToSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
