...
#include <Functions/Meos/Npoint/TnpointRoutePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTnpointRoutePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TnpointRoutePhysicalFunction::TnpointRoutePhysicalFunction(PhysicalFunction ridFunction,
...
VarVal TnpointRoutePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTnpointRoutePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TnpointRoutePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TnpointRoutePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
