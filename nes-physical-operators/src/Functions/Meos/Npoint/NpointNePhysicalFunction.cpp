...
#include <Functions/Meos/Npoint/NpointNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointNePhysicalFunction::NpointNePhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointNePhysicalFunction(std::move(arg0), std::move(arg1));
}
