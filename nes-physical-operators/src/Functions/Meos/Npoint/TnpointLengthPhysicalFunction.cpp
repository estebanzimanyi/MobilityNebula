...
#include <Functions/Meos/Npoint/TnpointLengthPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTnpointLengthPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TnpointLengthPhysicalFunction::TnpointLengthPhysicalFunction(PhysicalFunction ridFunction,
...
VarVal TnpointLengthPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTnpointLengthPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TnpointLengthPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TnpointLengthPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
