...
#include <Functions/Meos/Npoint/NsegmentLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNsegmentLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NsegmentLtPhysicalFunction::NsegmentLtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NsegmentLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNsegmentLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NsegmentLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NsegmentLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
