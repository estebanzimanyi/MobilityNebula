...
#include <Functions/Meos/Npoint/NpointSamePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointSamePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointSamePhysicalFunction::NpointSamePhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointSamePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointSamePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointSamePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointSamePhysicalFunction(std::move(arg0), std::move(arg1));
}
