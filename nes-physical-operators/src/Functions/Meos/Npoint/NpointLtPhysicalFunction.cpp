...
#include <Functions/Meos/Npoint/NpointLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointLtPhysicalFunction::NpointLtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
