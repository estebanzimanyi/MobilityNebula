...
#include <Functions/Meos/Npoint/NsegmentGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNsegmentGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NsegmentGtPhysicalFunction::NsegmentGtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NsegmentGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNsegmentGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NsegmentGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NsegmentGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
