...
#include <Functions/Meos/Npoint/NsegmentMakePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNsegmentMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NsegmentMakePhysicalFunction::NsegmentMakePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal NsegmentMakePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                Nsegment* res = (Nsegment*) nsegment_make(temp, arg0, arg1);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNsegmentMakePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "NsegmentMakePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return NsegmentMakePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
