...
#include <Functions/Meos/Npoint/NsegmentCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNsegmentCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NsegmentCmpPhysicalFunction::NsegmentCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NsegmentCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNsegmentCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NsegmentCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NsegmentCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
