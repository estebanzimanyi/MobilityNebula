...
#include <Functions/Meos/Npoint/NsegmentEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNsegmentEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NsegmentEqPhysicalFunction::NsegmentEqPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NsegmentEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNsegmentEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NsegmentEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NsegmentEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
