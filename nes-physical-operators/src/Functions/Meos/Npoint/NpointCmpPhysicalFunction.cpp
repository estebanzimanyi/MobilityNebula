...
#include <Functions/Meos/Npoint/NpointCmpPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointCmpPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointCmpPhysicalFunction::NpointCmpPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointCmpPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointCmpPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointCmpPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointCmpPhysicalFunction(std::move(arg0), std::move(arg1));
}
