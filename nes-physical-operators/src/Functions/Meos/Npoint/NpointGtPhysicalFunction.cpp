...
#include <Functions/Meos/Npoint/NpointGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointGtPhysicalFunction::NpointGtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
