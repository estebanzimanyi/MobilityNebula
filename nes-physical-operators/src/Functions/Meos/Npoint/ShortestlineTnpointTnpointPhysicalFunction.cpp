...
#include <Functions/Meos/Npoint/ShortestlineTnpointTnpointPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterShortestlineTnpointTnpointPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ShortestlineTnpointTnpointPhysicalFunction::ShortestlineTnpointTnpointPhysicalFunction(PhysicalFunction ridFunction,
...
VarVal ShortestlineTnpointTnpointPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) shortestline_tnpoint_tnpoint(temp, arg0t);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterShortestlineTnpointTnpointPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "ShortestlineTnpointTnpointPhysicalFunction requires 6 children but got {}",
    ...
    return ShortestlineTnpointTnpointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
