...
#include <Functions/Meos/Npoint/TemporalEDWithinTNpointGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEDWithinTNpointGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }
