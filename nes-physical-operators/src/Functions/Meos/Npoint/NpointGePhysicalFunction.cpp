...
#include <Functions/Meos/Npoint/NpointGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointGePhysicalFunction::NpointGePhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointGePhysicalFunction(std::move(arg0), std::move(arg1));
}
