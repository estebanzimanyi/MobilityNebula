...
#include <Functions/Meos/Npoint/NsegmentGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNsegmentGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NsegmentGePhysicalFunction::NsegmentGePhysicalFunction(PhysicalFunction litFunction,
...
VarVal NsegmentGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNsegmentGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NsegmentGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NsegmentGePhysicalFunction(std::move(arg0), std::move(arg1));
}
