...
#include <Functions/Meos/Npoint/TdistanceTnpointTnpointPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdistanceTnpointTnpointPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdistanceTnpointTnpointPhysicalFunction::TdistanceTnpointTnpointPhysicalFunction(PhysicalFunction trajFunction,
...
VarVal TdistanceTnpointTnpointPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto hexStr = nautilus::invoke(
        +[](const char* aPtr, uint32_t aSize, const char* bPtr, uint32_t bSize) -> char*
        {
            try
            {
                ...
                Temporal* res = tdistance_tnpoint_tnpoint(a, b);
                free(a);
                free(b);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdistanceTnpointTnpointPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TdistanceTnpointTnpointPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TdistanceTnpointTnpointPhysicalFunction(std::move(arg0), std::move(arg1));
}
