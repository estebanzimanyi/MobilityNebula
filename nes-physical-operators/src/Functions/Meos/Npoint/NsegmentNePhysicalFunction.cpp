...
#include <Functions/Meos/Npoint/NsegmentNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNsegmentNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NsegmentNePhysicalFunction::NsegmentNePhysicalFunction(PhysicalFunction litFunction,
...
VarVal NsegmentNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNsegmentNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NsegmentNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NsegmentNePhysicalFunction(std::move(arg0), std::move(arg1));
}
