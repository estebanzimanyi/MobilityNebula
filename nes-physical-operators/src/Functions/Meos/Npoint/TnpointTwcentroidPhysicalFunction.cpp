...
#include <Functions/Meos/Npoint/TnpointTwcentroidPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTnpointTwcentroidPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TnpointTwcentroidPhysicalFunction::TnpointTwcentroidPhysicalFunction(PhysicalFunction ridFunction,
...
VarVal TnpointTwcentroidPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) tnpoint_twcentroid(temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTnpointTwcentroidPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TnpointTwcentroidPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TnpointTwcentroidPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
