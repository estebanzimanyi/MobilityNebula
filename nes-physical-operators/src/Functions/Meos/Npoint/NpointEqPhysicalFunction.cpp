...
#include <Functions/Meos/Npoint/NpointEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointEqPhysicalFunction::NpointEqPhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
