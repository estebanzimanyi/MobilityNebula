...
#include <Functions/Meos/Npoint/MinusNpointSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusNpointSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusNpointSetPhysicalFunction::MinusNpointSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusNpointSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Set* res = minus_npoint_set(arg0B, temp);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusNpointSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusNpointSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusNpointSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
