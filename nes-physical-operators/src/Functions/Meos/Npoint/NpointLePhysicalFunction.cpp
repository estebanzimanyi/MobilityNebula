...
#include <Functions/Meos/Npoint/NpointLePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNpointLePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NpointLePhysicalFunction::NpointLePhysicalFunction(PhysicalFunction litFunction,
...
VarVal NpointLePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNpointLePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "NpointLePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return NpointLePhysicalFunction(std::move(arg0), std::move(arg1));
}
