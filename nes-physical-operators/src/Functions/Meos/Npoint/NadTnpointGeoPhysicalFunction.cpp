...
#include <Functions/Meos/Npoint/NadTnpointGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTnpointGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }
    ...
    const auto result = nautilus::invoke(
        +[](int64_t rid,
            ...
            try
            {
                ...
                double r = nad_tnpoint_geo(temp, arg0G.getGeometry());
                free(temp);
                return r;
            }
