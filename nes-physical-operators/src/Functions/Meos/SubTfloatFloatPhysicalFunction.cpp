...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSubTfloatFloatPhysicalFunction(PhysicalFunctionRegistryArguments); }
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = sub_tfloat_float(temp, arg0);
                free(temp);
