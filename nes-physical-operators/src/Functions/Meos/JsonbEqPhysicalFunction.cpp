...
#include <Functions/Meos/JsonbEqPhysicalFunction.hpp>
...
JsonbEqPhysicalFunction::JsonbEqPhysicalFunction(PhysicalFunction jbFunction,
...
VarVal JsonbEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterJsonbEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "JsonbEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return JsonbEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
