...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEdisjointTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EdisjointTgeoTgeoPhysicalFunction::EdisjointTgeoTgeoPhysicalFunction(PhysicalFunction lonAFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EdisjointTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
