...
#include <Functions/Meos/SpanGtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpanGtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpanGtPhysicalFunction::SpanGtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpanGtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpanGtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpanGtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpanGtPhysicalFunction(std::move(arg0), std::move(arg1));
}
