...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeogAreaPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeogAreaPhysicalFunction::GeogAreaPhysicalFunction(PhysicalFunction litFunction)
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeogAreaPhysicalFunction(
