...
#include <Functions/Meos/TemporalEContainsTGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEContainsTGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalEContainsTGeometryPhysicalFunction::TemporalEContainsTGeometryPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalEContainsTGeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalEContainsTGeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalEContainsTGeometryPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalEContainsTGeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
