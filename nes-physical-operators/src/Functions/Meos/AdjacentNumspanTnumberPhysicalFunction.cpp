...
#include <Functions/Meos/AdjacentNumspanTnumberPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAdjacentNumspanTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AdjacentNumspanTnumberPhysicalFunction::AdjacentNumspanTnumberPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal AdjacentNumspanTnumberPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = adjacent_numspan_tnumber(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdjacentNumspanTnumberPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AdjacentNumspanTnumberPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AdjacentNumspanTnumberPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
