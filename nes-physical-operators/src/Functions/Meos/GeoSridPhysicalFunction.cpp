...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeoSridPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeoSridPhysicalFunction::GeoSridPhysicalFunction(PhysicalFunction litFunction)
{
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 1,
                 "GeoSridPhysicalFunction requires 1 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    return GeoSridPhysicalFunction(std::move(arg0));
}
