...
#include <Functions/Meos/TgeoSpaceSplitPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgeoSpaceSplitPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgeoSpaceSplitPhysicalFunction::TgeoSpaceSplitPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TgeoSpaceSplitPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTgeoSpaceSplitPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 7,
                 "TgeoSpaceSplitPhysicalFunction requires 7 children but got {}",
    ...
    return TgeoSpaceSplitPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
