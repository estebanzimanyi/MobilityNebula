...
#include <Functions/Meos/NadTfloatFloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTfloatFloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTfloatFloatPhysicalFunction::NadTfloatFloatPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal NadTfloatFloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTfloatFloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "NadTfloatFloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return NadTfloatFloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
