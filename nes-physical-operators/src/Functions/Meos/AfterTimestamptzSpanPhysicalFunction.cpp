...
#include <Functions/Meos/AfterTimestamptzSpanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAfterTimestamptzSpanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AfterTimestamptzSpanPhysicalFunction::AfterTimestamptzSpanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal AfterTimestamptzSpanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = after_timestamptz_span(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAfterTimestamptzSpanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AfterTimestamptzSpanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AfterTimestamptzSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
