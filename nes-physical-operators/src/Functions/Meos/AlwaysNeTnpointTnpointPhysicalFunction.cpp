...
AlwaysNeTnpointTnpointPhysicalFunction::AlwaysNeTnpointTnpointPhysicalFunction(
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t rid1, double pos1, uint64_t ts1,
            ...
            try {
                ...
                int r = always_ne_tnpoint_tnpoint(inst1, inst2);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeTnpointTnpointPhysicalFunction(std::move(arguments.childFunctions[0]),
