...
#include <Functions/Meos/SameTspatialTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSameTspatialTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SameTspatialTspatialPhysicalFunction::SameTspatialTspatialPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal SameTspatialTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return same_tspatial_tspatial(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSameTspatialTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "SameTspatialTspatialPhysicalFunction requires 6 children but got {}",
    ...
    return SameTspatialTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
