...
#include <Functions/Meos/EverGtIntTintPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverGtIntTintPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverGtIntTintPhysicalFunction::EverGtIntTintPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal EverGtIntTintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverGtIntTintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverGtIntTintPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverGtIntTintPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
