...
#include <Functions/Meos/NadTgeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTgeoTgeoPhysicalFunction::NadTgeoTgeoPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal NadTgeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTgeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "NadTgeoTgeoPhysicalFunction requires 6 children but got {}",
    ...
    return NadTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
