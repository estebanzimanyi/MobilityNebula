...
#include <Functions/Meos/SameTnumberTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSameTnumberTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SameTnumberTboxPhysicalFunction::SameTnumberTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal SameTnumberTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = same_tnumber_tbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSameTnumberTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "SameTnumberTboxPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return SameTnumberTboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
