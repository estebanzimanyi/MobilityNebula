...
GeomFromHexewkbPhysicalFunction::GeomFromHexewkbPhysicalFunction()
{
    ...
    const auto actualLen = nautilus::invoke(
        +[](char* buf,
            ...
            try
            {
                ...
                GSERIALIZED* gres = geom_from_hexewkb(hex0)();
                if (!gres) return 0u;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 0,
                 "GeomFromHexewkbPhysicalFunction requires 0 children but got {}",
