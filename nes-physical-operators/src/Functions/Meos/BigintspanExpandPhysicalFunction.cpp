...
#include <Functions/Meos/BigintspanExpandPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBigintspanExpandPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BigintspanExpandPhysicalFunction::BigintspanExpandPhysicalFunction(PhysicalFunction litFunction,
...
VarVal BigintspanExpandPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg0 = parameterValues[1].cast<nautilus::val<int64>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            int64 arg0) -> char*
        {
            try
            {
                ...
                Span* res = (Span*) bigintspan_expand(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBigintspanExpandPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "BigintspanExpandPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return BigintspanExpandPhysicalFunction(std::move(arg0), std::move(arg1));
}
