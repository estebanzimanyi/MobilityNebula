...
#include <Functions/Meos/LeftTnumberNumspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterLeftTnumberNumspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

LeftTnumberNumspanPhysicalFunction::LeftTnumberNumspanPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal LeftTnumberNumspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = left_tnumber_numspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterLeftTnumberNumspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "LeftTnumberNumspanPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return LeftTnumberNumspanPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
