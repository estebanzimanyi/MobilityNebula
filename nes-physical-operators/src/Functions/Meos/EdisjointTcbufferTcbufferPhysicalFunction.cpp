...
#include <Functions/Meos/EdisjointTcbufferTcbufferPhysicalFunction.hpp>
...
EdisjointTcbufferTcbufferPhysicalFunction::EdisjointTcbufferTcbufferPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal EdisjointTcbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, double radiusAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                int r = edisjoint_tcbuffer_tcbuffer(tA, tB);
                free(tA);
                free(tB);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEdisjointTcbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "EdisjointTcbufferTcbufferPhysicalFunction requires 8 children but got {}",
    ...
    return EdisjointTcbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
