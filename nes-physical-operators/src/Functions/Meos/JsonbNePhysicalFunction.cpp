...
JsonbNePhysicalFunction::JsonbNePhysicalFunction(PhysicalFunction jbFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return JsonbNePhysicalFunction(std::move(arg0), std::move(arg1));
}
