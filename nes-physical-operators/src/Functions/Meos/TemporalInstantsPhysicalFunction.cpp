...
#include <Functions/Meos/TemporalInstantsPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalInstantsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalInstantsPhysicalFunction::TemporalInstantsPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalInstantsPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                TInstant ** arr = (TInstant **) temporal_instants(temp, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalInstantsPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TemporalInstantsPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TemporalInstantsPhysicalFunction(std::move(arg0), std::move(arg1));
}
