...
#include <Functions/Meos/TemporalAIntersectsTCbufferCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalAIntersectsTCbufferCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalAIntersectsTCbufferCbufferPhysicalFunction::TemporalAIntersectsTCbufferCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalAIntersectsTCbufferCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                int r = aintersects_tcbuffer_cbuffer(tcbuffer, cb);
                free(tcbuffer);
                free(cb);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalAIntersectsTCbufferCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalAIntersectsTCbufferCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalAIntersectsTCbufferCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
