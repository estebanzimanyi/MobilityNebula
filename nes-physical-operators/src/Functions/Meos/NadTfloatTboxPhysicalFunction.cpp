...
#include <Functions/Meos/NadTfloatTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTfloatTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTfloatTboxPhysicalFunction::NadTfloatTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal NadTfloatTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                double r = nad_tfloat_tbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTfloatTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "NadTfloatTboxPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return NadTfloatTboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
