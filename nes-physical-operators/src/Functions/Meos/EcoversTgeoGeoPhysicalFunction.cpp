...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEcoversTgeoGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EcoversTgeoGeoPhysicalFunction::EcoversTgeoGeoPhysicalFunction(PhysicalFunction lonFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EcoversTgeoGeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
