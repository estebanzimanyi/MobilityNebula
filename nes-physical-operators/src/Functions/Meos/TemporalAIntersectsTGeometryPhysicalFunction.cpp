...
#include <Functions/Meos/TemporalAIntersectsTGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalAIntersectsTGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalAIntersectsTGeometryPhysicalFunction::TemporalAIntersectsTGeometryPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalAIntersectsTGeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                return aintersects_tgeo_tgeo(temporalGeometryA.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalAIntersectsTGeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalAIntersectsTGeometryPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalAIntersectsTGeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
