...
AddBigintTbigintPhysicalFunction::AddBigintTbigintPhysicalFunction(PhysicalFunction trajFunction,
    ...
    auto hexStr = nautilus::invoke(
        +[](const char* aPtr, uint32_t aSize, int64_t s) -> char*
        {
            try
            {
                ...
                Temporal* res = add_bigint_tbigint(s, a);
                free(a);
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AddBigintTbigintPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AddBigintTbigintPhysicalFunction(std::move(arg0), std::move(arg1));
}
