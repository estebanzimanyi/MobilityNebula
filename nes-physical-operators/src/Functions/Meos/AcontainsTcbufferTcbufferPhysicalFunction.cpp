...
#include <Functions/Meos/AcontainsTcbufferTcbufferPhysicalFunction.hpp>
...
AcontainsTcbufferTcbufferPhysicalFunction::AcontainsTcbufferTcbufferPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal AcontainsTcbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, double radiusAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                int r = acontains_tcbuffer_tcbuffer(tA, tB);
                free(tA);
                free(tB);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAcontainsTcbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "AcontainsTcbufferTcbufferPhysicalFunction requires 8 children but got {}",
    ...
    return AcontainsTcbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
