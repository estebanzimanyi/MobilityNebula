...
#include <Functions/Meos/GeomPointMake3dzPhysicalFunction.hpp>
...
GeomPointMake3dzPhysicalFunction::GeomPointMake3dzPhysicalFunction(PhysicalFunction sridFunction,
...
VarVal GeomPointMake3dzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto actualLen = nautilus::invoke(
        +[](uint64_t srid,
            ...
            try
            {
                ...
                GSERIALIZED* gres = geompoint_make3dz((int32_t)srid, x, y, z);
                if (!gres) return 0u;
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeomPointMake3dzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "GeomPointMake3dzPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return GeomPointMake3dzPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
