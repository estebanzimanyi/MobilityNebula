...
#include <Functions/Meos/DistanceSpansetTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceSpansetTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceSpansetTimestamptzPhysicalFunction::DistanceSpansetTimestamptzPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceSpansetTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_spanset_timestamptz(temp, arg0V);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceSpansetTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceSpansetTimestamptzPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceSpansetTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1));
}
