...
#include <Functions/Meos/FloatspanDegreesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatspanDegreesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatspanDegreesPhysicalFunction::FloatspanDegreesPhysicalFunction(PhysicalFunction litFunction,
...
VarVal FloatspanDegreesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg0) -> char*
        {
            try
            {
                ...
                Span* res = (Span*) floatspan_degrees(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterFloatspanDegreesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "FloatspanDegreesPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return FloatspanDegreesPhysicalFunction(std::move(arg0), std::move(arg1));
}
