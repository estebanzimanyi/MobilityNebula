...
#include <Functions/Meos/StboxGetTimeTilePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxGetTimeTilePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxGetTimeTilePhysicalFunction::StboxGetTimeTilePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal StboxGetTimeTilePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg1Ptr, uint32_t arg1Size) -> char*
        {
            try
            {
                ...
                STBox* res = (STBox*) stbox_get_time_tile(temp, arg0B, arg1V);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxGetTimeTilePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "StboxGetTimeTilePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return StboxGetTimeTilePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
