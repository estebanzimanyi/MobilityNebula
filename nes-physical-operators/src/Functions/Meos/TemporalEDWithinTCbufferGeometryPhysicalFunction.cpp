...
#include <Functions/Meos/TemporalEDWithinTCbufferGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEDWithinTCbufferGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalEDWithinTCbufferGeometryPhysicalFunction::TemporalEDWithinTCbufferGeometryPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalEDWithinTCbufferGeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue, double latValue, double radiusValue, uint64_t timestampValue,
            ...
            try
            {
                ...
                int r = edwithin_tcbuffer_geo(tcbuffer, staticGeometry.getGeometry(), distValue);
                free(tcbuffer);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalEDWithinTCbufferGeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalEDWithinTCbufferGeometryPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalEDWithinTCbufferGeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
