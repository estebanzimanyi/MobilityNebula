...
#include <string>
#include <cstring>
#include <Functions/Meos/AintersectsTgeoGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAintersectsTgeoGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

// Constructor with 4 parameters for temporal-static intersection
AintersectsTgeoGeoPhysicalFunction::AintersectsTgeoGeoPhysicalFunction(PhysicalFunction lon1Function, PhysicalFunction lat1Function, PhysicalFunction timestamp1Function, PhysicalFunction staticGeometryFunction)
...
AintersectsTgeoGeoPhysicalFunction::AintersectsTgeoGeoPhysicalFunction(PhysicalFunction lon1Function, PhysicalFunction lat1Function, PhysicalFunction timestamp1Function, PhysicalFunction lon2Function, PhysicalFunction lat2Function, PhysicalFunction timestamp2Function)
...
VarVal AintersectsTgeoGeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    std::cout << "AintersectsTgeoGeoPhysicalFunction::execute called with " << parameterFunctions.size() << " arguments" << std::endl;
...
VarVal AintersectsTgeoGeoPhysicalFunction::executeTemporal6Param(const std::vector<VarVal>& params) const
{
...
VarVal AintersectsTgeoGeoPhysicalFunction::executeTemporal4Param(const std::vector<VarVal>& params) const
{
...
PhysicalFunctionGeneratedRegistrar::RegisterAintersectsTgeoGeoPhysicalFunction(PhysicalFunctionRegistryArguments physicalFunctionRegistryArguments)
{
    if (physicalFunctionRegistryArguments.childFunctions.size() == 4) {
        return AintersectsTgeoGeoPhysicalFunction(
        ...
        PRECONDITION(false, "AintersectsTgeoGeoPhysicalFunction requires 4 or 6 child functions, but got {}", physicalFunctionRegistryArguments.childFunctions.size());
    }
}
