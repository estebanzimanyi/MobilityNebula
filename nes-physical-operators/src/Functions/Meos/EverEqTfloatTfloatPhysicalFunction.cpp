...
#include <Functions/Meos/EverEqTfloatTfloatPhysicalFunction.hpp>
...
EverEqTfloatTfloatPhysicalFunction::EverEqTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal EverEqTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double v1, double v2, uint64_t t) -> double {
            try {
                ...
                int r = ever_eq_tfloat_tfloat(temp1, temp2);
                free(temp1);
                free(temp2);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverEqTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverEqTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverEqTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
