...
BackTspatialTspatialPhysicalFunction::BackTspatialTspatialPhysicalFunction(PhysicalFunction lonFunction,
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = back_tspatial_tspatial(temp, arg0t);
                free(temp);
                free(arg0t);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "BackTspatialTspatialPhysicalFunction requires 8 children but got {}",
    ...
    return BackTspatialTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
