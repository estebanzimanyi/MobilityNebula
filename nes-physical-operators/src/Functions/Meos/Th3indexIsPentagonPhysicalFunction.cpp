...
Th3indexIsPentagonPhysicalFunction::Th3indexIsPentagonPhysicalFunction(PhysicalFunction cellFunction,
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t cell,
            ...
            try
            {
                ...
                double r = th3index_is_pentagon(temp);
                free(temp);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return Th3indexIsPentagonPhysicalFunction(std::move(arg0), std::move(arg1));
}
