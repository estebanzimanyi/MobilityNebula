...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomShortestline2dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomShortestline2dPhysicalFunction::GeomShortestline2dPhysicalFunction(PhysicalFunction litFunction,
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) geom_shortestline2d(temp, arg0G.getGeometry());
