...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeoGeoNPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeoGeoNPhysicalFunction::GeoGeoNPhysicalFunction(PhysicalFunction litFunction,
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) geo_geo_n(temp, arg0);
