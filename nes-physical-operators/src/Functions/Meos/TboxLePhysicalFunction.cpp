...
#include <Functions/Meos/TboxLePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTboxLePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TboxLePhysicalFunction::TboxLePhysicalFunction(PhysicalFunction litFunction,
...
VarVal TboxLePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTboxLePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TboxLePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TboxLePhysicalFunction(std::move(arg0), std::move(arg1));
}
