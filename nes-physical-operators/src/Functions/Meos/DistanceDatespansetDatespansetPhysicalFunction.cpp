...
#include <Functions/Meos/DistanceDatespansetDatespansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceDatespansetDatespansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceDatespansetDatespansetPhysicalFunction::DistanceDatespansetDatespansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceDatespansetDatespansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                SpanSet* arg0B = datespanset_in(arg0S.c_str());
                if (!arg0B) { free(temp); return 0; }

                int r = distance_datespanset_datespanset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceDatespansetDatespansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceDatespansetDatespansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceDatespansetDatespansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
