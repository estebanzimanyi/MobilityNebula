...
#include <Functions/Meos/TneTextTtextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTneTextTtextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TneTextTtextPhysicalFunction::TneTextTtextPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TneTextTtextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tne_text_ttext(arg0T, temp);
                free(temp);
                free(arg0T);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTneTextTtextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TneTextTtextPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TneTextTtextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
