...
GeomContainsPhysicalFunction::GeomContainsPhysicalFunction(PhysicalFunction wkt1Function,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return GeomContainsPhysicalFunction(
