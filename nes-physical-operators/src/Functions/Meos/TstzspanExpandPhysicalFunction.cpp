...
#include <Functions/Meos/TstzspanExpandPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTstzspanExpandPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TstzspanExpandPhysicalFunction::TstzspanExpandPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TstzspanExpandPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Span* res = tstzspan_expand(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTstzspanExpandPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TstzspanExpandPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TstzspanExpandPhysicalFunction(std::move(arg0), std::move(arg1));
}
