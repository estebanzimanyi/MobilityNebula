...
#include <Functions/Meos/EcontainsTcbufferTcbufferPhysicalFunction.hpp>
...
EcontainsTcbufferTcbufferPhysicalFunction::EcontainsTcbufferTcbufferPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal EcontainsTcbufferTcbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, double radiusAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                int r = econtains_tcbuffer_tcbuffer(tA, tB);
                free(tA);
                free(tB);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEcontainsTcbufferTcbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "EcontainsTcbufferTcbufferPhysicalFunction requires 8 children but got {}",
    ...
    return EcontainsTcbufferTcbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
