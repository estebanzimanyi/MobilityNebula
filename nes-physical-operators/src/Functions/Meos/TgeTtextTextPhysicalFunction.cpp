...
#include <Functions/Meos/TgeTtextTextPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTgeTtextTextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TgeTtextTextPhysicalFunction::TgeTtextTextPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TgeTtextTextPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = tge_ttext_text(temp, arg0T);
                free(temp);
                free(arg0T);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTgeTtextTextPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TgeTtextTextPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TgeTtextTextPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
