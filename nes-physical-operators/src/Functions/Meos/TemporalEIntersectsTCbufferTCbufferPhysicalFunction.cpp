...
#include <Functions/Meos/TemporalEIntersectsTCbufferTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalEIntersectsTCbufferTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalEIntersectsTCbufferTCbufferPhysicalFunction::TemporalEIntersectsTCbufferTCbufferPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalEIntersectsTCbufferTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalEIntersectsTCbufferTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "TemporalEIntersectsTCbufferTCbufferPhysicalFunction requires 8 children but got {}",
    ...
    return TemporalEIntersectsTCbufferTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
