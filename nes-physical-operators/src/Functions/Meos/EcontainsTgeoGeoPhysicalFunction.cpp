...
#include <Functions/Meos/EcontainsTgeoGeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEcontainsTgeoGeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

/* ─────────── constructors ─────────── */

EcontainsTgeoGeoPhysicalFunction::
EcontainsTgeoGeoPhysicalFunction(PhysicalFunction param1,
...
EcontainsTgeoGeoPhysicalFunction::
EcontainsTgeoGeoPhysicalFunction(PhysicalFunction lon1,
...
VarVal EcontainsTgeoGeoPhysicalFunction::execute(const Record& rec,
                                                          ArenaRef& arena) const {
    std::cout << "EcontainsTgeoGeoPhysicalFunction::execute called with " << paramFns.size() << " arguments" << std::endl;
...
VarVal
EcontainsTgeoGeoPhysicalFunction::execTemporalTemporal(const std::vector<VarVal>& p) const {
...
VarVal
EcontainsTgeoGeoPhysicalFunction::execTemporalStatic(const std::vector<VarVal>& p) const 
{
...
VarVal
EcontainsTgeoGeoPhysicalFunction::execStaticTemporal(const std::vector<VarVal>& p) const
{
...
PhysicalFunctionGeneratedRegistrar::RegisterEcontainsTgeoGeoPhysicalFunction(
    ...
    if (physicalFunctionRegistryArguments.childFunctions.size() == 6) {
        return EcontainsTgeoGeoPhysicalFunction(
    ...
    PRECONDITION(physicalFunctionRegistryArguments.childFunctions.size()==4,
                 "EcontainsTgeoGeo expects 4 or 6 child functions, got {}", physicalFunctionRegistryArguments.childFunctions.size());

    return EcontainsTgeoGeoPhysicalFunction(physicalFunctionRegistryArguments.childFunctions[0],physicalFunctionRegistryArguments.childFunctions[1],
