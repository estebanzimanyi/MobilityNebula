...
#include <Functions/Meos/StboxLePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxLePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxLePhysicalFunction::StboxLePhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxLePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxLePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxLePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxLePhysicalFunction(std::move(arg0), std::move(arg1));
}
