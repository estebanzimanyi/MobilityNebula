...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomAzimuthPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomAzimuthPhysicalFunction::GeomAzimuthPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double res;
                bool ok = geom_azimuth(temp, arg0G.getGeometry(), &res);
                if (!ok) return 0.0;
                return (double) res;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return GeomAzimuthPhysicalFunction(std::move(arg0), std::move(arg1));
}
