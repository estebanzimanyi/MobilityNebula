...
#include <Functions/Meos/SubFloatTfloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSubFloatTfloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SubFloatTfloatPhysicalFunction::SubFloatTfloatPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal SubFloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = sub_float_tfloat(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSubFloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "SubFloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return SubFloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
