...
#include <Functions/Meos/OverbackTspatialStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverbackTspatialStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverbackTspatialStboxPhysicalFunction::OverbackTspatialStboxPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal OverbackTspatialStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = overback_tspatial_stbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverbackTspatialStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "OverbackTspatialStboxPhysicalFunction requires 5 children but got {}",
    ...
    return OverbackTspatialStboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
