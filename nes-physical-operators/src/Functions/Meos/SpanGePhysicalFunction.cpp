...
#include <Functions/Meos/SpanGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpanGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpanGePhysicalFunction::SpanGePhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpanGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpanGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpanGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpanGePhysicalFunction(std::move(arg0), std::move(arg1));
}
