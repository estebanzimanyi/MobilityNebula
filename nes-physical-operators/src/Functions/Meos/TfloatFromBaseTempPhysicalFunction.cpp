...
#include <Functions/Meos/TfloatFromBaseTempPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatFromBaseTempPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TfloatFromBaseTempPhysicalFunction::TfloatFromBaseTempPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TfloatFromBaseTempPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = tfloat_from_base_temp(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTfloatFromBaseTempPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TfloatFromBaseTempPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TfloatFromBaseTempPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
