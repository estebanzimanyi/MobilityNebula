...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomDifference2dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomDifference2dPhysicalFunction::GeomDifference2dPhysicalFunction(PhysicalFunction litFunction,
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                GSERIALIZED* res = (GSERIALIZED*) geom_difference2d(temp, arg0G.getGeometry());
