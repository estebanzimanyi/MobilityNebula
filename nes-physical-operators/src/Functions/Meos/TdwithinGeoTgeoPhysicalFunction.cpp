...
#include <Functions/Meos/TdwithinGeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdwithinGeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdwithinGeoTgeoPhysicalFunction::TdwithinGeoTgeoPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TdwithinGeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tdwithin_geo_tgeo(temp, arg0T, arg1);
                free(arg0T);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdwithinGeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TdwithinGeoTgeoPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TdwithinGeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
