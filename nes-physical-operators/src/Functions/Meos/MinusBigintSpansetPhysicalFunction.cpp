...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusBigintSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }
