...
#include <Functions/Meos/MinusDateIntPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusDateIntPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusDateIntPhysicalFunction::MinusDateIntPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal MinusDateIntPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                DateADT res = minus_date_int(temp, arg0);
                char* outStr = date_out(res);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusDateIntPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusDateIntPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusDateIntPhysicalFunction(std::move(arg0), std::move(arg1));
}
