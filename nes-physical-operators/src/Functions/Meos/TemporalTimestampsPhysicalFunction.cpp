...
#include <Functions/Meos/TemporalTimestampsPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalTimestampsPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalTimestampsPhysicalFunction::TemporalTimestampsPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalTimestampsPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                int64_t* arr = (int64_t*) temporal_timestamps(temp, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalTimestampsPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TemporalTimestampsPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TemporalTimestampsPhysicalFunction(std::move(arg0), std::move(arg1));
}
