...
GeogCentroidPhysicalFunction::GeogCentroidPhysicalFunction(PhysicalFunction wktFunction,
    ...
    const auto actualLen = nautilus::invoke(
        +[](const char* wktPtr, uint32_t wktSize,
            ...
            try
            {
                ...
                GSERIALIZED* gres = geog_centroid(temp, (bool)arg0);
                free(temp);
                if (!gres) return 0u;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return GeogCentroidPhysicalFunction(std::move(arg0), std::move(arg1));
}
