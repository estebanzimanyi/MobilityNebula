...
#include <Functions/Meos/StboxGePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxGePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxGePhysicalFunction::StboxGePhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxGePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxGePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxGePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxGePhysicalFunction(std::move(arg0), std::move(arg1));
}
