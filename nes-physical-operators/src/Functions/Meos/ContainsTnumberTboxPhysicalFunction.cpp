...
#include <Functions/Meos/ContainsTnumberTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsTnumberTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsTnumberTboxPhysicalFunction::ContainsTnumberTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal ContainsTnumberTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = contains_tnumber_tbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainsTnumberTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "ContainsTnumberTboxPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return ContainsTnumberTboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
