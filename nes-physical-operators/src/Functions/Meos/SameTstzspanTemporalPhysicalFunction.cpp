...
#include <Functions/Meos/SameTstzspanTemporalPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSameTstzspanTemporalPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SameTstzspanTemporalPhysicalFunction::SameTstzspanTemporalPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal SameTstzspanTemporalPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = same_tstzspan_temporal(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSameTstzspanTemporalPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "SameTstzspanTemporalPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return SameTstzspanTemporalPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
