...
#include <Functions/Meos/DistanceIntspansetIntspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceIntspansetIntspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceIntspansetIntspanPhysicalFunction::DistanceIntspansetIntspanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceIntspansetIntspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = distance_intspanset_intspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceIntspansetIntspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceIntspansetIntspanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceIntspansetIntspanPhysicalFunction(std::move(arg0), std::move(arg1));
}
