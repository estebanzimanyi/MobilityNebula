...
ContainsFloatspanSpanPhysicalFunction::ContainsFloatspanSpanPhysicalFunction(PhysicalFunction spFunction,
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return ContainsFloatspanSpanPhysicalFunction(std::move(arg0), std::move(arg1));
}
