...
#include <Functions/Meos/OverrightTnumberTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterOverrightTnumberTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

OverrightTnumberTboxPhysicalFunction::OverrightTnumberTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal OverrightTnumberTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = overright_tnumber_tbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterOverrightTnumberTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "OverrightTnumberTboxPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return OverrightTnumberTboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
