...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverLeTextTtextPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverLeTextTtextPhysicalFunction::EverLeTextTtextPhysicalFunction(PhysicalFunction valueFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* valuePtr, uint32_t valueSize,
            ...
            try
            {
                ...
                int r = ever_le_text_ttext(arg0T, temp);
                free(temp);
                free(arg0T);
                return r;
            }
