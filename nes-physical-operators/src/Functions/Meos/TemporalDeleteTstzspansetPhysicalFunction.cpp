...
#include <Functions/Meos/TemporalDeleteTstzspansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalDeleteTstzspansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalDeleteTstzspansetPhysicalFunction::TemporalDeleteTstzspansetPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalDeleteTstzspansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_delete_tstzspanset(temp, arg0B, false);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalDeleteTstzspansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalDeleteTstzspansetPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalDeleteTstzspansetPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
