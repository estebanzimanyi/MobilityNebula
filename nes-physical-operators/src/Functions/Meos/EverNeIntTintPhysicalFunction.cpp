...
#include <Functions/Meos/EverNeIntTintPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverNeIntTintPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverNeIntTintPhysicalFunction::EverNeIntTintPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal EverNeIntTintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverNeIntTintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverNeIntTintPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverNeIntTintPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
