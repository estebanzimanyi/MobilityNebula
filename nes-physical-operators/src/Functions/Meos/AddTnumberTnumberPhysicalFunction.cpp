...
#include <Functions/Meos/AddTnumberTnumberPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAddTnumberTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }
