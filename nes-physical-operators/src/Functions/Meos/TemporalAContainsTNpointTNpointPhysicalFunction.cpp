...
#include <Functions/Meos/TemporalAContainsTNpointTNpointPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalAContainsTNpointTNpointPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalAContainsTNpointTNpointPhysicalFunction::TemporalAContainsTNpointTNpointPhysicalFunction(PhysicalFunction ridAFunction,
...
VarVal TemporalAContainsTNpointTNpointPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t ridAValue, double fractionAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                int r = acontains_tgeo_tgeo(tgeoA, tgeoB);
                free(tgeoB);
                free(tnpointB);
                free(tgeoA);
                free(tnpointA);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalAContainsTNpointTNpointPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalAContainsTNpointTNpointPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalAContainsTNpointTNpointPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
