...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysGtTintIntPhysicalFunction(PhysicalFunctionRegistryArguments); }
    ...
    const auto result = nautilus::invoke(
        +[](int valueValue,
            ...
            try
            {
                ...
                if (!temp) return 0;
                int r = always_gt_tint_int(temp, scalarValue);
                free(temp);
                return r;
            }
