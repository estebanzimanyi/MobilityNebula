...
#include <Functions/Meos/SpansetEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetEqPhysicalFunction::SpansetEqPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
