...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFloatspanMakePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FloatspanMakePhysicalFunction::FloatspanMakePhysicalFunction(PhysicalFunction valueFunction,
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg2) -> char*
        {
            try
            {
                ...
                Span* res = (Span*) floatspan_make(temp, arg0, arg1, arg2);
