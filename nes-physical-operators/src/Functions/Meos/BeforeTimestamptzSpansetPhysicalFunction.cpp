...
#include <Functions/Meos/BeforeTimestamptzSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBeforeTimestamptzSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BeforeTimestamptzSpansetPhysicalFunction::BeforeTimestamptzSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal BeforeTimestamptzSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = before_timestamptz_spanset(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBeforeTimestamptzSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "BeforeTimestamptzSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return BeforeTimestamptzSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
