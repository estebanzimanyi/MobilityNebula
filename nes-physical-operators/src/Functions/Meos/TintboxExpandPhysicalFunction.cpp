...
#include <Functions/Meos/TintboxExpandPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintboxExpandPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintboxExpandPhysicalFunction::TintboxExpandPhysicalFunction(PhysicalFunction litFunction,
...
VarVal TintboxExpandPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                TBox* res = (TBox*) tintbox_expand(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintboxExpandPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "TintboxExpandPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return TintboxExpandPhysicalFunction(std::move(arg0), std::move(arg1));
}
