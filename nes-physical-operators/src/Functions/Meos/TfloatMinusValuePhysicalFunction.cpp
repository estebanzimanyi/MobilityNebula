...
#include <Functions/Meos/TfloatMinusValuePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTfloatMinusValuePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TfloatMinusValuePhysicalFunction::TfloatMinusValuePhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TfloatMinusValuePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = tfloat_minus_value(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTfloatMinusValuePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TfloatMinusValuePhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TfloatMinusValuePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
