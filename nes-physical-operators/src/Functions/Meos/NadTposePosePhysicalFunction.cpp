    ...
    const auto result = nautilus::invoke(
        +[](double x,
            ...
            try
            {
                ...
                double r = nad_tpose_pose(temp, pose0);
                free(temp);
                free(pose0);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return NadTposePosePhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
