...
#include <Functions/Meos/ContainsTstzspanTemporalPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsTstzspanTemporalPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsTstzspanTemporalPhysicalFunction::ContainsTstzspanTemporalPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal ContainsTstzspanTemporalPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                int r = contains_tstzspan_temporal(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterContainsTstzspanTemporalPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "ContainsTstzspanTemporalPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return ContainsTstzspanTemporalPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
