...
#include <Functions/Meos/EverEqIntTintPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterEverEqIntTintPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

EverEqIntTintPhysicalFunction::EverEqIntTintPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal EverEqIntTintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverEqIntTintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverEqIntTintPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverEqIntTintPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
