...
#include <Functions/Meos/AdwithinGeoTgeoPhysicalFunction.hpp>
...
AdwithinGeoTgeoPhysicalFunction::AdwithinGeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal AdwithinGeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue,
            ...
            try
            {
                ...
                return adwithin_geo_tgeo(staticGeometry.getGeometry(),
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdwithinGeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "AdwithinGeoTgeoPhysicalFunction requires 5 children but got {}",
    ...
    return AdwithinGeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
