...
#include <Functions/Meos/EverGtTfloatTfloatPhysicalFunction.hpp>
...
EverGtTfloatTfloatPhysicalFunction::EverGtTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal EverGtTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverGtTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverGtTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverGtTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
