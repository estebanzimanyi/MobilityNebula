...
#include <Functions/Meos/MinusSpanFloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusSpanFloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusSpanFloatPhysicalFunction::MinusSpanFloatPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusSpanFloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = minus_span_float(temp, arg0);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusSpanFloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusSpanFloatPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusSpanFloatPhysicalFunction(std::move(arg0), std::move(arg1));
}
