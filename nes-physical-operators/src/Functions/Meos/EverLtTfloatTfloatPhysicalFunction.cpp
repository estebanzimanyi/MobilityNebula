...
#include <Functions/Meos/EverLtTfloatTfloatPhysicalFunction.hpp>
...
EverLtTfloatTfloatPhysicalFunction::EverLtTfloatTfloatPhysicalFunction(PhysicalFunction value1Function,
...
VarVal EverLtTfloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterEverLtTfloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "EverLtTfloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return EverLtTfloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
