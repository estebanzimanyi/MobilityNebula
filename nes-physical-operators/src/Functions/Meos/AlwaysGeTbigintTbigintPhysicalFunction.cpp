...
#include <Functions/Meos/AlwaysGeTbigintTbigintPhysicalFunction.hpp>
...
AlwaysGeTbigintTbigintPhysicalFunction::AlwaysGeTbigintTbigintPhysicalFunction(PhysicalFunction value1Function,
...
VarVal AlwaysGeTbigintTbigintPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAlwaysGeTbigintTbigintPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AlwaysGeTbigintTbigintPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AlwaysGeTbigintTbigintPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
