...
#include <Functions/Meos/BeforeSpansetTimestamptzPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBeforeSpansetTimestamptzPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BeforeSpansetTimestamptzPhysicalFunction::BeforeSpansetTimestamptzPhysicalFunction(PhysicalFunction litFunction,
...
VarVal BeforeSpansetTimestamptzPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = before_spanset_timestamptz(temp, arg0V);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBeforeSpansetTimestamptzPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "BeforeSpansetTimestamptzPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return BeforeSpansetTimestamptzPhysicalFunction(std::move(arg0), std::move(arg1));
}
