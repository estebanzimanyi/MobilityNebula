...
#include <Functions/Meos/TemporalADWithinTCbufferGeometryPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalADWithinTCbufferGeometryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalADWithinTCbufferGeometryPhysicalFunction::TemporalADWithinTCbufferGeometryPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalADWithinTCbufferGeometryPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonValue, double latValue, double radiusValue, uint64_t timestampValue,
            ...
            try
            {
                ...
                int r = adwithin_tcbuffer_geo(tcbuffer, staticGeometry.getGeometry(), distValue);
                free(tcbuffer);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalADWithinTCbufferGeometryPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TemporalADWithinTCbufferGeometryPhysicalFunction requires 6 children but got {}",
    ...
    return TemporalADWithinTCbufferGeometryPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
