...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMulTnumberTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }
