...
#include <Functions/Meos/TintersectsTgeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTintersectsTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TintersectsTgeoTgeoPhysicalFunction::TintersectsTgeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TintersectsTgeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            uint64_t ts2) -> char*
        {
            try
            {
                ...
                Temporal* res = tintersects_tgeo_tgeo(temp, arg0t);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTintersectsTgeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 6,
                 "TintersectsTgeoTgeoPhysicalFunction requires 6 children but got {}",
    ...
    return TintersectsTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
