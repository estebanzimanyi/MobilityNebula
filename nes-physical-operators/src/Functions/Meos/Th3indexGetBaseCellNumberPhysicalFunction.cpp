...
Th3indexGetBaseCellNumberPhysicalFunction::Th3indexGetBaseCellNumberPhysicalFunction(PhysicalFunction cellFunction,
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t cell,
            ...
            try
            {
                ...
                double r = th3index_get_base_cell_number(temp);
                free(temp);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return Th3indexGetBaseCellNumberPhysicalFunction(std::move(arg0), std::move(arg1));
}
