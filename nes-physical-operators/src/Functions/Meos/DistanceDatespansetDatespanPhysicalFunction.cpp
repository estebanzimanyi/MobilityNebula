...
#include <Functions/Meos/DistanceDatespansetDatespanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceDatespansetDatespanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceDatespansetDatespanPhysicalFunction::DistanceDatespansetDatespanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceDatespansetDatespanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = distance_datespanset_datespan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceDatespansetDatespanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceDatespansetDatespanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceDatespansetDatespanPhysicalFunction(std::move(arg0), std::move(arg1));
}
