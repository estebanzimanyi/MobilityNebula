...
#include <Functions/Meos/DistanceTstzsetTstzsetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceTstzsetTstzsetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceTstzsetTstzsetPhysicalFunction::DistanceTstzsetTstzsetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceTstzsetTstzsetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_tstzset_tstzset(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceTstzsetTstzsetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceTstzsetTstzsetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceTstzsetTstzsetPhysicalFunction(std::move(arg0), std::move(arg1));
}
