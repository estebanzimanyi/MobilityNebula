...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterContainsSpanFloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

ContainsSpanFloatPhysicalFunction::ContainsSpanFloatPhysicalFunction(PhysicalFunction litFunction,
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = contains_span_float(temp, arg0);
                free(temp);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return ContainsSpanFloatPhysicalFunction(std::move(arg0), std::move(arg1));
}
