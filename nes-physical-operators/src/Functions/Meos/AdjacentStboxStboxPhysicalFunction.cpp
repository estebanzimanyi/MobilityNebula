...
#include <Functions/Meos/AdjacentStboxStboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAdjacentStboxStboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AdjacentStboxStboxPhysicalFunction::AdjacentStboxStboxPhysicalFunction(PhysicalFunction boxFunction,
...
VarVal AdjacentStboxStboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* boxPtr, uint32_t boxSize,
            ...
            try
            {
                ...
                bool r = adjacent_stbox_stbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdjacentStboxStboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AdjacentStboxStboxPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AdjacentStboxStboxPhysicalFunction(std::move(arg0), std::move(arg1));
}
