...
#include <Functions/Meos/MinusFloatSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusFloatSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusFloatSetPhysicalFunction::MinusFloatSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusFloatSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Set* res = minus_float_set(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusFloatSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusFloatSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusFloatSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
