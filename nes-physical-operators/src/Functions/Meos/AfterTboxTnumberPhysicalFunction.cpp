...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAfterTboxTnumberPhysicalFunction(PhysicalFunctionRegistryArguments); }
