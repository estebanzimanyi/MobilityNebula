...
#include <Functions/Meos/UnionBigintSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionBigintSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionBigintSpansetPhysicalFunction::UnionBigintSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionBigintSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                SpanSet* res = union_bigint_spanset(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionBigintSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionBigintSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionBigintSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
