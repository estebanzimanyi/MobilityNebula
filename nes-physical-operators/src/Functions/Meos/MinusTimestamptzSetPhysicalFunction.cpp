...
#include <Functions/Meos/MinusTimestamptzSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterMinusTimestamptzSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

MinusTimestamptzSetPhysicalFunction::MinusTimestamptzSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal MinusTimestamptzSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int64_t arg0) -> char*
        {
            try
            {
                ...
                Set* res = minus_timestamptz_set(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterMinusTimestamptzSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "MinusTimestamptzSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return MinusTimestamptzSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
