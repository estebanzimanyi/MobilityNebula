...
#include <Functions/Meos/SpanEqPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpanEqPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpanEqPhysicalFunction::SpanEqPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpanEqPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpanEqPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpanEqPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpanEqPhysicalFunction(std::move(arg0), std::move(arg1));
}
