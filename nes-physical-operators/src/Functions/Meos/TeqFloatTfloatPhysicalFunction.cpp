...
#include <Functions/Meos/TeqFloatTfloatPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTeqFloatTfloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TeqFloatTfloatPhysicalFunction::TeqFloatTfloatPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TeqFloatTfloatPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                Temporal* res = teq_float_tfloat(arg0, temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTeqFloatTfloatPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TeqFloatTfloatPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TeqFloatTfloatPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
