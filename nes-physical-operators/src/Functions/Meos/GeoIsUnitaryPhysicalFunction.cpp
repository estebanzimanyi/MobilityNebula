...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeoIsUnitaryPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeoIsUnitaryPhysicalFunction::GeoIsUnitaryPhysicalFunction(PhysicalFunction litFunction)
{
