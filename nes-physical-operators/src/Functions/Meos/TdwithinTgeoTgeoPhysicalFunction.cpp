...
#include <Functions/Meos/TdwithinTgeoTgeoPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTdwithinTgeoTgeoPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TdwithinTgeoTgeoPhysicalFunction::TdwithinTgeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TdwithinTgeoTgeoPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto arg1 = parameterValues[6].cast<nautilus::val<double>>();
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg1) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) tdwithin_tgeo_tgeo(temp, arg0t, arg1);
                free(temp);
                free(arg0t);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTdwithinTgeoTgeoPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 7,
                 "TdwithinTgeoTgeoPhysicalFunction requires 7 children but got {}",
    ...
    return TdwithinTgeoTgeoPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6));
}
