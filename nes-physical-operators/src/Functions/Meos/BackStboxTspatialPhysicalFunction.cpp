...
#include <Functions/Meos/BackStboxTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBackStboxTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BackStboxTspatialPhysicalFunction::BackStboxTspatialPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal BackStboxTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = back_stbox_tspatial(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBackStboxTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "BackStboxTspatialPhysicalFunction requires 5 children but got {}",
    ...
    return BackStboxTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
