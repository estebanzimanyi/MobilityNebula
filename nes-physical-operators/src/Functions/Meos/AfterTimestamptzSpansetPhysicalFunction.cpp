...
#include <Functions/Meos/AfterTimestamptzSpansetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAfterTimestamptzSpansetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AfterTimestamptzSpansetPhysicalFunction::AfterTimestamptzSpansetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal AfterTimestamptzSpansetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = after_timestamptz_spanset(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAfterTimestamptzSpansetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "AfterTimestamptzSpansetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return AfterTimestamptzSpansetPhysicalFunction(std::move(arg0), std::move(arg1));
}
