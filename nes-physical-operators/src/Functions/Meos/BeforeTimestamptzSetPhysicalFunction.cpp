...
#include <Functions/Meos/BeforeTimestamptzSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterBeforeTimestamptzSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

BeforeTimestamptzSetPhysicalFunction::BeforeTimestamptzSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal BeforeTimestamptzSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = before_timestamptz_set(arg0V, temp);
                free(temp);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterBeforeTimestamptzSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "BeforeTimestamptzSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return BeforeTimestamptzSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
