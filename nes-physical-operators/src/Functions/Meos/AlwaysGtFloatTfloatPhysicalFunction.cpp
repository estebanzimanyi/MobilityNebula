...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAlwaysGtFloatTfloatPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AlwaysGtFloatTfloatPhysicalFunction::AlwaysGtFloatTfloatPhysicalFunction(PhysicalFunction valueFunction,
