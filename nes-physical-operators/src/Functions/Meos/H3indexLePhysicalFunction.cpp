...
H3indexLePhysicalFunction::H3indexLePhysicalFunction(PhysicalFunction aFunction,
    ...
    const auto result = nautilus::invoke(
        +[](uint64_t a,
            ...
            try
            {
                ...
                double r = h3index_le((H3Index)a, (H3Index)b);
                return r;
            }
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return H3indexLePhysicalFunction(std::move(arg0), std::move(arg1));
}
