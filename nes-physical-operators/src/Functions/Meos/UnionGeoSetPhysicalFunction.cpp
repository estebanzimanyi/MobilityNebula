...
#include <Functions/Meos/UnionGeoSetPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterUnionGeoSetPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

UnionGeoSetPhysicalFunction::UnionGeoSetPhysicalFunction(PhysicalFunction litFunction,
...
VarVal UnionGeoSetPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Set* res = union_geo_set(arg0G.getGeometry(), temp);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterUnionGeoSetPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "UnionGeoSetPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return UnionGeoSetPhysicalFunction(std::move(arg0), std::move(arg1));
}
