...
#include <Functions/Meos/FrontStboxTspatialPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterFrontStboxTspatialPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

FrontStboxTspatialPhysicalFunction::FrontStboxTspatialPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal FrontStboxTspatialPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lon,
            ...
            try
            {
                ...
                int r = front_stbox_tspatial(arg0B, temp);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterFrontStboxTspatialPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "FrontStboxTspatialPhysicalFunction requires 5 children but got {}",
    ...
    return FrontStboxTspatialPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
