...
#include <Functions/Meos/TemporalACoversTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalACoversTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalACoversTCbufferPhysicalFunction::TemporalACoversTCbufferPhysicalFunction(PhysicalFunction lonFunction,
...
VarVal TemporalACoversTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalACoversTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 5,
                 "TemporalACoversTCbufferPhysicalFunction requires 5 children but got {}",
    ...
    return TemporalACoversTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
