...
#include <Functions/Meos/DistanceFloatspanFloatspanPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterDistanceFloatspanFloatspanPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

DistanceFloatspanFloatspanPhysicalFunction::DistanceFloatspanFloatspanPhysicalFunction(PhysicalFunction litFunction,
...
VarVal DistanceFloatspanFloatspanPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                double r = distance_floatspan_floatspan(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterDistanceFloatspanFloatspanPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "DistanceFloatspanFloatspanPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return DistanceFloatspanFloatspanPhysicalFunction(std::move(arg0), std::move(arg1));
}
