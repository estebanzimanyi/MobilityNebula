...
#include <Functions/Meos/StboxExpandSpacePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterStboxExpandSpacePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

StboxExpandSpacePhysicalFunction::StboxExpandSpacePhysicalFunction(PhysicalFunction boxFunction,
...
VarVal StboxExpandSpacePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            double arg0) -> char*
        {
            try
            {
                ...
                STBox* res = (STBox*) stbox_expand_space(temp, arg0);
                free(temp);
        ...
        box.getContent(), box.getContentSize(), arg0);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterStboxExpandSpacePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "StboxExpandSpacePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return StboxExpandSpacePhysicalFunction(std::move(arg0), std::move(arg1));
}
