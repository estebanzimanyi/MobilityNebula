...
#include <Functions/Meos/TemporalETouchesTCbufferTCbufferPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalETouchesTCbufferTCbufferPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalETouchesTCbufferTCbufferPhysicalFunction::TemporalETouchesTCbufferTCbufferPhysicalFunction(PhysicalFunction lonAFunction,
...
VarVal TemporalETouchesTCbufferTCbufferPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double lonAValue, double latAValue, double radiusAValue, uint64_t tsAValue,
            ...
            try
            {
                ...
                int r = etouches_tcbuffer_tcbuffer(tA, tB);
                free(tA);
                free(tB);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalETouchesTCbufferTCbufferPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 8,
                 "TemporalETouchesTCbufferTCbufferPhysicalFunction requires 8 children but got {}",
    ...
    return TemporalETouchesTCbufferTCbufferPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
