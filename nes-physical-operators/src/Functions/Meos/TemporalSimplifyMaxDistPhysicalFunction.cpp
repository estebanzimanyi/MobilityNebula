...
#include <Functions/Meos/TemporalSimplifyMaxDistPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalSimplifyMaxDistPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalSimplifyMaxDistPhysicalFunction::TemporalSimplifyMaxDistPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalSimplifyMaxDistPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            bool arg1) -> char*
        {
            try
            {
                ...
                Temporal* res = (Temporal*) temporal_simplify_max_dist(temp, arg0, arg1);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalSimplifyMaxDistPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 4,
                 "TemporalSimplifyMaxDistPhysicalFunction requires 4 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    auto arg3 = std::move(arguments.childFunctions[3]);
    return TemporalSimplifyMaxDistPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
