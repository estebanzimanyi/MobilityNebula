...
#include <Functions/Meos/AdjacentTnumberTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterAdjacentTnumberTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

AdjacentTnumberTboxPhysicalFunction::AdjacentTnumberTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal AdjacentTnumberTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](double value,
            ...
            try
            {
                ...
                bool r = adjacent_tnumber_tbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterAdjacentTnumberTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "AdjacentTnumberTboxPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return AdjacentTnumberTboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
