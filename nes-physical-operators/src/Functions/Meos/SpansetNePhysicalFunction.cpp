...
#include <Functions/Meos/SpansetNePhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetNePhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetNePhysicalFunction::SpansetNePhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetNePhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetNePhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetNePhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetNePhysicalFunction(std::move(arg0), std::move(arg1));
}
