...
#include <Functions/Meos/SpansetSplitNSpansPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetSplitNSpansPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetSplitNSpansPhysicalFunction::SpansetSplitNSpansPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetSplitNSpansPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            int32_t arg0) -> char*
        {
            try
            {
                ...
                int _cnt = 0;
                Span* arr = (Span*) spanset_split_n_spans(temp, arg0, &_cnt);
                free(temp);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetSplitNSpansPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetSplitNSpansPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetSplitNSpansPhysicalFunction(std::move(arg0), std::move(arg1));
}
