...
#include <Functions/Meos/TemporalMinusValuesPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterTemporalMinusValuesPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

TemporalMinusValuesPhysicalFunction::TemporalMinusValuesPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal TemporalMinusValuesPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    auto outStr = nautilus::invoke(
            ...
            const char* arg0Ptr, uint32_t arg0Size) -> char*
        {
            try
            {
                ...
                Temporal* res = temporal_minus_values(temp, arg0B);
                free(temp);
                free(arg0B);
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterTemporalMinusValuesPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "TemporalMinusValuesPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return TemporalMinusValuesPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
