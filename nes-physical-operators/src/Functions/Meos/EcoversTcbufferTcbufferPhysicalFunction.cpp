...
EcoversTcbufferTcbufferPhysicalFunction::EcoversTcbufferTcbufferPhysicalFunction(
    ...
    const auto result = nautilus::invoke(
        +[](double lon1, double lat1, double r1, uint64_t ts1,
            ...
            try {
                ...
                int r = ecovers_tcbuffer_tcbuffer(tcb1, tcb2);
                free(tcb1); free(tcb2);
                return r > 0 ? 1.0 : 0.0;
    ...
    PhysicalFunctionRegistryArguments arguments)
{
    ...
    return EcoversTcbufferTcbufferPhysicalFunction(std::move(arguments.childFunctions[0]),
