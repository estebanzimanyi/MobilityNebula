...
#include <Functions/Meos/GeomIntersects3dPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterGeomIntersects3dPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

GeomIntersects3dPhysicalFunction::GeomIntersects3dPhysicalFunction(PhysicalFunction litFunction,
...
VarVal GeomIntersects3dPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](const char* litPtr, uint32_t litSize,
            ...
            try
            {
                ...
                int r = geom_intersects3d(temp, arg0G.getGeometry());
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterGeomIntersects3dPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "GeomIntersects3dPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return GeomIntersects3dPhysicalFunction(std::move(arg0), std::move(arg1));
}
