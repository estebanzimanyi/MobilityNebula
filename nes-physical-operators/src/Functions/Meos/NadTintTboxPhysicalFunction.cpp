...
#include <Functions/Meos/NadTintTboxPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterNadTintTboxPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

NadTintTboxPhysicalFunction::NadTintTboxPhysicalFunction(PhysicalFunction valueFunction,
...
VarVal NadTintTboxPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    const auto result = nautilus::invoke(
        +[](int32_t value,
            ...
            try
            {
                ...
                int r = nad_tint_tbox(temp, arg0B);
                free(temp);
                free(arg0B);
                return r;
            }
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterNadTintTboxPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 3,
                 "NadTintTboxPhysicalFunction requires 3 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    auto arg2 = std::move(arguments.childFunctions[2]);
    return NadTintTboxPhysicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
