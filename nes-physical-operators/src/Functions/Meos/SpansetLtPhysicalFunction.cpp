...
#include <Functions/Meos/SpansetLtPhysicalFunction.hpp>
...
namespace NES::PhysicalFunctionGeneratedRegistrar { PhysicalFunctionRegistryReturnType RegisterSpansetLtPhysicalFunction(PhysicalFunctionRegistryArguments); }

namespace NES {

SpansetLtPhysicalFunction::SpansetLtPhysicalFunction(PhysicalFunction litFunction,
...
VarVal SpansetLtPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterSpansetLtPhysicalFunction(
    PhysicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.childFunctions.size() == 2,
                 "SpansetLtPhysicalFunction requires 2 children but got {}",
                 arguments.childFunctions.size());
    auto arg0 = std::move(arguments.childFunctions[0]);
    auto arg1 = std::move(arguments.childFunctions[1]);
    return SpansetLtPhysicalFunction(std::move(arg0), std::move(arg1));
}
