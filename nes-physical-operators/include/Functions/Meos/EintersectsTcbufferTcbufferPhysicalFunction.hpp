...
class EintersectsTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    EintersectsTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
