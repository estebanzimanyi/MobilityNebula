...
class AlwaysEqTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    AlwaysEqTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
