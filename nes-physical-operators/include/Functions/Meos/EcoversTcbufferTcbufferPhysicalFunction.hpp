...
class EcoversTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    EcoversTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
