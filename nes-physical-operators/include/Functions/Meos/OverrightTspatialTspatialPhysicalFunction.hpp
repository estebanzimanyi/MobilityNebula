...
/**
 * @brief Physical operator for `overright_tspatial_tspatial`.
 *
 * Per-event overright_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class OverrightTspatialTspatialPhysicalFunction : public PhysicalFunctionConcept {
public:
