...
/**
 * @brief Physical operator for `contains_temporal_temporal`.
 *
 * Per-event contains_temporal_temporal between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class ContainsTemporalTemporalPhysicalFunction : public PhysicalFunctionConcept {
public:
