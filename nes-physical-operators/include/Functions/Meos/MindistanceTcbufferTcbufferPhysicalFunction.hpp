...
/**
 * @brief Physical operator for `mindistance_tcbuffer_tcbuffer`.
 *
 * Per-event minimum distance between two tcbuffer instants within threshold.
 *
...
public:
    MindistanceTcbufferTcbufferPhysicalFunction(PhysicalFunction lonAFunction,
