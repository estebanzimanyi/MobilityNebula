...
/**
 * @brief Physical operator for `above_tspatial_tspatial`.
 *
 * Per-event above_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class AboveTspatialTspatialPhysicalFunction : public PhysicalFunctionConcept {
public:
