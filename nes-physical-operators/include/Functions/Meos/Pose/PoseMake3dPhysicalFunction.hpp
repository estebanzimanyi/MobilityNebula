...
/**
 * @brief Physical operator for `pose_make_3d`.
 *
 * pose_make_3d (Pose *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class PoseMake3dPhysicalFunction : public PhysicalFunctionConcept {
public:
    PoseMake3dPhysicalFunction(PhysicalFunction valueFunction,
