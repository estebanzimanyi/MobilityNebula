...
class AintersectsTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    AintersectsTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
