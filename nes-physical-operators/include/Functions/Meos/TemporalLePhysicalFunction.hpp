...
/**
 * @brief Physical operator for `temporal_le`.
 *
 * Per-event temporal_le between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class TemporalLePhysicalFunction : public PhysicalFunctionConcept {
public:
