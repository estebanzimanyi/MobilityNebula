...
class AdisjointTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    AdisjointTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
