...
/**
 * @brief Physical operator for `intersects_tgeo_geo`.
 *
 * Per-event intersects_tgeo_geo spatial predicate.
 *
...
public:
    TemporalIntersectsGeometryPhysicalFunction(PhysicalFunction lonFunction,
