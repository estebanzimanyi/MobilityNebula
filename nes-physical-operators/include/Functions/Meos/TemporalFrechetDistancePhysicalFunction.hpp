...
/**
 * @brief Physical operator for `temporal_frechet_distance`.
 *
 * Per-event temporal_frechet_distance between two single-instant tgeompoints -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class TemporalFrechetDistancePhysicalFunction : public PhysicalFunctionConcept {
public:
