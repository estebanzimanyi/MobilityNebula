...
/**
 * @brief Physical operator for `left_tspatial_tspatial`.
 *
 * Per-event left_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class LeftTspatialTspatialPhysicalFunction : public PhysicalFunctionConcept {
public:
