...
/**
 * @brief Physical operator for `overafter_tspatial_tspatial`.
 *
 * Per-event overafter_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class OverafterTspatialTspatialPhysicalFunction : public PhysicalFunctionConcept {
public:
