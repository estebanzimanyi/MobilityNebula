...
/**
 * @brief Physical operator for `ecovers_tcbuffer_tcbuffer`.
 *
 * Per-event ever-covers between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class TemporalECoversTCbufferTCbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    TemporalECoversTCbufferTCbufferPhysicalFunction(PhysicalFunction lonAFunction,
