...
/**
 * @brief Physical operator for `ever_eq_geo_tgeo`.
 *
 * ever_eq_geo_tgeo (int) — temporal tgeo ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class EverEqGeoTgeoPhysicalFunction : public PhysicalFunctionConcept {
public:
    EverEqGeoTgeoPhysicalFunction(PhysicalFunction lonFunction,
