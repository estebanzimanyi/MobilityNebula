...
/**
 * @brief Physical operator for `interval_make`.
 *
 * interval_make (Interval *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class IntervalMakePhysicalFunction : public PhysicalFunctionConcept {
public:
    IntervalMakePhysicalFunction(PhysicalFunction valueFunction,
