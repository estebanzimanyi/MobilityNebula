...
/**
 * @brief Physical operator for `ever_ne_tcbuffer_tcbuffer`.
 *
 * Per-event ever_ne_tcbuffer_tcbuffer between two single-instant tcbuffers -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class EverNeTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    EverNeTcbufferTcbufferPhysicalFunction(PhysicalFunction lonAFunction,
