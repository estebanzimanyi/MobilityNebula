...
/**
 * @brief Physical operator for `tdwithin_tcbuffer_tcbuffer`.
 *
 * tdwithin_tcbuffer_tcbuffer (Temporal *) — two tcbuffer instants tdwithin.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class TdwithinTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    TdwithinTcbufferTcbufferPhysicalFunction(PhysicalFunction lonFunction,
