...
class AlwaysNeTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    AlwaysNeTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
