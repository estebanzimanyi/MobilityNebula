...
class AtouchesTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    AtouchesTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
