...
/**
 * @brief Physical operator for `acovers_tcbuffer_tcbuffer`.
 *
 * Per-event acovers_tcbuffer_tcbuffer spatial predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py.
 */
class AcoversTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    AcoversTcbufferTcbufferPhysicalFunction(PhysicalFunction lonAFunction,
