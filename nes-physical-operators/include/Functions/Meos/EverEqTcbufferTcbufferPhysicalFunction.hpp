...
class EverEqTcbufferTcbufferPhysicalFunction : public PhysicalFunctionConcept {
public:
    EverEqTcbufferTcbufferPhysicalFunction(PhysicalFunction lon1, PhysicalFunction lat1, PhysicalFunction r1,
