...
class SpanExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    SpanExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~SpanExtentTransfnAggregationPhysicalFunction() override = default;
