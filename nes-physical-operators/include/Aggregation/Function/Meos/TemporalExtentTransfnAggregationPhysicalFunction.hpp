...
class TemporalExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalExtentTransfnAggregationPhysicalFunction() override = default;
