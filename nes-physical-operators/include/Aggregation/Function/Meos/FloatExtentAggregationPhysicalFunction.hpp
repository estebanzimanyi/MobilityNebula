...
class FloatExtentAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    FloatExtentAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~FloatExtentAggregationPhysicalFunction() override = default;
