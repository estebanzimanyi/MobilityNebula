...
class TnumberIntegralAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberIntegralAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberIntegralAggregationPhysicalFunction() override = default;
