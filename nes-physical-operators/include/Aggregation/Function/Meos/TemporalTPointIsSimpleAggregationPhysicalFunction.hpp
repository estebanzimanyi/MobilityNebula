...
class TemporalTPointIsSimpleAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalTPointIsSimpleAggregationPhysicalFunction() override = default;
