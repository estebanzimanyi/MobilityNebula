...
class TpointGetYAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointGetYAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointGetYAggregationPhysicalFunction() override = default;
