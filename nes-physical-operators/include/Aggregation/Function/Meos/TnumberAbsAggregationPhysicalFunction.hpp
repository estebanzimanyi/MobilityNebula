...
class TnumberAbsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberAbsAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberAbsAggregationPhysicalFunction() override = default;
