...
class TnumberAngularDifferenceExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TnumberAngularDifferenceExpAggregationPhysicalFunction() override = default;
