...
class TintStartValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintStartValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintStartValueAggregationPhysicalFunction() override = default;
