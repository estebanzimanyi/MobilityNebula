...
class TemporalTFloatStartValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTFloatStartValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTFloatStartValueAggregationPhysicalFunction() override = default;
