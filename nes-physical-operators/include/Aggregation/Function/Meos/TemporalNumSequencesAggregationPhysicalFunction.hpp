...
class TemporalNumSequencesAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalNumSequencesAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalNumSequencesAggregationPhysicalFunction() override = default;
