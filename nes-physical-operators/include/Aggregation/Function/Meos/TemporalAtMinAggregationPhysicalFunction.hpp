...
class TemporalAtMinAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalAtMinAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalAtMinAggregationPhysicalFunction() override = default;
