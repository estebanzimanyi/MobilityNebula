...
class TemporalTNumberTwAvgAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTNumberTwAvgAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTNumberTwAvgAggregationPhysicalFunction() override = default;
