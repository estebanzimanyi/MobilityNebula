...
class TimestamptzUnionAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TimestamptzUnionAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TimestamptzUnionAggregationPhysicalFunction() override = default;
