...
class TfloatStartValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatStartValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatStartValueAggregationPhysicalFunction() override = default;
