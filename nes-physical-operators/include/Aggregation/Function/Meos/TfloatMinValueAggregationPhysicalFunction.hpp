...
class TfloatMinValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatMinValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatMinValueAggregationPhysicalFunction() override = default;
