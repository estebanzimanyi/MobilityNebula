...
class TemporalMergeTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalMergeTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalMergeTransfnAggregationPhysicalFunction() override = default;
