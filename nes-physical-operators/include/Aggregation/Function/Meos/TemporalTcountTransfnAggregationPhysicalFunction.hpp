...
class TemporalTcountTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTcountTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTcountTransfnAggregationPhysicalFunction() override = default;
