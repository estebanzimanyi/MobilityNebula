...
class TpointTcentroidTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointTcentroidTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointTcentroidTransfnAggregationPhysicalFunction() override = default;
