...
class TpointSpeedExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointSpeedExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointSpeedExpAggregationPhysicalFunction() override = default;
