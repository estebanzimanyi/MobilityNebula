...
class TintMaxValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintMaxValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintMaxValueAggregationPhysicalFunction() override = default;
