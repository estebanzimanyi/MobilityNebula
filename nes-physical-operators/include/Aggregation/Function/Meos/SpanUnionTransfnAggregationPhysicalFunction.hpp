...
class SpanUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    SpanUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~SpanUnionTransfnAggregationPhysicalFunction() override = default;
