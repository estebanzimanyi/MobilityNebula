...
class TpointAngularDifferenceAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointAngularDifferenceAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointAngularDifferenceAggregationPhysicalFunction() override = default;
