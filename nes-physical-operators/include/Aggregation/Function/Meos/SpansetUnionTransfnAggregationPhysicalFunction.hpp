...
class SpansetUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    SpansetUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~SpansetUnionTransfnAggregationPhysicalFunction() override = default;
