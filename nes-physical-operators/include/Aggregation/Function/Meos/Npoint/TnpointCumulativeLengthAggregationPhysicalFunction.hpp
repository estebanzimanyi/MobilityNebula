...
class TnpointCumulativeLengthAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnpointCumulativeLengthAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnpointCumulativeLengthAggregationPhysicalFunction() override = default;
