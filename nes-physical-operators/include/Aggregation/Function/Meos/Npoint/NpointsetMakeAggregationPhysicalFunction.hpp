...
class NpointsetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    NpointsetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~NpointsetMakeAggregationPhysicalFunction() override = default;
