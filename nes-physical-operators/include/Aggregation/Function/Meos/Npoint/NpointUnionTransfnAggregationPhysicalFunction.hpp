...
class NpointUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    NpointUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~NpointUnionTransfnAggregationPhysicalFunction() override = default;
