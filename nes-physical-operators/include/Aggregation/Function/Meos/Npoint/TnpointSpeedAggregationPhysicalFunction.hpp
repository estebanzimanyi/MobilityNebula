...
class TnpointSpeedAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnpointSpeedAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnpointSpeedAggregationPhysicalFunction() override = default;
