...
class TnpointTcentroidTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnpointTcentroidTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnpointTcentroidTransfnAggregationPhysicalFunction() override = default;
