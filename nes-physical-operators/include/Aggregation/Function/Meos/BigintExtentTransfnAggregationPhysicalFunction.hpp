...
class BigintExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    BigintExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~BigintExtentTransfnAggregationPhysicalFunction() override = default;
