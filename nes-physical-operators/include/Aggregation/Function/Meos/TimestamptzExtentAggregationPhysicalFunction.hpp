...
class TimestamptzExtentAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TimestamptzExtentAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TimestamptzExtentAggregationPhysicalFunction() override = default;
