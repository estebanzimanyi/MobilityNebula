...
class TgeoConvexHullAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TgeoConvexHullAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TgeoConvexHullAggregationPhysicalFunction() override = default;
