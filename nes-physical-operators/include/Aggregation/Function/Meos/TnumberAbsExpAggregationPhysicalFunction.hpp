...
class TnumberAbsExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberAbsExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberAbsExpAggregationPhysicalFunction() override = default;
