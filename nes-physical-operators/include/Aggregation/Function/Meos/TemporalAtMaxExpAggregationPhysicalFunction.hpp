...
class TemporalAtMaxExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalAtMaxExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalAtMaxExpAggregationPhysicalFunction() override = default;
