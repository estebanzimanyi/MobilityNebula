...
class TrajectoryWkbAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrajectoryWkbAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrajectoryWkbAggregationPhysicalFunction() override = default;
