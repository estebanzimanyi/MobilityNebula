...
class TnpointCumulativeLengthExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnpointCumulativeLengthExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnpointCumulativeLengthExpAggregationPhysicalFunction() override = default;
