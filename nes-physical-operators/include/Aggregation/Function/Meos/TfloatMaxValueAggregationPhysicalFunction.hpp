...
class TfloatMaxValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatMaxValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatMaxValueAggregationPhysicalFunction() override = default;
