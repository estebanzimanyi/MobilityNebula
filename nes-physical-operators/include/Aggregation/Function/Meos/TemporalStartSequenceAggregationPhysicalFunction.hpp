...
class TemporalStartSequenceAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalStartSequenceAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalStartSequenceAggregationPhysicalFunction() override = default;
