...
class TstzspansetTcountTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TstzspansetTcountTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TstzspansetTcountTransfnAggregationPhysicalFunction() override = default;
