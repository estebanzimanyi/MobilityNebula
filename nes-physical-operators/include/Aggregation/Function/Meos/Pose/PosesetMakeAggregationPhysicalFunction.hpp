...
class PosesetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    PosesetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~PosesetMakeAggregationPhysicalFunction() override = default;
