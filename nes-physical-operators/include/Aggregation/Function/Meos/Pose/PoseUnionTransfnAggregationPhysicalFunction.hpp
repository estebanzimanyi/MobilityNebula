...
class PoseUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    PoseUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~PoseUnionTransfnAggregationPhysicalFunction() override = default;
