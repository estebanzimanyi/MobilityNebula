...
class TpointMakeSimpleAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointMakeSimpleAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointMakeSimpleAggregationPhysicalFunction() override = default;
