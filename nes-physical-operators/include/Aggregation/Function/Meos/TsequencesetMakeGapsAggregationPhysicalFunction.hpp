...
class TsequencesetMakeGapsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TsequencesetMakeGapsAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TsequencesetMakeGapsAggregationPhysicalFunction() override = default;
