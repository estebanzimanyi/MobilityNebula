...
class TextsetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TextsetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TextsetMakeAggregationPhysicalFunction() override = default;
