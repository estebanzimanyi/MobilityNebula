...
class TnumberWavgTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberWavgTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberWavgTransfnAggregationPhysicalFunction() override = default;
