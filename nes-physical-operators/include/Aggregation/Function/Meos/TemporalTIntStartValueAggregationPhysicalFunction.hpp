...
class TemporalTIntStartValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTIntStartValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTIntStartValueAggregationPhysicalFunction() override = default;
