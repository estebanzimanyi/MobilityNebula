...
class TpointGetXExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointGetXExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointGetXExpAggregationPhysicalFunction() override = default;
