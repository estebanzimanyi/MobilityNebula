...
class GeosetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    GeosetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~GeosetMakeAggregationPhysicalFunction() override = default;
