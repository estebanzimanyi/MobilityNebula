...
class GeomArrayUnionAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    GeomArrayUnionAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~GeomArrayUnionAggregationPhysicalFunction() override = default;
