...
class TLengthExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TLengthExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TLengthExpAggregationPhysicalFunction() override = default;
