...
class TpointTwcentroidExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TpointTwcentroidExpAggregationPhysicalFunction() override = default;
