...
class TpointTrajectoryAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointTrajectoryAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointTrajectoryAggregationPhysicalFunction() override = default;
