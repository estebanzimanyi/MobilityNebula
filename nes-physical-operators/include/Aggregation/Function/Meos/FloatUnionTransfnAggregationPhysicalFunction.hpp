...
class FloatUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    FloatUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~FloatUnionTransfnAggregationPhysicalFunction() override = default;
