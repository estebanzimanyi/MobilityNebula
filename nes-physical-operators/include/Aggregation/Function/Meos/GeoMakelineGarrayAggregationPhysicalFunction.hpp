...
class GeoMakelineGarrayAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    GeoMakelineGarrayAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~GeoMakelineGarrayAggregationPhysicalFunction() override = default;
