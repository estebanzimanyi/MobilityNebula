...
class GeoUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    GeoUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~GeoUnionTransfnAggregationPhysicalFunction() override = default;
