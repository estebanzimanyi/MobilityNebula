...
class TintTsumTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintTsumTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintTsumTransfnAggregationPhysicalFunction() override = default;
