...
class TemporalSequencesAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalSequencesAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalSequencesAggregationPhysicalFunction() override = default;
