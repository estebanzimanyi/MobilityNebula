...
class TintEndValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintEndValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintEndValueAggregationPhysicalFunction() override = default;
