...
class IntsetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    IntsetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~IntsetMakeAggregationPhysicalFunction() override = default;
