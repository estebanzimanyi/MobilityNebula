...
class TstzsetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TstzsetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TstzsetMakeAggregationPhysicalFunction() override = default;
