...
class TpointTwcentroidAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointTwcentroidAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointTwcentroidAggregationPhysicalFunction() override = default;
