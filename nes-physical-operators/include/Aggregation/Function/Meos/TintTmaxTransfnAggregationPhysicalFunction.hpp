...
class TintTmaxTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintTmaxTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintTmaxTransfnAggregationPhysicalFunction() override = default;
