...
class BigintUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    BigintUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~BigintUnionTransfnAggregationPhysicalFunction() override = default;
