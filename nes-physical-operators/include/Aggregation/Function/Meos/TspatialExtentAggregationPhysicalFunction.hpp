...
class TspatialExtentAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TspatialExtentAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TspatialExtentAggregationPhysicalFunction() override = default;
