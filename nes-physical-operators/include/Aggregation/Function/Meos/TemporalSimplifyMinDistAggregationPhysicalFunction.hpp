...
class TemporalSimplifyMinDistAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalSimplifyMinDistAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalSimplifyMinDistAggregationPhysicalFunction() override = default;
