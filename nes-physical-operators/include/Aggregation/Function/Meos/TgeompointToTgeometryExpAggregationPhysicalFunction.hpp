...
class TgeompointToTgeometryExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TgeompointToTgeometryExpAggregationPhysicalFunction() override = default;
