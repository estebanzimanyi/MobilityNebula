...
class TemporalMinusMaxAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalMinusMaxAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalMinusMaxAggregationPhysicalFunction() override = default;
