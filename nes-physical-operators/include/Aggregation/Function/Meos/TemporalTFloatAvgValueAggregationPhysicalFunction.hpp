...
class TemporalTFloatAvgValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalTFloatAvgValueAggregationPhysicalFunction() override = default;
