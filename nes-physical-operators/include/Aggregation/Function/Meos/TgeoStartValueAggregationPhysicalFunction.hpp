...
class TgeoStartValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TgeoStartValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TgeoStartValueAggregationPhysicalFunction() override = default;
