...
class BigintUnionAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    BigintUnionAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~BigintUnionAggregationPhysicalFunction() override = default;
