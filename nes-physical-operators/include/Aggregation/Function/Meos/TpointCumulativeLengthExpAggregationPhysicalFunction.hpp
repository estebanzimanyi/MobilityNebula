...
class TpointCumulativeLengthExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TpointCumulativeLengthExpAggregationPhysicalFunction() override = default;
