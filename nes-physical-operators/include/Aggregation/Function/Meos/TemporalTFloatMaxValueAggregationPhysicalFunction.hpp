...
class TemporalTFloatMaxValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTFloatMaxValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTFloatMaxValueAggregationPhysicalFunction() override = default;
