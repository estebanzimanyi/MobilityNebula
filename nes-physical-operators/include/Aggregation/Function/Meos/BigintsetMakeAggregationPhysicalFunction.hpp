...
class BigintsetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    BigintsetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~BigintsetMakeAggregationPhysicalFunction() override = default;
