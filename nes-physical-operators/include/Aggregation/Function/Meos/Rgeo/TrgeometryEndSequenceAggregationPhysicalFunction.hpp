...
class TrgeometryEndSequenceAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometryEndSequenceAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometryEndSequenceAggregationPhysicalFunction() override = default;
