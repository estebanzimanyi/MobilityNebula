...
class TrgeometrySequenceNAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometrySequenceNAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometrySequenceNAggregationPhysicalFunction() override = default;
