...
class TrgeometrySequencesAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometrySequencesAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometrySequencesAggregationPhysicalFunction() override = default;
