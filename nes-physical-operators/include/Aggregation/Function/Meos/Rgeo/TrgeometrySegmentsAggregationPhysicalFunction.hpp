...
class TrgeometrySegmentsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometrySegmentsAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometrySegmentsAggregationPhysicalFunction() override = default;
