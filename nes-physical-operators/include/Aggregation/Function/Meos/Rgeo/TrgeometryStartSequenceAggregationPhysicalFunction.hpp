...
class TrgeometryStartSequenceAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometryStartSequenceAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometryStartSequenceAggregationPhysicalFunction() override = default;
