...
class TrgeometrySetInterpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometrySetInterpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometrySetInterpAggregationPhysicalFunction() override = default;
