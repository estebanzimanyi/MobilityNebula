...
class TrgeometryInstantsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometryInstantsAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometryInstantsAggregationPhysicalFunction() override = default;
