...
class TrgeometryRestrictValuesAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TrgeometryRestrictValuesAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TrgeometryRestrictValuesAggregationPhysicalFunction() override = default;
