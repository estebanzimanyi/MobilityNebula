...
class TemporalMinusMaxExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalMinusMaxExpAggregationPhysicalFunction() override = default;
