...
class TpointDirectionAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointDirectionAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointDirectionAggregationPhysicalFunction() override = default;
