...
class TfloatWsumTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatWsumTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatWsumTransfnAggregationPhysicalFunction() override = default;
