...
class CbuffersetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    CbuffersetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~CbuffersetMakeAggregationPhysicalFunction() override = default;
