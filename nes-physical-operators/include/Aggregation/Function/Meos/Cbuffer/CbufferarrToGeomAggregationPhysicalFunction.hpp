...
class CbufferarrToGeomAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    CbufferarrToGeomAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~CbufferarrToGeomAggregationPhysicalFunction() override = default;
