...
class CbufferUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    CbufferUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~CbufferUnionTransfnAggregationPhysicalFunction() override = default;
