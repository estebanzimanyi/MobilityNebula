...
class TemporalEndTimestamptzAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalEndTimestamptzAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalEndTimestamptzAggregationPhysicalFunction() override = default;
