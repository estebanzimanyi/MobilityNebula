...
class TnumberAngularDifferenceAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberAngularDifferenceAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberAngularDifferenceAggregationPhysicalFunction() override = default;
