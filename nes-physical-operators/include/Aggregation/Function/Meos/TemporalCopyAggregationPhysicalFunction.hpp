...
class TemporalCopyAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalCopyAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalCopyAggregationPhysicalFunction() override = default;
