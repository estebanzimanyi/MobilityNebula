...
class TgeompointToTgeometryAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TgeompointToTgeometryAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TgeompointToTgeometryAggregationPhysicalFunction() override = default;
