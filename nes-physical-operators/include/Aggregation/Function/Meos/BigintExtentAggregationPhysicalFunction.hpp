...
class BigintExtentAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    BigintExtentAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~BigintExtentAggregationPhysicalFunction() override = default;
