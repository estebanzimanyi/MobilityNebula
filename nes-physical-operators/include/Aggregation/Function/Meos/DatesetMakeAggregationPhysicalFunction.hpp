...
class DatesetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    DatesetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~DatesetMakeAggregationPhysicalFunction() override = default;
