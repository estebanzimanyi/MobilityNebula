...
class DateUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    DateUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~DateUnionTransfnAggregationPhysicalFunction() override = default;
