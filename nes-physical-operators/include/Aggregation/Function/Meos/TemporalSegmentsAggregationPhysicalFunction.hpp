...
class TemporalSegmentsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalSegmentsAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalSegmentsAggregationPhysicalFunction() override = default;
