...
class TemporalNumInstantsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalNumInstantsAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalNumInstantsAggregationPhysicalFunction() override = default;
