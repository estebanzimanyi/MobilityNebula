...
class TemporalSequenceNAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalSequenceNAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalSequenceNAggregationPhysicalFunction() override = default;
