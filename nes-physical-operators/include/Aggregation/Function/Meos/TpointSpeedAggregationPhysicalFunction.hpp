...
class TpointSpeedAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointSpeedAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointSpeedAggregationPhysicalFunction() override = default;
