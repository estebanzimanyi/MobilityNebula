...
class TfloatEndValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatEndValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatEndValueAggregationPhysicalFunction() override = default;
