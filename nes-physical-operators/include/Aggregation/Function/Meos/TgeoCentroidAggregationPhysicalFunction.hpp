...
class TgeoCentroidAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TgeoCentroidAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TgeoCentroidAggregationPhysicalFunction() override = default;
