...
class TnumberDeltaValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberDeltaValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberDeltaValueAggregationPhysicalFunction() override = default;
