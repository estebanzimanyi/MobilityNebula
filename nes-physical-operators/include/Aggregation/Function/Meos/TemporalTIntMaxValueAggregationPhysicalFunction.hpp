...
class TemporalTIntMaxValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTIntMaxValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTIntMaxValueAggregationPhysicalFunction() override = default;
