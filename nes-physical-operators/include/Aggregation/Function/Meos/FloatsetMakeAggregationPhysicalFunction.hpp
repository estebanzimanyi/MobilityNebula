...
class FloatsetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    FloatsetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~FloatsetMakeAggregationPhysicalFunction() override = default;
