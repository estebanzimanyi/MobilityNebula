...
class TnumberDeltaValueExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberDeltaValueExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberDeltaValueExpAggregationPhysicalFunction() override = default;
