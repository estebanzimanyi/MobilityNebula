...
class TfloatTminTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatTminTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatTminTransfnAggregationPhysicalFunction() override = default;
