...
class TemporalTNumberIntegralAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTNumberIntegralAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTNumberIntegralAggregationPhysicalFunction() override = default;
