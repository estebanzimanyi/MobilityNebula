...
class TimestamptzUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TimestamptzUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TimestamptzUnionTransfnAggregationPhysicalFunction() override = default;
