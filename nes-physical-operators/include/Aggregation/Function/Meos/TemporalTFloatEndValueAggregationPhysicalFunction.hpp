...
class TemporalTFloatEndValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTFloatEndValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTFloatEndValueAggregationPhysicalFunction() override = default;
