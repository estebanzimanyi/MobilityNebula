...
class IntExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    IntExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~IntExtentTransfnAggregationPhysicalFunction() override = default;
