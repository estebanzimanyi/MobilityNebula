...
class TemporalEndSequenceAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalEndSequenceAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalEndSequenceAggregationPhysicalFunction() override = default;
