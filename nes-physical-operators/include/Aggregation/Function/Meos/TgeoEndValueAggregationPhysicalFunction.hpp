...
class TgeoEndValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TgeoEndValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TgeoEndValueAggregationPhysicalFunction() override = default;
