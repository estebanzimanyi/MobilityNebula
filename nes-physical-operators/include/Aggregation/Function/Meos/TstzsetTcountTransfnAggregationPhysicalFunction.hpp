...
class TstzsetTcountTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TstzsetTcountTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TstzsetTcountTransfnAggregationPhysicalFunction() override = default;
