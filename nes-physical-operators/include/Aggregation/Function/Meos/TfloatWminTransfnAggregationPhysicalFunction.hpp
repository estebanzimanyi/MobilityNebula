...
class TfloatWminTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatWminTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatWminTransfnAggregationPhysicalFunction() override = default;
