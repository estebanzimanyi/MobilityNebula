...
class TemporalMinusMinExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalMinusMinExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalMinusMinExpAggregationPhysicalFunction() override = default;
