...
class TemporalSegmDurationAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalSegmDurationAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalSegmDurationAggregationPhysicalFunction() override = default;
