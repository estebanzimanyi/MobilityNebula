...
class TintMinValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintMinValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintMinValueAggregationPhysicalFunction() override = default;
