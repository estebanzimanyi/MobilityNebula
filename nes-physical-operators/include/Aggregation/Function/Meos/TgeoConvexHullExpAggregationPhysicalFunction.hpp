...
class TgeoConvexHullExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TgeoConvexHullExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TgeoConvexHullExpAggregationPhysicalFunction() override = default;
