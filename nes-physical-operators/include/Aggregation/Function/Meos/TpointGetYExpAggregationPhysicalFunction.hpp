...
class TpointGetYExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointGetYExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointGetYExpAggregationPhysicalFunction() override = default;
