...
class TextUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TextUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TextUnionTransfnAggregationPhysicalFunction() override = default;
