...
class TpointGetXAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointGetXAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointGetXAggregationPhysicalFunction() override = default;
