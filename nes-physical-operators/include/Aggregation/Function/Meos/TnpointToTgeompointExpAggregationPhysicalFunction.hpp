...
class TnpointToTgeompointExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnpointToTgeompointExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnpointToTgeompointExpAggregationPhysicalFunction() override = default;
