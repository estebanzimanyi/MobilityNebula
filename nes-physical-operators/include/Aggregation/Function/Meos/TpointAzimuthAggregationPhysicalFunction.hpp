...
class TpointAzimuthAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointAzimuthAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointAzimuthAggregationPhysicalFunction() override = default;
