...
class TpointAngularDifferenceExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointAngularDifferenceExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointAngularDifferenceExpAggregationPhysicalFunction() override = default;
