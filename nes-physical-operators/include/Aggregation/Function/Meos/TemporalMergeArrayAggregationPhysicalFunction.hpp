...
class TemporalMergeArrayAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalMergeArrayAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalMergeArrayAggregationPhysicalFunction() override = default;
