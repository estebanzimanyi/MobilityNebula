...
class DateExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    DateExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~DateExtentTransfnAggregationPhysicalFunction() override = default;
