...
class TemporalTIntEndValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTIntEndValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTIntEndValueAggregationPhysicalFunction() override = default;
