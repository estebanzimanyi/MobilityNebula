...
class SpansetExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    SpansetExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~SpansetExtentTransfnAggregationPhysicalFunction() override = default;
