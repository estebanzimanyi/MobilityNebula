...
class FloatUnionAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    FloatUnionAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~FloatUnionAggregationPhysicalFunction() override = default;
