...
class TintWmaxTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintWmaxTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintWmaxTransfnAggregationPhysicalFunction() override = default;
