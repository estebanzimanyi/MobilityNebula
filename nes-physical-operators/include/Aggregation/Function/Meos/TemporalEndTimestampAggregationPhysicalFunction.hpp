...
class TemporalEndTimestampAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalEndTimestampAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalEndTimestampAggregationPhysicalFunction() override = default;
