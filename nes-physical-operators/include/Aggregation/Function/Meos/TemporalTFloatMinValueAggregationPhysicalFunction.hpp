...
class TemporalTFloatMinValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalTFloatMinValueAggregationPhysicalFunction() override = default;
