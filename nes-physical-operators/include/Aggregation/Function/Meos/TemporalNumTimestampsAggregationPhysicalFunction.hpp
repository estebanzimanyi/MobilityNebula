...
class TemporalNumTimestampsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalNumTimestampsAggregationPhysicalFunction() override = default;
