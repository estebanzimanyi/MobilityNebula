...
class TintWminTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintWminTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintWminTransfnAggregationPhysicalFunction() override = default;
