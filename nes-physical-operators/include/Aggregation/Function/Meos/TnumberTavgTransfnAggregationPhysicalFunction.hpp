...
class TnumberTavgTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberTavgTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberTavgTransfnAggregationPhysicalFunction() override = default;
