...
class TboolTandTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TboolTandTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TboolTandTransfnAggregationPhysicalFunction() override = default;
