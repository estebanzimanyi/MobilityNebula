...
class TpointCumulativeLengthAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointCumulativeLengthAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointCumulativeLengthAggregationPhysicalFunction() override = default;
