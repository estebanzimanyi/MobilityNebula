...
class TspatialExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TspatialExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TspatialExtentTransfnAggregationPhysicalFunction() override = default;
