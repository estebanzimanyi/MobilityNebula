...
class TnumberExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberExtentTransfnAggregationPhysicalFunction() override = default;
