...
class TemporalMinusMinAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalMinusMinAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalMinusMinAggregationPhysicalFunction() override = default;
