...
class TnumberAvgValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberAvgValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberAvgValueAggregationPhysicalFunction() override = default;
