...
class TemporalStartTimestamptzAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalStartTimestamptzAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalStartTimestamptzAggregationPhysicalFunction() override = default;
