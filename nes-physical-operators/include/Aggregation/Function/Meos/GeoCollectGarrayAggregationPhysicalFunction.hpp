...
class GeoCollectGarrayAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    GeoCollectGarrayAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~GeoCollectGarrayAggregationPhysicalFunction() override = default;
