...
class TnumberExtentAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberExtentAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberExtentAggregationPhysicalFunction() override = default;
