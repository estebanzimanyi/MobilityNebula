...
class SpansetMakeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    SpansetMakeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~SpansetMakeAggregationPhysicalFunction() override = default;
