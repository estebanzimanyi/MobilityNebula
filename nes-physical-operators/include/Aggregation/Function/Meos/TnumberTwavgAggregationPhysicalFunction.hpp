...
class TnumberTwavgAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberTwavgAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberTwavgAggregationPhysicalFunction() override = default;
