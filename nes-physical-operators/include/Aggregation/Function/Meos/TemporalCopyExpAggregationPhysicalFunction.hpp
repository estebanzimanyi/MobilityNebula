...
class TemporalCopyExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalCopyExpAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalCopyExpAggregationPhysicalFunction() override = default;
