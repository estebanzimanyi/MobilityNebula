...
class TemporalTIntMinValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalTIntMinValueAggregationPhysicalFunction() override = default;
