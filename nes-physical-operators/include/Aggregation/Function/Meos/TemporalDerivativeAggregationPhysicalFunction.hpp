...
class TemporalDerivativeAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalDerivativeAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalDerivativeAggregationPhysicalFunction() override = default;
