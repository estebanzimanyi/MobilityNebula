...
class TfloatTmaxTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatTmaxTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatTmaxTransfnAggregationPhysicalFunction() override = default;
