...
class TtextTmaxTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TtextTmaxTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TtextTmaxTransfnAggregationPhysicalFunction() override = default;
