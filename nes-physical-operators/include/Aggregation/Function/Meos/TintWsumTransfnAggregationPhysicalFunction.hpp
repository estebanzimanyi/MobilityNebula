...
class TintWsumTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintWsumTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintWsumTransfnAggregationPhysicalFunction() override = default;
