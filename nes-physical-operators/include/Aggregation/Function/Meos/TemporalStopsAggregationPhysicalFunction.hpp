...
class TemporalStopsAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalStopsAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalStopsAggregationPhysicalFunction() override = default;
