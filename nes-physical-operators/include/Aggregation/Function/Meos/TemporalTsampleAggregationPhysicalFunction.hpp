...
class TemporalTsampleAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTsampleAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTsampleAggregationPhysicalFunction() override = default;
