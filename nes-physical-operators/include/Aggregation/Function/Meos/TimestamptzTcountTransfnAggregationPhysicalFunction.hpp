...
class TimestamptzTcountTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TimestamptzTcountTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TimestamptzTcountTransfnAggregationPhysicalFunction() override = default;
