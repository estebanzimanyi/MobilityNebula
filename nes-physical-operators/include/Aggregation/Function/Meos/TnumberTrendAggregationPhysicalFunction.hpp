...
class TnumberTrendAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnumberTrendAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnumberTrendAggregationPhysicalFunction() override = default;
