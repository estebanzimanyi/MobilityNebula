...
class TintTminTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TintTminTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TintTminTransfnAggregationPhysicalFunction() override = default;
