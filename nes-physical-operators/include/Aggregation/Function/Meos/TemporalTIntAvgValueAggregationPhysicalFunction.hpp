...
class TemporalTIntAvgValueAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalTIntAvgValueAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalTIntAvgValueAggregationPhysicalFunction() override = default;
