...
class TfloatWmaxTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatWmaxTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatWmaxTransfnAggregationPhysicalFunction() override = default;
