...
class TemporalDerivativeExpAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalDerivativeExpAggregationPhysicalFunction() override = default;
