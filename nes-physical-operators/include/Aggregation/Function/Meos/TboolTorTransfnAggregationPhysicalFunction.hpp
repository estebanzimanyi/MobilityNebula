...
class TboolTorTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TboolTorTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TboolTorTransfnAggregationPhysicalFunction() override = default;
