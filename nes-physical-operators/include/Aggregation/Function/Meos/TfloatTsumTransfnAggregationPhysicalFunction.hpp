...
class TfloatTsumTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TfloatTsumTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TfloatTsumTransfnAggregationPhysicalFunction() override = default;
