...
class TnpointToTgeompointAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TnpointToTgeompointAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TnpointToTgeompointAggregationPhysicalFunction() override = default;
