...
class SetExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    SetExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~SetExtentTransfnAggregationPhysicalFunction() override = default;
