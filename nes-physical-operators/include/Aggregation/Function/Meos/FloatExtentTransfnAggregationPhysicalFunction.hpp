...
class FloatExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    FloatExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~FloatExtentTransfnAggregationPhysicalFunction() override = default;
