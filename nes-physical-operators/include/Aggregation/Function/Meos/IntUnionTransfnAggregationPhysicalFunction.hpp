...
class IntUnionTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    IntUnionTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~IntUnionTransfnAggregationPhysicalFunction() override = default;
