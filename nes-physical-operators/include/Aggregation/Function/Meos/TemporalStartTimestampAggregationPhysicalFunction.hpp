...
class TemporalStartTimestampAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    ...
    ~TemporalStartTimestampAggregationPhysicalFunction() override = default;
