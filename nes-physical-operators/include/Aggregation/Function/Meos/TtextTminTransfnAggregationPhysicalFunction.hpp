...
class TtextTminTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TtextTminTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TtextTminTransfnAggregationPhysicalFunction() override = default;
