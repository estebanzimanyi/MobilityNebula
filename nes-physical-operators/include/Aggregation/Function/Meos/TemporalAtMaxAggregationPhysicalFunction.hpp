...
class TemporalAtMaxAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TemporalAtMaxAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TemporalAtMaxAggregationPhysicalFunction() override = default;
