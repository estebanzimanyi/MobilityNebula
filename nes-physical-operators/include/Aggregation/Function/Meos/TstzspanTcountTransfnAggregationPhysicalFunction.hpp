...
class TstzspanTcountTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TstzspanTcountTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TstzspanTcountTransfnAggregationPhysicalFunction() override = default;
