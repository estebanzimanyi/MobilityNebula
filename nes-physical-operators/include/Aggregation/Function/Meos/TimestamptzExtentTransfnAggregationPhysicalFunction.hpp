...
class TimestamptzExtentTransfnAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TimestamptzExtentTransfnAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TimestamptzExtentTransfnAggregationPhysicalFunction() override = default;
