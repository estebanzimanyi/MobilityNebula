...
class TpointIsSimpleAggregationPhysicalFunction : public AggregationPhysicalFunction
{
public:
    TpointIsSimpleAggregationPhysicalFunction(
        DataType inputType,
        DataType resultType,
    ...
    ~TpointIsSimpleAggregationPhysicalFunction() override = default;
