...
def _trgeo_phys_cpp_trgeometry_geo_nad(nebula_name, meos_call, ctor_args):
    ...
    return (
        ...
        + "    auto x = paramFns[1].execute(record, arena).cast<nautilus::val<double>>();\n"
        + "    auto y = paramFns[2].execute(record, arena).cast<nautilus::val<double>>();\n"
        + "    auto theta = paramFns[3].execute(record, arena).cast<nautilus::val<double>>();\n"
        + "    auto ts = paramFns[4].execute(record, arena).cast<nautilus::val<uint64_t>>();\n"
...
def _trgeo_phys_cpp_geo_trgeometry_eq(nebula_name, meos_call, ctor_args):
    ...
    return (
        ...
        + "    auto x = paramFns[2].execute(record, arena).cast<nautilus::val<double>>();\n"
        + "    auto y = paramFns[3].execute(record, arena).cast<nautilus::val<double>>();\n"
        + "    auto theta = paramFns[4].execute(record, arena).cast<nautilus::val<double>>();\n"
        + "    auto ts = paramFns[5].execute(record, arena).cast<nautilus::val<uint64_t>>();\n"
        + "    const auto result = nautilus::invoke(\n"
