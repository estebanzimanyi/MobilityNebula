...
|---|---|---|---|
| **NebulaStream** | **1,821 — 93.9%** | 6 — 0.3% | 112 — 5.8% |
...
- **NebulaStream: 1,821 / 1,939 confirmed callable (93.9%), 6 wired-only, 112 gap.** The
  ...
  under test; 1,821 are confirmed callable via systests that run end-to-end against
