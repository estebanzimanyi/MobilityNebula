...
|---|---|---|---|
| **NebulaStream** | **1,854 — 95.6%** | 5 — 0.3% | 80 — 4.1% |
...
- **NebulaStream: 1,854 / 1,939 confirmed callable (95.6%), 5 wired-only, 80 gap.** The
  ...
  under test; 1,854 are confirmed callable via systests that run end-to-end against
