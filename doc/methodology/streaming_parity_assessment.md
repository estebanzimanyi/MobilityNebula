...
|---|---|---|---|
| **NebulaStream** | **1,906 — 98.3%** | 2 — 0.1% | 30 — 1.5% |
...
- **NebulaStream: 1,906 / 1,938 confirmed callable (98.3%), 2 wired-only, 30 gap.** The
  ...
  under test; 1,906 are confirmed callable via systests that run end-to-end against
