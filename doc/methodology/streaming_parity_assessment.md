...
|---|---|---|---|
| **NebulaStream** | **1,889 — 97.4%** | 4 — 0.2% | 50 — 2.6% |
...
- **NebulaStream: 1,889 / 1,939 confirmed callable (97.4%), 4 wired-only, 50 gap.** The
  ...
  under test; 1,889 are confirmed callable via systests that run end-to-end against
