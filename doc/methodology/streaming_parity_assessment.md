...
|---|---|---|---|
| **NebulaStream** | **1,893 — 97.7%** | 4 — 0.2% | 45 — 2.3% |
...
- **NebulaStream: 1,893 / 1,938 confirmed callable (97.7%), 4 wired-only, 45 gap.** The
  ...
  under test; 1,893 are confirmed callable via systests that run end-to-end against
