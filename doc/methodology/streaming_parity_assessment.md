...
|---|---|---|---|
| **NebulaStream** | **1,847 — 95.3%** | 6 — 0.3% | 86 — 4.4% |
...
- **NebulaStream: 1,847 / 1,939 confirmed callable (95.3%), 6 wired-only, 86 gap.** The
  ...
  under test; 1,847 are confirmed callable via systests that run end-to-end against
