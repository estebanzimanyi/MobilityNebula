...
|---|---|---|---|
| **NebulaStream** | **1,899 — 98.0%** | 1 — 0.1% | 38 — 2.0% |
...
- **NebulaStream: 1,899 / 1,938 confirmed callable (98.0%), 1 wired-only, 38 gap.** The
  ...
  under test; 1,899 are confirmed callable via systests that run end-to-end against
