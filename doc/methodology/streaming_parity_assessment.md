...
|---|---|---|---|
| **NebulaStream** | **1,813 — 93.5%** | 5 — 0.3% | 121 — 6.2% |
...
- **NebulaStream: 1,813 / 1,939 confirmed callable (93.5%), 5 wired-only, 121 gap.** The
  ...
  under test; 1,813 are confirmed callable via systests that run end-to-end against
