...
|---|---|---|---|
| **NebulaStream** | **1,875 — 96.7%** | 5 — 0.3% | 64 — 3.3% |
...
- **NebulaStream: 1,875 / 1,939 confirmed callable (96.7%), 5 wired-only, 64 gap.** The
  ...
  under test; 1,875 are confirmed callable via systests that run end-to-end against
