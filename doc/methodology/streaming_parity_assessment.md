...
|---|---|---|---|
| **NebulaStream** | **1,910 — 98.6%** | 2 — 0.1% | 26 — 1.3% |
...
- **NebulaStream: 1,910 / 1,938 confirmed callable (98.6%), 2 wired-only, 26 gap.** The
  ...
  under test; 1,910 are confirmed callable via systests that run end-to-end against
