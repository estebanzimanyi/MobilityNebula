...
|---|---|---|---|
| **NebulaStream** | **1,832 — 94.5%** | 6 — 0.3% | 101 — 5.2% |
...
- **NebulaStream: 1,832 / 1,939 confirmed callable (94.5%), 6 wired-only, 101 gap.** The
  ...
  under test; 1,832 are confirmed callable via systests that run end-to-end against
