...
|---|---|---|---|
| **NebulaStream** | **1,891 — 97.5%** | 4 — 0.2% | 48 — 2.5% |
...
- **NebulaStream: 1,891 / 1,939 confirmed callable (97.5%), 4 wired-only, 48 gap.** The
  ...
  under test; 1,891 are confirmed callable via systests that run end-to-end against
