...
|---|---|---|---|
| **NebulaStream** | **1,827 — 94.2%** | 6 — 0.3% | 106 — 5.5% |
...
- **NebulaStream: 1,827 / 1,939 confirmed callable (94.2%), 6 wired-only, 106 gap.** The
  ...
  under test; 1,827 are confirmed callable via systests that run end-to-end against
