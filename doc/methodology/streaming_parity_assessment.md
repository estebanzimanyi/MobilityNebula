...
|---|---|---|---|
| **NebulaStream** | **1,834 — 94.6%** | 6 — 0.3% | 99 — 5.1% |
...
- **NebulaStream: 1,834 / 1,939 confirmed callable (94.6%), 6 wired-only, 99 gap.** The
  ...
  under test; 1,834 are confirmed callable via systests that run end-to-end against
