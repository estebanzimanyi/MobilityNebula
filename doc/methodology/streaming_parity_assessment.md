...
|---|---|---|---|
| **NebulaStream** | **1,803 — 93.0%** | 15 — 0.8% | 121 — 6.2% |
...
- **NebulaStream: 1,803 / 1,939 confirmed callable (93.0%), 15 wired-only, 121 gap.** The
  ...
  under test; 1,803 are confirmed callable via systests that run end-to-end against
