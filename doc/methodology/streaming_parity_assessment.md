...
|---|---|---|---|
| **NebulaStream** | **8 — 0.4%** | 77 — 4.0% | 1,860 — 95.6% |
...
- **NebulaStream: next.** 8 / 1,945 confirmed via runnable systests today. The
  path is to emit a systest per operator (not per shape) over the W1–W21 codegen
  surface and run them, lifting NebulaStream toward parity with the JVM tools.
