...
|---|---|---|---|
| **NebulaStream** | **1,900 — 98.0%** | 1 — 0.1% | 37 — 1.9% |
...
- **NebulaStream: 1,900 / 1,938 confirmed callable (98.0%), 1 wired-only, 37 gap.** The
  ...
  under test; 1,900 are confirmed callable via systests that run end-to-end against
