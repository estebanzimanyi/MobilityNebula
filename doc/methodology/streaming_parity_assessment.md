...
|---|---|---|---|
| **NebulaStream** | **1,884 — 97.2%** | 4 — 0.2% | 55 — 2.8% |
...
- **NebulaStream: 1,884 / 1,939 confirmed callable (97.2%), 4 wired-only, 55 gap.** The
  ...
  under test; 1,884 are confirmed callable via systests that run end-to-end against
