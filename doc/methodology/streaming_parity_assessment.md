...
|---|---|---|---|
| **NebulaStream** | **1,894 — 97.7%** | 3 — 0.2% | 41 — 2.1% |
...
- **NebulaStream: 1,894 / 1,938 confirmed callable (97.7%), 3 wired-only, 41 gap.** The
  ...
  under test; 1,894 are confirmed callable via systests that run end-to-end against
