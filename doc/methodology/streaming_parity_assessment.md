...
|---|---|---|---|
| **NebulaStream** | **1,878 — 96.9%** | 5 — 0.3% | 61 — 3.1% |
...
- **NebulaStream: 1,878 / 1,939 confirmed callable (96.9%), 5 wired-only, 61 gap.** The
  ...
  under test; 1,878 are confirmed callable via systests that run end-to-end against
