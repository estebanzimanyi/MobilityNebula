...
|---|---|---|---|
| **NebulaStream** | **1,798 — 92.7%** | 15 — 0.8% | 126 — 6.5% |
...
- **NebulaStream: 1,798 / 1,939 confirmed callable (92.7%), 15 wired-only, 126 gap.** The
  ...
  under test; 1,798 are confirmed callable via systests that run end-to-end against
