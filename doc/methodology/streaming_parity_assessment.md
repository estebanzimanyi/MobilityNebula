...
|---|---|---|---|
| **NebulaStream** | **1,836 — 94.7%** | 6 — 0.3% | 97 — 5.0% |
...
- **NebulaStream: 1,836 / 1,939 confirmed callable (94.7%), 6 wired-only, 97 gap.** The
  ...
  under test; 1,836 are confirmed callable via systests that run end-to-end against
