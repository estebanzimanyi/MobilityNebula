...
|---|---|---|---|
| **NebulaStream** | **1,897 — 97.9%** | 3 — 0.2% | 38 — 2.0% |
...
- **NebulaStream: 1,897 / 1,938 confirmed callable (97.9%), 3 wired-only, 38 gap.** The
  ...
  under test; 1,897 are confirmed callable via systests that run end-to-end against
