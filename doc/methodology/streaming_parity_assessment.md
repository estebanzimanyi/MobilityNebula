...
|---|---|---|---|
| **NebulaStream** | **1,869 — 96.4%** | 5 — 0.3% | 70 — 3.6% |
...
- **NebulaStream: 1,869 / 1,939 confirmed callable (96.4%), 5 wired-only, 70 gap.** The
  ...
  under test; 1,869 are confirmed callable via systests that run end-to-end against
