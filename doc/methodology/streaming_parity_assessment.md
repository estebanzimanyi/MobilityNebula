...
|---|---|---|---|
| **NebulaStream** | **1,838 — 94.8%** | 6 — 0.3% | 95 — 4.9% |
...
- **NebulaStream: 1,838 / 1,939 confirmed callable (94.8%), 6 wired-only, 95 gap.** The
  ...
  under test; 1,838 are confirmed callable via systests that run end-to-end against
