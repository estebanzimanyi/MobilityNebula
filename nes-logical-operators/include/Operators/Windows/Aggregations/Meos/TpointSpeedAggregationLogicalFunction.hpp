 ...
 */
class TpointSpeedAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointSpeedAggregationLogicalFunction(
    ...
    ~TpointSpeedAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointSpeed";
