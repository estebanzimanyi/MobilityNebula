 ...
 */
class TemporalCopyAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalCopyAggregationLogicalFunction(
    ...
    ~TemporalCopyAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalCopy";
