...
/**
 * @brief Windowed temporal_minus_max over the expandable tfloat mini-series, emitted as hex-WKB.
 *
 ...
 * sequence and calls MEOS `temporal_minus_max` to fold it to a single scalar.
 */
class TemporalMinusMaxAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TemporalMinusMax";
