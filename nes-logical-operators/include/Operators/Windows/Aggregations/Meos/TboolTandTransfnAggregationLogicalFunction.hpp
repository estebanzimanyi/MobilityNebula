...
/**
 * @brief Windowed TBOOL_TAND_TRANSFN -> aggregate tbool (hex-WKB) via tbool_tand_transfn/temporal_tagg_finalfn; bool fed as int 0/1.
 *
 ...
 * sequence and calls MEOS `tbool_tand_transfn` to fold it to a single scalar.
 */
class TboolTandTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TboolTandTransfn";
