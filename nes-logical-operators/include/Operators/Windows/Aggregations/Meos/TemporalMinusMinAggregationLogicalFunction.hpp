...
/**
 * @brief Windowed temporal_minus_min over the expandable tfloat mini-series, emitted as hex-WKB.
 *
 ...
 * sequence and calls MEOS `temporal_minus_min` to fold it to a single scalar.
 */
class TemporalMinusMinAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TemporalMinusMin";
