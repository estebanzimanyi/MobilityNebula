...
/**
 * @brief Value at the first instant of the per-(window, group) tfloat sequence.
 *
 ...
 * sequence and calls MEOS `tfloat_start_value` to fold it to a single scalar.
 */
class TfloatStartValueAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatStartValue";
