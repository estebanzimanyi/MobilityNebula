...
/**
 * @brief temporal_sequences (TSequence **) - the array of sequences of the windowed continuous trajectory, each as EWKB hex.
 *
 ...
 */
class TemporalSequencesAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalSequencesAggregationLogicalFunction(
    ...
    ~TemporalSequencesAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalSequences";
