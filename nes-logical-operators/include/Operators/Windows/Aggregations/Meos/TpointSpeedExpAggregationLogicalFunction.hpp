...
/**
 * @brief Windowed tgeompoint mini-trip; tpoint_speed differentiates it into a speed tfloat (hex-WKB).
 *
 ...
 * and calls MEOS `tpoint_speed` to fold it to a single scalar.
 */
class TpointSpeedExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointSpeedExpAggregationLogicalFunction(
    ...
    ~TpointSpeedExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointSpeedExp";
