...
/**
 * @brief Windowed NPOINT_UNION_TRANSFN -> unioned container (text) via npoint_union_transfn/set_union_finalfn.
 *
 ...
 * sequence and calls MEOS `npoint_union_transfn` to fold it to a single scalar.
 */
class NpointUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "NpointUnionTransfn";
