...
/**
 * @brief Time-weighted integral (area under the value-vs-time curve) of the per-(window, group) tfloat sequence.
 *
 ...
 * sequence and calls MEOS `tnumber_integral` to fold it to a single scalar.
 */
class TnumberIntegralAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TnumberIntegral";
