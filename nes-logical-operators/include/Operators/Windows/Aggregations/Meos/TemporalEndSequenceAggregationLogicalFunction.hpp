...
/**
 * @brief temporal_end_sequence (Temporal *) - the last sequence of the windowed continuous trajectory.
 *
 ...
 */
class TemporalEndSequenceAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalEndSequenceAggregationLogicalFunction(
    ...
    ~TemporalEndSequenceAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalEndSequence";
