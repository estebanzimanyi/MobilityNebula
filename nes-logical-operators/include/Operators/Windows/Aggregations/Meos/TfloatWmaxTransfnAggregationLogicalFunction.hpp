...
/**
 * @brief Windowed TFLOAT_WMAX_TRANSFN -> aggregate Temporal (hex-WKB) via tfloat_wmax_transfn/temporal_tagg_finalfn with a 1-hour radius.
 *
 ...
 * sequence and calls MEOS `tfloat_wmax_transfn` to fold it to a single scalar.
 */
class TfloatWmaxTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatWmaxTransfn";
