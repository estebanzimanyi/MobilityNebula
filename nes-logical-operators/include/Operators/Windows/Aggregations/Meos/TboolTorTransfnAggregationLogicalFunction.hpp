...
/**
 * @brief Windowed TBOOL_TOR_TRANSFN -> aggregate tbool (hex-WKB) via tbool_tor_transfn/temporal_tagg_finalfn; bool fed as int 0/1.
 *
 ...
 * sequence and calls MEOS `tbool_tor_transfn` to fold it to a single scalar.
 */
class TboolTorTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TboolTorTransfn";
