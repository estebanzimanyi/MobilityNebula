...
/**
 * @brief Windowed value extent (BIGINTSPAN) over a tbigint stream via bigint_extent_transfn.
 *
 ...
 */
class BigintExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    BigintExtentTransfnAggregationLogicalFunction(
        const FieldAccessLogicalFunction& valueField,
        const FieldAccessLogicalFunction& timestampField,
        const FieldAccessLogicalFunction& asField);

    void inferStamp(const Schema& schema) override;
    ~BigintExtentTransfnAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "BigintExtentTransfn";
