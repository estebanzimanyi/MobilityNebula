 ...
 */
class TemporalTFloatStartValueAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TemporalTFloatStartValueAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalTFloatStartValue";
