...
/**
 * @brief geoset_make (Set *) - the geometry set collected from a window of geometry values.
 *
 ...
 */
class GeosetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "GeosetMake";
