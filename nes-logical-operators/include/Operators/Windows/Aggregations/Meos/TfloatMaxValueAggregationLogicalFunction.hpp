...
/**
 * @brief Maximum value across instants of the per-(window, group) tfloat sequence.
 *
 ...
 * sequence and calls MEOS `tfloat_max_value` to fold it to a single scalar.
 */
class TfloatMaxValueAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatMaxValue";
