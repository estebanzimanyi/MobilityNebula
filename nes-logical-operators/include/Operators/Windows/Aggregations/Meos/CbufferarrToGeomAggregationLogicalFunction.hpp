...
/**
 * @brief cbufferarr_to_geom (GSERIALIZED *) - the geometry built from a window of cbuffer values.
 *
 ...
 */
class CbufferarrToGeomAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "CbufferarrToGeom";
