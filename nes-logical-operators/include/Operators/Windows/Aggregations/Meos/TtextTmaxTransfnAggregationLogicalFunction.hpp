...
/**
 * @brief Windowed TTEXT_TMAX_TRANSFN -> aggregate ttext (hex-WKB) via ttext_tmax_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `ttext_tmax_transfn` to fold it to a single scalar.
 */
class TtextTmaxTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TtextTmaxTransfn";
