...
/**
 * @brief Windowed tnumber mini-series; tnumber_trend emits the rising/falling trend as a tint (hex-WKB).
 *
 ...
 * sequence and calls MEOS `tnumber_trend` to fold it to a single scalar.
 */
class TnumberTrendExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TnumberTrendExp";
