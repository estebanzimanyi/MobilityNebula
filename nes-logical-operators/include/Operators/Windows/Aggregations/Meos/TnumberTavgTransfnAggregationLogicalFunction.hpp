...
/**
 * @brief Windowed TNUMBER_TAVG_TRANSFN -> aggregate tfloat avg (hex-WKB) via tnumber_tavg_transfn/tnumber_tavg_finalfn.
 *
 ...
 * sequence and calls MEOS `tnumber_tavg_transfn` to fold it to a single scalar.
 */
class TnumberTavgTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TnumberTavgTransfn";
