 ...
 */
class TpointTwcentroidExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TpointTwcentroidExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointTwcentroidExp";
