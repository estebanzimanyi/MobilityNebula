...
/**
 * @brief Windowed tgeompoint mini-trip; tgeo_start_value emits the first point geometry as hex-EWKB.
 *
 ...
 * and calls MEOS `tgeo_start_value` to fold it to a single scalar.
 */
class TgeoStartValueAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TgeoStartValueAggregationLogicalFunction(
    ...
    ~TgeoStartValueAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeoStartValue";
