...
/**
 * @brief Windowed temporal_at_max over the expandable tfloat mini-series, emitted as hex-WKB.
 *
 ...
 * sequence and calls MEOS `temporal_at_max` to fold it to a single scalar.
 */
class TemporalAtMaxExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TEMPORAL_AT_MAX_EXP";
