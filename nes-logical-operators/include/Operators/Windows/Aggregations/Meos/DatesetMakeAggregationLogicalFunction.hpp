...
/**
 * @brief dateset_make (Set *) - the date set collected from a window of date values.
 *
 ...
 */
class DatesetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "DatesetMake";
