...
/**
 * @brief tpoint_make_simple (Temporal **) - the array of simple (non-self-intersecting) fragments of the windowed point trajectory, each as EWKB hex.
 *
 ...
 */
class TpointMakeSimpleAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointMakeSimpleAggregationLogicalFunction(
    ...
    ~TpointMakeSimpleAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointMakeSimple";
