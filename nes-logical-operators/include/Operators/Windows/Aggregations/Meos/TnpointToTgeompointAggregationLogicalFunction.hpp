 ...
 */
class TnpointToTgeompointAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TnpointToTgeompointAggregationLogicalFunction(
    ...
    ~TnpointToTgeompointAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TnpointToTgeompoint";
