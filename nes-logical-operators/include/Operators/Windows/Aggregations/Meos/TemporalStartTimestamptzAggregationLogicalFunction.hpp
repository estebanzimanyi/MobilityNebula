 ...
 */
class TemporalStartTimestamptzAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalStartTimestamptzAggregationLogicalFunction(
    ...
    ~TemporalStartTimestamptzAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalStartTimestamptz";
