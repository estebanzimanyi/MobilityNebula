...
/**
 * @brief Windowed DATE_UNION_TRANSFN — DateADT values unioned into a DATESET via date_union_transfn.
 *
 ...
 * sequence and calls MEOS `date_union_transfn` to fold it to a single scalar.
 */
class DateUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "DateUnionTransfn";
