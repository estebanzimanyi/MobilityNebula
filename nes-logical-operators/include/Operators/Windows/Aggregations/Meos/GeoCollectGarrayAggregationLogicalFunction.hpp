...
/**
 * @brief geo_collect_garray (GSERIALIZED *) - the geometry collection built from a window of geometry values.
 *
 ...
 */
class GeoCollectGarrayAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "GeoCollectGarray";
