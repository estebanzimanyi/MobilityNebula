...
/**
 * @brief Windowed TEXT_UNION_TRANSFN -> unioned container (text) via text_union_transfn/set_union_finalfn.
 *
 ...
 * sequence and calls MEOS `text_union_transfn` to fold it to a single scalar.
 */
class TextUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TextUnionTransfn";
