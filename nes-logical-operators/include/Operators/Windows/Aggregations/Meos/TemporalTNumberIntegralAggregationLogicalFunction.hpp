 ...
 */
class TemporalTNumberIntegralAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TemporalTNumberIntegralAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalTNumberIntegral";
