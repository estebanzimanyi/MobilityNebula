 ...
 */
class TgeoStartValueExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TgeoStartValueExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeoStartValueExp";
