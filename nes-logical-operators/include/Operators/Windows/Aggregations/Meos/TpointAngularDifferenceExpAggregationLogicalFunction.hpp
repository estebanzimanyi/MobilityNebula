...
/**
 * @brief Windowed angular difference via tpoint_angular_difference over the expandable mini-trip, emitted as hex-WKB.
 *
 ...
 * and calls MEOS `tpoint_angular_difference` to fold it to a single scalar.
 */
class TpointAngularDifferenceExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointAngularDifferenceExpAggregationLogicalFunction(
    ...
    ~TpointAngularDifferenceExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TPOINT_ANGULAR_DIFFERENCE_EXP";
