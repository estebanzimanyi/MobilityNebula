...
/**
 * @brief tpoint_direction (double via out-param) - the azimuth/direction of the windowed temporal point.
 *
 ...
 * and calls MEOS `tpoint_direction` to fold it to a single scalar.
 */
class TpointDirectionAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointDirectionAggregationLogicalFunction(
    ...
    ~TpointDirectionAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointDirection";
