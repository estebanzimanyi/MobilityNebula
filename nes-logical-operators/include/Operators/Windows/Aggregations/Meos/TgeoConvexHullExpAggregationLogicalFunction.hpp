...
/**
 * @brief Windowed tgeompoint mini-trip; tgeo_convex_hull emits the trajectory convex hull as hex-EWKB.
 *
 ...
 * and calls MEOS `tgeo_convex_hull` to fold it to a single scalar.
 */
class TgeoConvexHullExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TgeoConvexHullExpAggregationLogicalFunction(
    ...
    ~TgeoConvexHullExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeoConvexHullExp";
