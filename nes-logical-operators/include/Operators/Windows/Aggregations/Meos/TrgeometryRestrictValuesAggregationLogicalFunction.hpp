...
/**
 * @brief Windowed tpose -> trgeometry, restricted to/minus a geometry value set (trgeometry_restrict_values) as hex-WKB.
 *
 ...
 */
class TrgeometryRestrictValuesAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TrgeometryRestrictValuesAggregationLogicalFunction(
    ...
    ~TrgeometryRestrictValuesAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TrgeometryRestrictValues";
