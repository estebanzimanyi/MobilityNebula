...
/**
 * @brief Windowed TINT_TSUM_TRANSFN -> aggregate tint (hex-WKB) via tint_tsum_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `tint_tsum_transfn` to fold it to a single scalar.
 */
class TintTsumTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TintTsumTransfn";
