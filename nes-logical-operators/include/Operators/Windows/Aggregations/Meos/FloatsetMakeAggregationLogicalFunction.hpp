...
/**
 * @brief floatset_make (Set *) - the float set collected from a window of float values.
 *
 ...
 */
class FloatsetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "FloatsetMake";
