...
/**
 * @brief geom_array_union (GSERIALIZED *) - the union built from a window of geometry values.
 *
 ...
 */
class GeomArrayUnionAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "GeomArrayUnion";
