...
/**
 * @brief Windowed value extent (FLOATSPAN) over a tfloat stream via float_extent_transfn.
 *
 ...
 */
class FloatExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "FloatExtentTransfn";
