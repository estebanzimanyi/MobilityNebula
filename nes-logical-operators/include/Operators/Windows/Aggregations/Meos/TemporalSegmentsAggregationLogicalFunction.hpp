...
/**
 * @brief temporal_segments (TSequence **) - the array of maximal segments of the windowed continuous trajectory, each as EWKB hex.
 *
 ...
 */
class TemporalSegmentsAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalSegmentsAggregationLogicalFunction(
    ...
    ~TemporalSegmentsAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalSegments";
