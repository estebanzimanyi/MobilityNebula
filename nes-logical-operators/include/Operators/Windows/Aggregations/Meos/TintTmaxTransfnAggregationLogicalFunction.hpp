...
/**
 * @brief Windowed TINT_TMAX_TRANSFN -> aggregate tint (hex-WKB) via tint_tmax_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `tint_tmax_transfn` to fold it to a single scalar.
 */
class TintTmaxTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TintTmaxTransfn";
