 ...
 */
class TpointAzimuthAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointAzimuthAggregationLogicalFunction(
    ...
    ~TpointAzimuthAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointAzimuth";
