...
/**
 * @brief Windowed TFLOAT_TMIN_TRANSFN -> aggregate tfloat (hex-WKB) via tfloat_tmin_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `tfloat_tmin_transfn` to fold it to a single scalar.
 */
class TfloatTminTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatTminTransfn";
