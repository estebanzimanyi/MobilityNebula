 ...
 */
class TspatialExtentAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TspatialExtentAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TSPATIAL_EXTENT";
