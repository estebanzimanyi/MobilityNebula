...
/**
 * @brief Windowed TINT_TMIN_TRANSFN -> aggregate tint (hex-WKB) via tint_tmin_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `tint_tmin_transfn` to fold it to a single scalar.
 */
class TintTminTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TintTminTransfn";
