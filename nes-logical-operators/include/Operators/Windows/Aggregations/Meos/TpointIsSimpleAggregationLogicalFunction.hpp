 ...
 */
class TpointIsSimpleAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointIsSimpleAggregationLogicalFunction(
    ...
    ~TpointIsSimpleAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointIsSimple";
