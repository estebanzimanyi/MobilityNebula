...
/**
 * @brief Windowed TFLOAT_WSUM_TRANSFN -> aggregate Temporal (hex-WKB) via tfloat_wsum_transfn/temporal_tagg_finalfn with a 1-hour radius.
 *
 ...
 * sequence and calls MEOS `tfloat_wsum_transfn` to fold it to a single scalar.
 */
class TfloatWsumTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatWsumTransfn";
