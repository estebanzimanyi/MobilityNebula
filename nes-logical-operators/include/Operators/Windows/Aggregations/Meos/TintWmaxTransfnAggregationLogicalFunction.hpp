...
/**
 * @brief Windowed TINT_WMAX_TRANSFN -> aggregate Temporal (hex-WKB) via tint_wmax_transfn/temporal_tagg_finalfn with a 1-hour radius.
 *
 ...
 * sequence and calls MEOS `tint_wmax_transfn` to fold it to a single scalar.
 */
class TintWmaxTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TintWmaxTransfn";
