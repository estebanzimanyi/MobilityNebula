...
/**
 * @brief Windowed tgeompoint mini-trip; tgeo_end_value emits the last point geometry as hex-EWKB.
 *
 ...
 * and calls MEOS `tgeo_end_value` to fold it to a single scalar.
 */
class TgeoEndValueExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TgeoEndValueExpAggregationLogicalFunction(
    ...
    ~TgeoEndValueExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeoEndValueExp";
