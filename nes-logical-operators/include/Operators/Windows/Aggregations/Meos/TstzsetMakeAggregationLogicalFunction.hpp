...
/**
 * @brief tstzset_make (Set *) - the timestamptz set collected from a window of timestamp values.
 *
 ...
 */
class TstzsetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TstzsetMake";
