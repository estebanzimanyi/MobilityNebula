...
/**
 * @brief Windowed spatiotemporal extent (STBox) over a tgeo trajectory via tspatial_extent_transfn.
 *
 ...
 */
class TspatialExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TspatialExtentTransfnAggregationLogicalFunction(
    ...
    ~TspatialExtentTransfnAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TspatialExtentTransfn";
