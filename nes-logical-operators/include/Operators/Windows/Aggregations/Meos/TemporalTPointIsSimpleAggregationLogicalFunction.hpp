...
/**
 * @brief True if the per-(window, group) tgeo trajectory does not self-intersect.
 *
 ...
 * and calls MEOS `tpoint_is_simple` to fold it to a single scalar.
 */
class TemporalTPointIsSimpleAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalTPointIsSimpleAggregationLogicalFunction(
    ...
    ~TemporalTPointIsSimpleAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalTPointIsSimple";
    static constexpr DataType::Type partialAggregateStampType = DataType::Type::UNDEFINED;
    static constexpr DataType::Type finalAggregateStampType = DataType::Type::BOOLEAN;
