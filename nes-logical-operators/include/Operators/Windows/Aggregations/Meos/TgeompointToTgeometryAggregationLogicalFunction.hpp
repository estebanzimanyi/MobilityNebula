...
/**
 * @brief Windowed tgeompoint->tgeometry conversion over the expandable mini-trip, emitted as hex-WKB.
 *
 ...
 * and calls MEOS `tgeompoint_to_tgeometry` to fold it to a single scalar.
 */
class TgeompointToTgeometryAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TgeompointToTgeometryAggregationLogicalFunction(
    ...
    ~TgeompointToTgeometryAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeompointToTgeometry";
