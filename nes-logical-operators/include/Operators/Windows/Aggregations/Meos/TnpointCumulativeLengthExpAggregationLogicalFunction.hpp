 ...
 */
class TnpointCumulativeLengthExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TnpointCumulativeLengthExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TnpointCumulativeLengthExp";
