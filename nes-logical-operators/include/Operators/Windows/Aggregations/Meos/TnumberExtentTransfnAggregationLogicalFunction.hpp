...
/**
 * @brief Windowed numeric-temporal extent (TBox) over a tnumber sequence via tnumber_extent_transfn.
 *
 ...
 */
class TnumberExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TnumberExtentTransfnAggregationLogicalFunction(
        const FieldAccessLogicalFunction& valueField,
        const FieldAccessLogicalFunction& timestampField,
        const FieldAccessLogicalFunction& asField);

    void inferStamp(const Schema& schema) override;
    ~TnumberExtentTransfnAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TnumberExtentTransfn";
