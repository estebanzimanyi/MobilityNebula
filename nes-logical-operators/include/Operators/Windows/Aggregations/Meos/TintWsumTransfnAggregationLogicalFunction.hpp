...
/**
 * @brief Windowed TINT_WSUM_TRANSFN -> aggregate Temporal (hex-WKB) via tint_wsum_transfn/temporal_tagg_finalfn with a 1-hour radius.
 *
 ...
 * sequence and calls MEOS `tint_wsum_transfn` to fold it to a single scalar.
 */
class TintWsumTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TintWsumTransfn";
