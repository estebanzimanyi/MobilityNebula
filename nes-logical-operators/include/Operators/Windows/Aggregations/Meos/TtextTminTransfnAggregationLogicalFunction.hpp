...
/**
 * @brief Windowed TTEXT_TMIN_TRANSFN -> aggregate ttext (hex-WKB) via ttext_tmin_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `ttext_tmin_transfn` to fold it to a single scalar.
 */
class TtextTminTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TtextTminTransfn";
