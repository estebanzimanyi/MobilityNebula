...
/**
 * @brief Windowed TFLOAT_WMIN_TRANSFN -> aggregate Temporal (hex-WKB) via tfloat_wmin_transfn/temporal_tagg_finalfn with a 1-hour radius.
 *
 ...
 * sequence and calls MEOS `tfloat_wmin_transfn` to fold it to a single scalar.
 */
class TfloatWminTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatWminTransfn";
