...
/**
 * @brief cbufferset_make (Set *) - the circular-buffer set collected from a window of cbuffer values.
 *
 ...
 */
class CbuffersetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "CbuffersetMake";
