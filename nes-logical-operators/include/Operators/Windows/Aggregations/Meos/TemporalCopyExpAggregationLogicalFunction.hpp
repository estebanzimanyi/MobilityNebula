...
/**
 * @brief Windowed temporal_copy over the expandable mini-trip, emitted as hex-WKB.
 *
 ...
 * and calls MEOS `temporal_copy` to fold it to a single scalar.
 */
class TemporalCopyExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalCopyExpAggregationLogicalFunction(
    ...
    ~TemporalCopyExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TEMPORAL_COPY_EXP";
