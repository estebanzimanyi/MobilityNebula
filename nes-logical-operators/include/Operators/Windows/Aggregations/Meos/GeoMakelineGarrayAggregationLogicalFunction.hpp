...
/**
 * @brief geo_makeline_garray (GSERIALIZED *) - the line built from a window of point values.
 *
 ...
 */
class GeoMakelineGarrayAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "GeoMakelineGarray";
