...
/**
 * @brief Windowed value extent (INTSPAN) over a tint stream via int_extent_transfn.
 *
 ...
 */
class IntExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "IntExtentTransfn";
