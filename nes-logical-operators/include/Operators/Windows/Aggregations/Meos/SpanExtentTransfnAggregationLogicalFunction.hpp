...
/**
 * @brief Windowed SPAN_EXTENT_TRANSFN -> bounding Span (text) via span_extent_transfn.
 *
 ...
 * sequence and calls MEOS `span_extent_transfn` to fold it to a single scalar.
 */
class SpanExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "SpanExtentTransfn";
