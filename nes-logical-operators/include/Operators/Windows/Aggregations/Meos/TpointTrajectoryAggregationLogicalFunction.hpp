...
/**
 * @brief Windowed mini-trip trajectory materialized as hex-WKB — the value the MEOS function library composes over.
 *
 ...
 */
class TpointTrajectoryAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointTrajectoryAggregationLogicalFunction(
    ...
    ~TpointTrajectoryAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointTrajectory";
