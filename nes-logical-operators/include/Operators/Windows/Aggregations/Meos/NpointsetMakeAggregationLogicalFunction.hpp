...
/**
 * @brief npointset_make (Set *) - the network-point set collected from a window of npoint values.
 *
 ...
 */
class NpointsetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "NpointsetMake";
