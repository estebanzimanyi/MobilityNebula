 ...
 */
class TrajectoryWkbAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TrajectoryWkbAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TRAJECTORY_WKB";
