...
/**
 * @brief Windowed TFLOAT_TSUM_TRANSFN -> aggregate tfloat (hex-WKB) via tfloat_tsum_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `tfloat_tsum_transfn` to fold it to a single scalar.
 */
class TfloatTsumTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatTsumTransfn";
