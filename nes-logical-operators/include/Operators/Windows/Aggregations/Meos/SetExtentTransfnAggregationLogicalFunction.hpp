...
/**
 * @brief Windowed SET_EXTENT_TRANSFN -> bounding Span (text) via set_extent_transfn.
 *
 ...
 * sequence and calls MEOS `set_extent_transfn` to fold it to a single scalar.
 */
class SetExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "SetExtentTransfn";
