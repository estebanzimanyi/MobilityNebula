...
/**
 * @brief Per-(window, group) count of instants in the assembled tgeo trajectory.
 *
 ...
 * and calls MEOS `temporal_num_instants` to fold it to a single scalar.
 */
class TemporalNumInstantsAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalNumInstantsAggregationLogicalFunction(
    ...
    ~TemporalNumInstantsAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalNumInstants";
