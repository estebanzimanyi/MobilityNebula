...
/**
 * @brief Windowed DATE_EXTENT_TRANSFN — DateADT value extent (DATESPAN) via date_extent_transfn.
 *
 ...
 * sequence and calls MEOS `date_extent_transfn` to fold it to a single scalar.
 */
class DateExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "DateExtentTransfn";
