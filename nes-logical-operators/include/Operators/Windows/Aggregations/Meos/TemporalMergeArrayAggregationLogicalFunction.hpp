...
/**
 * @brief temporal_merge_array (Temporal *) - the temporal merged from a window of temporal values (hex-WKB).
 *
 ...
 */
class TemporalMergeArrayAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TemporalMergeArray";
