...
/**
 * @brief Windowed centroid trajectory via tgeo_centroid over the expandable mini-trip, emitted as hex-WKB.
 *
 ...
 * and calls MEOS `tgeo_centroid` to fold it to a single scalar.
 */
class TgeoCentroidAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TgeoCentroidAggregationLogicalFunction(
    ...
    ~TgeoCentroidAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeoCentroid";
