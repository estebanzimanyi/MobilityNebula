...
/**
 * @brief temporal_sequence_n (Temporal *) - the first sequence (n=1) of the windowed continuous trajectory.
 *
 ...
 */
class TemporalSequenceNAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalSequenceNAggregationLogicalFunction(
    ...
    ~TemporalSequenceNAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalSequenceN";
