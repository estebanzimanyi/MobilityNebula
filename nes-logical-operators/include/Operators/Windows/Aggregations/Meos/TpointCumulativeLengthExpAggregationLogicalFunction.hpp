 ...
 */
class TpointCumulativeLengthExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TpointCumulativeLengthExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointCumulativeLengthExp";
