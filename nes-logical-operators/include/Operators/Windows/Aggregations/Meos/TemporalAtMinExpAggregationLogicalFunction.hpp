...
/**
 * @brief Windowed temporal_at_min over the expandable tfloat mini-series, emitted as hex-WKB.
 *
 ...
 * sequence and calls MEOS `temporal_at_min` to fold it to a single scalar.
 */
class TemporalAtMinExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TEMPORAL_AT_MIN_EXP";
