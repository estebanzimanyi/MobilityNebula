...
/**
 * @brief Windowed TINT_WMIN_TRANSFN -> aggregate Temporal (hex-WKB) via tint_wmin_transfn/temporal_tagg_finalfn with a 1-hour radius.
 *
 ...
 * sequence and calls MEOS `tint_wmin_transfn` to fold it to a single scalar.
 */
class TintWminTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TintWminTransfn";
