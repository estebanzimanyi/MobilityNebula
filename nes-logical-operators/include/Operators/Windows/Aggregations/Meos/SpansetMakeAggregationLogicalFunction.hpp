...
/**
 * @brief spanset_make (SpanSet *) - the span set built from a window of span values.
 *
 ...
 */
class SpansetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "SpansetMake";
