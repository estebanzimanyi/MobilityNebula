...
/**
 * @brief Windowed TNUMBER_WAVG_TRANSFN -> aggregate Temporal (hex-WKB) via tnumber_wavg_transfn/tnumber_tavg_finalfn with a 1-hour radius.
 *
 ...
 * sequence and calls MEOS `tnumber_wavg_transfn` to fold it to a single scalar.
 */
class TnumberWavgTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TnumberWavgTransfn";
