...
/**
 * @brief True if the per-(window, group) tgeo trajectory's upper period bound is inclusive.
 *
 ...
 * and calls MEOS `temporal_upper_inc` to fold it to a single scalar.
 */
class TemporalUpperIncAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TemporalUpperIncAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalUpperInc";
