 ...
 */
class FloatExtentAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~FloatExtentAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "FLOAT_EXTENT";
