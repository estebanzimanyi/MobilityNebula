...
/**
 * @brief Windowed TPOINT_TCENTROID_TRANSFN -> aggregate tgeompoint centroid (hex-WKB) via tpoint_tcentroid_transfn/finalfn.
 *
 ...
 * and calls MEOS `tpoint_tcentroid_transfn` to fold it to a single scalar.
 */
class TpointTcentroidTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointTcentroidTransfnAggregationLogicalFunction(
    ...
    ~TpointTcentroidTransfnAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointTcentroidTransfn";
