...
/**
 * @brief Windowed tnpoint_cumulative_length over the expandable tnpoint mini-series, emitted as hex-WKB.
 *
 ...
 * and calls MEOS `tnpoint_cumulative_length` to fold it to a single scalar.
 */
class TnpointCumulativeLengthAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TnpointCumulativeLengthAggregationLogicalFunction(
    ...
    ~TnpointCumulativeLengthAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TnpointCumulativeLength";
