 ...
 */
class TgeompointToTgeometryExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~TgeompointToTgeometryExpAggregationLogicalFunction() override = default;
