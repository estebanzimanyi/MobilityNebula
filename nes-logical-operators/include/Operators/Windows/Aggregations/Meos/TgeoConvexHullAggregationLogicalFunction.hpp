 ...
 */
class TgeoConvexHullAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TgeoConvexHullAggregationLogicalFunction(
    ...
    ~TgeoConvexHullAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeoConvexHull";
