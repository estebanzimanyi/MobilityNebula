...
/**
 * @brief Windowed time union (TSTZSET) over an event-time field via timestamptz_union_transfn + set_union_finalfn.
 *
 ...
 */
class TimestamptzUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TimestamptzUnionTransfnAggregationLogicalFunction(
        const FieldAccessLogicalFunction& valueField,
        const FieldAccessLogicalFunction& timestampField,
        const FieldAccessLogicalFunction& asField);

    void inferStamp(const Schema& schema) override;
    ~TimestamptzUnionTransfnAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TimestamptzUnionTransfn";
