...
/**
 * @brief trgeometry_end_sequence (TSequence *) - the last sequence of the windowed continuous trgeometry, as EWKB hex.
 *
 ...
 * MEOS sequence accessor `trgeometry_end_sequence(static_cast<Temporal*>(temp))` to fold it.
 */
class TrgeometryEndSequenceAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TrgeometryEndSequenceAggregationLogicalFunction(
    ...
    ~TrgeometryEndSequenceAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TrgeometryEndSequence";
