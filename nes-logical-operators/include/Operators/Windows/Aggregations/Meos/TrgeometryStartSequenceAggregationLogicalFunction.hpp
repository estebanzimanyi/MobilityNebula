...
/**
 * @brief trgeometry_start_sequence (TSequence *) - the first sequence of the windowed continuous trgeometry, as EWKB hex.
 *
 ...
 * MEOS sequence accessor `trgeometry_start_sequence(static_cast<Temporal*>(temp))` to fold it.
 */
class TrgeometryStartSequenceAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TrgeometryStartSequenceAggregationLogicalFunction(
    ...
    ~TrgeometryStartSequenceAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TrgeometryStartSequence";
