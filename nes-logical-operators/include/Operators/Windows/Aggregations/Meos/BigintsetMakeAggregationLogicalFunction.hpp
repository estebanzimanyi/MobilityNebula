...
/**
 * @brief bigintset_make (Set *) - the bigint set collected from a window of bigint values.
 *
 ...
 */
class BigintsetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "BigintsetMake";
