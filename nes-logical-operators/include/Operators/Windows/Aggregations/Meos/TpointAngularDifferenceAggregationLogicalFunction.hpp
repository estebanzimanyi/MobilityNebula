 ...
 */
class TpointAngularDifferenceAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointAngularDifferenceAggregationLogicalFunction(
    ...
    ~TpointAngularDifferenceAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointAngularDifference";
