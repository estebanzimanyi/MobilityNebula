...
/**
 * @brief Windowed tnpoint_speed over the expandable tnpoint mini-series, emitted as hex-WKB.
 *
 ...
 * and calls MEOS `tnpoint_speed` to fold it to a single scalar.
 */
class TnpointSpeedAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TnpointSpeedAggregationLogicalFunction(
    ...
    ~TnpointSpeedAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TnpointSpeed";
