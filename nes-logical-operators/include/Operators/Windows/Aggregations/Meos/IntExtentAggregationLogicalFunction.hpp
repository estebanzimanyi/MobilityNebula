 ...
 */
class IntExtentAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~IntExtentAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "INT_EXTENT";
