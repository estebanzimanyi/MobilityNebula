...
/**
 * @brief temporal_simplify_min_dist (Temporal* -> hex-WKB) - the windowed trajectory simplified to a minimum-distance tolerance (double constant arg).
 *
 ...
 * and calls MEOS `temporal_simplify_min_dist` to fold it to a single scalar.
 */
class TemporalSimplifyMinDistAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalSimplifyMinDistAggregationLogicalFunction(
    ...
    ~TemporalSimplifyMinDistAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalSimplifyMinDist";
