...
/**
 * @brief Windowed TFLOAT_TMAX_TRANSFN -> aggregate tfloat (hex-WKB) via tfloat_tmax_transfn/temporal_tagg_finalfn.
 *
 ...
 * sequence and calls MEOS `tfloat_tmax_transfn` to fold it to a single scalar.
 */
class TfloatTmaxTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TfloatTmaxTransfn";
