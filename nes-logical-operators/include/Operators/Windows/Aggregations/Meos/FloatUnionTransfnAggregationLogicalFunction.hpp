...
/**
 * @brief Windowed value union (FLOATSET) over a tfloat stream via float_union_transfn + set_union_finalfn.
 *
 ...
 */
class FloatUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "FloatUnionTransfn";
