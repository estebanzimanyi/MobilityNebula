...
/**
 * @brief Windowed tnumber_abs over the expandable tfloat mini-series, emitted as hex-WKB.
 *
 ...
 * sequence and calls MEOS `tnumber_abs` to fold it to a single scalar.
 */
class TnumberAbsAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TnumberAbs";
