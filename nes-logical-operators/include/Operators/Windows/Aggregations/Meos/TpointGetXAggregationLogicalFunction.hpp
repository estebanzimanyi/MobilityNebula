 ...
 */
class TpointGetXAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointGetXAggregationLogicalFunction(
    ...
    ~TpointGetXAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointGetX";
