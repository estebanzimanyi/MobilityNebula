...
/**
 * @brief Windowed tgeompoint mini-trip; tpoint_twcentroid emits the time-weighted centroid point as hex-EWKB.
 *
 ...
 * and calls MEOS `tpoint_twcentroid` to fold it to a single scalar.
 */
class TpointTwcentroidAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointTwcentroidAggregationLogicalFunction(
    ...
    ~TpointTwcentroidAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointTwcentroid";
