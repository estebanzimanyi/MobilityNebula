 ...
 */
class TgeoEndValueAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TgeoEndValueAggregationLogicalFunction(
    ...
    ~TgeoEndValueAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TgeoEndValue";
