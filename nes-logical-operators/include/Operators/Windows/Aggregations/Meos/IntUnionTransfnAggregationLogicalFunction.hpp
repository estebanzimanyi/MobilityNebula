...
/**
 * @brief Windowed value union (INTSET) over a tint stream via int_union_transfn + set_union_finalfn.
 *
 ...
 */
class IntUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "IntUnionTransfn";
