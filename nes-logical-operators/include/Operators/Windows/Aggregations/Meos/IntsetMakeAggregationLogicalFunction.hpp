...
/**
 * @brief intset_make (Set *) - the integer set collected from a window of int values.
 *
 ...
 */
class IntsetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "IntsetMake";
