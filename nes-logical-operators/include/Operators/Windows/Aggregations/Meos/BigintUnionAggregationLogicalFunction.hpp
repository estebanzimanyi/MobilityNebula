 ...
 */
class BigintUnionAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    ~BigintUnionAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "BIGINT_UNION";
