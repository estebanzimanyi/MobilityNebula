...
/**
 * @brief Windowed POSE_UNION_TRANSFN -> unioned container (text) via pose_union_transfn/set_union_finalfn.
 *
 ...
 * sequence and calls MEOS `pose_union_transfn` to fold it to a single scalar.
 */
class PoseUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "PoseUnionTransfn";
