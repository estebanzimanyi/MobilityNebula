...
/**
 * @brief textset_make (Set *) - the text set collected from a window of text values.
 *
 ...
 */
class TextsetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TextsetMake";
