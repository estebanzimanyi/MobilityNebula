...
/**
 * @brief Windowed tgeompoint mini-trip; tpoint_get_y projects the Y coordinate as a tfloat (hex-WKB).
 *
 ...
 * and calls MEOS `tpoint_get_y` to fold it to a single scalar.
 */
class TpointGetYAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointGetYAggregationLogicalFunction(
    ...
    ~TpointGetYAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointGetY";
