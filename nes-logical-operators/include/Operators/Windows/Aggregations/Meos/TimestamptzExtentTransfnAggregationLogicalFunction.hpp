...
/**
 * @brief Windowed time extent (TSTZSPAN) over an event-time field via timestamptz_extent_transfn.
 *
 ...
 */
class TimestamptzExtentTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TimestamptzExtentTransfnAggregationLogicalFunction(
        const FieldAccessLogicalFunction& valueField,
        const FieldAccessLogicalFunction& timestampField,
        const FieldAccessLogicalFunction& asField);

    void inferStamp(const Schema& schema) override;
    ~TimestamptzExtentTransfnAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TimestamptzExtentTransfn";
