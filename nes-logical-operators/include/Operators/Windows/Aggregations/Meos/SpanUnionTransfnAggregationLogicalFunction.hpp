...
/**
 * @brief Windowed SPAN_UNION_TRANSFN -> unioned container (text) via span_union_transfn/spanset_union_finalfn.
 *
 ...
 * sequence and calls MEOS `span_union_transfn` to fold it to a single scalar.
 */
class SpanUnionTransfnAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "SpanUnionTransfn";
