...
/**
 * @brief Value at the last instant of the per-(window, group) tint sequence.
 *
 ...
 * sequence and calls MEOS `tint_end_value` to fold it to a single scalar.
 */
class TintEndValueAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "TintEndValue";
