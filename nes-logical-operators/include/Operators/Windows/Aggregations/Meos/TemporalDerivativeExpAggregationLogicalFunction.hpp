...
/**
 * @brief Windowed temporal_derivative over the expandable tfloat mini-series, emitted as hex-WKB.
 *
 ...
 * sequence and calls MEOS `temporal_derivative` to fold it to a single scalar.
 */
class TemporalDerivativeExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalDerivativeExpAggregationLogicalFunction(
        const FieldAccessLogicalFunction& valueField,
        const FieldAccessLogicalFunction& timestampField,
        const FieldAccessLogicalFunction& asField);

    void inferStamp(const Schema& schema) override;
    ~TemporalDerivativeExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TEMPORAL_DERIVATIVE_EXP";
