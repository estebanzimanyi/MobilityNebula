...
/**
 * @brief poseset_make (Set *) - the pose set collected from a window of pose values.
 *
 ...
 */
class PosesetMakeAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
...
private:
    static constexpr std::string_view NAME = "PosesetMake";
