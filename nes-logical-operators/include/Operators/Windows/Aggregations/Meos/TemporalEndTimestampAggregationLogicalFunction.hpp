 ...
 */
class TemporalEndTimestampAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalEndTimestampAggregationLogicalFunction(
    ...
    ~TemporalEndTimestampAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalEndTimestamp";
