...
/**
 * @brief Per-(window, group) count of distinct timestamps in the assembled tgeo trajectory.
 *
 ...
 * and calls MEOS `temporal_num_timestamps` to fold it to a single scalar.
 */
class TemporalNumTimestampsAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TemporalNumTimestampsAggregationLogicalFunction(
    ...
    ~TemporalNumTimestampsAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TemporalNumTimestamps";
