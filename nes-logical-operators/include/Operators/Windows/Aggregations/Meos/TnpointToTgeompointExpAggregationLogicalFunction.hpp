...
/**
 * @brief Windowed tnpoint_to_tgeompoint over the expandable tnpoint mini-series, emitted as hex-WKB.
 *
 ...
 * and calls MEOS `tnpoint_to_tgeompoint` to fold it to a single scalar.
 */
class TnpointToTgeompointExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TnpointToTgeompointExpAggregationLogicalFunction(
    ...
    ~TnpointToTgeompointExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TnpointToTgeompointExp";
