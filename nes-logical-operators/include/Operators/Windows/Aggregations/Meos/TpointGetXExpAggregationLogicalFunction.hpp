...
/**
 * @brief Windowed tgeompoint mini-trip; tpoint_get_x projects the X coordinate as a tfloat (hex-WKB).
 *
 ...
 * and calls MEOS `tpoint_get_x` to fold it to a single scalar.
 */
class TpointGetXExpAggregationLogicalFunction : public WindowAggregationLogicalFunction
{
public:
    ...
    TpointGetXExpAggregationLogicalFunction(
    ...
    ~TpointGetXExpAggregationLogicalFunction() override = default;
...
private:
    static constexpr std::string_view NAME = "TpointGetXExp";
