...
/**
 * @brief textset_initcap (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textset_initcap`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextsetInitcapLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextsetInitcap";

    TextsetInitcapLogicalFunction(LogicalFunction lit);
