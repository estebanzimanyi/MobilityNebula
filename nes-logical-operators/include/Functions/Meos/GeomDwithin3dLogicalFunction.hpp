...
/**
 * @brief Static geometry function geom_dwithin3d: (wkt1:VARCHAR, wkt2:VARCHAR, dist:FLOAT64) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function `geom_dwithin3d`.
 */
class GeomDwithin3dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomDwithin3d";

    GeomDwithin3dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2, LogicalFunction dist);
