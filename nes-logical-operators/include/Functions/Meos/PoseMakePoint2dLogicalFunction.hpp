...
/**
 * @brief pose_make_point2d (Pose *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_make_point2d`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseMakePoint2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseMakePoint2d";

    PoseMakePoint2dLogicalFunction(LogicalFunction lit,
