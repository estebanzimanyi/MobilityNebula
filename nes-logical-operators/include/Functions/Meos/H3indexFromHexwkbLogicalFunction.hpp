...
/**
 * @brief Parses an H3Index from its HexWKB string representation (VARSIZED) to a cell identifier (UINT64).
 */
class H3indexFromHexwkbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexFromHexwkb";

    H3indexFromHexwkbLogicalFunction(LogicalFunction hexwkb);
