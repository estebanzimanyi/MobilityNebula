...
/**
 * @brief Returns 1.0 if temporal geometry always covers the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class AcoversTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcoversTgeoGeo";

    AcoversTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
