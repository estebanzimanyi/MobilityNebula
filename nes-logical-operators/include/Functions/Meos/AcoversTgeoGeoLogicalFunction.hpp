...
/**
 * @brief Per-event acovers_tgeo_geo spatial predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_tgeo_geo`. Per-event scalar operator following the
...
public:
    ...
    AcoversTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
