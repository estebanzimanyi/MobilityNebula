...
/**
 * @brief tgeo_at_value (Temporal *) — tgeo restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_at_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoAtValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoAtValue";

    TgeoAtValueLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
