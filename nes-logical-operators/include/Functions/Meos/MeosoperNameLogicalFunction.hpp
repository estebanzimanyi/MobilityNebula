...
/**
 * @brief meosoper_name (const char *) - the name of a MEOS operator.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `meosoper_name`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MeosoperNameLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MeosoperName";

    MeosoperNameLogicalFunction(LogicalFunction value);
