...
/**
 * @brief Tests if JSONB value jb1 is greater than or equal to jb2.
 */
class JsonbGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbGe";
    JsonbGeLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
