...
/**
 * @brief Per-event stbox_cmp: two per-vehicle extent STBoxes -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxCmp";

    StboxCmpLogicalFunction(LogicalFunction box,
