...
/**
 * @brief minus_set_float (Set *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetFloat";

    MinusSetFloatLogicalFunction(LogicalFunction lit,
