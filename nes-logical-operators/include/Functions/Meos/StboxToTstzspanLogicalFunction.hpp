...
/**
 * @brief stbox_to_tstzspan (Span *) — STBox -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_to_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxToTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxToTstzspan";

    StboxToTstzspanLogicalFunction(LogicalFunction box);
