...
/**
 * @brief right_bigint_set (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_bigint_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightBigintSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightBigintSet";

    RightBigintSetLogicalFunction(LogicalFunction lit,
