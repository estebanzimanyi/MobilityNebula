...
/**
 * @brief tstzspan_to_stbox (STBox *) — Span -> STBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanToStbox";

    TstzspanToStboxLogicalFunction(LogicalFunction lit);
