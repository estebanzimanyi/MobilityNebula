...
/**
 * @brief trgeometry_rotation (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_rotation`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryRotationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryRotation";

    TrgeometryRotationLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
