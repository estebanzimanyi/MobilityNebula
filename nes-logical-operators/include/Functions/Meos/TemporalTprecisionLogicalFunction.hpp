...
/**
 * @brief temporal_tprecision (Temporal *) — arity-3 tfloat_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_tprecision`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalTprecisionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalTprecision";

    TemporalTprecisionLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
