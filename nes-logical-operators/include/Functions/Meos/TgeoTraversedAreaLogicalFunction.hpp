...
/**
 * @brief tgeo_traversed_area (GSERIALIZED *) - the area traversed by a temporal geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_traversed_area`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoTraversedAreaLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoTraversedArea";

    TgeoTraversedAreaLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
