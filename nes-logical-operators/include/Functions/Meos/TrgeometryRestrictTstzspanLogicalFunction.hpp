...
/**
 * @brief trgeometry_restrict_tstzspan (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_restrict_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryRestrictTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryRestrictTstzspan";

    TrgeometryRestrictTstzspanLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
