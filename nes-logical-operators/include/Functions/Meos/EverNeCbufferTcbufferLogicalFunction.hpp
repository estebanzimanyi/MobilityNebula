...
/**
 * @brief ever_ne_cbuffer_tcbuffer (int) — always/ever tcbuffer ⊗ Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EverNeCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeCbufferTcbuffer";

    EverNeCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
