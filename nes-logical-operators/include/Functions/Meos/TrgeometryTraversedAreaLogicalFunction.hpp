...
/**
 * @brief trgeometry_traversed_area (GSERIALIZED *) - the area traversed by a temporal rigid geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_traversed_area`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryTraversedAreaLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryTraversedArea";

    TrgeometryTraversedAreaLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
