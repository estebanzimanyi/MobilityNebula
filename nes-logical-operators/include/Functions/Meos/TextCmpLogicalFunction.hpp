...
/**
 * @brief text_cmp (int) — text comparator.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `text_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextCmp";

    TextCmpLogicalFunction(LogicalFunction lit,
