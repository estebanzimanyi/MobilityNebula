...
/**
 * @brief teq_trgeometry_geo (Temporal *) — temporal trgeometry ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `teq_trgeometry_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TeqTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TeqTrgeometryGeo";

    TeqTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
