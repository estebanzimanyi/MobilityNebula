...
/**
 * @brief union_text_set: extern Set *union_text_set(const text *txt, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_text_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionTextSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionTextSet";

    UnionTextSetLogicalFunction(LogicalFunction lit,
