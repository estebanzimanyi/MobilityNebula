...
/**
 * @brief nai_tnpoint_tnpoint (TInstant *) — two tnpoint instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tnpoint_tnpoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTnpointTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTnpointTnpoint";

    NaiTnpointTnpointLogicalFunction(LogicalFunction rid,
