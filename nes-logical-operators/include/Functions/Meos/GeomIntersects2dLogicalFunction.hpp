...
/**
 * @brief geom_intersects2d (bool) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_intersects2d`. Per-event scalar operator following the
...
public:
    ...
    GeomIntersects2dLogicalFunction(LogicalFunction lit,
