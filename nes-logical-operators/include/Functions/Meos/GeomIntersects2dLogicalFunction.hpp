...
/**
 * @brief Static geometry predicate geom_intersects2d: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_intersects2d`. Operates on plain WKT strings without a temporal dimension.
 */
class GeomIntersects2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomIntersects2d";

    GeomIntersects2dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
