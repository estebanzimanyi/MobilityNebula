...
/**
 * @brief Per-event overbefore_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbefore_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbeforeTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbeforeTnumberTbox";

    OverbeforeTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
