...
/**
 * @brief npointset_routes (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npointset_routes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointsetRoutesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointsetRoutes";

    NpointsetRoutesLogicalFunction(LogicalFunction lit);
