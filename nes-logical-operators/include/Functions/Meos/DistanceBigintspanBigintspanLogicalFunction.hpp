...
/**
 * @brief distance_bigintspan_bigintspan (int64) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_bigintspan_bigintspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceBigintspanBigintspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceBigintspanBigintspan";

    DistanceBigintspanBigintspanLogicalFunction(LogicalFunction lit,
