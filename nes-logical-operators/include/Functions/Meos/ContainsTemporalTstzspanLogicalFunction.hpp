...
/**
 * @brief contains_temporal_tstzspan (bool) — temporal ⊗ tstzspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_temporal_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsTemporalTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsTemporalTstzspan";

    ContainsTemporalTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
