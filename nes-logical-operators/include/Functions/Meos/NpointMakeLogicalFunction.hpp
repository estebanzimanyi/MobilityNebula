...
/**
 * @brief npoint_make (Npoint *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointMake";

    NpointMakeLogicalFunction(LogicalFunction value,
