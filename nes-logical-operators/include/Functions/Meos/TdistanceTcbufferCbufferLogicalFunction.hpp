...
/**
 * @brief tdistance_tcbuffer_cbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTcbufferCbuffer";

    TdistanceTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
