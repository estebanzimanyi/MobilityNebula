...
/**
 * @brief geom_buffer (GSERIALIZED *) — geometry op with fixed 1.0, "".
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_buffer`. Per-event scalar operator following the
...
public:
    ...
    GeomBufferLogicalFunction(LogicalFunction lit);
