...
/**
 * @brief Returns a geometry buffered by the given size with optional style parameters, as WKT.
 */
class GeomBufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomBuffer";

    GeomBufferLogicalFunction(LogicalFunction wkt, LogicalFunction size, LogicalFunction params);
