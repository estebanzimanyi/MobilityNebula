...
/**
 * @brief minus_timestamptz_timestamptz (Interval *) - the interval between two timestamps.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_timestamptz_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusTimestamptzTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusTimestamptzTimestamptz";

    MinusTimestamptzTimestamptzLogicalFunction(LogicalFunction value,
