...
/**
 * @brief tstzspan_duration (Interval *) — tstzspan duration.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_duration`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanDurationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanDuration";

    TstzspanDurationLogicalFunction(LogicalFunction lit);
