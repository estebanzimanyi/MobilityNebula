...
/**
 * @brief distance_cbuffer_geo (double) — Cbuffer ⊗ GSERIALIZED distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_cbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceCbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceCbufferGeo";

    DistanceCbufferGeoLogicalFunction(LogicalFunction lit,
