...
/**
 * @brief Per-event eintersects_geo_tgeo: a static geometry vs a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `eintersects_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EintersectsGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EintersectsGeoTgeo";

    EintersectsGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
