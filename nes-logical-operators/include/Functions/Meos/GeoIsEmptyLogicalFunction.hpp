...
/**
 * @brief geo_is_empty (bool) — unary geom accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_is_empty`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoIsEmptyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoIsEmpty";

    GeoIsEmptyLogicalFunction(LogicalFunction lit);
