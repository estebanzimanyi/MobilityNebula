...
/**
 * @brief ever_eq_geo_trgeometry (int) — temporal trgeometry ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_geo_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    EverEqGeoTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
