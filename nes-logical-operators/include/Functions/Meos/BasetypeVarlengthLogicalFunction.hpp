...
/**
 * @brief basetype_varlength (bool) - whether a MEOS base type is variable-length.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `basetype_varlength`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BasetypeVarlengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BasetypeVarlength";

    BasetypeVarlengthLogicalFunction(LogicalFunction value);
