...
/**
 * @brief Per-event same_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `same_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SameTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SameTnumberTbox";

    SameTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
