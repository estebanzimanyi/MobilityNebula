...
/**
 * @brief minus_timestamptz_interval (TimestampTz) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_timestamptz_interval`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusTimestamptzIntervalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusTimestamptzInterval";

    MinusTimestamptzIntervalLogicalFunction(LogicalFunction value,
