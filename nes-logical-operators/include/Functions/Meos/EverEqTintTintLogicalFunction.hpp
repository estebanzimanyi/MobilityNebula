 ...
 */
class EverEqTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTintTint";

    EverEqTintTintLogicalFunction(LogicalFunction value1,
