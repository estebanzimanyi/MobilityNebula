...
/**
 * @brief ttouches_tcbuffer_cbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttouches_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtouchesTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtouchesTcbufferCbuffer";

    TtouchesTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
