...
/**
 * @brief Per-event ever-covers between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalECoversTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversTNpointTNpoint";

    TemporalECoversTNpointTNpointLogicalFunction(LogicalFunction ridA,
