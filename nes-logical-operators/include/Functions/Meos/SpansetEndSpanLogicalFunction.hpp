...
/**
 * @brief spanset_end_span (Span *) — unary floatspanset -> Span.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_end_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetEndSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetEndSpan";

    SpansetEndSpanLogicalFunction(LogicalFunction lit);
