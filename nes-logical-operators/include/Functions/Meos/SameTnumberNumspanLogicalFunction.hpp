...
/**
 * @brief same_tnumber_numspan (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `same_tnumber_numspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SameTnumberNumspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SameTnumberNumspan";

    SameTnumberNumspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
