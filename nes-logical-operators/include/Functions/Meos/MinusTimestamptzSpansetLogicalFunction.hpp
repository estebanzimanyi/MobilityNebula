...
/**
 * @brief minus_timestamptz_spanset: extern SpanSet *minus_timestamptz_spanset(TimestampTz t, const SpanSet *ss);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_timestamptz_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusTimestamptzSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusTimestamptzSpanset";

    MinusTimestamptzSpansetLogicalFunction(LogicalFunction lit,
