...
/**
 * @brief intset_end_value (int) — unary intset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntsetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntsetEndValue";

    IntsetEndValueLogicalFunction(LogicalFunction lit);
