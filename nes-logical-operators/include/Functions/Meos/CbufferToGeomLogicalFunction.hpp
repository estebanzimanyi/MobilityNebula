...
/**
 * @brief cbuffer_to_geom (GSERIALIZED *) — unary cbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_to_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferToGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferToGeom";

    CbufferToGeomLogicalFunction(LogicalFunction lit);
