...
/**
 * @brief cbuffer_srid (int32_t) — unary cbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferSrid";

    CbufferSridLogicalFunction(LogicalFunction lit);
