...
/**
 * @brief date_to_span (date value) -> span (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `date_to_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DateToSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DateToSpan";

    DateToSpanLogicalFunction(LogicalFunction value);
