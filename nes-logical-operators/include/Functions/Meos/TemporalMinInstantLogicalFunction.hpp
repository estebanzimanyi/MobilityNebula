...
/**
 * @brief temporal_min_instant (TInstant *) — unary tfloat accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_min_instant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMinInstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMinInstant";

    TemporalMinInstantLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
