...
/**
 * @brief Per-event sub_tnumber_tnumber: element-wise subtraction of two single-instant tnumbers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_tnumber_tnumber`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two co-instant temporals, applies the subtraction, and returns FLOAT64.
 */
class SubTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SubTnumberTnumber";

    SubTnumberTnumberLogicalFunction(LogicalFunction value1,
