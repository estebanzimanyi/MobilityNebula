...
/**
 * @brief Per-event sub_tnumber_tnumber: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_tnumber_tnumber`. Per-event scalar operator following the
...
public:
    ...
    SubTnumberTnumberLogicalFunction(LogicalFunction traj,
