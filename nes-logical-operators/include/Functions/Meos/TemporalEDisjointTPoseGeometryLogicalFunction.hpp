...
/**
 * @brief Per-event ever-disjoint between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalEDisjointTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointTPoseGeometry";

    TemporalEDisjointTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
