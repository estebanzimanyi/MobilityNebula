...
/**
 * @brief shortestline_tcbuffer_tcbuffer (GSERIALIZED *) — two tcbuffer instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTcbufferTcbuffer";

    ShortestlineTcbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
