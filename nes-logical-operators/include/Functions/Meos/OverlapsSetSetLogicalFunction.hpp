...
/**
 * @brief overlaps_set_set over two text literals (parsed as intset/intset_in); type-generic MEOS topology predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overlaps_set_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverlapsSetSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverlapsSetSet";

    OverlapsSetSetLogicalFunction(LogicalFunction lit,
