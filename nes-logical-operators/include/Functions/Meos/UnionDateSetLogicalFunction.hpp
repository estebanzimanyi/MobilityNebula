...
/**
 * @brief union_date_set: extern Set *union_date_set(DateADT d, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_date_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionDateSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionDateSet";

    UnionDateSetLogicalFunction(LogicalFunction lit,
