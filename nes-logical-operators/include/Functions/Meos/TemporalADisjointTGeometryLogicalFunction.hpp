...
/**
 * @brief Per-event always-disjoint between two single-instant tgeompoints.
 *
 ...
 */
class TemporalADisjointTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADisjointTGeometry";

    TemporalADisjointTGeometryLogicalFunction(LogicalFunction lonA,
