...
/**
 * @brief stbox_expand_space (STBox *) - expand an STBox by a distance in the spatial dimensions.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_expand_space`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxExpandSpaceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxExpandSpace";

    StboxExpandSpaceLogicalFunction(LogicalFunction box,
