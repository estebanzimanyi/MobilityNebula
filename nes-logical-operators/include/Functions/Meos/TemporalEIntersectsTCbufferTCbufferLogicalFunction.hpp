...
/**
 * @brief Per-event ever-intersects between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `eintersects_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEIntersectsTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEIntersectsTCbufferTCbuffer";

    TemporalEIntersectsTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
