...
/**
 * @brief geoset_type (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geoset_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeosetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeosetType";

    GeosetTypeLogicalFunction(LogicalFunction lit);
