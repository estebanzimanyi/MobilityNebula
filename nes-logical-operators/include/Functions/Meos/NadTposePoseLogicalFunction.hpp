...
/**
 * @brief nad_tpose_pose (double) — tpose nearest-approach ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tpose_pose`. Per-event scalar operator following the
...
public:
    ...
    NadTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
