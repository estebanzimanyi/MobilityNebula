...
/**
 * @brief Returns the nearest approach distance between a 2D tpose instant and a static pose.
 */
class NadTposePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTposePose";

    NadTposePoseLogicalFunction(LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction x2, LogicalFunction y2, LogicalFunction theta2);
