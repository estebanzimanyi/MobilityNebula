...
/**
 * @brief same_tstzspan_temporal (bool) — temporal ⊗ tstzspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `same_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SameTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SameTstzspanTemporal";

    SameTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
