...
/**
 * @brief temporal_at_tstzspan (Temporal *) — tint restricted by a tstzspan box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_at_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAtTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAtTstzspan";

    TemporalAtTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
