...
/**
 * @brief intspan_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled intspan.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspan_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspanShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanShiftScale";

    IntspanShiftScaleLogicalFunction(LogicalFunction lit,
