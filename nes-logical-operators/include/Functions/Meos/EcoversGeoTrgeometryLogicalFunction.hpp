...
/**
 * @brief Returns 1 if the geometry ecovers the trgeometry instant.
 */
class EcoversGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcoversGeoTrgeometry";
    EcoversGeoTrgeometryLogicalFunction(LogicalFunction tgt_wkt, LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1);
