...
/**
 * @brief Per-event trgeometry_minus_stbox: a hex-WKB temporal, a static STBox, and a border flag -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_minus_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryMinusStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryMinusStbox";

    TrgeometryMinusStboxLogicalFunction(LogicalFunction traj,
