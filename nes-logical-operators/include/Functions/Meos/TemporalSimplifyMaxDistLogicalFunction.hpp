...
/**
 * @brief temporal_simplify_max_dist (Temporal *) — arity-3 tfloat_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_simplify_max_dist`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSimplifyMaxDistLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSimplifyMaxDist";

    TemporalSimplifyMaxDistLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
