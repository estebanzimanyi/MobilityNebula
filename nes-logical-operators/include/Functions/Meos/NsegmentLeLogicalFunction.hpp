...
/**
 * @brief nsegment_le (bool) — Nsegment scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_le`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentLeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentLe";

    NsegmentLeLogicalFunction(LogicalFunction lit,
