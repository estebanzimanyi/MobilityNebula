...
/**
 * @brief Per-event always-distance-within between a single-instant tcbuffer and a static Cbuffer under a fixed threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adwithin_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalADWithinTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinTCbufferCbuffer";

    TemporalADWithinTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
