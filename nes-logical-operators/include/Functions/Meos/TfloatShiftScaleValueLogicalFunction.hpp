...
/**
 * @brief Per-event tfloat_shift_scale_value: shifts and scales a single-instant tfloat by shift and width.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_shift_scale_value`. Takes (value:FLOAT64, ts:UINT64, shift:FLOAT64, width:FLOAT64),
 * constructs a single-instant temporal, applies shift+scale, and returns FLOAT64.
 */
class TfloatShiftScaleValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatShiftScaleValue";

    TfloatShiftScaleValueLogicalFunction(LogicalFunction value,
                                         LogicalFunction ts,
