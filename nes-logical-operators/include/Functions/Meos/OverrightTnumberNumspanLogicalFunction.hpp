...
/**
 * @brief overright_tnumber_numspan (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_tnumber_numspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightTnumberNumspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightTnumberNumspan";

    OverrightTnumberNumspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
