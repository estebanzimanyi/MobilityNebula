...
/**
 * @brief tstzspanset_lower (TimestampTz) — unary tstzspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetLower";

    TstzspansetLowerLogicalFunction(LogicalFunction lit);
