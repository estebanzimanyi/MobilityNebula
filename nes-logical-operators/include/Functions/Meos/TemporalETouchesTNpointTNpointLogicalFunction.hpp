...
/**
 * @brief Per-event ever-touches between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalETouchesTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalETouchesTNpointTNpoint";

    TemporalETouchesTNpointTNpointLogicalFunction(LogicalFunction ridA,
