...
/**
 * @brief floatspan_radians (Span *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_radians`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanRadiansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanRadians";

    FloatspanRadiansLogicalFunction(LogicalFunction lit);
