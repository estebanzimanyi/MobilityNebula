...
/**
 * @brief npoint_to_geompoint (GSERIALIZED *) — unary npoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_to_geompoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointToGeompointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointToGeompoint";

    NpointToGeompointLogicalFunction(LogicalFunction lit);
