...
/**
 * @brief bigintset_value_n (out-param int64, n=1) — bigintset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintsetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintsetValueN";

    BigintsetValueNLogicalFunction(LogicalFunction lit);
