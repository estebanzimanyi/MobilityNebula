...
/**
 * @brief float_to_spanset (float value) -> spanset (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_to_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatToSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatToSpanset";

    FloatToSpansetLogicalFunction(LogicalFunction value);
