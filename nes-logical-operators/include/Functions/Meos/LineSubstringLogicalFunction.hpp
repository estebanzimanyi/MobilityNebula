...
/**
 * @brief Returns the portion of a linestring between fractional positions from and to.
 */
class LineSubstringLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LineSubstring";

    LineSubstringLogicalFunction(LogicalFunction wkt, LogicalFunction from_f, LogicalFunction to_f);
