...
/**
 * @brief Per-event tpose_pitch: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_pitch`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposePitchLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposePitch";

    TposePitchLogicalFunction(LogicalFunction traj);
