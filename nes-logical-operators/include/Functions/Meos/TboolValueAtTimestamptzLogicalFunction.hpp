...
/**
 * @brief tbool_value_at_timestamptz (out-param bool) — tbool value at a timestamp.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_value_at_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolValueAtTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolValueAtTimestamptz";

    TboolValueAtTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
