...
/**
 * @brief Returns 1.0 if two planar geometries are the same (identical coordinates).
 *
 * Args: (wkt1:VARCHAR, wkt2:VARCHAR) -> FLOAT64.
 */
class GeoSameLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoSame";

    GeoSameLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
