...
/**
 * @brief bigintspan_lower (int64) — unary bigintspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspan_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspanLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspanLower";

    BigintspanLowerLogicalFunction(LogicalFunction lit);
