...
/**
 * @brief intersection_set_cbuffer (Set *) — object-set ± cbuffer value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_set_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSetCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSetCbuffer";

    IntersectionSetCbufferLogicalFunction(LogicalFunction lit,
