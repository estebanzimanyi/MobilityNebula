...
/**
 * @brief Returns the nearest approach distance between two tcbuffer instants.
 *
 * Args: (lon1:FLOAT64, lat1:FLOAT64, r1:FLOAT64, ts1:UINT64,
 *        lon2:FLOAT64, lat2:FLOAT64, r2:FLOAT64, ts2:UINT64) -> FLOAT64.
 */
class NadTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTcbufferTcbuffer";

    NadTcbufferTcbufferLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction r1,
                          LogicalFunction ts1,
