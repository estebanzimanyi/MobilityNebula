...
/**
 * @brief floatspan_ceil (Span *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_ceil`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanCeilLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanCeil";

    FloatspanCeilLogicalFunction(LogicalFunction lit);
