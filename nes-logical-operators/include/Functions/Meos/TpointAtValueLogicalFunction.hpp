...
/**
 * @brief tpoint_at_value (Temporal *) — tgeo restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_at_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointAtValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointAtValue";

    TpointAtValueLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
