...
/**
 * @brief tnpoint_positions (Nsegment **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_positions`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointPositionsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointPositions";

    TnpointPositionsLogicalFunction(LogicalFunction rid,
