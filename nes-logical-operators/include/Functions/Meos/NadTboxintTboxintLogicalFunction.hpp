...
/**
 * @brief nad_tboxint_tboxint (int) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tboxint_tboxint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTboxintTboxintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTboxintTboxint";

    NadTboxintTboxintLogicalFunction(LogicalFunction lit,
