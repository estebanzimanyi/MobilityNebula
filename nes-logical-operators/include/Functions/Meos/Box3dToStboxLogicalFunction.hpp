...
/**
 * @brief box3d_to_stbox (STBox *) - the spatiotemporal box of a PostGIS BOX3D.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `box3d_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class Box3dToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Box3dToStbox";

    Box3dToStboxLogicalFunction(LogicalFunction box);
