...
/**
 * @brief Per-event ever-disjoint between two single-instant tgeompoints, each lifted from a tpose (x,y,theta,ts) via tpose_to_tpoint composition.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edisjoint_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEDisjointTPoseTPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointTPoseTPose";

    TemporalEDisjointTPoseTPoseLogicalFunction(LogicalFunction xA,
                                          LogicalFunction yA,
