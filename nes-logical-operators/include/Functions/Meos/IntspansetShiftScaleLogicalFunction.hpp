...
/**
 * @brief intspanset_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled intspanset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspanset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspansetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspansetShiftScale";

    IntspansetShiftScaleLogicalFunction(LogicalFunction lit,
