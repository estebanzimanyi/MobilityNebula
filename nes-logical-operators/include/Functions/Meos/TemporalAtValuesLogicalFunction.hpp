...
/**
 * @brief temporal_at_values (Temporal *) — tint restricted by a values box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_at_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAtValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAtValues";

    TemporalAtValuesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
