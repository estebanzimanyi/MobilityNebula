...
/**
 * @brief temporal_at_tstzset (Temporal *) — tint restricted by a tstzset box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_at_tstzset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAtTstzsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAtTstzset";

    TemporalAtTstzsetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
