...
/**
 * @brief overlaps_tstzspan_temporal (bool) — temporal ⊗ tstzspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overlaps_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverlapsTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverlapsTstzspanTemporal";

    OverlapsTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
