...
/**
 * @brief union_spanset_float (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_spanset_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSpansetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSpansetFloat";

    UnionSpansetFloatLogicalFunction(LogicalFunction lit,
