...
/**
 * @brief minus_timestamptz_set: extern Set *minus_timestamptz_set(TimestampTz t, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_timestamptz_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusTimestamptzSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusTimestamptzSet";

    MinusTimestamptzSetLogicalFunction(LogicalFunction lit,
