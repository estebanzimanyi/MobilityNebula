...
/**
 * @brief Per-event aintersects_geo_tgeo: a static geometry vs a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `aintersects_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AintersectsGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AintersectsGeoTgeo";

    AintersectsGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
