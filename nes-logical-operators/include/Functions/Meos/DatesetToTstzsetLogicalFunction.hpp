...
/**
 * @brief dateset_to_tstzset (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `dateset_to_tstzset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatesetToTstzsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatesetToTstzset";

    DatesetToTstzsetLogicalFunction(LogicalFunction lit);
