...
/**
 * @brief Per-event sub_int_tint: subtracts a single-instant tint value from a constant.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_int_tint`. Takes (scalar:FLOAT64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the subtraction, and returns FLOAT64.
 */
class SubIntTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SubIntTint";

    SubIntTintLogicalFunction(LogicalFunction scalar,
