...
/**
 * @brief Per-event sub_int_tint: scalar int minus single-instant tint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_int_tint`. Per-event scalar operator following the
...
public:
    ...
    SubIntTintLogicalFunction(LogicalFunction arg0,
