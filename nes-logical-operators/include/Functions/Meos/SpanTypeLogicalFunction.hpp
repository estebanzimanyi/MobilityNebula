...
/**
 * @brief span_type (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanType";

    SpanTypeLogicalFunction(LogicalFunction lit);
