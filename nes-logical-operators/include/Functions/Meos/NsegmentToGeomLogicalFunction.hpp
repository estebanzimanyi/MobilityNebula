...
/**
 * @brief nsegment_to_geom (GSERIALIZED *) — unary nsegment accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_to_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentToGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentToGeom";

    NsegmentToGeomLogicalFunction(LogicalFunction lit);
