...
/**
 * @brief stboxarr_round — round a 1-element STBox array.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stboxarr_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxarrRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxarrRound";

    StboxarrRoundLogicalFunction(LogicalFunction box);
