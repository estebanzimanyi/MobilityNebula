...
/**
 * @brief always_eq_trgeometry_trgeometry (bool) — two trgeometry instants -> int reduction.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_trgeometry_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
