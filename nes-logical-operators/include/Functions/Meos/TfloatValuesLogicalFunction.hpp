...
/**
 * @brief tfloat_values (double *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatValues";

    TfloatValuesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
