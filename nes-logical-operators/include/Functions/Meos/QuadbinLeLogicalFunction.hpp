...
/**
 * @brief Tests if Quadbin cell a is less than or equal to b.
 */
class QuadbinLeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinLe";
    QuadbinLeLogicalFunction(LogicalFunction a, LogicalFunction b);
