...
/**
 * @brief temporal_simplify_dp (Temporal *) — arity-3 tfloat_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_simplify_dp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSimplifyDpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSimplifyDp";

    TemporalSimplifyDpLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
