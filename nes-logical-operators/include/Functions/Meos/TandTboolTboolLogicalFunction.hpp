...
/**
 * @brief Per-event tand_tbool_tbool: AND of two single-instant tbools.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tand_tbool_tbool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the operation, and returns FLOAT64 (0.0/1.0).
 */
class TandTboolTboolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TandTboolTbool";

    TandTboolTboolLogicalFunction(LogicalFunction value,
