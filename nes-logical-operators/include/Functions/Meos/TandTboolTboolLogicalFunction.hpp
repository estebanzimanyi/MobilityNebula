...
/**
 * @brief Per-event tand_tbool_tbool: temporal AND of two tbool values (WKB result).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tand_tbool_tbool`. Per-event scalar operator following the
...
public:
    ...
    TandTboolTboolLogicalFunction(LogicalFunction traj,
