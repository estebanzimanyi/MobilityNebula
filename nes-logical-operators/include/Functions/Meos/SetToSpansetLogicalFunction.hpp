...
/**
 * @brief set_to_spanset (SpanSet *) — Set -> SpanSet conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_to_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetToSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetToSpanset";

    SetToSpansetLogicalFunction(LogicalFunction lit);
