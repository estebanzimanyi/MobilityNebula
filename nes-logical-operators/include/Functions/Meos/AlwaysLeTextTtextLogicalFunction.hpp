...
/**
 * @brief always_le_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_le_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    AlwaysLeTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
