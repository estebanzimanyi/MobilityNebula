...
/**
 * @brief Always lequal text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_le_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysLeTextTtextLogicalFunction(LogicalFunction arg0,
