...
/**
 * @brief datespan_duration (Interval *) — datespan duration.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespan_duration`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespanDurationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespanDuration";

    DatespanDurationLogicalFunction(LogicalFunction lit);
