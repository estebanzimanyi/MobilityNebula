...
/**
 * @brief teq_tpose_pose (Temporal *) — temporal tpose ⊗ Pose -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `teq_tpose_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TeqTposePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TeqTposePose";

    TeqTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
