...
/**
 * @brief Ever gequal text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ge_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    EverGeTextTtextLogicalFunction(LogicalFunction arg0,
