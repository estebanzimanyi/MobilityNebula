...
/**
 * @brief ever_ge_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ge_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    EverGeTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
