...
class EverGeTextTtextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGeTextTtext";

    EverGeTextTtextLogicalFunction(LogicalFunction value, LogicalFunction ref, LogicalFunction ts);
