...
/**
 * @brief intset_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled intset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntsetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntsetShiftScale";

    IntsetShiftScaleLogicalFunction(LogicalFunction lit,
