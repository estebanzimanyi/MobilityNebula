...
/**
 * @brief Returns the H3 grid distance (number of cells) between two H3 cells as FLOAT64.
 *
 * Args: (cell1:UINT64, ts1:UINT64, cell2:UINT64, ts2:UINT64) -> FLOAT64.
 */
class Th3indexGridDistanceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexGridDistance";

    Th3indexGridDistanceLogicalFunction(LogicalFunction cell1, LogicalFunction ts1,
