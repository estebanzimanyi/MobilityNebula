...
/**
 * @brief Th3index grid distance
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_grid_distance(temp, inst0)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexGridDistanceLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
