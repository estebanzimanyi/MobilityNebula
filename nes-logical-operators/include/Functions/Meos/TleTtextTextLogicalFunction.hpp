...
/**
 * @brief tle_ttext_text (Temporal *) — temporal ttext ⊗ text -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tle_ttext_text`. Per-event scalar operator following the
...
public:
    ...
    TleTtextTextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
