...
/**
 * @brief floatspanset_upper (double) — unary floatspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetUpper";

    FloatspansetUpperLogicalFunction(LogicalFunction lit);
