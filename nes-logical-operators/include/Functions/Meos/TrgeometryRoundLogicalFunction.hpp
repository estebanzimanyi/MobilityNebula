...
/**
 * @brief trgeometry_round (Temporal *) — round trgeometry to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryRound";

    TrgeometryRoundLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
