...
/**
 * @brief temporal_time_split (Temporal **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_time_split`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalTimeSplitLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalTimeSplit";

    TemporalTimeSplitLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
