...
/**
 * @brief tboxfloat_xmin (out-param double) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tboxfloat_xmin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxfloatXminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxfloatXmin";

    TboxfloatXminLogicalFunction(LogicalFunction lit);
