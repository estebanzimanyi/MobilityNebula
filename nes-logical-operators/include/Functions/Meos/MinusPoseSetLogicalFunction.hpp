...
/**
 * @brief minus_pose_set (Set *) — object-set ± pose value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_pose_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusPoseSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusPoseSet";

    MinusPoseSetLogicalFunction(LogicalFunction lit,
