...
/**
 * @brief cbuffer_timestamptz_to_stbox (STBox *) — spatiotemporal bounding box.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_timestamptz_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferTimestamptzToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferTimestamptzToStbox";

    CbufferTimestamptzToStboxLogicalFunction(LogicalFunction lit,
