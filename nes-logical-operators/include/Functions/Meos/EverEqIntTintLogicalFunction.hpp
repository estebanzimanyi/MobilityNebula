...
/**
 * @brief Per-event ever comparison of a scalar constant against a single-instant tint (built from value+timestamp); scalar-first MEOS arg order.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_int_tint`. Per-event scalar operator following the
