...
/**
 * @brief Per-event mul_int_tint: scalar int times single-instant tint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_int_tint`. Per-event scalar operator following the
...
public:
    ...
    MulIntTintLogicalFunction(LogicalFunction arg0,
