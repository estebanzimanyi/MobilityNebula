...
/**
 * @brief Per-event mul_int_tint: multiplies a constant by a single-instant tint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_int_tint`. Takes (scalar:FLOAT64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the multiplication, and returns FLOAT64.
 */
class MulIntTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulIntTint";

    MulIntTintLogicalFunction(LogicalFunction scalar,
