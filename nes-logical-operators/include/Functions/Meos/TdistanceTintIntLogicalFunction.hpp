...
/**
 * @brief Per-event tdistance_tint_int: distance between a single-instant tint and an integer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tint_int`. Takes (value:FLOAT64, ts:UINT64, d:FLOAT64→int),
 * constructs a single-instant temporal, applies the distance function, and returns FLOAT64.
 */
class TdistanceTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTintInt";

    TdistanceTintIntLogicalFunction(LogicalFunction value,
                                    LogicalFunction ts,
                                    LogicalFunction d);
