...
/**
 * @brief minus_span_timestamptz: extern SpanSet *minus_span_timestamptz(const Span *s, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_span_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpanTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpanTimestamptz";

    MinusSpanTimestamptzLogicalFunction(LogicalFunction lit,
