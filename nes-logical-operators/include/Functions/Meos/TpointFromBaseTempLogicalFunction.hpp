...
/**
 * @brief tpoint_from_base_temp (Temporal *) - a temporal point from a geometry and a temporal's time frame.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_from_base_temp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointFromBaseTempLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointFromBaseTemp";

    TpointFromBaseTempLogicalFunction(LogicalFunction lit,
