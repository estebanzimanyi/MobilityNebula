...
/**
 * @brief int64_cmp (int) — scalar comparator.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int64_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class Int64CmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Int64Cmp";

    Int64CmpLogicalFunction(LogicalFunction value,
