...
/**
 * @brief timespan_basetype (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timespan_basetype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimespanBasetypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimespanBasetype";

    TimespanBasetypeLogicalFunction(LogicalFunction lit);
