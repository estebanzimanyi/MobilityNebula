...
/**
 * @brief union_float_spanset (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_float_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionFloatSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionFloatSpanset";

    UnionFloatSpansetLogicalFunction(LogicalFunction lit,
