...
/**
 * @brief econtains_cbuffer_tcbuffer (int) — temporal tcbuffer ⊗ Cbuffer -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `econtains_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EcontainsCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcontainsCbufferTcbuffer";

    EcontainsCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
