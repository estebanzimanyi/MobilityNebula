...
/**
 * @brief distance_pose_pose (double) — Pose scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_pose_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistancePosePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistancePosePose";

    DistancePosePoseLogicalFunction(LogicalFunction lit,
