...
/**
 * @brief spanset_spanarr (Span **) - the array of span pointers of a span set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_spanarr`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetSpanarrLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetSpanarr";

    SpansetSpanarrLogicalFunction(LogicalFunction lit);
