...
/**
 * @brief trgeometry_start_sequence (TSequence *) — unary trgeometry accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_start_sequence`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryStartSequenceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryStartSequence";

    TrgeometryStartSequenceLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
