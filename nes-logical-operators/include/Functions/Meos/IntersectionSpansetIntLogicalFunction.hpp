...
/**
 * @brief intersection_spanset_int (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_spanset_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpansetIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpansetInt";

    IntersectionSpansetIntLogicalFunction(LogicalFunction lit,
