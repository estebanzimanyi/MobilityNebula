...
/**
 * @brief Returns the nearest approach distance between the tcbuffer and a static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, radius:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class NadTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTcbufferGeo";

    NadTcbufferGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
