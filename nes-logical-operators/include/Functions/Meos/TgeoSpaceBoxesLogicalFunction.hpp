...
/**
 * @brief tgeo_space_boxes (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_space_boxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoSpaceBoxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoSpaceBoxes";

    TgeoSpaceBoxesLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
