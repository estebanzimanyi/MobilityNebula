...
/**
 * @brief int_to_spanset (int value) -> spanset (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int_to_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntToSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntToSpanset";

    IntToSpansetLogicalFunction(LogicalFunction value);
