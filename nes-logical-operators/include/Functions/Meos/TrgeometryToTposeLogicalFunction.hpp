...
/**
 * @brief trgeometry_to_tpose (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_to_tpose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryToTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryToTpose";

    TrgeometryToTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
