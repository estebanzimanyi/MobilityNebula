...
/**
 * @brief Per-event always-distance-within between two single-instant tgeompoints under a static threshold.
 *
 ...
 */
class TemporalADWithinTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinTGeometry";

    TemporalADWithinTGeometryLogicalFunction(LogicalFunction lonA,
