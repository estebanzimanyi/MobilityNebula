...
/**
 * @brief timespanset_type (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timespanset_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimespansetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimespansetType";

    TimespansetTypeLogicalFunction(LogicalFunction lit);
