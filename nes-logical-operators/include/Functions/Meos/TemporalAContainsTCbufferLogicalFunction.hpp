...
/**
 * @brief Per-event always-contains between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acontains_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAContainsTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAContainsTCbuffer";

    TemporalAContainsTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
