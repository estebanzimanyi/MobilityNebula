...
/**
 * @brief Returns 1 if the geometry acontains the trgeometry instant.
 */
class AcontainsGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcontainsGeoTrgeometry";
    AcontainsGeoTrgeometryLogicalFunction(LogicalFunction tgt_wkt, LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1);
