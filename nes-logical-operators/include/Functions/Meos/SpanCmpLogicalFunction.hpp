...
/**
 * @brief span_cmp (int) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanCmp";

    SpanCmpLogicalFunction(LogicalFunction lit,
