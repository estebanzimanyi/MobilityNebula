...
/**
 * @brief Per-event a-contains between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acontains_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAContainsTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAContainsTCbufferCbuffer";

    TemporalAContainsTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
