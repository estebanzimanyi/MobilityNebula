...
/**
 * @brief Always gequal text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ge_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysGeTextTtextLogicalFunction(LogicalFunction arg0,
