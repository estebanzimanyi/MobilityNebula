...
/**
 * @brief always_ge_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ge_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    AlwaysGeTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
