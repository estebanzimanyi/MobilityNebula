...
/**
 * @brief Per-event always_ne_tnpoint_tnpoint: two hex-WKB temporal operands -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tnpoint_tnpoint`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTnpointTnpointLogicalFunction(LogicalFunction traj,
