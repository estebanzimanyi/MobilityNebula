...
/**
 * @brief temporal_interp (const char *) - the interpolation name of a temporal value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_interp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalInterpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalInterp";

    TemporalInterpLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
