...
/**
 * @brief npointset_start_value (Npoint *) — unary npointset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npointset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointsetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointsetStartValue";

    NpointsetStartValueLogicalFunction(LogicalFunction lit);
