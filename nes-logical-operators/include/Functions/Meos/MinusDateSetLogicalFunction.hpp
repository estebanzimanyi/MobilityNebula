...
/**
 * @brief minus_date_set: extern Set *minus_date_set(DateADT d, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_date_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusDateSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusDateSet";

    MinusDateSetLogicalFunction(LogicalFunction lit,
