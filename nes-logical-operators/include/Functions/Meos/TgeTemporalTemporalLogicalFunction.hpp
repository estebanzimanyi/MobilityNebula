...
/**
 * @brief temporal GE: two single-instant tfloats
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tge_temporal_temporal`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TgeTemporalTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeTemporalTemporal";

    TgeTemporalTemporalLogicalFunction(LogicalFunction value,
