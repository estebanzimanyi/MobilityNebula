...
/**
 * @brief Returns a geometry with coordinates rounded to maxdd decimal digits, as WKT.
 */
class GeoRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoRound";

    GeoRoundLogicalFunction(LogicalFunction wkt, LogicalFunction maxdd);
