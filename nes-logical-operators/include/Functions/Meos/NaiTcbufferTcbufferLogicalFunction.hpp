...
/**
 * @brief nai_tcbuffer_tcbuffer (TInstant *) — two tcbuffer instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTcbufferTcbuffer";

    NaiTcbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
