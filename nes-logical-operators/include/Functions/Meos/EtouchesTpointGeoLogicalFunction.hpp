...
/**
 * @brief Per-event etouches_tpoint_geo between a single-instant tgeompoint and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `etouches_tpoint_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EtouchesTpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EtouchesTpointGeo";

    EtouchesTpointGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
