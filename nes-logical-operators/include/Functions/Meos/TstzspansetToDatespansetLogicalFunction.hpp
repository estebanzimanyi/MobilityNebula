...
/**
 * @brief tstzspanset_to_datespanset (SpanSet *) — SpanSet -> SpanSet conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_to_datespanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetToDatespansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetToDatespanset";

    TstzspansetToDatespansetLogicalFunction(LogicalFunction lit);
