...
/**
 * @brief Returns 1.0 if two geographic geometries are within tolerance distance (spheroidal).
 *
 * Args: (wkt1:VARCHAR, wkt2:VARCHAR, tolerance:FLOAT64) -> FLOAT64.
 */
class GeogDwithinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogDwithin";

    GeogDwithinLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2, LogicalFunction tolerance);
