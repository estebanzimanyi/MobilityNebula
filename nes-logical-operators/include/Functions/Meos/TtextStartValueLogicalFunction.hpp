...
/**
 * @brief ttext_start_value (text *) — unary ttext -> text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextStartValue";

    TtextStartValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
