...
/**
 * @brief Always equal tjsonb vs jsonb
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tjsonb_jsonb`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTjsonbJsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
