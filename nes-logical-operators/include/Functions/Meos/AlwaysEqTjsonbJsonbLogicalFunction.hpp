...
/**
 * @brief Returns 1.0 if the tjsonb instant value always equals the target Jsonb.
 */
class AlwaysEqTjsonbJsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTjsonbJsonb";

    AlwaysEqTjsonbJsonbLogicalFunction(LogicalFunction json_str, LogicalFunction ts, LogicalFunction target_json);
