...
/**
 * @brief tfloat_value_n (out-param double, n=1) — tfloat value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatValueN";

    TfloatValueNLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
