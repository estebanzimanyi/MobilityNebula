...
/**
 * @brief type_span_bbox (bool) - whether a MEOS type has a span bounding box.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `type_span_bbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TypeSpanBboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TypeSpanBbox";

    TypeSpanBboxLogicalFunction(LogicalFunction value);
