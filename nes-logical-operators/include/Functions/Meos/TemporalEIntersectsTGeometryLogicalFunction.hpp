...
/**
 * @brief Per-event ever-intersects between two single-instant tgeompoints.
 *
 ...
 */
class TemporalEIntersectsTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEIntersectsTGeometry";

    TemporalEIntersectsTGeometryLogicalFunction(LogicalFunction lonA,
