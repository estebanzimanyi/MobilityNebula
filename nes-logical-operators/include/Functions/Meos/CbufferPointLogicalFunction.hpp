...
/**
 * @brief cbuffer_point (GSERIALIZED *) — unary cbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_point`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferPointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferPoint";

    CbufferPointLogicalFunction(LogicalFunction lit);
