...
/**
 * @brief overright_spanset_float (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_spanset_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightSpansetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightSpansetFloat";

    OverrightSpansetFloatLogicalFunction(LogicalFunction lit,
