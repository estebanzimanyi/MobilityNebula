...
/**
 * @brief intersection_text_set: extern Set *intersection_text_set(const text *txt, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_text_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionTextSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionTextSet";

    IntersectionTextSetLogicalFunction(LogicalFunction lit,
