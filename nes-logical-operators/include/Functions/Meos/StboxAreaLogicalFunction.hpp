...
/**
 * @brief stbox_area (double) — stbox_text accessor (planar flag).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_area`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxAreaLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxArea";

    StboxAreaLogicalFunction(LogicalFunction box);
