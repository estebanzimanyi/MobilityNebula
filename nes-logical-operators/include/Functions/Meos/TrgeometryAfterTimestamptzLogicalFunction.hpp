...
/**
 * @brief trgeometry_after_timestamptz (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_after_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryAfterTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryAfterTimestamptz";

    TrgeometryAfterTimestamptzLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
