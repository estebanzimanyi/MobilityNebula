...
/**
 * @brief floatspanset_ceil (SpanSet *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_ceil`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetCeilLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetCeil";

    FloatspansetCeilLogicalFunction(LogicalFunction lit);
