...
/**
 * @brief Per-event temporal_cmp between two single-instant tgeompoints -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalCmp";

    TemporalCmpLogicalFunction(LogicalFunction lonA,
