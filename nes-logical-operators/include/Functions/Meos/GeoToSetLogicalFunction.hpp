...
/**
 * @brief geo_to_set (Set *) — object -> singleton set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoToSet";

    GeoToSetLogicalFunction(LogicalFunction lit);
