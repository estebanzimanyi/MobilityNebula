...
/**
 * @brief temporal_time_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_time_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalTimeBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalTimeBins";

    TemporalTimeBinsLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
