...
/**
 * @brief tfloat_value_time_boxes (TBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_value_time_boxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatValueTimeBoxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatValueTimeBoxes";

    TfloatValueTimeBoxesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
