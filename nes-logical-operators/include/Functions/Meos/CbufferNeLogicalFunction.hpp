...
/**
 * @brief cbuffer_ne (bool) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferNe";

    CbufferNeLogicalFunction(LogicalFunction lit,
