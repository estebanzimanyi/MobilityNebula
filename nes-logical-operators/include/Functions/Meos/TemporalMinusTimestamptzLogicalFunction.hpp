...
/**
 * @brief temporal_minus_timestamptz (Temporal *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_minus_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMinusTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMinusTimestamptz";

    TemporalMinusTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
