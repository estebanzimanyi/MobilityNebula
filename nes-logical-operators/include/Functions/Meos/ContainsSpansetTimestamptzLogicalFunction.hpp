...
/**
 * @brief contains_spanset_timestamptz (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_spanset_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsSpansetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSpansetTimestamptz";

    ContainsSpansetTimestamptzLogicalFunction(LogicalFunction lit,
