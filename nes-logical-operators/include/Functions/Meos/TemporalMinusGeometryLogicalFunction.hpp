...
/**
 * @brief Per-event spatial subtraction: 1 if the single-instant tgeompoint survives subtraction of the static geometry, 0 if removed.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_minus_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMinusGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMinusGeometry";

    TemporalMinusGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
