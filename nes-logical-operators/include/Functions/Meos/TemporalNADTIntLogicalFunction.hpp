...
/**
 * @brief Per-event nearest-approach distance between two single-instant tints.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tint_tint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalNADTIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTInt";

    TemporalNADTIntLogicalFunction(LogicalFunction valueA,
                                          LogicalFunction tsA,
