...
/**
 * @brief Per-event overleft_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_tspatial_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftTspatialTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftTspatialTspatial";

    OverleftTspatialTspatialLogicalFunction(LogicalFunction lonA,
