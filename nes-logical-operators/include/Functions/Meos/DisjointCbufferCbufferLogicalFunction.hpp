...
/**
 * @brief disjoint_cbuffer_cbuffer (int) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `disjoint_cbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DisjointCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DisjointCbufferCbuffer";

    DisjointCbufferCbufferLogicalFunction(LogicalFunction lit,
