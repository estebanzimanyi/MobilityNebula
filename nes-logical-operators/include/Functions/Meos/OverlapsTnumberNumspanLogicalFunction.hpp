...
/**
 * @brief overlaps_tnumber_numspan (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overlaps_tnumber_numspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverlapsTnumberNumspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverlapsTnumberNumspan";

    OverlapsTnumberNumspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
