...
/**
 * @brief spanset_ge (bool) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_ge`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetGe";

    SpansetGeLogicalFunction(LogicalFunction lit,
