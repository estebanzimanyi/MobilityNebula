...
/**
 * @brief tgeometry_to_tgeompoint (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeometry_to_tgeompoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeometryToTgeompointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeometryToTgeompoint";

    TgeometryToTgeompointLogicalFunction(LogicalFunction geomWkt,
                                          LogicalFunction ts);
