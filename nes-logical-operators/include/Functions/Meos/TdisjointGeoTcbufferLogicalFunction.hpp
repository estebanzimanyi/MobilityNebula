...
/**
 * @brief tdisjoint_geo_tcbuffer (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdisjoint_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdisjointGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdisjointGeoTcbuffer";

    TdisjointGeoTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
