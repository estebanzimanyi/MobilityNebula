 ...
 */
class AlwaysNeTbigintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTbigintTfloat";

    AlwaysNeTbigintTfloatLogicalFunction(LogicalFunction value1,
