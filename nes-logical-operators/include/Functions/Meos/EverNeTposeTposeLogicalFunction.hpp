...
/**
 * @brief Per-event ever_ne_tpose_tpose: two hex-WKB temporal operands -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tpose_tpose`. Per-event scalar operator following the
...
public:
    ...
    EverNeTposeTposeLogicalFunction(LogicalFunction traj,
