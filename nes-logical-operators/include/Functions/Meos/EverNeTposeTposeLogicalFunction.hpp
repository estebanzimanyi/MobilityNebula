...
/**
 * @brief Returns 1.0 if the two 2D tpose instants are ever not equal, 0.0 otherwise.
 *
 * Args: (x1:FLOAT64, y1:FLOAT64, theta1:FLOAT64, ts1:UINT64,
 *        x2:FLOAT64, y2:FLOAT64, theta2:FLOAT64, ts2:UINT64) -> FLOAT64.
 */
class EverNeTposeTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTposeTpose";

    EverNeTposeTposeLogicalFunction(LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1,
                          LogicalFunction ts1,
