...
/**
 * @brief distance_intset_intset (int) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_intset_intset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceIntsetIntsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceIntsetIntset";

    DistanceIntsetIntsetLogicalFunction(LogicalFunction lit,
