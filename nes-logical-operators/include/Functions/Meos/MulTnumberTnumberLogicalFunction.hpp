...
/**
 * @brief Per-event mul_tnumber_tnumber: element-wise multiplication of two single-instant tnumbers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_tnumber_tnumber`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two co-instant temporals, applies the multiplication, and returns FLOAT64.
 */
class MulTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulTnumberTnumber";

    MulTnumberTnumberLogicalFunction(LogicalFunction value1,
