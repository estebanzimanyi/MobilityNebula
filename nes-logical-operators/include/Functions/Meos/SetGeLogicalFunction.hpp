...
/**
 * @brief set_ge (bool) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_ge`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetGe";

    SetGeLogicalFunction(LogicalFunction lit,
