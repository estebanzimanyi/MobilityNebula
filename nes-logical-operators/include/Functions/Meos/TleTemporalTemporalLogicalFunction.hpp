...
/**
 * @brief temporal LE: two single-instant tfloats
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tle_temporal_temporal`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TleTemporalTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TleTemporalTemporal";

    TleTemporalTemporalLogicalFunction(LogicalFunction value,
