...
/**
 * @brief Returns the upper bound of an integer span.
 */
class IntspanUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanUpper";
    IntspanUpperLogicalFunction(LogicalFunction sp);
