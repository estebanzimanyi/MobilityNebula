...
/**
 * @brief contained_numspan_tnumber (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_numspan_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedNumspanTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedNumspanTnumber";

    ContainedNumspanTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
