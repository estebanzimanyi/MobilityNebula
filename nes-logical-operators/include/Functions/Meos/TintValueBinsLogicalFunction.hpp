...
/**
 * @brief tint_value_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_value_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValueBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValueBins";

    TintValueBinsLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
