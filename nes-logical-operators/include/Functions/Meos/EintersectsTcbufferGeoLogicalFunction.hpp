...
/**
 * @brief Returns 1.0 if the tcbuffer ever intersects the static geometry, 0.0 otherwise.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, radius:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class EintersectsTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EintersectsTcbufferGeo";

    EintersectsTcbufferGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
