...
/**
 * @brief tstzspan_expand (Span *) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_expand`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanExpandLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanExpand";

    TstzspanExpandLogicalFunction(LogicalFunction lit,
