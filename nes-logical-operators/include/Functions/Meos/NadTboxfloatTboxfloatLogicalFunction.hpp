...
/**
 * @brief nad_tboxfloat_tboxfloat (double) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tboxfloat_tboxfloat`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTboxfloatTboxfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTboxfloatTboxfloat";

    NadTboxfloatTboxfloatLogicalFunction(LogicalFunction lit,
