...
/**
 * @brief tcbuffer_points (Set *) — unary tcbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_points`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferPointsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferPoints";

    TcbufferPointsLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
