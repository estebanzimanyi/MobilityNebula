...
/**
 * @brief dateset_shift_scale (container, int shift, int width, true, true) -> shifted+scaled dateset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `dateset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatesetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatesetShiftScale";

    DatesetShiftScaleLogicalFunction(LogicalFunction lit,
