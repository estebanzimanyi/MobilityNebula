...
/**
 * @brief Temporal spatial predicate edisjoint_tgeo_geo:
 * (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> float64 (0/1).
 *
 * Generated from the MEOS function `edisjoint_tgeo_geo`.
 * The tgeompoint instant is encoded as lon/lat/timestamp columns; wkt is a
 * static WKT geometry string.
 */
...
public:
    ...
    EdisjointTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
