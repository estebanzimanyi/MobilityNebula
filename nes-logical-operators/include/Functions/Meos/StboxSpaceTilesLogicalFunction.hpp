...
/**
 * @brief stbox_space_tiles (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_space_tiles`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxSpaceTilesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxSpaceTiles";

    StboxSpaceTilesLogicalFunction(LogicalFunction box,
