...
/**
 * @brief same_numspan_tnumber (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `same_numspan_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SameNumspanTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SameNumspanTnumber";

    SameNumspanTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
