...
/**
 * @brief Per-event contains_tnumber_tnumber: two hex-WKB temporal operands -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_tnumber_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsTnumberTnumber";

    ContainsTnumberTnumberLogicalFunction(LogicalFunction traj,
