...
/**
 * @brief geo_cluster_within (GSERIALIZED **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_cluster_within`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoClusterWithinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoClusterWithin";

    GeoClusterWithinLogicalFunction(LogicalFunction lit);
