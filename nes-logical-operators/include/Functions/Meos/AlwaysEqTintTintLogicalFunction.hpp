 ...
 */
class AlwaysEqTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTintTint";

    AlwaysEqTintTintLogicalFunction(LogicalFunction value1,
