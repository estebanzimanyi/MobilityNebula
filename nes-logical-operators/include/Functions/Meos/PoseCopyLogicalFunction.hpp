...
/**
 * @brief pose_copy (Pose *) — unary pose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_copy`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseCopyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseCopy";

    PoseCopyLogicalFunction(LogicalFunction lit);
