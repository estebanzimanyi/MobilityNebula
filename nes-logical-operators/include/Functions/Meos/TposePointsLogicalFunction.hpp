...
/**
 * @brief tpose_points (Set *) — unary tpose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_points`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposePointsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposePoints";

    TposePointsLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
