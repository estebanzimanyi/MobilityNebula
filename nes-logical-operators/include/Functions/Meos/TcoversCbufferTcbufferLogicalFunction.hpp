...
/**
 * @brief tcovers_cbuffer_tcbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcovers_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcoversCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcoversCbufferTcbuffer";

    TcoversCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
