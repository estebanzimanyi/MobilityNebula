...
/**
 * @brief tboxfloat_xmax (out-param double) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tboxfloat_xmax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxfloatXmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxfloatXmax";

    TboxfloatXmaxLogicalFunction(LogicalFunction lit);
