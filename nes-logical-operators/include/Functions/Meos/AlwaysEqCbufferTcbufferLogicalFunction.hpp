...
/**
 * @brief always_eq_cbuffer_tcbuffer (int) — always/ever tcbuffer ⊗ Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AlwaysEqCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqCbufferTcbuffer";

    AlwaysEqCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
