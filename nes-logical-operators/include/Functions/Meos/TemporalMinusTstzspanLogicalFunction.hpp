...
/**
 * @brief temporal_minus_tstzspan (Temporal *) — tint restricted by a tstzspan box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_minus_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMinusTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMinusTstzspan";

    TemporalMinusTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
