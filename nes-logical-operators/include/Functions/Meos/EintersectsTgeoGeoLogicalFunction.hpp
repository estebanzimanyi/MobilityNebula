...
/**
 * @brief Returns 1.0 if temporal geometry ever intersects the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class EintersectsTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EintersectsTgeoGeo";

    EintersectsTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
