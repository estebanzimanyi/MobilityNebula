...
/**
 * @brief Per-event nearest-approach distance between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalNADTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTCbufferTCbuffer";

    TemporalNADTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
