...
/**
 * @brief intspanset_to_floatspanset (SpanSet *) — SpanSet -> SpanSet conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspanset_to_floatspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspansetToFloatspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspansetToFloatspanset";

    IntspansetToFloatspansetLogicalFunction(LogicalFunction lit);
