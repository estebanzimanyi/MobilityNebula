...
/**
 * @brief stbox_transform_pipeline (STBox *) — PROJ-pipeline transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_transform_pipeline`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxTransformPipelineLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxTransformPipeline";

    StboxTransformPipelineLogicalFunction(LogicalFunction box);
