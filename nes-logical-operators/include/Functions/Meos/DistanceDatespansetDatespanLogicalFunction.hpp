...
/**
 * @brief distance_datespanset_datespan (int) — SpanSet/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_datespanset_datespan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceDatespansetDatespanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceDatespansetDatespan";

    DistanceDatespansetDatespanLogicalFunction(LogicalFunction lit,
