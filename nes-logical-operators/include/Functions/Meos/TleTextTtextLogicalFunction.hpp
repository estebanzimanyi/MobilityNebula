...
/**
 * @brief tle_text_ttext (Temporal *) — temporal ttext ⊗ text -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tle_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    TleTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
