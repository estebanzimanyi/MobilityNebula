...
/**
 * @brief Per-event stbox_eq: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_eq`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxEq";

    StboxEqLogicalFunction(LogicalFunction box,
