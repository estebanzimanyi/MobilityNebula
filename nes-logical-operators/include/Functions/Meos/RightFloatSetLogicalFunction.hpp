...
/**
 * @brief right_float_set (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_float_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightFloatSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightFloatSet";

    RightFloatSetLogicalFunction(LogicalFunction lit,
