...
/**
 * @brief tnpoint_at_npoint (Temporal *) — tnpoint restriction by Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_at_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointAtNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointAtNpoint";

    TnpointAtNpointLogicalFunction(LogicalFunction rid,
