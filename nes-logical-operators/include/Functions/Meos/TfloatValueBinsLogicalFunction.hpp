...
/**
 * @brief tfloat_value_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_value_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatValueBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatValueBins";

    TfloatValueBinsLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
