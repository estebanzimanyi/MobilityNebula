...
/**
 * @brief distance_pose_stbox (double) — Pose ⊗ STBox distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_pose_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistancePoseStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistancePoseStbox";

    DistancePoseStboxLogicalFunction(LogicalFunction lit,
