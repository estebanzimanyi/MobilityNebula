...
/**
 * @brief Per-event mul_tbigint_bigint: multiplies a single-instant tbigint value by a constant int64.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_tbigint_bigint`. Takes (value:FLOAT64, ts:UINT64, factor:FLOAT64→int64),
 * constructs a single-instant temporal, applies the multiplication, and returns FLOAT64.
 */
class MulTbigintBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulTbigintBigint";

    MulTbigintBigintLogicalFunction(LogicalFunction value,
                                    LogicalFunction ts,
