...
/**
 * @brief intersection_timestamptz_set: extern Set *intersection_timestamptz_set(TimestampTz t, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_timestamptz_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionTimestamptzSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionTimestamptzSet";

    IntersectionTimestamptzSetLogicalFunction(LogicalFunction lit,
