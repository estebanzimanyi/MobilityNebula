...
/**
 * @brief nai_tpose_tpose (TInstant *) — two tpose instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tpose_tpose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTposeTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTposeTpose";

    NaiTposeTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
