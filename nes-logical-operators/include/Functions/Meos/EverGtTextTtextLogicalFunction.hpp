...
/**
 * @brief Ever gtqual text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_gt_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    EverGtTextTtextLogicalFunction(LogicalFunction arg0,
