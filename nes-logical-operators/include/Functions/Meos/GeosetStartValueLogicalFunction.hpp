...
/**
 * @brief geoset_start_value (GSERIALIZED *) — unary geoset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geoset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeosetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeosetStartValue";

    GeosetStartValueLogicalFunction(LogicalFunction lit);
