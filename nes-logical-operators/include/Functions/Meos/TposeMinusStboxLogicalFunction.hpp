...
/**
 * @brief tpose_minus_stbox (Temporal *) — tpose restriction by STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_minus_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeMinusStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeMinusStbox";

    TposeMinusStboxLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
