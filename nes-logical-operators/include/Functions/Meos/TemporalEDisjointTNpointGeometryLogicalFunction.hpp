...
/**
 * @brief Per-event ever-disjoint between a single-instant tgeompoint resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint and a static geometry (network SRID).
 *
 ...
 */
class TemporalEDisjointTNpointGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointTNpointGeometry";

    TemporalEDisjointTNpointGeometryLogicalFunction(LogicalFunction rid,
