...
/**
 * @brief Per-event always comparison of a single-instant tint (built from value+timestamp) against a scalar constant.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ge_tint_int`. Per-event scalar operator following the
