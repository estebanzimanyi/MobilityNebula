...
/**
 * @brief Returns the number of sub-geometries in a geometry collection.
 *
 * Args: (wkt:VARCHAR) -> FLOAT64.
 */
class GeoNumGeosLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoNumGeos";

    explicit GeoNumGeosLogicalFunction(LogicalFunction wkt);
