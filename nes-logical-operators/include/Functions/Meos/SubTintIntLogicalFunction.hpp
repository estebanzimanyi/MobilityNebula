...
/**
 * @brief Per-event sub_tint_int: subtracts a constant integer from a single-instant tint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_tint_int`. Takes (value:FLOAT64, ts:UINT64, subtrahend:FLOAT64→int),
 * constructs a single-instant temporal, applies the subtraction, and returns FLOAT64.
 */
class SubTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SubTintInt";

    SubTintIntLogicalFunction(LogicalFunction value,
                              LogicalFunction ts,
