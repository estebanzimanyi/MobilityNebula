...
/**
 * @brief temporal_delete_timestamptz (Temporal *) — tfloat restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_delete_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalDeleteTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalDeleteTimestamptz";

    TemporalDeleteTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
