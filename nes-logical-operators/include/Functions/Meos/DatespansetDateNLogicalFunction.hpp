...
/**
 * @brief datespanset_date_n (out-param DateADT, n=1) — datespanset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_date_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetDateNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetDateN";

    DatespansetDateNLogicalFunction(LogicalFunction lit);
