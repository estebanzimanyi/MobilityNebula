...
class EverNeTextTtextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTextTtext";

    EverNeTextTtextLogicalFunction(LogicalFunction value, LogicalFunction ref, LogicalFunction ts);
