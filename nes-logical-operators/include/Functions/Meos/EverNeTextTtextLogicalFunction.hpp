...
/**
 * @brief Ever nequal text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    EverNeTextTtextLogicalFunction(LogicalFunction arg0,
