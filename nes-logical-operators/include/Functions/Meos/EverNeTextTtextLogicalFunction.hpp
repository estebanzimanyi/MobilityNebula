...
/**
 * @brief ever_ne_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    EverNeTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
