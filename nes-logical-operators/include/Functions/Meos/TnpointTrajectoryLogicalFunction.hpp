...
/**
 * @brief tnpoint_trajectory (GSERIALIZED *) — unary tnpoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_trajectory`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointTrajectoryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointTrajectory";

    TnpointTrajectoryLogicalFunction(LogicalFunction rid,
