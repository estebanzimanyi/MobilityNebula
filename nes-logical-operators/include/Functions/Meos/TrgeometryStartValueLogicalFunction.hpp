...
/**
 * @brief trgeometry_start_value (GSERIALIZED *) — unary trgeometry accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryStartValue";

    TrgeometryStartValueLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
