...
/**
 * @brief ttouches_geo_tcbuffer (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttouches_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtouchesGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtouchesGeoTcbuffer";

    TtouchesGeoTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
