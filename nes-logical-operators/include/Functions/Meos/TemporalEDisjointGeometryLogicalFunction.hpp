...
/**
 * @brief Per-event ever-disjoint between a single-instant tgeompoint built from event fields and a static geometry.
 *
 ...
 */
class TemporalEDisjointGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointGeometry";

    TemporalEDisjointGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
