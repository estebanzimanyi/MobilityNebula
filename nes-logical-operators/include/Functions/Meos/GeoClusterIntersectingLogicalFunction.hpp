...
/**
 * @brief geo_cluster_intersecting (GSERIALIZED **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_cluster_intersecting`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoClusterIntersectingLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoClusterIntersecting";

    GeoClusterIntersectingLogicalFunction(LogicalFunction lit);
