...
/**
 * @brief stbox_quad_split (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_quad_split`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxQuadSplitLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxQuadSplit";

    StboxQuadSplitLogicalFunction(LogicalFunction box);
