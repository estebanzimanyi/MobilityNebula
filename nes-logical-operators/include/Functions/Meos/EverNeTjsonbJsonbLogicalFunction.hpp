...
/**
 * @brief Returns 1.0 if the tjsonb instant value ever differs from the target Jsonb.
 */
class EverNeTjsonbJsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTjsonbJsonb";

    EverNeTjsonbJsonbLogicalFunction(LogicalFunction json_str, LogicalFunction ts, LogicalFunction target_json);
