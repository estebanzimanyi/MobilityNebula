...
/**
 * @brief Per-event tcovers_tgeo_tgeo: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcovers_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcoversTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcoversTgeoTgeo";

    TcoversTgeoTgeoLogicalFunction(LogicalFunction traj,
