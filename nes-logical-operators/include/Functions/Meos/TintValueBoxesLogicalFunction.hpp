...
/**
 * @brief tint_value_boxes (TBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_value_boxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValueBoxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValueBoxes";

    TintValueBoxesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
