...
class AlwaysEqTtextTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTtextText";

    AlwaysEqTtextTextLogicalFunction(LogicalFunction value, LogicalFunction ref, LogicalFunction ts);
