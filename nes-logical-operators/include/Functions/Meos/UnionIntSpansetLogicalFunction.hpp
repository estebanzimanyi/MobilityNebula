...
/**
 * @brief union_int_spanset (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_int_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionIntSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionIntSpanset";

    UnionIntSpansetLogicalFunction(LogicalFunction lit,
