...
/**
 * @brief tbox_to_floatspan (Span *) — TBox -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_to_floatspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxToFloatspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxToFloatspan";

    TboxToFloatspanLogicalFunction(LogicalFunction lit);
