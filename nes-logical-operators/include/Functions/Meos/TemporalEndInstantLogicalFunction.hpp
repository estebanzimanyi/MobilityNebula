...
/**
 * @brief temporal_end_instant (TInstant *) — unary tfloat accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_end_instant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEndInstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEndInstant";

    TemporalEndInstantLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
