...
/**
 * @brief temporal GT: scalar float vs single-instant tfloat
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgt_float_tfloat`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TgtFloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgtFloatTfloat";

    TgtFloatTfloatLogicalFunction(LogicalFunction value,
