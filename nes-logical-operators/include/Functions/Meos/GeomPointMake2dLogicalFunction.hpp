...
/**
 * @brief Constructs a 2D geometry point from SRID, x, and y as WKT.
 */
class GeomPointMake2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomPointMake2d";

    GeomPointMake2dLogicalFunction(LogicalFunction srid, LogicalFunction x, LogicalFunction y);
