...
/**
 * @brief Make 2D geometry point
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geompoint_make2d((int32_t)srid, x, y)`. Per-event scalar operator following the
...
public:
    ...
    GeomPointMake2dLogicalFunction(LogicalFunction srid,
                                          LogicalFunction x,
                                          LogicalFunction y);
