...
/**
 * @brief Tests equality of two JSONB values.
 */
class JsonbEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbEq";
    JsonbEqLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
