...
/**
 * @brief nsegment_cmp (int) — Nsegment scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentCmp";

    NsegmentCmpLogicalFunction(LogicalFunction lit,
