...
/**
 * @brief tgeogpoint_to_tgeography (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeogpoint_to_tgeography`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeogpointToTgeographyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeogpointToTgeography";

    TgeogpointToTgeographyLogicalFunction(LogicalFunction geomWkt,
                                          LogicalFunction ts);
