...
/**
 * @brief float_get_bin (double) — arity-3 double op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_get_bin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatGetBinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatGetBin";

    FloatGetBinLogicalFunction(LogicalFunction value,
