...
/**
 * @brief Returns the number of elements in the outermost JSONB array.
 */
class JsonbArrayLengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbArrayLength";
    JsonbArrayLengthLogicalFunction(LogicalFunction jb);
