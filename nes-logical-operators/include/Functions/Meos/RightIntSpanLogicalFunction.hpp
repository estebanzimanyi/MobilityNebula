...
/**
 * @brief right_int_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_int_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightIntSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightIntSpan";

    RightIntSpanLogicalFunction(LogicalFunction lit,
