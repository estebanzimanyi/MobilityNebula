...
/**
 * @brief tpose_rotation (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_rotation`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeRotationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeRotation";

    TposeRotationLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
