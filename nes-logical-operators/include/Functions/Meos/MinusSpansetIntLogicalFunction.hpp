...
/**
 * @brief minus_spanset_int (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_spanset_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpansetIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpansetInt";

    MinusSpansetIntLogicalFunction(LogicalFunction lit,
