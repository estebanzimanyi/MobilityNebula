...
/**
 * @brief Per-event nearest-approach distance between two single-instant tgeompoints, each resolved from a tpose via tpose_to_tpoint.
 *
 ...
 */
class TemporalNADTPoseTPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTPoseTPose";

    TemporalNADTPoseTPoseLogicalFunction(LogicalFunction xA,
                                          LogicalFunction yA,
