...
/**
 * @brief stbox_hast (bool) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_hast`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxHastLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxHast";

    StboxHastLogicalFunction(LogicalFunction box);
