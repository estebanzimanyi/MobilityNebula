...
/**
 * @brief always_eq_geo_trgeometry (int) — temporal trgeometry ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_geo_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqGeoTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
