...
/**
 * @brief Returns 1.0 if the static geometry is always equal to the 2D trgeometry instant.
 */
class AlwaysEqGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqGeoTrgeometry";

    AlwaysEqGeoTrgeometryLogicalFunction(LogicalFunction tgt_wkt, LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts);
