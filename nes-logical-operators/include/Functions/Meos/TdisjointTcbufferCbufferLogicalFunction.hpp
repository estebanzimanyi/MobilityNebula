...
/**
 * @brief tdisjoint_tcbuffer_cbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdisjoint_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdisjointTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdisjointTcbufferCbuffer";

    TdisjointTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
