...
/**
 * @brief Per-event ttext_lower: single-instant ttext transform -> varchar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_lower`. Per-event scalar operator; returns the transformed text value.
 */
class TtextLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextLower";

    TtextLowerLogicalFunction(LogicalFunction value,
                         LogicalFunction ts);
