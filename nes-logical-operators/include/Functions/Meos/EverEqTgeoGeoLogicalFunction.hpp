...
/**
 * @brief Returns 1.0 if the temporal geometry is ever equal to the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class EverEqTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTgeoGeo";

    EverEqTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
