...
/**
 * @brief Per-event ever_eq_tgeo_geo between a single-instant tgeompoint and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_tgeo_geo`. Per-event scalar operator following the
...
public:
    ...
    EverEqTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
