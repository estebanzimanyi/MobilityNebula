...
/**
 * @brief Returns the H3 cell index (hex string) for a point at the given resolution.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, resolution:UINT64) -> VARCHAR.
 */
class H3GsPointToCellLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3GsPointToCell";

    H3GsPointToCellLogicalFunction(LogicalFunction lon, LogicalFunction lat, LogicalFunction resolution);
