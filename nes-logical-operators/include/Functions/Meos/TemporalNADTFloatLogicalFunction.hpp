...
/**
 * @brief Per-event nearest-approach distance between two single-instant tfloats.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tfloat_tfloat`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalNADTFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTFloat";

    TemporalNADTFloatLogicalFunction(LogicalFunction valueA,
                                          LogicalFunction tsA,
