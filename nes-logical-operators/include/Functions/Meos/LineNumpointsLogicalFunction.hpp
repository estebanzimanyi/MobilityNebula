...
/**
 * @brief Returns the number of points in a linestring.
 */
class LineNumpointsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LineNumpoints";

    LineNumpointsLogicalFunction(LogicalFunction wkt);
