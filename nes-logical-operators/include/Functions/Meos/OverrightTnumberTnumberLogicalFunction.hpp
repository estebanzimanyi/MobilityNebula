...
/**
 * @brief Per-event overright_tnumber_tnumber: two hex-WKB temporal operands -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_tnumber_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightTnumberTnumber";

    OverrightTnumberTnumberLogicalFunction(LogicalFunction traj,
