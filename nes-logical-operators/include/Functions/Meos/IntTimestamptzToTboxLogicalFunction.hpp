...
/**
 * @brief int_timestamptz_to_tbox (TBox *) — int + TimestampTz -> TBox constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int_timestamptz_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntTimestamptzToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntTimestamptzToTbox";

    IntTimestamptzToTboxLogicalFunction(LogicalFunction value,
