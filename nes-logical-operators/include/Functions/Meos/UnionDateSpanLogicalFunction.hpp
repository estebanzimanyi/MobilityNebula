...
/**
 * @brief union_date_span: extern SpanSet *union_date_span(const Span *s, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_date_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionDateSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionDateSpan";

    UnionDateSpanLogicalFunction(LogicalFunction lit,
