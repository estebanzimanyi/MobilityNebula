...
/**
 * @brief tpose_trajectory (GSERIALIZED *) — unary tpose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_trajectory`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeTrajectoryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeTrajectory";

    TposeTrajectoryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
