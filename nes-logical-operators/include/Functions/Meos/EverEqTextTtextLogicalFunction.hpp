...
/**
 * @brief Ever eqqual text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    EverEqTextTtextLogicalFunction(LogicalFunction arg0,
