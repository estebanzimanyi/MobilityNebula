...
/**
 * @brief Per-event always_le_bigint_tbigint: tests if a single-instant tfloat value ever equals a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_le_bigint_tbigint`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysLeBigintTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysLeBigintTbigint";

    AlwaysLeBigintTbigintLogicalFunction(LogicalFunction value,
