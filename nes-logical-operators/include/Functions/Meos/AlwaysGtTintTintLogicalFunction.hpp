...
/**
 * @brief Per-event always_gt_tint_tfloat: tests if two single-instant tint values are always greater than.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_gt_tint_tfloat`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two single-instant temporals, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysGtTintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysGtTintTfloat";

    AlwaysGtTintTfloatLogicalFunction(LogicalFunction value1,
