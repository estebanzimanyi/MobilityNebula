 ...
 */
class AlwaysGtTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysGtTintTint";

    AlwaysGtTintTintLogicalFunction(LogicalFunction value1,
