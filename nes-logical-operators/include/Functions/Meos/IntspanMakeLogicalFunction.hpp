...
/**
 * @brief Construct an integer span from bounds and inclusivity flags.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `({Span* _sp=intspan_make((int)lower,(int)upper,lower_inc!=0.0,upper_inc!=0.0);if(!_sp)return 0u;char* _out=intspan_out(_sp);free(_sp);_out;})`. Per-event scalar operator following the
...
public:
    ...
    IntspanMakeLogicalFunction(LogicalFunction lower,
