...
/**
 * @brief Creates an integer span from bounds and inclusivity flags.
 */
class IntspanMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanMake";
    IntspanMakeLogicalFunction(LogicalFunction lower, LogicalFunction upper, LogicalFunction lower_inc, LogicalFunction upper_inc);
