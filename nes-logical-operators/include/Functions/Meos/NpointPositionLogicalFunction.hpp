...
/**
 * @brief npoint_position (double) — unary npoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_position`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointPositionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointPosition";

    NpointPositionLogicalFunction(LogicalFunction lit);
