...
/**
 * @brief Always ltqual text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_lt_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysLtTextTtextLogicalFunction(LogicalFunction arg0,
