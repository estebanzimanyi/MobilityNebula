...
/**
 * @brief always_lt_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_lt_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    AlwaysLtTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
