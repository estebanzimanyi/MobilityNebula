...
/**
 * @brief Tests if JSONB value jb1 is less than jb2.
 */
class JsonbLtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbLt";
    JsonbLtLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
