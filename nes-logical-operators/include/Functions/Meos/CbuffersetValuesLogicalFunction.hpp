...
/**
 * @brief cbufferset_values (Cbuffer **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbufferset_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbuffersetValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbuffersetValues";

    CbuffersetValuesLogicalFunction(LogicalFunction lit);
