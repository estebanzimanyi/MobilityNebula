...
/**
 * @brief Per-event ever-disjoint between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edisjoint_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEDisjointTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointTCbuffer";

    TemporalEDisjointTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
