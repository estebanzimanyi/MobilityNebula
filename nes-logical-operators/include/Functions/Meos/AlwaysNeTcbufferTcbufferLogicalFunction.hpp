...
/**
 * @brief Per-event always_ne_tcbuffer_tcbuffer between two single-instant tcbuffers -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tcbuffer_tcbuffer`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
