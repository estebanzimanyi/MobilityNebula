...
/**
 * @brief floatspan_round (Span *) — round floatspan to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanRound";

    FloatspanRoundLogicalFunction(LogicalFunction lit);
