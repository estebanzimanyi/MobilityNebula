...
/**
 * @brief Per-event tint_to_tbigint: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_to_tbigint`. Per-event scalar operator following the
...
public:
    ...
    TintToTbigintLogicalFunction(LogicalFunction traj);
