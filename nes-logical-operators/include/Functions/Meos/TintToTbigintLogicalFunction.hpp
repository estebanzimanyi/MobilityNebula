...
/**
 * @brief Per-event tint_to_tbigint: converts a single-instant tint to tbigint, returns FLOAT64.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_to_tbigint`. Takes (value:FLOAT64, ts:UINT64), constructs a single-instant
 * temporal integer, widens to bigint, and returns FLOAT64.
 */
class TintToTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintToTbigint";

    TintToTbigintLogicalFunction(LogicalFunction value,
                                 LogicalFunction ts);
