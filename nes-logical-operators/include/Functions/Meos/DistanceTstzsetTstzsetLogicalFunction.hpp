...
/**
 * @brief distance_tstzset_tstzset (double) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_tstzset_tstzset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceTstzsetTstzsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceTstzsetTstzset";

    DistanceTstzsetTstzsetLogicalFunction(LogicalFunction lit,
