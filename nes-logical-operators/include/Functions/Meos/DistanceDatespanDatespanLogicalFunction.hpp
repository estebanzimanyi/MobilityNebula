...
/**
 * @brief distance_datespan_datespan (int) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_datespan_datespan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceDatespanDatespanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceDatespanDatespan";

    DistanceDatespanDatespanLogicalFunction(LogicalFunction lit,
