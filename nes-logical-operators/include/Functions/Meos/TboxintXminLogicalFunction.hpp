...
/**
 * @brief tboxint_xmin (out-param int) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tboxint_xmin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxintXminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxintXmin";

    TboxintXminLogicalFunction(LogicalFunction lit);
