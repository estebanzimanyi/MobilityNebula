...
/**
 * @brief Per-event e-touches between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `etouches_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalETouchesTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalETouchesTCbufferCbuffer";

    TemporalETouchesTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
