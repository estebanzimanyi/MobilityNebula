...
/**
 * @brief ttext_min_value (text *) — unary ttext -> text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_min_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextMinValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextMinValue";

    TtextMinValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
