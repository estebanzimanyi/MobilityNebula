...
/**
 * @brief Per-event ever-dwithin between a tgeompoint resolved from a tpose (x,y,theta,ts) via tpose_to_tgeompoint and a static geometry, within a distance.
 *
 ...
 */
class TemporalEDWithinTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTPoseGeometry";

    TemporalEDWithinTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
