...
/**
 * @brief Per-event trgeometry_to_tgeometry: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_to_tgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryToTgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryToTgeometry";

    TrgeometryToTgeometryLogicalFunction(LogicalFunction traj);
