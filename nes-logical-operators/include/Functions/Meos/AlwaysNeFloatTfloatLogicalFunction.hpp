...
/**
 * @brief Per-event always comparison of a scalar constant against a single-instant tfloat (built from value+timestamp); scalar-first MEOS arg order.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_float_tfloat`. Per-event scalar operator following the
