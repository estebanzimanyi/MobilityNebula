...
/**
 * @brief spanset_start_span (Span *) — unary floatspanset -> Span.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_start_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetStartSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetStartSpan";

    SpansetStartSpanLogicalFunction(LogicalFunction lit);
