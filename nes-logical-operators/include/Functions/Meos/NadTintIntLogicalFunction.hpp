 ...
 */
class NadTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTintInt";

    NadTintIntLogicalFunction(LogicalFunction value,
