...
/**
 * @brief tpose_end_value (Pose *) — unary tpose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeEndValue";

    TposeEndValueLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
