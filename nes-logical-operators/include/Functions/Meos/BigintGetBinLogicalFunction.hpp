...
/**
 * @brief bigint_get_bin (int64) — arity-3 int64 op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigint_get_bin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintGetBinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintGetBin";

    BigintGetBinLogicalFunction(LogicalFunction value,
