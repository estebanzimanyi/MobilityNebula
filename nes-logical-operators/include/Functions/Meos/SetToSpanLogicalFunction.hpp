...
/**
 * @brief set_to_span (Span *) — Set -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_to_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetToSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetToSpan";

    SetToSpanLogicalFunction(LogicalFunction lit);
