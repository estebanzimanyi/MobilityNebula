...
/**
 * @brief Per-event always-touches between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `atouches_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalATouchesTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalATouchesTCbufferTCbuffer";

    TemporalATouchesTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
