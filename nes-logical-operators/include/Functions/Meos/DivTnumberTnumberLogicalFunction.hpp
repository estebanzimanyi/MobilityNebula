...
/**
 * @brief Per-event div_tnumber_tnumber: element-wise division of two single-instant tnumbers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_tnumber_tnumber`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two co-instant temporals, applies the division, and returns FLOAT64.
 */
class DivTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DivTnumberTnumber";

    DivTnumberTnumberLogicalFunction(LogicalFunction value1,
