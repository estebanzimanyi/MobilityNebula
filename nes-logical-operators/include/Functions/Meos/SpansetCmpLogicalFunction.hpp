...
/**
 * @brief spanset_cmp (int) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetCmp";

    SpansetCmpLogicalFunction(LogicalFunction lit,
