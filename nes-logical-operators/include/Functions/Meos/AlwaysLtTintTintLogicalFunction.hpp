 ...
 */
class AlwaysLtTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysLtTintTint";

    AlwaysLtTintTintLogicalFunction(LogicalFunction value1,
