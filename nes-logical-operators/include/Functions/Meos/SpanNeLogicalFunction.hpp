...
/**
 * @brief span_ne (bool) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanNe";

    SpanNeLogicalFunction(LogicalFunction lit,
