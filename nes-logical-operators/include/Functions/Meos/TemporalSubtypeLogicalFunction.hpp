...
/**
 * @brief temporal_subtype (const char *) - the subtype name of a temporal value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_subtype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSubtypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSubtype";

    TemporalSubtypeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
