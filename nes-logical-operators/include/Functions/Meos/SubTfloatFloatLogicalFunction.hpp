...
/**
 * @brief Per-event sub_tfloat_float: subtracts a constant from a single-instant tfloat value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_tfloat_float`. Takes (value:FLOAT64, ts:UINT64, subtrahend:FLOAT64),
 * constructs a single-instant temporal, applies the subtraction, and returns FLOAT64.
 */
class SubTfloatFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SubTfloatFloat";

    SubTfloatFloatLogicalFunction(LogicalFunction value,
                                  LogicalFunction ts,
