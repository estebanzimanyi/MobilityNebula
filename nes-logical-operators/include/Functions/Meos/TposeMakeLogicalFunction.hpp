...
/**
 * @brief tpose_make (Temporal *) - a temporal pose from a temporal point and a temporal float orientation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeMake";

    TposeMakeLogicalFunction(LogicalFunction traj,
