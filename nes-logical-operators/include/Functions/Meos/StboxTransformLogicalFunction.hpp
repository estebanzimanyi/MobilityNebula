...
/**
 * @brief stbox_transform (STBox *) — SRID set/transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_transform`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxTransformLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxTransform";

    StboxTransformLogicalFunction(LogicalFunction box);
