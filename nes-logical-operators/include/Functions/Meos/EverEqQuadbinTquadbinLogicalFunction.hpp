...
/**
 * @brief Per-event ever_eq_quadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_quadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    EverEqQuadbinTquadbinLogicalFunction(LogicalFunction arg0,
