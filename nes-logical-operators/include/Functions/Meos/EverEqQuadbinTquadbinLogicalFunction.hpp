...
/**
 * @brief Returns 1 if the tquadbin instant ever equals the Quadbin cell.
 */
class EverEqQuadbinTquadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqQuadbinTquadbin";
    EverEqQuadbinTquadbinLogicalFunction(LogicalFunction cell, LogicalFunction inst_cell, LogicalFunction ts);
