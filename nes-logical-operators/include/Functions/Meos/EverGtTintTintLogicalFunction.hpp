 ...
 */
class EverGtTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGtTintTint";

    EverGtTintTintLogicalFunction(LogicalFunction value1,
