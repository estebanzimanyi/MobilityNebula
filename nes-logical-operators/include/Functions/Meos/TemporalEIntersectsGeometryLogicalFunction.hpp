...
/**
 * @brief Per-event ever-intersects between a single-instant tgeompoint and a static geometry.
 *
 ...
 */
class TemporalEIntersectsGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEIntersectsGeometry";

    TemporalEIntersectsGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
