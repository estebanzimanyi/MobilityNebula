...
/**
 * @brief Per-event trgeometry_centroid: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_centroid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryCentroidLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryCentroid";

    TrgeometryCentroidLogicalFunction(LogicalFunction traj);
