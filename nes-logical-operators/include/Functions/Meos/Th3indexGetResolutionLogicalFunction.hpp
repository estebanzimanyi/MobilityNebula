...
/**
 * @brief Th3index th3index get resolution
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_get_resolution(temp)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexGetResolutionLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts);
