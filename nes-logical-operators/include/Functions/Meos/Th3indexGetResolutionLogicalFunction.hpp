...
/**
 * @brief Returns the H3 resolution (0-15) of the cell as FLOAT64.
 *
 * Args: (cell:UINT64, ts:UINT64) -> FLOAT64.
 */
class Th3indexGetResolutionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexGetResolution";

    Th3indexGetResolutionLogicalFunction(LogicalFunction cell, LogicalFunction ts);
