...
/**
 * @brief npoint_hash (uint32) — unary npoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointHash";

    NpointHashLogicalFunction(LogicalFunction lit);
