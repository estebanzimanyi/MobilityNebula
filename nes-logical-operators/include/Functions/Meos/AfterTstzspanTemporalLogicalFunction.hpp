...
/**
 * @brief after_tstzspan_temporal (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterTstzspanTemporal";

    AfterTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
