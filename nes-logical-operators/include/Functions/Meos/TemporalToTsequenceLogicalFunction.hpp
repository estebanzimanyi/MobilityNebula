...
/**
 * @brief temporal_to_tsequence (TSequence *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_to_tsequence`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalToTsequenceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalToTsequence";

    TemporalToTsequenceLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
