...
/**
 * @brief tnumber_at_tbox (Temporal *) — tint restricted by a tbox box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_at_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberAtTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberAtTbox";

    TnumberAtTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
