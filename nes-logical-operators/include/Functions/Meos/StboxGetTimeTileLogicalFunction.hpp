...
/**
 * @brief stbox_get_time_tile (STBox *) — arity-3 stbox_text_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_get_time_tile`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxGetTimeTileLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxGetTimeTile";

    StboxGetTimeTileLogicalFunction(LogicalFunction value,
