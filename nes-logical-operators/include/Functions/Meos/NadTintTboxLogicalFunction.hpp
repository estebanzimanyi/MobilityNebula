...
/**
 * @brief Per-event nad_tint_tbox: single-instant tint against a tbox literal -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tint_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTintTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTintTbox";

    NadTintTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
