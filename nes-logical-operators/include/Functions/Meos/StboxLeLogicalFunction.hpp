...
/**
 * @brief Per-event stbox_le: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_le`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxLeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxLe";

    StboxLeLogicalFunction(LogicalFunction box,
