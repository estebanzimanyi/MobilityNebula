...
/**
 * @brief Per-event always-disjoint between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adisjoint_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalADisjointTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADisjointTCbufferTCbuffer";

    TemporalADisjointTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
