...
/**
 * @brief timestamptz_to_stbox (STBox *) — TimestampTz -> STBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzToStbox";

    TimestamptzToStboxLogicalFunction(LogicalFunction value);
