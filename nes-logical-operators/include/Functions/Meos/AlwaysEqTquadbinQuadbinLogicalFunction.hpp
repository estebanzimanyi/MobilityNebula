...
/**
 * @brief Always equal tquadbin vs quadbin
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tquadbin_quadbin(temp, (Quadbin)arg0)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTquadbinQuadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
