 ...
 */
class AlwaysEqTquadbinQuadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTquadbinQuadbin";
    AlwaysEqTquadbinQuadbinLogicalFunction(LogicalFunction inst_cell, LogicalFunction ts, LogicalFunction cell);
