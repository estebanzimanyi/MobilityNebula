...
/**
 * @brief nad_stbox_geo (double) — STBox ⊗ GSERIALIZED distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_stbox_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadStboxGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadStboxGeo";

    NadStboxGeoLogicalFunction(LogicalFunction box,
