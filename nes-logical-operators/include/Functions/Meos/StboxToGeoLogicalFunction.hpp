...
/**
 * @brief stbox_to_geo (GSERIALIZED *) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_to_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxToGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxToGeo";

    StboxToGeoLogicalFunction(LogicalFunction box);
