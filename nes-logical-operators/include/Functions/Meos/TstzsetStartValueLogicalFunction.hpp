...
/**
 * @brief tstzset_start_value (TimestampTz) — unary tstzset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetStartValue";

    TstzsetStartValueLogicalFunction(LogicalFunction lit);
