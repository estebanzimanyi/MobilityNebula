...
/**
 * @brief Returns 1.0 if the 2D trgeometry instant is always not equal to the static geometry.
 */
class AlwaysNeTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTrgeometryGeo";

    AlwaysNeTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction tgt_wkt);
