...
/**
 * @brief tint_value_n (out-param int, n=1) — tint value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValueN";

    TintValueNLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
