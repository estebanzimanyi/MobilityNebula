...
/**
 * @brief Static geometry function geom_intersects3d: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function `geom_intersects3d`.
 */
class GeomIntersects3dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomIntersects3d";

    GeomIntersects3dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
