...
/**
 * @brief geom_intersects3d (bool) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_intersects3d`. Per-event scalar operator following the
...
public:
    ...
    GeomIntersects3dLogicalFunction(LogicalFunction lit,
