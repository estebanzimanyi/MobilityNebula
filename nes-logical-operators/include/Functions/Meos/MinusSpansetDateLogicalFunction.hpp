...
/**
 * @brief minus_spanset_date: extern SpanSet *minus_spanset_date(const SpanSet *ss, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_spanset_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpansetDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpansetDate";

    MinusSpansetDateLogicalFunction(LogicalFunction lit,
