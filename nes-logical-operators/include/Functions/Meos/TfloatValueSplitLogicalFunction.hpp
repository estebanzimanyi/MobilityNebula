...
/**
 * @brief tfloat_value_split (Temporal **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_value_split`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatValueSplitLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatValueSplit";

    TfloatValueSplitLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
