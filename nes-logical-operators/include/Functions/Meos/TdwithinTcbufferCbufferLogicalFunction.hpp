...
/**
 * @brief tdwithin_tcbuffer_cbuffer (Temporal *) — tcbuffer tdwithin Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdwithin_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdwithinTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdwithinTcbufferCbuffer";

    TdwithinTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
