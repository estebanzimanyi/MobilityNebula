...
/**
 * @brief Quadbin cell to parent
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `quadbin_cell_to_parent((Quadbin)cell, (uint32_t)res)`. Per-event scalar operator following the
...
public:
    ...
    QuadbinCellToParentLogicalFunction(LogicalFunction cell,
                                          LogicalFunction res);
