...
/**
 * @brief Returns a VARCHAR for a quadbin cell. NES token: QUADBIN_CELL_TO_PARENT.
 */
class QuadbinCellToParentLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinCellToParent";

    QuadbinCellToParentLogicalFunction(LogicalFunction cell, LogicalFunction res);
