...
/**
 * @brief Per-event tfloat_to_tint: converts a single-instant tfloat to tint, returns FLOAT64.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_to_tint`. Takes (value:FLOAT64, ts:UINT64), constructs a single-instant
 * temporal float, truncates to integer, and returns FLOAT64.
 */
class TfloatToTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatToTint";

    TfloatToTintLogicalFunction(LogicalFunction value,
                                LogicalFunction ts);
