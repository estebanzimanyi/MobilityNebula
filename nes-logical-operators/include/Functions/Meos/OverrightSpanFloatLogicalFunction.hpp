...
/**
 * @brief overright_span_float (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_span_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightSpanFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightSpanFloat";

    OverrightSpanFloatLogicalFunction(LogicalFunction lit,
