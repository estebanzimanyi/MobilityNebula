...
/**
 * @brief Per-event always-disjoint between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adisjoint_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalADisjointTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADisjointTCbuffer";

    TemporalADisjointTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
