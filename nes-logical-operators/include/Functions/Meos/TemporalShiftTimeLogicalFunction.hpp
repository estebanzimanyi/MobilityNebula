...
/**
 * @brief temporal_shift_time (Temporal *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_shift_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalShiftTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalShiftTime";

    TemporalShiftTimeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
