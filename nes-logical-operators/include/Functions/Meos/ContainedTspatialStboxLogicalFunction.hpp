...
/**
 * @brief Per-event contained_tspatial_stbox: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_tspatial_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTspatialStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTspatialStbox";

    ContainedTspatialStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
