...
/**
 * @brief temporal_at_tstzspanset (Temporal *) — tint restricted by a tstzspanset box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_at_tstzspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAtTstzspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAtTstzspanset";

    TemporalAtTstzspansetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
