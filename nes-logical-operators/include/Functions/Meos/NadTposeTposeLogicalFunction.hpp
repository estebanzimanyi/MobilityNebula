...
/**
 * @brief Per-event nad_tpose_tpose: two hex-WKB temporal operands -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tpose_tpose`. Per-event scalar operator following the
...
public:
    ...
    NadTposeTposeLogicalFunction(LogicalFunction traj,
