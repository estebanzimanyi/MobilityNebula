...
/**
 * @brief Returns the nearest approach distance between two 2D tpose instants.
 *
 * Args: (x1:FLOAT64, y1:FLOAT64, theta1:FLOAT64, ts1:UINT64,
 *        x2:FLOAT64, y2:FLOAT64, theta2:FLOAT64, ts2:UINT64) -> FLOAT64.
 */
class NadTposeTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTposeTpose";

    NadTposeTposeLogicalFunction(LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1,
                          LogicalFunction ts1,
