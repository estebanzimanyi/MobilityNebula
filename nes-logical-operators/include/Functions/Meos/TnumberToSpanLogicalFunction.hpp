...
/**
 * @brief tnumber_to_span (Span *) — Temporal -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_to_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberToSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberToSpan";

    TnumberToSpanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
