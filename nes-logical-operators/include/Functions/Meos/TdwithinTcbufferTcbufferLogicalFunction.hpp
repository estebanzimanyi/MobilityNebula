...
/**
 * @brief tdwithin_tcbuffer_tcbuffer (Temporal *) — two tcbuffer instants tdwithin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdwithin_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdwithinTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdwithinTcbufferTcbuffer";

    TdwithinTcbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
