...
/**
 * @brief intersection_spanset_timestamptz: extern SpanSet *intersection_spanset_timestamptz(const SpanSet *ss, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_spanset_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpansetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpansetTimestamptz";

    IntersectionSpansetTimestamptzLogicalFunction(LogicalFunction lit,
