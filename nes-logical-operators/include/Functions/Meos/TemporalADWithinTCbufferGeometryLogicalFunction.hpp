...
/**
 * @brief Per-event always-distance-within between a single-instant tcbuffer and a static geometry under a fixed threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adwithin_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalADWithinTCbufferGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinTCbufferGeometry";

    TemporalADWithinTCbufferGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
