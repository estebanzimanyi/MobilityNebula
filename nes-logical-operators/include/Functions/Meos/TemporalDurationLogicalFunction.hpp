...
/**
 * @brief temporal_duration (Interval *) — temporal duration.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_duration`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalDurationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalDuration";

    TemporalDurationLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
