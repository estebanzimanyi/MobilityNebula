...
/**
 * @brief span_ge (bool) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_ge`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanGe";

    SpanGeLogicalFunction(LogicalFunction lit,
