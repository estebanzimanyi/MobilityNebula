...
/**
 * @brief bigintspanset_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled bigintspanset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspanset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspansetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspansetShiftScale";

    BigintspansetShiftScaleLogicalFunction(LogicalFunction lit,
