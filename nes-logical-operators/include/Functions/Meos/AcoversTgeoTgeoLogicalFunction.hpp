...
/**
 * @brief Per-event acovers_tgeo_tgeo spatial predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_tgeo_tgeo`. Per-event scalar operator following the
...
public:
    ...
    AcoversTgeoTgeoLogicalFunction(LogicalFunction lonA,
