...
/**
 * @brief datespanset_end_date (DateADT) — unary datespanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_end_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetEndDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetEndDate";

    DatespansetEndDateLogicalFunction(LogicalFunction lit);
