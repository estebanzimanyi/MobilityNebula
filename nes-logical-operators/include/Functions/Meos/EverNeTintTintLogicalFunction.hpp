 ...
 */
class EverNeTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTintTint";

    EverNeTintTintLogicalFunction(LogicalFunction value1,
