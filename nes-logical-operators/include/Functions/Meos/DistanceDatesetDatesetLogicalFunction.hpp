...
/**
 * @brief distance_dateset_dateset (int) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_dateset_dateset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceDatesetDatesetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceDatesetDateset";

    DistanceDatesetDatesetLogicalFunction(LogicalFunction lit,
