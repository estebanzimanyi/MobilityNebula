...
/**
 * @brief intersection_stbox_stbox (STBox *) — STBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_stbox_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionStboxStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionStboxStbox";

    IntersectionStboxStboxLogicalFunction(LogicalFunction box,
