...
/**
 * @brief Per-event always-touches between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `atouches_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalATouchesTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalATouchesTCbuffer";

    TemporalATouchesTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
