...
/**
 * @brief temporal_sequences (TSequence **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_sequences`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSequencesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSequences";

    TemporalSequencesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
