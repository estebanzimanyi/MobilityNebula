...
/**
 * @brief Returns 1 if the trgeometry instant atouches the geometry.
 */
class AtouchesTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AtouchesTrgeometryGeo";
    AtouchesTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1, LogicalFunction tgt_wkt);
