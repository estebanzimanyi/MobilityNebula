...
/**
 * @brief after_timestamptz_set (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_timestamptz_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterTimestamptzSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterTimestamptzSet";

    AfterTimestamptzSetLogicalFunction(LogicalFunction lit,
