...
/**
 * @brief Per-event tgeompoint_to_tnpoint: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeompoint_to_tnpoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeompointToTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeompointToTnpoint";

    TgeompointToTnpointLogicalFunction(LogicalFunction traj);
