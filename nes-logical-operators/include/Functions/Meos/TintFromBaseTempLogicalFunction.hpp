...
/**
 * @brief tint_from_base_temp (Temporal *) — temporal tint ⊗ scalar -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_from_base_temp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintFromBaseTempLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintFromBaseTemp";

    TintFromBaseTempLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
