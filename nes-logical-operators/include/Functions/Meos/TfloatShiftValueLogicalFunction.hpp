...
/**
 * @brief Per-event tfloat_shift_value: shifts the value of a single-instant tfloat by a scalar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_shift_value`. Takes (value:FLOAT64, ts:UINT64, shift:FLOAT64),
 * constructs a single-instant temporal, applies the shift, and returns FLOAT64.
 */
class TfloatShiftValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatShiftValue";

    TfloatShiftValueLogicalFunction(LogicalFunction value,
                                    LogicalFunction ts,
