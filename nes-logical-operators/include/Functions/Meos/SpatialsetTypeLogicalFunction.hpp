...
/**
 * @brief spatialset_type (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spatialset_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpatialsetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpatialsetType";

    SpatialsetTypeLogicalFunction(LogicalFunction lit);
