...
/**
 * @brief adjacent_tbox_tbox (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_tbox_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentTboxTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentTboxTbox";

    AdjacentTboxTboxLogicalFunction(LogicalFunction lit,
