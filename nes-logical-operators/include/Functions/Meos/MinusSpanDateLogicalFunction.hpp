...
/**
 * @brief minus_span_date: extern SpanSet *minus_span_date(const Span *s, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_span_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpanDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpanDate";

    MinusSpanDateLogicalFunction(LogicalFunction lit,
