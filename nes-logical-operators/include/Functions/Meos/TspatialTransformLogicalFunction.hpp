...
/**
 * @brief tspatial_transform (Temporal *) — SRID set/transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tspatial_transform`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TspatialTransformLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TspatialTransform";

    TspatialTransformLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
