...
/**
 * @brief tdistance_tcbuffer_geo (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTcbufferGeo";

    TdistanceTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
