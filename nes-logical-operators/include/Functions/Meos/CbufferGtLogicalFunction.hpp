...
/**
 * @brief cbuffer_gt (bool) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferGt";

    CbufferGtLogicalFunction(LogicalFunction lit,
