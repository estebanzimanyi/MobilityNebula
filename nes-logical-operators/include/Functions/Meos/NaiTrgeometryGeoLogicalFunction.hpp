...
/**
 * @brief nai_trgeometry_geo (TInstant *) — trgeometry nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_trgeometry_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTrgeometryGeo";

    NaiTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
