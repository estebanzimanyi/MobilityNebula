...
/**
 * @brief Tests if a key exists in a JSONB object.
 */
class JsonbExistsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbExists";
    JsonbExistsLogicalFunction(LogicalFunction jb, LogicalFunction key);
