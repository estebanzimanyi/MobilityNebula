...
/**
 * @brief tcontains_cbuffer_tcbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcontains_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcontainsCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcontainsCbufferTcbuffer";

    TcontainsCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
