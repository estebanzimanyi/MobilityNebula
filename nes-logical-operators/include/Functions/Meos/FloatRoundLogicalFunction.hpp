...
/**
 * @brief float_round (double) — round to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatRound";

    FloatRoundLogicalFunction(LogicalFunction value);
