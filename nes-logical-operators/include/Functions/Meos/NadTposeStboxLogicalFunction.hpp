...
/**
 * @brief Per-event nad_tpose_stbox: single-instant tpose against a stbox literal -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tpose_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTposeStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTposeStbox";

    NadTposeStboxLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
