...
/**
 * @brief tfloatbox_shift_scale (TBox *) — arity-3 tbox_text_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloatbox_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatboxShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatboxShiftScale";

    TfloatboxShiftScaleLogicalFunction(LogicalFunction lit,
