...
/**
 * @brief cbuffer_nsame (bool) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_nsame`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferNsameLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferNsame";

    CbufferNsameLogicalFunction(LogicalFunction lit,
