...
/**
 * @brief stbox_perimeter (double) — stbox_text accessor (planar flag).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_perimeter`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxPerimeterLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxPerimeter";

    StboxPerimeterLogicalFunction(LogicalFunction box);
