...
/**
 * @brief Per-event contains_stbox_tspatial: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_stbox_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsStboxTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsStboxTspatial";

    ContainsStboxTspatialLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
