...
/**
 * @brief nsegment_route (int64) — unary nsegment accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_route`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentRouteLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentRoute";

    NsegmentRouteLogicalFunction(LogicalFunction lit);
