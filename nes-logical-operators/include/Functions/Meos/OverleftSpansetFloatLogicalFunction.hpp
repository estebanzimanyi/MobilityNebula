...
/**
 * @brief overleft_spanset_float (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_spanset_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftSpansetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftSpansetFloat";

    OverleftSpansetFloatLogicalFunction(LogicalFunction lit,
