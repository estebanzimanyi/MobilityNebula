...
/**
 * @brief tdwithin_tgeo_tgeo (Temporal *) — two tgeompoint instants tdwithin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdwithin_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdwithinTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdwithinTgeoTgeo";

    TdwithinTgeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
