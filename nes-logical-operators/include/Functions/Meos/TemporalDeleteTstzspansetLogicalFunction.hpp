...
/**
 * @brief temporal_delete_tstzspanset (Temporal *) — tfloat restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_delete_tstzspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalDeleteTstzspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalDeleteTstzspanset";

    TemporalDeleteTstzspansetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
