...
/**
 * @brief Returns 1.0 if the H3 cell is a pentagon cell, 0.0 otherwise.
 *
 * Args: (cell:UINT64, ts:UINT64) -> FLOAT64.
 */
class Th3indexIsPentagonLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexIsPentagon";

    Th3indexIsPentagonLogicalFunction(LogicalFunction cell, LogicalFunction ts);
