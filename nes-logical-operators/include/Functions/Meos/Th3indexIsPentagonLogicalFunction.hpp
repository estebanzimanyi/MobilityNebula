...
/**
 * @brief Th3index th3index is pentagon
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_is_pentagon(temp)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexIsPentagonLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts);
