...
/**
 * @brief Returns the nearest approach distance between two tnpoint instants.
 *
 * Args: (rid1:UINT64, pos1:FLOAT64, ts1:UINT64,
 *        rid2:UINT64, pos2:FLOAT64, ts2:UINT64) -> FLOAT64.
 */
class NadTnpointTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTnpointTnpoint";

    NadTnpointTnpointLogicalFunction(LogicalFunction rid1, LogicalFunction pos1, LogicalFunction ts1,
