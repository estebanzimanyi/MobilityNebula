...
/**
 * @brief Per-event nad_tnpoint_tnpoint: two hex-WKB temporal operands -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tnpoint_tnpoint`. Per-event scalar operator following the
...
public:
    ...
    NadTnpointTnpointLogicalFunction(LogicalFunction traj,
