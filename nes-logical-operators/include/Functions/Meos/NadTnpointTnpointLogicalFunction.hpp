...
/**
 * @brief NAD tnpoint vs tnpoint
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tnpoint_tnpoint(temp, inst0)`. Per-event scalar operator following the
...
public:
    ...
    NadTnpointTnpointLogicalFunction(LogicalFunction rid,
