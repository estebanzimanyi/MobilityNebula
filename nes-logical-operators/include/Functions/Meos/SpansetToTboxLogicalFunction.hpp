...
/**
 * @brief spanset_to_tbox (TBox *) — SpanSet -> TBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetToTbox";

    SpansetToTboxLogicalFunction(LogicalFunction lit);
