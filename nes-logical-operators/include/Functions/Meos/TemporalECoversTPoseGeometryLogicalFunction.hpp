...
/**
 * @brief Per-event ever-covers between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalECoversTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversTPoseGeometry";

    TemporalECoversTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
