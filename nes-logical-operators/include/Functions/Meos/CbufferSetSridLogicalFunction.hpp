...
/**
 * @brief cbuffer_set_srid (Cbuffer *) - the circular buffer with its SRID set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_set_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferSetSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferSetSrid";

    CbufferSetSridLogicalFunction(LogicalFunction lit,
