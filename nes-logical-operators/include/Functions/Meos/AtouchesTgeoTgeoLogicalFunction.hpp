...
/**
 * @brief Tests whether two temporal geometries always touch.
 */
class AtouchesTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AtouchesTgeoTgeo";

    AtouchesTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2);
