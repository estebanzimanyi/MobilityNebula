...
/**
 * @brief npointset_values (Npoint **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npointset_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointsetValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointsetValues";

    NpointsetValuesLogicalFunction(LogicalFunction lit);
