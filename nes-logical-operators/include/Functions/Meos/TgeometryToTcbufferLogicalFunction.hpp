...
/**
 * @brief tgeometry_to_tcbuffer (Temporal *) - the temporal circular buffer of a temporal geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeometry_to_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeometryToTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeometryToTcbuffer";

    TgeometryToTcbufferLogicalFunction(LogicalFunction traj);
