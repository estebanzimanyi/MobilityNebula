...
/**
 * @brief Converts a geography to a geometry as WKT.
 */
class GeogToGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogToGeom";

    GeogToGeomLogicalFunction(LogicalFunction wkt);
