...
/**
 * @brief union_spanset_int (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_spanset_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSpansetIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSpansetInt";

    UnionSpansetIntLogicalFunction(LogicalFunction lit,
