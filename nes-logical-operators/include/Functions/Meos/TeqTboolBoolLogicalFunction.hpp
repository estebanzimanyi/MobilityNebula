...
/**
 * @brief temporal EQ: single-instant tbool vs scalar bool
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `teq_tbool_bool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TeqTboolBoolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TeqTboolBool";

    TeqTboolBoolLogicalFunction(LogicalFunction value,
