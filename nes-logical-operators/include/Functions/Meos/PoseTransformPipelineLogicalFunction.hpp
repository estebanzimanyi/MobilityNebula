...
/**
 * @brief pose_transform_pipeline (Pose *) — PROJ-pipeline transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_transform_pipeline`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseTransformPipelineLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseTransformPipeline";

    PoseTransformPipelineLogicalFunction(LogicalFunction lit);
