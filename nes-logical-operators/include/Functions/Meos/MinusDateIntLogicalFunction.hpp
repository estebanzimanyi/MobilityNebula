...
/**
 * @brief minus_date_int (DateADT) - the date shifted back by a number of days.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_date_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusDateIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusDateInt";

    MinusDateIntLogicalFunction(LogicalFunction value,
