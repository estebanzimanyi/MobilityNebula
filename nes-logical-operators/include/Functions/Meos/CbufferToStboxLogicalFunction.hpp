...
/**
 * @brief cbuffer_to_stbox (STBox *) — Cbuffer -> STBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferToStbox";

    CbufferToStboxLogicalFunction(LogicalFunction lit);
