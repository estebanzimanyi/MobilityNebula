...
/**
 * @brief Per-event teq_bool_tbool: temporal equality of scalar bool and tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `teq_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    TeqBoolTboolLogicalFunction(LogicalFunction arg0,
