...
/**
 * @brief bigintspanset_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspanset_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspansetBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspansetBins";

    BigintspansetBinsLogicalFunction(LogicalFunction lit,
