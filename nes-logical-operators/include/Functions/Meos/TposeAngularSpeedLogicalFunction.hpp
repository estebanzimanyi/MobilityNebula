...
/**
 * @brief Per-event tpose_angular_speed: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_angular_speed`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeAngularSpeedLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeAngularSpeed";

    TposeAngularSpeedLogicalFunction(LogicalFunction traj);
