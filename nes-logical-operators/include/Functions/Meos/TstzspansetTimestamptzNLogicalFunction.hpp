...
/**
 * @brief tstzspanset_timestamptz_n (out-param TimestampTz, n=1) — tstzspanset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_timestamptz_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetTimestamptzNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetTimestamptzN";

    TstzspansetTimestamptzNLogicalFunction(LogicalFunction lit);
