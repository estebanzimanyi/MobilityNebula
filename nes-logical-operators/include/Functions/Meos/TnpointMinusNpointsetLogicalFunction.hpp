...
/**
 * @brief tnpoint_minus_npointset (Temporal *) — tnpoint restriction by Set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_minus_npointset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointMinusNpointsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointMinusNpointset";

    TnpointMinusNpointsetLogicalFunction(LogicalFunction rid,
