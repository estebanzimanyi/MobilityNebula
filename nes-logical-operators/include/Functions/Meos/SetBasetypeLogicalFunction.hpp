...
/**
 * @brief set_basetype (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_basetype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetBasetypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetBasetype";

    SetBasetypeLogicalFunction(LogicalFunction lit);
