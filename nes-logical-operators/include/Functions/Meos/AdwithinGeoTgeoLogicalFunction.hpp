...
/**
 * @brief Per-event adwithin_geo_tgeo: a static geometry within a distance of a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adwithin_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdwithinGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdwithinGeoTgeo";

    AdwithinGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
