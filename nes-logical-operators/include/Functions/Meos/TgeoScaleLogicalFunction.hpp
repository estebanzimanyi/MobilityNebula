...
/**
 * @brief tgeo_scale (Temporal) — scale by (2,2) about origin (0,0).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoScale";

    TgeoScaleLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
