...
/**
 * @brief Always eqqual text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTextTtextLogicalFunction(LogicalFunction arg0,
