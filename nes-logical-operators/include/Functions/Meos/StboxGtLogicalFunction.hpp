...
/**
 * @brief Per-event stbox_gt: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxGt";

    StboxGtLogicalFunction(LogicalFunction box,
