...
/**
 * @brief Per-event overabove_stbox_stbox: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overabove_stbox_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OveraboveStboxStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OveraboveStboxStbox";

    OveraboveStboxStboxLogicalFunction(LogicalFunction box,
