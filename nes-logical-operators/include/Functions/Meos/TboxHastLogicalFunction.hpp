...
/**
 * @brief tbox_hast (bool) — unary tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_hast`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxHastLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxHast";

    TboxHastLogicalFunction(LogicalFunction lit);
