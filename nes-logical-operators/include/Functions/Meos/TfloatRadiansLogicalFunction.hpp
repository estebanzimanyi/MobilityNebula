...
/**
 * @brief Per-event tfloat_radians: single-instant tfloat transform, value extracted -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_radians`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatRadiansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatRadians";

    TfloatRadiansLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
