...
/**
 * @brief Returns a VARCHAR for a quadbin cell. NES token: QUADBIN_CELL_TO_QUADKEY.
 */
class QuadbinCellToQuadkeyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinCellToQuadkey";

    QuadbinCellToQuadkeyLogicalFunction(LogicalFunction cell);
