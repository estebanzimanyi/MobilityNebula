...
/**
 * @brief union_set_bigint (Set *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_set_bigint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSetBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSetBigint";

    UnionSetBigintLogicalFunction(LogicalFunction lit,
