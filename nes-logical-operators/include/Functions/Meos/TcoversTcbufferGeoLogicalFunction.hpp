...
/**
 * @brief tcovers_tcbuffer_geo (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcovers_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcoversTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcoversTcbufferGeo";

    TcoversTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
