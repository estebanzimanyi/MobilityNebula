...
/**
 * @brief intset_values (int *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intset_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntsetValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntsetValues";

    IntsetValuesLogicalFunction(LogicalFunction lit);
