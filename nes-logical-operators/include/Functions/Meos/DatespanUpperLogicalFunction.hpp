...
/**
 * @brief datespan_upper (DateADT) — unary datespan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespan_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespanUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespanUpper";

    DatespanUpperLogicalFunction(LogicalFunction lit);
