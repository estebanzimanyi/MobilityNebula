...
/**
 * @brief Per-event nearest-approach distance between a single-instant tint and a scalar int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tint_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalNADIntScalarLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADIntScalar";

    TemporalNADIntScalarLogicalFunction(LogicalFunction value,
