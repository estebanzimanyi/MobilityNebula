...
/**
 * @brief intspanset_lower (int) — unary intspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspanset_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspansetLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspansetLower";

    IntspansetLowerLogicalFunction(LogicalFunction lit);
