...
/**
 * @brief tgeography_to_tgeogpoint (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeography_to_tgeogpoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeographyToTgeogpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeographyToTgeogpoint";

    TgeographyToTgeogpointLogicalFunction(LogicalFunction geomWkt,
                                          LogicalFunction ts);
