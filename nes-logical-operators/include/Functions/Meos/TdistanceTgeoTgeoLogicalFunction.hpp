...
/**
 * @brief Per-event tdistance_tgeo_tgeo: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTgeoTgeo";

    TdistanceTgeoTgeoLogicalFunction(LogicalFunction traj,
