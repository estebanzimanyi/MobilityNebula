...
/**
 * @brief Per-event temporal_gt between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalGt";

    TemporalGtLogicalFunction(LogicalFunction lonA,
