...
/**
 * @brief ever_gt_ttext_text (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_gt_ttext_text`. Per-event scalar operator following the
...
public:
    ...
    EverGtTtextTextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
