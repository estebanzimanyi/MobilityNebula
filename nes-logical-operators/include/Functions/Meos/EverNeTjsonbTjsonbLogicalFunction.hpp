...
/**
 * @brief Ever neual tjsonb vs tjsonb
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tjsonb_tjsonb`. Per-event scalar operator following the
...
public:
    ...
    EverNeTjsonbTjsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
