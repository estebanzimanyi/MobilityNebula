...
/**
 * @brief Returns 1.0 if the two tjsonb instants are ever not equal.
 */
class EverNeTjsonbTjsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTjsonbTjsonb";

    EverNeTjsonbTjsonbLogicalFunction(LogicalFunction json1, LogicalFunction ts1, LogicalFunction json2, LogicalFunction ts2);
