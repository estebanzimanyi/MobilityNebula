...
/**
 * @brief tstzset_value_n (out-param TimestampTz, n=1) — tstzset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetValueN";

    TstzsetValueNLogicalFunction(LogicalFunction lit);
