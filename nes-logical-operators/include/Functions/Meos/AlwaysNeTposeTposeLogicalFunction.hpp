...
/**
 * @brief Per-event always_ne_tpose_tpose: two hex-WKB temporal operands -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tpose_tpose`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTposeTposeLogicalFunction(LogicalFunction traj,
