...
/**
 * @brief Returns the fractional location (0–1) of the closest point on the line to a point.
 */
class LineLocatePointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LineLocatePoint";

    LineLocatePointLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
