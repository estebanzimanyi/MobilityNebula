...
/**
 * @brief minus_spanset_float (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_spanset_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpansetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpansetFloat";

    MinusSpansetFloatLogicalFunction(LogicalFunction lit,
