...
/**
 * @brief contained_pose_set (bool) — object-set ± pose value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_pose_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedPoseSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedPoseSet";

    ContainedPoseSetLogicalFunction(LogicalFunction lit,
