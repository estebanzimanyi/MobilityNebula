...
/**
 * @brief tstzspanset_upper (TimestampTz) — unary tstzspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetUpper";

    TstzspansetUpperLogicalFunction(LogicalFunction lit);
