...
/**
 * @brief dateset_values (DateADT *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `dateset_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatesetValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatesetValues";

    DatesetValuesLogicalFunction(LogicalFunction lit);
