...
/**
 * @brief Returns the nearest-approach distance between a tpcpoint instant and a geometry.
 */
class NadTpcpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTpcpointGeo";

    NadTpcpointGeoLogicalFunction(LogicalFunction pt_hexwkb, LogicalFunction ts, LogicalFunction tgt_wkt);
