...
/**
 * @brief tstzspanset_to_stbox (STBox *) — SpanSet -> STBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetToStbox";

    TstzspansetToStboxLogicalFunction(LogicalFunction lit);
