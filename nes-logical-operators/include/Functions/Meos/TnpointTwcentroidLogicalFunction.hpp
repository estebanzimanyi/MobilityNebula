...
/**
 * @brief tnpoint_twcentroid (GSERIALIZED *) — unary tnpoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_twcentroid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointTwcentroidLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointTwcentroid";

    TnpointTwcentroidLogicalFunction(LogicalFunction rid,
