...
/**
 * @brief tstzset_tprecision (Set *) — arity-3 tstzset_text op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_tprecision`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetTprecisionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetTprecision";

    TstzsetTprecisionLogicalFunction(LogicalFunction lit,
