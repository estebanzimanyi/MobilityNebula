...
/**
 * @brief npoint_route (int64) — unary npoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_route`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointRouteLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointRoute";

    NpointRouteLogicalFunction(LogicalFunction lit);
