...
/**
 * @brief tbox_ge (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_ge`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxGe";

    TboxGeLogicalFunction(LogicalFunction lit,
