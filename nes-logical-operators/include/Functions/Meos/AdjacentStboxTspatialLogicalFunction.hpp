...
/**
 * @brief Per-event adjacent_stbox_tspatial: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_stbox_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentStboxTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentStboxTspatial";

    AdjacentStboxTspatialLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
