...
/**
 * @brief tpose_start_value (Pose *) — unary tpose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeStartValue";

    TposeStartValueLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
