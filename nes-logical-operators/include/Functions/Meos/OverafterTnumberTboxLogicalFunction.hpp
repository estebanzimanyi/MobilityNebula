...
/**
 * @brief Per-event overafter_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterTnumberTbox";

    OverafterTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
