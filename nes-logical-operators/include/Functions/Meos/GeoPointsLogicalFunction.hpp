...
/**
 * @brief Returns a multi-point geometry of all vertices as WKT.
 */
class GeoPointsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoPoints";

    GeoPointsLogicalFunction(LogicalFunction wkt);
