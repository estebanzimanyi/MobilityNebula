...
class EverLtTtextTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverLtTtextText";

    EverLtTtextTextLogicalFunction(LogicalFunction value, LogicalFunction ref, LogicalFunction ts);
