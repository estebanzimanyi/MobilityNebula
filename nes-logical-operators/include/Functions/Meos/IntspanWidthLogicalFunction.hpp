...
/**
 * @brief Returns the width of an integer span.
 */
class IntspanWidthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanWidth";
    IntspanWidthLogicalFunction(LogicalFunction sp);
