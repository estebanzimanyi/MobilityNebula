...
/**
 * @brief Per-event tcovers_tcbuffer_tcbuffer: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcovers_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcoversTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcoversTcbufferTcbuffer";

    TcoversTcbufferTcbufferLogicalFunction(LogicalFunction traj,
