...
/**
 * @brief Per-event tbigint_shift_value: shifts a single-instant tbigint by a constant int64_t.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbigint_shift_value`. Takes (value:FLOAT64, ts:UINT64, shift:FLOAT64→int64_t),
 * constructs a single-instant temporal, applies the shift, and returns FLOAT64.
 */
class TbigintShiftValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TbigintShiftValue";

    TbigintShiftValueLogicalFunction(LogicalFunction value,
                                     LogicalFunction ts,
