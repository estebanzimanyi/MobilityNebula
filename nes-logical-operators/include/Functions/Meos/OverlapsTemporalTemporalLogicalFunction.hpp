...
/**
 * @brief Per-event overlaps_temporal_temporal between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overlaps_temporal_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverlapsTemporalTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverlapsTemporalTemporal";

    OverlapsTemporalTemporalLogicalFunction(LogicalFunction lonA,
