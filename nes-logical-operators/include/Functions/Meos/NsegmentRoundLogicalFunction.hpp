...
/**
 * @brief nsegment_round (Nsegment *) — round nsegment to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentRound";

    NsegmentRoundLogicalFunction(LogicalFunction lit);
