...
class TgtTextTtextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgtTextTtext";

    TgtTextTtextLogicalFunction(LogicalFunction value, LogicalFunction ref, LogicalFunction ts);
