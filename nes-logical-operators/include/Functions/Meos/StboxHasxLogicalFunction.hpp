...
/**
 * @brief stbox_hasx (bool) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_hasx`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxHasxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxHasx";

    StboxHasxLogicalFunction(LogicalFunction box);
