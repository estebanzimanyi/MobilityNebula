...
/**
 * @brief tdwithin_geo_tgeo (Temporal *) - whether a geometry is within a distance of a temporal geo, over time.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdwithin_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdwithinGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdwithinGeoTgeo";

    TdwithinGeoTgeoLogicalFunction(LogicalFunction lit,
