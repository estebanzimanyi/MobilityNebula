...
/**
 * @brief intspanset_width (SpanSet*, boundspan=false) -> total width of the component spans.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspanset_width`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspansetWidthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspansetWidth";

    IntspansetWidthLogicalFunction(LogicalFunction lit);
