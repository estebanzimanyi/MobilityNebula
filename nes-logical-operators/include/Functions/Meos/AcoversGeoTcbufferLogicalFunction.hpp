...
/**
 * @brief acovers_geo_tcbuffer (int) — temporal tcbuffer ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AcoversGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcoversGeoTcbuffer";

    AcoversGeoTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
