...
/**
 * @brief pose_set_srid (Pose *) - the pose with its SRID set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_set_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseSetSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseSetSrid";

    PoseSetSridLogicalFunction(LogicalFunction lit,
