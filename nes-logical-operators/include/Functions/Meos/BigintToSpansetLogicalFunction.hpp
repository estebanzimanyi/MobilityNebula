...
/**
 * @brief bigint_to_spanset (bigint value) -> spanset (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigint_to_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintToSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintToSpanset";

    BigintToSpansetLogicalFunction(LogicalFunction value);
