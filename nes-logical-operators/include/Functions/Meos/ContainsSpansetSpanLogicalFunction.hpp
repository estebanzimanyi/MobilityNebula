...
/**
 * @brief contains_spanset_span over two text literals (parsed as intspanset/intspan_in); type-generic MEOS topology predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_spanset_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsSpansetSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSpansetSpan";

    ContainsSpansetSpanLogicalFunction(LogicalFunction lit,
