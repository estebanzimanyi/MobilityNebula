...
/**
 * @brief npointset_end_value (Npoint *) — unary npointset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npointset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointsetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointsetEndValue";

    NpointsetEndValueLogicalFunction(LogicalFunction lit);
