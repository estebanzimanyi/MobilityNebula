...
/**
 * @brief union_date_spanset: extern SpanSet *union_date_spanset(DateADT d, SpanSet *ss);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_date_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionDateSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionDateSpanset";

    UnionDateSpansetLogicalFunction(LogicalFunction lit,
