...
/**
 * @brief Tests equality of two Quadbin cell identifiers.
 */
class QuadbinEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinEq";
    QuadbinEqLogicalFunction(LogicalFunction a, LogicalFunction b);
