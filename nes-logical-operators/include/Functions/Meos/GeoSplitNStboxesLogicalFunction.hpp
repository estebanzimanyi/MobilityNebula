...
/**
 * @brief geo_split_n_stboxes (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_split_n_stboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoSplitNStboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoSplitNStboxes";

    GeoSplitNStboxesLogicalFunction(LogicalFunction lit,
