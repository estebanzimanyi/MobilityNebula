...
/**
 * @brief temporal_set_interp (Temporal *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_set_interp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSetInterpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSetInterp";

    TemporalSetInterpLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
