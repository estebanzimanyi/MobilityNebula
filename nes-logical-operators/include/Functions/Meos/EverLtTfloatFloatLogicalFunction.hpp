...
/**
 * @brief Per-event ever comparison of a single-instant tfloat (built from value+timestamp) against a scalar constant.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_lt_tfloat_float`. Per-event scalar operator following the
