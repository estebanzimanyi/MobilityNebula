...
/**
 * @brief spanset_eq (bool) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_eq`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetEq";

    SpansetEqLogicalFunction(LogicalFunction lit,
