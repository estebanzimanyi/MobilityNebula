...
/**
 * @brief Ever equal tjsonb vs tjsonb
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_tjsonb_tjsonb`. Per-event scalar operator following the
...
public:
    ...
    EverEqTjsonbTjsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
