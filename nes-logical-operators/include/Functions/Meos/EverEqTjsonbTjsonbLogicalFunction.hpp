...
/**
 * @brief Returns 1.0 if the two tjsonb instants are ever equal.
 */
class EverEqTjsonbTjsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTjsonbTjsonb";

    EverEqTjsonbTjsonbLogicalFunction(LogicalFunction json1, LogicalFunction ts1, LogicalFunction json2, LogicalFunction ts2);
