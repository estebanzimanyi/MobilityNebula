...
/**
 * @brief Static geometry function geom_distance2d: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function `geom_distance2d`.
 */
class GeomDistance2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomDistance2d";

    GeomDistance2dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
