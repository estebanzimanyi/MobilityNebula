...
/**
 * @brief geom_distance2d (double) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_distance2d`. Per-event scalar operator following the
...
public:
    ...
    GeomDistance2dLogicalFunction(LogicalFunction lit,
