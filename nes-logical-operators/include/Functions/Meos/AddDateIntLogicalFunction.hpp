...
/**
 * @brief add_date_int (DateADT) - the date shifted forward by a number of days.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `add_date_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AddDateIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AddDateInt";

    AddDateIntLogicalFunction(LogicalFunction value,
