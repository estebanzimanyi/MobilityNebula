...
/**
 * @brief cbufferset_end_value (Cbuffer *) — unary cbufferset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbufferset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbuffersetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbuffersetEndValue";

    CbuffersetEndValueLogicalFunction(LogicalFunction lit);
