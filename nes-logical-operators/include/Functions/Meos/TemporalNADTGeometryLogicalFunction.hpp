...
/**
 * @brief Per-event nearest-approach distance between two single-instant tgeompoints.
 *
 ...
 */
class TemporalNADTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTGeometry";

    TemporalNADTGeometryLogicalFunction(LogicalFunction lonA,
