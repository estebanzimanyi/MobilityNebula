...
/**
 * @brief Th3index are neighbor cells
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_are_neighbor_cells(temp, inst0)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexAreNeighborCellsLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
