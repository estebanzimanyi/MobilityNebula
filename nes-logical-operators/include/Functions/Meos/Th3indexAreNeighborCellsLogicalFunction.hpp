...
/**
 * @brief Returns 1.0 if the two H3 cells are neighbors (share an edge), 0.0 otherwise.
 *
 * Args: (cell1:UINT64, ts1:UINT64, cell2:UINT64, ts2:UINT64) -> FLOAT64.
 */
class Th3indexAreNeighborCellsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexAreNeighborCells";

    Th3indexAreNeighborCellsLogicalFunction(LogicalFunction cell1, LogicalFunction ts1,
