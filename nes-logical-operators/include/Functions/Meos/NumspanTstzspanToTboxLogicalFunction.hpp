...
/**
 * @brief numspan_tstzspan_to_tbox (TBox *) — Span + Span -> TBox constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `numspan_tstzspan_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NumspanTstzspanToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NumspanTstzspanToTbox";

    NumspanTstzspanToTboxLogicalFunction(LogicalFunction lit,
