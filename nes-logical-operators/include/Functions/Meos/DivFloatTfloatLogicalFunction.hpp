...
/**
 * @brief Per-event div_float_tfloat: scalar float divided by single-instant tfloat.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_float_tfloat`. Per-event scalar operator following the
...
public:
    ...
    DivFloatTfloatLogicalFunction(LogicalFunction arg0,
