...
/**
 * @brief Per-event div_float_tfloat: divides a constant by a single-instant tfloat value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_float_tfloat`. Takes (scalar:FLOAT64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the division, and returns FLOAT64.
 */
class DivFloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DivFloatTfloat";

    DivFloatTfloatLogicalFunction(LogicalFunction scalar,
