...
/**
 * @brief intspan_to_floatspan (Span *) — Span -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspan_to_floatspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspanToFloatspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanToFloatspan";

    IntspanToFloatspanLogicalFunction(LogicalFunction lit);
