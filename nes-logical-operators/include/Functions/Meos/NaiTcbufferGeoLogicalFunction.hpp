...
/**
 * @brief nai_tcbuffer_geo (TInstant *) — tcbuffer nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTcbufferGeo";

    NaiTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
