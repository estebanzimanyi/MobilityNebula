...
/**
 * @brief left_spanset_bigint (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `left_spanset_bigint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class LeftSpansetBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LeftSpansetBigint";

    LeftSpansetBigintLogicalFunction(LogicalFunction lit,
