...
/**
 * @brief Per-event tcontains_tgeo_tgeo: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcontains_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcontainsTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcontainsTgeoTgeo";

    TcontainsTgeoTgeoLogicalFunction(LogicalFunction traj,
