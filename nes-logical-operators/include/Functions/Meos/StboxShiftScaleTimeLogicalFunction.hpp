...
/**
 * @brief stbox_shift_scale_time (STBox *) — arity-3 stbox_text_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_shift_scale_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxShiftScaleTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxShiftScaleTime";

    StboxShiftScaleTimeLogicalFunction(LogicalFunction box,
