...
/**
 * @brief Converts a JSONB value to its text representation.
 */
class JsonbToCstringLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbToCstring";
    JsonbToCstringLogicalFunction(LogicalFunction jb);
