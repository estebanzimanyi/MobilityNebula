...
/**
 * @brief contains_tnumber_numspan (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_tnumber_numspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsTnumberNumspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsTnumberNumspan";

    ContainsTnumberNumspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
