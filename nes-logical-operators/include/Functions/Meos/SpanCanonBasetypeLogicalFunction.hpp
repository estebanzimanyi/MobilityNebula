...
/**
 * @brief span_canon_basetype (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_canon_basetype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanCanonBasetypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanCanonBasetype";

    SpanCanonBasetypeLogicalFunction(LogicalFunction lit);
