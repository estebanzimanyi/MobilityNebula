 ...
 */
class AlwaysGeTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysGeTintTint";

    AlwaysGeTintTintLogicalFunction(LogicalFunction value1,
