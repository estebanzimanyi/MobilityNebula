...
/**
 * @brief Per-event mul_tint_int: multiplies a single-instant tint value by a constant integer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_tint_int`. Takes (value:FLOAT64, ts:UINT64, multiplier:FLOAT64→int),
 * constructs a single-instant temporal, applies the multiplication, and returns FLOAT64.
 */
class MulTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulTintInt";

    MulTintIntLogicalFunction(LogicalFunction value,
                              LogicalFunction ts,
