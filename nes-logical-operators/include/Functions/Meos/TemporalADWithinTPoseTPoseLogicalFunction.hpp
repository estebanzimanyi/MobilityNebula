...
/**
 * @brief Per-event always-dwithin between two tgeompoints resolved from tposes via tpose_to_tgeompoint, within a distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adwithin_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalADWithinTPoseTPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinTPoseTPose";

    TemporalADWithinTPoseTPoseLogicalFunction(LogicalFunction xA,
                                          LogicalFunction yA,
