...
/**
 * @brief Per-event always-touches between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalATouchesTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalATouchesTNpointTNpoint";

    TemporalATouchesTNpointTNpointLogicalFunction(LogicalFunction ridA,
