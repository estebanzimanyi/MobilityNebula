...
/**
 * @brief tnumber_minus_span (Temporal *) — tint restricted by a span box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_minus_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberMinusSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberMinusSpan";

    TnumberMinusSpanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
