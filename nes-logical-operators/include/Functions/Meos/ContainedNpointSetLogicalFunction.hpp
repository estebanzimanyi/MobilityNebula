...
/**
 * @brief contained_npoint_set (bool) — object-set ± npoint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_npoint_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedNpointSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedNpointSet";

    ContainedNpointSetLogicalFunction(LogicalFunction lit,
