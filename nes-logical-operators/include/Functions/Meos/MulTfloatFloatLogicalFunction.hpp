...
/**
 * @brief Per-event mul_tfloat_float: multiplies a single-instant tfloat value by a constant.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_tfloat_float`. Takes (value:FLOAT64, ts:UINT64, factor:FLOAT64),
 * constructs a single-instant temporal, applies the multiplication, and returns FLOAT64.
 */
class MulTfloatFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulTfloatFloat";

    MulTfloatFloatLogicalFunction(LogicalFunction value,
                                  LogicalFunction ts,
