...
/**
 * @brief stbox_hasz (bool) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_hasz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxHaszLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxHasz";

    StboxHaszLogicalFunction(LogicalFunction box);
