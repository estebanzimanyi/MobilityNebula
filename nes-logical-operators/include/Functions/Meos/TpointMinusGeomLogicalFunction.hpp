...
/**
 * @brief tpoint_minus_geom (Temporal *) — tgeo restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_minus_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointMinusGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointMinusGeom";

    TpointMinusGeomLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
