...
/**
 * @brief tbox_tmin_inc (out-param bool) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_tmin_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxTminIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxTminInc";

    TboxTminIncLogicalFunction(LogicalFunction lit);
