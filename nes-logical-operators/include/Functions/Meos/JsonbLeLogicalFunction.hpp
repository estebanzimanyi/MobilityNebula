...
/**
 * @brief Tests if JSONB value jb1 is less than or equal to jb2.
 */
class JsonbLeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbLe";
    JsonbLeLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
