...
/**
 * @brief textset_lower (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textset_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextsetLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextsetLower";

    TextsetLowerLogicalFunction(LogicalFunction lit);
