...
/**
 * @brief tnpoint_route (int64) — unary tnpoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_route`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointRouteLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointRoute";

    TnpointRouteLogicalFunction(LogicalFunction rid,
