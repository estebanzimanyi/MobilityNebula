...
/**
 * @brief tbox_hash (uint32) — unary tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxHash";

    TboxHashLogicalFunction(LogicalFunction lit);
