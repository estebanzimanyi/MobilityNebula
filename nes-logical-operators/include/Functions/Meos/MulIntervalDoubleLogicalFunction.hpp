...
/**
 * @brief mul_interval_double (Interval *) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_interval_double`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MulIntervalDoubleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulIntervalDouble";

    MulIntervalDoubleLogicalFunction(LogicalFunction lit,
