...
/**
 * @brief Returns 1.0 if the static npoint is ever not equal to the tnpoint instant, 0.0 otherwise.
 */
class EverNeNpointTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeNpointTnpoint";

    EverNeNpointTnpointLogicalFunction(LogicalFunction rid_np, LogicalFunction pos_np, LogicalFunction rid_tp, LogicalFunction pos_tp, LogicalFunction ts);
