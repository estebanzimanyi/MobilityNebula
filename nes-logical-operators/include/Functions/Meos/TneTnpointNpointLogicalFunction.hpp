...
/**
 * @brief tne_tnpoint_npoint (Temporal *) — temporal tnpoint ⊗ Npoint -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_tnpoint_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TneTnpointNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TneTnpointNpoint";

    TneTnpointNpointLogicalFunction(LogicalFunction rid,
