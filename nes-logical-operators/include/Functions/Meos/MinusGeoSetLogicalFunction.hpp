...
/**
 * @brief minus_geo_set (Set *) — object-set ± geo value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_geo_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusGeoSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusGeoSet";

    MinusGeoSetLogicalFunction(LogicalFunction lit,
