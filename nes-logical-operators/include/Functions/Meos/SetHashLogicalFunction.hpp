...
/**
 * @brief set_hash (uint32) — unary intset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetHash";

    SetHashLogicalFunction(LogicalFunction lit);
