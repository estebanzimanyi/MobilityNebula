...
/**
 * @brief tdisjoint_tgeo_tgeo (Temporal *) — two tgeompoint instants -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdisjoint_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdisjointTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdisjointTgeoTgeo";

    TdisjointTgeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
