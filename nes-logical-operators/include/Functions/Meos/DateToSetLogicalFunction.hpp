...
/**
 * @brief date_to_set (date value) -> set (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `date_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DateToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DateToSet";

    DateToSetLogicalFunction(LogicalFunction value);
