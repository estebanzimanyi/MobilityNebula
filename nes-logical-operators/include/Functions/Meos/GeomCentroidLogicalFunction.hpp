...
/**
 * @brief geom_centroid (GSERIALIZED *) — unary geom accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_centroid`. Per-event scalar operator following the
...
public:
    ...
    GeomCentroidLogicalFunction(LogicalFunction lit);
