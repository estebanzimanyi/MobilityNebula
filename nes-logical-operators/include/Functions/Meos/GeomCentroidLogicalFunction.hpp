...
/**
 * @brief Returns the centroid of a geometry as WKT.
 */
class GeomCentroidLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomCentroid";

    GeomCentroidLogicalFunction(LogicalFunction wkt);
