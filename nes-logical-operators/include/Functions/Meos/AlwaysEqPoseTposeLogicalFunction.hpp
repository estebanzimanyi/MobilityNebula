...
/**
 * @brief always_eq_pose_tpose (int) — always/ever tpose ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_pose_tpose`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqPoseTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
