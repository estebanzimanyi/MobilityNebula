...
/**
 * @brief Per-event contained_tnumber_tnumber: two hex-WKB temporal operands -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_tnumber_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTnumberTnumber";

    ContainedTnumberTnumberLogicalFunction(LogicalFunction traj,
