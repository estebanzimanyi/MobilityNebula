...
/**
 * @brief overleft_spanset_spanset over two text literals (parsed as intspanset/intspanset_in); type-generic MEOS topology predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_spanset_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftSpansetSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftSpansetSpanset";

    OverleftSpansetSpansetLogicalFunction(LogicalFunction lit,
