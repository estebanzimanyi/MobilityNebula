...
/**
 * @brief Tests if JSONB jb1 contains jb2.
 */
class JsonbContainsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbContains";
    JsonbContainsLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
