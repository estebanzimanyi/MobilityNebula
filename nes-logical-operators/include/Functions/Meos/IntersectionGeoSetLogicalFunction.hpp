...
/**
 * @brief intersection_geo_set (Set *) — object-set ± geo value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_geo_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionGeoSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionGeoSet";

    IntersectionGeoSetLogicalFunction(LogicalFunction lit,
