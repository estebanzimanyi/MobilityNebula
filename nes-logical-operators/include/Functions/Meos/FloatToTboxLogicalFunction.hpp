...
/**
 * @brief float_to_tbox (TBox *) — double -> TBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatToTbox";

    FloatToTboxLogicalFunction(LogicalFunction value);
