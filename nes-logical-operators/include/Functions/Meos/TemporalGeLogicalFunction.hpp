...
/**
 * @brief Per-event temporal_ge between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_ge`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalGe";

    TemporalGeLogicalFunction(LogicalFunction lonA,
