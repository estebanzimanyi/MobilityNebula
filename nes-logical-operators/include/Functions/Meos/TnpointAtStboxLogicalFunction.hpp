...
/**
 * @brief tnpoint_at_stbox (Temporal *) — tnpoint restriction by STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_at_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointAtStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointAtStbox";

    TnpointAtStboxLogicalFunction(LogicalFunction rid,
