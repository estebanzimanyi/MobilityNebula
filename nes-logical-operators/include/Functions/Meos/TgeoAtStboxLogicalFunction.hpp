...
class TgeoAtStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoAtStbox";

    TgeoAtStboxLogicalFunction(LogicalFunction lon,
                                   LogicalFunction lat,
