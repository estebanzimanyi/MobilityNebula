...
/**
 * @brief npoint_to_stbox (STBox *) — Npoint -> STBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointToStbox";

    NpointToStboxLogicalFunction(LogicalFunction lit);
