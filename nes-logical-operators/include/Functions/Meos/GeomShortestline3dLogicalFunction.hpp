...
/**
 * @brief geom_shortestline3d (GSERIALIZED *) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_shortestline3d`. Per-event scalar operator following the
...
public:
    ...
    GeomShortestline3dLogicalFunction(LogicalFunction lit,
