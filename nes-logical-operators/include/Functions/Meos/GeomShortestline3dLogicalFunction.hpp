...
/**
 * @brief Returns the shortest 3D line between two geometries as WKT.
 */
class GeomShortestline3dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomShortestline3d";

    GeomShortestline3dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
