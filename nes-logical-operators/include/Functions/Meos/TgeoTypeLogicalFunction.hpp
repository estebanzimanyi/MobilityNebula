...
/**
 * @brief tgeo_type (bool) — type-dispatch predicate on a value's temptype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoType";

    TgeoTypeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
