...
/**
 * @brief floatspanset_lower (double) — unary floatspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetLower";

    FloatspansetLowerLogicalFunction(LogicalFunction lit);
