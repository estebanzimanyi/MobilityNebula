...
/**
 * @brief adjacent_tnumber_numspan (tnumber, number span) value topological adjacency -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_tnumber_numspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentTnumberNumspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentTnumberNumspan";

    AdjacentTnumberNumspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
