...
/**
 * @brief Tests if H3 cell index a is less than b.
 */
class H3indexLtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexLt";

    H3indexLtLogicalFunction(LogicalFunction a, LogicalFunction b);
