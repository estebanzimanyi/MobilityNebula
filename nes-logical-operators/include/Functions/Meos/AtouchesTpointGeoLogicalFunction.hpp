...
/**
 * @brief Per-event atouches_tpoint_geo between a single-instant tgeompoint and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `atouches_tpoint_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AtouchesTpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AtouchesTpointGeo";

    AtouchesTpointGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
