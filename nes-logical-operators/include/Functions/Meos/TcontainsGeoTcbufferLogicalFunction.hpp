...
/**
 * @brief tcontains_geo_tcbuffer (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcontains_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcontainsGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcontainsGeoTcbuffer";

    TcontainsGeoTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
