...
/**
 * @brief bigintspanset_upper (int64) — unary bigintspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspanset_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspansetUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspansetUpper";

    BigintspansetUpperLogicalFunction(LogicalFunction lit);
