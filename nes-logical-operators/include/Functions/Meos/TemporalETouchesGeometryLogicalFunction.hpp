...
/**
 * @brief Per-event ever-touches between a single-instant tgeompoint and a static geometry.
 *
 ...
 */
class TemporalETouchesGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalETouchesGeometry";

    TemporalETouchesGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
