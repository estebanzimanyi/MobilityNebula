...
/**
 * @brief intersection_float_set (Set *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_float_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionFloatSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionFloatSet";

    IntersectionFloatSetLogicalFunction(LogicalFunction lit,
