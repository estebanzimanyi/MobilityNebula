...
/**
 * @brief shortestline_tnpoint_geo (GSERIALIZED *) — tnpoint nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tnpoint_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTnpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTnpointGeo";

    ShortestlineTnpointGeoLogicalFunction(LogicalFunction rid,
