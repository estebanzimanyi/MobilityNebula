...
/**
 * @brief Per-event tdistance_tpose_tpose: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tpose_tpose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTposeTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTposeTpose";

    TdistanceTposeTposeLogicalFunction(LogicalFunction traj,
