...
/**
 * @brief distance_cbuffer_stbox (double) — Cbuffer ⊗ STBox distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_cbuffer_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceCbufferStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceCbufferStbox";

    DistanceCbufferStboxLogicalFunction(LogicalFunction lit,
