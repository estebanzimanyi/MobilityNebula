...
/**
 * @brief Make 3D geography point
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geogpoint_make3dz((int32_t)srid, x, y, z)`. Per-event scalar operator following the
...
public:
    ...
    GeogPointMake3dzLogicalFunction(LogicalFunction srid,
                                          LogicalFunction x,
                                          LogicalFunction y,
                                          LogicalFunction z);
