...
/**
 * @brief Constructs a 3DZ geography point from SRID, x, y, and z as WKT.
 */
class GeogPointMake3dzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogPointMake3dz";

    GeogPointMake3dzLogicalFunction(LogicalFunction srid, LogicalFunction x, LogicalFunction y, LogicalFunction z);
