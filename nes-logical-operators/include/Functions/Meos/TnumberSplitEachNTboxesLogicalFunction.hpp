...
/**
 * @brief tnumber_split_each_n_tboxes (TBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_split_each_n_tboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberSplitEachNTboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberSplitEachNTboxes";

    TnumberSplitEachNTboxesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
