...
/**
 * @brief temporal_max_instant (TInstant *) — unary tfloat accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_max_instant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMaxInstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMaxInstant";

    TemporalMaxInstantLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
