...
/**
 * @brief tspatial_srid (int32_t) — unary tgeompoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tspatial_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TspatialSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TspatialSrid";

    TspatialSridLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
