...
/**
 * @brief Tests inequality of two H3 cell indices.
 */
class H3indexNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexNe";

    H3indexNeLogicalFunction(LogicalFunction a, LogicalFunction b);
