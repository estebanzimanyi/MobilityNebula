...
/**
 * @brief distance_bigintspanset_bigintspanset (int64) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_bigintspanset_bigintspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceBigintspansetBigintspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceBigintspansetBigintspanset";

    DistanceBigintspansetBigintspansetLogicalFunction(LogicalFunction lit,
