...
/**
 * @brief Per-event ever-touches between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `etouches_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalETouchesTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalETouchesTCbufferTCbuffer";

    TemporalETouchesTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
