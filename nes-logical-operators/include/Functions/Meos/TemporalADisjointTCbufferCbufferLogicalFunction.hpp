...
/**
 * @brief Per-event a-disjoint between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adisjoint_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalADisjointTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADisjointTCbufferCbuffer";

    TemporalADisjointTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
