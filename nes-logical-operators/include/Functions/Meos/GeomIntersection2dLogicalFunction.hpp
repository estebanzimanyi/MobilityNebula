...
/**
 * @brief Returns the geometric intersection of two geometries as WKT.
 */
class GeomIntersection2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomIntersection2d";

    GeomIntersection2dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
