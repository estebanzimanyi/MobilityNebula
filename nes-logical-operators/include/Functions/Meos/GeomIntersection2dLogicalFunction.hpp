...
/**
 * @brief geom_intersection2d (GSERIALIZED *) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_intersection2d`. Per-event scalar operator following the
...
public:
    ...
    GeomIntersection2dLogicalFunction(LogicalFunction lit,
