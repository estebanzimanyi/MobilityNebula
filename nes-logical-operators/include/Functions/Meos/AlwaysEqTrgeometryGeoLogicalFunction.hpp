...
/**
 * @brief always_eq_trgeometry_geo (int) — temporal trgeometry ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_trgeometry_geo`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
