...
/**
 * @brief Returns 1.0 if the 2D trgeometry instant is always equal to the static geometry.
 */
class AlwaysEqTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTrgeometryGeo";

    AlwaysEqTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction tgt_wkt);
