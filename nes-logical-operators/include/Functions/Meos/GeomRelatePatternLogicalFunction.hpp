...
/**
 * @brief Tests whether two geometries satisfy a DE-9IM relation pattern, returning 1.0 if true.
 */
...
public:
    ...
    GeomRelatePatternLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2, LogicalFunction pattern);
