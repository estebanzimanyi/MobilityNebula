...
/**
 * @brief geom_relate_pattern (bool) — geometry op with fixed (char*)"T*F**FFF*".
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_relate_pattern`. Per-event scalar operator following the
...
public:
    ...
    GeomRelatePatternLogicalFunction(LogicalFunction lit,
