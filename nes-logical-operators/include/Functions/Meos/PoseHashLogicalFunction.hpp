...
/**
 * @brief pose_hash (uint32) — unary pose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseHash";

    PoseHashLogicalFunction(LogicalFunction lit);
