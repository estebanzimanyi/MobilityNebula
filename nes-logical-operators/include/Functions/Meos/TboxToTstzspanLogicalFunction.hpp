...
/**
 * @brief tbox_to_tstzspan (Span *) — TBox -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_to_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxToTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxToTstzspan";

    TboxToTstzspanLogicalFunction(LogicalFunction lit);
