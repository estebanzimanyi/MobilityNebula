...
/**
 * @brief tfloatbox_expand (TBox *) - expand a TBox by a value in the float dimension.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloatbox_expand`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatboxExpandLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatboxExpand";

    TfloatboxExpandLogicalFunction(LogicalFunction lit,
