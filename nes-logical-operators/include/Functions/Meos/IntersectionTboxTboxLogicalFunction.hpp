...
/**
 * @brief intersection_tbox_tbox (TBox *) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_tbox_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionTboxTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionTboxTbox";

    IntersectionTboxTboxLogicalFunction(LogicalFunction lit,
