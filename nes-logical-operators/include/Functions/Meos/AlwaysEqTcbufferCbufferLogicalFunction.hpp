...
/**
 * @brief Per-event always_eq_tcbuffer_cbuffer between a single-instant tcbuffer and a static cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tcbuffer_cbuffer`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
