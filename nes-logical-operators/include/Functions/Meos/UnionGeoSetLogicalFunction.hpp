...
/**
 * @brief union_geo_set (Set *) — object-set ± geo value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_geo_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionGeoSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionGeoSet";

    UnionGeoSetLogicalFunction(LogicalFunction lit,
