...
/**
 * @brief contains_span_bigint (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_span_bigint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsSpanBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSpanBigint";

    ContainsSpanBigintLogicalFunction(LogicalFunction lit,
