...
/**
 * @brief Returns the geometric difference of two geometries as WKT.
 */
class GeomDifference2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomDifference2d";

    GeomDifference2dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
