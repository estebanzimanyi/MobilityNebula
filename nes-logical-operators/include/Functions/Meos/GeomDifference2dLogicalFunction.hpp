...
/**
 * @brief geom_difference2d (GSERIALIZED *) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_difference2d`. Per-event scalar operator following the
...
public:
    ...
    GeomDifference2dLogicalFunction(LogicalFunction lit,
