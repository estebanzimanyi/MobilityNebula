...
/**
 * @brief tcbuffer_at_stbox (Temporal *) — tcbuffer restriction by STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_at_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferAtStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferAtStbox";

    TcbufferAtStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
