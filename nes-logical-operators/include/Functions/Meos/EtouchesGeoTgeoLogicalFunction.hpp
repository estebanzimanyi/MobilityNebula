...
/**
 * @brief Per-event etouches_geo_tgeo: a static geometry vs a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `etouches_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EtouchesGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EtouchesGeoTgeo";

    EtouchesGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
