...
/**
 * @brief Returns 1.0 if the tcbuffer ever covers the static geometry, 0.0 otherwise.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, radius:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class EcoversTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcoversTcbufferGeo";

    EcoversTcbufferGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
