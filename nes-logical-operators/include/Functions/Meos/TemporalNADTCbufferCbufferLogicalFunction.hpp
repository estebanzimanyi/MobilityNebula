...
/**
 * @brief Per-event nearest-approach distance between a single-instant tcbuffer and a static cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalNADTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTCbufferCbuffer";

    TemporalNADTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
