...
/**
 * @brief tdistance_tnpoint_point (Temporal *) — temporal tnpoint ⊗ GSERIALIZED -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tnpoint_point`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTnpointPointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTnpointPoint";

    TdistanceTnpointPointLogicalFunction(LogicalFunction rid,
