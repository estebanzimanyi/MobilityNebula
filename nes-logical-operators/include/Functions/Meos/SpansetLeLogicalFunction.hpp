...
/**
 * @brief spanset_le (bool) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_le`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetLeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetLe";

    SpansetLeLogicalFunction(LogicalFunction lit,
