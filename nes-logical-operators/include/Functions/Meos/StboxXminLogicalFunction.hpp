...
/**
 * @brief stbox_xmin (out-param double) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_xmin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxXminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxXmin";

    StboxXminLogicalFunction(LogicalFunction box);
