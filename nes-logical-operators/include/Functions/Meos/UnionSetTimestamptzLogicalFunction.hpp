...
/**
 * @brief union_set_timestamptz: extern Set *union_set_timestamptz(const Set *s, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_set_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSetTimestamptz";

    UnionSetTimestamptzLogicalFunction(LogicalFunction lit,
