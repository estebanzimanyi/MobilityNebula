...
/**
 * @brief tne_pose_tpose (Temporal *) — temporal tpose ⊗ Pose -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_pose_tpose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnePoseTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnePoseTpose";

    TnePoseTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
