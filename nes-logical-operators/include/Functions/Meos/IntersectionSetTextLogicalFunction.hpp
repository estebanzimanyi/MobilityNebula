...
/**
 * @brief intersection_set_text: extern Set *intersection_set_text(const Set *s, const text *txt);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_set_text`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSetTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSetText";

    IntersectionSetTextLogicalFunction(LogicalFunction lit,
