...
/**
 * @brief gbox_to_stbox (STBox *) - the spatiotemporal box of a PostGIS GBOX.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `gbox_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GboxToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GboxToStbox";

    GboxToStboxLogicalFunction(LogicalFunction box);
