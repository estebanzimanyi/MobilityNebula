...
/**
 * @brief Static geometry scalar geom_length: (wkt1:VARCHAR) -> float64.
 *
 * Generated from the MEOS function `geom_length`.
 * Operates on plain WKT strings without a temporal dimension.
 */
class GeomLengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomLength";

    explicit GeomLengthLogicalFunction(LogicalFunction wkt1);
