...
/**
 * @brief Per-event sub_float_tfloat: scalar float minus single-instant tfloat.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_float_tfloat`. Per-event scalar operator following the
...
public:
    ...
    SubFloatTfloatLogicalFunction(LogicalFunction arg0,
