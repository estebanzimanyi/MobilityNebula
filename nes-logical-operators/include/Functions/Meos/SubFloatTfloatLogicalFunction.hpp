...
/**
 * @brief Per-event sub_float_tfloat: subtracts a single-instant tfloat value from a constant.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_float_tfloat`. Takes (scalar:FLOAT64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the subtraction, and returns FLOAT64.
 */
class SubFloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SubFloatTfloat";

    SubFloatTfloatLogicalFunction(LogicalFunction scalar,
