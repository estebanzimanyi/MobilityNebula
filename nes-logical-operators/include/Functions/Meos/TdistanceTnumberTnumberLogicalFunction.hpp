...
/**
 * @brief Per-event tdistance_tnumber_tnumber: temporal distance between two tnumbers (WKB result).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tnumber_tnumber`. Per-event scalar operator following the
...
public:
    ...
    TdistanceTnumberTnumberLogicalFunction(LogicalFunction traj,
