...
/**
 * @brief Per-event tdistance_tnumber_tnumber: distance between two co-instant tnumber values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tnumber_tnumber`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two co-instant temporals, applies the distance function, and returns FLOAT64.
 */
class TdistanceTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTnumberTnumber";

    TdistanceTnumberTnumberLogicalFunction(LogicalFunction value1,
