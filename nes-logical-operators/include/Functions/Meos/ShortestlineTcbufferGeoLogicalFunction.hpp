...
/**
 * @brief shortestline_tcbuffer_geo (GSERIALIZED *) — tcbuffer nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTcbufferGeo";

    ShortestlineTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
