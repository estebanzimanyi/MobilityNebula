...
/**
 * @brief datespan_to_tstzspan (Span *) — Span -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespan_to_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespanToTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespanToTstzspan";

    DatespanToTstzspanLogicalFunction(LogicalFunction lit);
