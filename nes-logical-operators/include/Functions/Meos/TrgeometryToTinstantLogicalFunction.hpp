...
/**
 * @brief trgeometry_to_tinstant (TInstant *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_to_tinstant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryToTinstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryToTinstant";

    TrgeometryToTinstantLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
