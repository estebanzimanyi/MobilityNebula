...
/**
 * @brief before_temporal_tstzspan (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_temporal_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeTemporalTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeTemporalTstzspan";

    BeforeTemporalTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
