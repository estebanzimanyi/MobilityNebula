...
/**
 * @brief after_set_date (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_set_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterSetDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterSetDate";

    AfterSetDateLogicalFunction(LogicalFunction lit,
