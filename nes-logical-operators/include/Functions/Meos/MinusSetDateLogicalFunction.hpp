...
/**
 * @brief minus_set_date: extern Set *minus_set_date(const Set *s, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetDate";

    MinusSetDateLogicalFunction(LogicalFunction lit,
