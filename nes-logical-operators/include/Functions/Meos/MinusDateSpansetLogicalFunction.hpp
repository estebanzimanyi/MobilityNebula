...
/**
 * @brief minus_date_spanset: extern SpanSet *minus_date_spanset(DateADT d, const SpanSet *ss);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_date_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusDateSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusDateSpanset";

    MinusDateSpansetLogicalFunction(LogicalFunction lit,
