 ...
 */
class AlwaysLeTbigintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysLeTbigintTfloat";

    AlwaysLeTbigintTfloatLogicalFunction(LogicalFunction value1,
