...
/**
 * @brief Per-event always_le_tbigint_tfloat: tests if two single-instant tbigint values are always less or equal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_le_tbigint_tfloat`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two single-instant temporals, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysLeTbigintTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysLeTbigintTbigint";

    AlwaysLeTbigintTbigintLogicalFunction(LogicalFunction value1,
