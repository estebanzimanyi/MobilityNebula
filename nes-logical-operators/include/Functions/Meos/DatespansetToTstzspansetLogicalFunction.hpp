...
/**
 * @brief datespanset_to_tstzspanset (SpanSet *) — SpanSet -> SpanSet conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_to_tstzspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetToTstzspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetToTstzspanset";

    DatespansetToTstzspansetLogicalFunction(LogicalFunction lit);
