...
/**
 * @brief Per-event overlaps_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overlaps_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverlapsTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverlapsTnumberTbox";

    OverlapsTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
