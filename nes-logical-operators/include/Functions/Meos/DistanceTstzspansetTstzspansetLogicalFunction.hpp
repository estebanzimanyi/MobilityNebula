...
/**
 * @brief distance_tstzspanset_tstzspanset (double) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_tstzspanset_tstzspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceTstzspansetTstzspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceTstzspansetTstzspanset";

    DistanceTstzspansetTstzspansetLogicalFunction(LogicalFunction lit,
