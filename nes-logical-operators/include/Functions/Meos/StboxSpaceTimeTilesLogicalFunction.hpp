...
/**
 * @brief stbox_space_time_tiles (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_space_time_tiles`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxSpaceTimeTilesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxSpaceTimeTiles";

    StboxSpaceTimeTilesLogicalFunction(LogicalFunction box,
