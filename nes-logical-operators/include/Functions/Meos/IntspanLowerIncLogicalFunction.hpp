...
/**
 * @brief Returns 1 if the lower bound of an integer span is inclusive, 0 otherwise.
 */
class IntspanLowerIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanLowerInc";
    IntspanLowerIncLogicalFunction(LogicalFunction sp);
