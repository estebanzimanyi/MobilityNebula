...
/**
 * @brief temporal_shift_scale_time (Temporal *) — arity-3 tfloat_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_shift_scale_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalShiftScaleTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalShiftScaleTime";

    TemporalShiftScaleTimeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
