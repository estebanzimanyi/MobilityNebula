...
/**
 * @brief intersection_spanset_spanset over two text literals; type-generic MEOS set-algebra, VARSIZED (intspanset_text).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_spanset_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpansetSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpansetSpanset";

    IntersectionSpansetSpansetLogicalFunction(LogicalFunction lit,
