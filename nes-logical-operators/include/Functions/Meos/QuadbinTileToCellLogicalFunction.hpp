...
/**
 * @brief Quadbin tile to cell
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `quadbin_tile_to_cell((uint32_t)x, (uint32_t)y, (uint32_t)z)`. Per-event scalar operator following the
...
public:
    ...
    QuadbinTileToCellLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
                                          LogicalFunction z);
