...
/**
 * @brief Returns a VARCHAR for a quadbin cell. NES token: QUADBIN_TILE_TO_CELL.
 */
class QuadbinTileToCellLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinTileToCell";

    QuadbinTileToCellLogicalFunction(LogicalFunction x, LogicalFunction y, LogicalFunction z);
