...
/**
 * @brief Returns the width of a float span.
 */
class FloatspanWidthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanWidth";
    FloatspanWidthLogicalFunction(LogicalFunction sp);
