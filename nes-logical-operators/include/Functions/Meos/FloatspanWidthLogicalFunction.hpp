...
/**
 * @brief floatspan_width (double) — unary floatspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_width`. Per-event scalar operator following the
...
public:
    ...
    FloatspanWidthLogicalFunction(LogicalFunction lit);
