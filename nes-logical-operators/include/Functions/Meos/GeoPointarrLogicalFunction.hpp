...
/**
 * @brief geo_pointarr (GSERIALIZED **) - the array of points of a geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_pointarr`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoPointarrLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoPointarr";

    GeoPointarrLogicalFunction(LogicalFunction lit);
