...
/**
 * @brief geoset_value_n (out-param GSERIALIZED, n=1) — geoset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geoset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeosetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeosetValueN";

    GeosetValueNLogicalFunction(LogicalFunction lit);
