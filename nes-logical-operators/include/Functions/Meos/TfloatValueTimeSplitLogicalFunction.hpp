...
/**
 * @brief tfloat_value_time_split (Temporal **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_value_time_split`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatValueTimeSplitLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatValueTimeSplit";

    TfloatValueTimeSplitLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
