...
/**
 * @brief Always gtqual text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_gt_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysGtTextTtextLogicalFunction(LogicalFunction arg0,
