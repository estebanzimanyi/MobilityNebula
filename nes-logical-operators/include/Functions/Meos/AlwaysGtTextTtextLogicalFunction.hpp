...
/**
 * @brief always_gt_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_gt_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    AlwaysGtTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
