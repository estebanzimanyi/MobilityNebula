...
/**
 * @brief Tests if Quadbin cell a is less than b.
 */
class QuadbinLtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinLt";
    QuadbinLtLogicalFunction(LogicalFunction a, LogicalFunction b);
