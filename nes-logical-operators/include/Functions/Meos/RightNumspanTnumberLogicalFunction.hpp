...
/**
 * @brief right_numspan_tnumber (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_numspan_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightNumspanTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightNumspanTnumber";

    RightNumspanTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
