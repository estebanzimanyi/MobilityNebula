...
/**
 * @brief Interpolate point on line
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `line_interpolate_point(temp, arg0)`. Per-event scalar operator following the
...
public:
    ...
    LineInterpolatePointLogicalFunction(LogicalFunction wkt,
