...
/**
 * @brief Returns the point (or multi-point if repeat=1) interpolated at the given fraction along a line.
 */
class LineInterpolatePointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LineInterpolatePoint";

    LineInterpolatePointLogicalFunction(LogicalFunction wkt, LogicalFunction frac, LogicalFunction repeat);
