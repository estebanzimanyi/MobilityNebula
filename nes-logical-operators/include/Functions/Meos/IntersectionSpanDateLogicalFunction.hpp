...
/**
 * @brief intersection_span_date: extern Span *intersection_span_date(const Span *s, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_span_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpanDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpanDate";

    IntersectionSpanDateLogicalFunction(LogicalFunction lit,
