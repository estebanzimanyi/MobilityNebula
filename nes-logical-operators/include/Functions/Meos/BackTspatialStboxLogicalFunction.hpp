...
/**
 * @brief Per-event back_tspatial_stbox: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `back_tspatial_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BackTspatialStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BackTspatialStbox";

    BackTspatialStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
