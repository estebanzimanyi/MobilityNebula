...
/**
 * @brief Per-event tdistance_tnpoint_tnpoint: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tnpoint_tnpoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTnpointTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTnpointTnpoint";

    TdistanceTnpointTnpointLogicalFunction(LogicalFunction traj,
