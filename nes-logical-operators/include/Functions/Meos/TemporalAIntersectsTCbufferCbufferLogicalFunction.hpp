...
/**
 * @brief Per-event a-intersects between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `aintersects_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAIntersectsTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAIntersectsTCbufferCbuffer";

    TemporalAIntersectsTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
