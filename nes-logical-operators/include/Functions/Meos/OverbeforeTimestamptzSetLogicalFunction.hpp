...
/**
 * @brief overbefore_timestamptz_set (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbefore_timestamptz_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbeforeTimestamptzSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbeforeTimestamptzSet";

    OverbeforeTimestamptzSetLogicalFunction(LogicalFunction lit,
