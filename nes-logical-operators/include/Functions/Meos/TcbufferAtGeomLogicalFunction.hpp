...
/**
 * @brief tcbuffer_at_geom (Temporal *) — tcbuffer restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_at_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferAtGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferAtGeom";

    TcbufferAtGeomLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
