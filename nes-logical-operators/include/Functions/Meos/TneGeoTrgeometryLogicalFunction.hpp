...
/**
 * @brief tne_geo_trgeometry (Temporal *) — temporal trgeometry ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_geo_trgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TneGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TneGeoTrgeometry";

    TneGeoTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
