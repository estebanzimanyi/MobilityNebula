...
/**
 * @brief stbox_xmax (out-param double) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_xmax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxXmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxXmax";

    StboxXmaxLogicalFunction(LogicalFunction box);
