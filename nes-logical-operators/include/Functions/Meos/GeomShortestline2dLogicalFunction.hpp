...
/**
 * @brief Returns the shortest 2D line between two geometries as WKT.
 */
class GeomShortestline2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomShortestline2d";

    GeomShortestline2dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
