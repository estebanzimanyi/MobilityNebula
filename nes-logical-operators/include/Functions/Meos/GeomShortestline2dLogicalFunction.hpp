...
/**
 * @brief geom_shortestline2d (GSERIALIZED *) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_shortestline2d`. Per-event scalar operator following the
...
public:
    ...
    GeomShortestline2dLogicalFunction(LogicalFunction lit,
