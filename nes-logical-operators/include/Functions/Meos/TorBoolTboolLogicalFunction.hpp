...
/**
 * @brief Per-event tor_bool_tbool: OR of a scalar bool and a single-instant tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tor_bool_tbool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the operation, and returns FLOAT64 (0.0/1.0).
 */
class TorBoolTboolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TorBoolTbool";

    TorBoolTboolLogicalFunction(LogicalFunction value,
