...
/**
 * @brief Per-event tor_bool_tbool: temporal OR of scalar bool and tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tor_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    TorBoolTboolLogicalFunction(LogicalFunction arg0,
