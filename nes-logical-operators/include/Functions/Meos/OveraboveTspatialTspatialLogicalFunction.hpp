...
/**
 * @brief Per-event overabove_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overabove_tspatial_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OveraboveTspatialTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OveraboveTspatialTspatial";

    OveraboveTspatialTspatialLogicalFunction(LogicalFunction lonA,
