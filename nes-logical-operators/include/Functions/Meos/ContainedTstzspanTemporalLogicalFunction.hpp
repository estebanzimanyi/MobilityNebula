...
/**
 * @brief contained_tstzspan_temporal (bool) — temporal ⊗ tstzspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTstzspanTemporal";

    ContainedTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
