...
/**
 * @brief Per-event div_int_tint: scalar int divided by single-instant tint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_int_tint`. Per-event scalar operator following the
...
public:
    ...
    DivIntTintLogicalFunction(LogicalFunction arg0,
