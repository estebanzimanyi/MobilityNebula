...
/**
 * @brief Per-event div_int_tint: divides a constant by a single-instant tint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_int_tint`. Takes (scalar:FLOAT64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the division, and returns FLOAT64.
 */
class DivIntTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DivIntTint";

    DivIntTintLogicalFunction(LogicalFunction scalar,
