...
/**
 * @brief Per-event always_ne_quadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_quadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeQuadbinTquadbinLogicalFunction(LogicalFunction arg0,
