...
/**
 * @brief textset_value_n (out-param text, n=1) — textset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextsetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextsetValueN";

    TextsetValueNLogicalFunction(LogicalFunction lit);
