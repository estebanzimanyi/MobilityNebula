...
/**
 * @brief tcbuffer_minus_stbox (Temporal *) — tcbuffer restriction by STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_minus_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferMinusStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferMinusStbox";

    TcbufferMinusStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
