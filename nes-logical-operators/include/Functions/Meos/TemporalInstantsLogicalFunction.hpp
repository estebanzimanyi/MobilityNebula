...
/**
 * @brief temporal_instants (TInstant **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_instants`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalInstantsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalInstants";

    TemporalInstantsLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
