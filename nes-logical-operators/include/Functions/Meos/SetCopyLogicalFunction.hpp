...
/**
 * @brief set_copy (Set *) — unary floatset -> Set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_copy`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetCopyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetCopy";

    SetCopyLogicalFunction(LogicalFunction lit);
