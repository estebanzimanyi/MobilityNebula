...
/**
 * @brief Th3index th3index cell to parent
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_cell_to_parent(temp, (int32_t)arg0)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexCellToParentLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
