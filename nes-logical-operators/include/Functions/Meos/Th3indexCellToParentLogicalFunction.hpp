...
/**
 * @brief Returns the H3 parent cell at the given resolution as a hex string.
 *
 * Args: (cell:UINT64, ts:UINT64, resolution:UINT64) -> VARCHAR.
 */
class Th3indexCellToParentLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexCellToParent";

    Th3indexCellToParentLogicalFunction(LogicalFunction cell, LogicalFunction ts, LogicalFunction resolution);
