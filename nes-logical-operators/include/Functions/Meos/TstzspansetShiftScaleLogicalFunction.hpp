...
/**
 * @brief tstzspanset_shift_scale (container, interval shift, interval duration) -> shifted+scaled tstzspanset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetShiftScale";

    TstzspansetShiftScaleLogicalFunction(LogicalFunction lit,
