...
/**
 * @brief tdisjoint_tcbuffer_tcbuffer (Temporal *) — two tcbuffer instants -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdisjoint_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdisjointTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdisjointTcbufferTcbuffer";

    TdisjointTcbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
