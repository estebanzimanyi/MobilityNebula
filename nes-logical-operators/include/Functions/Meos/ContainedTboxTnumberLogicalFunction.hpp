...
/**
 * @brief Per-event contained_tbox_tnumber: single-instant tfloat against a TBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_tbox_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTboxTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTboxTnumber";

    ContainedTboxTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
