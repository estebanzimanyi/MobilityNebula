...
/**
 * @brief distance_floatset_floatset (double) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_floatset_floatset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceFloatsetFloatsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceFloatsetFloatset";

    DistanceFloatsetFloatsetLogicalFunction(LogicalFunction lit,
