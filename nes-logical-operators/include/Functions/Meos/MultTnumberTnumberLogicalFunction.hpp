...
/**
 * @brief Per-event mult_tnumber_tnumber: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mult_tnumber_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MultTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MultTnumberTnumber";

    MultTnumberTnumberLogicalFunction(LogicalFunction traj,
