...
/**
 * @brief Per-event ever-contains between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalEContainsTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEContainsTPoseGeometry";

    TemporalEContainsTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
