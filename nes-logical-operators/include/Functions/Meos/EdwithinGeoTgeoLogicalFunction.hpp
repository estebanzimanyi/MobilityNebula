...
/**
 * @brief Per-event edwithin_geo_tgeo: a static geometry within a distance of a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edwithin_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EdwithinGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EdwithinGeoTgeo";

    EdwithinGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
