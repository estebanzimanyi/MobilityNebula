...
/**
 * @brief distance_datespanset_datespanset (int) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_datespanset_datespanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceDatespansetDatespansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceDatespansetDatespanset";

    DistanceDatespansetDatespansetLogicalFunction(LogicalFunction lit,
