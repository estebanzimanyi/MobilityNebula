...
/**
 * @brief tint_value_time_split (Temporal **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_value_time_split`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValueTimeSplitLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValueTimeSplit";

    TintValueTimeSplitLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
