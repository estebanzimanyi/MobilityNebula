...
/**
 * @brief minus_npoint_set (Set *) — object-set ± npoint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_npoint_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusNpointSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusNpointSet";

    MinusNpointSetLogicalFunction(LogicalFunction lit,
