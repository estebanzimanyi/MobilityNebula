...
/**
 * @brief cbuffer_ge (bool) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_ge`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferGe";

    CbufferGeLogicalFunction(LogicalFunction lit,
