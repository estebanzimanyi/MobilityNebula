...
/**
 * @brief tcbuffer_make (Temporal *) - a temporal circular buffer from a temporal point and a temporal float radius.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferMake";

    TcbufferMakeLogicalFunction(LogicalFunction traj,
