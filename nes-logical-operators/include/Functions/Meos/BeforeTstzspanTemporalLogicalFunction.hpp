...
/**
 * @brief before_tstzspan_temporal (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeTstzspanTemporal";

    BeforeTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
