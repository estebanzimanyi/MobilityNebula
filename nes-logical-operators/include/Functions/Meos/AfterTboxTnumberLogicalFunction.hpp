...
/**
 * @brief Per-event after_tbox_tnumber: single-instant tfloat against a TBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_tbox_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterTboxTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterTboxTnumber";

    AfterTboxTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
