...
/**
 * @brief tgeo_minus_value (Temporal *) — tgeo restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_minus_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoMinusValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoMinusValue";

    TgeoMinusValueLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
