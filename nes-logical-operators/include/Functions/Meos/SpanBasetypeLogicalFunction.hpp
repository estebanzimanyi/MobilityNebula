...
/**
 * @brief span_basetype (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_basetype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanBasetypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanBasetype";

    SpanBasetypeLogicalFunction(LogicalFunction lit);
