...
/**
 * @brief ttext_max_value (text *) — unary ttext -> text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_max_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextMaxValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextMaxValue";

    TtextMaxValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
