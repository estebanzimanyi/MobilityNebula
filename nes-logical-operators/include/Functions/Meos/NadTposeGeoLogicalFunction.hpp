...
/**
 * @brief Per-event nad_tpose_geo: single-instant tpose against a static geometry -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tpose_geo`. Per-event scalar operator following the
...
public:
    ...
    NadTposeGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
