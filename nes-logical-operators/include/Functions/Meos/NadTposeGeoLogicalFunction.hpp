...
/**
 * @brief Returns the nearest approach distance between a 2D tpose instant and a static geometry.
 */
class NadTposeGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTposeGeo";

    NadTposeGeoLogicalFunction(LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction wkt);
