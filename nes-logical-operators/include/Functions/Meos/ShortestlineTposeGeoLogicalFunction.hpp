...
/**
 * @brief shortestline_tpose_geo (GSERIALIZED *) — tpose nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tpose_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTposeGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTposeGeo";

    ShortestlineTposeGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
