...
/**
 * @brief span_to_spanset (SpanSet *) — Span -> SpanSet conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_to_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanToSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanToSpanset";

    SpanToSpansetLogicalFunction(LogicalFunction lit);
