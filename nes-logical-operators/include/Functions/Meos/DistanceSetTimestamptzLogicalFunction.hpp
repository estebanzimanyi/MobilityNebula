...
/**
 * @brief distance_set_timestamptz (double) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_set_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceSetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceSetTimestamptz";

    DistanceSetTimestamptzLogicalFunction(LogicalFunction lit,
