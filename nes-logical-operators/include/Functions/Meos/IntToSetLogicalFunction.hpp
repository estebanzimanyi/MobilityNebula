...
/**
 * @brief int_to_set (int value) -> set (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntToSet";

    IntToSetLogicalFunction(LogicalFunction value);
