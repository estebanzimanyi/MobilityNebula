...
/**
 * @brief distance_intspanset_intspan (int) — SpanSet/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_intspanset_intspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceIntspansetIntspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceIntspansetIntspan";

    DistanceIntspansetIntspanLogicalFunction(LogicalFunction lit,
