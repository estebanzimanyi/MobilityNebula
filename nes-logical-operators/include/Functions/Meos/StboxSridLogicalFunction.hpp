...
/**
 * @brief stbox_srid (int32_t) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxSrid";

    StboxSridLogicalFunction(LogicalFunction box);
