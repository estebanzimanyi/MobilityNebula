...
/**
 * @brief alphanumset_type (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `alphanumset_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AlphanumsetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlphanumsetType";

    AlphanumsetTypeLogicalFunction(LogicalFunction lit);
