...
/**
 * @brief Per-event before_tbox_tnumber: single-instant tfloat against a TBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_tbox_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeTboxTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeTboxTnumber";

    BeforeTboxTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
