...
/**
 * @brief poseset_end_value (Pose *) — unary poseset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `poseset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PosesetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PosesetEndValue";

    PosesetEndValueLogicalFunction(LogicalFunction lit);
