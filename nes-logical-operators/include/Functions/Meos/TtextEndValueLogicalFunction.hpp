...
/**
 * @brief ttext_end_value (text *) — unary ttext -> text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextEndValue";

    TtextEndValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
