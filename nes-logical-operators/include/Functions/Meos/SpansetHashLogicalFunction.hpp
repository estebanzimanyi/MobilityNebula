...
/**
 * @brief spanset_hash (uint32) — unary intspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetHash";

    SpansetHashLogicalFunction(LogicalFunction lit);
