...
/**
 * @brief after_spanset_date (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_spanset_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterSpansetDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterSpansetDate";

    AfterSpansetDateLogicalFunction(LogicalFunction lit,
