...
/**
 * @brief union_timestamptz_span: extern SpanSet *union_timestamptz_span(TimestampTz t, const Span *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_timestamptz_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionTimestamptzSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionTimestamptzSpan";

    UnionTimestamptzSpanLogicalFunction(LogicalFunction lit,
