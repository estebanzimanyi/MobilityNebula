...
/**
 * @brief Returns 1.0 if the th3index instant is always not equal to the target H3 cell.
 *
 * Args: (cell:UINT64, ts:UINT64, target:UINT64) -> FLOAT64.
 */
class AlwaysNeTh3indexH3indexLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTh3indexH3index";

    AlwaysNeTh3indexH3indexLogicalFunction(LogicalFunction cell, LogicalFunction ts, LogicalFunction target);
