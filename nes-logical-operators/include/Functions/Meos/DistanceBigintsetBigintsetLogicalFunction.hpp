...
/**
 * @brief distance_bigintset_bigintset (int64) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_bigintset_bigintset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceBigintsetBigintsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceBigintsetBigintset";

    DistanceBigintsetBigintsetLogicalFunction(LogicalFunction lit,
