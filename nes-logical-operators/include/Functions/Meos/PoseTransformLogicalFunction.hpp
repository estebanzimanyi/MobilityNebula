...
/**
 * @brief pose_transform (Pose *) — SRID set/transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_transform`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseTransformLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseTransform";

    PoseTransformLogicalFunction(LogicalFunction lit);
