...
/**
 * @brief bigintspanset_lower (int64) — unary bigintspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspanset_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspansetLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspansetLower";

    BigintspansetLowerLogicalFunction(LogicalFunction lit);
