...
/**
 * @brief Per-event ever-contains between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `econtains_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEContainsTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEContainsTCbuffer";

    TemporalEContainsTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
