...
/**
 * @brief Per-event a-touches between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `atouches_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalATouchesTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalATouchesTCbufferCbuffer";

    TemporalATouchesTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
