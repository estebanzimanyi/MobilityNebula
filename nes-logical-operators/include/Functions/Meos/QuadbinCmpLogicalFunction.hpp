...
/**
 * @brief Returns -1, 0, or 1 comparison result for two Quadbin cells.
 */
class QuadbinCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinCmp";
    QuadbinCmpLogicalFunction(LogicalFunction a, LogicalFunction b);
