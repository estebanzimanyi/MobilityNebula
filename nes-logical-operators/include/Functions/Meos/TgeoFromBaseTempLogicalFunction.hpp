...
/**
 * @brief tgeo_from_base_temp (Temporal *) - a temporal geo from a geometry and a temporal's time frame.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_from_base_temp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoFromBaseTempLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoFromBaseTemp";

    TgeoFromBaseTempLogicalFunction(LogicalFunction lit,
