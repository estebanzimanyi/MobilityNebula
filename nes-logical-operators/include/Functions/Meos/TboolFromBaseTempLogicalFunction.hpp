...
/**
 * @brief tbool_from_base_temp (Temporal *) — temporal tbool ⊗ bool -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_from_base_temp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolFromBaseTempLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolFromBaseTemp";

    TboolFromBaseTempLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
