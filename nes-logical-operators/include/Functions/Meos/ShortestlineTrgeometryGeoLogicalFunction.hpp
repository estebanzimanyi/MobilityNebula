...
/**
 * @brief shortestline_trgeometry_geo (GSERIALIZED *) — trgeometry nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_trgeometry_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTrgeometryGeo";

    ShortestlineTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
