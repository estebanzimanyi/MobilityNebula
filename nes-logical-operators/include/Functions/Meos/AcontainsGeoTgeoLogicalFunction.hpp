...
/**
 * @brief acontains_geo_tgeo (int) — temporal tgeo ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acontains_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AcontainsGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcontainsGeoTgeo";

    AcontainsGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
