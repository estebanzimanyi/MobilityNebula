...
/**
 * @brief union_set_geo (Set *) — object-set ± geo value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_set_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSetGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSetGeo";

    UnionSetGeoLogicalFunction(LogicalFunction lit,
