...
/**
 * @brief Per-event trgeometry_at_stbox: a hex-WKB temporal, a static STBox, and a border flag -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_at_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryAtStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryAtStbox";

    TrgeometryAtStboxLogicalFunction(LogicalFunction traj,
