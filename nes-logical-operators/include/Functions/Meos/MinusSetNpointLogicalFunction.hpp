...
/**
 * @brief minus_set_npoint (Set *) — object-set ± npoint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetNpoint";

    MinusSetNpointLogicalFunction(LogicalFunction lit,
