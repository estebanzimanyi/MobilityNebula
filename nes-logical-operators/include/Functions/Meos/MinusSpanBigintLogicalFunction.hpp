...
/**
 * @brief minus_span_bigint (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_span_bigint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpanBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpanBigint";

    MinusSpanBigintLogicalFunction(LogicalFunction lit,
