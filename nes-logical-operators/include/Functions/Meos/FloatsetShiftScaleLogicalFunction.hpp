...
/**
 * @brief floatset_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled floatset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetShiftScale";

    FloatsetShiftScaleLogicalFunction(LogicalFunction lit,
