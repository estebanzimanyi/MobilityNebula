...
/**
 * @brief cbuffer_copy (Cbuffer *) — unary cbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_copy`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferCopyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferCopy";

    CbufferCopyLogicalFunction(LogicalFunction lit);
