...
/**
 * @brief Tests whether two temporal geometries are always within a distance.
 */
class AdwithinTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdwithinTgeoTgeo";

    AdwithinTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2, LogicalFunction dist);
