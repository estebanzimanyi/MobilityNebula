...
/**
 * @brief always_ne_npoint_tnpoint (int) — always/ever tnpoint ⊗ Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_npoint_tnpoint`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeNpointTnpointLogicalFunction(LogicalFunction rid,
