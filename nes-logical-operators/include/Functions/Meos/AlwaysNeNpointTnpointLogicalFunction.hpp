...
/**
 * @brief Returns 1.0 if the static npoint is always not equal to the tnpoint instant, 0.0 otherwise.
 */
class AlwaysNeNpointTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeNpointTnpoint";

    AlwaysNeNpointTnpointLogicalFunction(LogicalFunction rid_np, LogicalFunction pos_np, LogicalFunction rid_tp, LogicalFunction pos_tp, LogicalFunction ts);
