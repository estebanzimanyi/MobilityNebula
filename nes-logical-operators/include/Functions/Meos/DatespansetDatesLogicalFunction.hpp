...
/**
 * @brief datespanset_dates (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_dates`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetDatesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetDates";

    DatespansetDatesLogicalFunction(LogicalFunction lit);
