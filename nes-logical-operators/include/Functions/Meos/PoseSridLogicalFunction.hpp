...
/**
 * @brief pose_srid (int32_t) — unary pose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseSrid";

    PoseSridLogicalFunction(LogicalFunction lit);
