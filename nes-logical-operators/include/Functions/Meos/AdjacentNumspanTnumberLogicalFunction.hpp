...
/**
 * @brief adjacent_numspan_tnumber (tnumber, number span) value topological adjacency -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_numspan_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentNumspanTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentNumspanTnumber";

    AdjacentNumspanTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
