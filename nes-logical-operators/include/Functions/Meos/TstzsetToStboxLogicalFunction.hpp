...
/**
 * @brief tstzset_to_stbox (STBox *) — Set -> STBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetToStbox";

    TstzsetToStboxLogicalFunction(LogicalFunction lit);
