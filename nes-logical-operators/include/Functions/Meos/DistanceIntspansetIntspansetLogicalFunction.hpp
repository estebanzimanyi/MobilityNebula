...
/**
 * @brief distance_intspanset_intspanset (int) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_intspanset_intspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceIntspansetIntspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceIntspansetIntspanset";

    DistanceIntspansetIntspansetLogicalFunction(LogicalFunction lit,
