...
/**
 * @brief Per-event tnpoint_length: double accessor over a single-instant tnpoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_length`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointLengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointLength";

    TnpointLengthLogicalFunction(LogicalFunction rid,
