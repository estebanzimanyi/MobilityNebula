...
/**
 * @brief Returns -1, 0, or 1 comparison result for two JSONB values.
 */
class JsonbCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbCmp";
    JsonbCmpLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
