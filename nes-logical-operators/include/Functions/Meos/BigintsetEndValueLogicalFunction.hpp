...
/**
 * @brief bigintset_end_value (int64) — unary bigintset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintsetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintsetEndValue";

    BigintsetEndValueLogicalFunction(LogicalFunction lit);
