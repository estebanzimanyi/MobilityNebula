...
/**
 * @brief float_to_set (float value) -> set (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatToSet";

    FloatToSetLogicalFunction(LogicalFunction value);
