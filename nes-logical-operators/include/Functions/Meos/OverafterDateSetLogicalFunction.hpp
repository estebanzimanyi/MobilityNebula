...
/**
 * @brief overafter_date_set (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_date_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterDateSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterDateSet";

    OverafterDateSetLogicalFunction(LogicalFunction lit,
