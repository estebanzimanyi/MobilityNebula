...
/**
 * @brief bigintspanset_width (SpanSet*, boundspan=false) -> total width of the component spans.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspanset_width`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspansetWidthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspansetWidth";

    BigintspansetWidthLogicalFunction(LogicalFunction lit);
