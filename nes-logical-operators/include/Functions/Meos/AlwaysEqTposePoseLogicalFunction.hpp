...
/**
 * @brief always_eq_tpose_pose (int) — always/ever tpose ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tpose_pose`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
