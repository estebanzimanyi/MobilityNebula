...
/**
 * @brief nsegment_lt (bool) — Nsegment scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_lt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentLtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentLt";

    NsegmentLtLogicalFunction(LogicalFunction lit,
