...
/**
 * @brief union_span_date: extern SpanSet *union_span_date(const Span *s, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_span_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSpanDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSpanDate";

    UnionSpanDateLogicalFunction(LogicalFunction lit,
