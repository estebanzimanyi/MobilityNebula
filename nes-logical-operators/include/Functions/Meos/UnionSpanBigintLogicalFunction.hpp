...
/**
 * @brief union_span_bigint (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_span_bigint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSpanBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSpanBigint";

    UnionSpanBigintLogicalFunction(LogicalFunction lit,
