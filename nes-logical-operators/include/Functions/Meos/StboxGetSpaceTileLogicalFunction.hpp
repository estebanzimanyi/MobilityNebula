...
/**
 * @brief stbox_get_space_tile (STBox) — 5x5x5 space tile from origin (0,0,0).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_get_space_tile`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxGetSpaceTileLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxGetSpaceTile";

    StboxGetSpaceTileLogicalFunction(LogicalFunction lit);
