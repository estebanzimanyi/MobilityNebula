...
/**
 * @brief numspan_timestamptz_to_tbox (TBox *) — Span + TimestampTz -> TBox constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `numspan_timestamptz_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NumspanTimestamptzToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NumspanTimestamptzToTbox";

    NumspanTimestamptzToTboxLogicalFunction(LogicalFunction lit,
