...
/**
 * @brief Always neual tquadbin vs quadbin
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tquadbin_quadbin(temp, (Quadbin)arg0)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTquadbinQuadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
