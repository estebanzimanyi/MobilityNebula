...
/**
 * @brief Returns 1 if the tquadbin instant always differs from the Quadbin cell.
 */
class AlwaysNeTquadbinQuadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTquadbinQuadbin";
    AlwaysNeTquadbinQuadbinLogicalFunction(LogicalFunction inst_cell, LogicalFunction ts, LogicalFunction cell);
