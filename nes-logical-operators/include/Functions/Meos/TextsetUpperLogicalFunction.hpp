...
/**
 * @brief textset_upper (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textset_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextsetUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextsetUpper";

    TextsetUpperLogicalFunction(LogicalFunction lit);
