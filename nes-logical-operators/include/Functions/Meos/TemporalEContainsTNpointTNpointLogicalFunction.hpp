...
/**
 * @brief Per-event ever-contains between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalEContainsTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEContainsTNpointTNpoint";

    TemporalEContainsTNpointTNpointLogicalFunction(LogicalFunction ridA,
