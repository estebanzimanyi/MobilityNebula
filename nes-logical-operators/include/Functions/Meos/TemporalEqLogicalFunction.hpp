...
/**
 * @brief Per-event temporal_eq between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_eq`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEq";

    TemporalEqLogicalFunction(LogicalFunction lonA,
