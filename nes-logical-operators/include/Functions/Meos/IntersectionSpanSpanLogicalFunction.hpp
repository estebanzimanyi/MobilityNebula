...
/**
 * @brief intersection_span_span over two text literals; type-generic MEOS set-algebra, VARSIZED (intspan_text).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_span_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpanSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpanSpan";

    IntersectionSpanSpanLogicalFunction(LogicalFunction lit,
