...
/**
 * @brief tgeo_minus_stbox (Temporal *) — tgeo restriction by STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_minus_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoMinusStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoMinusStbox";

    TgeoMinusStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
