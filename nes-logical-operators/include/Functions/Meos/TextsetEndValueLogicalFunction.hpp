...
/**
 * @brief textset_end_value (text *) — unary textset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextsetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextsetEndValue";

    TextsetEndValueLogicalFunction(LogicalFunction lit);
