...
/**
 * @brief stbox_expand_time (STBox *) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_expand_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxExpandTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxExpandTime";

    StboxExpandTimeLogicalFunction(LogicalFunction box,
