...
/**
 * @brief trgeometry_end_instant (TInstant *) — unary trgeometry accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_end_instant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryEndInstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryEndInstant";

    TrgeometryEndInstantLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
