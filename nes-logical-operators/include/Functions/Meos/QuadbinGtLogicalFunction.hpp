...
/**
 * @brief Tests if Quadbin cell a is greater than b.
 */
class QuadbinGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinGt";
    QuadbinGtLogicalFunction(LogicalFunction a, LogicalFunction b);
