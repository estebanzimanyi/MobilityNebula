...
/**
 * @brief Per-event always_eq_tgeo_tgeo between two single-instant tgeompoints -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tgeo_tgeo`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTgeoTgeoLogicalFunction(LogicalFunction lonA,
