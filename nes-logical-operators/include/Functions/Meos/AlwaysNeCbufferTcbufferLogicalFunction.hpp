...
/**
 * @brief always_ne_cbuffer_tcbuffer (int) — always/ever tcbuffer ⊗ Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AlwaysNeCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeCbufferTcbuffer";

    AlwaysNeCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
