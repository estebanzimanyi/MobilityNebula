...
/**
 * @brief Per-event tdistance_tcbuffer_tcbuffer: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTcbufferTcbuffer";

    TdistanceTcbufferTcbufferLogicalFunction(LogicalFunction traj,
