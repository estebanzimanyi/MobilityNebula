...
/**
 * @brief Per-event tbigint_to_tfloat: converts a single-instant tbigint to tfloat, returns FLOAT64.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbigint_to_tfloat`. Takes (value:FLOAT64, ts:UINT64), constructs a single-instant
 * temporal bigint, widens to float, and returns FLOAT64.
 */
class TbigintToTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TbigintToTfloat";

    TbigintToTfloatLogicalFunction(LogicalFunction value,
                                   LogicalFunction ts);
