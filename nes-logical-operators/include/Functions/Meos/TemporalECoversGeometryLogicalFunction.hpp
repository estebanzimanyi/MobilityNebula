...
/**
 * @brief Per-event ever-covers between a single-instant tgeompoint and a static geometry.
 *
 ...
 */
class TemporalECoversGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversGeometry";

    TemporalECoversGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
