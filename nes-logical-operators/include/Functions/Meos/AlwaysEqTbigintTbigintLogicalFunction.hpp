 ...
 */
class AlwaysEqTbigintTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTbigintTbigint";

    AlwaysEqTbigintTbigintLogicalFunction(LogicalFunction value1,
