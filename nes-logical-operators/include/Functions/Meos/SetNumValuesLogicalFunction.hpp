...
/**
 * @brief set_num_values (int) — unary intset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_num_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetNumValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetNumValues";

    SetNumValuesLogicalFunction(LogicalFunction lit);
