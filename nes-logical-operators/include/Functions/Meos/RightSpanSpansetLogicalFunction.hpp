...
/**
 * @brief right_span_spanset (bool) — Span/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_span_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightSpanSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightSpanSpanset";

    RightSpanSpansetLogicalFunction(LogicalFunction lit,
