...
/**
 * @brief overlaps_temporal_tstzspan (bool) — temporal ⊗ tstzspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overlaps_temporal_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverlapsTemporalTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverlapsTemporalTstzspan";

    OverlapsTemporalTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
