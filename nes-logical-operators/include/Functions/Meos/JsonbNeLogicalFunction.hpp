...
/**
 * @brief Tests inequality of two JSONB values.
 */
class JsonbNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbNe";
    JsonbNeLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
