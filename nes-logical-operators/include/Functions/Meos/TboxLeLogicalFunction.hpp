...
/**
 * @brief tbox_le (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_le`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxLeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxLe";

    TboxLeLogicalFunction(LogicalFunction lit,
