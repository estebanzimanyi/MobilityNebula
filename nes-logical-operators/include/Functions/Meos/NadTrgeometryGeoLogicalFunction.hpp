...
/**
 * @brief Returns the nearest approach distance between a 2D trgeometry instant and a static geometry.
 */
class NadTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTrgeometryGeo";

    NadTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction tgt_wkt);
