...
/**
 * @brief nad_trgeometry_geo (double) — trgeometry nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_trgeometry_geo`. Per-event scalar operator following the
...
public:
    ...
    NadTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
