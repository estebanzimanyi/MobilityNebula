...
/**
 * @brief Tests whether two temporal geometries are ever spatially not equal.
 */
class EverNeTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTgeoTgeo";

    EverNeTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2);
