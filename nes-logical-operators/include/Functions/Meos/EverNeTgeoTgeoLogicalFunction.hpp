...
/**
 * @brief Per-event ever_ne_tgeo_tgeo between two single-instant tgeompoints -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tgeo_tgeo`. Per-event scalar operator following the
...
public:
    ...
    EverNeTgeoTgeoLogicalFunction(LogicalFunction lonA,
