...
/**
 * @brief Per-event always-intersects between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalAIntersectsTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAIntersectsTNpointTNpoint";

    TemporalAIntersectsTNpointTNpointLogicalFunction(LogicalFunction ridA,
