...
/**
 * @brief geo_set_srid (GSERIALIZED *) — geometry op with fixed 4326.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_set_srid`. Per-event scalar operator following the
...
public:
    ...
    GeoSetSridLogicalFunction(LogicalFunction lit);
