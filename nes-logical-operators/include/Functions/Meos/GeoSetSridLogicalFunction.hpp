...
/**
 * @brief Returns a geometry with a new SRID assigned, as WKT.
 */
class GeoSetSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoSetSrid";

    GeoSetSridLogicalFunction(LogicalFunction wkt, LogicalFunction srid);
