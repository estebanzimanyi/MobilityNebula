...
/**
 * @brief Per-event mul_float_tfloat: multiplies a constant by a single-instant tfloat value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_float_tfloat`. Takes (scalar:FLOAT64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the multiplication, and returns FLOAT64.
 */
class MulFloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulFloatTfloat";

    MulFloatTfloatLogicalFunction(LogicalFunction scalar,
