...
/**
 * @brief Per-event mul_float_tfloat: scalar float times single-instant tfloat.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_float_tfloat`. Per-event scalar operator following the
...
public:
    ...
    MulFloatTfloatLogicalFunction(LogicalFunction arg0,
