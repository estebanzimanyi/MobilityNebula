...
/**
 * @brief Per-event e-disjoint between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edisjoint_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEDisjointTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointTCbufferCbuffer";

    TemporalEDisjointTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
