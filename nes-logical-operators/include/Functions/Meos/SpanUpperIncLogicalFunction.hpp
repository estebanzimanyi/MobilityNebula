...
/**
 * @brief span_upper_inc (bool) — unary intspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_upper_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanUpperIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanUpperInc";

    SpanUpperIncLogicalFunction(LogicalFunction lit);
