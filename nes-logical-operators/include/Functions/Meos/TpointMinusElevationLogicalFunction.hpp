...
/**
 * @brief tpoint_minus_elevation (Temporal *) - the temporal point minus an elevation span.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_minus_elevation`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointMinusElevationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointMinusElevation";

    TpointMinusElevationLogicalFunction(LogicalFunction traj,
