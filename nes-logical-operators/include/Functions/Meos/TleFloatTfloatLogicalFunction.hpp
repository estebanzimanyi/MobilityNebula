...
/**
 * @brief temporal LE: scalar float vs single-instant tfloat
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tle_float_tfloat`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TleFloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TleFloatTfloat";

    TleFloatTfloatLogicalFunction(LogicalFunction value,
