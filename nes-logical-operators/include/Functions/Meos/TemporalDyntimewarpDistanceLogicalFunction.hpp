...
/**
 * @brief Per-event temporal_dyntimewarp_distance between two single-instant tgeompoints -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_dyntimewarp_distance`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalDyntimewarpDistanceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalDyntimewarpDistance";

    TemporalDyntimewarpDistanceLogicalFunction(LogicalFunction lonA,
