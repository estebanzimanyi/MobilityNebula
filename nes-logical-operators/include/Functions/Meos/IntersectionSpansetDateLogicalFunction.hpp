...
/**
 * @brief intersection_spanset_date: extern SpanSet *intersection_spanset_date(const SpanSet *ss, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_spanset_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpansetDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpansetDate";

    IntersectionSpansetDateLogicalFunction(LogicalFunction lit,
