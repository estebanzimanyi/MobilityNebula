...
/**
 * @brief tbool_when_true (SpanSet *) - the time spans when a temporal boolean is true.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_when_true`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolWhenTrueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolWhenTrue";

    TboolWhenTrueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
