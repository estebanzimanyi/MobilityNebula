...
/**
 * @brief Returns the spheroidal distance between two geographic geometries in metres.
 *
 * Args: (wkt1:VARCHAR, wkt2:VARCHAR) -> FLOAT64.
 */
class GeogDistanceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogDistance";

    GeogDistanceLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
