...
/**
 * @brief geog_distance (double) — geodetic binary measure.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geog_distance`. Per-event scalar operator following the
...
public:
    ...
    GeogDistanceLogicalFunction(LogicalFunction lit,
