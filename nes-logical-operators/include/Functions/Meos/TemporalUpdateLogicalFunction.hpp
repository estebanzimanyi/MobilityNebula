...
/**
 * @brief temporal_update (Temporal *) — merge a 2nd tint into the 1st.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_update`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalUpdateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalUpdate";

    TemporalUpdateLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
