 ...
 */
class EverNeTbigintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTbigintTfloat";

    EverNeTbigintTfloatLogicalFunction(LogicalFunction value1,
