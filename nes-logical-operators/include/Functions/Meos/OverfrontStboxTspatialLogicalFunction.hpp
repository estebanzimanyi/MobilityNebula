...
/**
 * @brief Per-event overfront_stbox_tspatial: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overfront_stbox_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverfrontStboxTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverfrontStboxTspatial";

    OverfrontStboxTspatialLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
