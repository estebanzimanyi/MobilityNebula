...
/**
 * @brief overleft_text_set (bool) — object-set ± text value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_text_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftTextSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftTextSet";

    OverleftTextSetLogicalFunction(LogicalFunction lit,
