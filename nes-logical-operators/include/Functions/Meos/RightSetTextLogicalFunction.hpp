...
/**
 * @brief right_set_text (bool) — object-set ± text value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_set_text`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightSetTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightSetText";

    RightSetTextLogicalFunction(LogicalFunction lit,
