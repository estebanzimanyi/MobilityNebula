...
/**
 * @brief nai_tcbuffer_cbuffer (TInstant *) — tcbuffer nearest-approach ⊗ Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTcbufferCbuffer";

    NaiTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
