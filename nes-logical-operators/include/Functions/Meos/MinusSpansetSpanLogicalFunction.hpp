...
/**
 * @brief minus_spanset_span over two text literals; type-generic MEOS set-algebra, VARSIZED (intspanset_text).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_spanset_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpansetSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpansetSpan";

    MinusSpansetSpanLogicalFunction(LogicalFunction lit,
