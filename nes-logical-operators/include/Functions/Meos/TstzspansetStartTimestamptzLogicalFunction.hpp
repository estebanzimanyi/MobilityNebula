...
/**
 * @brief tstzspanset_start_timestamptz (TimestampTz) — unary tstzspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_start_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetStartTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetStartTimestamptz";

    TstzspansetStartTimestamptzLogicalFunction(LogicalFunction lit);
