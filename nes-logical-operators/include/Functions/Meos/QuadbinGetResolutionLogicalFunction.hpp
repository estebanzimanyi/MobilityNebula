...
/**
 * @brief Returns a FLOAT64 scalar for a quadbin cell. NES token: QUADBIN_GET_RESOLUTION.
 */
class QuadbinGetResolutionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinGetResolution";

    QuadbinGetResolutionLogicalFunction(LogicalFunction cell);
