...
/**
 * @brief tstzspan_make (Span *) — span constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanMake";

    TstzspanMakeLogicalFunction(LogicalFunction value,
