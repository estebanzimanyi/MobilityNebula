...
/**
 * @brief stbox_to_gbox (GBOX *) - the PostGIS GBOX of a spatiotemporal box.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_to_gbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxToGboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxToGbox";

    StboxToGboxLogicalFunction(LogicalFunction box);
