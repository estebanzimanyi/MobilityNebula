...
/**
 * @brief intersection_spanset_bigint (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_spanset_bigint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpansetBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpansetBigint";

    IntersectionSpansetBigintLogicalFunction(LogicalFunction lit,
