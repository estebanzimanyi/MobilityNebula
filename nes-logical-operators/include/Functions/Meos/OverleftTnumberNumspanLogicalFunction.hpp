...
/**
 * @brief overleft_tnumber_numspan (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_tnumber_numspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftTnumberNumspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftTnumberNumspan";

    OverleftTnumberNumspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
