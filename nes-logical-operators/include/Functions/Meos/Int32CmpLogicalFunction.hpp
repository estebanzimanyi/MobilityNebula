...
/**
 * @brief int32_cmp (int) — scalar comparator.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int32_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class Int32CmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Int32Cmp";

    Int32CmpLogicalFunction(LogicalFunction value,
