...
/**
 * @brief Per-event always-contains between two single-instant tgeompoints.
 *
 ...
 */
class TemporalAContainsTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAContainsTGeometry";

    TemporalAContainsTGeometryLogicalFunction(LogicalFunction lonA,
