...
/**
 * @brief Returns 1 if the float value is contained by the float span.
 */
class ContainedFloatSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedFloatSpan";
    ContainedFloatSpanLogicalFunction(LogicalFunction val, LogicalFunction sp);
