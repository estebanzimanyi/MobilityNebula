...
/**
 * @brief Float contained in span
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_float_span(arg0, temp)`. Per-event scalar operator following the
...
public:
    ...
    ContainedFloatSpanLogicalFunction(LogicalFunction arg0,
                                          LogicalFunction sp);
