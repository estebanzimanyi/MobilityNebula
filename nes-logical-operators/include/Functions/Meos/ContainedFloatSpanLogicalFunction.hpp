...
/**
 * @brief contained_float_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_float_span`. Per-event scalar operator following the
...
public:
    ...
    ContainedFloatSpanLogicalFunction(LogicalFunction lit,
