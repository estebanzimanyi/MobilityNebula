...
/**
 * @brief intset_to_floatset (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intset_to_floatset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntsetToFloatsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntsetToFloatset";

    IntsetToFloatsetLogicalFunction(LogicalFunction lit);
