...
/**
 * @brief tpose_minus_geom (Temporal *) — tpose restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_minus_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeMinusGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeMinusGeom";

    TposeMinusGeomLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
