...
/**
 * @brief tpose_value_at_timestamptz (out-param Pose) — tpose value at a timestamp.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_value_at_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeValueAtTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeValueAtTimestamptz";

    TposeValueAtTimestamptzLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
