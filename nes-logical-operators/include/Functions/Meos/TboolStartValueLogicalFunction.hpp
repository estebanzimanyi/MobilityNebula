...
/**
 * @brief Per-event tbool_start_value: bool accessor over a single-instant tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolStartValue";

    TboolStartValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
