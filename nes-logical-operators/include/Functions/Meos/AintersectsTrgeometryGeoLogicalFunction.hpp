...
/**
 * @brief Returns 1 if the trgeometry instant aintersects the geometry.
 */
class AintersectsTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AintersectsTrgeometryGeo";
    AintersectsTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1, LogicalFunction tgt_wkt);
