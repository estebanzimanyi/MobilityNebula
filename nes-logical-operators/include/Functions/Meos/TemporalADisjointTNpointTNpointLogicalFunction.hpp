...
/**
 * @brief Per-event always-disjoint between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalADisjointTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADisjointTNpointTNpoint";

    TemporalADisjointTNpointTNpointLogicalFunction(LogicalFunction ridA,
