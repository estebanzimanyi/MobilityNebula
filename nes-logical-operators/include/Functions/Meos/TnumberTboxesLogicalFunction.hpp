...
/**
 * @brief tnumber_tboxes (TBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_tboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberTboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberTboxes";

    TnumberTboxesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
