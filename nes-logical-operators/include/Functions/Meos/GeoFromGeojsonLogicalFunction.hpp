...
/**
 * @brief Parses a GeoJSON string and returns the geometry as WKT.
 */
class GeoFromGeojsonLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoFromGeojson";

    GeoFromGeojsonLogicalFunction(LogicalFunction json);
