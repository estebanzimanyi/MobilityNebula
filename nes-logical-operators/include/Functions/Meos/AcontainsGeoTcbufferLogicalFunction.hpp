...
/**
 * @brief acontains_geo_tcbuffer (int) — temporal tcbuffer ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acontains_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AcontainsGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcontainsGeoTcbuffer";

    AcontainsGeoTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
