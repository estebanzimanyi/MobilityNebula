...
/**
 * @brief Returns 1 if float span sp1 contains float span sp2.
 */
class ContainsFloatspanSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsFloatspanSpan";
    ContainsFloatspanSpanLogicalFunction(LogicalFunction sp1, LogicalFunction sp2);
