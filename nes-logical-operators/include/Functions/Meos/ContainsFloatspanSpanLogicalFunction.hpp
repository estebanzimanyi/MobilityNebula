...
/**
 * @brief Floatspan contains floatspan
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_span_span(temp, sp0)`. Per-event scalar operator following the
...
public:
    ...
    ContainsFloatspanSpanLogicalFunction(LogicalFunction sp,
