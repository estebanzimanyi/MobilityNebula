...
/**
 * @brief tintinst_make (TInstant *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tintinst_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintinstMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintinstMake";

    TintinstMakeLogicalFunction(LogicalFunction value,
