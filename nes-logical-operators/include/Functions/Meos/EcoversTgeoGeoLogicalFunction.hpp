...
/**
 * @brief Temporal spatial predicate ecovers_tgeo_geo:
 * (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> float64 (0/1).
 *
 * Generated from the MEOS function `ecovers_tgeo_geo`.
...
public:
    ...
    EcoversTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
