...
/**
 * @brief left_spanset_span over two text literals (parsed as intspanset/intspan_in); type-generic MEOS topology predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `left_spanset_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class LeftSpansetSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LeftSpansetSpan";

    LeftSpansetSpanLogicalFunction(LogicalFunction lit,
