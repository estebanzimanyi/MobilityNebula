...
/**
 * @brief bigintspan_width (int64) — unary bigintspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspan_width`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspanWidthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspanWidth";

    BigintspanWidthLogicalFunction(LogicalFunction lit);
