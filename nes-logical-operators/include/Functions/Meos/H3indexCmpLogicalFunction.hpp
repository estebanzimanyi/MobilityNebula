...
/**
 * @brief Returns -1, 0, or 1 comparison result for two H3 cell indices.
 */
class H3indexCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexCmp";

    H3indexCmpLogicalFunction(LogicalFunction a, LogicalFunction b);
