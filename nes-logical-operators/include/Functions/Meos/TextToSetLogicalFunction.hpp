...
/**
 * @brief text_to_set (Set *) - singleton text set from a text value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `text_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextToSet";

    TextToSetLogicalFunction(LogicalFunction lit);
