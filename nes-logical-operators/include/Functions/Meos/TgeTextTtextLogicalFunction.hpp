...
/**
 * @brief tge_text_ttext (Temporal *) — temporal ttext ⊗ text -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tge_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    TgeTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
