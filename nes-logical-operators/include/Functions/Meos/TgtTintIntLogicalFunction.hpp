...
/**
 * @brief temporal GT: single-instant tint vs scalar int
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgt_tint_int`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TgtTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgtTintInt";

    TgtTintIntLogicalFunction(LogicalFunction value,
