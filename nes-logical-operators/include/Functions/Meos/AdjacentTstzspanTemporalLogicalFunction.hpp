...
/**
 * @brief adjacent_tstzspan_temporal (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentTstzspanTemporal";

    AdjacentTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
