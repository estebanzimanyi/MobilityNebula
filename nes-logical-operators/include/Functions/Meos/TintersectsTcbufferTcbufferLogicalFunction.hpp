...
/**
 * @brief tintersects_tcbuffer_tcbuffer (Temporal *) — two tcbuffer instants -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tintersects_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintersectsTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintersectsTcbufferTcbuffer";

    TintersectsTcbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
