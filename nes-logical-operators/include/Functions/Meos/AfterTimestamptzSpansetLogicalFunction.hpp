...
/**
 * @brief after_timestamptz_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_timestamptz_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterTimestamptzSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterTimestamptzSpanset";

    AfterTimestamptzSpansetLogicalFunction(LogicalFunction lit,
