...
/**
 * @brief contains_tstzspan_temporal (bool) — temporal ⊗ tstzspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsTstzspanTemporal";

    ContainsTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
