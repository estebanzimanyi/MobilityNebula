...
/**
 * @brief intersection_set_timestamptz: extern Set *intersection_set_timestamptz(const Set *s, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_set_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSetTimestamptz";

    IntersectionSetTimestamptzLogicalFunction(LogicalFunction lit,
