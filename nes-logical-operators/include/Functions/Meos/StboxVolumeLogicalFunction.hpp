...
/**
 * @brief stbox_volume (double) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_volume`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxVolumeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxVolume";

    StboxVolumeLogicalFunction(LogicalFunction box);
