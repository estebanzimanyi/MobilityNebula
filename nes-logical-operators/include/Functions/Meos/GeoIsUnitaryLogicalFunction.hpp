...
/**
 * @brief Returns 1.0 if the geometry is a single geometry (not a collection).
 *
 * Args: (wkt:VARCHAR) -> FLOAT64.
 */
class GeoIsUnitaryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoIsUnitary";

    explicit GeoIsUnitaryLogicalFunction(LogicalFunction wkt);
