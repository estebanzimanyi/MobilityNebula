...
/**
 * @brief Per-event overfront_stbox_stbox: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overfront_stbox_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverfrontStboxStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverfrontStboxStbox";

    OverfrontStboxStboxLogicalFunction(LogicalFunction box,
