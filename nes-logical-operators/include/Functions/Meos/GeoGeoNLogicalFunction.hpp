...
/**
 * @brief Returns the nth component geometry from a geometry collection as WKT.
 */
class GeoGeoNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoGeoN";

    GeoGeoNLogicalFunction(LogicalFunction wkt, LogicalFunction n);
