...
/**
 * @brief ever_ne_geo_trgeometry (int) — temporal trgeometry ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_geo_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    EverNeGeoTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
