...
/**
 * @brief Returns 1.0 if the static geometry is ever not equal to the 2D trgeometry instant.
 */
class EverNeGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeGeoTrgeometry";

    EverNeGeoTrgeometryLogicalFunction(LogicalFunction tgt_wkt, LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts);
