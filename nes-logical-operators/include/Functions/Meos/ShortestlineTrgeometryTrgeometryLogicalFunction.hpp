...
/**
 * @brief shortestline_trgeometry_trgeometry (GSERIALIZED *) — two trgeometry instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_trgeometry_trgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTrgeometryTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTrgeometryTrgeometry";

    ShortestlineTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
