...
/**
 * @brief tdistance_trgeometry_geo (Temporal *) — temporal trgeometry ⊗ GSERIALIZED -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_trgeometry_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTrgeometryGeo";

    TdistanceTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
