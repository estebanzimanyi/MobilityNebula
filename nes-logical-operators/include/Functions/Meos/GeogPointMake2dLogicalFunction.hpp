...
/**
 * @brief Make 2D geography point
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geogpoint_make2d((int32_t)srid, x, y)`. Per-event scalar operator following the
...
public:
    ...
    GeogPointMake2dLogicalFunction(LogicalFunction srid,
                                          LogicalFunction x,
                                          LogicalFunction y);
