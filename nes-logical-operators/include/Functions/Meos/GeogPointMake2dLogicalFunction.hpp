...
/**
 * @brief Constructs a 2D geography point from SRID, x, and y as WKT.
 */
class GeogPointMake2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogPointMake2d";

    GeogPointMake2dLogicalFunction(LogicalFunction srid, LogicalFunction x, LogicalFunction y);
