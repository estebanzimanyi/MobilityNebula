...
/**
 * @brief Per-event edisjoint_geo_tgeo: a static geometry vs a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edisjoint_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EdisjointGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EdisjointGeoTgeo";

    EdisjointGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
