...
/**
 * @brief tnumber_valuespans (SpanSet *) — unary temporal -> SpanSet.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_valuespans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberValuespansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberValuespans";

    TnumberValuespansLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
