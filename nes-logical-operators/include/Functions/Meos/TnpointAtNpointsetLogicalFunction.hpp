...
/**
 * @brief tnpoint_at_npointset (Temporal *) — tnpoint restriction by Set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_at_npointset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointAtNpointsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointAtNpointset";

    TnpointAtNpointsetLogicalFunction(LogicalFunction rid,
