...
/**
 * @brief minus_date_span: extern SpanSet *minus_date_span(DateADT d, const Span *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_date_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusDateSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusDateSpan";

    MinusDateSpanLogicalFunction(LogicalFunction lit,
