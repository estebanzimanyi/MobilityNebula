...
/**
 * @brief geog_centroid (GSERIALIZED *) — geodetic measure (use_spheroid=true).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geog_centroid`. Per-event scalar operator following the
...
public:
    ...
    GeogCentroidLogicalFunction(LogicalFunction lit);
