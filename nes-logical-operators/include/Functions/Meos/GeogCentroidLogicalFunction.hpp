...
/**
 * @brief Returns the centroid of a geography (use_spheroid=1 for spheroid, 0 for sphere) as WKT.
 */
class GeogCentroidLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogCentroid";

    GeogCentroidLogicalFunction(LogicalFunction wkt, LogicalFunction use_spheroid);
