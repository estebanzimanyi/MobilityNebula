...
/**
 * @brief ever_eq_trgeometry_geo (int) — temporal trgeometry ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_trgeometry_geo`. Per-event scalar operator following the
...
public:
    ...
    EverEqTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
