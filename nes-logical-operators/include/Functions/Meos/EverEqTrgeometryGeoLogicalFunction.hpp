...
/**
 * @brief Returns 1.0 if the 2D trgeometry instant is ever equal to the static geometry.
 */
class EverEqTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTrgeometryGeo";

    EverEqTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction tgt_wkt);
