...
/**
 * @brief floatset_end_value (double) — unary floatset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetEndValue";

    FloatsetEndValueLogicalFunction(LogicalFunction lit);
