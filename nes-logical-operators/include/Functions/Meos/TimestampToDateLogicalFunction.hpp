...
/**
 * @brief timestamp_to_date (DateADT) — scalar date/time conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamp_to_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestampToDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestampToDate";

    TimestampToDateLogicalFunction(LogicalFunction value);
