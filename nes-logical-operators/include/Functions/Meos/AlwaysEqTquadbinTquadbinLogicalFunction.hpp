...
/**
 * @brief Per-event always_eq_tquadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tquadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTquadbinTquadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
