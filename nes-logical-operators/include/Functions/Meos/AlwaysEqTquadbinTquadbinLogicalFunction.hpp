...
/**
 * @brief Returns 1 if two tquadbin instants always have equal cells.
 */
class AlwaysEqTquadbinTquadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTquadbinTquadbin";
    AlwaysEqTquadbinTquadbinLogicalFunction(LogicalFunction cell1, LogicalFunction ts1, LogicalFunction cell2, LogicalFunction ts2);
