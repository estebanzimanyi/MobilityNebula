...
/**
 * @brief Tests if JSONB value jb1 is greater than jb2.
 */
class JsonbGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbGt";
    JsonbGtLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
