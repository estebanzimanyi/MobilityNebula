...
/**
 * @brief Per-event overleft_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftTnumberTbox";

    OverleftTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
