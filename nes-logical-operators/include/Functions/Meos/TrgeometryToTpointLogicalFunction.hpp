...
/**
 * @brief trgeometry_to_tpoint (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_to_tpoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryToTpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryToTpoint";

    TrgeometryToTpointLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
