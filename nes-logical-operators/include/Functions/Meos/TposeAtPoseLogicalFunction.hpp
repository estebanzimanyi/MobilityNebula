...
/**
 * @brief tpose_at_pose (Temporal *) — tpose restriction by Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_at_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeAtPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeAtPose";

    TposeAtPoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
