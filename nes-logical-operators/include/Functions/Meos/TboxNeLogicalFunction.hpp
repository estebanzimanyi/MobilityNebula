...
/**
 * @brief tbox_ne (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxNe";

    TboxNeLogicalFunction(LogicalFunction lit,
