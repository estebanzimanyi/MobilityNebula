...
/**
 * @brief Per-event nearest-approach distance between a single-instant tfloat and a scalar double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tfloat_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalNADFloatScalarLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADFloatScalar";

    TemporalNADFloatScalarLogicalFunction(LogicalFunction value,
