...
/**
 * @brief geom_to_cbuffer (Cbuffer *) — unary geom accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_to_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeomToCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomToCbuffer";

    GeomToCbufferLogicalFunction(LogicalFunction lit);
