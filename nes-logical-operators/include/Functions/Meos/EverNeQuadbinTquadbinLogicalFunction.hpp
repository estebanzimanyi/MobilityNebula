...
/**
 * @brief Returns 1 if the tquadbin instant ever differs from the Quadbin cell.
 */
class EverNeQuadbinTquadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeQuadbinTquadbin";
    EverNeQuadbinTquadbinLogicalFunction(LogicalFunction cell, LogicalFunction inst_cell, LogicalFunction ts);
