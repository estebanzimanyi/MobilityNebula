...
/**
 * @brief Per-event ever_ne_quadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_quadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    EverNeQuadbinTquadbinLogicalFunction(LogicalFunction arg0,
