...
/**
 * @brief datespan_lower (DateADT) — unary datespan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespan_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespanLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespanLower";

    DatespanLowerLogicalFunction(LogicalFunction lit);
