...
/**
 * @brief timeset_type (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timeset_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimesetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimesetType";

    TimesetTypeLogicalFunction(LogicalFunction lit);
