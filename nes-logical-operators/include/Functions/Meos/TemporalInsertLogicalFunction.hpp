...
/**
 * @brief temporal_insert (Temporal *) — merge a 2nd tint into the 1st.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_insert`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalInsertLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalInsert";

    TemporalInsertLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
