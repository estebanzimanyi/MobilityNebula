...
/**
 * @brief poseset_value_n (out-param Pose, n=1) — poseset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `poseset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PosesetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PosesetValueN";

    PosesetValueNLogicalFunction(LogicalFunction lit);
