...
/**
 * @brief tpose_at_stbox (Temporal *) — tpose restriction by STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_at_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeAtStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeAtStbox";

    TposeAtStboxLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
