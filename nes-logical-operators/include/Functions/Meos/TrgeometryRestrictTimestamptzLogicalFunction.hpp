...
/**
 * @brief trgeometry_restrict_timestamptz (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_restrict_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryRestrictTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryRestrictTimestamptz";

    TrgeometryRestrictTimestamptzLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
