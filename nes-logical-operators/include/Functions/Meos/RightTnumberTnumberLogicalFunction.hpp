...
/**
 * @brief Per-event right_tnumber_tnumber: two hex-WKB temporal operands -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_tnumber_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightTnumberTnumber";

    RightTnumberTnumberLogicalFunction(LogicalFunction traj,
