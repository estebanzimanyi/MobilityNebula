...
/**
 * @brief Geographic area (spheroid=true) of the geometry: (wkt:VARCHAR) -> float64.
 */
class GeogAreaLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogArea";

    explicit GeogAreaLogicalFunction(LogicalFunction wkt1);
