...
/**
 * @brief tcbuffer_minus_geom (Temporal *) — tcbuffer restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_minus_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferMinusGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferMinusGeom";

    TcbufferMinusGeomLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
