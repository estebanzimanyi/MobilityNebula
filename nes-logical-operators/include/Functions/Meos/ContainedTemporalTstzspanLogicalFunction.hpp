...
/**
 * @brief contained_temporal_tstzspan (bool) — temporal ⊗ tstzspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_temporal_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTemporalTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTemporalTstzspan";

    ContainedTemporalTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
