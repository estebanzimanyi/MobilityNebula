...
/**
 * @brief tbox_xmin (out-param double) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_xmin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxXminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxXmin";

    TboxXminLogicalFunction(LogicalFunction lit);
