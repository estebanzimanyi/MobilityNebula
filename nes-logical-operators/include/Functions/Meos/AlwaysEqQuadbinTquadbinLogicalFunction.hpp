...
/**
 * @brief Returns 1 if the tquadbin instant always equals the Quadbin cell.
 */
class AlwaysEqQuadbinTquadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqQuadbinTquadbin";
    AlwaysEqQuadbinTquadbinLogicalFunction(LogicalFunction cell, LogicalFunction inst_cell, LogicalFunction ts);
