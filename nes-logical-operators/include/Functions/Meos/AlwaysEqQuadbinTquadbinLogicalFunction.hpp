...
/**
 * @brief Per-event always_eq_quadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_quadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqQuadbinTquadbinLogicalFunction(LogicalFunction arg0,
