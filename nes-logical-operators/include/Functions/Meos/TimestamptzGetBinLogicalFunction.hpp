...
/**
 * @brief timestamptz_get_bin (TimestampTz) — arity-3 int64 op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_get_bin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzGetBinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzGetBin";

    TimestamptzGetBinLogicalFunction(LogicalFunction value,
