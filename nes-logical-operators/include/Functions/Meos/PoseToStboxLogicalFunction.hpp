...
/**
 * @brief pose_to_stbox (STBox *) — Pose -> STBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseToStbox";

    PoseToStboxLogicalFunction(LogicalFunction lit);
