...
/**
 * @brief posearr_round — round a 1-element Pose array.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `posearr_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PosearrRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PosearrRound";

    PosearrRoundLogicalFunction(LogicalFunction lit);
