...
/**
 * @brief tcbuffer_minus_cbuffer (Temporal *) — tcbuffer restriction by Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_minus_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferMinusCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferMinusCbuffer";

    TcbufferMinusCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
