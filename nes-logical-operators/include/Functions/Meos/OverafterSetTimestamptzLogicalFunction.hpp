...
/**
 * @brief overafter_set_timestamptz (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_set_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterSetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterSetTimestamptz";

    OverafterSetTimestamptzLogicalFunction(LogicalFunction lit,
