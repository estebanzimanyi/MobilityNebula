...
/**
 * @brief union_span_timestamptz: extern SpanSet *union_span_timestamptz(const Span *s, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_span_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSpanTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSpanTimestamptz";

    UnionSpanTimestamptzLogicalFunction(LogicalFunction lit,
