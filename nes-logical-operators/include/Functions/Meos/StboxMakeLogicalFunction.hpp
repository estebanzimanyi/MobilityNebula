...
/**
 * @brief stbox_make (STBox *) - an STBox from hasx/hasz/geodetic, srid, the six bounds (xmin,xmax,ymin,ymax,zmin,zmax) and a time span.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxMake";

    StboxMakeLogicalFunction(LogicalFunction value,
