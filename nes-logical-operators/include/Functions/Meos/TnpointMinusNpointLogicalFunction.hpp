...
/**
 * @brief tnpoint_minus_npoint (Temporal *) — tnpoint restriction by Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_minus_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointMinusNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointMinusNpoint";

    TnpointMinusNpointLogicalFunction(LogicalFunction rid,
