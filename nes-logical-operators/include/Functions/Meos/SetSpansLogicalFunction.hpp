...
/**
 * @brief set_spans (Span *) - the array of singleton spans of a set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetSpans";

    SetSpansLogicalFunction(LogicalFunction lit);
