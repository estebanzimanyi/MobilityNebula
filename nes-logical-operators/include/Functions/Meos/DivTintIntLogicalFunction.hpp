...
/**
 * @brief Per-event div_tint_int: divides a single-instant tint value by a constant integer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_tint_int`. Takes (value:FLOAT64, ts:UINT64, divisor:FLOAT64→int),
 * constructs a single-instant temporal, applies the division, and returns FLOAT64.
 */
class DivTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DivTintInt";

    DivTintIntLogicalFunction(LogicalFunction value,
                              LogicalFunction ts,
