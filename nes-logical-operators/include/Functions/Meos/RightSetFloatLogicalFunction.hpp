...
/**
 * @brief right_set_float (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_set_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightSetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightSetFloat";

    RightSetFloatLogicalFunction(LogicalFunction lit,
