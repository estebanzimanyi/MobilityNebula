...
/**
 * @brief Per-event adisjoint_geo_tgeo: a static geometry vs a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adisjoint_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdisjointGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdisjointGeoTgeo";

    AdisjointGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
