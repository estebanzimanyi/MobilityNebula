...
/**
 * @brief Per-event add_int_tint: scalar int plus single-instant tint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `add_int_tint`. Per-event scalar operator following the
...
public:
    ...
    AddIntTintLogicalFunction(LogicalFunction arg0,
