...
/**
 * @brief Returns 1.0 if two planar geometries are within tolerance distance (default planar).
 *
 * Args: (wkt1:VARCHAR, wkt2:VARCHAR, tolerance:FLOAT64) -> FLOAT64.
 */
class GeomDwithinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomDwithin";

    GeomDwithinLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2, LogicalFunction tolerance);
