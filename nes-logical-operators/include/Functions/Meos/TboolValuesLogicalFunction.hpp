...
/**
 * @brief tbool_values (bool *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolValues";

    TboolValuesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
