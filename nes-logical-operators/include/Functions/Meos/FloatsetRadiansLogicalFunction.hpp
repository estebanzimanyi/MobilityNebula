...
/**
 * @brief floatset_radians (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_radians`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetRadiansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetRadians";

    FloatsetRadiansLogicalFunction(LogicalFunction lit);
