...
/**
 * @brief datespanset_duration (Interval *) — datespanset duration.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_duration`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetDurationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetDuration";

    DatespansetDurationLogicalFunction(LogicalFunction lit);
