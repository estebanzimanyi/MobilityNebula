...
/**
 * @brief before_timestamptz_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_timestamptz_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeTimestamptzSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeTimestamptzSpanset";

    BeforeTimestamptzSpansetLogicalFunction(LogicalFunction lit,
