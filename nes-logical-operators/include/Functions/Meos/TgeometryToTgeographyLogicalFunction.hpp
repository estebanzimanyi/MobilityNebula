...
/**
 * @brief tgeometry_to_tgeography (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeometry_to_tgeography`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeometryToTgeographyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeometryToTgeography";

    TgeometryToTgeographyLogicalFunction(LogicalFunction geomWkt,
                                          LogicalFunction ts);
