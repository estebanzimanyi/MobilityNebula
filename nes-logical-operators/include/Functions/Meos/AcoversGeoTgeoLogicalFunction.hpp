...
/**
 * @brief Per-event acovers_geo_tgeo: a static geometry vs a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_geo_tgeo`. Per-event scalar operator following the
...
public:
    ...
    AcoversGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
