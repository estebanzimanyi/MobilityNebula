...
/**
 * @brief Converts an H3Index cell ID (UINT64) to its hex string representation.
 */
class H3indexOutLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexOut";

    H3indexOutLogicalFunction(LogicalFunction cell);
