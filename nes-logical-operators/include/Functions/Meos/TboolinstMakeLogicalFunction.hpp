...
/**
 * @brief tboolinst_make (TInstant *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tboolinst_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolinstMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolinstMake";

    TboolinstMakeLogicalFunction(LogicalFunction value,
