...
/**
 * @brief floatspanset_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetBins";

    FloatspansetBinsLogicalFunction(LogicalFunction lit,
