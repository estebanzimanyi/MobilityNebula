...
/**
 * @brief bigintspan_upper (int64) — unary bigintspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspan_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspanUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspanUpper";

    BigintspanUpperLogicalFunction(LogicalFunction lit);
