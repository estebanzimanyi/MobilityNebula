...
/**
 * @brief tspatial_set_srid (Temporal *) — SRID set/transform to 4326.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tspatial_set_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TspatialSetSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TspatialSetSrid";

    TspatialSetSridLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
