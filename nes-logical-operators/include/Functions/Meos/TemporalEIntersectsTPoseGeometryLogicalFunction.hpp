...
/**
 * @brief Per-event ever-intersects between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalEIntersectsTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEIntersectsTPoseGeometry";

    TemporalEIntersectsTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
