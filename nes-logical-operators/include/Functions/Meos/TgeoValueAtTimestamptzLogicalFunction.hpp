...
/**
 * @brief tgeo_value_at_timestamptz (out-param GSERIALIZED) — tgeompoint value at a timestamp.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_value_at_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoValueAtTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoValueAtTimestamptz";

    TgeoValueAtTimestamptzLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
