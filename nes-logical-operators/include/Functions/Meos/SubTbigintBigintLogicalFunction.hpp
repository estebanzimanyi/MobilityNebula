...
/**
 * @brief Per-event sub_tbigint_bigint: subtracts a constant int64 from a single-instant tbigint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_tbigint_bigint`. Takes (value:FLOAT64, ts:UINT64, subtrahend:FLOAT64→int64),
 * constructs a single-instant temporal, applies the subtraction, and returns FLOAT64.
 */
class SubTbigintBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SubTbigintBigint";

    SubTbigintBigintLogicalFunction(LogicalFunction value,
                                    LogicalFunction ts,
