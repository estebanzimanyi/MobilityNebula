...
/**
 * @brief Per-event a-covers between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalACoversTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalACoversTCbufferCbuffer";

    TemporalACoversTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
