...
/**
 * @brief tnpoint_at_geom (Temporal *) — tnpoint restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_at_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointAtGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointAtGeom";

    TnpointAtGeomLogicalFunction(LogicalFunction rid,
