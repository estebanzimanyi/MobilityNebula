...
/**
 * @brief nad_tnpoint_npoint (double) — tnpoint nearest-approach ⊗ Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tnpoint_npoint`. Per-event scalar operator following the
...
public:
    ...
    NadTnpointNpointLogicalFunction(LogicalFunction rid,
