...
/**
 * @brief Returns the nearest approach distance between a tnpoint instant and a static npoint.
 */
class NadTnpointNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTnpointNpoint";

    NadTnpointNpointLogicalFunction(LogicalFunction rid1, LogicalFunction pos1, LogicalFunction ts, LogicalFunction rid2, LogicalFunction pos2);
