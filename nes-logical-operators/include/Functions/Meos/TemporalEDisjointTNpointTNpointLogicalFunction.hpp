...
/**
 * @brief Per-event ever-disjoint between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalEDisjointTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointTNpointTNpoint";

    TemporalEDisjointTNpointTNpointLogicalFunction(LogicalFunction ridA,
