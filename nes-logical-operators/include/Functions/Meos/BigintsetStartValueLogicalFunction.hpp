...
/**
 * @brief bigintset_start_value (int64) — unary bigintset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintsetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintsetStartValue";

    BigintsetStartValueLogicalFunction(LogicalFunction lit);
