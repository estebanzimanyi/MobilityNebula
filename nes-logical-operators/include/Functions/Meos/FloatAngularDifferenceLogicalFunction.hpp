...
/**
 * @brief float_angular_difference (double) — scalar float math.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_angular_difference`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatAngularDifferenceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatAngularDifference";

    FloatAngularDifferenceLogicalFunction(LogicalFunction value,
