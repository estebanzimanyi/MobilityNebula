...
/**
 * @brief Converts the first letter of each word in a text string to upper case.
 */
class TextInitcapLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextInitcap";
    TextInitcapLogicalFunction(LogicalFunction str);
