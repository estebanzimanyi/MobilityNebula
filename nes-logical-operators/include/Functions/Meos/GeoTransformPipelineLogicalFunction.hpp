...
/**
 * @brief Reprojects a geometry using a PROJ pipeline string and target SRID, as WKT.
 */
class GeoTransformPipelineLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoTransformPipeline";

    GeoTransformPipelineLogicalFunction(LogicalFunction wkt, LogicalFunction pipeline, LogicalFunction srid_to, LogicalFunction is_forward);
