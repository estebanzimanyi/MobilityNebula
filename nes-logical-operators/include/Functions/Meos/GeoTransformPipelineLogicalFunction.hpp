...
/**
 * @brief geo_transform_pipeline (GSERIALIZED *) — PROJ-pipeline transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_transform_pipeline`. Per-event scalar operator following the
...
public:
    ...
    GeoTransformPipelineLogicalFunction(LogicalFunction lit);
