 ...
 */
class EverLeTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverLeTintTint";

    EverLeTintTintLogicalFunction(LogicalFunction value1,
