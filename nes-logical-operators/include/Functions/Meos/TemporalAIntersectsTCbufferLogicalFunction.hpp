...
/**
 * @brief Per-event always-intersects between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `aintersects_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAIntersectsTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAIntersectsTCbuffer";

    TemporalAIntersectsTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
