 ...
 */
class TgeoAtGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoAtGeom";

    TgeoAtGeomLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
