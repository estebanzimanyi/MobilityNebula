...
/**
 * @brief spanset_lt (bool) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_lt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetLtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetLt";

    SpansetLtLogicalFunction(LogicalFunction lit,
