...
/**
 * @brief stbox_tmin_inc (out-param bool) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_tmin_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxTminIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxTminInc";

    StboxTminIncLogicalFunction(LogicalFunction box);
