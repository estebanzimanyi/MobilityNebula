...
/**
 * @brief spanset_span_n (Span *) - the n-th span of a span set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_span_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetSpanNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetSpanN";

    SpansetSpanNLogicalFunction(LogicalFunction lit,
