...
/**
 * @brief Returns 1 if two tquadbin instants always have different cells.
 */
class AlwaysNeTquadbinTquadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTquadbinTquadbin";
    AlwaysNeTquadbinTquadbinLogicalFunction(LogicalFunction cell1, LogicalFunction ts1, LogicalFunction cell2, LogicalFunction ts2);
