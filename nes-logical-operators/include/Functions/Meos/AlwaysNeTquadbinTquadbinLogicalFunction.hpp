...
/**
 * @brief Per-event always_ne_tquadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tquadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTquadbinTquadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
