...
/**
 * @brief ttouches_tcbuffer_geo (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttouches_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtouchesTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtouchesTcbufferGeo";

    TtouchesTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
