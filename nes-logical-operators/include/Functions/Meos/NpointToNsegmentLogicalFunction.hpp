...
/**
 * @brief npoint_to_nsegment (Nsegment *) — unary npoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_to_nsegment`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointToNsegmentLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointToNsegment";

    NpointToNsegmentLogicalFunction(LogicalFunction lit);
