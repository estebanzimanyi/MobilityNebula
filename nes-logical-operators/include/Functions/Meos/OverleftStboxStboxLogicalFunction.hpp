...
/**
 * @brief Per-event overleft_stbox_stbox: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_stbox_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftStboxStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftStboxStbox";

    OverleftStboxStboxLogicalFunction(LogicalFunction box,
