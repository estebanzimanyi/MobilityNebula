...
/**
 * @brief intersection_set_npoint (Set *) — object-set ± npoint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_set_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSetNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSetNpoint";

    IntersectionSetNpointLogicalFunction(LogicalFunction lit,
