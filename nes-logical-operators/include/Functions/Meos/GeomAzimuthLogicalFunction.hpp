...
/**
 * @brief geom_azimuth (out-param double) — geometry azimuth/bearing.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_azimuth`. Per-event scalar operator following the
...
public:
    ...
    GeomAzimuthLogicalFunction(LogicalFunction lit,
