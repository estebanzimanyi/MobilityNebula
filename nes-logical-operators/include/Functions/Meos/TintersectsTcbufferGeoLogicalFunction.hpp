...
/**
 * @brief tintersects_tcbuffer_geo (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tintersects_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintersectsTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintersectsTcbufferGeo";

    TintersectsTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
