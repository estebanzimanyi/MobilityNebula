...
/**
 * @brief distance_set_float (double) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_set_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceSetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceSetFloat";

    DistanceSetFloatLogicalFunction(LogicalFunction lit,
