...
/**
 * @brief Constructs a 3DZ geometry point from SRID, x, y, and z as WKT.
 */
class GeomPointMake3dzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomPointMake3dz";

    GeomPointMake3dzLogicalFunction(LogicalFunction srid, LogicalFunction x, LogicalFunction y, LogicalFunction z);
