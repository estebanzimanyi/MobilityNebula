...
/**
 * @brief temporal_before_timestamptz (Temporal *) — tfloat restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_before_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalBeforeTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalBeforeTimestamptz";

    TemporalBeforeTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
