...
/**
 * @brief before_date_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_date_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeDateSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeDateSpanset";

    BeforeDateSpansetLogicalFunction(LogicalFunction lit,
