...
/**
 * @brief tint_at_value (Temporal *) — temporal tint ⊗ int -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_at_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintAtValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintAtValue";

    TintAtValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
