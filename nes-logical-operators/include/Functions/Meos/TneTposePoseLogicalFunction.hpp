...
/**
 * @brief tne_tpose_pose (Temporal *) — temporal tpose ⊗ Pose -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_tpose_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TneTposePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TneTposePose";

    TneTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
