...
/**
 * @brief contains_span_int (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_span_int`. Per-event scalar operator following the
...
public:
    ...
    ContainsSpanIntLogicalFunction(LogicalFunction lit,
