...
/**
 * @brief Returns 1 if the integer span contains the integer value.
 */
class ContainsSpanIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSpanInt";
    ContainsSpanIntLogicalFunction(LogicalFunction sp, LogicalFunction val);
