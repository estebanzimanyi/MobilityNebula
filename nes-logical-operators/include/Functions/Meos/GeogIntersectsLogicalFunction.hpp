...
/**
 * @brief geog_intersects (bool) — geometry op with fixed true.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geog_intersects`. Per-event scalar operator following the
...
public:
    ...
    GeogIntersectsLogicalFunction(LogicalFunction lit,
