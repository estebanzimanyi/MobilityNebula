...
/**
 * @brief Returns 1.0 if two geographic geometries intersect (spheroidal).
 *
 * Args: (wkt1:VARCHAR, wkt2:VARCHAR) -> FLOAT64.
 */
class GeogIntersectsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogIntersects";

    GeogIntersectsLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
