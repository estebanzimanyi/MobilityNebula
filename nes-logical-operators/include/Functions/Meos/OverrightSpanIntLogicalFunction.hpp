...
/**
 * @brief overright_span_int (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_span_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightSpanIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightSpanInt";

    OverrightSpanIntLogicalFunction(LogicalFunction lit,
