...
/**
 * @brief spanset_upper_inc (bool) — unary intspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_upper_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetUpperIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetUpperInc";

    SpansetUpperIncLogicalFunction(LogicalFunction lit);
