...
/**
 * @brief spanset_split_n_spans (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_split_n_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetSplitNSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetSplitNSpans";

    SpansetSplitNSpansLogicalFunction(LogicalFunction lit,
