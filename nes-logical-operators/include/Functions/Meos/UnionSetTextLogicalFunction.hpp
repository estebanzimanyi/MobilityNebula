...
/**
 * @brief union_set_text: extern Set *union_set_text(const Set *s, const text *txt);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_set_text`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSetTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSetText";

    UnionSetTextLogicalFunction(LogicalFunction lit,
