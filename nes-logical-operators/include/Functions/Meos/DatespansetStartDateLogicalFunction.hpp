...
/**
 * @brief datespanset_start_date (DateADT) — unary datespanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_start_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetStartDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetStartDate";

    DatespansetStartDateLogicalFunction(LogicalFunction lit);
