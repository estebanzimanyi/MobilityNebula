...
/**
 * @brief stbox_tmax_inc (out-param bool) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_tmax_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxTmaxIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxTmaxInc";

    StboxTmaxIncLogicalFunction(LogicalFunction box);
