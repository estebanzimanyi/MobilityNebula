...
/**
 * @brief Per-event always_eq_bool_tbool: always-equal scalar bool vs tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqBoolTboolLogicalFunction(LogicalFunction arg0,
