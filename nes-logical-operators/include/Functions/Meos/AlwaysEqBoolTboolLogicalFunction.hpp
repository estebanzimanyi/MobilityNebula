...
/**
 * @brief Per-event always_eq_bool_tbool: tests if a single-instant tfloat value ever equals a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_bool_tbool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysEqBoolTboolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqBoolTbool";

    AlwaysEqBoolTboolLogicalFunction(LogicalFunction value,
