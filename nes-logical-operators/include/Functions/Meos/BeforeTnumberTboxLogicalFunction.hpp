...
/**
 * @brief Per-event before_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeTnumberTbox";

    BeforeTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
