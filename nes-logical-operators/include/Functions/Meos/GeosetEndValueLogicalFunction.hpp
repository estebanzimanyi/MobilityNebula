...
/**
 * @brief geoset_end_value (GSERIALIZED *) — unary geoset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geoset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeosetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeosetEndValue";

    GeosetEndValueLogicalFunction(LogicalFunction lit);
