...
/**
 * @brief ever_ne_tpose_pose (int) — always/ever tpose ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tpose_pose`. Per-event scalar operator following the
...
public:
    ...
    EverNeTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
