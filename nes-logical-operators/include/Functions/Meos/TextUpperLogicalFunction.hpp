...
/**
 * @brief Converts a text string to upper case.
 */
class TextUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextUpper";
    TextUpperLogicalFunction(LogicalFunction str);
