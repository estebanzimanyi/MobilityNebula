...
/**
 * @brief ever_eq_trgeometry_trgeometry (bool) — two trgeometry instants -> int reduction.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_trgeometry_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    EverEqTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
