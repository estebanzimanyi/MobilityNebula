...
/**
 * @brief cbuffer_radius (double) — unary cbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_radius`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferRadiusLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferRadius";

    CbufferRadiusLogicalFunction(LogicalFunction lit);
