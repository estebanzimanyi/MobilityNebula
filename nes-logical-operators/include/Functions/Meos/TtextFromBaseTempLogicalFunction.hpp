...
/**
 * @brief ttext_from_base_temp (Temporal *) — temporal ttext ⊗ text -> ttext_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_from_base_temp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextFromBaseTempLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextFromBaseTemp";

    TtextFromBaseTempLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
