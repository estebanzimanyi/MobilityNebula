...
/**
 * @brief Per-event ever-dwithin between two tgeompoints resolved from tnpoints via tnpoint_to_tgeompoint, within a distance.
 *
 ...
 */
class TemporalEDWithinTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTNpointTNpoint";

    TemporalEDWithinTNpointTNpointLogicalFunction(LogicalFunction ridA,
