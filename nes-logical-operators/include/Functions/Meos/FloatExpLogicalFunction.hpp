...
/**
 * @brief float_exp (double) — scalar float math.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_exp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatExpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatExp";

    FloatExpLogicalFunction(LogicalFunction value);
