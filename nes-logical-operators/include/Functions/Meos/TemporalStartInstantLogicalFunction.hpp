...
/**
 * @brief temporal_start_instant (TInstant *) — unary tfloat accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_start_instant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalStartInstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalStartInstant";

    TemporalStartInstantLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
