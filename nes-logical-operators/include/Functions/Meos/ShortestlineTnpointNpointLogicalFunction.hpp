...
/**
 * @brief shortestline_tnpoint_npoint (GSERIALIZED *) — tnpoint nearest-approach ⊗ Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tnpoint_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTnpointNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTnpointNpoint";

    ShortestlineTnpointNpointLogicalFunction(LogicalFunction rid,
