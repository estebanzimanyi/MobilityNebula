...
/**
 * @brief nad_trgeometry_stbox (double) - nearest-approach distance between a temporal rigid geometry and an STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_trgeometry_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTrgeometryStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTrgeometryStbox";

    NadTrgeometryStboxLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
