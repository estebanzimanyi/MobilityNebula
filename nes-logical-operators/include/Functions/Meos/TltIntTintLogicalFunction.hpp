...
/**
 * @brief temporal LT: scalar int vs single-instant tint
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tlt_int_tint`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TltIntTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TltIntTint";

    TltIntTintLogicalFunction(LogicalFunction value,
