...
/**
 * @brief acovers_cbuffer_tcbuffer (int) — temporal tcbuffer ⊗ Cbuffer -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AcoversCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcoversCbufferTcbuffer";

    AcoversCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
