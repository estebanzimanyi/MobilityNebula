...
/**
 * @brief interptype_name (const char *) - the name of an interpolation type.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `interptype_name`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class InterptypeNameLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "InterptypeName";

    InterptypeNameLogicalFunction(LogicalFunction value);
