...
/**
 * @brief Per-event tbool_end_value: bool accessor over a single-instant tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolEndValue";

    TboolEndValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
