...
/**
 * @brief Returns the lower bound of a float span.
 */
class FloatspanLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanLower";
    FloatspanLowerLogicalFunction(LogicalFunction sp);
