...
/**
 * @brief floatspan_lower (double) — unary floatspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_lower`. Per-event scalar operator following the
...
public:
    ...
    FloatspanLowerLogicalFunction(LogicalFunction lit);
