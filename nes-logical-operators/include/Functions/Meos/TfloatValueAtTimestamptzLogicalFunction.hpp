...
/**
 * @brief tfloat_value_at_timestamptz (out-param double) — tfloat value at a timestamp.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_value_at_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatValueAtTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatValueAtTimestamptz";

    TfloatValueAtTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
