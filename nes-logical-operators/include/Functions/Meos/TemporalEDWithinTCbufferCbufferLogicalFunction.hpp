...
/**
 * @brief Per-event ever-distance-within between a single-instant tcbuffer and a static Cbuffer under a fixed threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edwithin_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEDWithinTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTCbufferCbuffer";

    TemporalEDWithinTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
