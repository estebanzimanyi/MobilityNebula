...
/**
 * @brief intset_start_value (int) — unary intset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntsetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntsetStartValue";

    IntsetStartValueLogicalFunction(LogicalFunction lit);
