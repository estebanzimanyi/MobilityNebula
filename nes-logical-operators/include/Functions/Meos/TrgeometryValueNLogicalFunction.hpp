...
/**
 * @brief trgeometry_value_n (out-param GSERIALIZED, n=1) — trgeometry value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryValueN";

    TrgeometryValueNLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
