...
/**
 * @brief tstzspan_shift_scale (container, interval shift, interval duration) -> shifted+scaled tstzspan.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanShiftScale";

    TstzspanShiftScaleLogicalFunction(LogicalFunction lit,
