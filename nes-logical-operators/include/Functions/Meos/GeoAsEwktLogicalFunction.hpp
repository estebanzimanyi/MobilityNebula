...
/**
 * @brief Serializes a geometry to EWKT with the given coordinate precision.
 */
class GeoAsEwktLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoAsEwkt";

    GeoAsEwktLogicalFunction(LogicalFunction wkt, LogicalFunction precision);
