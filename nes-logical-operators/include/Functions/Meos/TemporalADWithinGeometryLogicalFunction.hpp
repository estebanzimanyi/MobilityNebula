...
/**
 * @brief Per-event always-distance-within between a single-instant tgeompoint and a static geometry under a static threshold.
 *
 ...
 */
class TemporalADWithinGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinGeometry";

    TemporalADWithinGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
