...
/**
 * @brief Returns 1.0 if temporal geometry ever contains the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class EcontainsTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcontainsTgeoGeo";

    EcontainsTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
