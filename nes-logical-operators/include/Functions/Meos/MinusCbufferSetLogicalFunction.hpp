...
/**
 * @brief minus_cbuffer_set (Set *) — object-set ± cbuffer value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_cbuffer_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusCbufferSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusCbufferSet";

    MinusCbufferSetLogicalFunction(LogicalFunction lit,
