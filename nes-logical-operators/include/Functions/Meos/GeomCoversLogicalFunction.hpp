...
/**
 * @brief Static geometry function geom_covers: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function `geom_covers`.
 */
class GeomCoversLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomCovers";

    GeomCoversLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
