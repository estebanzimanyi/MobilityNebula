...
/**
 * @brief right_spanset_span over two text literals (parsed as intspanset/intspan_in); type-generic MEOS topology predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_spanset_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightSpansetSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightSpansetSpan";

    RightSpansetSpanLogicalFunction(LogicalFunction lit,
