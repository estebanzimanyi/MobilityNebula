...
/**
 * @brief Per-event ever-intersects between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalEIntersectsTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEIntersectsTNpointTNpoint";

    TemporalEIntersectsTNpointTNpointLogicalFunction(LogicalFunction ridA,
