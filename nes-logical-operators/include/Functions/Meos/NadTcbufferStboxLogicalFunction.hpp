...
/**
 * @brief Per-event nad_tcbuffer_stbox: single-instant tcbuffer against a stbox literal -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tcbuffer_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTcbufferStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTcbufferStbox";

    NadTcbufferStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
