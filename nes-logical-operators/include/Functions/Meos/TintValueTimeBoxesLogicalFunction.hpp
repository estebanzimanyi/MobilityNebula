...
/**
 * @brief tint_value_time_boxes (TBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_value_time_boxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValueTimeBoxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValueTimeBoxes";

    TintValueTimeBoxesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
