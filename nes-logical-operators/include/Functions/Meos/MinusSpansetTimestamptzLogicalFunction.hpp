...
/**
 * @brief minus_spanset_timestamptz: extern SpanSet *minus_spanset_timestamptz(const SpanSet *ss, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_spanset_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpansetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpansetTimestamptz";

    MinusSpansetTimestamptzLogicalFunction(LogicalFunction lit,
