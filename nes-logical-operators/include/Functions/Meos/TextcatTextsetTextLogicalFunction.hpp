...
/**
 * @brief textcat_textset_text (Set *) - concatenate a text value onto every element of a text set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_textset_text`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextcatTextsetTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextcatTextsetText";

    TextcatTextsetTextLogicalFunction(LogicalFunction lit,
