...
/**
 * @brief Per-event ever-contains between two single-instant tgeompoints built from event fields.
 *
 ...
 */
class TemporalEContainsTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEContainsTGeometry";

    TemporalEContainsTGeometryLogicalFunction(LogicalFunction lonA,
