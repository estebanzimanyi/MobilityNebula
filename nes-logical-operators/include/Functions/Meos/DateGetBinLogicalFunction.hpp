...
/**
 * @brief date_get_bin (DateADT) — arity-3 int op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `date_get_bin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DateGetBinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DateGetBin";

    DateGetBinLogicalFunction(LogicalFunction value,
