...
/**
 * @brief Returns 1 if integer span sp1 contains integer span sp2.
 */
class ContainsSpanSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSpanSpan";
    ContainsSpanSpanLogicalFunction(LogicalFunction sp1, LogicalFunction sp2);
