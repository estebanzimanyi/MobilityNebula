...
/**
 * @brief distance_floatspanset_floatspan (double) — SpanSet/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_floatspanset_floatspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceFloatspansetFloatspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceFloatspansetFloatspan";

    DistanceFloatspansetFloatspanLogicalFunction(LogicalFunction lit,
