...
/**
 * @brief tstzset_shift_scale (container, interval shift, interval duration) -> shifted+scaled tstzset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetShiftScale";

    TstzsetShiftScaleLogicalFunction(LogicalFunction lit,
