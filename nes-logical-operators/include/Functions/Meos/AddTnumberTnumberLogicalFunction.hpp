...
/**
 * @brief Per-event add_tnumber_tnumber: two hex-WKB temporal operands -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `add_tnumber_tnumber`. Per-event scalar operator following the
...
public:
    ...
    AddTnumberTnumberLogicalFunction(LogicalFunction traj,
