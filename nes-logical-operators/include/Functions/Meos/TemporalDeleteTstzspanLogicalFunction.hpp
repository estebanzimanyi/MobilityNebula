...
/**
 * @brief temporal_delete_tstzspan (Temporal *) — tfloat restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_delete_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalDeleteTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalDeleteTstzspan";

    TemporalDeleteTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
