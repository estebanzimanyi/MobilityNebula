...
/**
 * @brief tpoint_get_z (Temporal *) — temporal-point accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_get_z`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointGetZLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointGetZ";

    TpointGetZLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction z,
                                          LogicalFunction ts);
