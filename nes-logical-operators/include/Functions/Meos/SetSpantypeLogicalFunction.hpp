...
/**
 * @brief set_spantype (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_spantype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetSpantypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetSpantype";

    SetSpantypeLogicalFunction(LogicalFunction lit);
