...
/**
 * @brief pose_ne (bool) — Pose scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseNe";

    PoseNeLogicalFunction(LogicalFunction lit,
