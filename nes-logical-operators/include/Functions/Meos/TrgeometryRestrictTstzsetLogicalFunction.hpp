...
/**
 * @brief trgeometry_restrict_tstzset (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_restrict_tstzset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryRestrictTstzsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryRestrictTstzset";

    TrgeometryRestrictTstzsetLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
