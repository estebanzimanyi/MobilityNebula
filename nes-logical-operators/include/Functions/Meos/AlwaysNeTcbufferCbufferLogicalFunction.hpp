...
/**
 * @brief Per-event always_ne_tcbuffer_cbuffer between a single-instant tcbuffer and a static cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tcbuffer_cbuffer`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
