...
/**
 * @brief left_numspan_tnumber (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `left_numspan_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class LeftNumspanTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LeftNumspanTnumber";

    LeftNumspanTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
