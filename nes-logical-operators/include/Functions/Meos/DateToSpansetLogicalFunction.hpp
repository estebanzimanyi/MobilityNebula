...
/**
 * @brief date_to_spanset (date value) -> spanset (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `date_to_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DateToSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DateToSpanset";

    DateToSpansetLogicalFunction(LogicalFunction value);
