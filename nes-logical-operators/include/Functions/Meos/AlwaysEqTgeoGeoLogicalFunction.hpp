...
/**
 * @brief Returns 1.0 if the temporal geometry is always equal to the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class AlwaysEqTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTgeoGeo";

    AlwaysEqTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
