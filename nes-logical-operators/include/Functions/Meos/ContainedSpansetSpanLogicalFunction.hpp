...
/**
 * @brief contained_spanset_span over two text literals (parsed as intspanset/intspan_in); type-generic MEOS topology predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_spanset_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedSpansetSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedSpansetSpan";

    ContainedSpansetSpanLogicalFunction(LogicalFunction lit,
