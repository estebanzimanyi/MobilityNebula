...
/**
 * @brief Returns the H3 parent cell at resolution-1 as a hex string.
 *
 * Args: (cell:UINT64, ts:UINT64) -> VARCHAR.
 */
class Th3indexCellToParentNextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexCellToParentNext";

    Th3indexCellToParentNextLogicalFunction(LogicalFunction cell, LogicalFunction ts);
