...
/**
 * @brief Per-event tbigint_shift_scale_value: shifts and scales a single-instant tbigint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbigint_shift_scale_value`. Takes (value:FLOAT64, ts:UINT64, shift:FLOAT64→int64_t, width:FLOAT64→int64_t),
 * constructs a single-instant temporal, applies the shift-and-scale, and returns FLOAT64.
 */
class TbigintShiftScaleValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TbigintShiftScaleValue";

    TbigintShiftScaleValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
