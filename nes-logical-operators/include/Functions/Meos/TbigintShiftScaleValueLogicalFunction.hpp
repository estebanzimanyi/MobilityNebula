...
/**
 * @brief Per-event tbigint_shift_scale_value: shift then scale single-instant tbigint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbigint_shift_scale_value`. Per-event scalar operator following the
