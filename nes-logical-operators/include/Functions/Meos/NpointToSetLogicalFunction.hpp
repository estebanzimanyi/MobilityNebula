...
/**
 * @brief npoint_to_set (Set *) — object -> singleton set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointToSet";

    NpointToSetLogicalFunction(LogicalFunction lit);
