...
/**
 * @brief Returns the convex hull of a geometry as WKT.
 */
class GeomConvexHullLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomConvexHull";

    GeomConvexHullLogicalFunction(LogicalFunction wkt);
