...
/**
 * @brief geom_convex_hull (GSERIALIZED *) — unary geom accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_convex_hull`. Per-event scalar operator following the
...
public:
    ...
    GeomConvexHullLogicalFunction(LogicalFunction lit);
