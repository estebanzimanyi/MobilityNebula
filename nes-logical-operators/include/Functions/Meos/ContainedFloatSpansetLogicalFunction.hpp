...
/**
 * @brief contained_float_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_float_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedFloatSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedFloatSpanset";

    ContainedFloatSpansetLogicalFunction(LogicalFunction lit,
