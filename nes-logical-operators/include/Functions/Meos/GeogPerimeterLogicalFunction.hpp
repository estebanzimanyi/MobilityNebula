...
/**
 * @brief Geographic perimeter (spheroid=true) of the geometry: (wkt:VARCHAR) -> float64.
 */
class GeogPerimeterLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogPerimeter";

    explicit GeogPerimeterLogicalFunction(LogicalFunction wkt1);
