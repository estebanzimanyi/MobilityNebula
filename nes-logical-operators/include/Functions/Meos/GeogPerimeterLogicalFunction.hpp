...
/**
 * @brief geog_perimeter (double) — geodetic measure (use_spheroid=true).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geog_perimeter`. Per-event scalar operator following the
...
public:
    ...
    GeogPerimeterLogicalFunction(LogicalFunction lit);
