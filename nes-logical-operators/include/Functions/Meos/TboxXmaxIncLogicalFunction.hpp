...
/**
 * @brief tbox_xmax_inc (out-param bool) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_xmax_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxXmaxIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxXmaxInc";

    TboxXmaxIncLogicalFunction(LogicalFunction lit);
