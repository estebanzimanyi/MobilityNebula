...
/**
 * @brief Per-event overabove_tspatial_stbox: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overabove_tspatial_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OveraboveTspatialStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OveraboveTspatialStbox";

    OveraboveTspatialStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
