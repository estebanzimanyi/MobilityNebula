...
/**
 * @brief Tests if H3 cell index a is greater than b.
 */
class H3indexGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexGt";

    H3indexGtLogicalFunction(LogicalFunction a, LogicalFunction b);
