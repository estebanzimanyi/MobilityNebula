...
/**
 * @brief after_temporal_tstzspan (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_temporal_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterTemporalTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterTemporalTstzspan";

    AfterTemporalTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
