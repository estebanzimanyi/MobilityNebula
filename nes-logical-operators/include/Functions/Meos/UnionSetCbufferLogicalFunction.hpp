...
/**
 * @brief union_set_cbuffer (Set *) — object-set ± cbuffer value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_set_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSetCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSetCbuffer";

    UnionSetCbufferLogicalFunction(LogicalFunction lit,
