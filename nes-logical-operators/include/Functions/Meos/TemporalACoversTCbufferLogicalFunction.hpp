...
/**
 * @brief Per-event always-covers between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalACoversTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalACoversTCbuffer";

    TemporalACoversTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
