...
/**
 * @brief datespanset_shift_scale (container, int shift, int width, true, true) -> shifted+scaled datespanset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetShiftScale";

    DatespansetShiftScaleLogicalFunction(LogicalFunction lit,
