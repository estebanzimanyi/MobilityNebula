...
/**
 * @brief temporal_to_tsequenceset (TSequenceSet *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_to_tsequenceset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalToTsequencesetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalToTsequenceset";

    TemporalToTsequencesetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
