...
/**
 * @brief Returns the center point of the minimum bounding circle of a geometry as WKT.
 */
class GeomMinBoundingCenterLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomMinBoundingCenter";

    GeomMinBoundingCenterLogicalFunction(LogicalFunction wkt);
