...
/**
 * @brief Per-event overright_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightTnumberTbox";

    OverrightTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
