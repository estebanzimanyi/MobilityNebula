...
/**
 * @brief Per-event always_ge_tfloat_float: tests if a single-instant tfloat value always is greater than or equal to a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ge_tfloat_float`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysGeTfloatFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysGeTfloatFloat";

    AlwaysGeTfloatFloatLogicalFunction(LogicalFunction value,
