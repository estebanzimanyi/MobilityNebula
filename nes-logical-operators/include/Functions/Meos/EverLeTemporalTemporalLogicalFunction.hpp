...
/**
 * @brief Per-event ever_le_temporal_temporal: tests if a single-instant tfloat value ever equals a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_le_temporal_temporal`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class EverLeTemporalTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverLeTemporalTemporal";

    EverLeTemporalTemporalLogicalFunction(LogicalFunction value,
