...
/**
 * @brief Converts a geometry to a geography as WKT.
 */
class GeomToGeogLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomToGeog";

    GeomToGeogLogicalFunction(LogicalFunction wkt);
