...
/**
 * @brief add_timestamptz_interval (TimestampTz) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `add_timestamptz_interval`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AddTimestamptzIntervalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AddTimestamptzInterval";

    AddTimestamptzIntervalLogicalFunction(LogicalFunction value,
