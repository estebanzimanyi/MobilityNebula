...
/**
 * @brief stbox_ymin (out-param double) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_ymin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxYminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxYmin";

    StboxYminLogicalFunction(LogicalFunction box);
