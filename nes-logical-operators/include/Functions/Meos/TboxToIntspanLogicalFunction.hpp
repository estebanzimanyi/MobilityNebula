...
/**
 * @brief tbox_to_intspan (Span *) — TBox -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_to_intspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxToIntspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxToIntspan";

    TboxToIntspanLogicalFunction(LogicalFunction lit);
