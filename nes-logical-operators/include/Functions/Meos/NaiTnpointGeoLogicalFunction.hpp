...
/**
 * @brief nai_tnpoint_geo (TInstant *) — tnpoint nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tnpoint_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTnpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTnpointGeo";

    NaiTnpointGeoLogicalFunction(LogicalFunction rid,
