...
/**
 * @brief tbox_tmin (out-param TimestampTz) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_tmin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxTminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxTmin";

    TboxTminLogicalFunction(LogicalFunction lit);
