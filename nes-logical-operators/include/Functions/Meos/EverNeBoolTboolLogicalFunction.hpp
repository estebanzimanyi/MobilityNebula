...
/**
 * @brief Per-event ever_ne_bool_tbool: ever-not-equal scalar bool vs tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    EverNeBoolTboolLogicalFunction(LogicalFunction arg0,
