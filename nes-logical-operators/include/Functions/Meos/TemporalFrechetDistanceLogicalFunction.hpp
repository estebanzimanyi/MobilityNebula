...
/**
 * @brief Per-event temporal_frechet_distance between two single-instant tgeompoints -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_frechet_distance`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalFrechetDistanceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalFrechetDistance";

    TemporalFrechetDistanceLogicalFunction(LogicalFunction lonA,
