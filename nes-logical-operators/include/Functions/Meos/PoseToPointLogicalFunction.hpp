...
/**
 * @brief pose_to_point (GSERIALIZED *) — unary pose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_to_point`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseToPointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseToPoint";

    PoseToPointLogicalFunction(LogicalFunction lit);
