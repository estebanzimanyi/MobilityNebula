...
/**
 * @brief temporal_at_timestamptz (Temporal *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_at_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAtTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAtTimestamptz";

    TemporalAtTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
