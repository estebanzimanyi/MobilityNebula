...
/**
 * @brief tgeography_to_tgeometry (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeography_to_tgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeographyToTgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeographyToTgeometry";

    TgeographyToTgeometryLogicalFunction(LogicalFunction geomWkt,
                                          LogicalFunction ts);
