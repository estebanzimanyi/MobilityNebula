...
/**
 * @brief Returns 1.0 if the tnpoint instant is always equal to the static npoint, 0.0 otherwise.
 */
class AlwaysEqTnpointNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTnpointNpoint";

    AlwaysEqTnpointNpointLogicalFunction(LogicalFunction rid1, LogicalFunction pos1, LogicalFunction ts, LogicalFunction rid2, LogicalFunction pos2);
