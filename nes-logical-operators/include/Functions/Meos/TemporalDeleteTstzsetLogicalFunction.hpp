...
/**
 * @brief temporal_delete_tstzset (Temporal *) — tfloat restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_delete_tstzset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalDeleteTstzsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalDeleteTstzset";

    TemporalDeleteTstzsetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
