 ...
 */
class TgeoMinusGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoMinusGeom";

    TgeoMinusGeomLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
