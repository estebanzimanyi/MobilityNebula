...
/**
 * @brief tcontains_tcbuffer_geo (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcontains_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcontainsTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcontainsTcbufferGeo";

    TcontainsTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
