...
/**
 * @brief distance_spanset_int (int) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_spanset_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceSpansetIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceSpansetInt";

    DistanceSpansetIntLogicalFunction(LogicalFunction lit,
