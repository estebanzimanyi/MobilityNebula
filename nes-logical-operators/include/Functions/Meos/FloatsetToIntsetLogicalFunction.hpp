...
/**
 * @brief floatset_to_intset (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_to_intset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetToIntsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetToIntset";

    FloatsetToIntsetLogicalFunction(LogicalFunction lit);
