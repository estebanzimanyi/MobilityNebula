...
/**
 * @brief trgeometry_restrict_tstzspanset (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_restrict_tstzspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryRestrictTstzspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryRestrictTstzspanset";

    TrgeometryRestrictTstzspansetLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
