...
/**
 * @brief tstzspan_to_datespan (Span *) — Span -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_to_datespan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanToDatespanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanToDatespan";

    TstzspanToDatespanLogicalFunction(LogicalFunction lit);
