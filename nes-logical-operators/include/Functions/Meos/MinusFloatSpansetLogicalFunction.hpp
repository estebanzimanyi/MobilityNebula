...
/**
 * @brief minus_float_spanset (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_float_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusFloatSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusFloatSpanset";

    MinusFloatSpansetLogicalFunction(LogicalFunction lit,
