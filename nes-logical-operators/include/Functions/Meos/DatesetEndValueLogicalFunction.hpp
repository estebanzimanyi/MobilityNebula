...
/**
 * @brief dateset_end_value (DateADT) — unary dateset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `dateset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatesetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatesetEndValue";

    DatesetEndValueLogicalFunction(LogicalFunction lit);
