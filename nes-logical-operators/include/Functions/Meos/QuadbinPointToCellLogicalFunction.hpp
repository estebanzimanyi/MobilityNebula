...
/**
 * @brief Quadbin point to cell
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `quadbin_point_to_cell(lon, lat, (uint32_t)res)`. Per-event scalar operator following the
...
public:
    ...
    QuadbinPointToCellLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction res);
