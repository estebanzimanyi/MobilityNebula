...
/**
 * @brief Returns a VARCHAR for a quadbin cell. NES token: QUADBIN_POINT_TO_CELL.
 */
class QuadbinPointToCellLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinPointToCell";

    QuadbinPointToCellLogicalFunction(LogicalFunction lon, LogicalFunction lat, LogicalFunction res);
