...
/**
 * @brief overbefore_temporal_tstzspan (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbefore_temporal_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbeforeTemporalTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbeforeTemporalTstzspan";

    OverbeforeTemporalTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
