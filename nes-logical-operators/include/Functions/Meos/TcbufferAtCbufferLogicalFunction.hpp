...
/**
 * @brief tcbuffer_at_cbuffer (Temporal *) — tcbuffer restriction by Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_at_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferAtCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferAtCbuffer";

    TcbufferAtCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
