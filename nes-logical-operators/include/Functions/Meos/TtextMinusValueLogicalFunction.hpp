...
/**
 * @brief ttext_minus_value (Temporal *) — temporal ttext ⊗ text -> ttext_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_minus_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextMinusValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextMinusValue";

    TtextMinusValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
