...
/**
 * @brief distance_tstzspanset_tstzspan (double) — SpanSet/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_tstzspanset_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceTstzspansetTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceTstzspansetTstzspan";

    DistanceTstzspansetTstzspanLogicalFunction(LogicalFunction lit,
