...
/**
 * @brief right_span_bigint (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_span_bigint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightSpanBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightSpanBigint";

    RightSpanBigintLogicalFunction(LogicalFunction lit,
