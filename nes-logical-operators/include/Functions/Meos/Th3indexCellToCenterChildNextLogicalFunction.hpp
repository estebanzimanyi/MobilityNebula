...
/**
 * @brief Th3index th3index cell to center child next
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_cell_to_center_child_next(temp, (int32_t)arg0)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexCellToCenterChildNextLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
