...
/**
 * @brief Returns the H3 center child cell at resolution+1 as a hex string.
 *
 * Args: (cell:UINT64, ts:UINT64) -> VARCHAR.
 */
class Th3indexCellToCenterChildNextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexCellToCenterChildNext";

    Th3indexCellToCenterChildNextLogicalFunction(LogicalFunction cell, LogicalFunction ts);
