...
/**
 * @brief left_span_int (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `left_span_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class LeftSpanIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LeftSpanInt";

    LeftSpanIntLogicalFunction(LogicalFunction lit,
