...
/**
 * @brief tcbuffer_radius (Set *) - the set of radius values of a temporal circular buffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_radius`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferRadiusLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferRadius";

    TcbufferRadiusLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
