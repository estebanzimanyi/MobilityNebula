...
/**
 * @brief pose_round (Pose *) — round pose to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseRound";

    PoseRoundLogicalFunction(LogicalFunction lit);
