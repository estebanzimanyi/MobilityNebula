...
/**
 * @brief datespan_make (Span *) — span constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespan_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespanMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespanMake";

    DatespanMakeLogicalFunction(LogicalFunction value,
