...
/**
 * @brief datespan_shift_scale (container, int shift, int width, true, true) -> shifted+scaled datespan.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespan_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespanShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespanShiftScale";

    DatespanShiftScaleLogicalFunction(LogicalFunction lit,
