...
/**
 * @brief cbuffer_transform_pipeline (Cbuffer *) — PROJ-pipeline transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_transform_pipeline`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferTransformPipelineLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferTransformPipeline";

    CbufferTransformPipelineLogicalFunction(LogicalFunction lit);
