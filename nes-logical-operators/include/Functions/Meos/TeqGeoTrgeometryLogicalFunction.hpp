...
/**
 * @brief teq_geo_trgeometry (Temporal *) — temporal trgeometry ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `teq_geo_trgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TeqGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TeqGeoTrgeometry";

    TeqGeoTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
