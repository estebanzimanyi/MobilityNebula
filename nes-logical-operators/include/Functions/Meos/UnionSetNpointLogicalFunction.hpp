...
/**
 * @brief union_set_npoint (Set *) — object-set ± npoint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_set_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSetNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSetNpoint";

    UnionSetNpointLogicalFunction(LogicalFunction lit,
