...
/**
 * @brief distance_span_date (int) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_span_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceSpanDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceSpanDate";

    DistanceSpanDateLogicalFunction(LogicalFunction lit,
