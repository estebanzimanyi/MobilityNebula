...
/**
 * @brief cbuffer_same (bool) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_same`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferSameLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferSame";

    CbufferSameLogicalFunction(LogicalFunction lit,
