...
/**
 * @brief Static geometry function geom_touches: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function `geom_touches`.
 */
class GeomTouchesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomTouches";

    GeomTouchesLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
