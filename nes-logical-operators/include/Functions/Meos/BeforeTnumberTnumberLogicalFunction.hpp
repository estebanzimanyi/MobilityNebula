...
/**
 * @brief Per-event before_tnumber_tnumber: two hex-WKB temporal operands -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_tnumber_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeTnumberTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeTnumberTnumber";

    BeforeTnumberTnumberLogicalFunction(LogicalFunction traj,
