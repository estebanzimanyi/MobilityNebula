...
/**
 * @brief minus_set_geo (Set *) — object-set ± geo value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetGeo";

    MinusSetGeoLogicalFunction(LogicalFunction lit,
