...
/**
 * @brief Returns the type of the outermost JSON value as a text string.
 */
class JsonTypeofLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonTypeof";

    JsonTypeofLogicalFunction(LogicalFunction js);
