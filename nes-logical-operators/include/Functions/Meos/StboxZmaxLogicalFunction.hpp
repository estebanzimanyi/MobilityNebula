...
/**
 * @brief stbox_zmax (out-param double) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_zmax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxZmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxZmax";

    StboxZmaxLogicalFunction(LogicalFunction box);
