...
/**
 * @brief adjacent_span_spanset (bool) — Span/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_span_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentSpanSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentSpanSpanset";

    AdjacentSpanSpansetLogicalFunction(LogicalFunction lit,
