...
/**
 * @brief tdistance_tnpoint_npoint (Temporal *) — temporal tnpoint ⊗ Npoint -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tnpoint_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTnpointNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTnpointNpoint";

    TdistanceTnpointNpointLogicalFunction(LogicalFunction rid,
