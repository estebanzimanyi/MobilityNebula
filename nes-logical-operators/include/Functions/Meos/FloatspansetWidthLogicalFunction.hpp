...
/**
 * @brief floatspanset_width (SpanSet*, boundspan=false) -> total width of the component spans.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_width`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetWidthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetWidth";

    FloatspansetWidthLogicalFunction(LogicalFunction lit);
