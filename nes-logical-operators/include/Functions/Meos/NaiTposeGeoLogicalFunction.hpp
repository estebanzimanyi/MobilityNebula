...
/**
 * @brief nai_tpose_geo (TInstant *) — tpose nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tpose_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTposeGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTposeGeo";

    NaiTposeGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
