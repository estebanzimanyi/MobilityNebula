...
/**
 * @brief nai_tnpoint_npoint (TInstant *) — tnpoint nearest-approach ⊗ Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tnpoint_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTnpointNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTnpointNpoint";

    NaiTnpointNpointLogicalFunction(LogicalFunction rid,
