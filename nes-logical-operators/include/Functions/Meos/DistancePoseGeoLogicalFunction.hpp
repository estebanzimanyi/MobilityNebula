...
/**
 * @brief distance_pose_geo (double) — Pose ⊗ GSERIALIZED distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_pose_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistancePoseGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistancePoseGeo";

    DistancePoseGeoLogicalFunction(LogicalFunction lit,
