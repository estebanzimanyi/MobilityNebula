...
/**
 * @brief tcbuffer_to_tgeompoint (Temporal *) — unary tcbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_to_tgeompoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferToTgeompointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferToTgeompoint";

    TcbufferToTgeompointLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
