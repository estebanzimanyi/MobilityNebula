...
/**
 * @brief Returns the minimum distance between two tcbuffer instants within the given threshold.
 *
 * Args: (lon1:FLOAT64, lat1:FLOAT64, r1:FLOAT64, ts1:UINT64,
 *        lon2:FLOAT64, lat2:FLOAT64, r2:FLOAT64, ts2:UINT64,
 *        dist:FLOAT64) -> FLOAT64.
 */
class MindistanceTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MindistanceTcbufferTcbuffer";

    MindistanceTcbufferTcbufferLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction r1,
                          LogicalFunction ts1,
                          LogicalFunction lon2, LogicalFunction lat2, LogicalFunction r2,
                          LogicalFunction ts2, LogicalFunction dist);
