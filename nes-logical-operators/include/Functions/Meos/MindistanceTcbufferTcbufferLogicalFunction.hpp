...
/**
 * @brief Per-event minimum distance between two tcbuffer instants within threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mindistance_tcbuffer_tcbuffer`. Per-event scalar operator following the
...
public:
    ...
    MindistanceTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
