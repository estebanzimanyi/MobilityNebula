...
/**
 * @brief timestamptz_shift (TimestampTz) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_shift`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzShiftLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzShift";

    TimestamptzShiftLogicalFunction(LogicalFunction value,
