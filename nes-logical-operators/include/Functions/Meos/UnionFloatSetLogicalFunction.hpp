...
/**
 * @brief union_float_set (Set *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_float_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionFloatSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionFloatSet";

    UnionFloatSetLogicalFunction(LogicalFunction lit,
