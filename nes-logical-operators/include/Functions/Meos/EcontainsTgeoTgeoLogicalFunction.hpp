...
/**
 * @brief Tests whether a temporal geometry ever contains another.
 */
class EcontainsTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcontainsTgeoTgeo";

    EcontainsTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2);
