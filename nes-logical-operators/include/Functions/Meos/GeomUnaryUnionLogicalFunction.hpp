...
/**
 * @brief Returns the topological union of a geometry's components as WKT.
 */
class GeomUnaryUnionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomUnaryUnion";

    GeomUnaryUnionLogicalFunction(LogicalFunction wkt);
