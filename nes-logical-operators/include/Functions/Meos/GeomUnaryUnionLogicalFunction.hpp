...
/**
 * @brief geom_unary_union (GSERIALIZED *) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_unary_union`. Per-event scalar operator following the
...
public:
    ...
    GeomUnaryUnionLogicalFunction(LogicalFunction lit,
