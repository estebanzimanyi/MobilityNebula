...
/**
 * @brief tbox_hasx (bool) — unary tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_hasx`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxHasxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxHasx";

    TboxHasxLogicalFunction(LogicalFunction lit);
