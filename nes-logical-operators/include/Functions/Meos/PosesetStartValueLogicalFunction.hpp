...
/**
 * @brief poseset_start_value (Pose *) — unary poseset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `poseset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PosesetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PosesetStartValue";

    PosesetStartValueLogicalFunction(LogicalFunction lit);
