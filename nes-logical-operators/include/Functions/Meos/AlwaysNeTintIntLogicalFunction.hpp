...
/**
 * @brief Per-event always_ne_tint_int: tests if a single-instant tint value always does not equal a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tint_int`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysNeTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTintInt";

    AlwaysNeTintIntLogicalFunction(LogicalFunction value,
