...
/**
 * @brief Per-event always-disjoint between a single-instant tgeompoint and a static geometry.
 *
 ...
 */
class TemporalADisjointGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADisjointGeometry";

    TemporalADisjointGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
