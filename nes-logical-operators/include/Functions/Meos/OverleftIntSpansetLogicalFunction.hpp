...
/**
 * @brief overleft_int_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_int_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftIntSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftIntSpanset";

    OverleftIntSpansetLogicalFunction(LogicalFunction lit,
