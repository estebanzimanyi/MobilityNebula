...
/**
 * @brief intersection_bigint_set: extern Set *intersection_bigint_set(int64 i, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_bigint_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionBigintSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionBigintSet";

    IntersectionBigintSetLogicalFunction(LogicalFunction lit,
