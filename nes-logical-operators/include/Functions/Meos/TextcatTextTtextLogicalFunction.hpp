...
/**
 * @brief textcat_text_ttext (Temporal *) — temporal ttext ⊗ text -> ttext_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    TextcatTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
