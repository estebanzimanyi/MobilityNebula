...
/**
 * @brief Concatenate text and ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    TextcatTextTtextLogicalFunction(LogicalFunction arg0,
