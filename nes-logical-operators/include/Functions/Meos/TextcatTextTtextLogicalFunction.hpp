...
/**
 * @brief Per-event textcat_text_ttext: (value:VARCHAR, ts:UINT64, ref:VARCHAR) -> varchar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_text_ttext`. Per-event scalar operator returning VARCHAR.
 */
class TextcatTextTtextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextcatTextTtext";

    TextcatTextTtextLogicalFunction(LogicalFunction value, LogicalFunction ts, LogicalFunction ref);
