...
/**
 * @brief Th3index th3index get base cell number
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_get_base_cell_number(temp)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexGetBaseCellNumberLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts);
