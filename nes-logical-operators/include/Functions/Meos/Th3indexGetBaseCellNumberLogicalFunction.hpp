...
/**
 * @brief Returns the H3 base cell number (0-121) of the cell as FLOAT64.
 *
 * Args: (cell:UINT64, ts:UINT64) -> FLOAT64.
 */
class Th3indexGetBaseCellNumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexGetBaseCellNumber";

    Th3indexGetBaseCellNumberLogicalFunction(LogicalFunction cell, LogicalFunction ts);
