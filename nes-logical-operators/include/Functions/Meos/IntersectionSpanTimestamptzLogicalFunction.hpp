...
/**
 * @brief intersection_span_timestamptz: extern Span *intersection_span_timestamptz(const Span *s, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_span_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSpanTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSpanTimestamptz";

    IntersectionSpanTimestamptzLogicalFunction(LogicalFunction lit,
