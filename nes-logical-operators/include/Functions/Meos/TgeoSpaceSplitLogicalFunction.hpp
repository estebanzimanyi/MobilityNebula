...
/**
 * @brief tgeo_space_split (Temporal **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_space_split`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoSpaceSplitLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoSpaceSplit";

    TgeoSpaceSplitLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction z,
                                          LogicalFunction ts,
