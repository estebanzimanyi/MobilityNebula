...
/**
 * @brief trgeometry_instant_n (TInstant *) - the n-th instant of a temporal rigid geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_instant_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryInstantNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryInstantN";

    TrgeometryInstantNLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
