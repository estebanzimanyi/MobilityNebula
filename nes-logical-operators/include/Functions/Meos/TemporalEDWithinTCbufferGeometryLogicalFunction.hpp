...
/**
 * @brief Per-event ever-distance-within between a single-instant tcbuffer and a static geometry under a fixed threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edwithin_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEDWithinTCbufferGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTCbufferGeometry";

    TemporalEDWithinTCbufferGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
