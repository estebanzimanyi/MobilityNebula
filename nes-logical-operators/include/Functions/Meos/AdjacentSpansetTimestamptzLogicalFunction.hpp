...
/**
 * @brief adjacent_spanset_timestamptz (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_spanset_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentSpansetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentSpansetTimestamptz";

    AdjacentSpansetTimestamptzLogicalFunction(LogicalFunction lit,
