...
/**
 * @brief stbox_isgeodetic (bool) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_isgeodetic`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxIsgeodeticLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxIsgeodetic";

    StboxIsgeodeticLogicalFunction(LogicalFunction box);
