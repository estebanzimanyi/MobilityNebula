...
/**
 * @brief distance_bigintspanset_bigintspan (int64) — SpanSet/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_bigintspanset_bigintspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceBigintspansetBigintspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceBigintspansetBigintspan";

    DistanceBigintspansetBigintspanLogicalFunction(LogicalFunction lit,
