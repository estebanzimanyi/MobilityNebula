...
/**
 * @brief Returns 1.0 if the tjsonb instant value ever equals the target Jsonb.
 */
class EverEqTjsonbJsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTjsonbJsonb";

    EverEqTjsonbJsonbLogicalFunction(LogicalFunction json_str, LogicalFunction ts, LogicalFunction target_json);
