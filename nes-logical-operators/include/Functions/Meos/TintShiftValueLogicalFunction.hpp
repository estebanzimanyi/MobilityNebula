...
/**
 * @brief Per-event tint_shift_value: shifts a single-instant tint by a constant integer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_shift_value`. Takes (value:FLOAT64, ts:UINT64, shift:FLOAT64→int),
 * constructs a single-instant temporal, applies the shift, and returns FLOAT64.
 */
class TintShiftValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintShiftValue";

    TintShiftValueLogicalFunction(LogicalFunction value,
                                  LogicalFunction ts,
