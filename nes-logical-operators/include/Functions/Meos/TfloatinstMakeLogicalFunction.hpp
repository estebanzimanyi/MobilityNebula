...
/**
 * @brief tfloatinst_make (TInstant *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloatinst_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatinstMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatinstMake";

    TfloatinstMakeLogicalFunction(LogicalFunction value,
