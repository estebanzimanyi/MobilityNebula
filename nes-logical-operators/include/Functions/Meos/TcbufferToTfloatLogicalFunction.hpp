...
/**
 * @brief Per-event tcbuffer_to_tfloat: single-instant tcbuffer transform, value extracted -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_to_tfloat`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferToTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferToTfloat";

    TcbufferToTfloatLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
