...
/**
 * @brief always_ne_geo_trgeometry (int) — temporal trgeometry ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_geo_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeGeoTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
