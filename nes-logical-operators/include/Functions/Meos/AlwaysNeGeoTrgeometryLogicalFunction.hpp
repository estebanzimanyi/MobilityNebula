...
/**
 * @brief Returns 1.0 if the static geometry is always not equal to the 2D trgeometry instant.
 */
class AlwaysNeGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeGeoTrgeometry";

    AlwaysNeGeoTrgeometryLogicalFunction(LogicalFunction tgt_wkt, LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts);
