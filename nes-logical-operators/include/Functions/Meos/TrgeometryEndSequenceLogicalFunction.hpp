...
/**
 * @brief trgeometry_end_sequence (TSequence *) — unary trgeometry accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_end_sequence`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryEndSequenceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryEndSequence";

    TrgeometryEndSequenceLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
