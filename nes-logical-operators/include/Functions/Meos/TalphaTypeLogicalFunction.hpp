...
/**
 * @brief talpha_type (bool) — type-dispatch predicate on a value's temptype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `talpha_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TalphaTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TalphaType";

    TalphaTypeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
