...
/**
 * @brief stbox_get_space (STBox *) — unary stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_get_space`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxGetSpaceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxGetSpace";

    StboxGetSpaceLogicalFunction(LogicalFunction box);
