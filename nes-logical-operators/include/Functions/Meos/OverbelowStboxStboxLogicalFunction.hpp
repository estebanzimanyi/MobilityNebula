...
/**
 * @brief Per-event overbelow_stbox_stbox: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbelow_stbox_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbelowStboxStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbelowStboxStbox";

    OverbelowStboxStboxLogicalFunction(LogicalFunction box,
