...
/**
 * @brief temparr_round — round a 1-element Temporal array.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temparr_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemparrRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemparrRound";

    TemparrRoundLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
