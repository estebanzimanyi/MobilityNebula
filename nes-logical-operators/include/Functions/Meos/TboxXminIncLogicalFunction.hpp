...
/**
 * @brief tbox_xmin_inc (out-param bool) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_xmin_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxXminIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxXminInc";

    TboxXminIncLogicalFunction(LogicalFunction lit);
