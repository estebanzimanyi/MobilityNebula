...
/**
 * @brief Per-event contains_tbox_tnumber: single-instant tfloat against a TBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_tbox_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsTboxTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsTboxTnumber";

    ContainsTboxTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
