...
/**
 * @brief minus_span_spanset over two text literals; type-generic MEOS set-algebra, VARSIZED (intspanset_text).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_span_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpanSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpanSpanset";

    MinusSpanSpansetLogicalFunction(LogicalFunction lit,
