...
/**
 * @brief overafter_temporal_tstzspan (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_temporal_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterTemporalTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterTemporalTstzspan";

    OverafterTemporalTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
