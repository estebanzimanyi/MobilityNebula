...
/**
 * @brief floatspan_to_intspan (Span *) — Span -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_to_intspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanToIntspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanToIntspan";

    FloatspanToIntspanLogicalFunction(LogicalFunction lit);
