...
/**
 * @brief minus_set_text: extern Set *minus_set_text(const Set *s, const text *txt);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_text`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetText";

    MinusSetTextLogicalFunction(LogicalFunction lit,
