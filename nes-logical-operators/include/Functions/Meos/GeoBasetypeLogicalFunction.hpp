...
/**
 * @brief geo_basetype (bool) - whether a MEOS base type is a geo type.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_basetype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoBasetypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoBasetype";

    GeoBasetypeLogicalFunction(LogicalFunction value);
