...
/**
 * @brief stbox_set_srid (STBox *) — SRID set/transform to 4326.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_set_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxSetSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxSetSrid";

    StboxSetSridLogicalFunction(LogicalFunction box);
