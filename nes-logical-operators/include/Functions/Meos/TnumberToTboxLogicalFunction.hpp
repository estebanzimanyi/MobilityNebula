...
/**
 * @brief tnumber_to_tbox (TBox *) — Temporal -> TBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberToTbox";

    TnumberToTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
