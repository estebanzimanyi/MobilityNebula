...
/**
 * @brief basetype_byvalue (bool) - whether a MEOS base type is passed by value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `basetype_byvalue`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BasetypeByvalueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BasetypeByvalue";

    BasetypeByvalueLogicalFunction(LogicalFunction value);
