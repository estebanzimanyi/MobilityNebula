...
/**
 * @brief float_timestamptz_to_tbox (TBox *) — double + TimestampTz -> TBox constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_timestamptz_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatTimestamptzToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatTimestamptzToTbox";

    FloatTimestamptzToTboxLogicalFunction(LogicalFunction value,
