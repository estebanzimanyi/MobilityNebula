...
/**
 * @brief intersection_set_geo (Set *) — object-set ± geo value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_set_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionSetGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionSetGeo";

    IntersectionSetGeoLogicalFunction(LogicalFunction lit,
