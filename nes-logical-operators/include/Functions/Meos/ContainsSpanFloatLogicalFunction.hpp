...
/**
 * @brief Floatspan contains float
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_span_float(temp, arg0)`. Per-event scalar operator following the
...
public:
    ...
    ContainsSpanFloatLogicalFunction(LogicalFunction sp,
