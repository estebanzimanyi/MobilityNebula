...
/**
 * @brief Returns 1 if the float span contains the float value.
 */
class ContainsSpanFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSpanFloat";
    ContainsSpanFloatLogicalFunction(LogicalFunction sp, LogicalFunction val);
