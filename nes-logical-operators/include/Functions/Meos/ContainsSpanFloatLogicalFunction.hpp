...
/**
 * @brief contains_span_float (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_span_float`. Per-event scalar operator following the
...
public:
    ...
    ContainsSpanFloatLogicalFunction(LogicalFunction lit,
