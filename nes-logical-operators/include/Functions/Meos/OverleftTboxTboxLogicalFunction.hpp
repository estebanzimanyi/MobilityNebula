...
/**
 * @brief overleft_tbox_tbox (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_tbox_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftTboxTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftTboxTbox";

    OverleftTboxTboxLogicalFunction(LogicalFunction lit,
