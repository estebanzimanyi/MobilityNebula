...
/**
 * @brief Per-event after_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterTnumberTbox";

    AfterTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
