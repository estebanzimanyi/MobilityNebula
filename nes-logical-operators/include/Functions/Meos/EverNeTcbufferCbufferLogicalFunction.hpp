...
/**
 * @brief Per-event ever_ne_tcbuffer_cbuffer between a single-instant tcbuffer and a static cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tcbuffer_cbuffer`. Per-event scalar operator following the
...
public:
    ...
    EverNeTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
