...
/**
 * @brief tpose_minus_pose (Temporal *) — tpose restriction by Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_minus_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeMinusPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeMinusPose";

    TposeMinusPoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
