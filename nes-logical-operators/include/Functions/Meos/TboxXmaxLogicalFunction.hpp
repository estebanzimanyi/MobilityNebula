...
/**
 * @brief tbox_xmax (out-param double) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_xmax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxXmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxXmax";

    TboxXmaxLogicalFunction(LogicalFunction lit);
