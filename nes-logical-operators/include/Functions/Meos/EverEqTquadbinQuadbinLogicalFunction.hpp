 ...
 */
class EverEqTquadbinQuadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTquadbinQuadbin";
    EverEqTquadbinQuadbinLogicalFunction(LogicalFunction inst_cell, LogicalFunction ts, LogicalFunction cell);
