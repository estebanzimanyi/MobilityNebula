...
/**
 * @brief Ever equal tquadbin vs quadbin
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_tquadbin_quadbin(temp, (Quadbin)arg0)`. Per-event scalar operator following the
...
public:
    ...
    EverEqTquadbinQuadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
