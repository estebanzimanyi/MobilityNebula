...
/**
 * @brief pose_make_point3d (Pose *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_make_point3d`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseMakePoint3dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseMakePoint3d";

    PoseMakePoint3dLogicalFunction(LogicalFunction lit,
