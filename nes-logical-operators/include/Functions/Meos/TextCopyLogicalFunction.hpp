...
/**
 * @brief text_copy (text *) — text string transform.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `text_copy`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextCopyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextCopy";

    TextCopyLogicalFunction(LogicalFunction lit);
