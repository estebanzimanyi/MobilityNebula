...
/**
 * @brief Returns 1.0 if the 2D tpose instant is always not equal to the static pose, 0.0 otherwise.
 */
class AlwaysNeTposePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTposePose";

    AlwaysNeTposePoseLogicalFunction(LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction x2, LogicalFunction y2, LogicalFunction theta2);
