...
/**
 * @brief set_type (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetType";

    SetTypeLogicalFunction(LogicalFunction lit);
