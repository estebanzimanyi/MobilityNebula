...
/**
 * @brief ever_eq_tpose_pose (int) — always/ever tpose ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_tpose_pose`. Per-event scalar operator following the
...
public:
    ...
    EverEqTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
