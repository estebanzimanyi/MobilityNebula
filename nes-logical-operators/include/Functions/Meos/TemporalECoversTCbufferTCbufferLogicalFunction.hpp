...
/**
 * @brief Per-event ever-covers between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ecovers_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalECoversTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversTCbufferTCbuffer";

    TemporalECoversTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
