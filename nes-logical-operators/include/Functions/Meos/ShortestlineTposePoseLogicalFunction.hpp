...
/**
 * @brief shortestline_tpose_pose (GSERIALIZED *) — tpose nearest-approach ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tpose_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTposePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTposePose";

    ShortestlineTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
