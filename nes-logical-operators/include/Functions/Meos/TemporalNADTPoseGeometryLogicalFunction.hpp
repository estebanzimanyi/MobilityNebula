...
/**
 * @brief Per-event nearest-approach distance between a single-instant tgeompoint resolved from a tpose (x,y,theta,ts) via tpose_to_tpoint and a static geometry.
 *
