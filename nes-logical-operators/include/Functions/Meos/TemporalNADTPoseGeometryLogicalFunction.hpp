...
/**
 * @brief Per-event nearest-approach distance between a single-instant tgeompoint resolved from a tpose (x,y,theta,ts) via tpose_to_tgeompoint and a static geometry.
 *
 ...
 */
class TemporalNADTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTPoseGeometry";

    TemporalNADTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
