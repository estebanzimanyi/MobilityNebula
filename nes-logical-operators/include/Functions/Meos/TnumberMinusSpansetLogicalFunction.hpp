...
/**
 * @brief tnumber_minus_spanset (Temporal *) — tint restricted by a spanset box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_minus_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberMinusSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberMinusSpanset";

    TnumberMinusSpansetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
