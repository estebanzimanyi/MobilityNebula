...
/**
 * @brief Per-event always-contains between two single-instant tgeompoints, each lifted from a tpose (x,y,theta,ts) via tpose_to_tpoint composition.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acontains_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAContainsTPoseTPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAContainsTPoseTPose";

    TemporalAContainsTPoseTPoseLogicalFunction(LogicalFunction xA,
                                          LogicalFunction yA,
