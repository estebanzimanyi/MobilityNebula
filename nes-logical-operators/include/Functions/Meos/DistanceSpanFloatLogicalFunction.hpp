...
/**
 * @brief distance_span_float (double) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_span_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceSpanFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceSpanFloat";

    DistanceSpanFloatLogicalFunction(LogicalFunction lit,
