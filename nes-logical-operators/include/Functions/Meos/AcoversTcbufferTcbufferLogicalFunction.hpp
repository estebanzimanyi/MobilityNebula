...
/**
 * @brief Per-event acovers_tcbuffer_tcbuffer spatial predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acovers_tcbuffer_tcbuffer`. Per-event scalar operator following the
...
public:
    ...
    AcoversTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
