...
/**
 * @brief overright_float_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_float_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightFloatSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightFloatSpan";

    OverrightFloatSpanLogicalFunction(LogicalFunction lit,
