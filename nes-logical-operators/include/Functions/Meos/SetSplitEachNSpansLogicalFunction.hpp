...
/**
 * @brief set_split_each_n_spans (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_split_each_n_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetSplitEachNSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetSplitEachNSpans";

    SetSplitEachNSpansLogicalFunction(LogicalFunction lit,
