...
/**
 * @brief contained_cbuffer_set (bool) — object-set ± cbuffer value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_cbuffer_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedCbufferSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedCbufferSet";

    ContainedCbufferSetLogicalFunction(LogicalFunction lit,
