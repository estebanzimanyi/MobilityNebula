...
/**
 * @brief tnumber_minus_tbox (Temporal *) — tint restricted by a tbox box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_minus_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberMinusTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberMinusTbox";

    TnumberMinusTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
