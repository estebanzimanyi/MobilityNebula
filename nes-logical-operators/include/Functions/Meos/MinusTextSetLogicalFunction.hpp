...
/**
 * @brief minus_text_set: extern Set *minus_text_set(const text *txt, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_text_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusTextSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusTextSet";

    MinusTextSetLogicalFunction(LogicalFunction lit,
