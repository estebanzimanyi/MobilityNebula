...
/**
 * @brief contained_int_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_int_span`. Per-event scalar operator following the
...
public:
    ...
    ContainedIntSpanLogicalFunction(LogicalFunction lit,
