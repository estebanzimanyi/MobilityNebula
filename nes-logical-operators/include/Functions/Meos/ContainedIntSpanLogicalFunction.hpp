...
/**
 * @brief Int contained in span
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_int_span((int)arg0, temp)`. Per-event scalar operator following the
...
public:
    ...
    ContainedIntSpanLogicalFunction(LogicalFunction arg0,
                                          LogicalFunction sp);
