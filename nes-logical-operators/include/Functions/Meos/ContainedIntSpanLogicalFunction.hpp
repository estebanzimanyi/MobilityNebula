...
/**
 * @brief Returns 1 if the integer value is contained by the integer span.
 */
class ContainedIntSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedIntSpan";
    ContainedIntSpanLogicalFunction(LogicalFunction val, LogicalFunction sp);
