...
/**
 * @brief Returns the nearest approach distance between two 2D trgeometry instants.
 */
class NadTrgeometryTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTrgeometryTrgeometry";

    NadTrgeometryTrgeometryLogicalFunction(LogicalFunction ref1_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1, LogicalFunction ref2_wkt, LogicalFunction x2, LogicalFunction y2, LogicalFunction theta2, LogicalFunction ts2);
