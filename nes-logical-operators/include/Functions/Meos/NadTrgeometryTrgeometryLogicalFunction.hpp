...
/**
 * @brief nad_trgeometry_trgeometry (double) — two trgeometry instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_trgeometry_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    NadTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
