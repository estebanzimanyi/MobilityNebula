...
/**
 * @brief pose_make_3d (Pose *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_make_3d`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseMake3dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseMake3d";

    PoseMake3dLogicalFunction(LogicalFunction value,
