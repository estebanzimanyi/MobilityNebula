...
/**
 * @brief right_float_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_float_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightFloatSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightFloatSpanset";

    RightFloatSpansetLogicalFunction(LogicalFunction lit,
