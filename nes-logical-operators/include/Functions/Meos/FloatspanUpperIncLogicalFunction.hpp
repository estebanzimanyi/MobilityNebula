...
/**
 * @brief Returns 1 if the upper bound of a float span is inclusive, 0 otherwise.
 */
class FloatspanUpperIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanUpperInc";
    FloatspanUpperIncLogicalFunction(LogicalFunction sp);
