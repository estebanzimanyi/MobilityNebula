...
/**
 * @brief distance_floatspanset_floatspanset (double) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_floatspanset_floatspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceFloatspansetFloatspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceFloatspansetFloatspanset";

    DistanceFloatspansetFloatspansetLogicalFunction(LogicalFunction lit,
