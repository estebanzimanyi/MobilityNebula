...
/**
 * @brief Per-event ever-covers between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ecovers_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalECoversTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversTCbuffer";

    TemporalECoversTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
