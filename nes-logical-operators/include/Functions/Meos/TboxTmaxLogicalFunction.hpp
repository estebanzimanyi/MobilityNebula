...
/**
 * @brief tbox_tmax (out-param TimestampTz) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_tmax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxTmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxTmax";

    TboxTmaxLogicalFunction(LogicalFunction lit);
