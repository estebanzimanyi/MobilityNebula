...
/**
 * @brief Per-event temporal_hausdorff_distance between two single-instant tgeompoints -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_hausdorff_distance`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalHausdorffDistanceLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalHausdorffDistance";

    TemporalHausdorffDistanceLogicalFunction(LogicalFunction lonA,
