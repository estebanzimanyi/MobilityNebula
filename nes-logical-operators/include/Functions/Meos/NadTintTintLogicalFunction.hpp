 ...
 */
class NadTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTintTint";

    NadTintTintLogicalFunction(LogicalFunction valueA,
                                          LogicalFunction tsA,
