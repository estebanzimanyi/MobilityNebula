...
/**
 * @brief left_span_spanset (bool) — Span/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `left_span_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class LeftSpanSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LeftSpanSpanset";

    LeftSpanSpansetLogicalFunction(LogicalFunction lit,
