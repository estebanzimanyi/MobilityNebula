...
/**
 * @brief Per-event tint_scale_value: scales a single-instant tint to a given width.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_scale_value`. Takes (value:FLOAT64, ts:UINT64, width:FLOAT64→int),
 * constructs a single-instant temporal, applies the scale, and returns FLOAT64.
 */
class TintScaleValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintScaleValue";

    TintScaleValueLogicalFunction(LogicalFunction value,
                                  LogicalFunction ts,
