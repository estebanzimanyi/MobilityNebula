...
/**
 * @brief temporal GT: single-instant tfloat vs scalar float
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgt_tfloat_float`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TgtTfloatFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgtTfloatFloat";

    TgtTfloatFloatLogicalFunction(LogicalFunction value,
