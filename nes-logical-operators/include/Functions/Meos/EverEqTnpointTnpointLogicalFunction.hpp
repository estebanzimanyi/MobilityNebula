...
/**
 * @brief Returns 1.0 if the two tnpoint instants are ever equal, 0.0 otherwise.
 *
 * Args: (rid1:UINT64, pos1:FLOAT64, ts1:UINT64,
 *        rid2:UINT64, pos2:FLOAT64, ts2:UINT64) -> FLOAT64.
 */
class EverEqTnpointTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTnpointTnpoint";

    EverEqTnpointTnpointLogicalFunction(LogicalFunction rid1, LogicalFunction pos1, LogicalFunction ts1,
