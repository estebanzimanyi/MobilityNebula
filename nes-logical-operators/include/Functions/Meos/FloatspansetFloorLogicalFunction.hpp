...
/**
 * @brief floatspanset_floor (SpanSet *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_floor`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetFloorLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetFloor";

    FloatspansetFloorLogicalFunction(LogicalFunction lit);
