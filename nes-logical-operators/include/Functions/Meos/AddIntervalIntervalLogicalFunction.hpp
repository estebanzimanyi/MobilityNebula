...
/**
 * @brief add_interval_interval (Interval *) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `add_interval_interval`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AddIntervalIntervalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AddIntervalInterval";

    AddIntervalIntervalLogicalFunction(LogicalFunction lit,
