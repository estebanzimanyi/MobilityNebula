...
/**
 * @brief tbox_gt (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxGt";

    TboxGtLogicalFunction(LogicalFunction lit,
