...
/**
 * @brief teq_pose_tpose (Temporal *) — temporal tpose ⊗ Pose -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `teq_pose_tpose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TeqPoseTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TeqPoseTpose";

    TeqPoseTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
