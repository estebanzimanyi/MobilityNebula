...
/**
 * @brief Returns 1 if float span sp1 is contained by float span sp2.
 */
class ContainedFloatspanSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedFloatspanSpan";
    ContainedFloatspanSpanLogicalFunction(LogicalFunction sp1, LogicalFunction sp2);
