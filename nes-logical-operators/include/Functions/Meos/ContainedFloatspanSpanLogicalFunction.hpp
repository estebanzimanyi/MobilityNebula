...
/**
 * @brief Floatspan contained in floatspan
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_span_span(temp, sp0)`. Per-event scalar operator following the
...
public:
    ...
    ContainedFloatspanSpanLogicalFunction(LogicalFunction sp,
