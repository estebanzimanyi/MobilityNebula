...
/**
 * @brief Per-event ttext_upper: single-instant ttext transform -> varchar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_upper`. Per-event scalar operator; returns the transformed text value.
 */
class TtextUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextUpper";

    TtextUpperLogicalFunction(LogicalFunction value,
                         LogicalFunction ts);
