...
/**
 * @brief tne_trgeometry_geo (Temporal *) — temporal trgeometry ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_trgeometry_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TneTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TneTrgeometryGeo";

    TneTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
