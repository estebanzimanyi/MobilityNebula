...
/**
 * @brief Per-event sub_bigint_tbigint: subtracts a single-instant tbigint value from a constant int64 scalar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `sub_bigint_tbigint`. Takes (scalar:FLOAT64→int64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the subtraction, and returns FLOAT64.
 */
class SubBigintTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SubBigintTbigint";

    SubBigintTbigintLogicalFunction(LogicalFunction scalar,
