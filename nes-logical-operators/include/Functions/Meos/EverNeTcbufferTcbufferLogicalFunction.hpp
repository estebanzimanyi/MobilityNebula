...
/**
 * @brief Per-event ever_ne_tcbuffer_tcbuffer between two single-instant tcbuffers -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tcbuffer_tcbuffer`. Per-event scalar operator following the
...
public:
    ...
    EverNeTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
