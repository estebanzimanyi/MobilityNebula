...
/**
 * @brief tdwithin_tcbuffer_geo (Temporal *) — tcbuffer tdwithin GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdwithin_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdwithinTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdwithinTcbufferGeo";

    TdwithinTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
