...
/**
 * @brief tstzset_end_value (TimestampTz) — unary tstzset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetEndValue";

    TstzsetEndValueLogicalFunction(LogicalFunction lit);
