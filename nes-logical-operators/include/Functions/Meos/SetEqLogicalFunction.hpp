...
/**
 * @brief set_eq (bool) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_eq`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetEq";

    SetEqLogicalFunction(LogicalFunction lit,
