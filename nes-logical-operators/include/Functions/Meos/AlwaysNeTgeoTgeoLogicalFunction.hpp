...
/**
 * @brief Tests whether two temporal geometries are always spatially not equal.
 */
class AlwaysNeTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTgeoTgeo";

    AlwaysNeTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2);
