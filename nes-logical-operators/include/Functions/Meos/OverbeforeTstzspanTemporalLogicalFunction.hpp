...
/**
 * @brief overbefore_tstzspan_temporal (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbefore_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbeforeTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbeforeTstzspanTemporal";

    OverbeforeTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
