...
/**
 * @brief floatspan_degrees (Span *) — radians->degrees container transform.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_degrees`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanDegreesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanDegrees";

    FloatspanDegreesLogicalFunction(LogicalFunction lit,
