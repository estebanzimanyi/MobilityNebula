...
/**
 * @brief shortestline_tnpoint_tnpoint (GSERIALIZED *) — two tnpoint instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tnpoint_tnpoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTnpointTnpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTnpointTnpoint";

    ShortestlineTnpointTnpointLogicalFunction(LogicalFunction rid,
