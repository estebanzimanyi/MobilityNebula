...
/**
 * @brief cbufferset_value_n (out-param Cbuffer, n=1) — cbufferset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbufferset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbuffersetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbuffersetValueN";

    CbuffersetValueNLogicalFunction(LogicalFunction lit);
