...
/**
 * @brief Per-event ever-covers between two single-instant tgeompoints.
 *
 ...
 */
class TemporalECoversTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversTGeometry";

    TemporalECoversTGeometryLogicalFunction(LogicalFunction lonA,
