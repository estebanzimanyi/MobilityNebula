...
/**
 * @brief set_round (Set *) — round floatset to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetRound";

    SetRoundLogicalFunction(LogicalFunction lit);
