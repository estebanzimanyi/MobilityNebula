...
/**
 * @brief Per-event tfloat_to_tbigint: converts a single-instant tfloat to tbigint, returns FLOAT64.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_to_tbigint`. Takes (value:FLOAT64, ts:UINT64), constructs a single-instant
 * temporal float, truncates to bigint, and returns FLOAT64.
 */
class TfloatToTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatToTbigint";

    TfloatToTbigintLogicalFunction(LogicalFunction value,
                                   LogicalFunction ts);
