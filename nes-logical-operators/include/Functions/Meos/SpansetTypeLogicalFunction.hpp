...
/**
 * @brief spanset_type (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetType";

    SpansetTypeLogicalFunction(LogicalFunction lit);
