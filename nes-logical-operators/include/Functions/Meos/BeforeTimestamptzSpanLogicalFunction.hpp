...
/**
 * @brief before_timestamptz_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_timestamptz_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeTimestamptzSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeTimestamptzSpan";

    BeforeTimestamptzSpanLogicalFunction(LogicalFunction lit,
