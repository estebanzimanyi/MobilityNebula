...
/**
 * @brief tcovers_geo_tcbuffer (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcovers_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcoversGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcoversGeoTcbuffer";

    TcoversGeoTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
