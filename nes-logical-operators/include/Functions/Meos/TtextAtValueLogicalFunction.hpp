...
/**
 * @brief ttext_at_value (Temporal *) — temporal ttext ⊗ text -> ttext_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_at_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextAtValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextAtValue";

    TtextAtValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
