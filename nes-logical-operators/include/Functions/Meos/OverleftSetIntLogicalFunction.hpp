...
/**
 * @brief overleft_set_int (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_set_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftSetIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftSetInt";

    OverleftSetIntLogicalFunction(LogicalFunction lit,
