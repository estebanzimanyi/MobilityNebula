...
/**
 * @brief tfloat_from_base_temp (Temporal *) — temporal tfloat ⊗ scalar -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_from_base_temp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatFromBaseTempLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatFromBaseTemp";

    TfloatFromBaseTempLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
