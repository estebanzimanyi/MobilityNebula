...
/**
 * @brief Returns 1 if the upper bound of an integer span is inclusive, 0 otherwise.
 */
class IntspanUpperIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanUpperInc";
    IntspanUpperIncLogicalFunction(LogicalFunction sp);
