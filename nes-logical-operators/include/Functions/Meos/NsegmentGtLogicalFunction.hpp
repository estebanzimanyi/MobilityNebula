...
/**
 * @brief nsegment_gt (bool) — Nsegment scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentGt";

    NsegmentGtLogicalFunction(LogicalFunction lit,
