...
/**
 * @brief overbefore_timestamptz_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbefore_timestamptz_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbeforeTimestamptzSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbeforeTimestamptzSpan";

    OverbeforeTimestamptzSpanLogicalFunction(LogicalFunction lit,
