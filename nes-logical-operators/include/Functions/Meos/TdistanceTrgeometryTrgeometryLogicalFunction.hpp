...
/**
 * @brief tdistance_trgeometry_trgeometry (Temporal *) — two trgeometry instants -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_trgeometry_trgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTrgeometryTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTrgeometryTrgeometry";

    TdistanceTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
