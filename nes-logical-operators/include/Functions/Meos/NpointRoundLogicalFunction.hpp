...
/**
 * @brief npoint_round (Npoint *) — round npoint to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npoint_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointRound";

    NpointRoundLogicalFunction(LogicalFunction lit);
