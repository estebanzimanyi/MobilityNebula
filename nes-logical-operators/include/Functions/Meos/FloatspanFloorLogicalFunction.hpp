...
/**
 * @brief floatspan_floor (Span *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_floor`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanFloorLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanFloor";

    FloatspanFloorLogicalFunction(LogicalFunction lit);
