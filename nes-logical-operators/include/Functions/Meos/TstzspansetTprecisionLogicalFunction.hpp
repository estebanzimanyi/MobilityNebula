...
/**
 * @brief tstzspanset_tprecision (SpanSet *) — arity-3 tstzspanset_text op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_tprecision`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetTprecisionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetTprecision";

    TstzspansetTprecisionLogicalFunction(LogicalFunction lit,
