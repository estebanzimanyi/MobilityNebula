...
/**
 * @brief float_to_span (float value) -> span (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_to_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatToSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatToSpan";

    FloatToSpanLogicalFunction(LogicalFunction value);
