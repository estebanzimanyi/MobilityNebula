...
/**
 * @brief Per-event always-touches between a single-instant tgeompoint and a static geometry.
 *
 ...
 */
class TemporalATouchesGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalATouchesGeometry";

    TemporalATouchesGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
