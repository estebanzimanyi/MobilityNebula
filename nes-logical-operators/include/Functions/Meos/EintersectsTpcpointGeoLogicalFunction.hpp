...
/**
 * @brief Returns 1.0 if the tpcpoint instant position intersects the geometry.
 */
class EintersectsTpcpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EintersectsTpcpointGeo";

    EintersectsTpcpointGeoLogicalFunction(LogicalFunction pt_hexwkb, LogicalFunction ts, LogicalFunction tgt_wkt);
