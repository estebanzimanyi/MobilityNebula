 ...
 */
class EverGeTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGeTintTint";

    EverGeTintTintLogicalFunction(LogicalFunction value1,
