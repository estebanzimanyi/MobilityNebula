...
/**
 * @brief tnumber_at_span (Temporal *) — tint restricted by a span box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_at_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberAtSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberAtSpan";

    TnumberAtSpanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
