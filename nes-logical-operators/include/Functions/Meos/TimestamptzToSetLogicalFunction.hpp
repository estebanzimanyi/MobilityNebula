...
/**
 * @brief timestamptz_to_set (timestamptz value) -> set (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzToSet";

    TimestamptzToSetLogicalFunction(LogicalFunction value);
