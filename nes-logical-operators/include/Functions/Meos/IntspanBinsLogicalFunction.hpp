...
/**
 * @brief intspan_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspan_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspanBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanBins";

    IntspanBinsLogicalFunction(LogicalFunction lit,
