...
/**
 * @brief contains_set_geo (bool) — object-set ± geo value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_set_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsSetGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSetGeo";

    ContainsSetGeoLogicalFunction(LogicalFunction lit,
