...
/**
 * @brief spatial_basetype (bool) - whether a MEOS base type is a spatial type.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spatial_basetype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpatialBasetypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpatialBasetype";

    SpatialBasetypeLogicalFunction(LogicalFunction value);
