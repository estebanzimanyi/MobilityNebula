...
/**
 * @brief nai_tpose_pose (TInstant *) — tpose nearest-approach ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tpose_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTposePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTposePose";

    NaiTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
