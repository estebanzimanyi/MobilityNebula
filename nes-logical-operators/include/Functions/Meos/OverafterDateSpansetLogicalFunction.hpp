...
/**
 * @brief overafter_date_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_date_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterDateSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterDateSpanset";

    OverafterDateSpansetLogicalFunction(LogicalFunction lit,
