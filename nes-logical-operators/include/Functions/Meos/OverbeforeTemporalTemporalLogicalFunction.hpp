...
/**
 * @brief Per-event overbefore_temporal_temporal between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbefore_temporal_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbeforeTemporalTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbeforeTemporalTemporal";

    OverbeforeTemporalTemporalLogicalFunction(LogicalFunction lonA,
