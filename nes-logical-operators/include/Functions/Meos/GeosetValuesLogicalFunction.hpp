...
/**
 * @brief geoset_values (GSERIALIZED **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geoset_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeosetValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeosetValues";

    GeosetValuesLogicalFunction(LogicalFunction lit);
