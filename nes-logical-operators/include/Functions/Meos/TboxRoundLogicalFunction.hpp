...
/**
 * @brief tbox_round (TBox *) — round tbox_text to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxRound";

    TboxRoundLogicalFunction(LogicalFunction lit);
