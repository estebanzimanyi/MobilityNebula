...
/**
 * @brief Tests if H3 cell index a is greater than or equal to b.
 */
class H3indexGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexGe";

    H3indexGeLogicalFunction(LogicalFunction a, LogicalFunction b);
