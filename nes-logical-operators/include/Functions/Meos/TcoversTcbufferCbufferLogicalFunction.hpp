...
/**
 * @brief tcovers_tcbuffer_cbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcovers_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcoversTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcoversTcbufferCbuffer";

    TcoversTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
