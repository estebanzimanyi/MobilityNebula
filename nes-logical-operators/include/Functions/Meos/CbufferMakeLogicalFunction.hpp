...
/**
 * @brief cbuffer_make (Cbuffer *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferMake";

    CbufferMakeLogicalFunction(LogicalFunction lit,
