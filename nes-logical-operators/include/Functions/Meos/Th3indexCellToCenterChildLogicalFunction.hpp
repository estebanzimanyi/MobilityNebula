...
/**
 * @brief Returns the H3 center child cell at the given resolution as a hex string.
 *
 * Args: (cell:UINT64, ts:UINT64, resolution:UINT64) -> VARCHAR.
 */
class Th3indexCellToCenterChildLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexCellToCenterChild";

    Th3indexCellToCenterChildLogicalFunction(LogicalFunction cell, LogicalFunction ts, LogicalFunction resolution);
