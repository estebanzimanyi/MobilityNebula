...
/**
 * @brief geo_to_stbox (STBox *) — spatiotemporal bounding box.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoToStbox";

    GeoToStboxLogicalFunction(LogicalFunction lit);
