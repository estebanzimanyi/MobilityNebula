...
/**
 * @brief Per-event nad_stbox_stbox: two per-vehicle extent STBoxes -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_stbox_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadStboxStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadStboxStbox";

    NadStboxStboxLogicalFunction(LogicalFunction box,
