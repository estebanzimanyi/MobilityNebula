...
/**
 * @brief spanset_split_each_n_spans (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_split_each_n_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetSplitEachNSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetSplitEachNSpans";

    SpansetSplitEachNSpansLogicalFunction(LogicalFunction lit,
