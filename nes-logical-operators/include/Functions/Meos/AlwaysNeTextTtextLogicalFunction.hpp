...
/**
 * @brief Always nequal text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTextTtextLogicalFunction(LogicalFunction arg0,
