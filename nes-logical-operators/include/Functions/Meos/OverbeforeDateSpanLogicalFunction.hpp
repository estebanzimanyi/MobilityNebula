...
/**
 * @brief overbefore_date_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbefore_date_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbeforeDateSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbeforeDateSpan";

    OverbeforeDateSpanLogicalFunction(LogicalFunction lit,
