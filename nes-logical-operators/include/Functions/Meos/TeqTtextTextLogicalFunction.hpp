...
/**
 * @brief teq_ttext_text (Temporal *) — temporal ttext ⊗ text -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `teq_ttext_text`. Per-event scalar operator following the
...
public:
    ...
    TeqTtextTextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
