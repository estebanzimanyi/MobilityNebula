...
/**
 * @brief Per-event ever-dwithin between two tgeompoints resolved from tposes via tpose_to_tgeompoint, within a distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edwithin_tgeo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEDWithinTPoseTPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTPoseTPose";

    TemporalEDWithinTPoseTPoseLogicalFunction(LogicalFunction xA,
                                          LogicalFunction yA,
