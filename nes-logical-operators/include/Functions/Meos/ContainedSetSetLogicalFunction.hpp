...
/**
 * @brief contained_set_set over two text literals (parsed as intset/intset_in); type-generic MEOS topology predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_set_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedSetSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedSetSet";

    ContainedSetSetLogicalFunction(LogicalFunction lit,
