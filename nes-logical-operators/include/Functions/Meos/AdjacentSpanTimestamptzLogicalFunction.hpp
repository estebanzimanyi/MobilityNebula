...
/**
 * @brief adjacent_span_timestamptz (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_span_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentSpanTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentSpanTimestamptz";

    AdjacentSpanTimestamptzLogicalFunction(LogicalFunction lit,
