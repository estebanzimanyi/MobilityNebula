 ...
 */
class AlwaysLeTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysLeTintTint";

    AlwaysLeTintTintLogicalFunction(LogicalFunction value1,
