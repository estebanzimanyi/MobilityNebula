...
/**
 * @brief intspanset_upper (int) — unary intspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspanset_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspansetUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspansetUpper";

    IntspansetUpperLogicalFunction(LogicalFunction lit);
