...
/**
 * @brief tempsubtype_name (const char *) - the name of a temporal subtype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tempsubtype_name`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TempsubtypeNameLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TempsubtypeName";

    TempsubtypeNameLogicalFunction(LogicalFunction value);
