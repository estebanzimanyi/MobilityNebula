...
/**
 * @brief Returns 1.0 if temporal geometry is always within dist of the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR, dist:FLOAT64) -> FLOAT64.
 */
class AdwithinTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdwithinTgeoGeo";

    AdwithinTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
