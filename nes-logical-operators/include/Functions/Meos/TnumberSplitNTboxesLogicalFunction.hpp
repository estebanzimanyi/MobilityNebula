...
/**
 * @brief tnumber_split_n_tboxes (TBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_split_n_tboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberSplitNTboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberSplitNTboxes";

    TnumberSplitNTboxesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
