...
/**
 * @brief temporal_hash (uint32) — unary tfloat accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalHash";

    TemporalHashLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
