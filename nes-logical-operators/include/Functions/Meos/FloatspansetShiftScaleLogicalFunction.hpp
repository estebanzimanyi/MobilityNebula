...
/**
 * @brief floatspanset_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled floatspanset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetShiftScale";

    FloatspansetShiftScaleLogicalFunction(LogicalFunction lit,
