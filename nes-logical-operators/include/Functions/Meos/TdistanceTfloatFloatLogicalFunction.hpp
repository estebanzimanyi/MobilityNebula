...
/**
 * @brief Per-event tdistance_tfloat_float: distance between a single-instant tfloat and a float.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tfloat_float`. Takes (value:FLOAT64, ts:UINT64, d:FLOAT64),
 * constructs a single-instant temporal, applies the distance function, and returns FLOAT64.
 */
class TdistanceTfloatFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTfloatFloat";

    TdistanceTfloatFloatLogicalFunction(LogicalFunction value,
                                        LogicalFunction ts,
                                        LogicalFunction d);
