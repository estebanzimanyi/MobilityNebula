...
/**
 * @brief Per-event tdistance_tfloat_float: temporal distance between tfloat and scalar float.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tfloat_float`. Per-event scalar operator following the
