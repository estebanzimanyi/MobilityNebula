...
/**
 * @brief Per-event ever_ne_tint_int: tests if a single-instant tint value ever is != a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tint_int`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class EverNeTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTintInt";

    EverNeTintIntLogicalFunction(LogicalFunction value,
