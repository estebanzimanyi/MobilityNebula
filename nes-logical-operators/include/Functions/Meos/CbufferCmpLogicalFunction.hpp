...
/**
 * @brief cbuffer_cmp (int) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferCmp";

    CbufferCmpLogicalFunction(LogicalFunction lit,
