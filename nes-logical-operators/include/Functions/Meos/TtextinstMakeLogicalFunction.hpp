...
/**
 * @brief ttextinst_make (TInstant *) — constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttextinst_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextinstMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextinstMake";

    TtextinstMakeLogicalFunction(LogicalFunction lit,
