...
/**
 * @brief tstzspanset_num_timestamps (int) — unary tstzspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_num_timestamps`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetNumTimestampsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetNumTimestamps";

    TstzspansetNumTimestampsLogicalFunction(LogicalFunction lit);
