...
/**
 * @brief floatset_ceil (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_ceil`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetCeilLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetCeil";

    FloatsetCeilLogicalFunction(LogicalFunction lit);
