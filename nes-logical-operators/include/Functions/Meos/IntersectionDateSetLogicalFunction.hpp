...
/**
 * @brief intersection_date_set: extern Set *intersection_date_set(DateADT d, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersection_date_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntersectionDateSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntersectionDateSet";

    IntersectionDateSetLogicalFunction(LogicalFunction lit,
