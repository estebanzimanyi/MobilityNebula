...
/**
 * @brief Per-event overfront_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overfront_tspatial_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverfrontTspatialTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverfrontTspatialTspatial";

    OverfrontTspatialTspatialLogicalFunction(LogicalFunction lonA,
