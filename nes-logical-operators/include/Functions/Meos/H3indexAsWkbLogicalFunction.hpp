...
/**
 * @brief Serializes an H3Index cell (UINT64) to raw WKB bytes.
 */
class H3indexAsWkbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexAsWkb";

    H3indexAsWkbLogicalFunction(LogicalFunction cell, LogicalFunction variant);
