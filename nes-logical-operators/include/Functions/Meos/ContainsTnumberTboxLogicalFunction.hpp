...
/**
 * @brief Per-event contains_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsTnumberTbox";

    ContainsTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
