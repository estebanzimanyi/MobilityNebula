...
/**
 * @brief union_set_date: extern Set *union_set_date(const Set *s, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_set_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSetDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSetDate";

    UnionSetDateLogicalFunction(LogicalFunction lit,
