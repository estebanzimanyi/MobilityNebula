...
/**
 * @brief tstzspanset_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetBins";

    TstzspansetBinsLogicalFunction(LogicalFunction lit,
