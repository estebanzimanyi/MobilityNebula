...
/**
 * @brief tne_cbuffer_tcbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TneCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TneCbufferTcbuffer";

    TneCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
