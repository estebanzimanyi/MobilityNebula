...
/**
 * @brief span_lower_inc (bool) — unary intspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_lower_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanLowerIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanLowerInc";

    SpanLowerIncLogicalFunction(LogicalFunction lit);
