...
/**
 * @brief span_gt (bool) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanGt";

    SpanGtLogicalFunction(LogicalFunction lit,
