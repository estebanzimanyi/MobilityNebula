...
/**
 * @brief Returns 1 if the geometry acovers the trgeometry instant.
 */
class AcoversGeoTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcoversGeoTrgeometry";
    AcoversGeoTrgeometryLogicalFunction(LogicalFunction tgt_wkt, LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1);
