...
/**
 * @brief Serializes an H3Index cell (UINT64) to its HexWKB string, with endian variant.
 */
class H3indexAsHexwkbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexAsHexwkb";

    H3indexAsHexwkbLogicalFunction(LogicalFunction cell, LogicalFunction variant);
