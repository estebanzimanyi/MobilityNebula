...
/**
 * @brief Per-event ever_ne_tgeo_geo between a single-instant tgeompoint and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tgeo_geo`. Per-event scalar operator following the
...
public:
    ...
    EverNeTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
