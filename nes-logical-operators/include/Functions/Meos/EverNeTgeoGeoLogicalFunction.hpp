...
/**
 * @brief Returns 1.0 if the temporal geometry is ever not equal to the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class EverNeTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTgeoGeo";

    EverNeTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
