...
/**
 * @brief Returns 1.0 if two planar geometries are spatially equal.
 *
 * Args: (wkt1:VARCHAR, wkt2:VARCHAR) -> FLOAT64.
 */
class GeoEqualsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoEquals";

    GeoEqualsLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
