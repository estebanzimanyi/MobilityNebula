...
/**
 * @brief tcbuffer_expand (Temporal *) - expand a temporal circular buffer by a distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_expand`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferExpandLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferExpand";

    TcbufferExpandLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
