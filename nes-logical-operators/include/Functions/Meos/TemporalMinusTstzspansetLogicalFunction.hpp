...
/**
 * @brief temporal_minus_tstzspanset (Temporal *) — tint restricted by a tstzspanset box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_minus_tstzspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMinusTstzspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMinusTstzspanset";

    TemporalMinusTstzspansetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
