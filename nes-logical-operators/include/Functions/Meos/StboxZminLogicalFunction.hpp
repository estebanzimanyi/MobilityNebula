...
/**
 * @brief stbox_zmin (out-param double) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_zmin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxZminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxZmin";

    StboxZminLogicalFunction(LogicalFunction box);
