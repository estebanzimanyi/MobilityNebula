...
/**
 * @brief date_to_timestamptz (TimestampTz) — scalar date/time conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `date_to_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DateToTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DateToTimestamptz";

    DateToTimestamptzLogicalFunction(LogicalFunction value);
