...
/**
 * @brief tnpoint_minus_geom (Temporal *) — tnpoint restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_minus_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointMinusGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointMinusGeom";

    TnpointMinusGeomLogicalFunction(LogicalFunction rid,
