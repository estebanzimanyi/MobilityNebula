...
/**
 * @brief timestamptz_to_spanset (timestamptz value) -> spanset (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_to_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzToSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzToSpanset";

    TimestamptzToSpansetLogicalFunction(LogicalFunction value);
