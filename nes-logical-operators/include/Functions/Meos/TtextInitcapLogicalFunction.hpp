...
/**
 * @brief Per-event ttext_initcap: single-instant ttext transform -> varchar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_initcap`. Per-event scalar operator; returns the transformed text value.
 */
class TtextInitcapLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextInitcap";

    TtextInitcapLogicalFunction(LogicalFunction value,
                         LogicalFunction ts);
