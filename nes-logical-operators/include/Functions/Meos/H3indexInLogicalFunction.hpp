...
/**
 * @brief Parses an H3Index hex string (VARSIZED) to a cell identifier (UINT64).
 */
class H3indexInLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexIn";

    H3indexInLogicalFunction(LogicalFunction hex);
