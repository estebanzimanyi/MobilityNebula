 ...
 */
class EverEqTbigintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTbigintTfloat";

    EverEqTbigintTfloatLogicalFunction(LogicalFunction value1,
