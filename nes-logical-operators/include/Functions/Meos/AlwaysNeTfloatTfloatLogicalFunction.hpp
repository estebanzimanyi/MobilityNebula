...
/**
 * @brief Per-event always_ne_tfloat_tfloat: tests if two single-instant tfloat values are always not equal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tfloat_tfloat`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two single-instant temporals, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysNeTfloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTfloatTfloat";

    AlwaysNeTfloatTfloatLogicalFunction(LogicalFunction value1,
