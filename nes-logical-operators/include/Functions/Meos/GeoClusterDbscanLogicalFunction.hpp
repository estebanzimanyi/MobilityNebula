...
/**
 * @brief geo_cluster_dbscan (int) — geometry cluster id (array input).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_cluster_dbscan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoClusterDbscanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoClusterDbscan";

    GeoClusterDbscanLogicalFunction(LogicalFunction lit);
