...
/**
 * @brief tbox_eq (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_eq`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxEq";

    TboxEqLogicalFunction(LogicalFunction lit,
