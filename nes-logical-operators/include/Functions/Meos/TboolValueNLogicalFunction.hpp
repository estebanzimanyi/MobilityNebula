...
/**
 * @brief tbool_value_n (out-param bool, n=1) — tbool value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolValueN";

    TboolValueNLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
