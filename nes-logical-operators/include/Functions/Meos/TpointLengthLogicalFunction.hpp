 ...
 */
class TpointLengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointLength";

    TpointLengthLogicalFunction(LogicalFunction traj);
