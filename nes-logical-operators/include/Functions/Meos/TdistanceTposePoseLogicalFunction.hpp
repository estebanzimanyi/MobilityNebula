...
/**
 * @brief tdistance_tpose_pose (Temporal *) — temporal tpose ⊗ Pose -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tpose_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTposePoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTposePose";

    TdistanceTposePoseLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
