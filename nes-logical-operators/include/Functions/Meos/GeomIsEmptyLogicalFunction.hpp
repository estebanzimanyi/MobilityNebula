...
/**
 * @brief Returns 1.0 if the geometry is empty, 0.0 otherwise: (wkt:VARCHAR) -> float64.
 */
class GeomIsEmptyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomIsEmpty";

    explicit GeomIsEmptyLogicalFunction(LogicalFunction wkt1);
