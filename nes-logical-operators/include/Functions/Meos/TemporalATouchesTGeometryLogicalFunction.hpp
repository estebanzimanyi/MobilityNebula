...
/**
 * @brief Per-event always-touches between two single-instant tgeompoints.
 *
 ...
 */
class TemporalATouchesTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalATouchesTGeometry";

    TemporalATouchesTGeometryLogicalFunction(LogicalFunction lonA,
