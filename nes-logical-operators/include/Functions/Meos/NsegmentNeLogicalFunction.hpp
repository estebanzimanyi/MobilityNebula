...
/**
 * @brief nsegment_ne (bool) — Nsegment scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentNe";

    NsegmentNeLogicalFunction(LogicalFunction lit,
