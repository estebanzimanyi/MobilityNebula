...
class AlwaysGeTtextTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysGeTtextText";

    AlwaysGeTtextTextLogicalFunction(LogicalFunction value, LogicalFunction ref, LogicalFunction ts);
