...
/**
 * @brief always_ge_ttext_text (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ge_ttext_text`. Per-event scalar operator following the
...
public:
    ...
    AlwaysGeTtextTextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
