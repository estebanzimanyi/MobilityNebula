...
/**
 * @brief Per-event adjacent_tspatial_stbox: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_tspatial_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentTspatialStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentTspatialStbox";

    AdjacentTspatialStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
