...
/**
 * @brief Per-event nad_tgeo_stbox: single-instant tgeompoint against a stbox literal -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tgeo_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTgeoStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTgeoStbox";

    NadTgeoStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
