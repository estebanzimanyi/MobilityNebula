...
/**
 * @brief tstzspanset_timestamps (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_timestamps`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetTimestampsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetTimestamps";

    TstzspansetTimestampsLogicalFunction(LogicalFunction lit);
