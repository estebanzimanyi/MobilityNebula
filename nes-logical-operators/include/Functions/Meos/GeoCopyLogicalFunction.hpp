...
/**
 * @brief geo_copy (GSERIALIZED *) — unary geom accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_copy`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoCopyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoCopy";

    GeoCopyLogicalFunction(LogicalFunction lit);
