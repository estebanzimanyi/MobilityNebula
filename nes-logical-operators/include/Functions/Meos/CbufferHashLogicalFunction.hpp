...
/**
 * @brief cbuffer_hash (uint32) — unary cbuffer accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferHash";

    CbufferHashLogicalFunction(LogicalFunction lit);
