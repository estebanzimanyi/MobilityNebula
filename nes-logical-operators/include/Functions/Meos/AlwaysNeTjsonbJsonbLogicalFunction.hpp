...
/**
 * @brief Returns 1.0 if the tjsonb instant value always differs from the target Jsonb.
 */
class AlwaysNeTjsonbJsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTjsonbJsonb";

    AlwaysNeTjsonbJsonbLogicalFunction(LogicalFunction json_str, LogicalFunction ts, LogicalFunction target_json);
