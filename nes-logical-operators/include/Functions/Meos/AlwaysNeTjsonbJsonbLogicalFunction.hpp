...
/**
 * @brief Always neual tjsonb vs jsonb
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tjsonb_jsonb`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTjsonbJsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
