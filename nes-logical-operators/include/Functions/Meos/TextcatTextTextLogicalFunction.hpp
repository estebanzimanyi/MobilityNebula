...
/**
 * @brief textcat_text_text (text *) - concatenation of two text values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_text_text`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextcatTextTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextcatTextText";

    TextcatTextTextLogicalFunction(LogicalFunction lit,
