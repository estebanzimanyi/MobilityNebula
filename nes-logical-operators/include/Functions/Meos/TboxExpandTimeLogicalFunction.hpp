...
/**
 * @brief tbox_expand_time (TBox *) — Interval-consuming op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_expand_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxExpandTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxExpandTime";

    TboxExpandTimeLogicalFunction(LogicalFunction lit,
