...
/**
 * @brief spanset_span (Span *) — unary floatspanset -> Span.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetSpan";

    SpansetSpanLogicalFunction(LogicalFunction lit);
