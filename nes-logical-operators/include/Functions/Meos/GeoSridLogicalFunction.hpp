...
/**
 * @brief Returns the SRID of a geometry.
 *
 * Args: (wkt:VARCHAR) -> FLOAT64.
 */
class GeoSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoSrid";

    explicit GeoSridLogicalFunction(LogicalFunction wkt);
