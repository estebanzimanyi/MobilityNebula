...
/**
 * @brief Per-event ever-dwithin between a tgeompoint resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint and a static geometry (network SRID), within a distance.
 *
 ...
 */
class TemporalEDWithinTNpointGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTNpointGeometry";

    TemporalEDWithinTNpointGeometryLogicalFunction(LogicalFunction rid,
