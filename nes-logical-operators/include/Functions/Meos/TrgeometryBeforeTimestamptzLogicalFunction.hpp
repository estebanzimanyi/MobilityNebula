...
/**
 * @brief trgeometry_before_timestamptz (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_before_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryBeforeTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryBeforeTimestamptz";

    TrgeometryBeforeTimestamptzLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
