...
/**
 * @brief tstzspan_upper (TimestampTz) — unary tstzspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_upper`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanUpper";

    TstzspanUpperLogicalFunction(LogicalFunction lit);
