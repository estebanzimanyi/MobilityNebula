...
/**
 * @brief Per-event atouches_geo_tgeo: a static geometry vs a single-instant tgeompoint (geo-first) -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `atouches_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AtouchesGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AtouchesGeoTgeo";

    AtouchesGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
