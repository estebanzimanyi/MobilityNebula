...
/**
 * @brief Returns the geometry with vertex order reversed as WKT.
 */
class GeoReverseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoReverse";

    GeoReverseLogicalFunction(LogicalFunction wkt);
