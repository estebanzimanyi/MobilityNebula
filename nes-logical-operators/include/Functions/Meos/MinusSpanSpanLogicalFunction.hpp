...
/**
 * @brief minus_span_span over two text literals; type-generic MEOS set-algebra, VARSIZED (intspanset_text).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_span_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSpanSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSpanSpan";

    MinusSpanSpanLogicalFunction(LogicalFunction lit,
