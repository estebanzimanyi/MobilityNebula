...
/**
 * @brief temporal NE: scalar bool vs single-instant tbool
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_bool_tbool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class TneBoolTboolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TneBoolTbool";

    TneBoolTboolLogicalFunction(LogicalFunction value,
