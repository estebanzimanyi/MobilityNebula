...
/**
 * @brief Per-event tne_bool_tbool: temporal inequality of scalar bool and tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    TneBoolTboolLogicalFunction(LogicalFunction arg0,
