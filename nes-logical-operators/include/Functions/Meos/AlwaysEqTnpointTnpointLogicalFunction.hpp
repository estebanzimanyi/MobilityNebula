...
/**
 * @brief Per-event always_eq_tnpoint_tnpoint: two hex-WKB temporal operands -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tnpoint_tnpoint`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTnpointTnpointLogicalFunction(LogicalFunction traj,
