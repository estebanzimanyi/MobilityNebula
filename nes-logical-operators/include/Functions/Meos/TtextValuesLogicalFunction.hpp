...
/**
 * @brief ttext_values (text **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextValues";

    TtextValuesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
