...
/**
 * @brief intspan_expand (Span *) — span widened by a scalar delta.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intspan_expand`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntspanExpandLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanExpand";

    IntspanExpandLogicalFunction(LogicalFunction lit,
