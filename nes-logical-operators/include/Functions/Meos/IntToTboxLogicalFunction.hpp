...
/**
 * @brief int_to_tbox (TBox *) — int -> TBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntToTbox";

    IntToTboxLogicalFunction(LogicalFunction value);
