...
/**
 * @brief tpoint_type (bool) — type-dispatch predicate on a value's temptype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointType";

    TpointTypeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
