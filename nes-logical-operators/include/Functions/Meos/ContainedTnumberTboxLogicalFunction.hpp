...
/**
 * @brief Per-event contained_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTnumberTbox";

    ContainedTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
