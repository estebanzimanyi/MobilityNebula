...
/**
 * @brief Per-event always-disjoint between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalADisjointTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADisjointTPoseGeometry";

    TemporalADisjointTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
