...
/**
 * @brief spatialset_srid (int) - the SRID of a geo set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spatialset_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpatialsetSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpatialsetSrid";

    SpatialsetSridLogicalFunction(LogicalFunction lit);
