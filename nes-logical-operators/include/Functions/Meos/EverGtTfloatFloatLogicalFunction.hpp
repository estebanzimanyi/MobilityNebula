...
/**
 * @brief Per-event ever_gt_tfloat_float: tests if a single-instant tfloat value is ever > a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_gt_tfloat_float`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class EverGtTfloatFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGtTfloatFloat";

    EverGtTfloatFloatLogicalFunction(LogicalFunction value,
