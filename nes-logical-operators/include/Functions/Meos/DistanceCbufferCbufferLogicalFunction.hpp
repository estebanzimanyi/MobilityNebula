...
/**
 * @brief distance_cbuffer_cbuffer (double) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_cbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceCbufferCbuffer";

    DistanceCbufferCbufferLogicalFunction(LogicalFunction lit,
