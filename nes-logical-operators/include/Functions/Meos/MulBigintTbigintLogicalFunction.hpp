...
/**
 * @brief Per-event mul_bigint_tbigint: multiplies a constant int64 scalar by a single-instant tbigint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `mul_bigint_tbigint`. Takes (scalar:FLOAT64→int64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the multiplication, and returns FLOAT64.
 */
class MulBigintTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MulBigintTbigint";

    MulBigintTbigintLogicalFunction(LogicalFunction scalar,
