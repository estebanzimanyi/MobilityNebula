...
/**
 * @brief span_hash (uint32) — unary intspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_hash`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanHashLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanHash";

    SpanHashLogicalFunction(LogicalFunction lit);
