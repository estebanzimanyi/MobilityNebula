...
/**
 * @brief tcbuffer_traversed_area (GSERIALIZED *) - the area traversed by a temporal circular buffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tcbuffer_traversed_area`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TcbufferTraversedAreaLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TcbufferTraversedArea";

    TcbufferTraversedAreaLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
