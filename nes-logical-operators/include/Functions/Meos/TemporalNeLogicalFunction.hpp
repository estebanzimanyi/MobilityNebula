...
/**
 * @brief Per-event temporal_ne between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNe";

    TemporalNeLogicalFunction(LogicalFunction lonA,
