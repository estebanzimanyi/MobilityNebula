...
/**
 * @brief Returns a FLOAT64 scalar for a quadbin cell. NES token: QUADBIN_IS_VALID_CELL.
 */
class QuadbinIsValidCellLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinIsValidCell";

    QuadbinIsValidCellLogicalFunction(LogicalFunction cell);
