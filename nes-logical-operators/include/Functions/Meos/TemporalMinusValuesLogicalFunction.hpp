...
/**
 * @brief temporal_minus_values (Temporal *) — tint restricted by a values box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_minus_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMinusValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMinusValues";

    TemporalMinusValuesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
