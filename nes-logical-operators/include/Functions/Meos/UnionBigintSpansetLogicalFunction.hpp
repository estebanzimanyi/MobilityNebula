...
/**
 * @brief union_bigint_spanset (SpanSet *) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_bigint_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionBigintSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionBigintSpanset";

    UnionBigintSpansetLogicalFunction(LogicalFunction lit,
