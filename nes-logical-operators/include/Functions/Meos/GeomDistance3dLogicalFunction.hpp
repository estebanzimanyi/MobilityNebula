...
/**
 * @brief geom_distance3d (double) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_distance3d`. Per-event scalar operator following the
...
public:
    ...
    GeomDistance3dLogicalFunction(LogicalFunction lit,
