...
/**
 * @brief Static geometry function geom_distance3d: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function `geom_distance3d`.
 */
class GeomDistance3dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomDistance3d";

    GeomDistance3dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
