...
/**
 * @brief float_tstzspan_to_tbox (TBox *) — double + Span -> TBox constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_tstzspan_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatTstzspanToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatTstzspanToTbox";

    FloatTstzspanToTboxLogicalFunction(LogicalFunction value,
