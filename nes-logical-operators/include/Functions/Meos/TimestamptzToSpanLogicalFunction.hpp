...
/**
 * @brief timestamptz_to_span (timestamptz value) -> span (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_to_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzToSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzToSpan";

    TimestamptzToSpanLogicalFunction(LogicalFunction value);
