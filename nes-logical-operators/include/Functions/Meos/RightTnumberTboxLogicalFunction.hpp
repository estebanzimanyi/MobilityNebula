...
/**
 * @brief Per-event right_tnumber_tbox: single-instant tfloat against a tbox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_tnumber_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightTnumberTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightTnumberTbox";

    RightTnumberTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
