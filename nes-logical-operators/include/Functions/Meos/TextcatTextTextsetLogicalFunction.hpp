...
/**
 * @brief textcat_text_textset (Set *) - a text concatenated before each element of a text set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_text_textset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextcatTextTextsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextcatTextTextset";

    TextcatTextTextsetLogicalFunction(LogicalFunction lit,
