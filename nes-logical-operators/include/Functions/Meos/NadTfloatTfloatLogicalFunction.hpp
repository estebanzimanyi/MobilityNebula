 ...
 */
class NadTfloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTfloatTfloat";

    NadTfloatTfloatLogicalFunction(LogicalFunction valueA,
                                          LogicalFunction tsA,
