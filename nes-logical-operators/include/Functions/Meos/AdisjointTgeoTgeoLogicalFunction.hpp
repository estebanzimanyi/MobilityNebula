...
/**
 * @brief Tests whether two temporal geometries are always disjoint.
 */
class AdisjointTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdisjointTgeoTgeo";

    AdisjointTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2);
