...
/**
 * @brief tstzspanset_duration (Interval *) — tstzspanset duration.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_duration`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetDurationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetDuration";

    TstzspansetDurationLogicalFunction(LogicalFunction lit);
