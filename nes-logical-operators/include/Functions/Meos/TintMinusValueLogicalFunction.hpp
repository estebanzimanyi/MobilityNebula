...
/**
 * @brief tint_minus_value (Temporal *) — temporal tint ⊗ scalar -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_minus_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintMinusValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintMinusValue";

    TintMinusValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
