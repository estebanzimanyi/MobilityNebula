...
/**
 * @brief ever_ne_pose_tpose (int) — always/ever tpose ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_pose_tpose`. Per-event scalar operator following the
...
public:
    ...
    EverNePoseTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
