...
/**
 * @brief always_ne_tnpoint_npoint (int) — always/ever tnpoint ⊗ Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tnpoint_npoint`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTnpointNpointLogicalFunction(LogicalFunction rid,
