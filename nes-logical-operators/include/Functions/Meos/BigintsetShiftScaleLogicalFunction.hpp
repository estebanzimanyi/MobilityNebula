...
/**
 * @brief bigintset_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled bigintset.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintset_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintsetShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintsetShiftScale";

    BigintsetShiftScaleLogicalFunction(LogicalFunction lit,
