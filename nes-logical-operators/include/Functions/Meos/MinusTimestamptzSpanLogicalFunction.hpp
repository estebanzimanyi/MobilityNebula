...
/**
 * @brief minus_timestamptz_span: extern SpanSet *minus_timestamptz_span(TimestampTz t, const Span *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_timestamptz_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusTimestamptzSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusTimestamptzSpan";

    MinusTimestamptzSpanLogicalFunction(LogicalFunction lit,
