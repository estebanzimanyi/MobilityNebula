...
/**
 * @brief temporal_instant_n (TInstant *) — temporal-point accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_instant_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalInstantNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalInstantN";

    TemporalInstantNLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
