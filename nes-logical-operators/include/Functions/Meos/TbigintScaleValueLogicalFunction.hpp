...
/**
 * @brief Per-event tbigint_scale_value: scales a single-instant tbigint to a given int64_t width.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbigint_scale_value`. Takes (value:FLOAT64, ts:UINT64, width:FLOAT64→int64_t),
 * constructs a single-instant temporal, applies the scale, and returns FLOAT64.
 */
class TbigintScaleValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TbigintScaleValue";

    TbigintScaleValueLogicalFunction(LogicalFunction value,
                                     LogicalFunction ts,
