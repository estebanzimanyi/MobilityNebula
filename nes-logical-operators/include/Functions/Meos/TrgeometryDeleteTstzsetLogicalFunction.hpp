...
/**
 * @brief trgeometry_delete_tstzset (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_delete_tstzset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryDeleteTstzsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryDeleteTstzset";

    TrgeometryDeleteTstzsetLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
