...
/**
 * @brief bigintset_values (int64 *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintset_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintsetValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintsetValues";

    BigintsetValuesLogicalFunction(LogicalFunction lit);
