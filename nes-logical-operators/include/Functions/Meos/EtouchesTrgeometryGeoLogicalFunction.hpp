...
/**
 * @brief Returns 1 if the trgeometry instant etouches the geometry.
 */
class EtouchesTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EtouchesTrgeometryGeo";
    EtouchesTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1, LogicalFunction tgt_wkt);
