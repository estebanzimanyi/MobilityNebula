...
/**
 * @brief always_ne_trgeometry_trgeometry (bool) — two trgeometry instants -> int reduction.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_trgeometry_trgeometry`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
