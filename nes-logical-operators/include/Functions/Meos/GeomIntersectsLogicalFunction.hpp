...
/**
 * @brief Returns 1.0 if two planar geometries intersect (default planar, no dimension suffix).
 *
 * Args: (wkt1:VARCHAR, wkt2:VARCHAR) -> FLOAT64.
 */
class GeomIntersectsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomIntersects";

    GeomIntersectsLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
