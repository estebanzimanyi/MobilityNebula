...
/**
 * @brief spanset_ne (bool) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetNe";

    SpansetNeLogicalFunction(LogicalFunction lit,
