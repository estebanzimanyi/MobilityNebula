...
/**
 * @brief temporal_minus_tstzset (Temporal *) — tint restricted by a tstzset box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_minus_tstzset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalMinusTstzsetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalMinusTstzset";

    TemporalMinusTstzsetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
