...
/**
 * @brief acontains_cbuffer_tcbuffer (int) — temporal tcbuffer ⊗ Cbuffer -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `acontains_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AcontainsCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AcontainsCbufferTcbuffer";

    AcontainsCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
