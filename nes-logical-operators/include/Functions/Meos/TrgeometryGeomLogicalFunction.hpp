...
/**
 * @brief trgeometry_geom (GSERIALIZED *) — unary trgeometry accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryGeom";

    TrgeometryGeomLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
