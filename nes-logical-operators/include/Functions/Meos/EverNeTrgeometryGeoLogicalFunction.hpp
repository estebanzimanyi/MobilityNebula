...
/**
 * @brief ever_ne_trgeometry_geo (int) — temporal trgeometry ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_trgeometry_geo`. Per-event scalar operator following the
...
public:
    ...
    EverNeTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
