...
/**
 * @brief nai_trgeometry_trgeometry (TInstant *) — two trgeometry instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_trgeometry_trgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTrgeometryTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTrgeometryTrgeometry";

    NaiTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
