...
/**
 * @brief numspan_basetype (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `numspan_basetype`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NumspanBasetypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NumspanBasetype";

    NumspanBasetypeLogicalFunction(LogicalFunction lit);
