...
/**
 * @brief floatset_degrees (Set *) — radians->degrees container transform.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_degrees`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetDegreesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetDegrees";

    FloatsetDegreesLogicalFunction(LogicalFunction lit,
