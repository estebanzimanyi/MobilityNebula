...
/**
 * @brief span_eq (bool) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_eq`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanEq";

    SpanEqLogicalFunction(LogicalFunction lit,
