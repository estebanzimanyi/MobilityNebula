...
/**
 * @brief Per-event ever-distance-within between two single-instant tcbuffers under a fixed threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `edwithin_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEDWithinTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTCbufferTCbuffer";

    TemporalEDWithinTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
