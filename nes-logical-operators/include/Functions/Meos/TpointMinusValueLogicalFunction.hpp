...
/**
 * @brief tpoint_minus_value (Temporal *) — tgeo restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_minus_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointMinusValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointMinusValue";

    TpointMinusValueLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
