...
/**
 * @brief ever_eq_npoint_tnpoint (int) — always/ever tnpoint ⊗ Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_npoint_tnpoint`. Per-event scalar operator following the
...
public:
    ...
    EverEqNpointTnpointLogicalFunction(LogicalFunction rid,
