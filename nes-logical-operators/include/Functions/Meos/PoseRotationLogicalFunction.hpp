...
/**
 * @brief pose_rotation (double) — unary pose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_rotation`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseRotationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseRotation";

    PoseRotationLogicalFunction(LogicalFunction lit);
