...
/**
 * @brief Tests if Quadbin cell a is greater than or equal to b.
 */
class QuadbinGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinGe";
    QuadbinGeLogicalFunction(LogicalFunction a, LogicalFunction b);
