...
/**
 * @brief spanset_gt (bool) — SpanSet/SpanSet operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetGt";

    SpansetGtLogicalFunction(LogicalFunction lit,
