...
/**
 * @brief cbuffer_round (Cbuffer *) — round cbuffer to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferRound";

    CbufferRoundLogicalFunction(LogicalFunction lit);
