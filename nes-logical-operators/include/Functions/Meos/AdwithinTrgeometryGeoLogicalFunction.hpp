...
/**
 * @brief Returns 1 if the trgeometry instant is within dist of the geometry (adwithin).
 */
class AdwithinTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdwithinTrgeometryGeo";
    AdwithinTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1, LogicalFunction tgt_wkt, LogicalFunction dist);
