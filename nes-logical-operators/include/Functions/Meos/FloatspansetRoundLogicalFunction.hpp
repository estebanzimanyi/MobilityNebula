...
/**
 * @brief floatspanset_round (SpanSet *) — round floatspanset to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetRound";

    FloatspansetRoundLogicalFunction(LogicalFunction lit);
