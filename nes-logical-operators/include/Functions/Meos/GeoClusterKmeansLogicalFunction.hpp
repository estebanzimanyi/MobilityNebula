...
/**
 * @brief geo_cluster_kmeans (int) — geometry cluster id (array input).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_cluster_kmeans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoClusterKmeansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoClusterKmeans";

    GeoClusterKmeansLogicalFunction(LogicalFunction lit);
