...
/**
 * @brief Per-event ever-touches between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalETouchesTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalETouchesTPoseGeometry";

    TemporalETouchesTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
