...
/**
 * @brief distance_floatspan_floatspan (double) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_floatspan_floatspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceFloatspanFloatspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceFloatspanFloatspan";

    DistanceFloatspanFloatspanLogicalFunction(LogicalFunction lit,
