...
/**
 * @brief floatset_value_n (out-param double, n=1) — floatset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetValueN";

    FloatsetValueNLogicalFunction(LogicalFunction lit);
