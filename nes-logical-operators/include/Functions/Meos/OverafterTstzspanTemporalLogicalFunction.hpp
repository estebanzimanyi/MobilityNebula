...
/**
 * @brief overafter_tstzspan_temporal (Temporal, tstzspan) time topological relationship -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_tstzspan_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterTstzspanTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterTstzspanTemporal";

    OverafterTstzspanTemporalLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
