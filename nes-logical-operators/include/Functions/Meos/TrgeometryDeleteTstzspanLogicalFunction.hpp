...
/**
 * @brief trgeometry_delete_tstzspan (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_delete_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryDeleteTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryDeleteTstzspan";

    TrgeometryDeleteTstzspanLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
