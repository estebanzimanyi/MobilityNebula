...
/**
 * @brief tnpoint_routes (Set *) — unary tnpoint accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_routes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointRoutesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointRoutes";

    TnpointRoutesLogicalFunction(LogicalFunction rid,
