...
/**
 * @brief Returns 1 if the trgeometry instant adisjoint the geometry.
 */
class AdisjointTrgeometryGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdisjointTrgeometryGeo";
    AdisjointTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1, LogicalFunction tgt_wkt);
