...
/**
 * @brief temporal_timestamptz_n (out-param TimestampTz, n=1) — tfloat value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_timestamptz_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalTimestamptzNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalTimestamptzN";

    TemporalTimestamptzNLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
