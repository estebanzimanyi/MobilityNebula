 ...
 */
class NadTfloatFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTfloatFloat";

    NadTfloatFloatLogicalFunction(LogicalFunction value,
