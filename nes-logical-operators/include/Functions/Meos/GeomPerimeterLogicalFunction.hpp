...
/**
 * @brief Static geometry scalar geom_perimeter: (wkt1:VARCHAR) -> float64.
 *
 * Generated from the MEOS function `geom_perimeter`.
 * Operates on plain WKT strings without a temporal dimension.
 */
class GeomPerimeterLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomPerimeter";

    explicit GeomPerimeterLogicalFunction(LogicalFunction wkt1);
