...
/**
 * @brief Ever lequal text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_le_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    EverLeTextTtextLogicalFunction(LogicalFunction arg0,
