...
/**
 * @brief ever_le_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_le_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    EverLeTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
