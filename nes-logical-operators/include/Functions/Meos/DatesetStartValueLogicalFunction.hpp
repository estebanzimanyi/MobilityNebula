...
/**
 * @brief dateset_start_value (DateADT) — unary dateset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `dateset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatesetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatesetStartValue";

    DatesetStartValueLogicalFunction(LogicalFunction lit);
