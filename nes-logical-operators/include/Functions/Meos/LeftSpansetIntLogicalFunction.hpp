...
/**
 * @brief left_spanset_int (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `left_spanset_int`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class LeftSpansetIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LeftSpansetInt";

    LeftSpansetIntLogicalFunction(LogicalFunction lit,
