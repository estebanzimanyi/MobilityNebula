...
/**
 * @brief Per-event always-contains between a single-instant tgeompoint and a static geometry.
 *
 ...
 */
class TemporalAContainsGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAContainsGeometry";

    TemporalAContainsGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
