 ...
 */
class JsonArrayLengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonArrayLength";

    JsonArrayLengthLogicalFunction(LogicalFunction js);
