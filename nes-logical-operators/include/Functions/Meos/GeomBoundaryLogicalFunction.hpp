...
/**
 * @brief geom_boundary (GSERIALIZED *) — unary geom accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_boundary`. Per-event scalar operator following the
...
public:
    ...
    GeomBoundaryLogicalFunction(LogicalFunction lit);
