...
/**
 * @brief Returns the boundary of a geometry as WKT.
 */
class GeomBoundaryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomBoundary";

    GeomBoundaryLogicalFunction(LogicalFunction wkt);
