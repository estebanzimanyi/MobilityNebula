...
/**
 * @brief Parses a hex EWKB string and returns the geometry as WKT.
 */
class GeomFromHexewkbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomFromHexewkb";

    GeomFromHexewkbLogicalFunction(LogicalFunction hex);
