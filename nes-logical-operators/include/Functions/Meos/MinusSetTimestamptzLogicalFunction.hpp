...
/**
 * @brief minus_set_timestamptz: extern Set *minus_set_timestamptz(const Set *s, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetTimestamptz";

    MinusSetTimestamptzLogicalFunction(LogicalFunction lit,
