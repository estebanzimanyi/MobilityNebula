...
/**
 * @brief Per-event always-contains between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalAContainsTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAContainsTPoseGeometry";

    TemporalAContainsTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
