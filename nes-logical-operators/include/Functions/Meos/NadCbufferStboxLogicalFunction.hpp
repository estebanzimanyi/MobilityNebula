...
/**
 * @brief nad_cbuffer_stbox (double) — Cbuffer ⊗ STBox distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_cbuffer_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadCbufferStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadCbufferStbox";

    NadCbufferStboxLogicalFunction(LogicalFunction lit,
