...
/**
 * @brief ever_lt_text_ttext (int) — always/ever ttext ⊗ text.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_lt_text_ttext`. Per-event scalar operator following the
...
public:
    ...
    EverLtTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
