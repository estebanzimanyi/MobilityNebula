...
/**
 * @brief Ever ltqual text vs ttext
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_lt_text_ttext(txt0, temp)`. Per-event scalar operator following the
...
public:
    ...
    EverLtTextTtextLogicalFunction(LogicalFunction arg0,
