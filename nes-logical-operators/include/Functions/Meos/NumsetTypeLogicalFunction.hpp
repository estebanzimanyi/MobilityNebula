...
/**
 * @brief numset_type (bool) — type-dispatch predicate on a value's settype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `numset_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NumsetTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NumsetType";

    NumsetTypeLogicalFunction(LogicalFunction lit);
