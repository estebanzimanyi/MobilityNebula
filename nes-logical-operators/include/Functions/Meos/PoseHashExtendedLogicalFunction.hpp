...
/**
 * @brief pose_hash_extended (uint64) — data hash with fixed seed 1.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_hash_extended`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseHashExtendedLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseHashExtended";

    PoseHashExtendedLogicalFunction(LogicalFunction lit);
