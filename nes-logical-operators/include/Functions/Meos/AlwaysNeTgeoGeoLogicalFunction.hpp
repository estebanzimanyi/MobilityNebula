...
/**
 * @brief Per-event always_ne_tgeo_geo between a single-instant tgeompoint and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tgeo_geo`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
