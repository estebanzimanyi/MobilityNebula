...
/**
 * @brief set_split_n_spans (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_split_n_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetSplitNSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetSplitNSpans";

    SetSplitNSpansLogicalFunction(LogicalFunction lit,
