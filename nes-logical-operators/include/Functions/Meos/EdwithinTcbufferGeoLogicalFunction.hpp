...
/**
 * @brief Returns 1.0 if the tcbuffer ever comes within dist of the static geometry, 0.0 otherwise.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, radius:FLOAT64, ts:UINT64, wkt:VARCHAR, dist:FLOAT64) -> FLOAT64.
 */
class EdwithinTcbufferGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EdwithinTcbufferGeo";

    EdwithinTcbufferGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
