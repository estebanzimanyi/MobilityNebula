...
/**
 * @brief Returns a JSONB value formatted with indentation.
 */
class JsonbPrettyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbPretty";
    JsonbPrettyLogicalFunction(LogicalFunction jb);
