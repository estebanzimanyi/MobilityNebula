...
/**
 * @brief after_tbox_tbox (bool) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `after_tbox_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AfterTboxTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AfterTboxTbox";

    AfterTboxTboxLogicalFunction(LogicalFunction lit,
