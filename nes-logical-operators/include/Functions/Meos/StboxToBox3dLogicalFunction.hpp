...
/**
 * @brief stbox_to_box3d (BOX3D *) - the PostGIS BOX3D of a spatiotemporal box.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_to_box3d`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxToBox3dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxToBox3d";

    StboxToBox3dLogicalFunction(LogicalFunction box);
