...
/**
 * @brief int_to_span (int value) -> span (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int_to_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntToSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntToSpan";

    IntToSpanLogicalFunction(LogicalFunction value);
