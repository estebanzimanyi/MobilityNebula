...
/**
 * @brief floatset_start_value (double) — unary floatset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatsetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatsetStartValue";

    FloatsetStartValueLogicalFunction(LogicalFunction lit);
