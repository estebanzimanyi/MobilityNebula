...
/**
 * @brief Per-event temporal_lt between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_lt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalLtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalLt";

    TemporalLtLogicalFunction(LogicalFunction lonA,
