...
/**
 * @brief int_get_bin (int) — arity-3 int op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int_get_bin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntGetBinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntGetBin";

    IntGetBinLogicalFunction(LogicalFunction value,
