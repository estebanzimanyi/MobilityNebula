...
/**
 * @brief Per-event tint_shift_scale_value: shifts and scales a single-instant tint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_shift_scale_value`. Takes (value:FLOAT64, ts:UINT64, shift:FLOAT64→int, width:FLOAT64→int),
 * constructs a single-instant temporal, applies the shift-and-scale, and returns FLOAT64.
 */
class TintShiftScaleValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintShiftScaleValue";

    TintShiftScaleValueLogicalFunction(LogicalFunction value,
                                       LogicalFunction ts,
