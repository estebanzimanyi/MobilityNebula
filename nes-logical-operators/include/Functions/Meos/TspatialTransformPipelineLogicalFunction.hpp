...
/**
 * @brief tspatial_transform_pipeline (Temporal *) — PROJ-pipeline transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tspatial_transform_pipeline`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TspatialTransformPipelineLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TspatialTransformPipeline";

    TspatialTransformPipelineLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
