...
/**
 * @brief tdwithin_geo_tcbuffer (Temporal *) - whether a geometry is within a distance of a temporal buffer, over time.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdwithin_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdwithinGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdwithinGeoTcbuffer";

    TdwithinGeoTcbufferLogicalFunction(LogicalFunction lit,
