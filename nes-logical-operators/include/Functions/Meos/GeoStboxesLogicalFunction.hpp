...
/**
 * @brief geo_stboxes (STBox *) - the array of spatiotemporal boxes of a (multi)line geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_stboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoStboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoStboxes";

    GeoStboxesLogicalFunction(LogicalFunction lit);
