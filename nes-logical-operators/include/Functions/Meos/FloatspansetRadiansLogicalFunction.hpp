...
/**
 * @brief floatspanset_radians (SpanSet *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_radians`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetRadiansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetRadians";

    FloatspansetRadiansLogicalFunction(LogicalFunction lit);
