...
/**
 * @brief Per-event always-dwithin between a tgeompoint resolved from a tpose (x,y,theta,ts) via tpose_to_tgeompoint and a static geometry, within a distance.
 *
 ...
 */
class TemporalADWithinTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinTPoseGeometry";

    TemporalADWithinTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
