...
/**
 * @brief overleft_set_float (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_set_float`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftSetFloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftSetFloat";

    OverleftSetFloatLogicalFunction(LogicalFunction lit,
