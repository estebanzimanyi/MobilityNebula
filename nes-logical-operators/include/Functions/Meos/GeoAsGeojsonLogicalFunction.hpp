...
/**
 * @brief Geometry as GeoJSON
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_as_geojson(temp, (int)arg0, (int)arg1, nullptr)`. Per-event scalar operator following the
...
public:
    ...
    GeoAsGeojsonLogicalFunction(LogicalFunction wkt,
