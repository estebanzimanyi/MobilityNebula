...
/**
 * @brief Serializes a geometry to a GeoJSON string with given option and precision.
 */
class GeoAsGeojsonLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoAsGeojson";

    GeoAsGeojsonLogicalFunction(LogicalFunction wkt, LogicalFunction option, LogicalFunction precision);
