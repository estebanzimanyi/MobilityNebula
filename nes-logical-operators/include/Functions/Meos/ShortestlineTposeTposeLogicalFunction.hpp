...
/**
 * @brief shortestline_tpose_tpose (GSERIALIZED *) — two tpose instants nearest-approach.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tpose_tpose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTposeTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTposeTpose";

    ShortestlineTposeTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
