...
/**
 * @brief datespanset_num_dates (int) — unary datespanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `datespanset_num_dates`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatespansetNumDatesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatespansetNumDates";

    DatespansetNumDatesLogicalFunction(LogicalFunction lit);
