...
/**
 * @brief bearing_point_point (out-param double) — geometry azimuth/bearing.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bearing_point_point`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BearingPointPointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BearingPointPoint";

    BearingPointPointLogicalFunction(LogicalFunction lit,
