...
/**
 * @brief cbufferset_start_value (Cbuffer *) — unary cbufferset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbufferset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbuffersetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbuffersetStartValue";

    CbuffersetStartValueLogicalFunction(LogicalFunction lit);
