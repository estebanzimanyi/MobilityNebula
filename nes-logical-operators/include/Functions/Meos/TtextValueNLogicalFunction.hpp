...
/**
 * @brief ttext_value_n (out-param text, n=1) — ttext value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextValueN";

    TtextValueNLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
