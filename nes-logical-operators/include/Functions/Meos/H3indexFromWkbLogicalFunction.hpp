...
/**
 * @brief Parses an H3Index from raw WKB bytes (VARSIZED) to a cell identifier (UINT64).
 */
class H3indexFromWkbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexFromWkb";

    H3indexFromWkbLogicalFunction(LogicalFunction wkb);
