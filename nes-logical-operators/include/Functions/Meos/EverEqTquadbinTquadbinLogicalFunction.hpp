...
/**
 * @brief Returns 1 if two tquadbin instants ever have equal cells.
 */
class EverEqTquadbinTquadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTquadbinTquadbin";
    EverEqTquadbinTquadbinLogicalFunction(LogicalFunction cell1, LogicalFunction ts1, LogicalFunction cell2, LogicalFunction ts2);
