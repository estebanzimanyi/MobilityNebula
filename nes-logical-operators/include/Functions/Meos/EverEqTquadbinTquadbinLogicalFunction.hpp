...
/**
 * @brief Per-event ever_eq_tquadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_tquadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    EverEqTquadbinTquadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
