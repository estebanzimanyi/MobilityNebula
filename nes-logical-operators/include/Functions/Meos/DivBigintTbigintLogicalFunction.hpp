...
/**
 * @brief Per-event div_bigint_tbigint: divides a constant int64 scalar by a single-instant tbigint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_bigint_tbigint`. Takes (scalar:FLOAT64→int64, value:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the division, and returns FLOAT64.
 */
class DivBigintTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DivBigintTbigint";

    DivBigintTbigintLogicalFunction(LogicalFunction scalar,
