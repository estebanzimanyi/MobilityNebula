...
/**
 * @brief Per-event div_bigint_tbigint: a scalar constant and a hex-WKB temporal number -> hex-WKB temporal (scalar-first MEOS arg order).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `div_bigint_tbigint`. Per-event scalar operator following the
...
public:
    ...
    DivBigintTbigintLogicalFunction(LogicalFunction traj,
