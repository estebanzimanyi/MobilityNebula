...
/**
 * @brief timestamptz_tprecision (TimestampTz) — arity-3 int64 op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_tprecision`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzTprecisionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzTprecision";

    TimestamptzTprecisionLogicalFunction(LogicalFunction value,
