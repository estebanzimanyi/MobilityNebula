...
/**
 * @brief ever_eq_cbuffer_tcbuffer (int) — always/ever tcbuffer ⊗ Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EverEqCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqCbufferTcbuffer";

    EverEqCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
