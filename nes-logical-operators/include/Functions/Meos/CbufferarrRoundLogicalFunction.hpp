...
/**
 * @brief cbufferarr_round — round a 1-element Cbuffer array.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbufferarr_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferarrRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferarrRound";

    CbufferarrRoundLogicalFunction(LogicalFunction lit);
