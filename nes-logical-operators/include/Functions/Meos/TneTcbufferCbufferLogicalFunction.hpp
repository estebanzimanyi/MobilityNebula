...
/**
 * @brief tne_tcbuffer_cbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tne_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TneTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TneTcbufferCbuffer";

    TneTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
