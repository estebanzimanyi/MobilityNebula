...
/**
 * @brief minus_date_date (int) - the number of days between two dates.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_date_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusDateDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusDateDate";

    MinusDateDateLogicalFunction(LogicalFunction value,
