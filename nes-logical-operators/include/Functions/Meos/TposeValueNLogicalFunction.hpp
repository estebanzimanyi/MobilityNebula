...
/**
 * @brief tpose_value_n (out-param Pose, n=1) — tpose value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeValueN";

    TposeValueNLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
