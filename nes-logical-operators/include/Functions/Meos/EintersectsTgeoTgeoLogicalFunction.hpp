...
/**
 * @brief Tests whether two temporal geometries ever intersect.
 */
class EintersectsTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EintersectsTgeoTgeo";

    EintersectsTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2);
