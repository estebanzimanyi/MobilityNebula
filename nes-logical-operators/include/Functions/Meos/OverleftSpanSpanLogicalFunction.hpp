...
/**
 * @brief overleft_span_span over two span text literals (parsed as intspan); type-generic MEOS predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_span_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftSpanSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftSpanSpan";

    OverleftSpanSpanLogicalFunction(LogicalFunction lit,
