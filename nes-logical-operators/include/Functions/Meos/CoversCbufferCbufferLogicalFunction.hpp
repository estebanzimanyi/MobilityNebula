...
/**
 * @brief covers_cbuffer_cbuffer (int) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `covers_cbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CoversCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CoversCbufferCbuffer";

    CoversCbufferCbufferLogicalFunction(LogicalFunction lit,
