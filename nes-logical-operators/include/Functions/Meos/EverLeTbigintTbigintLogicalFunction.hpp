 ...
 */
class EverLeTbigintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverLeTbigintTfloat";

    EverLeTbigintTfloatLogicalFunction(LogicalFunction value1,
