...
/**
 * @brief Always equal tjsonb vs tjsonb
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_eq_tjsonb_tjsonb`. Per-event scalar operator following the
...
public:
    ...
    AlwaysEqTjsonbTjsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
