...
/**
 * @brief Returns 1.0 if the two tjsonb instants are always equal.
 */
class AlwaysEqTjsonbTjsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysEqTjsonbTjsonb";

    AlwaysEqTjsonbTjsonbLogicalFunction(LogicalFunction json1, LogicalFunction ts1, LogicalFunction json2, LogicalFunction ts2);
