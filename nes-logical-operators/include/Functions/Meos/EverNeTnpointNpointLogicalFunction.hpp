...
/**
 * @brief ever_ne_tnpoint_npoint (int) — always/ever tnpoint ⊗ Npoint.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tnpoint_npoint`. Per-event scalar operator following the
...
public:
    ...
    EverNeTnpointNpointLogicalFunction(LogicalFunction rid,
