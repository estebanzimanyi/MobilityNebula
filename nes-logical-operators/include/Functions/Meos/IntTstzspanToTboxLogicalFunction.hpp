...
/**
 * @brief int_tstzspan_to_tbox (TBox *) — int + Span -> TBox constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `int_tstzspan_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntTstzspanToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntTstzspanToTbox";

    IntTstzspanToTboxLogicalFunction(LogicalFunction value,
