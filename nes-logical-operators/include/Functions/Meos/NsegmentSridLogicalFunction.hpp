...
/**
 * @brief nsegment_srid (int32_t) — unary nsegment accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nsegment_srid`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NsegmentSridLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NsegmentSrid";

    NsegmentSridLogicalFunction(LogicalFunction lit);
