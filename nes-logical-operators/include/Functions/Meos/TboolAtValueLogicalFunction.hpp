...
/**
 * @brief tbool_at_value (Temporal *) — temporal tbool ⊗ bool -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_at_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolAtValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolAtValue";

    TboolAtValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
