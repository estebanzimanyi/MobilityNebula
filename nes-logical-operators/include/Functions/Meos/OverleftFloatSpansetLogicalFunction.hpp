...
/**
 * @brief overleft_float_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_float_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftFloatSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftFloatSpanset";

    OverleftFloatSpansetLogicalFunction(LogicalFunction lit,
