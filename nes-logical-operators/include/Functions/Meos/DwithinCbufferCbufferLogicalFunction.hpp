...
/**
 * @brief dwithin_cbuffer_cbuffer (int) - whether two circular buffers are within a distance.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `dwithin_cbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DwithinCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DwithinCbufferCbuffer";

    DwithinCbufferCbufferLogicalFunction(LogicalFunction lit,
