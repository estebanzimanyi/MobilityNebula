...
/**
 * @brief timestamptz_to_tbox (TBox *) — TimestampTz -> TBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzToTbox";

    TimestamptzToTboxLogicalFunction(LogicalFunction value);
