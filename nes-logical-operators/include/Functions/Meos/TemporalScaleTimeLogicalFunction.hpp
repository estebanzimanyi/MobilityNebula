...
/**
 * @brief temporal_scale_time (Temporal *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_scale_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalScaleTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalScaleTime";

    TemporalScaleTimeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
