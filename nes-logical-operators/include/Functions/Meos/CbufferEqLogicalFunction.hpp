...
/**
 * @brief cbuffer_eq (bool) — Cbuffer scalar comparison/relation.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_eq`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferEq";

    CbufferEqLogicalFunction(LogicalFunction lit,
