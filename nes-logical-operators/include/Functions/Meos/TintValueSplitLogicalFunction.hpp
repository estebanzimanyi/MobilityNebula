...
/**
 * @brief tint_value_split (Temporal **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_value_split`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValueSplitLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValueSplit";

    TintValueSplitLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
