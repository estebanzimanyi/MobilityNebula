...
/**
 * @brief ecovers_cbuffer_tcbuffer (int) — temporal tcbuffer ⊗ Cbuffer -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ecovers_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EcoversCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EcoversCbufferTcbuffer";

    EcoversCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
