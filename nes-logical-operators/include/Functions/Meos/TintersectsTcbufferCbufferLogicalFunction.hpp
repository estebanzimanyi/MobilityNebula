...
/**
 * @brief tintersects_tcbuffer_cbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tintersects_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintersectsTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintersectsTcbufferCbuffer";

    TintersectsTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
