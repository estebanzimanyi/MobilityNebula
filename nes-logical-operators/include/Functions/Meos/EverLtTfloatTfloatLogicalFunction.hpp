...
/**
 * @brief Per-event ever_lt_tfloat_tfloat: tests if a single-instant tfloat value is ever < another.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_lt_tfloat_tfloat`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two single-instant temporals, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class EverLtTfloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverLtTfloatTfloat";

    EverLtTfloatTfloatLogicalFunction(LogicalFunction value1,
