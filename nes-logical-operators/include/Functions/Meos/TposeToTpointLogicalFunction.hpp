...
/**
 * @brief tpose_to_tgeompoint (Temporal *) — unary tpose accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_to_tgeompoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeToTpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeToTpoint";

    TposeToTpointLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
