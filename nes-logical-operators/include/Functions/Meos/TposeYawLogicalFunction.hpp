...
/**
 * @brief Per-event tpose_yaw: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_yaw`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeYawLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeYaw";

    TposeYawLogicalFunction(LogicalFunction traj);
