...
/**
 * @brief textset_start_value (text *) — unary textset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textset_start_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TextsetStartValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextsetStartValue";

    TextsetStartValueLogicalFunction(LogicalFunction lit);
