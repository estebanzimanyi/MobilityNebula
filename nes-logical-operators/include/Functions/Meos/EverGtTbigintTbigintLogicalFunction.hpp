...
/**
 * @brief Per-event ever_gt_tbigint_tfloat: tests if two single-instant tbigint values are ever greater than.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_gt_tbigint_tfloat`. Takes (value1:FLOAT64, value2:FLOAT64, ts:UINT64),
 * constructs two single-instant temporals, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class EverGtTbigintTbigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGtTbigintTbigint";

    EverGtTbigintTbigintLogicalFunction(LogicalFunction value1,
