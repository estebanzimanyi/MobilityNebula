 ...
 */
class EverGtTbigintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGtTbigintTfloat";

    EverGtTbigintTfloatLogicalFunction(LogicalFunction value1,
