 ...
 */
class EdwithinTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EdwithinTcbufferCbuffer";

    EdwithinTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
