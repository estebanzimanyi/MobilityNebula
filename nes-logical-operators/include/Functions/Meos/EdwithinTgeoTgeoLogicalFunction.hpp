...
/**
 * @brief Tests whether two temporal geometries are ever within a distance.
 */
class EdwithinTgeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EdwithinTgeoTgeo";

    EdwithinTgeoTgeoLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction ts1, LogicalFunction lon2, LogicalFunction lat2, LogicalFunction ts2, LogicalFunction dist);
