...
/**
 * @brief Per-event nad_tnpoint_stbox: single-instant tnpoint against a stbox literal -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tnpoint_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTnpointStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTnpointStbox";

    NadTnpointStboxLogicalFunction(LogicalFunction rid,
