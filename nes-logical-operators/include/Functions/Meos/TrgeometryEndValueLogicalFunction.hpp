...
/**
 * @brief trgeometry_end_value (GSERIALIZED *) — unary trgeometry accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_end_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryEndValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryEndValue";

    TrgeometryEndValueLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
