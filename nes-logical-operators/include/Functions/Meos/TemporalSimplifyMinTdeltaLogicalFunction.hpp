...
/**
 * @brief temporal_simplify_min_tdelta (Temporal *) — temporal time op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_simplify_min_tdelta`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSimplifyMinTdeltaLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSimplifyMinTdelta";

    TemporalSimplifyMinTdeltaLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
