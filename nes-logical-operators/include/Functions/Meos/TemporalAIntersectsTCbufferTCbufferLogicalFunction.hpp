...
/**
 * @brief Per-event always-intersects between two single-instant tcbuffers.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `aintersects_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAIntersectsTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAIntersectsTCbufferTCbuffer";

    TemporalAIntersectsTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
