...
/**
 * @brief Per-event front_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `front_tspatial_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FrontTspatialTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FrontTspatialTspatial";

    FrontTspatialTspatialLogicalFunction(LogicalFunction lonA,
