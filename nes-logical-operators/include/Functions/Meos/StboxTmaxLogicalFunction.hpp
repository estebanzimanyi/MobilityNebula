...
/**
 * @brief stbox_tmax (out-param TimestampTz) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_tmax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxTmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxTmax";

    StboxTmaxLogicalFunction(LogicalFunction box);
