...
/**
 * @brief floatspanset_to_intspanset (SpanSet *) — SpanSet -> SpanSet conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_to_intspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetToIntspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetToIntspanset";

    FloatspansetToIntspansetLogicalFunction(LogicalFunction lit);
