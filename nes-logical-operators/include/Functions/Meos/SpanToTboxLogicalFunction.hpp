...
/**
 * @brief span_to_tbox (TBox *) — Span -> TBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanToTbox";

    SpanToTboxLogicalFunction(LogicalFunction lit);
