...
/**
 * @brief Returns the lower bound of an integer span.
 */
class IntspanLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntspanLower";
    IntspanLowerLogicalFunction(LogicalFunction sp);
