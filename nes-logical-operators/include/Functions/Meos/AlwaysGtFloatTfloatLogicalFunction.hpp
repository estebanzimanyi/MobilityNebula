...
/**
 * @brief Per-event always_gt_float_tfloat: tests if a scalar is ever gt to a single-instant tfloat value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_gt_float_tfloat`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class AlwaysGtFloatTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysGtFloatTfloat";

    AlwaysGtFloatTfloatLogicalFunction(LogicalFunction value,
