...
/**
 * @brief set_gt (bool) — Set/Set operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_gt`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetGtLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetGt";

    SetGtLogicalFunction(LogicalFunction lit,
