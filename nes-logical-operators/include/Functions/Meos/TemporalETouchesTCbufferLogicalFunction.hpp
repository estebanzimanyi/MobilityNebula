...
/**
 * @brief Per-event ever-touches between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `etouches_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalETouchesTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalETouchesTCbuffer";

    TemporalETouchesTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
