...
/**
 * @brief Per-event always-dwithin between two tgeompoints resolved from tnpoints via tnpoint_to_tgeompoint, within a distance.
 *
 ...
 */
class TemporalADWithinTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinTNpointTNpoint";

    TemporalADWithinTNpointTNpointLogicalFunction(LogicalFunction ridA,
