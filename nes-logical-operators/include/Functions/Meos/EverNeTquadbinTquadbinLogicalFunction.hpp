...
/**
 * @brief Per-event ever_ne_tquadbin_tquadbin.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_tquadbin_tquadbin`. Per-event scalar operator following the
...
public:
    ...
    EverNeTquadbinTquadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
