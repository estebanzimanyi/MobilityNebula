...
/**
 * @brief Returns 1 if two tquadbin instants ever have different cells.
 */
class EverNeTquadbinTquadbinLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverNeTquadbinTquadbin";
    EverNeTquadbinTquadbinLogicalFunction(LogicalFunction cell1, LogicalFunction ts1, LogicalFunction cell2, LogicalFunction ts2);
