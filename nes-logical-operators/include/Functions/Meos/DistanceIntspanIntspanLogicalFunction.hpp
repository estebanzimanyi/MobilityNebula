...
/**
 * @brief distance_intspan_intspan (int) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_intspan_intspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceIntspanIntspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceIntspanIntspan";

    DistanceIntspanIntspanLogicalFunction(LogicalFunction lit,
