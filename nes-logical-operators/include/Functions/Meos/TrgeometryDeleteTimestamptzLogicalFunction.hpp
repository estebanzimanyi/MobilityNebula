...
/**
 * @brief trgeometry_delete_timestamptz (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_delete_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryDeleteTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryDeleteTimestamptz";

    TrgeometryDeleteTimestamptzLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
