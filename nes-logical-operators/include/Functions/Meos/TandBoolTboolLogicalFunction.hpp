...
/**
 * @brief Per-event tand_bool_tbool: temporal AND of scalar bool and tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tand_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    TandBoolTboolLogicalFunction(LogicalFunction arg0,
