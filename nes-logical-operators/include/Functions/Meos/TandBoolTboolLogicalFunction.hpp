...
/**
 * @brief Per-event tand_bool_tbool: AND of a scalar bool and a single-instant tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tand_bool_tbool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the operation, and returns FLOAT64 (0.0/1.0).
 */
class TandBoolTboolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TandBoolTbool";

    TandBoolTboolLogicalFunction(LogicalFunction value,
