...
/**
 * @brief Static geometry predicate geom_contains: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_contains`. Operates on plain WKT strings without a temporal dimension.
 */
class GeomContainsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomContains";

    GeomContainsLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
