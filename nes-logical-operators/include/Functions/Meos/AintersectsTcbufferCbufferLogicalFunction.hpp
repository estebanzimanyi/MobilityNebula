...
/**
 * @brief Returns 1.0 if the tcbuffer always intersects the static cbuffer, 0.0 otherwise.
 *
 * Args: (lon1:FLOAT64, lat1:FLOAT64, r1:FLOAT64, ts:UINT64,
 *        lon2:FLOAT64, lat2:FLOAT64, r2:FLOAT64) -> FLOAT64.
 */
class AintersectsTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AintersectsTcbufferCbuffer";

    AintersectsTcbufferCbufferLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction r1,
                          LogicalFunction ts,
