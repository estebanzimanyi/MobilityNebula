...
/**
 * @brief bigint_to_set (bigint value) -> set (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigint_to_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintToSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintToSet";

    BigintToSetLogicalFunction(LogicalFunction value);
