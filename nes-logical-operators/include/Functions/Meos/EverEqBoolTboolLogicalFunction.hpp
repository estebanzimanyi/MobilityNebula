...
/**
 * @brief Per-event ever_eq_bool_tbool: ever-equal scalar bool vs tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    EverEqBoolTboolLogicalFunction(LogicalFunction arg0,
