...
/**
 * @brief Per-event tpose_speed: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_speed`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeSpeedLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeSpeed";

    TposeSpeedLogicalFunction(LogicalFunction traj);
