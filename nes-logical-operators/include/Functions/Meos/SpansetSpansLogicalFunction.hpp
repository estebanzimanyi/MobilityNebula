...
/**
 * @brief spanset_spans (Span *) - the array of spans of a span set.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetSpans";

    SpansetSpansLogicalFunction(LogicalFunction lit);
