...
/**
 * @brief tintbox_expand (TBox *) - expand a TBox by a value in the integer dimension.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tintbox_expand`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintboxExpandLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintboxExpand";

    TintboxExpandLogicalFunction(LogicalFunction lit,
