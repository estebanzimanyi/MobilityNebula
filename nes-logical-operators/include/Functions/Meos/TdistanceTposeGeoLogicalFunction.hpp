...
/**
 * @brief tdistance_tpose_geo (Temporal *) - temporal tpose (x) GSERIALIZED -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tpose_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTposeGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTposeGeo";

    TdistanceTposeGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
