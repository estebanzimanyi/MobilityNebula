...
/**
 * @brief Per-event nad_tfloat_tbox: single-instant tfloat against a tbox literal -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tfloat_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NadTfloatTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTfloatTbox";

    NadTfloatTboxLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
