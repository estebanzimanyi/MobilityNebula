...
/**
 * @brief overafter_timestamptz_set (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_timestamptz_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterTimestamptzSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterTimestamptzSet";

    OverafterTimestamptzSetLogicalFunction(LogicalFunction lit,
