...
/**
 * @brief Per-event contains_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_tspatial_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsTspatialTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsTspatialTspatial";

    ContainsTspatialTspatialLogicalFunction(LogicalFunction lonA,
