...
/**
 * @brief Per-event tfloat_scale_value: scales the value of a single-instant tfloat by a width.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_scale_value`. Takes (value:FLOAT64, ts:UINT64, width:FLOAT64),
 * constructs a single-instant temporal, applies the scale, and returns FLOAT64.
 */
class TfloatScaleValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatScaleValue";

    TfloatScaleValueLogicalFunction(LogicalFunction value,
                                    LogicalFunction ts,
