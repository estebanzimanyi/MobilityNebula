...
/**
 * @brief Returns the collection-typed 2D intersection of two geometries as WKT.
 */
class GeomIntersection2dCollLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomIntersection2dColl";

    GeomIntersection2dCollLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
