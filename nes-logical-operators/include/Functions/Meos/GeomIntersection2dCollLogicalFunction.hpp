...
/**
 * @brief geom_intersection2d_coll (GSERIALIZED *) — geometry binary op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_intersection2d_coll`. Per-event scalar operator following the
...
public:
    ...
    GeomIntersection2dCollLogicalFunction(LogicalFunction lit,
