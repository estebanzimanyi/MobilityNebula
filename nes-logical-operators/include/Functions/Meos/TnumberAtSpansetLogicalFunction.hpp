...
/**
 * @brief tnumber_at_spanset (Temporal *) — tint restricted by a spanset box -> tint_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnumber_at_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnumberAtSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnumberAtSpanset";

    TnumberAtSpansetLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
