...
/**
 * @brief temporal_after_timestamptz (Temporal *) — tfloat restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_after_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAfterTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAfterTimestamptz";

    TemporalAfterTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
