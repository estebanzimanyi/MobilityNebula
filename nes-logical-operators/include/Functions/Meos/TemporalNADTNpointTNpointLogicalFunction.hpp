...
/**
 * @brief Per-event nearest-approach distance between two single-instant tgeompoints, each resolved from a tnpoint via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalNADTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADTNpointTNpoint";

    TemporalNADTNpointTNpointLogicalFunction(LogicalFunction ridA,
