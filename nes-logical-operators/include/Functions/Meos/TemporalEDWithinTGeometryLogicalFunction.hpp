...
/**
 * @brief Per-event ever-distance-within between two single-instant tgeompoints under a static threshold.
 *
 ...
 */
class TemporalEDWithinTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDWithinTGeometry";

    TemporalEDWithinTGeometryLogicalFunction(LogicalFunction lonA,
