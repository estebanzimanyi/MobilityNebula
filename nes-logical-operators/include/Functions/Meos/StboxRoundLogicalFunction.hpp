...
/**
 * @brief stbox_round (STBox *) — round stbox_text to 2 decimals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_round`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxRound";

    StboxRoundLogicalFunction(LogicalFunction box);
