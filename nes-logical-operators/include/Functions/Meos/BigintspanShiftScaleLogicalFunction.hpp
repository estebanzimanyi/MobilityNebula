...
/**
 * @brief bigintspan_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled bigintspan.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspan_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspanShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspanShiftScale";

    BigintspanShiftScaleLogicalFunction(LogicalFunction lit,
