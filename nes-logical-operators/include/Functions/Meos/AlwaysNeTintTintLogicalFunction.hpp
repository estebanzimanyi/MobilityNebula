 ...
 */
class AlwaysNeTintTintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTintTint";

    AlwaysNeTintTintLogicalFunction(LogicalFunction value1,
