...
/**
 * @brief Returns the number of points in a geometry.
 *
 * Args: (wkt:VARCHAR) -> FLOAT64.
 */
class GeoNumPointsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoNumPoints";

    explicit GeoNumPointsLogicalFunction(LogicalFunction wkt);
