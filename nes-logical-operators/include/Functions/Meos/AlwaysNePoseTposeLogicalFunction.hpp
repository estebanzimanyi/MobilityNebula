...
/**
 * @brief Returns 1.0 if the static pose is always not equal to the 2D tpose instant, 0.0 otherwise.
 */
class AlwaysNePoseTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNePoseTpose";

    AlwaysNePoseTposeLogicalFunction(LogicalFunction x2, LogicalFunction y2, LogicalFunction theta2, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts);
