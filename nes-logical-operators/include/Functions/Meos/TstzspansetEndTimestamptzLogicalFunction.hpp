...
/**
 * @brief tstzspanset_end_timestamptz (TimestampTz) — unary tstzspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspanset_end_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspansetEndTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspansetEndTimestamptz";

    TstzspansetEndTimestamptzLogicalFunction(LogicalFunction lit);
