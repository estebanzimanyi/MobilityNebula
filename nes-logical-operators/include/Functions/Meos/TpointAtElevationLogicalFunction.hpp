...
/**
 * @brief tpoint_at_elevation (Temporal *) - the temporal point restricted to an elevation span.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_at_elevation`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointAtElevationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointAtElevation";

    TpointAtElevationLogicalFunction(LogicalFunction traj,
