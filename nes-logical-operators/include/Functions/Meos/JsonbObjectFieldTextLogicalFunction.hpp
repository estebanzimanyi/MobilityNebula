...
/**
 * @brief Returns the value of a JSONB object field as plain text.
 */
class JsonbObjectFieldTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbObjectFieldText";
    JsonbObjectFieldTextLogicalFunction(LogicalFunction jb, LogicalFunction key);
