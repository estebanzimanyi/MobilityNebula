...
/**
 * @brief Jsonb object field text
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `jsonb_object_field_text(temp, txt0)`. Per-event scalar operator following the
...
public:
    ...
    JsonbObjectFieldTextLogicalFunction(LogicalFunction jb,
