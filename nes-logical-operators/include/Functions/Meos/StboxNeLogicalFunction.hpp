...
/**
 * @brief Per-event stbox_ne: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_ne`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxNe";

    StboxNeLogicalFunction(LogicalFunction box,
