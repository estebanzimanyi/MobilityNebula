...
/**
 * @brief tdistance_tnpoint_geo (Temporal *) - temporal tnpoint (x) GSERIALIZED -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tnpoint_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTnpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTnpointGeo";

    TdistanceTnpointGeoLogicalFunction(LogicalFunction rid,
