...
/**
 * @brief textcat_ttext_text (Temporal *) — temporal ttext ⊗ text -> ttext_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_ttext_text`. Per-event scalar operator following the
...
public:
    ...
    TextcatTtextTextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
