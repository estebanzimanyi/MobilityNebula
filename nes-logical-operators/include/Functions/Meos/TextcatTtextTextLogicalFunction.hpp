...
/**
 * @brief Per-event textcat_ttext_text: (value:VARCHAR, ts:UINT64, ref:VARCHAR) -> varchar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_ttext_text`. Per-event scalar operator returning VARCHAR.
 */
class TextcatTtextTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextcatTtextText";

    TextcatTtextTextLogicalFunction(LogicalFunction value, LogicalFunction ts, LogicalFunction ref);
