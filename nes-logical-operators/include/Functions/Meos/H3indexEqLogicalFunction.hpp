...
/**
 * @brief Tests equality of two H3 cell indices.
 */
class H3indexEqLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexEq";

    H3indexEqLogicalFunction(LogicalFunction a, LogicalFunction b);
