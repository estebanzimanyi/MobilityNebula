...
/**
 * @brief Per-event overright_tbox_tnumber: single-instant tfloat against a TBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overright_tbox_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverrightTboxTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverrightTboxTnumber";

    OverrightTboxTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
