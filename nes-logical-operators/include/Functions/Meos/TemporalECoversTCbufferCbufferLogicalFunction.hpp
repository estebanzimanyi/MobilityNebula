...
/**
 * @brief Per-event e-covers between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ecovers_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalECoversTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversTCbufferCbuffer";

    TemporalECoversTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
