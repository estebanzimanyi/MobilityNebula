...
/**
 * @brief Tests if H3 cell index a is less than or equal to b.
 */
class H3indexLeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "H3indexLe";

    H3indexLeLogicalFunction(LogicalFunction a, LogicalFunction b);
