...
/**
 * @brief tpose_values (Pose **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeValues";

    TposeValuesLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
