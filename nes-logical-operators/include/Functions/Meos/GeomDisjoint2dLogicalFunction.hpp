...
/**
 * @brief Static geometry predicate geom_disjoint2d: (wkt1:VARCHAR, wkt2:VARCHAR) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_disjoint2d`. Operates on plain WKT strings without a temporal dimension.
 */
class GeomDisjoint2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomDisjoint2d";

    GeomDisjoint2dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2);
