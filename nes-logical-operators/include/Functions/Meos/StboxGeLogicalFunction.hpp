...
/**
 * @brief Per-event stbox_ge: two per-vehicle extent STBoxes -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_ge`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxGeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxGe";

    StboxGeLogicalFunction(LogicalFunction box,
