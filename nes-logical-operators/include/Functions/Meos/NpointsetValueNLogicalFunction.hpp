...
/**
 * @brief npointset_value_n (out-param Npoint, n=1) — npointset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `npointset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NpointsetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NpointsetValueN";

    NpointsetValueNLogicalFunction(LogicalFunction lit);
