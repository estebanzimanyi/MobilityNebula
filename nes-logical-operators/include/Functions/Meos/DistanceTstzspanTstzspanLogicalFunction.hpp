...
/**
 * @brief distance_tstzspan_tstzspan (double) — Span/Span operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `distance_tstzspan_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DistanceTstzspanTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DistanceTstzspanTstzspan";

    DistanceTstzspanTstzspanLogicalFunction(LogicalFunction lit,
