...
/**
 * @brief cbuffer_transform (Cbuffer *) — SRID set/transform to 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `cbuffer_transform`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class CbufferTransformLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "CbufferTransform";

    CbufferTransformLogicalFunction(LogicalFunction lit);
