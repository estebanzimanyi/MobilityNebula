...
/**
 * @brief union_spanset_date: extern SpanSet *union_spanset_date(const SpanSet *ss, DateADT d);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_spanset_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSpansetDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSpansetDate";

    UnionSpansetDateLogicalFunction(LogicalFunction lit,
