...
/**
 * @brief Jsonb array element text
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `jsonb_array_element_text(temp, (int)idx_d)`. Per-event scalar operator following the
...
public:
    ...
    JsonbArrayElementTextLogicalFunction(LogicalFunction jb,
