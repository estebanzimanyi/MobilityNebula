...
/**
 * @brief Returns the n-th element of a JSONB array as plain text.
 */
class JsonbArrayElementTextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbArrayElementText";
    JsonbArrayElementTextLogicalFunction(LogicalFunction jb, LogicalFunction idx);
