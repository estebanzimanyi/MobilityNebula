...
/**
 * @brief contained_text_set (bool) — object-set ± text value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_text_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTextSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTextSet";

    ContainedTextSetLogicalFunction(LogicalFunction lit,
