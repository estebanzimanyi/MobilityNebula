...
/**
 * @brief Geographic length (spheroid=true) of the geometry: (wkt:VARCHAR) -> float64.
 */
class GeogLengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeogLength";

    explicit GeogLengthLogicalFunction(LogicalFunction wkt1);
