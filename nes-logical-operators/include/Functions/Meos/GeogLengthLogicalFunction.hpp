...
/**
 * @brief geog_length (double) — geodetic measure (use_spheroid=true).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geog_length`. Per-event scalar operator following the
...
public:
    ...
    GeogLengthLogicalFunction(LogicalFunction lit);
