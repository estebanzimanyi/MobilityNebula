...
/**
 * @brief temporal_timestamps (TimestampTz *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_timestamps`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalTimestampsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalTimestamps";

    TemporalTimestampsLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
