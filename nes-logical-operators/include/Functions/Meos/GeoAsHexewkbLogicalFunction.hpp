...
/**
 * @brief Serializes a geometry to hex EWKB with the given endian ('NDR' or 'XDR').
 */
class GeoAsHexewkbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoAsHexewkb";

    GeoAsHexewkbLogicalFunction(LogicalFunction wkt, LogicalFunction endian);
