...
/**
 * @brief tgeompoint_to_tgeometry (Temporal *) — temporal conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeompoint_to_tgeometry`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeompointToTgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeompointToTgeometry";

    TgeompointToTgeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
