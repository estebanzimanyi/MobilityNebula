...
/**
 * @brief textcat_ttext_ttext (Temporal *) — two ttext instants -> ttext_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_ttext_ttext`. Per-event scalar operator following the
...
public:
    ...
    TextcatTtextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
