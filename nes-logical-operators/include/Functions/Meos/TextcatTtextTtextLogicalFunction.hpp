...
/**
 * @brief Per-event textcat_ttext_ttext: (value1:VARCHAR, ts1:UINT64, value2:VARCHAR, ts2:UINT64) -> varchar.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `textcat_ttext_ttext`. Per-event scalar operator returning VARCHAR.
 */
class TextcatTtextTtextLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextcatTtextTtext";

    TextcatTtextTtextLogicalFunction(LogicalFunction value1, LogicalFunction ts1, LogicalFunction value2, LogicalFunction ts2);
