...
/**
 * @brief Per-event spatial restriction: 1 if the single-instant tgeompoint survives clipping by the static geometry, 0 if clipped.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_at_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalAtGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAtGeometry";

    TemporalAtGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
