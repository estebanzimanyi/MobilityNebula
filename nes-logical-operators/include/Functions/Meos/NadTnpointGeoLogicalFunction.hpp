...
/**
 * @brief Returns the nearest approach distance between a tnpoint instant and a static geometry.
 */
class NadTnpointGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTnpointGeo";

    NadTnpointGeoLogicalFunction(LogicalFunction rid, LogicalFunction pos, LogicalFunction ts, LogicalFunction wkt);
