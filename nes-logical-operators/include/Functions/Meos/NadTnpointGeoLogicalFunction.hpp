...
/**
 * @brief Per-event nad_tnpoint_geo: single-instant tnpoint against a static geometry -> double.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nad_tnpoint_geo`. Per-event scalar operator following the
...
public:
    ...
    NadTnpointGeoLogicalFunction(LogicalFunction rid,
