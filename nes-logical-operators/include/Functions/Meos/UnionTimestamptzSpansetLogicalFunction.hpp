...
/**
 * @brief union_timestamptz_spanset: extern SpanSet *union_timestamptz_spanset(TimestampTz t, SpanSet *ss);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_timestamptz_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionTimestamptzSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionTimestamptzSpanset";

    UnionTimestamptzSpansetLogicalFunction(LogicalFunction lit,
