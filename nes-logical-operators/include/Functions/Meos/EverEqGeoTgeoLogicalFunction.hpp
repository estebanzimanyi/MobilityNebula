...
/**
 * @brief ever_eq_geo_tgeo (int) — temporal tgeo ⊗ GSERIALIZED -> int.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_geo_tgeo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class EverEqGeoTgeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqGeoTgeo";

    EverEqGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
