...
/**
 * @brief Per-event ever-disjoint between two single-instant tgeompoints.
 *
 ...
 */
class TemporalEDisjointTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEDisjointTGeometry";

    TemporalEDisjointTGeometryLogicalFunction(LogicalFunction lonA,
