...
/**
 * @brief overlaps_numspan_tnumber (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overlaps_numspan_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverlapsNumspanTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverlapsNumspanTnumber";

    OverlapsNumspanTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
