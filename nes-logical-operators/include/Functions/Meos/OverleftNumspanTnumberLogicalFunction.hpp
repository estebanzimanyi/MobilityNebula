...
/**
 * @brief overleft_numspan_tnumber (bool) — temporal ⊗ numspan bbox predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overleft_numspan_tnumber`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverleftNumspanTnumberLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverleftNumspanTnumber";

    OverleftNumspanTnumberLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
