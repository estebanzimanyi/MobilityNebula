...
/**
 * @brief stbox_tmin (out-param TimestampTz) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_tmin`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxTminLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxTmin";

    StboxTminLogicalFunction(LogicalFunction box);
