...
/**
 * @brief floatspan_bins (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_bins`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanBinsLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanBins";

    FloatspanBinsLogicalFunction(LogicalFunction lit,
