...
/**
 * @brief float_degrees (double) — scalar float math.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_degrees`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatDegreesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatDegrees";

    FloatDegreesLogicalFunction(LogicalFunction value,
