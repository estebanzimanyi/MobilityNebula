...
/**
 * @brief float_ln (double) — scalar float math.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_ln`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatLnLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatLn";

    FloatLnLogicalFunction(LogicalFunction value);
