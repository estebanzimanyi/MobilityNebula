...
/**
 * @brief tgeo_split_n_stboxes (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_split_n_stboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoSplitNStboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoSplitNStboxes";

    TgeoSplitNStboxesLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
