...
/**
 * @brief float_log10 (double) — scalar float math.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `float_log10`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatLog10LogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatLog10";

    FloatLog10LogicalFunction(LogicalFunction value);
