...
/**
 * @brief pose_orientation (double *) - the orientation quaternion of a 3D pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `pose_orientation`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class PoseOrientationLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "PoseOrientation";

    PoseOrientationLogicalFunction(LogicalFunction lit);
