...
/**
 * @brief span_tbox_type (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `span_tbox_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpanTboxTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpanTboxType";

    SpanTboxTypeLogicalFunction(LogicalFunction lit);
