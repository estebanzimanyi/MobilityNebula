...
/**
 * @brief Returns 1 if the two trgeometry instants adisjoint.
 */
class AdisjointTrgeometryTrgeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdisjointTrgeometryTrgeometry";
    AdisjointTrgeometryTrgeometryLogicalFunction(LogicalFunction ref1_wkt, LogicalFunction x1, LogicalFunction y1, LogicalFunction theta1, LogicalFunction ts1, LogicalFunction ref2_wkt, LogicalFunction x2, LogicalFunction y2, LogicalFunction theta2, LogicalFunction ts2);
