...
/**
 * @brief spanset_copy (SpanSet *) — unary floatspanset -> SpanSet.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_copy`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetCopyLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetCopy";

    SpansetCopyLogicalFunction(LogicalFunction lit);
