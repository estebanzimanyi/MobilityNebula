...
/**
 * @brief bigintspan_expand (Span *) — span widened by a scalar delta.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspan_expand`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspanExpandLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspanExpand";

    BigintspanExpandLogicalFunction(LogicalFunction lit,
