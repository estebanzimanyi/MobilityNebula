...
/**
 * @brief Per-event e-contains between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `econtains_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEContainsTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEContainsTCbufferCbuffer";

    TemporalEContainsTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
