...
/**
 * @brief Per-event contained_temporal_temporal between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_temporal_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainedTemporalTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedTemporalTemporal";

    ContainedTemporalTemporalLogicalFunction(LogicalFunction lonA,
