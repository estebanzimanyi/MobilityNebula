...
/**
 * @brief Returns 1.0 if temporal geometry always touches the static geometry.
 *
 * Args: (lon:FLOAT64, lat:FLOAT64, ts:UINT64, wkt:VARCHAR) -> FLOAT64.
 */
class AtouchesTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AtouchesTgeoGeo";

    AtouchesTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
