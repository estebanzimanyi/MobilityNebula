...
/**
 * @brief tstzset_to_dateset (Set *) — set transform/conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_to_dateset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetToDatesetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetToDateset";

    TstzsetToDatesetLogicalFunction(LogicalFunction lit);
