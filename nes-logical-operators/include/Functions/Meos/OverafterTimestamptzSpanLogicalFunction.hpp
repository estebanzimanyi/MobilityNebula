...
/**
 * @brief overafter_timestamptz_span (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overafter_timestamptz_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverafterTimestamptzSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverafterTimestamptzSpan";

    OverafterTimestamptzSpanLogicalFunction(LogicalFunction lit,
