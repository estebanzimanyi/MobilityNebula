...
/**
 * @brief Per-event e-intersects between a single-instant tcbuffer and a static Cbuffer literal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `eintersects_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEIntersectsTCbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEIntersectsTCbufferCbuffer";

    TemporalEIntersectsTCbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
