...
/**
 * @brief tfloat_minus_value (Temporal *) — temporal tfloat ⊗ scalar -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_minus_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatMinusValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatMinusValue";

    TfloatMinusValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
