 ...
 */
class EverGeTbigintTfloatLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGeTbigintTfloat";

    EverGeTbigintTfloatLogicalFunction(LogicalFunction value1,
