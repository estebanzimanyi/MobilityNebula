...
/**
 * @brief spanset_num_spans (int) — unary intspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_num_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetNumSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetNumSpans";

    SpansetNumSpansLogicalFunction(LogicalFunction lit);
