...
/**
 * @brief temporal_to_tstzspan (Span *) — Temporal -> Span conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_to_tstzspan`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalToTstzspanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalToTstzspan";

    TemporalToTstzspanLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
