...
/**
 * @brief Per-event trgeometry_cumulative_length: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_cumulative_length`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryCumulativeLengthLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryCumulativeLength";

    TrgeometryCumulativeLengthLogicalFunction(LogicalFunction traj);
