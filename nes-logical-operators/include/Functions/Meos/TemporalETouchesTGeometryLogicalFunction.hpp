...
/**
 * @brief Per-event ever-touches between two single-instant tgeompoints.
 *
 ...
 */
class TemporalETouchesTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalETouchesTGeometry";

    TemporalETouchesTGeometryLogicalFunction(LogicalFunction lonA,
