...
/**
 * @brief nai_tgeo_geo (TInstant *) — tgeo nearest-approach ⊗ GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `nai_tgeo_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NaiTgeoGeoLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NaiTgeoGeo";

    NaiTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
