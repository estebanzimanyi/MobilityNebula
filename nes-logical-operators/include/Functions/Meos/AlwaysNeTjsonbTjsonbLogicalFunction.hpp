...
/**
 * @brief Always neual tjsonb vs tjsonb
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_tjsonb_tjsonb`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeTjsonbTjsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
