...
/**
 * @brief Returns 1.0 if the two tjsonb instants are always not equal.
 */
class AlwaysNeTjsonbTjsonbLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AlwaysNeTjsonbTjsonb";

    AlwaysNeTjsonbTjsonbLogicalFunction(LogicalFunction json1, LogicalFunction ts1, LogicalFunction json2, LogicalFunction ts2);
