...
/**
 * @brief Converts a text string to lower case.
 */
class TextLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TextLower";
    TextLowerLogicalFunction(LogicalFunction str);
