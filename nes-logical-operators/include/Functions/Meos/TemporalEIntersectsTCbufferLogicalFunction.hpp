...
/**
 * @brief Per-event ever-intersects between a single-instant tcbuffer and a static geometry.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `eintersects_tcbuffer_geo`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalEIntersectsTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalEIntersectsTCbuffer";

    TemporalEIntersectsTCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
