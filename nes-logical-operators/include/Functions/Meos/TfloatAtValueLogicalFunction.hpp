...
/**
 * @brief tfloat_at_value (Temporal *) — temporal tfloat ⊗ double -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tfloat_at_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TfloatAtValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TfloatAtValue";

    TfloatAtValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
