...
/**
 * @brief dateset_value_n (out-param DateADT, n=1) — dateset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `dateset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DatesetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DatesetValueN";

    DatesetValueNLogicalFunction(LogicalFunction lit);
