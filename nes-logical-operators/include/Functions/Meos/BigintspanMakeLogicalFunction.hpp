...
/**
 * @brief bigintspan_make (Span *) — span constructor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigintspan_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintspanMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintspanMake";

    BigintspanMakeLogicalFunction(LogicalFunction value,
