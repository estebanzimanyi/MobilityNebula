...
/**
 * @brief minus_set_set over two text literals; type-generic MEOS set-algebra, VARSIZED (intset_text).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetSet";

    MinusSetSetLogicalFunction(LogicalFunction lit,
