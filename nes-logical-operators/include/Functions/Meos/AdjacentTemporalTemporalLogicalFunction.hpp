...
/**
 * @brief Per-event adjacent_temporal_temporal between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adjacent_temporal_temporal`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class AdjacentTemporalTemporalLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AdjacentTemporalTemporal";

    AdjacentTemporalTemporalLogicalFunction(LogicalFunction lonA,
