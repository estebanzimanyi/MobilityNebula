...
/**
 * @brief geo_split_each_n_stboxes (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_split_each_n_stboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoSplitEachNStboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoSplitEachNStboxes";

    GeoSplitEachNStboxesLogicalFunction(LogicalFunction lit,
