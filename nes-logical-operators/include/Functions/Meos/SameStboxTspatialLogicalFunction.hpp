...
/**
 * @brief Per-event same_stbox_tspatial: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `same_stbox_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SameStboxTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SameStboxTspatial";

    SameStboxTspatialLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
