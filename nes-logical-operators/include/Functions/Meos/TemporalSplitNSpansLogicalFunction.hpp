...
/**
 * @brief temporal_split_n_spans (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_split_n_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSplitNSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSplitNSpans";

    TemporalSplitNSpansLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
