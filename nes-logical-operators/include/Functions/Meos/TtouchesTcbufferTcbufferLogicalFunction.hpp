...
/**
 * @brief ttouches_tcbuffer_tcbuffer (Temporal *) — two tcbuffer instants -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttouches_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtouchesTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtouchesTcbufferTcbuffer";

    TtouchesTcbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
