...
/**
 * @brief Returns a FLOAT64 scalar for a quadbin cell. NES token: QUADBIN_CELL_AREA.
 */
class QuadbinCellAreaLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinCellArea";

    QuadbinCellAreaLogicalFunction(LogicalFunction cell);
