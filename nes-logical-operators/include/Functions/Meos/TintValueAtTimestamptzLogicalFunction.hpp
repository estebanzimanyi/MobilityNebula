...
/**
 * @brief tint_value_at_timestamptz (out-param int) — tint value at a timestamp.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_value_at_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValueAtTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValueAtTimestamptz";

    TintValueAtTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
