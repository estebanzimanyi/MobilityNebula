...
/**
 * @brief contains_set_npoint (bool) — object-set ± npoint value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_set_npoint`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsSetNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSetNpoint";

    ContainsSetNpointLogicalFunction(LogicalFunction lit,
