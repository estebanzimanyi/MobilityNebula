...
/**
 * @brief trgeometry_delete_tstzspanset (Temporal *) — temporal restricted by a time operand.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_delete_tstzspanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryDeleteTstzspansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryDeleteTstzspanset";

    TrgeometryDeleteTstzspansetLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
