...
/**
 * @brief minus_set_pose (Set *) — object-set ± pose value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `minus_set_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class MinusSetPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "MinusSetPose";

    MinusSetPoseLogicalFunction(LogicalFunction lit,
