...
/**
 * @brief Per-event overbelow_tspatial_tspatial between two single-instant tgeompoints -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `overbelow_tspatial_tspatial`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class OverbelowTspatialTspatialLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "OverbelowTspatialTspatial";

    OverbelowTspatialTspatialLogicalFunction(LogicalFunction lonA,
