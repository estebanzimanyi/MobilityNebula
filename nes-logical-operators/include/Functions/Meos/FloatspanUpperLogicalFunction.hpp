...
/**
 * @brief floatspan_upper (double) — unary floatspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_upper`. Per-event scalar operator following the
...
public:
    ...
    FloatspanUpperLogicalFunction(LogicalFunction lit);
