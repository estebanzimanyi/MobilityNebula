...
/**
 * @brief Returns the upper bound of a float span.
 */
class FloatspanUpperLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanUpper";
    FloatspanUpperLogicalFunction(LogicalFunction sp);
