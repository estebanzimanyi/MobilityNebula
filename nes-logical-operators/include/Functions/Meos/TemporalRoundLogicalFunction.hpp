...
/**
 * @brief Per-event temporal_round: rounds a single-instant tfloat to N decimal places.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_round`. Takes (value:FLOAT64, ts:UINT64, maxdd:FLOAT64→int),
 * constructs a single-instant temporal, applies the rounding, and returns FLOAT64.
 */
class TemporalRoundLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalRound";

    TemporalRoundLogicalFunction(LogicalFunction value,
                                 LogicalFunction ts,
