...
/**
 * @brief temporal_spans (Span *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_spans`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalSpansLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalSpans";

    TemporalSpansLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
