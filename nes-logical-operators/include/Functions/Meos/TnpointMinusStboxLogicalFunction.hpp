...
/**
 * @brief tnpoint_minus_stbox (Temporal *) — tnpoint restriction by STBox.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tnpoint_minus_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TnpointMinusStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TnpointMinusStbox";

    TnpointMinusStboxLogicalFunction(LogicalFunction rid,
