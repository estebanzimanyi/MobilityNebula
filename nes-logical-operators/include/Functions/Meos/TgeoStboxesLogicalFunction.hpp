...
/**
 * @brief tgeo_stboxes (STBox *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_stboxes`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoStboxesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoStboxes";

    TgeoStboxesLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
