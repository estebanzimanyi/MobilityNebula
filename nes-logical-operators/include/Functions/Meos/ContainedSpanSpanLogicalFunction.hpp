...
/**
 * @brief contained_span_span over two span text literals (parsed as intspan); type-generic MEOS predicate, INT32.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contained_span_span`. Per-event scalar operator following the
...
public:
    ...
    ContainedSpanSpanLogicalFunction(LogicalFunction lit,
