...
/**
 * @brief Returns 1 if integer span sp1 is contained by integer span sp2.
 */
class ContainedSpanSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainedSpanSpan";
    ContainedSpanSpanLogicalFunction(LogicalFunction sp1, LogicalFunction sp2);
