...
/**
 * @brief floatspan_shift_scale (container, shift, width, hasshift=true, haswidth=true) -> shifted+scaled floatspan.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_shift_scale`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanShiftScaleLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanShiftScale";

    FloatspanShiftScaleLogicalFunction(LogicalFunction lit,
