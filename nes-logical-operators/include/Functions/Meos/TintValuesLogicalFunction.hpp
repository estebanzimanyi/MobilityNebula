...
/**
 * @brief tint_values (int *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tint_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintValues";

    TintValuesLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
