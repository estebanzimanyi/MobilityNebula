...
/**
 * @brief tbox_cmp (int) — TBox box-box operator over two literals.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_cmp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxCmpLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxCmp";

    TboxCmpLogicalFunction(LogicalFunction lit,
