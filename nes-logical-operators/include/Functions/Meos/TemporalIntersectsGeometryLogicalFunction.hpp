...
/**
 * @brief Per-event intersects_tgeo_geo spatial predicate.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intersects_tgeo_geo`. Per-event scalar operator following the
...
public:
    ...
    TemporalIntersectsGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
