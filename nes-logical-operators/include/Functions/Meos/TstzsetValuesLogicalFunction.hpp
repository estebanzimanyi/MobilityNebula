...
/**
 * @brief tstzset_values (TimestampTz *) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzset_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzsetValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzsetValues";

    TstzsetValuesLogicalFunction(LogicalFunction lit);
