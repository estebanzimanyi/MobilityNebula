...
/**
 * @brief set_to_tbox (TBox *) — Set -> TBox conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `set_to_tbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SetToTboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SetToTbox";

    SetToTboxLogicalFunction(LogicalFunction lit);
