...
/**
 * @brief geom_dwithin2d (bool) — geometry op with fixed 2.0.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_dwithin2d`. Per-event scalar operator following the
...
public:
    ...
    GeomDwithin2dLogicalFunction(LogicalFunction lit,
