...
/**
 * @brief Static geometry predicate geom_dwithin2d: (wkt1:VARCHAR, wkt2:VARCHAR, dist:FLOAT64) -> float64 (0/1).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geom_dwithin2d`. Operates on plain WKT strings without a temporal dimension.
 */
class GeomDwithin2dLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeomDwithin2d";

    GeomDwithin2dLogicalFunction(LogicalFunction wkt1, LogicalFunction wkt2, LogicalFunction dist);
