...
/**
 * @brief Returns the nth point of a linestring as WKT (1-based index).
 */
class LinePointNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "LinePointN";

    LinePointNLogicalFunction(LogicalFunction wkt, LogicalFunction n);
