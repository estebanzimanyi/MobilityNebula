...
/**
 * @brief Per-event add_float_tfloat: scalar float plus single-instant tfloat.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `add_float_tfloat`. Per-event scalar operator following the
...
public:
    ...
    AddFloatTfloatLogicalFunction(LogicalFunction arg0,
