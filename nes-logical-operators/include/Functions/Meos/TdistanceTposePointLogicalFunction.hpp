...
/**
 * @brief tdistance_tpose_point (Temporal *) — temporal tpose ⊗ GSERIALIZED -> tfloat_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tdistance_tpose_point`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TdistanceTposePointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TdistanceTposePoint";

    TdistanceTposePointLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
