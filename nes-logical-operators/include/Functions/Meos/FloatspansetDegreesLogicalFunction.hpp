...
/**
 * @brief floatspanset_degrees (SpanSet *) — radians->degrees container transform.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspanset_degrees`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspansetDegreesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspansetDegrees";

    FloatspansetDegreesLogicalFunction(LogicalFunction lit,
