...
/**
 * @brief Per-event tand_tbool_bool: AND of a single-instant tbool and a scalar bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tand_tbool_bool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the operation, and returns FLOAT64 (0.0/1.0).
 */
class TandTboolBoolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TandTboolBool";

    TandTboolBoolLogicalFunction(LogicalFunction value,
