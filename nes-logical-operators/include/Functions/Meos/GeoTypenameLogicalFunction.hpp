...
/**
 * @brief geo_typename (const char *) - the name of a geo type tag.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_typename`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GeoTypenameLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoTypename";

    GeoTypenameLogicalFunction(LogicalFunction value);
