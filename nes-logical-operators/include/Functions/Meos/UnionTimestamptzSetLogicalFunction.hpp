...
/**
 * @brief union_timestamptz_set: extern Set *union_timestamptz_set(TimestampTz t, const Set *s);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_timestamptz_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionTimestamptzSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionTimestamptzSet";

    UnionTimestamptzSetLogicalFunction(LogicalFunction lit,
