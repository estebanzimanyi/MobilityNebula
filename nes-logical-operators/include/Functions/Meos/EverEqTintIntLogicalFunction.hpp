...
/**
 * @brief Per-event ever_eq_tint_int: tests if a single-instant tint value ever equals a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_tint_int`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class EverEqTintIntLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqTintInt";

    EverEqTintIntLogicalFunction(LogicalFunction value,
