...
/**
 * @brief Per-event same_tspatial_stbox: single-instant tgeompoint against a STBox literal -> bool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `same_tspatial_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SameTspatialStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SameTspatialStbox";

    SameTspatialStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
