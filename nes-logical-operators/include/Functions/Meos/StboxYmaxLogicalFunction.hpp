...
/**
 * @brief stbox_ymax (out-param double) — stbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `stbox_ymax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class StboxYmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "StboxYmax";

    StboxYmaxLogicalFunction(LogicalFunction box);
