...
/**
 * @brief tintersects_geo_tcbuffer (Temporal *) — temporal tcbuffer ⊗ GSERIALIZED -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tintersects_geo_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintersectsGeoTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintersectsGeoTcbuffer";

    TintersectsGeoTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
