...
/**
 * @brief right_bigint_spanset (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `right_bigint_spanset`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class RightBigintSpansetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "RightBigintSpanset";

    RightBigintSpansetLogicalFunction(LogicalFunction lit,
