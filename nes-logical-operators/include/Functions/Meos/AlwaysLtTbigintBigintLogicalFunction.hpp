...
/**
 * @brief Per-event always comparison of a single-instant tbigint (built from value+timestamp) against a scalar constant.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_lt_tbigint_bigint`. Per-event scalar operator following the
