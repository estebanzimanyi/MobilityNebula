...
/**
 * @brief tpose_at_geom (Temporal *) — tpose restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_at_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeAtGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeAtGeom";

    TposeAtGeomLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
