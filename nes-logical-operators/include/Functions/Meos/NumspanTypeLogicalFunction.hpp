...
/**
 * @brief numspan_type (bool) — type-dispatch predicate on a value's spantype.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `numspan_type`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class NumspanTypeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NumspanType";

    NumspanTypeLogicalFunction(LogicalFunction lit);
