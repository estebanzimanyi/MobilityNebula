...
/**
 * @brief trgeometry_start_instant (TInstant *) — unary trgeometry accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `trgeometry_start_instant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TrgeometryStartInstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TrgeometryStartInstant";

    TrgeometryStartInstantLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
