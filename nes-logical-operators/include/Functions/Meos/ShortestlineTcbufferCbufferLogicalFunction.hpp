...
/**
 * @brief shortestline_tcbuffer_cbuffer (GSERIALIZED *) — tcbuffer nearest-approach ⊗ Cbuffer.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `shortestline_tcbuffer_cbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ShortestlineTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ShortestlineTcbufferCbuffer";

    ShortestlineTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
