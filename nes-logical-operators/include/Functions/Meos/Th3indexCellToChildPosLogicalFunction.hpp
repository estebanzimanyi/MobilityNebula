...
/**
 * @brief Th3index cell to child position
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_cell_to_child_pos(temp, (int32_t)arg0)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexCellToChildPosLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
