...
/**
 * @brief Returns the position of the H3 cell within its parent at parent_res as FLOAT64.
 *
 * Args: (cell:UINT64, ts:UINT64, parent_res:UINT64) -> FLOAT64.
 */
class Th3indexCellToChildPosLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexCellToChildPos";

    Th3indexCellToChildPosLogicalFunction(LogicalFunction cell, LogicalFunction ts, LogicalFunction parent_res);
