...
/**
 * @brief Returns 1.0 if the H3 cell index is valid, 0.0 otherwise.
 *
 * Args: (cell:UINT64, ts:UINT64) -> FLOAT64.
 */
class Th3indexIsValidCellLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Th3indexIsValidCell";

    Th3indexIsValidCellLogicalFunction(LogicalFunction cell, LogicalFunction ts);
