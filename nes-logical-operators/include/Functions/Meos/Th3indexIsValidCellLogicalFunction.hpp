...
/**
 * @brief Th3index th3index is valid cell
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `th3index_is_valid_cell(temp)`. Per-event scalar operator following the
...
public:
    ...
    Th3indexIsValidCellLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts);
