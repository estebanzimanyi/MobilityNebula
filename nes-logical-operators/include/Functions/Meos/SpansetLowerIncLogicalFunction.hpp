...
/**
 * @brief spanset_lower_inc (bool) — unary intspanset accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `spanset_lower_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class SpansetLowerIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "SpansetLowerInc";

    SpansetLowerIncLogicalFunction(LogicalFunction lit);
