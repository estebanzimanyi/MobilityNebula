...
/**
 * @brief temporal_time (SpanSet *) — unary temporal -> SpanSet.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalTime";

    TemporalTimeLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
