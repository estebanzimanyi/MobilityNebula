...
/**
 * @brief timestamptz_to_date (DateADT) — scalar date/time conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `timestamptz_to_date`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TimestamptzToDateLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TimestamptzToDate";

    TimestamptzToDateLogicalFunction(LogicalFunction value);
