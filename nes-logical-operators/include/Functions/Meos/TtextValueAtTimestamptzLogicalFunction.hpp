...
/**
 * @brief ttext_value_at_timestamptz (out-param text) — ttext value at a timestamp.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttext_value_at_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtextValueAtTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtextValueAtTimestamptz";

    TtextValueAtTimestamptzLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
