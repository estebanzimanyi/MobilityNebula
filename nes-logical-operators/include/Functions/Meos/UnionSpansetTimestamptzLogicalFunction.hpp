...
/**
 * @brief union_spanset_timestamptz: extern SpanSet *union_spanset_timestamptz(const SpanSet *ss, TimestampTz t);
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `union_spanset_timestamptz`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class UnionSpansetTimestamptzLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "UnionSpansetTimestamptz";

    UnionSpansetTimestamptzLogicalFunction(LogicalFunction lit,
