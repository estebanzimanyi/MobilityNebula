...
/**
 * @brief Per-event always-touches between a single-instant tpose (converted to tgeompoint at runtime) and a static geometry.
 *
 ...
 */
class TemporalATouchesTPoseGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalATouchesTPoseGeometry";

    TemporalATouchesTPoseGeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
