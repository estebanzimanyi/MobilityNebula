...
/**
 * @brief Per-event always_ne_bool_tbool: always-not-equal scalar bool vs tbool.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `always_ne_bool_tbool`. Per-event scalar operator following the
...
public:
    ...
    AlwaysNeBoolTboolLogicalFunction(LogicalFunction arg0,
