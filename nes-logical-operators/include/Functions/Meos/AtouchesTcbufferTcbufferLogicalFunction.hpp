...
/**
 * @brief Returns 1.0 if the two tcbuffer instants always touch, 0.0 otherwise.
 *
 * Args: (lon1:FLOAT64, lat1:FLOAT64, r1:FLOAT64, ts1:UINT64,
 *        lon2:FLOAT64, lat2:FLOAT64, r2:FLOAT64, ts2:UINT64) -> FLOAT64.
 */
class AtouchesTcbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "AtouchesTcbufferTcbuffer";

    AtouchesTcbufferTcbufferLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction r1,
                          LogicalFunction ts1,
