...
/**
 * @brief before_date_set (bool) — generic set-algebra/predicate, container⊕value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `before_date_set`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BeforeDateSetLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BeforeDateSet";

    BeforeDateSetLogicalFunction(LogicalFunction lit,
