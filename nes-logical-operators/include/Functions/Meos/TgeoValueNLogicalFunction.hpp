...
/**
 * @brief tgeo_value_n (out-param GSERIALIZED, n=1) — tgeompoint value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoValueN";

    TgeoValueNLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
