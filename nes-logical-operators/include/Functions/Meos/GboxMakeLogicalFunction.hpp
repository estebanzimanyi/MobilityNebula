...
/**
 * @brief gbox_make (GBOX *) - a PostGIS GBOX from hasz and its bounds (xmin,xmax,ymin,ymax,zmin,zmax).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `gbox_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class GboxMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GboxMake";

    GboxMakeLogicalFunction(LogicalFunction value,
