...
/**
 * @brief Creates a float span from bounds and inclusivity flags.
 */
class FloatspanMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanMake";
    FloatspanMakeLogicalFunction(LogicalFunction lower, LogicalFunction upper, LogicalFunction lower_inc, LogicalFunction upper_inc);
