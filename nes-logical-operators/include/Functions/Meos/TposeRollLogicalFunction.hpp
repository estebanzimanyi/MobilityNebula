...
/**
 * @brief Per-event tpose_roll: one hex-WKB temporal operand -> hex-WKB temporal.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpose_roll`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TposeRollLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TposeRoll";

    TposeRollLogicalFunction(LogicalFunction traj);
