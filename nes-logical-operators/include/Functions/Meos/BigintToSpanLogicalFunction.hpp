...
/**
 * @brief bigint_to_span (bigint value) -> span (VARSIZED).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `bigint_to_span`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class BigintToSpanLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "BigintToSpan";

    BigintToSpanLogicalFunction(LogicalFunction value);
