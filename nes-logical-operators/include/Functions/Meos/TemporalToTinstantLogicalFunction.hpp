...
/**
 * @brief temporal_to_tinstant (TInstant *) — unary tfloat accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `temporal_to_tinstant`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalToTinstantLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalToTinstant";

    TemporalToTinstantLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts);
