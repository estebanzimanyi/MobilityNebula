...
/**
 * @brief tgeo_values (GSERIALIZED **) — array of values.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tgeo_values`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TgeoValuesLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TgeoValues";

    TgeoValuesLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
