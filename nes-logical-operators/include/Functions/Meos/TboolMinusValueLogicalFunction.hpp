...
/**
 * @brief tbool_minus_value (Temporal *) — temporal tbool ⊗ bool -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbool_minus_value`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboolMinusValueLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboolMinusValue";

    TboolMinusValueLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
