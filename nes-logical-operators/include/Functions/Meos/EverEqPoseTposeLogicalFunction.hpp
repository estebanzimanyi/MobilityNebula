...
/**
 * @brief Returns 1.0 if the static pose is ever equal to the 2D tpose instant, 0.0 otherwise.
 */
class EverEqPoseTposeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverEqPoseTpose";

    EverEqPoseTposeLogicalFunction(LogicalFunction x2, LogicalFunction y2, LogicalFunction theta2, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts);
