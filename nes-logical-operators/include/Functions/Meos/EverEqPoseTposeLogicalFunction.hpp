...
/**
 * @brief ever_eq_pose_tpose (int) — always/ever tpose ⊗ Pose.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_eq_pose_tpose`. Per-event scalar operator following the
...
public:
    ...
    EverEqPoseTposeLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
