...
/**
 * @brief Ever neual th3index vs h3index
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_th3index_h3index(temp, (H3Index)arg0)`. Per-event scalar operator following the
...
public:
    ...
    EverNeTh3indexH3indexLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
