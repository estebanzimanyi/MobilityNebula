...
/**
 * @brief tstzspan_tprecision (Span *) — arity-3 tstzspan_text op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_tprecision`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanTprecisionLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanTprecision";

    TstzspanTprecisionLogicalFunction(LogicalFunction lit,
