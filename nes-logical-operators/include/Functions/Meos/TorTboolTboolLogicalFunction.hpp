...
/**
 * @brief Per-event tor_tbool_tbool: temporal OR of two tbool values (WKB result).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tor_tbool_tbool`. Per-event scalar operator following the
...
public:
    ...
    TorTboolTboolLogicalFunction(LogicalFunction traj,
