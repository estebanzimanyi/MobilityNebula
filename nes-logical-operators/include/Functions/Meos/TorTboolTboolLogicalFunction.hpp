...
/**
 * @brief Per-event tor_tbool_tbool: OR of two single-instant tbools.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tor_tbool_tbool`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the operation, and returns FLOAT64 (0.0/1.0).
 */
class TorTboolTboolLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TorTboolTbool";

    TorTboolTboolLogicalFunction(LogicalFunction value,
