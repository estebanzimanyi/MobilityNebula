...
/**
 * @brief Returns a geometry reprojected to the target SRID, as WKT.
 */
class GeoTransformLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "GeoTransform";

    GeoTransformLogicalFunction(LogicalFunction wkt, LogicalFunction srid_to);
