...
/**
 * @brief geo_transform (GSERIALIZED *) — geometry op with fixed 3857.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `geo_transform`. Per-event scalar operator following the
...
public:
    ...
    GeoTransformLogicalFunction(LogicalFunction lit);
