...
/**
 * @brief Per-event always-distance-within between two single-instant tcbuffers under a fixed threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `adwithin_tcbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TemporalADWithinTCbufferTCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalADWithinTCbufferTCbuffer";

    TemporalADWithinTCbufferTCbufferLogicalFunction(LogicalFunction lonA,
