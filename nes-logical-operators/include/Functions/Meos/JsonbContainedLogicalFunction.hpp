...
/**
 * @brief Tests if JSONB jb1 is contained by jb2.
 */
class JsonbContainedLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "JsonbContained";
    JsonbContainedLogicalFunction(LogicalFunction jb1, LogicalFunction jb2);
