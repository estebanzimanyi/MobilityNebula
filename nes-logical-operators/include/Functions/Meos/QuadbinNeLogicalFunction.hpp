...
/**
 * @brief Tests inequality of two Quadbin cell identifiers.
 */
class QuadbinNeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "QuadbinNe";
    QuadbinNeLogicalFunction(LogicalFunction a, LogicalFunction b);
