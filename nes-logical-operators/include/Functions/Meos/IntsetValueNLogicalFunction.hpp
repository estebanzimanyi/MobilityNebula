...
/**
 * @brief intset_value_n (out-param int, n=1) — intset value_n.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `intset_value_n`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class IntsetValueNLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "IntsetValueN";

    IntsetValueNLogicalFunction(LogicalFunction lit);
