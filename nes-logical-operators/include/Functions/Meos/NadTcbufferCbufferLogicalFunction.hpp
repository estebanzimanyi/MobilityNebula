...
/**
 * @brief Returns the nearest approach distance between the tcbuffer and a static cbuffer.
 *
 * Args: (lon1:FLOAT64, lat1:FLOAT64, r1:FLOAT64, ts:UINT64,
 *        lon2:FLOAT64, lat2:FLOAT64, r2:FLOAT64) -> FLOAT64.
 */
class NadTcbufferCbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "NadTcbufferCbuffer";

    NadTcbufferCbufferLogicalFunction(LogicalFunction lon1, LogicalFunction lat1, LogicalFunction r1,
                          LogicalFunction ts,
