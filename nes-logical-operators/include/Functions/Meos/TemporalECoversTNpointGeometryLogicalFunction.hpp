...
/**
 * @brief Per-event ever-covers between a single-instant tgeompoint resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint and a static geometry (network SRID).
 *
 ...
 */
class TemporalECoversTNpointGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalECoversTNpointGeometry";

    TemporalECoversTNpointGeometryLogicalFunction(LogicalFunction rid,
