...
/**
 * @brief Per-event ever_gt_tbigint_bigint: tests if a single-instant tbigint value ever gts a threshold.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_gt_tbigint_bigint`. Takes (value:FLOAT64, threshold:FLOAT64, ts:UINT64),
 * constructs a single-instant temporal, applies the comparison, and returns FLOAT64 (0.0/1.0).
 */
class EverGtTbigintBigintLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "EverGtTbigintBigint";

    EverGtTbigintBigintLogicalFunction(LogicalFunction value,
