...
/**
 * @brief date_to_timestamp (Timestamp) — scalar date/time conversion.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `date_to_timestamp`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class DateToTimestampLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "DateToTimestamp";

    DateToTimestampLogicalFunction(LogicalFunction value);
