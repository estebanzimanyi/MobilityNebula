...
/**
 * @brief Per-event always-intersects between two single-instant tgeompoints.
 *
 ...
 */
class TemporalAIntersectsTGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAIntersectsTGeometry";

    TemporalAIntersectsTGeometryLogicalFunction(LogicalFunction lonA,
