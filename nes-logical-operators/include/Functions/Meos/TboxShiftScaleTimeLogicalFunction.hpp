...
/**
 * @brief tbox_shift_scale_time (TBox *) — arity-3 tbox_text_out op.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_shift_scale_time`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxShiftScaleTimeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxShiftScaleTime";

    TboxShiftScaleTimeLogicalFunction(LogicalFunction lit,
