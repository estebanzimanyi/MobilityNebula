...
/**
 * @brief tstzspan_lower (TimestampTz) — unary tstzspan accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tstzspan_lower`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TstzspanLowerLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TstzspanLower";

    TstzspanLowerLogicalFunction(LogicalFunction lit);
