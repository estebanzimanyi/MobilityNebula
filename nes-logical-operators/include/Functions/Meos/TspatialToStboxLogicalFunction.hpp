...
/**
 * @brief tspatial_to_stbox (STBox *) - the spatiotemporal bounding box of a temporal geometry point.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tspatial_to_stbox`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TspatialToStboxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TspatialToStbox";

    TspatialToStboxLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts);
