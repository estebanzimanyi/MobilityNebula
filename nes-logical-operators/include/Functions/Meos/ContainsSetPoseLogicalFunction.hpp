...
/**
 * @brief contains_set_pose (bool) — object-set ± pose value.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `contains_set_pose`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class ContainsSetPoseLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "ContainsSetPose";

    ContainsSetPoseLogicalFunction(LogicalFunction lit,
