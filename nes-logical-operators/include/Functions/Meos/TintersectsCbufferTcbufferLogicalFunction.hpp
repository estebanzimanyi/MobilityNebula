...
/**
 * @brief tintersects_cbuffer_tcbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tintersects_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TintersectsCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TintersectsCbufferTcbuffer";

    TintersectsCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
