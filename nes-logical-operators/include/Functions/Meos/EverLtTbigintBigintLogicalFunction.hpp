...
/**
 * @brief Per-event ever comparison of a single-instant tbigint (built from value+timestamp) against a scalar constant.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_lt_tbigint_bigint`. Per-event scalar operator following the
