...
/**
 * @brief ttouches_cbuffer_tcbuffer (Temporal *) — temporal tcbuffer ⊗ Cbuffer -> tbool_out.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ttouches_cbuffer_tcbuffer`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TtouchesCbufferTcbufferLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TtouchesCbufferTcbuffer";

    TtouchesCbufferTcbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
