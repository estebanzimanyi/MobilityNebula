...
/**
 * @brief Returns 1 if the lower bound of a float span is inclusive, 0 otherwise.
 */
class FloatspanLowerIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanLowerInc";
    FloatspanLowerIncLogicalFunction(LogicalFunction sp);
