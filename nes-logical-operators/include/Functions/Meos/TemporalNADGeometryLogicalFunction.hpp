...
/**
 * @brief Per-event nearest-approach distance between a single-instant tgeompoint and a static geometry.
 *
 ...
 */
class TemporalNADGeometryLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalNADGeometry";

    TemporalNADGeometryLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
