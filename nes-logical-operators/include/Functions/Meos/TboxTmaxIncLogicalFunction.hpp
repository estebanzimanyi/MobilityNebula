...
/**
 * @brief tbox_tmax_inc (out-param bool) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tbox_tmax_inc`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxTmaxIncLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxTmaxInc";

    TboxTmaxIncLogicalFunction(LogicalFunction lit);
