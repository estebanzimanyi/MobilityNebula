...
/**
 * @brief Per-event always-contains between two single-instant tgeompoints, each resolved from a tnpoint (rid,fraction,ts) via tnpoint_to_tgeompoint.
 *
 ...
 */
class TemporalAContainsTNpointTNpointLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TemporalAContainsTNpointTNpoint";

    TemporalAContainsTNpointTNpointLogicalFunction(LogicalFunction ridA,
