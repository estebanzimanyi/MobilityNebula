...
/**
 * @brief floatspan_expand (Span *) — span widened by a scalar delta.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `floatspan_expand`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class FloatspanExpandLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "FloatspanExpand";

    FloatspanExpandLogicalFunction(LogicalFunction lit,
