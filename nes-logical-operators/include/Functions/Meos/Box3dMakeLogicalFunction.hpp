...
/**
 * @brief box3d_make (BOX3D *) - a PostGIS BOX3D from its bounds (xmin,xmax,ymin,ymax,zmin,zmax,srid).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `box3d_make`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class Box3dMakeLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "Box3dMake";

    Box3dMakeLogicalFunction(LogicalFunction value,
