...
/**
 * @brief Per-event ever comparison between two single-instant temporals (built from valueA/tsA and valueB/tsB).
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `ever_ne_temporal_temporal`. Per-event scalar operator following the
...
public:
    ...
    EverNeTemporalTemporalLogicalFunction(LogicalFunction valueA,
                                          LogicalFunction tsA,
