...
/**
 * @brief tpoint_at_geom (Temporal *) — tgeo restriction by GSERIALIZED.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tpoint_at_geom`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TpointAtGeomLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TpointAtGeom";

    TpointAtGeomLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
