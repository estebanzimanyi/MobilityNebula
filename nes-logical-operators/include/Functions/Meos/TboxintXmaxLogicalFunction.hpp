...
/**
 * @brief tboxint_xmax (out-param int) — tbox_text accessor.
 *
 * Generated by tools/codegen/codegen_nebula.py from the MEOS function
 * `tboxint_xmax`. Per-event scalar operator following the
 * TemporalEDWithinGeometry pattern.
 */
class TboxintXmaxLogicalFunction : public LogicalFunctionConcept {
public:
    static constexpr std::string_view NAME = "TboxintXmax";

    TboxintXmaxLogicalFunction(LogicalFunction lit);
