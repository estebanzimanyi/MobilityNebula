...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverEqTposeTposeLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EverEqTposeTposeLogicalFunction::EverEqTposeTposeLogicalFunction(LogicalFunction traj,
...
{
    PRECONDITION(children.size() == 2, "EverEqTposeTposeLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "EverEqTposeTposeLogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return EverEqTposeTposeLogicalFunction(std::move(arg0), std::move(arg1));
}
