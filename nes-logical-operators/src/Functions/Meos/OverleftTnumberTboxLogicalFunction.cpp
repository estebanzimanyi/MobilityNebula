...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverleftTnumberTboxLogicalFunction(LogicalFunctionRegistryArguments); }
