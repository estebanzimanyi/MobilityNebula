...
AlwaysEqTemporalTemporalLogicalFunction::AlwaysEqTemporalTemporalLogicalFunction(LogicalFunction value,
...
DataType AlwaysEqTemporalTemporalLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> AlwaysEqTemporalTemporalLogicalFunction::getChildren() const { return parameters; }

LogicalFunction AlwaysEqTemporalTemporalLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 3, "AlwaysEqTemporalTemporalLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view AlwaysEqTemporalTemporalLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 3,
                 "AlwaysEqTemporalTemporalLogicalFunction requires 3 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    auto arg2 = std::move(arguments.children[2]);
    return AlwaysEqTemporalTemporalLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
