...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverGeIntTintLogicalFunction(LogicalFunctionRegistryArguments); }
