...
DataType EverGeIntTintLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> EverGeIntTintLogicalFunction::getChildren() const { return parameters; }
...
std::string_view EverGeIntTintLogicalFunction::getType() const { return NAME; }
