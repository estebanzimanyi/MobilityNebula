...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeoPointsLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeoPointsLogicalFunction::GeoPointsLogicalFunction(LogicalFunction lit)
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterGeoPointsLogicalFunction(
