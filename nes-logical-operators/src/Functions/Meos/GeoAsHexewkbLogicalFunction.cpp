...
GeoAsHexewkbLogicalFunction::GeoAsHexewkbLogicalFunction(LogicalFunction wkt,
                                          LogicalFunction endian)
...
DataType GeoAsHexewkbLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeoAsHexewkbLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "GeoAsHexewkbLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeoAsHexewkbLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeoAsHexewkbLogicalFunction(std::move(arg0), std::move(arg1));
}
