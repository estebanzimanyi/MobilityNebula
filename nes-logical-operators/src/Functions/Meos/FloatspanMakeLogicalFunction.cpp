...
FloatspanMakeLogicalFunction::FloatspanMakeLogicalFunction(LogicalFunction lower,
                                          LogicalFunction upper,
                                          LogicalFunction lower_inc,
                                          LogicalFunction upper_inc)
