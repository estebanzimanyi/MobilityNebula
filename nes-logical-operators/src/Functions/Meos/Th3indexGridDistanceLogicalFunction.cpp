...
Th3indexGridDistanceLogicalFunction::Th3indexGridDistanceLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
...
DataType Th3indexGridDistanceLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> Th3indexGridDistanceLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 4, "Th3indexGridDistanceLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view Th3indexGridDistanceLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return Th3indexGridDistanceLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
