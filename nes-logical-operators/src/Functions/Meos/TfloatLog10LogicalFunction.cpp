...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTfloatLog10LogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

TfloatLog10LogicalFunction::TfloatLog10LogicalFunction(LogicalFunction value,
                                          LogicalFunction ts)
...
LogicalFunction TfloatLog10LogicalFunction::withInferredDataType(const Schema& schema) const
{
...
SerializableFunction TfloatLog10LogicalFunction::serialize() const
{
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterTfloatLog10LogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "TfloatLog10LogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return TfloatLog10LogicalFunction(std::move(arg0), std::move(arg1));
}
