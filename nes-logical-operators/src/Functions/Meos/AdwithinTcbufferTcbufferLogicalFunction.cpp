...
AdwithinTcbufferTcbufferLogicalFunction::AdwithinTcbufferTcbufferLogicalFunction(
...
DataType AdwithinTcbufferTcbufferLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> AdwithinTcbufferTcbufferLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction AdwithinTcbufferTcbufferLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 9,
                 "AdwithinTcbufferTcbufferLogicalFunction requires 9 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view AdwithinTcbufferTcbufferLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AdwithinTcbufferTcbufferLogicalFunction(std::move(arguments.children[0]),
