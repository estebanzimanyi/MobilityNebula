...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeomBoundaryLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeomBoundaryLogicalFunction::GeomBoundaryLogicalFunction(LogicalFunction lit)
...
DataType GeomBoundaryLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomBoundaryLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 1, "GeomBoundaryLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomBoundaryLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomBoundaryLogicalFunction(std::move(arg0));
}
