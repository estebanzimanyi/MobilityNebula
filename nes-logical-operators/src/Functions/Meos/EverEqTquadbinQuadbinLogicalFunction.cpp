...
EverEqTquadbinQuadbinLogicalFunction::EverEqTquadbinQuadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
...
DataType EverEqTquadbinQuadbinLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction EverEqTquadbinQuadbinLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> EverEqTquadbinQuadbinLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view EverEqTquadbinQuadbinLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const EverEqTquadbinQuadbinLogicalFunction*>(&rhs))
    {
...
std::string EverEqTquadbinQuadbinLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTquadbinQuadbinLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
