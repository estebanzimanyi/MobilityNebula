...
LinePointNLogicalFunction::LinePointNLogicalFunction(LogicalFunction wkt,
...
DataType LinePointNLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> LinePointNLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "LinePointNLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view LinePointNLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return LinePointNLogicalFunction(std::move(arg0), std::move(arg1));
}
