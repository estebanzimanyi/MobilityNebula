...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTleTfloatFloatLogicalFunction(LogicalFunctionRegistryArguments); }
...
DataType TleTfloatFloatLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> TleTfloatFloatLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view TleTfloatFloatLogicalFunction::getType() const
{
    return NAME;
}
