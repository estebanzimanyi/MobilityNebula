...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAlwaysNeTrgeometryTrgeometryLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

AlwaysNeTrgeometryTrgeometryLogicalFunction::AlwaysNeTrgeometryTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
...
DataType AlwaysNeTrgeometryTrgeometryLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AlwaysNeTrgeometryTrgeometryLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 8, "AlwaysNeTrgeometryTrgeometryLogicalFunction requires 8 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view AlwaysNeTrgeometryTrgeometryLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 8,
                 "AlwaysNeTrgeometryTrgeometryLogicalFunction requires 8 children but got {}",
    ...
    return AlwaysNeTrgeometryTrgeometryLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
