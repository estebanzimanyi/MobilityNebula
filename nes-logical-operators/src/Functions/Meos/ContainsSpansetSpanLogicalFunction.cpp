...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterContainsSpansetSpanLogicalFunction(LogicalFunctionRegistryArguments); }
