...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeomIntersects3dLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeomIntersects3dLogicalFunction::GeomIntersects3dLogicalFunction(LogicalFunction lit,
...
LogicalFunction GeomIntersects3dLogicalFunction::withInferredDataType(const Schema& schema) const
{
...
SerializableFunction GeomIntersects3dLogicalFunction::serialize() const
{
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterGeomIntersects3dLogicalFunction(
