...
EverNeTquadbinTquadbinLogicalFunction::EverNeTquadbinTquadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
...
DataType EverNeTquadbinTquadbinLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction EverNeTquadbinTquadbinLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> EverNeTquadbinTquadbinLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view EverNeTquadbinTquadbinLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const EverNeTquadbinTquadbinLogicalFunction*>(&rhs))
    {
...
std::string EverNeTquadbinTquadbinLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverNeTquadbinTquadbinLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
