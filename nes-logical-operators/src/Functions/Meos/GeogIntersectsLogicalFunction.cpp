...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeogIntersectsLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeogIntersectsLogicalFunction::GeogIntersectsLogicalFunction(LogicalFunction lit,
...
DataType GeogIntersectsLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeogIntersectsLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "GeogIntersectsLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeogIntersectsLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeogIntersectsLogicalFunction(std::move(arg0), std::move(arg1));
}
