...
JsonbNeLogicalFunction::JsonbNeLogicalFunction(LogicalFunction jb,
...
DataType JsonbNeLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction JsonbNeLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> JsonbNeLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view JsonbNeLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const JsonbNeLogicalFunction*>(&rhs))
    {
...
std::string JsonbNeLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return JsonbNeLogicalFunction(std::move(arg0), std::move(arg1));
}
