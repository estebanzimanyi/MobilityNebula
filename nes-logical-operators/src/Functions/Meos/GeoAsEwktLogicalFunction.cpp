...
GeoAsEwktLogicalFunction::GeoAsEwktLogicalFunction(LogicalFunction wkt,
...
DataType GeoAsEwktLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeoAsEwktLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "GeoAsEwktLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeoAsEwktLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeoAsEwktLogicalFunction(std::move(arg0), std::move(arg1));
}
