...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverafterTimestamptzSpansetLogicalFunction(LogicalFunctionRegistryArguments); }
