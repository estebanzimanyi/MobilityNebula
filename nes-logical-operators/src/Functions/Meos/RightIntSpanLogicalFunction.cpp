...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterRightIntSpanLogicalFunction(LogicalFunctionRegistryArguments); }
