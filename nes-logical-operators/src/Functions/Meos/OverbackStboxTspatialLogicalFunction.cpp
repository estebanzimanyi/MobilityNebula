...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverbackStboxTspatialLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

OverbackStboxTspatialLogicalFunction::OverbackStboxTspatialLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction z,
                                          LogicalFunction ts,
...
LogicalFunction OverbackStboxTspatialLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
{
    PRECONDITION(children.size() == 5, "OverbackStboxTspatialLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this;
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterOverbackStboxTspatialLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 5,
                 "OverbackStboxTspatialLogicalFunction requires 5 children but got {}",
    ...
    return OverbackStboxTspatialLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
