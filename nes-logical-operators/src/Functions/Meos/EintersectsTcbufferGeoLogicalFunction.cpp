...
EintersectsTcbufferGeoLogicalFunction::EintersectsTcbufferGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
...
DataType EintersectsTcbufferGeoLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> EintersectsTcbufferGeoLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction EintersectsTcbufferGeoLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 5,
                 "EintersectsTcbufferGeoLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view EintersectsTcbufferGeoLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EintersectsTcbufferGeoLogicalFunction(std::move(arguments.children[0]),
