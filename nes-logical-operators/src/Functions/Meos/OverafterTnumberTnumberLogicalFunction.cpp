...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverafterTnumberTnumberLogicalFunction(LogicalFunctionRegistryArguments); }
