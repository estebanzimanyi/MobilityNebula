...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTtextUpperLogicalFunction(LogicalFunctionRegistryArguments); }
...
DataType TtextUpperLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> TtextUpperLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view TtextUpperLogicalFunction::getType() const
{
    return NAME;
}
