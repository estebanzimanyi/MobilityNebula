...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterNadTgeoGeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

NadTgeoGeoLogicalFunction::NadTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
...
DataType NadTgeoGeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> NadTgeoGeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 4, "NadTgeoGeoLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view NadTgeoGeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return NadTgeoGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
