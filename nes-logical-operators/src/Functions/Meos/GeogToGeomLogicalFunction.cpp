...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeogToGeomLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeogToGeomLogicalFunction::GeogToGeomLogicalFunction(LogicalFunction lit)
...
DataType GeogToGeomLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeogToGeomLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 1, "GeogToGeomLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeogToGeomLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeogToGeomLogicalFunction(std::move(arg0));
}
