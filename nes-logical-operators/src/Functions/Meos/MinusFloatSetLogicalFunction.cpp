...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterMinusFloatSetLogicalFunction(LogicalFunctionRegistryArguments); }
