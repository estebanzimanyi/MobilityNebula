...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAdjacentSpanDateLogicalFunction(LogicalFunctionRegistryArguments); }
