...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverafterTboxTboxLogicalFunction(LogicalFunctionRegistryArguments); }
