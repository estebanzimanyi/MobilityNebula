...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAlwaysNeTgeoGeoLogicalFunction(LogicalFunctionRegistryArguments); }
