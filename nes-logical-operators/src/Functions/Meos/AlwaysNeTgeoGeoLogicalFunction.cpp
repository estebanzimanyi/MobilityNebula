...
AlwaysNeTgeoGeoLogicalFunction::AlwaysNeTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
...
DataType AlwaysNeTgeoGeoLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> AlwaysNeTgeoGeoLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction AlwaysNeTgeoGeoLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 4,
                 "AlwaysNeTgeoGeoLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view AlwaysNeTgeoGeoLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeTgeoGeoLogicalFunction(std::move(arguments.children[0]),
