...
QuadbinCellToParentLogicalFunction::QuadbinCellToParentLogicalFunction(LogicalFunction cell,
                                          LogicalFunction res)
...
DataType QuadbinCellToParentLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> QuadbinCellToParentLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "QuadbinCellToParentLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view QuadbinCellToParentLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return QuadbinCellToParentLogicalFunction(std::move(arg0), std::move(arg1));
}
