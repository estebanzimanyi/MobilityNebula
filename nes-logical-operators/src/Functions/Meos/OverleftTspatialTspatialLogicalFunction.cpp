...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverleftTspatialTspatialLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

OverleftTspatialTspatialLogicalFunction::OverleftTspatialTspatialLogicalFunction(LogicalFunction lonA,
...
LogicalFunction OverleftTspatialTspatialLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
{
    PRECONDITION(children.size() == 6, "OverleftTspatialTspatialLogicalFunction requires 6 children, but got {}", children.size());
    auto copy = *this;
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterOverleftTspatialTspatialLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 6,
                 "OverleftTspatialTspatialLogicalFunction requires 6 children but got {}",
    ...
    return OverleftTspatialTspatialLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
