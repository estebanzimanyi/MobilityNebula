...
AcoversGeoTgeoLogicalFunction::AcoversGeoTgeoLogicalFunction(LogicalFunction wkt,
...
DataType AcoversGeoTgeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AcoversGeoTgeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "AcoversGeoTgeoLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view AcoversGeoTgeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "AcoversGeoTgeoLogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return AcoversGeoTgeoLogicalFunction(std::move(arg0), std::move(arg1));
}
