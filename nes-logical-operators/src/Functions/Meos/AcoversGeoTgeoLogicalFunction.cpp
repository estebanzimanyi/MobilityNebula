...
AcoversGeoTgeoLogicalFunction::AcoversGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
...
{
    PRECONDITION(children.size() == 4, "AcoversGeoTgeoLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AcoversGeoTgeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
