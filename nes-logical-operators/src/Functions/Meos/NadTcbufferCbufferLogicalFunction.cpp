...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterNadTcbufferCbufferLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

NadTcbufferCbufferLogicalFunction::NadTcbufferCbufferLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
...
DataType NadTcbufferCbufferLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> NadTcbufferCbufferLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 5, "NadTcbufferCbufferLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view NadTcbufferCbufferLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 5,
                 "NadTcbufferCbufferLogicalFunction requires 5 children but got {}",
    ...
    return NadTcbufferCbufferLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
