...
DataType TleFloatTfloatLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> TleFloatTfloatLogicalFunction::getChildren() const { return parameters; }
...
std::string_view TleFloatTfloatLogicalFunction::getType() const { return NAME; }
