...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAintersectsTcbufferGeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

AintersectsTcbufferGeoLogicalFunction::AintersectsTcbufferGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
...
DataType AintersectsTcbufferGeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AintersectsTcbufferGeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 5, "AintersectsTcbufferGeoLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view AintersectsTcbufferGeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AintersectsTcbufferGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
