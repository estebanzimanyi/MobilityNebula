...
DataType AlwaysGeTbigintBigintLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AlwaysGeTbigintBigintLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view AlwaysGeTbigintBigintLogicalFunction::getType() const
{
    return NAME;
}
