...
Th3indexGetResolutionLogicalFunction::Th3indexGetResolutionLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts)
...
DataType Th3indexGetResolutionLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> Th3indexGetResolutionLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "Th3indexGetResolutionLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view Th3indexGetResolutionLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return Th3indexGetResolutionLogicalFunction(std::move(arg0), std::move(arg1));
}
