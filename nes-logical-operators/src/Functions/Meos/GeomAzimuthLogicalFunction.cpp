...
GeomAzimuthLogicalFunction::GeomAzimuthLogicalFunction(LogicalFunction wkt)
...
{
    PRECONDITION(children.size() == 1, "GeomAzimuthLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 1,
                 "GeomAzimuthLogicalFunction requires 1 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    return GeomAzimuthLogicalFunction(std::move(arg0));
}
