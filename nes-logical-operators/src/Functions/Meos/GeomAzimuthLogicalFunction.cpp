...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeomAzimuthLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeomAzimuthLogicalFunction::GeomAzimuthLogicalFunction(LogicalFunction lit,
...
DataType GeomAzimuthLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomAzimuthLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view GeomAzimuthLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomAzimuthLogicalFunction(std::move(arg0), std::move(arg1));
}
