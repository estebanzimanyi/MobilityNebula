...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverEqTrgeometryGeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EverEqTrgeometryGeoLogicalFunction::EverEqTrgeometryGeoLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
...
DataType EverEqTrgeometryGeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EverEqTrgeometryGeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 5, "EverEqTrgeometryGeoLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view EverEqTrgeometryGeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 5,
                 "EverEqTrgeometryGeoLogicalFunction requires 5 children but got {}",
    ...
    return EverEqTrgeometryGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
