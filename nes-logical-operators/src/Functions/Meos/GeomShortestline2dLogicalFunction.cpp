...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeomShortestline2dLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeomShortestline2dLogicalFunction::GeomShortestline2dLogicalFunction(LogicalFunction lit,
...
DataType GeomShortestline2dLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomShortestline2dLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "GeomShortestline2dLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomShortestline2dLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomShortestline2dLogicalFunction(std::move(arg0), std::move(arg1));
}
