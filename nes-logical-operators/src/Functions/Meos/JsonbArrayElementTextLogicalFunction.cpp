...
JsonbArrayElementTextLogicalFunction::JsonbArrayElementTextLogicalFunction(LogicalFunction jb,
...
DataType JsonbArrayElementTextLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction JsonbArrayElementTextLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> JsonbArrayElementTextLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view JsonbArrayElementTextLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const JsonbArrayElementTextLogicalFunction*>(&rhs))
    {
...
std::string JsonbArrayElementTextLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return JsonbArrayElementTextLogicalFunction(std::move(arg0), std::move(arg1));
}
