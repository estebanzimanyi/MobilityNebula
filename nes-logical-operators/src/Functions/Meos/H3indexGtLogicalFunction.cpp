...
H3indexGtLogicalFunction::H3indexGtLogicalFunction(LogicalFunction a,
                                          LogicalFunction b)
...
DataType H3indexGtLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> H3indexGtLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "H3indexGtLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view H3indexGtLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return H3indexGtLogicalFunction(std::move(arg0), std::move(arg1));
}
