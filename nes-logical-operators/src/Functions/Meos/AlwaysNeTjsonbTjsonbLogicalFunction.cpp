...
AlwaysNeTjsonbTjsonbLogicalFunction::AlwaysNeTjsonbTjsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
...
DataType AlwaysNeTjsonbTjsonbLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AlwaysNeTjsonbTjsonbLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 4, "AlwaysNeTjsonbTjsonbLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view AlwaysNeTjsonbTjsonbLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeTjsonbTjsonbLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
