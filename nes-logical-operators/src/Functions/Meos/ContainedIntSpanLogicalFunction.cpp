...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterContainedIntSpanLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

ContainedIntSpanLogicalFunction::ContainedIntSpanLogicalFunction(LogicalFunction lit,
