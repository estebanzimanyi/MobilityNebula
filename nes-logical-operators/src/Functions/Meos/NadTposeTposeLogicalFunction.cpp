...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterNadTposeTposeLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

NadTposeTposeLogicalFunction::NadTposeTposeLogicalFunction(LogicalFunction traj,
...
{
    PRECONDITION(children.size() == 2, "NadTposeTposeLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterNadTposeTposeLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "NadTposeTposeLogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return NadTposeTposeLogicalFunction(std::move(arg0), std::move(arg1));
}
