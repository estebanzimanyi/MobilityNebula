...
EdwithinTcbufferTcbufferLogicalFunction::EdwithinTcbufferTcbufferLogicalFunction(
...
DataType EdwithinTcbufferTcbufferLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> EdwithinTcbufferTcbufferLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction EdwithinTcbufferTcbufferLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 9,
                 "EdwithinTcbufferTcbufferLogicalFunction requires 9 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view EdwithinTcbufferTcbufferLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EdwithinTcbufferTcbufferLogicalFunction(std::move(arguments.children[0]),
