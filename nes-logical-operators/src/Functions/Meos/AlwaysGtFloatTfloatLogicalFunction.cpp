...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAlwaysGtFloatTfloatLogicalFunction(LogicalFunctionRegistryArguments); }
...
DataType AlwaysGtFloatTfloatLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AlwaysGtFloatTfloatLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view AlwaysGtFloatTfloatLogicalFunction::getType() const
{
    return NAME;
}
