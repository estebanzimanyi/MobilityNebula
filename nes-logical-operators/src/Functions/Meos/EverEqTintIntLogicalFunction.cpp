...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverEqTintIntLogicalFunction(LogicalFunctionRegistryArguments); }
...
DataType EverEqTintIntLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EverEqTintIntLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view EverEqTintIntLogicalFunction::getType() const
{
    return NAME;
}
