...
H3indexCmpLogicalFunction::H3indexCmpLogicalFunction(LogicalFunction a,
                                          LogicalFunction b)
...
DataType H3indexCmpLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> H3indexCmpLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "H3indexCmpLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view H3indexCmpLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return H3indexCmpLogicalFunction(std::move(arg0), std::move(arg1));
}
