...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterMulTnumberTnumberLogicalFunction(LogicalFunctionRegistryArguments); }
