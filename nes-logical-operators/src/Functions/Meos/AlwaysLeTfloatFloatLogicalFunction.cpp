...
DataType AlwaysLeTfloatFloatLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> AlwaysLeTfloatFloatLogicalFunction::getChildren() const { return parameters; }
...
std::string_view AlwaysLeTfloatFloatLogicalFunction::getType() const { return NAME; }
