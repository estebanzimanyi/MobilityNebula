...
AlwaysNeBigintTbigintLogicalFunction::AlwaysNeBigintTbigintLogicalFunction(LogicalFunction arg0,
...
DataType AlwaysNeBigintTbigintLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AlwaysNeBigintTbigintLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view AlwaysNeBigintTbigintLogicalFunction::getType() const
{
    return NAME;
}
