...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTcontainsGeoTgeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

TcontainsGeoTgeoLogicalFunction::TcontainsGeoTgeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction ts,
...
LogicalFunction TcontainsGeoTgeoLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterTcontainsGeoTgeoLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 4,
                 "TcontainsGeoTgeoLogicalFunction requires 4 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    auto arg2 = std::move(arguments.children[2]);
    auto arg3 = std::move(arguments.children[3]);
    return TcontainsGeoTgeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
