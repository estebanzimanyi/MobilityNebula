...
LineLocatePointLogicalFunction::LineLocatePointLogicalFunction(LogicalFunction wkt,
...
DataType LineLocatePointLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> LineLocatePointLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "LineLocatePointLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view LineLocatePointLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return LineLocatePointLogicalFunction(std::move(arg0), std::move(arg1));
}
