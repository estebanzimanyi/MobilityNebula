...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverbackTspatialTspatialLogicalFunction(LogicalFunctionRegistryArguments); }
...
LogicalFunction OverbackTspatialTspatialLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
