...
AlwaysNeQuadbinTquadbinLogicalFunction::AlwaysNeQuadbinTquadbinLogicalFunction(LogicalFunction arg0,
...
DataType AlwaysNeQuadbinTquadbinLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction AlwaysNeQuadbinTquadbinLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> AlwaysNeQuadbinTquadbinLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view AlwaysNeQuadbinTquadbinLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const AlwaysNeQuadbinTquadbinLogicalFunction*>(&rhs))
    {
...
std::string AlwaysNeQuadbinTquadbinLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeQuadbinTquadbinLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
