...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTemporalEIntersectsTNpointTNpointLogicalFunction(LogicalFunctionRegistryArguments); }
