...
QuadbinPointToCellLogicalFunction::QuadbinPointToCellLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction res)
...
DataType QuadbinPointToCellLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> QuadbinPointToCellLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "QuadbinPointToCellLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view QuadbinPointToCellLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return QuadbinPointToCellLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
