...
LineSubstringLogicalFunction::LineSubstringLogicalFunction(LogicalFunction wkt,
...
DataType LineSubstringLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> LineSubstringLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "LineSubstringLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view LineSubstringLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return LineSubstringLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
