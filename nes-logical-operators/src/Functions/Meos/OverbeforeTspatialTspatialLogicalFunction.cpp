...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverbeforeTspatialTspatialLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

OverbeforeTspatialTspatialLogicalFunction::OverbeforeTspatialTspatialLogicalFunction(LogicalFunction lonA,
...
LogicalFunction OverbeforeTspatialTspatialLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
{
    PRECONDITION(children.size() == 6, "OverbeforeTspatialTspatialLogicalFunction requires 6 children, but got {}", children.size());
    auto copy = *this;
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterOverbeforeTspatialTspatialLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 6,
                 "OverbeforeTspatialTspatialLogicalFunction requires 6 children but got {}",
    ...
    return OverbeforeTspatialTspatialLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
