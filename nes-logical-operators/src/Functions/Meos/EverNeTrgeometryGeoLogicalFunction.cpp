...
EverNeTrgeometryGeoLogicalFunction::EverNeTrgeometryGeoLogicalFunction(LogicalFunction ref_wkt, LogicalFunction x, LogicalFunction y, LogicalFunction theta, LogicalFunction ts, LogicalFunction tgt_wkt)
...
DataType EverNeTrgeometryGeoLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> EverNeTrgeometryGeoLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction EverNeTrgeometryGeoLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 6,
                 "EverNeTrgeometryGeoLogicalFunction requires 6 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view EverNeTrgeometryGeoLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 6,
                 "EverNeTrgeometryGeoLogicalFunction requires 6 children but got {}",
                 arguments.children.size());
    return EverNeTrgeometryGeoLogicalFunction(
