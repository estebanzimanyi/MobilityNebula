...
QuadbinLtLogicalFunction::QuadbinLtLogicalFunction(LogicalFunction a,
                                          LogicalFunction b)
...
DataType QuadbinLtLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction QuadbinLtLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> QuadbinLtLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view QuadbinLtLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const QuadbinLtLogicalFunction*>(&rhs))
    {
...
std::string QuadbinLtLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return QuadbinLtLogicalFunction(std::move(arg0), std::move(arg1));
}
