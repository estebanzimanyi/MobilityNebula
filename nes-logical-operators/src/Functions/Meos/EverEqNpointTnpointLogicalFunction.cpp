...
EverEqNpointTnpointLogicalFunction::EverEqNpointTnpointLogicalFunction(LogicalFunction rid0,
...
{
    PRECONDITION(children.size() == 5, "EverEqNpointTnpointLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqNpointTnpointLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
