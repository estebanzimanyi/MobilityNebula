...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTemporalAContainsGeometryLogicalFunction(LogicalFunctionRegistryArguments); }
