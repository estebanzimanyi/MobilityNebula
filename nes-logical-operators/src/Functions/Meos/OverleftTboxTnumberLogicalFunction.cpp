...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverleftTboxTnumberLogicalFunction(LogicalFunctionRegistryArguments); }
