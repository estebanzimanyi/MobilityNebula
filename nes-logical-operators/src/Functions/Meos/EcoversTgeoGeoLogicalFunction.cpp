...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEcoversTgeoGeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EcoversTgeoGeoLogicalFunction::EcoversTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
...
DataType EcoversTgeoGeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EcoversTgeoGeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view EcoversTgeoGeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EcoversTgeoGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
