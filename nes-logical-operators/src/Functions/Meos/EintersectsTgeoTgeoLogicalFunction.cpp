...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEintersectsTgeoTgeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EintersectsTgeoTgeoLogicalFunction::EintersectsTgeoTgeoLogicalFunction(LogicalFunction lonA,
...
DataType EintersectsTgeoTgeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EintersectsTgeoTgeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 6, "EintersectsTgeoTgeoLogicalFunction requires 6 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view EintersectsTgeoTgeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EintersectsTgeoTgeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
