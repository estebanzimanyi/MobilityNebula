...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTemporalADWithinTPoseGeometryLogicalFunction(LogicalFunctionRegistryArguments); }
