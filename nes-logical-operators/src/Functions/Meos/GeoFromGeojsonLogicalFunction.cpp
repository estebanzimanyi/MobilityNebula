...
{
    PRECONDITION(children.size() == 1, "GeoFromGeojsonLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeoFromGeojsonLogicalFunction(std::move(arg0));
}
