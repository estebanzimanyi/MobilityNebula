...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeoSameLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeoSameLogicalFunction::GeoSameLogicalFunction(LogicalFunction lit,
...
DataType GeoSameLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeoSameLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "GeoSameLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeoSameLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeoSameLogicalFunction(std::move(arg0), std::move(arg1));
}
