...
Th3indexGetBaseCellNumberLogicalFunction::Th3indexGetBaseCellNumberLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts)
...
DataType Th3indexGetBaseCellNumberLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> Th3indexGetBaseCellNumberLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "Th3indexGetBaseCellNumberLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view Th3indexGetBaseCellNumberLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return Th3indexGetBaseCellNumberLogicalFunction(std::move(arg0), std::move(arg1));
}
