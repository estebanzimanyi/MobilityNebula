...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterNadTnpointGeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

NadTnpointGeoLogicalFunction::NadTnpointGeoLogicalFunction(LogicalFunction rid,
...
DataType NadTnpointGeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> NadTnpointGeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 4, "NadTnpointGeoLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view NadTnpointGeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return NadTnpointGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
