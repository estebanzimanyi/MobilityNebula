...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAddFloatTfloatLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

AddFloatTfloatLogicalFunction::AddFloatTfloatLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
...
DataType AddFloatTfloatLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AddFloatTfloatLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view AddFloatTfloatLogicalFunction::getType() const
{
    return NAME;
}
