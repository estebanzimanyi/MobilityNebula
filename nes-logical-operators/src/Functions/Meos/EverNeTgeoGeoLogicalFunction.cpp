...
EverNeTgeoGeoLogicalFunction::EverNeTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
...
DataType EverNeTgeoGeoLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> EverNeTgeoGeoLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction EverNeTgeoGeoLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 4,
                 "EverNeTgeoGeoLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view EverNeTgeoGeoLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverNeTgeoGeoLogicalFunction(std::move(arguments.children[0]),
