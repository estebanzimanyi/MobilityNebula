...
Th3indexCellToChildPosLogicalFunction::Th3indexCellToChildPosLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
...
DataType Th3indexCellToChildPosLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> Th3indexCellToChildPosLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "Th3indexCellToChildPosLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view Th3indexCellToChildPosLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return Th3indexCellToChildPosLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
