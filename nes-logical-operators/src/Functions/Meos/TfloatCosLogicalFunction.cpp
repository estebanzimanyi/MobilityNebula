...
TfloatCosLogicalFunction::TfloatCosLogicalFunction(LogicalFunction traj)
...
DataType TfloatCosLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> TfloatCosLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 1, "TfloatCosLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view TfloatCosLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 1,
                 "TfloatCosLogicalFunction requires 1 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    return TfloatCosLogicalFunction(std::move(arg0));
}
