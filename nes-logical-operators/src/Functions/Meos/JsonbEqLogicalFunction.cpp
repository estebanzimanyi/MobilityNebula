...
JsonbEqLogicalFunction::JsonbEqLogicalFunction(LogicalFunction jb,
...
DataType JsonbEqLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction JsonbEqLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> JsonbEqLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view JsonbEqLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const JsonbEqLogicalFunction*>(&rhs))
    {
...
std::string JsonbEqLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return JsonbEqLogicalFunction(std::move(arg0), std::move(arg1));
}
