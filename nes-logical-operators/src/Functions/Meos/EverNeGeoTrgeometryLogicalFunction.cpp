...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverNeGeoTrgeometryLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EverNeGeoTrgeometryLogicalFunction::EverNeGeoTrgeometryLogicalFunction(LogicalFunction x,
                                          LogicalFunction y,
...
DataType EverNeGeoTrgeometryLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EverNeGeoTrgeometryLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 5, "EverNeGeoTrgeometryLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view EverNeGeoTrgeometryLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 5,
                 "EverNeGeoTrgeometryLogicalFunction requires 5 children but got {}",
    ...
    return EverNeGeoTrgeometryLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
