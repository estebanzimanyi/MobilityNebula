...
SubBigintTbigintLogicalFunction::SubBigintTbigintLogicalFunction(LogicalFunction traj,
...
{
    PRECONDITION(children.size() == 2, "SubBigintTbigintLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
...
LogicalFunction SubBigintTbigintLogicalFunction::withInferredDataType(const Schema& schema) const
{
...
SerializableFunction SubBigintTbigintLogicalFunction::serialize() const
{
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterSubBigintTbigintLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "SubBigintTbigintLogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return SubBigintTbigintLogicalFunction(std::move(arg0), std::move(arg1));
}
