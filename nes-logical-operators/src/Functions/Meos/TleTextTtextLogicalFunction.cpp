...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTleTextTtextLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

TleTextTtextLogicalFunction::TleTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
