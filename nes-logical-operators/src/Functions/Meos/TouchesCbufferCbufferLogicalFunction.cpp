...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTouchesCbufferCbufferLogicalFunction(LogicalFunctionRegistryArguments); }
