...
EintersectsTpcpointGeoLogicalFunction::EintersectsTpcpointGeoLogicalFunction(LogicalFunction pt_hexwkb,
                                          LogicalFunction ts,
...
DataType EintersectsTpcpointGeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EintersectsTpcpointGeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "EintersectsTpcpointGeoLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view EintersectsTpcpointGeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EintersectsTpcpointGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
