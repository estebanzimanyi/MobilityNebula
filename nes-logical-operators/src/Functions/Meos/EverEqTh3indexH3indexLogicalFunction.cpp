...
EverEqTh3indexH3indexLogicalFunction::EverEqTh3indexH3indexLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
...
DataType EverEqTh3indexH3indexLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EverEqTh3indexH3indexLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "EverEqTh3indexH3indexLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view EverEqTh3indexH3indexLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTh3indexH3indexLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
