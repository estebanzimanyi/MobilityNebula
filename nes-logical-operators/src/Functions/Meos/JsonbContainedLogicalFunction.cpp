...
JsonbContainedLogicalFunction::JsonbContainedLogicalFunction(LogicalFunction jb1, LogicalFunction jb2)
...
DataType JsonbContainedLogicalFunction::getDataType() const { return dataType; }
LogicalFunction JsonbContainedLogicalFunction::withDataType(const DataType& d) const { auto c=*this; c.dataType=d; return c; }
std::vector<LogicalFunction> JsonbContainedLogicalFunction::getChildren() const { return parameters; }
...
std::string_view JsonbContainedLogicalFunction::getType() const { return NAME; }
bool JsonbContainedLogicalFunction::operator==(const LogicalFunctionConcept& rhs) const {
    if (const auto* o=dynamic_cast<const JsonbContainedLogicalFunction*>(&rhs)) return parameters==o->parameters;
    return false;
}
std::string JsonbContainedLogicalFunction::explain(ExplainVerbosity v) const {
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return JsonbContainedLogicalFunction(
