...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEdisjointTcbufferGeoLogicalFunction(LogicalFunctionRegistryArguments); }
