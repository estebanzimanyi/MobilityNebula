...
{
    PRECONDITION(children.size() == 1, "GeomFromHexewkbLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomFromHexewkbLogicalFunction(std::move(arg0));
}
