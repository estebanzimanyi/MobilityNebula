...
GeomFromHexewkbLogicalFunction::GeomFromHexewkbLogicalFunction()
...
DataType GeomFromHexewkbLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomFromHexewkbLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 0, "GeomFromHexewkbLogicalFunction requires 0 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomFromHexewkbLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 0,
                 "GeomFromHexewkbLogicalFunction requires 0 children but got {}",
