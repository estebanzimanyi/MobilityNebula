...
AlwaysNeTposeTposeLogicalFunction::AlwaysNeTposeTposeLogicalFunction(
...
DataType AlwaysNeTposeTposeLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> AlwaysNeTposeTposeLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction AlwaysNeTposeTposeLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 8,
                 "AlwaysNeTposeTposeLogicalFunction requires 8 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view AlwaysNeTposeTposeLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysNeTposeTposeLogicalFunction(std::move(arguments.children[0]),
