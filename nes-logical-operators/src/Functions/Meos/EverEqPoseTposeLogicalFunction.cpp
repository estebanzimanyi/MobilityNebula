...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverEqPoseTposeLogicalFunction(LogicalFunctionRegistryArguments); }
