...
GeomPointMake2dLogicalFunction::GeomPointMake2dLogicalFunction(LogicalFunction srid,
                                          LogicalFunction x,
                                          LogicalFunction y)
...
DataType GeomPointMake2dLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomPointMake2dLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "GeomPointMake2dLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomPointMake2dLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomPointMake2dLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
