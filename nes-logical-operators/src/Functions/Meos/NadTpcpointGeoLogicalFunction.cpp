...
NadTpcpointGeoLogicalFunction::NadTpcpointGeoLogicalFunction(LogicalFunction pt_hexwkb,
                                          LogicalFunction ts,
...
DataType NadTpcpointGeoLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> NadTpcpointGeoLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "NadTpcpointGeoLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view NadTpcpointGeoLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return NadTpcpointGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
