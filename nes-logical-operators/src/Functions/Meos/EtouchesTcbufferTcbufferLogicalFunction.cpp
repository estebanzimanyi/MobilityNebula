...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEtouchesTcbufferTcbufferLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EtouchesTcbufferTcbufferLogicalFunction::EtouchesTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
...
DataType EtouchesTcbufferTcbufferLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EtouchesTcbufferTcbufferLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 8, "EtouchesTcbufferTcbufferLogicalFunction requires 8 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view EtouchesTcbufferTcbufferLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EtouchesTcbufferTcbufferLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7));
}
