...
MulBigintTbigintLogicalFunction::MulBigintTbigintLogicalFunction(LogicalFunction traj,
...
{
    PRECONDITION(children.size() == 2, "MulBigintTbigintLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
...
LogicalFunction MulBigintTbigintLogicalFunction::withInferredDataType(const Schema& schema) const
{
...
SerializableFunction MulBigintTbigintLogicalFunction::serialize() const
{
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterMulBigintTbigintLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "MulBigintTbigintLogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return MulBigintTbigintLogicalFunction(std::move(arg0), std::move(arg1));
}
