...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTemporalIntersectsGeometryLogicalFunction(LogicalFunctionRegistryArguments); }
