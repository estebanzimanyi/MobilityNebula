...
EverNeQuadbinTquadbinLogicalFunction::EverNeQuadbinTquadbinLogicalFunction(LogicalFunction cell, LogicalFunction inst_cell, LogicalFunction ts)
...
DataType EverNeQuadbinTquadbinLogicalFunction::getDataType() const { return dataType; }
LogicalFunction EverNeQuadbinTquadbinLogicalFunction::withDataType(const DataType& d) const { auto c=*this; c.dataType=d; return c; }
std::vector<LogicalFunction> EverNeQuadbinTquadbinLogicalFunction::getChildren() const { return parameters; }
...
std::string_view EverNeQuadbinTquadbinLogicalFunction::getType() const { return NAME; }
bool EverNeQuadbinTquadbinLogicalFunction::operator==(const LogicalFunctionConcept& rhs) const {
    if (const auto* o=dynamic_cast<const EverNeQuadbinTquadbinLogicalFunction*>(&rhs)) return parameters==o->parameters;
    return false;
}
std::string EverNeQuadbinTquadbinLogicalFunction::explain(ExplainVerbosity v) const {
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverNeQuadbinTquadbinLogicalFunction(
