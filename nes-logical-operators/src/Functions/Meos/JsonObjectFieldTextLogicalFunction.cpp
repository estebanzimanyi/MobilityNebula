...
JsonObjectFieldTextLogicalFunction::JsonObjectFieldTextLogicalFunction(LogicalFunction json,
                                          LogicalFunction key)
...
DataType JsonObjectFieldTextLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> JsonObjectFieldTextLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "JsonObjectFieldTextLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view JsonObjectFieldTextLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return JsonObjectFieldTextLogicalFunction(std::move(arg0), std::move(arg1));
}
