...
EverEqTjsonbTjsonbLogicalFunction::EverEqTjsonbTjsonbLogicalFunction(LogicalFunction json_str,
                                          LogicalFunction ts,
...
DataType EverEqTjsonbTjsonbLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> EverEqTjsonbTjsonbLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 4, "EverEqTjsonbTjsonbLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view EverEqTjsonbTjsonbLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTjsonbTjsonbLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
