...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverrightStboxStboxLogicalFunction(LogicalFunctionRegistryArguments); }
