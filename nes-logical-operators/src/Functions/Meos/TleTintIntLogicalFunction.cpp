...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTleTintIntLogicalFunction(LogicalFunctionRegistryArguments); }
...
DataType TleTintIntLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> TleTintIntLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view TleTintIntLogicalFunction::getType() const
{
    return NAME;
}
