...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterTpointLengthWkbLogicalFunction(LogicalFunctionRegistryArguments); }
