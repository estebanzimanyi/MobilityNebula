...
GeomBufferLogicalFunction::GeomBufferLogicalFunction(LogicalFunction wkt,
                                          LogicalFunction size,
                                          LogicalFunction params)
...
{
    PRECONDITION(children.size() == 3, "GeomBufferLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomBufferLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
