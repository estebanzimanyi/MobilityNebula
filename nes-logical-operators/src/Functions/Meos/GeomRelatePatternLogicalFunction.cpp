...
GeomRelatePatternLogicalFunction::GeomRelatePatternLogicalFunction(LogicalFunction wkt1,
...
{
    PRECONDITION(children.size() == 3, "GeomRelatePatternLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomRelatePatternLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
