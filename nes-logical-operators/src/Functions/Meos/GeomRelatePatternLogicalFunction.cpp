...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeomRelatePatternLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeomRelatePatternLogicalFunction::GeomRelatePatternLogicalFunction(LogicalFunction lit,
...
DataType GeomRelatePatternLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomRelatePatternLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "GeomRelatePatternLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomRelatePatternLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "GeomRelatePatternLogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return GeomRelatePatternLogicalFunction(std::move(arg0), std::move(arg1));
}
