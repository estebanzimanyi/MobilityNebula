...
EverNeTquadbinQuadbinLogicalFunction::EverNeTquadbinQuadbinLogicalFunction(LogicalFunction cell,
                                          LogicalFunction ts,
...
DataType EverNeTquadbinQuadbinLogicalFunction::getDataType() const
{
    return dataType;
}

LogicalFunction EverNeTquadbinQuadbinLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this;
...
std::vector<LogicalFunction> EverNeTquadbinQuadbinLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view EverNeTquadbinQuadbinLogicalFunction::getType() const
{
    return NAME;
}
...
{
    if (const auto* other = dynamic_cast<const EverNeTquadbinQuadbinLogicalFunction*>(&rhs))
    {
...
std::string EverNeTquadbinQuadbinLogicalFunction::explain(ExplainVerbosity verbosity) const
{
    std::string args;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverNeTquadbinQuadbinLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
