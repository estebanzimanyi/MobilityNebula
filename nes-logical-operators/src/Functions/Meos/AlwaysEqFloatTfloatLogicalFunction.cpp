...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAlwaysEqFloatTfloatLogicalFunction(LogicalFunctionRegistryArguments); }
...
DataType AlwaysEqFloatTfloatLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AlwaysEqFloatTfloatLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view AlwaysEqFloatTfloatLogicalFunction::getType() const
{
    return NAME;
}
