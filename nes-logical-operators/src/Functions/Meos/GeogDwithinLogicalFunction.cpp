...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeogDwithinLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeogDwithinLogicalFunction::GeogDwithinLogicalFunction(LogicalFunction lit,
