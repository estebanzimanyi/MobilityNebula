...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterOverrightTnumberTnumberLogicalFunction(LogicalFunctionRegistryArguments); }
