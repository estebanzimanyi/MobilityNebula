...
{
    PRECONDITION(children.size() == 5, "EverEqTnpointNpointLogicalFunction requires 5 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTnpointNpointLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4));
}
