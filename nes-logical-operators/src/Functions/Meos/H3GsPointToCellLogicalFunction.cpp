...
H3GsPointToCellLogicalFunction::H3GsPointToCellLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
                                          LogicalFunction res)
...
DataType H3GsPointToCellLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> H3GsPointToCellLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "H3GsPointToCellLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view H3GsPointToCellLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return H3GsPointToCellLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
