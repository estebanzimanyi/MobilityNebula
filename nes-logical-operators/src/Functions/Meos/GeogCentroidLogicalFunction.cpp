...
GeogCentroidLogicalFunction::GeogCentroidLogicalFunction(LogicalFunction wkt,
...
{
    PRECONDITION(children.size() == 2, "GeogCentroidLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeogCentroidLogicalFunction(std::move(arg0), std::move(arg1));
}
