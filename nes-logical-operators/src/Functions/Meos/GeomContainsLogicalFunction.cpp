...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeomContainsLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeomContainsLogicalFunction::GeomContainsLogicalFunction(LogicalFunction lit,
...
DataType GeomContainsLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomContainsLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view GeomContainsLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomContainsLogicalFunction(std::move(arg0), std::move(arg1));
}
