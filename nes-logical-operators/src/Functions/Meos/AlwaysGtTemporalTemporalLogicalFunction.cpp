...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAlwaysGtTemporalTemporalLogicalFunction(LogicalFunctionRegistryArguments); }
