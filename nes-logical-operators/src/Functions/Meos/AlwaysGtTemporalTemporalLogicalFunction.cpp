...
AlwaysGtTemporalTemporalLogicalFunction::AlwaysGtTemporalTemporalLogicalFunction(LogicalFunction value,
...
DataType AlwaysGtTemporalTemporalLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> AlwaysGtTemporalTemporalLogicalFunction::getChildren() const { return parameters; }

LogicalFunction AlwaysGtTemporalTemporalLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 3, "AlwaysGtTemporalTemporalLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view AlwaysGtTemporalTemporalLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 3,
                 "AlwaysGtTemporalTemporalLogicalFunction requires 3 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    auto arg2 = std::move(arguments.children[2]);
    return AlwaysGtTemporalTemporalLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
