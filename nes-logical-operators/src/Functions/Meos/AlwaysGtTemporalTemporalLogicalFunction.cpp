...
AlwaysGtTemporalTemporalLogicalFunction::AlwaysGtTemporalTemporalLogicalFunction(LogicalFunction lonA,
...
{
    PRECONDITION(children.size() == 6, "AlwaysGtTemporalTemporalLogicalFunction requires 6 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 6,
                 "AlwaysGtTemporalTemporalLogicalFunction requires 6 children but got {}",
    ...
    return AlwaysGtTemporalTemporalLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5));
}
