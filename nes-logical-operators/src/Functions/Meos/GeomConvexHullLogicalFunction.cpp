...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterGeomConvexHullLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

GeomConvexHullLogicalFunction::GeomConvexHullLogicalFunction(LogicalFunction lit)
...
DataType GeomConvexHullLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomConvexHullLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 1, "GeomConvexHullLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomConvexHullLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomConvexHullLogicalFunction(std::move(arg0));
}
