...
AlwaysEqTposeTposeLogicalFunction::AlwaysEqTposeTposeLogicalFunction(
...
DataType AlwaysEqTposeTposeLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> AlwaysEqTposeTposeLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction AlwaysEqTposeTposeLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 8,
                 "AlwaysEqTposeTposeLogicalFunction requires 8 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view AlwaysEqTposeTposeLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return AlwaysEqTposeTposeLogicalFunction(std::move(arguments.children[0]),
