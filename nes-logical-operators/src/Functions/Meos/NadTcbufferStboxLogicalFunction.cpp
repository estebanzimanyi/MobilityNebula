...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterNadTcbufferStboxLogicalFunction(LogicalFunctionRegistryArguments); }
