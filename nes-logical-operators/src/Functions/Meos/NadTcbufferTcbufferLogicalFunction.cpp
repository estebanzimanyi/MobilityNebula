...
NadTcbufferTcbufferLogicalFunction::NadTcbufferTcbufferLogicalFunction(
...
DataType NadTcbufferTcbufferLogicalFunction::getDataType() const { return dataType; }
...
std::vector<LogicalFunction> NadTcbufferTcbufferLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction NadTcbufferTcbufferLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 8,
                 "NadTcbufferTcbufferLogicalFunction requires 8 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view NadTcbufferTcbufferLogicalFunction::getType() const { return NAME; }
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return NadTcbufferTcbufferLogicalFunction(std::move(arguments.children[0]),
