...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterRightSpansetSpansetLogicalFunction(LogicalFunctionRegistryArguments); }
