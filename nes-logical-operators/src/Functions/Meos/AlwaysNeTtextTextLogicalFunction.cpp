...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterAlwaysNeTtextTextLogicalFunction(LogicalFunctionRegistryArguments); }
