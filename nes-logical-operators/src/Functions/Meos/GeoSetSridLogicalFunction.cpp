...
GeoSetSridLogicalFunction::GeoSetSridLogicalFunction(LogicalFunction wkt,
...
{
    PRECONDITION(children.size() == 2, "GeoSetSridLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeoSetSridLogicalFunction(std::move(arg0), std::move(arg1));
}
