...
GeomDwithinLogicalFunction::GeomDwithinLogicalFunction(LogicalFunction wkt,
...
DataType GeomDwithinLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomDwithinLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 3, "GeomDwithinLogicalFunction requires 3 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomDwithinLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomDwithinLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2));
}
