...
EverEqTgeoGeoLogicalFunction::EverEqTgeoGeoLogicalFunction(LogicalFunction lon, LogicalFunction lat,
...
DataType EverEqTgeoGeoLogicalFunction::getDataType() const { return dataType; }

LogicalFunction EverEqTgeoGeoLogicalFunction::withDataType(const DataType& newDataType) const
{
    auto copy = *this; copy.dataType = newDataType; return copy;
}

std::vector<LogicalFunction> EverEqTgeoGeoLogicalFunction::getChildren() const { return parameters; }
...
LogicalFunction EverEqTgeoGeoLogicalFunction::withChildren(const std::vector<LogicalFunction>& children) const
{
    PRECONDITION(children.size() == 4,
                 "EverEqTgeoGeoLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this; copy.parameters = children; return copy;
}

std::string_view EverEqTgeoGeoLogicalFunction::getType() const { return NAME; }
...
LogicalFunctionRegistryReturnType LogicalFunctionGeneratedRegistrar::RegisterEverEqTgeoGeoLogicalFunction(
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 4,
                 "EverEqTgeoGeoLogicalFunction requires 4 children but got {}",
                 arguments.children.size());
    return EverEqTgeoGeoLogicalFunction(std::move(arguments.children[0]),
