...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverEqTgeoGeoLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EverEqTgeoGeoLogicalFunction::EverEqTgeoGeoLogicalFunction(LogicalFunction lon,
                                          LogicalFunction lat,
...
{
    PRECONDITION(children.size() == 4, "EverEqTgeoGeoLogicalFunction requires 4 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return EverEqTgeoGeoLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3));
}
