...
MindistanceTcbufferTcbufferLogicalFunction::MindistanceTcbufferTcbufferLogicalFunction(LogicalFunction lonA,
...
DataType MindistanceTcbufferTcbufferLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> MindistanceTcbufferTcbufferLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 9, "MindistanceTcbufferTcbufferLogicalFunction requires 9 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view MindistanceTcbufferTcbufferLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return MindistanceTcbufferTcbufferLogicalFunction(std::move(arg0), std::move(arg1), std::move(arg2), std::move(arg3), std::move(arg4), std::move(arg5), std::move(arg6), std::move(arg7), std::move(arg8));
}
