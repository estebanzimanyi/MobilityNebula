...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverEqTextTtextLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EverEqTextTtextLogicalFunction::EverEqTextTtextLogicalFunction(LogicalFunction value,
                                          LogicalFunction ts,
