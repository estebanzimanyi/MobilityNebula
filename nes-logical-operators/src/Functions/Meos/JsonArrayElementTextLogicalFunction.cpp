...
JsonArrayElementTextLogicalFunction::JsonArrayElementTextLogicalFunction(LogicalFunction json,
                                          LogicalFunction idx)
...
DataType JsonArrayElementTextLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> JsonArrayElementTextLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 2, "JsonArrayElementTextLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view JsonArrayElementTextLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return JsonArrayElementTextLogicalFunction(std::move(arg0), std::move(arg1));
}
