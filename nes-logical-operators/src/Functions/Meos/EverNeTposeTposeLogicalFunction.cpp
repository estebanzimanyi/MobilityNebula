...
namespace NES::LogicalFunctionGeneratedRegistrar { LogicalFunctionRegistryReturnType RegisterEverNeTposeTposeLogicalFunction(LogicalFunctionRegistryArguments); }

namespace NES
{

EverNeTposeTposeLogicalFunction::EverNeTposeTposeLogicalFunction(LogicalFunction traj,
...
{
    PRECONDITION(children.size() == 2, "EverNeTposeTposeLogicalFunction requires 2 children, but got {}", children.size());
    auto copy = *this;
    ...
    LogicalFunctionRegistryArguments arguments)
{
    PRECONDITION(arguments.children.size() == 2,
                 "EverNeTposeTposeLogicalFunction requires 2 children but got {}",
                 arguments.children.size());
    auto arg0 = std::move(arguments.children[0]);
    auto arg1 = std::move(arguments.children[1]);
    return EverNeTposeTposeLogicalFunction(std::move(arg0), std::move(arg1));
}
