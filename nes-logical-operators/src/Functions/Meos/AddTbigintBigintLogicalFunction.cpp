...
DataType AddTbigintBigintLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> AddTbigintBigintLogicalFunction::getChildren() const
{
    return parameters;
}
...
std::string_view AddTbigintBigintLogicalFunction::getType() const
{
    return NAME;
}
