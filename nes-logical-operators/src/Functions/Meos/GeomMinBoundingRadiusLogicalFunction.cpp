...
DataType GeomMinBoundingRadiusLogicalFunction::getDataType() const
{
    return dataType;
}
...
std::vector<LogicalFunction> GeomMinBoundingRadiusLogicalFunction::getChildren() const
{
    return parameters;
}
...
{
    PRECONDITION(children.size() == 1, "GeomMinBoundingRadiusLogicalFunction requires 1 children, but got {}", children.size());
    auto copy = *this;
    copy.parameters = children;
    return copy;
}

std::string_view GeomMinBoundingRadiusLogicalFunction::getType() const
{
    return NAME;
}
    ...
    LogicalFunctionRegistryArguments arguments)
{
    ...
    return GeomMinBoundingRadiusLogicalFunction(std::move(arg0));
}
