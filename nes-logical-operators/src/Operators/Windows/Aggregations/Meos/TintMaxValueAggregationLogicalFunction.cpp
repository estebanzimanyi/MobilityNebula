...
TintMaxValueAggregationLogicalFunction::TintMaxValueAggregationLogicalFunction(
...
TintMaxValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TintMaxValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TintMaxValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TintMaxValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TintMaxValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TintMaxValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTintMaxValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TintMaxValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TintMaxValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
