...
TemporalAtMinExpAggregationLogicalFunction::TemporalAtMinExpAggregationLogicalFunction(
...
TemporalAtMinExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalAtMinExpAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalAtMinExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalAtMinExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalAtMinExpAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalAtMinExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalAtMinExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<TemporalAtMinExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalAtMinExpAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
