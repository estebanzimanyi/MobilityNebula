...
IntExtentAggregationLogicalFunction::IntExtentAggregationLogicalFunction(
...
IntExtentAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<IntExtentAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view IntExtentAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void IntExtentAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("IntExtentAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction IntExtentAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterIntExtentAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<IntExtentAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "IntExtentAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
