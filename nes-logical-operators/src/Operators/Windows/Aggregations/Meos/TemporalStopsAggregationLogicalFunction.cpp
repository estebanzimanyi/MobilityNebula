...
TemporalStopsAggregationLogicalFunction::TemporalStopsAggregationLogicalFunction(
...
TemporalStopsAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField,
    std::vector<std::string> constArgs)
{
    return std::make_shared<TemporalStopsAggregationLogicalFunction>(lonField, latField, timestampField, lonField, std::move(constArgs));
}

std::string_view TemporalStopsAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalStopsAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalStopsAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalStopsAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalStopsAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalStopsAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3],
            arguments.literals);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalStopsAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
