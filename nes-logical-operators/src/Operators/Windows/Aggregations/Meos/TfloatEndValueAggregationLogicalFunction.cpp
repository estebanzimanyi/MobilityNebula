...
TfloatEndValueAggregationLogicalFunction::TfloatEndValueAggregationLogicalFunction(
...
TfloatEndValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TfloatEndValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TfloatEndValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TfloatEndValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TfloatEndValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TfloatEndValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTfloatEndValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TfloatEndValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TfloatEndValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
