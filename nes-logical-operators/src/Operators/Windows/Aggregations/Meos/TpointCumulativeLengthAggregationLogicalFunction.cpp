...
TpointCumulativeLengthAggregationLogicalFunction::TpointCumulativeLengthAggregationLogicalFunction(
...
TpointCumulativeLengthAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TpointCumulativeLengthAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TpointCumulativeLengthAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TpointCumulativeLengthAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TpointCumulativeLengthAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TpointCumulativeLengthAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTpointCumulativeLengthAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TpointCumulativeLengthAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TpointCumulativeLengthAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
