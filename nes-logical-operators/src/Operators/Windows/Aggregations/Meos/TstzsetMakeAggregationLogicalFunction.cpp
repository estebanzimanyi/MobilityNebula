...
TstzsetMakeAggregationLogicalFunction::TstzsetMakeAggregationLogicalFunction(
...
TstzsetMakeAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TstzsetMakeAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TstzsetMakeAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TstzsetMakeAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TstzsetMakeAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TstzsetMakeAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTstzsetMakeAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TstzsetMakeAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TstzsetMakeAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
