...
TnpointSpeedAggregationLogicalFunction::TnpointSpeedAggregationLogicalFunction(
...
TnpointSpeedAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnpointSpeedAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TnpointSpeedAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnpointSpeedAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnpointSpeedAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnpointSpeedAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnpointSpeedAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TnpointSpeedAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnpointSpeedAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
