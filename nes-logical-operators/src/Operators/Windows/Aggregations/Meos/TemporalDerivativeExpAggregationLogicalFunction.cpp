...
TemporalDerivativeExpAggregationLogicalFunction::TemporalDerivativeExpAggregationLogicalFunction(
...
TemporalDerivativeExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalDerivativeExpAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalDerivativeExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalDerivativeExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalDerivativeExpAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalDerivativeExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalDerivativeExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TemporalDerivativeExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalDerivativeExpAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
