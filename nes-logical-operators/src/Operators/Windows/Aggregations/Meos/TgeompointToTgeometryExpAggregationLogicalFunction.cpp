...
TgeompointToTgeometryExpAggregationLogicalFunction::TgeompointToTgeometryExpAggregationLogicalFunction(
...
TgeompointToTgeometryExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeompointToTgeometryExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeompointToTgeometryExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeompointToTgeometryExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeompointToTgeometryExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeompointToTgeometryExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeompointToTgeometryExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeompointToTgeometryExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeompointToTgeometryExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
