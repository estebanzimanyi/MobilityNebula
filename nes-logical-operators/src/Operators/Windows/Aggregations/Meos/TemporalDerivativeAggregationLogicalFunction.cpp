...
TemporalDerivativeAggregationLogicalFunction::TemporalDerivativeAggregationLogicalFunction(
...
TemporalDerivativeAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalDerivativeAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalDerivativeAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalDerivativeAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalDerivativeAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalDerivativeAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalDerivativeAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TemporalDerivativeAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalDerivativeAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
