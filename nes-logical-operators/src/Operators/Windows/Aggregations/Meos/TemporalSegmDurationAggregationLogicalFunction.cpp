...
TemporalSegmDurationAggregationLogicalFunction::TemporalSegmDurationAggregationLogicalFunction(
...
TemporalSegmDurationAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField,
    std::vector<std::string> constArgs)
{
    return std::make_shared<TemporalSegmDurationAggregationLogicalFunction>(lonField, latField, timestampField, lonField, std::move(constArgs));
}

std::string_view TemporalSegmDurationAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalSegmDurationAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalSegmDurationAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalSegmDurationAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalSegmDurationAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalSegmDurationAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3],
            arguments.literals);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalSegmDurationAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
