...
TemporalTIntStartValueAggregationLogicalFunction::TemporalTIntStartValueAggregationLogicalFunction(
...
TemporalTIntStartValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalTIntStartValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalTIntStartValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalTIntStartValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalTIntStartValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalTIntStartValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalTIntStartValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TemporalTIntStartValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalTIntStartValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
