...
TpointTwcentroidAggregationLogicalFunction::TpointTwcentroidAggregationLogicalFunction(
...
TpointTwcentroidAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TpointTwcentroidAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TpointTwcentroidAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TpointTwcentroidAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TpointTwcentroidAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TpointTwcentroidAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTpointTwcentroidAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TpointTwcentroidAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TpointTwcentroidAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
