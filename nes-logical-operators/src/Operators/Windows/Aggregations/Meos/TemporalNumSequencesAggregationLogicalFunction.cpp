...
TemporalNumSequencesAggregationLogicalFunction::TemporalNumSequencesAggregationLogicalFunction(
...
TemporalNumSequencesAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalNumSequencesAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalNumSequencesAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalNumSequencesAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalNumSequencesAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalNumSequencesAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalNumSequencesAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalNumSequencesAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalNumSequencesAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
