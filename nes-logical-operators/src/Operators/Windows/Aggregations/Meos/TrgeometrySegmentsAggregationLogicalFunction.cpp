...
TrgeometrySegmentsAggregationLogicalFunction::TrgeometrySegmentsAggregationLogicalFunction(
...
TrgeometrySegmentsAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& xField,
    const FieldAccessLogicalFunction& yField,
    const FieldAccessLogicalFunction& thetaField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TrgeometrySegmentsAggregationLogicalFunction>(xField, yField, thetaField, timestampField, xField);
}

std::string_view TrgeometrySegmentsAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TrgeometrySegmentsAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TrgeometrySegmentsAggregationLogicalFunction: x, y, theta, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TrgeometrySegmentsAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTrgeometrySegmentsAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 5)
    {
        auto ptr = std::make_shared<TrgeometrySegmentsAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3], arguments.fields[4]);
        return ptr;
    }
    throw CannotDeserialize(
        "TrgeometrySegmentsAggregationLogicalFunction requires x, y, theta, timestamp, and alias fields but got {}",
