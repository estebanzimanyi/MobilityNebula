...
TemporalMinusMaxAggregationLogicalFunction::TemporalMinusMaxAggregationLogicalFunction(
...
TemporalMinusMaxAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalMinusMaxAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalMinusMaxAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalMinusMaxAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalMinusMaxAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalMinusMaxAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalMinusMaxAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TemporalMinusMaxAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalMinusMaxAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
