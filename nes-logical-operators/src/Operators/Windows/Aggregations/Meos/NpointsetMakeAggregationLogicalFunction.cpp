...
NpointsetMakeAggregationLogicalFunction::NpointsetMakeAggregationLogicalFunction(
...
NpointsetMakeAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<NpointsetMakeAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view NpointsetMakeAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void NpointsetMakeAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("NpointsetMakeAggregationLogicalFunction: value must be an npoint literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction NpointsetMakeAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterNpointsetMakeAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<NpointsetMakeAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "NpointsetMakeAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
