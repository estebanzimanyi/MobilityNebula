...
TnumberTwavgAggregationLogicalFunction::TnumberTwavgAggregationLogicalFunction(
...
TnumberTwavgAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberTwavgAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberTwavgAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberTwavgAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberTwavgAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberTwavgAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberTwavgAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberTwavgAggregationLogicalFunction>(
    ...
    throw CannotDeserialize(
        "TnumberTwavgAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
