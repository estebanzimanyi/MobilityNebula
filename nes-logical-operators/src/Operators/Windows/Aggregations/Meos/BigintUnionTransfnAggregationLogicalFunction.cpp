...
BigintUnionTransfnAggregationLogicalFunction::BigintUnionTransfnAggregationLogicalFunction(
...
BigintUnionTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<BigintUnionTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view BigintUnionTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void BigintUnionTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("BigintUnionTransfnAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction BigintUnionTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterBigintUnionTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<BigintUnionTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "BigintUnionTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
