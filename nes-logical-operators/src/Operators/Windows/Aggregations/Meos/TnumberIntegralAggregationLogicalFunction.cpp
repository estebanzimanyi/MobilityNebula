...
TnumberIntegralAggregationLogicalFunction::TnumberIntegralAggregationLogicalFunction(
...
TnumberIntegralAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberIntegralAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberIntegralAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberIntegralAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberIntegralAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberIntegralAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberIntegralAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberIntegralAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberIntegralAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
