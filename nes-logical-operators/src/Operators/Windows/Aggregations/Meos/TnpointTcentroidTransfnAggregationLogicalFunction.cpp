...
TnpointTcentroidTransfnAggregationLogicalFunction::TnpointTcentroidTransfnAggregationLogicalFunction(
...
TnpointTcentroidTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnpointTcentroidTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnpointTcentroidTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnpointTcentroidTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnpointTcentroidTransfnAggregationLogicalFunction: timestamp field must be numeric.");
    }
...
NES::SerializableAggregationFunction TnpointTcentroidTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnpointTcentroidTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnpointTcentroidTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnpointTcentroidTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
