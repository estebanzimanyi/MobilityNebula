...
TgeoCentroidExpAggregationLogicalFunction::TgeoCentroidExpAggregationLogicalFunction(
...
TgeoCentroidExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeoCentroidExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeoCentroidExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeoCentroidExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeoCentroidExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeoCentroidExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeoCentroidExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeoCentroidExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeoCentroidExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
