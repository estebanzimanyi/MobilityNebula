...
GeoCollectGarrayAggregationLogicalFunction::GeoCollectGarrayAggregationLogicalFunction(
...
GeoCollectGarrayAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<GeoCollectGarrayAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view GeoCollectGarrayAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void GeoCollectGarrayAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("GeoCollectGarrayAggregationLogicalFunction: value must be a geometry literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction GeoCollectGarrayAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterGeoCollectGarrayAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<GeoCollectGarrayAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "GeoCollectGarrayAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
