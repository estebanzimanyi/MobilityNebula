...
TemporalMergeArrayAggregationLogicalFunction::TemporalMergeArrayAggregationLogicalFunction(
...
TemporalMergeArrayAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalMergeArrayAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalMergeArrayAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalMergeArrayAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalMergeArrayAggregationLogicalFunction: value must be a temporal hex-WKB literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalMergeArrayAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalMergeArrayAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TemporalMergeArrayAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalMergeArrayAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
