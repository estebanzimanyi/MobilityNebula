...
GeoMakelineGarrayAggregationLogicalFunction::GeoMakelineGarrayAggregationLogicalFunction(
...
GeoMakelineGarrayAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<GeoMakelineGarrayAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view GeoMakelineGarrayAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void GeoMakelineGarrayAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("GeoMakelineGarrayAggregationLogicalFunction: value must be a geometry literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction GeoMakelineGarrayAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterGeoMakelineGarrayAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<GeoMakelineGarrayAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "GeoMakelineGarrayAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
