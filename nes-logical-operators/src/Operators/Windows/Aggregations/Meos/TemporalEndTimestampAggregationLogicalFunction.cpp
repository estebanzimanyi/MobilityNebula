...
TemporalEndTimestampAggregationLogicalFunction::TemporalEndTimestampAggregationLogicalFunction(
...
TemporalEndTimestampAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalEndTimestampAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalEndTimestampAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalEndTimestampAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalEndTimestampAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalEndTimestampAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalEndTimestampAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalEndTimestampAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalEndTimestampAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
