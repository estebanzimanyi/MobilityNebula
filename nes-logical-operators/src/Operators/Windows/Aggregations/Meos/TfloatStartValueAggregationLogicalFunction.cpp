...
TfloatStartValueAggregationLogicalFunction::TfloatStartValueAggregationLogicalFunction(
...
TfloatStartValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TfloatStartValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TfloatStartValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TfloatStartValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TfloatStartValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TfloatStartValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTfloatStartValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TfloatStartValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TfloatStartValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
