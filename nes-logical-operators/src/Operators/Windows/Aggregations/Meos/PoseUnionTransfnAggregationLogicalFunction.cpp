...
PoseUnionTransfnAggregationLogicalFunction::PoseUnionTransfnAggregationLogicalFunction(
...
PoseUnionTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<PoseUnionTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view PoseUnionTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void PoseUnionTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("PoseUnionTransfnAggregationLogicalFunction: timestamp field must be numeric.");
    }
...
NES::SerializableAggregationFunction PoseUnionTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterPoseUnionTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<PoseUnionTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "PoseUnionTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
