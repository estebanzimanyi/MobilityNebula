...
CbufferUnionTransfnAggregationLogicalFunction::CbufferUnionTransfnAggregationLogicalFunction(
...
CbufferUnionTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<CbufferUnionTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view CbufferUnionTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void CbufferUnionTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("CbufferUnionTransfnAggregationLogicalFunction: timestamp field must be numeric.");
    }
...
NES::SerializableAggregationFunction CbufferUnionTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterCbufferUnionTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<CbufferUnionTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "CbufferUnionTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
