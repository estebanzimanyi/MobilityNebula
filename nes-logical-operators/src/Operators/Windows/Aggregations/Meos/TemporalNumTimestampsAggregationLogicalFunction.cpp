...
TemporalNumTimestampsAggregationLogicalFunction::TemporalNumTimestampsAggregationLogicalFunction(
...
TemporalNumTimestampsAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalNumTimestampsAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalNumTimestampsAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalNumTimestampsAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalNumTimestampsAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalNumTimestampsAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalNumTimestampsAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalNumTimestampsAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalNumTimestampsAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
