...
TnpointToTgeompointAggregationLogicalFunction::TnpointToTgeompointAggregationLogicalFunction(
...
TnpointToTgeompointAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnpointToTgeompointAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TnpointToTgeompointAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnpointToTgeompointAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnpointToTgeompointAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnpointToTgeompointAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnpointToTgeompointAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TnpointToTgeompointAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnpointToTgeompointAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
