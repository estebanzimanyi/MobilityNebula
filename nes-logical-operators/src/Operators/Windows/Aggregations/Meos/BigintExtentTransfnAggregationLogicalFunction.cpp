...
BigintExtentTransfnAggregationLogicalFunction::BigintExtentTransfnAggregationLogicalFunction(
...
BigintExtentTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<BigintExtentTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view BigintExtentTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void BigintExtentTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("BigintExtentTransfnAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction BigintExtentTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterBigintExtentTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<BigintExtentTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "BigintExtentTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
