...
TemporalEndTimestamptzAggregationLogicalFunction::TemporalEndTimestamptzAggregationLogicalFunction(
...
TemporalEndTimestamptzAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalEndTimestamptzAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalEndTimestamptzAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalEndTimestamptzAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalEndTimestamptzAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalEndTimestamptzAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalEndTimestamptzAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalEndTimestamptzAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalEndTimestamptzAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
