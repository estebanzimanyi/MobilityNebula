...
TnumberAbsAggregationLogicalFunction::TnumberAbsAggregationLogicalFunction(
...
TnumberAbsAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberAbsAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberAbsAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberAbsAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberAbsAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberAbsAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberAbsAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberAbsAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberAbsAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
