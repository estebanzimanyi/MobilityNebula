...
TpointTcentroidTransfnAggregationLogicalFunction::TpointTcentroidTransfnAggregationLogicalFunction(
...
TpointTcentroidTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TpointTcentroidTransfnAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TpointTcentroidTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TpointTcentroidTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TpointTcentroidTransfnAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TpointTcentroidTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTpointTcentroidTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TpointTcentroidTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TpointTcentroidTransfnAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
