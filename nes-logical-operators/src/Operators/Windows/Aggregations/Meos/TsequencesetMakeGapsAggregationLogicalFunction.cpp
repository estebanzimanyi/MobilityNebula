...
TsequencesetMakeGapsAggregationLogicalFunction::TsequencesetMakeGapsAggregationLogicalFunction(
...
TsequencesetMakeGapsAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TsequencesetMakeGapsAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TsequencesetMakeGapsAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TsequencesetMakeGapsAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TsequencesetMakeGapsAggregationLogicalFunction: value must be a temporal-instant literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction TsequencesetMakeGapsAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTsequencesetMakeGapsAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TsequencesetMakeGapsAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TsequencesetMakeGapsAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
