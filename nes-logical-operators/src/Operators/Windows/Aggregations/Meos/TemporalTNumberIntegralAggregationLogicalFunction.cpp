...
TemporalTNumberIntegralAggregationLogicalFunction::TemporalTNumberIntegralAggregationLogicalFunction(
...
TemporalTNumberIntegralAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalTNumberIntegralAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalTNumberIntegralAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalTNumberIntegralAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalTNumberIntegralAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalTNumberIntegralAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalTNumberIntegralAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<TemporalTNumberIntegralAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalTNumberIntegralAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
