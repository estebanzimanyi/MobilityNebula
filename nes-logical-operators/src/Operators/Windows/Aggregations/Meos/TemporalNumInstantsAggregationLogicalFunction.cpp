...
TemporalNumInstantsAggregationLogicalFunction::TemporalNumInstantsAggregationLogicalFunction(
...
TemporalNumInstantsAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalNumInstantsAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalNumInstantsAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalNumInstantsAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalNumInstantsAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalNumInstantsAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalNumInstantsAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalNumInstantsAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalNumInstantsAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
