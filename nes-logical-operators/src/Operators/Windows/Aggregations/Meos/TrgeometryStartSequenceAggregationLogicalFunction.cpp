...
TrgeometryStartSequenceAggregationLogicalFunction::TrgeometryStartSequenceAggregationLogicalFunction(
...
TrgeometryStartSequenceAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& xField,
    const FieldAccessLogicalFunction& yField,
    const FieldAccessLogicalFunction& thetaField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TrgeometryStartSequenceAggregationLogicalFunction>(xField, yField, thetaField, timestampField, xField);
}

std::string_view TrgeometryStartSequenceAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TrgeometryStartSequenceAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TrgeometryStartSequenceAggregationLogicalFunction: x, y, theta, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TrgeometryStartSequenceAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTrgeometryStartSequenceAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 5)
    {
        auto ptr = std::make_shared<TrgeometryStartSequenceAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3], arguments.fields[4]);
        return ptr;
    }
    throw CannotDeserialize(
        "TrgeometryStartSequenceAggregationLogicalFunction requires x, y, theta, timestamp, and alias fields but got {}",
