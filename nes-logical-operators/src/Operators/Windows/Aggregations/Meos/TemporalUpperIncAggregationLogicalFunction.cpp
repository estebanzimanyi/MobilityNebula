...
TemporalUpperIncAggregationLogicalFunction::TemporalUpperIncAggregationLogicalFunction(
...
TemporalUpperIncAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalUpperIncAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalUpperIncAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalUpperIncAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalUpperIncAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalUpperIncAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalUpperIncAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalUpperIncAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalUpperIncAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
