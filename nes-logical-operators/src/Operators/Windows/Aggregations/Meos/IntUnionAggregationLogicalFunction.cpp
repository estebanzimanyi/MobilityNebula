...
IntUnionAggregationLogicalFunction::IntUnionAggregationLogicalFunction(
...
IntUnionAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<IntUnionAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view IntUnionAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void IntUnionAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("IntUnionAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction IntUnionAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterIntUnionAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<IntUnionAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "IntUnionAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
