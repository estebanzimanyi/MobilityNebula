...
TnpointToTgeompointExpAggregationLogicalFunction::TnpointToTgeompointExpAggregationLogicalFunction(
...
TnpointToTgeompointExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnpointToTgeompointExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TnpointToTgeompointExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnpointToTgeompointExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnpointToTgeompointExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnpointToTgeompointExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnpointToTgeompointExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TnpointToTgeompointExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnpointToTgeompointExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
