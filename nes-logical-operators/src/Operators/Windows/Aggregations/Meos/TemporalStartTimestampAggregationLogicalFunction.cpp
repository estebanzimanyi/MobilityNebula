...
TemporalStartTimestampAggregationLogicalFunction::TemporalStartTimestampAggregationLogicalFunction(
...
TemporalStartTimestampAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalStartTimestampAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalStartTimestampAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalStartTimestampAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalStartTimestampAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalStartTimestampAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalStartTimestampAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalStartTimestampAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalStartTimestampAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
