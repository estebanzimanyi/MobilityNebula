...
TpointTrajectoryAggregationLogicalFunction::TpointTrajectoryAggregationLogicalFunction(
...
TpointTrajectoryAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TpointTrajectoryAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TpointTrajectoryAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TpointTrajectoryAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TpointTrajectoryAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TpointTrajectoryAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTpointTrajectoryAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TpointTrajectoryAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TpointTrajectoryAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
