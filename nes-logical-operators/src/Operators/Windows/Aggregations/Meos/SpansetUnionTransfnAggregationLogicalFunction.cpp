...
SpansetUnionTransfnAggregationLogicalFunction::SpansetUnionTransfnAggregationLogicalFunction(
...
SpansetUnionTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<SpansetUnionTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view SpansetUnionTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void SpansetUnionTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("SpansetUnionTransfnAggregationLogicalFunction: timestamp field must be numeric.");
    }
...
NES::SerializableAggregationFunction SpansetUnionTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterSpansetUnionTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<SpansetUnionTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "SpansetUnionTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
