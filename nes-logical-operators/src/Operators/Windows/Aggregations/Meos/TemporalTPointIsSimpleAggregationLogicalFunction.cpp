...
TemporalTPointIsSimpleAggregationLogicalFunction::TemporalTPointIsSimpleAggregationLogicalFunction(
...
TemporalTPointIsSimpleAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalTPointIsSimpleAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalTPointIsSimpleAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalTPointIsSimpleAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalTPointIsSimpleAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalTPointIsSimpleAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalTPointIsSimpleAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalTPointIsSimpleAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalTPointIsSimpleAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
