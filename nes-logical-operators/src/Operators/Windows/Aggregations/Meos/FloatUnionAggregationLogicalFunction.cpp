...
FloatUnionAggregationLogicalFunction::FloatUnionAggregationLogicalFunction(
...
FloatUnionAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<FloatUnionAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view FloatUnionAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void FloatUnionAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("FloatUnionAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction FloatUnionAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterFloatUnionAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<FloatUnionAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "FloatUnionAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
