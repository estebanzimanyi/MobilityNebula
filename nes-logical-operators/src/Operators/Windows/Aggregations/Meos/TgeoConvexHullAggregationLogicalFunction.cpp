...
TgeoConvexHullAggregationLogicalFunction::TgeoConvexHullAggregationLogicalFunction(
...
TgeoConvexHullAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeoConvexHullAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeoConvexHullAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeoConvexHullAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeoConvexHullAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeoConvexHullAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeoConvexHullAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeoConvexHullAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeoConvexHullAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
