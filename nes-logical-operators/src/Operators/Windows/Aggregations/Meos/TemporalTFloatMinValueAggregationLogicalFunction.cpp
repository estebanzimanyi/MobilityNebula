...
TemporalTFloatMinValueAggregationLogicalFunction::TemporalTFloatMinValueAggregationLogicalFunction(
...
TemporalTFloatMinValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalTFloatMinValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalTFloatMinValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalTFloatMinValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalTFloatMinValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalTFloatMinValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalTFloatMinValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<TemporalTFloatMinValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalTFloatMinValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
