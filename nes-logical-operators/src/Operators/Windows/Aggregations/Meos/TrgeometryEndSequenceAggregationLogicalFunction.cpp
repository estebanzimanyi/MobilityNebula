...
TrgeometryEndSequenceAggregationLogicalFunction::TrgeometryEndSequenceAggregationLogicalFunction(
...
TrgeometryEndSequenceAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& xField,
    const FieldAccessLogicalFunction& yField,
    const FieldAccessLogicalFunction& thetaField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TrgeometryEndSequenceAggregationLogicalFunction>(xField, yField, thetaField, timestampField, xField);
}

std::string_view TrgeometryEndSequenceAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TrgeometryEndSequenceAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TrgeometryEndSequenceAggregationLogicalFunction: x, y, theta, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TrgeometryEndSequenceAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTrgeometryEndSequenceAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 5)
    {
        auto ptr = std::make_shared<TrgeometryEndSequenceAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3], arguments.fields[4]);
        return ptr;
    }
    throw CannotDeserialize(
        "TrgeometryEndSequenceAggregationLogicalFunction requires x, y, theta, timestamp, and alias fields but got {}",
