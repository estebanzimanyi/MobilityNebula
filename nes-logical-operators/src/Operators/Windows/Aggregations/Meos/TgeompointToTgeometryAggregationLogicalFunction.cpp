...
TgeompointToTgeometryAggregationLogicalFunction::TgeompointToTgeometryAggregationLogicalFunction(
...
TgeompointToTgeometryAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeompointToTgeometryAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeompointToTgeometryAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeompointToTgeometryAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeompointToTgeometryAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeompointToTgeometryAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeompointToTgeometryAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeompointToTgeometryAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeompointToTgeometryAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
