...
TnpointCumulativeLengthAggregationLogicalFunction::TnpointCumulativeLengthAggregationLogicalFunction(
...
TnpointCumulativeLengthAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnpointCumulativeLengthAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TnpointCumulativeLengthAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnpointCumulativeLengthAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnpointCumulativeLengthAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnpointCumulativeLengthAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnpointCumulativeLengthAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TnpointCumulativeLengthAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnpointCumulativeLengthAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
