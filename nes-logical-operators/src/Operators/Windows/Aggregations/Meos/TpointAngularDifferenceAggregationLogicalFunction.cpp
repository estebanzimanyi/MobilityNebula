...
TpointAngularDifferenceAggregationLogicalFunction::TpointAngularDifferenceAggregationLogicalFunction(
...
TpointAngularDifferenceAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TpointAngularDifferenceAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TpointAngularDifferenceAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TpointAngularDifferenceAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TpointAngularDifferenceAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TpointAngularDifferenceAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTpointAngularDifferenceAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TpointAngularDifferenceAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TpointAngularDifferenceAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
