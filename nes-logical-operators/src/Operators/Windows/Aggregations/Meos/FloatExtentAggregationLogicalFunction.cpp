...
FloatExtentAggregationLogicalFunction::FloatExtentAggregationLogicalFunction(
...
FloatExtentAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<FloatExtentAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view FloatExtentAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void FloatExtentAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("FloatExtentAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction FloatExtentAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterFloatExtentAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<FloatExtentAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "FloatExtentAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
