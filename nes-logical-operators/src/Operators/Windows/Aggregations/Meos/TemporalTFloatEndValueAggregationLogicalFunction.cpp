...
TemporalTFloatEndValueAggregationLogicalFunction::TemporalTFloatEndValueAggregationLogicalFunction(
...
TemporalTFloatEndValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalTFloatEndValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalTFloatEndValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalTFloatEndValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalTFloatEndValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalTFloatEndValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalTFloatEndValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<TemporalTFloatEndValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalTFloatEndValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
