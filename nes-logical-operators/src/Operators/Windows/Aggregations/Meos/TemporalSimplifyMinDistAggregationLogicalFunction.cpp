...
TemporalSimplifyMinDistAggregationLogicalFunction::TemporalSimplifyMinDistAggregationLogicalFunction(
...
TemporalSimplifyMinDistAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField,
    std::vector<std::string> constArgs)
{
    return std::make_shared<TemporalSimplifyMinDistAggregationLogicalFunction>(lonField, latField, timestampField, lonField, std::move(constArgs));
}

std::string_view TemporalSimplifyMinDistAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalSimplifyMinDistAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalSimplifyMinDistAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalSimplifyMinDistAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalSimplifyMinDistAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalSimplifyMinDistAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3],
            arguments.literals);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalSimplifyMinDistAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
