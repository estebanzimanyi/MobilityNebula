...
TintWmaxTransfnAggregationLogicalFunction::TintWmaxTransfnAggregationLogicalFunction(
...
TintWmaxTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TintWmaxTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TintWmaxTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TintWmaxTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TintWmaxTransfnAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TintWmaxTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTintWmaxTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TintWmaxTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TintWmaxTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
