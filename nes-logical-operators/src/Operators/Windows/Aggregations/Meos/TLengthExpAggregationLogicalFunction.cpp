...
TLengthExpAggregationLogicalFunction::TLengthExpAggregationLogicalFunction(
...
TLengthExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TLengthExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TLengthExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TLengthExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TLengthExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TLengthExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTLengthExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TLengthExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TLengthExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
