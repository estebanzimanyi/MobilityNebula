...
TnumberExtentAggregationLogicalFunction::TnumberExtentAggregationLogicalFunction(
...
TnumberExtentAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberExtentAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberExtentAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberExtentAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberExtentAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberExtentAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberExtentAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberExtentAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberExtentAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
