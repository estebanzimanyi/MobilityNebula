...
BigintExtentAggregationLogicalFunction::BigintExtentAggregationLogicalFunction(
...
BigintExtentAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<BigintExtentAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view BigintExtentAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void BigintExtentAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("BigintExtentAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction BigintExtentAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterBigintExtentAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<BigintExtentAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "BigintExtentAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
