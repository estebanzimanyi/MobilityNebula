...
TpointMakeSimpleAggregationLogicalFunction::TpointMakeSimpleAggregationLogicalFunction(
...
TpointMakeSimpleAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TpointMakeSimpleAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TpointMakeSimpleAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TpointMakeSimpleAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TpointMakeSimpleAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TpointMakeSimpleAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTpointMakeSimpleAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TpointMakeSimpleAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TpointMakeSimpleAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
