...
PosesetMakeAggregationLogicalFunction::PosesetMakeAggregationLogicalFunction(
...
PosesetMakeAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<PosesetMakeAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view PosesetMakeAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void PosesetMakeAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("PosesetMakeAggregationLogicalFunction: value must be a pose literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction PosesetMakeAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterPosesetMakeAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<PosesetMakeAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "PosesetMakeAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
