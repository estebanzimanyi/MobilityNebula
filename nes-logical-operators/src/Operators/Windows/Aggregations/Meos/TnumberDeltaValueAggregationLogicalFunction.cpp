...
TnumberDeltaValueAggregationLogicalFunction::TnumberDeltaValueAggregationLogicalFunction(
...
TnumberDeltaValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberDeltaValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberDeltaValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberDeltaValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberDeltaValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberDeltaValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberDeltaValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberDeltaValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberDeltaValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
