...
TpointCumulativeLengthExpAggregationLogicalFunction::TpointCumulativeLengthExpAggregationLogicalFunction(
...
TpointCumulativeLengthExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TpointCumulativeLengthExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TpointCumulativeLengthExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TpointCumulativeLengthExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TpointCumulativeLengthExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TpointCumulativeLengthExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTpointCumulativeLengthExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TpointCumulativeLengthExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TpointCumulativeLengthExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
