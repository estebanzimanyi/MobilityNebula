...
TemporalLengthAggregationLogicalFunction::TemporalLengthAggregationLogicalFunction(
...
TemporalLengthAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalLengthAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalLengthAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalLengthAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalLengthAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalLengthAggregationLogicalFunction::serialize() const
{
    // Same wire shape as TemporalSequence (3 fields + alias); only the type tag differs.
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalLengthAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalLengthAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalLengthAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
