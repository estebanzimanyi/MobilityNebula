...
TspatialExtentTransfnAggregationLogicalFunction::TspatialExtentTransfnAggregationLogicalFunction(
...
TspatialExtentTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TspatialExtentTransfnAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TspatialExtentTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TspatialExtentTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TspatialExtentTransfnAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TspatialExtentTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTspatialExtentTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TspatialExtentTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TspatialExtentTransfnAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
