...
TnumberTrendAggregationLogicalFunction::TnumberTrendAggregationLogicalFunction(
...
TnumberTrendAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberTrendAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberTrendAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberTrendAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberTrendAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberTrendAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberTrendAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberTrendAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberTrendAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
