...
TimestamptzExtentAggregationLogicalFunction::TimestamptzExtentAggregationLogicalFunction(
...
TimestamptzExtentAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TimestamptzExtentAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TimestamptzExtentAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TimestamptzExtentAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TimestamptzExtentAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TimestamptzExtentAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTimestamptzExtentAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TimestamptzExtentAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TimestamptzExtentAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
