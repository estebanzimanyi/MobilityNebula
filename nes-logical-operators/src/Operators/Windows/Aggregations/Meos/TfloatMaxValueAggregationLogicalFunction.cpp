...
TfloatMaxValueAggregationLogicalFunction::TfloatMaxValueAggregationLogicalFunction(
...
TfloatMaxValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TfloatMaxValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TfloatMaxValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TfloatMaxValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TfloatMaxValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TfloatMaxValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTfloatMaxValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TfloatMaxValueAggregationLogicalFunction>(
    ...
    throw CannotDeserialize(
        "TfloatMaxValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
