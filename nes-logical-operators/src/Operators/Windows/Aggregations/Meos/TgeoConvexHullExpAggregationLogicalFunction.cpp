...
TgeoConvexHullExpAggregationLogicalFunction::TgeoConvexHullExpAggregationLogicalFunction(
...
TgeoConvexHullExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeoConvexHullExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeoConvexHullExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeoConvexHullExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeoConvexHullExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeoConvexHullExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeoConvexHullExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeoConvexHullExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeoConvexHullExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
