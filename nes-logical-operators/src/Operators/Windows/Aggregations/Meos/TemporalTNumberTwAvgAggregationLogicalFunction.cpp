...
TemporalTNumberTwAvgAggregationLogicalFunction::TemporalTNumberTwAvgAggregationLogicalFunction(
...
TemporalTNumberTwAvgAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalTNumberTwAvgAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalTNumberTwAvgAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalTNumberTwAvgAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalTNumberTwAvgAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalTNumberTwAvgAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalTNumberTwAvgAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    throw CannotDeserialize(
        "TemporalTNumberTwAvgAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
