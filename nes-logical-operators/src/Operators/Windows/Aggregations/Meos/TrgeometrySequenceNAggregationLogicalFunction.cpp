...
TrgeometrySequenceNAggregationLogicalFunction::TrgeometrySequenceNAggregationLogicalFunction(
...
TrgeometrySequenceNAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& xField,
    const FieldAccessLogicalFunction& yField,
    const FieldAccessLogicalFunction& thetaField,
    const FieldAccessLogicalFunction& timestampField,
    std::vector<std::string> constArgs)
{
    return std::make_shared<TrgeometrySequenceNAggregationLogicalFunction>(xField, yField, thetaField, timestampField, xField, std::move(constArgs));
}

std::string_view TrgeometrySequenceNAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TrgeometrySequenceNAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TrgeometrySequenceNAggregationLogicalFunction: x, y, theta, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TrgeometrySequenceNAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTrgeometrySequenceNAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 5)
    {
        auto ptr = std::make_shared<TrgeometrySequenceNAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3], arguments.fields[4],
            arguments.literals);
        return ptr;
    }
    throw CannotDeserialize(
        "TrgeometrySequenceNAggregationLogicalFunction requires x, y, theta, timestamp, and alias fields but got {}",
