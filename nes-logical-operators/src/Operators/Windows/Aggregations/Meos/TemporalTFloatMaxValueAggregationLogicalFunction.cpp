...
TemporalTFloatMaxValueAggregationLogicalFunction::TemporalTFloatMaxValueAggregationLogicalFunction(
...
TemporalTFloatMaxValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalTFloatMaxValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalTFloatMaxValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalTFloatMaxValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalTFloatMaxValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalTFloatMaxValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalTFloatMaxValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    // serialize() uses the 4-field TemporalSequence serde with value duplicated:
    // parse returns [value, timestamp, value, alias], so alias is fields[3].
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalTFloatMaxValueAggregationLogicalFunction>(
    ...
    throw CannotDeserialize(
        "TemporalTFloatMaxValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
