...
TgeoEndValueExpAggregationLogicalFunction::TgeoEndValueExpAggregationLogicalFunction(
...
TgeoEndValueExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeoEndValueExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeoEndValueExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeoEndValueExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeoEndValueExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeoEndValueExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeoEndValueExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeoEndValueExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeoEndValueExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
