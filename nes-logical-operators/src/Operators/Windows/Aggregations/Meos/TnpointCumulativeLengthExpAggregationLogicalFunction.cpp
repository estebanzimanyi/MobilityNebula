...
TnpointCumulativeLengthExpAggregationLogicalFunction::TnpointCumulativeLengthExpAggregationLogicalFunction(
...
TnpointCumulativeLengthExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnpointCumulativeLengthExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TnpointCumulativeLengthExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnpointCumulativeLengthExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnpointCumulativeLengthExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnpointCumulativeLengthExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnpointCumulativeLengthExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TnpointCumulativeLengthExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnpointCumulativeLengthExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
