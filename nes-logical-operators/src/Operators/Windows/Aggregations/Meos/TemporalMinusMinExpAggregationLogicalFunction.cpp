...
TemporalMinusMinExpAggregationLogicalFunction::TemporalMinusMinExpAggregationLogicalFunction(
...
TemporalMinusMinExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalMinusMinExpAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalMinusMinExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalMinusMinExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalMinusMinExpAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalMinusMinExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalMinusMinExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<TemporalMinusMinExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalMinusMinExpAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
