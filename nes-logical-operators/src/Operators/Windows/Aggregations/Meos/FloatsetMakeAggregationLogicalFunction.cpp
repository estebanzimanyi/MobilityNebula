...
FloatsetMakeAggregationLogicalFunction::FloatsetMakeAggregationLogicalFunction(
...
FloatsetMakeAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<FloatsetMakeAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view FloatsetMakeAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void FloatsetMakeAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("FloatsetMakeAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction FloatsetMakeAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterFloatsetMakeAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<FloatsetMakeAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "FloatsetMakeAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
