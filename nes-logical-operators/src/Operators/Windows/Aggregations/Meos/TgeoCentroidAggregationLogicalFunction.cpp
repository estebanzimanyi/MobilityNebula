...
TgeoCentroidAggregationLogicalFunction::TgeoCentroidAggregationLogicalFunction(
...
TgeoCentroidAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeoCentroidAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeoCentroidAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeoCentroidAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeoCentroidAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeoCentroidAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeoCentroidAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeoCentroidAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeoCentroidAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
