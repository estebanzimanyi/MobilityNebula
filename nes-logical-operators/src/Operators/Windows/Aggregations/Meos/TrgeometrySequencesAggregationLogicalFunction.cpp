...
TrgeometrySequencesAggregationLogicalFunction::TrgeometrySequencesAggregationLogicalFunction(
...
TrgeometrySequencesAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& xField,
    const FieldAccessLogicalFunction& yField,
    const FieldAccessLogicalFunction& thetaField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TrgeometrySequencesAggregationLogicalFunction>(xField, yField, thetaField, timestampField, xField);
}

std::string_view TrgeometrySequencesAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TrgeometrySequencesAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TrgeometrySequencesAggregationLogicalFunction: x, y, theta, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TrgeometrySequencesAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTrgeometrySequencesAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 5)
    {
        auto ptr = std::make_shared<TrgeometrySequencesAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3], arguments.fields[4]);
        return ptr;
    }
    throw CannotDeserialize(
        "TrgeometrySequencesAggregationLogicalFunction requires x, y, theta, timestamp, and alias fields but got {}",
