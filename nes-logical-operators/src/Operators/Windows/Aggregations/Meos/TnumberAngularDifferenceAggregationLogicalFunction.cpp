...
TnumberAngularDifferenceAggregationLogicalFunction::TnumberAngularDifferenceAggregationLogicalFunction(
...
TnumberAngularDifferenceAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberAngularDifferenceAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberAngularDifferenceAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberAngularDifferenceAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberAngularDifferenceAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberAngularDifferenceAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberAngularDifferenceAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberAngularDifferenceAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberAngularDifferenceAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
