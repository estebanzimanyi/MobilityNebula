...
GeomArrayUnionAggregationLogicalFunction::GeomArrayUnionAggregationLogicalFunction(
...
GeomArrayUnionAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<GeomArrayUnionAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view GeomArrayUnionAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void GeomArrayUnionAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("GeomArrayUnionAggregationLogicalFunction: value must be a geometry literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction GeomArrayUnionAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterGeomArrayUnionAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<GeomArrayUnionAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "GeomArrayUnionAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
