...
TnumberAbsExpAggregationLogicalFunction::TnumberAbsExpAggregationLogicalFunction(
...
TnumberAbsExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberAbsExpAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberAbsExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberAbsExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberAbsExpAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberAbsExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberAbsExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberAbsExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberAbsExpAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
