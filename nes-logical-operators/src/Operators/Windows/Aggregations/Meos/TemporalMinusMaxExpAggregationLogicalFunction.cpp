...
TemporalMinusMaxExpAggregationLogicalFunction::TemporalMinusMaxExpAggregationLogicalFunction(
...
TemporalMinusMaxExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalMinusMaxExpAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TemporalMinusMaxExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalMinusMaxExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalMinusMaxExpAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalMinusMaxExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalMinusMaxExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TemporalMinusMaxExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalMinusMaxExpAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
