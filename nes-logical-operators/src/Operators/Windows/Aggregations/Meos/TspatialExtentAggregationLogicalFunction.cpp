...
TspatialExtentAggregationLogicalFunction::TspatialExtentAggregationLogicalFunction(
...
TspatialExtentAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TspatialExtentAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TspatialExtentAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TspatialExtentAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TspatialExtentAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TspatialExtentAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTspatialExtentAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TspatialExtentAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TspatialExtentAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
