...
TtextTminTransfnAggregationLogicalFunction::TtextTminTransfnAggregationLogicalFunction(
...
TtextTminTransfnAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TtextTminTransfnAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TtextTminTransfnAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TtextTminTransfnAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TtextTminTransfnAggregationLogicalFunction: timestamp field must be numeric.");
    }
...
NES::SerializableAggregationFunction TtextTminTransfnAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTtextTminTransfnAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TtextTminTransfnAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TtextTminTransfnAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
