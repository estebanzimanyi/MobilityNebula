...
TnumberTrendExpAggregationLogicalFunction::TnumberTrendExpAggregationLogicalFunction(
...
TnumberTrendExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberTrendExpAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberTrendExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberTrendExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberTrendExpAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberTrendExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberTrendExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberTrendExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberTrendExpAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
