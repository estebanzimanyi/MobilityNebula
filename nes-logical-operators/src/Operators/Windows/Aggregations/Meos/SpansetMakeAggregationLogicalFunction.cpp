...
SpansetMakeAggregationLogicalFunction::SpansetMakeAggregationLogicalFunction(
...
SpansetMakeAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<SpansetMakeAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view SpansetMakeAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void SpansetMakeAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("SpansetMakeAggregationLogicalFunction: value must be a span literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction SpansetMakeAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterSpansetMakeAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<SpansetMakeAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "SpansetMakeAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
