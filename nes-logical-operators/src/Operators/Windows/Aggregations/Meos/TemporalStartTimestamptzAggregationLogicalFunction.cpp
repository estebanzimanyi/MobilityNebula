...
TemporalStartTimestamptzAggregationLogicalFunction::TemporalStartTimestamptzAggregationLogicalFunction(
...
TemporalStartTimestamptzAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TemporalStartTimestamptzAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TemporalStartTimestamptzAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TemporalStartTimestamptzAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TemporalStartTimestamptzAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TemporalStartTimestamptzAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTemporalStartTimestamptzAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TemporalStartTimestamptzAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TemporalStartTimestamptzAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
