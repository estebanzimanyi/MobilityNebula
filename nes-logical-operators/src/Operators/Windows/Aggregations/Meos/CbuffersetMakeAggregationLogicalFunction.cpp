...
CbuffersetMakeAggregationLogicalFunction::CbuffersetMakeAggregationLogicalFunction(
...
CbuffersetMakeAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<CbuffersetMakeAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view CbuffersetMakeAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void CbuffersetMakeAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("CbuffersetMakeAggregationLogicalFunction: value must be a cbuffer literal; timestamp must be numeric.");
    }
...
NES::SerializableAggregationFunction CbuffersetMakeAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterCbuffersetMakeAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<CbuffersetMakeAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "CbuffersetMakeAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
