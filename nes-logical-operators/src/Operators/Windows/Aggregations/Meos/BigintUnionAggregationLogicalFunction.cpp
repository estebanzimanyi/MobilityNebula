...
BigintUnionAggregationLogicalFunction::BigintUnionAggregationLogicalFunction(
...
BigintUnionAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<BigintUnionAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view BigintUnionAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void BigintUnionAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("BigintUnionAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction BigintUnionAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterBigintUnionAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 3)
    {
        auto ptr = std::make_shared<BigintUnionAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2]);
        return ptr;
    }
    throw CannotDeserialize(
        "BigintUnionAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
