...
TintStartValueAggregationLogicalFunction::TintStartValueAggregationLogicalFunction(
...
TintStartValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TintStartValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TintStartValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TintStartValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TintStartValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TintStartValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTintStartValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TintStartValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TintStartValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
