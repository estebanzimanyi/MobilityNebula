...
TrgeometrySetInterpAggregationLogicalFunction::TrgeometrySetInterpAggregationLogicalFunction(
...
TrgeometrySetInterpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& xField,
    const FieldAccessLogicalFunction& yField,
    const FieldAccessLogicalFunction& thetaField,
    const FieldAccessLogicalFunction& timestampField,
    std::vector<std::string> constArgs)
{
    return std::make_shared<TrgeometrySetInterpAggregationLogicalFunction>(xField, yField, thetaField, timestampField, xField, std::move(constArgs));
}

std::string_view TrgeometrySetInterpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TrgeometrySetInterpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TrgeometrySetInterpAggregationLogicalFunction: x, y, theta, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TrgeometrySetInterpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTrgeometrySetInterpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 5)
    {
        auto ptr = std::make_shared<TrgeometrySetInterpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3], arguments.fields[4],
            arguments.literals);
        return ptr;
    }
    throw CannotDeserialize(
        "TrgeometrySetInterpAggregationLogicalFunction requires x, y, theta, timestamp, and alias fields but got {}",
