...
TnumberAvgValueAggregationLogicalFunction::TnumberAvgValueAggregationLogicalFunction(
...
TnumberAvgValueAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberAvgValueAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberAvgValueAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberAvgValueAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberAvgValueAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberAvgValueAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberAvgValueAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberAvgValueAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberAvgValueAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
