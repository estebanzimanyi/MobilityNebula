...
TnumberDeltaValueExpAggregationLogicalFunction::TnumberDeltaValueExpAggregationLogicalFunction(
...
TnumberDeltaValueExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TnumberDeltaValueExpAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TnumberDeltaValueExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TnumberDeltaValueExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TnumberDeltaValueExpAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TnumberDeltaValueExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTnumberDeltaValueExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TnumberDeltaValueExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TnumberDeltaValueExpAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
