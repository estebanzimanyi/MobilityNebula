...
TimestamptzUnionAggregationLogicalFunction::TimestamptzUnionAggregationLogicalFunction(
...
TimestamptzUnionAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& valueField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TimestamptzUnionAggregationLogicalFunction>(valueField, timestampField, valueField);
}

std::string_view TimestamptzUnionAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TimestamptzUnionAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TimestamptzUnionAggregationLogicalFunction: value and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TimestamptzUnionAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTimestamptzUnionAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    ...
    {
        auto ptr = std::make_shared<TimestamptzUnionAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TimestamptzUnionAggregationLogicalFunction requires value, timestamp, and alias fields but got {}",
