...
TgeoStartValueExpAggregationLogicalFunction::TgeoStartValueExpAggregationLogicalFunction(
...
TgeoStartValueExpAggregationLogicalFunction::create(
    const FieldAccessLogicalFunction& lonField,
    const FieldAccessLogicalFunction& latField,
    const FieldAccessLogicalFunction& timestampField)
{
    return std::make_shared<TgeoStartValueExpAggregationLogicalFunction>(lonField, latField, timestampField, lonField);
}

std::string_view TgeoStartValueExpAggregationLogicalFunction::getName() const noexcept
{
    return NAME;
}

void TgeoStartValueExpAggregationLogicalFunction::inferStamp(const Schema& schema)
{
    ...
    {
        throw CannotInferSchema("TgeoStartValueExpAggregationLogicalFunction: lon, lat, and timestamp fields must be numeric.");
    }
...
NES::SerializableAggregationFunction TgeoStartValueExpAggregationLogicalFunction::serialize() const
{
...
AggregationLogicalFunctionRegistryReturnType AggregationLogicalFunctionGeneratedRegistrar::RegisterTgeoStartValueExpAggregationLogicalFunction(
    AggregationLogicalFunctionRegistryArguments arguments)
{
    if (arguments.fields.size() == 4)
    {
        auto ptr = std::make_shared<TgeoStartValueExpAggregationLogicalFunction>(
            arguments.fields[0], arguments.fields[1], arguments.fields[2], arguments.fields[3]);
        return ptr;
    }
    throw CannotDeserialize(
        "TgeoStartValueExpAggregationLogicalFunction requires lon, lat, timestamp, and alias fields but got {}",
